...
/**
 * <p>
 * Unit test cases for PersistenceException.
 * </p>
 *
 * <p>
...
public class PersistenceExceptionAccuracyTests extends TestCase {
    ...
    public void testPersistenceException1() {
        PersistenceException exception = new PersistenceException(ERROR_MESSAGE);
        assertNotNull("Unable to instantiate PersistenceException.", exception);
    ...
    public void testPersistenceException2() {
        PersistenceException exception = new PersistenceException(ERROR_MESSAGE, CAUSE_EXCEPTION);
     ...
     *
     * <p>
     * Verifies PersistenceException subclasses Exception.
     * </p>
     */
    public void testPersistenceExceptionInheritance1() {
        PersistenceException exception = new PersistenceException(ERROR_MESSAGE);
        assertTrue("PersistenceException does not subclass Exception.", exception instanceof Exception);
    }
