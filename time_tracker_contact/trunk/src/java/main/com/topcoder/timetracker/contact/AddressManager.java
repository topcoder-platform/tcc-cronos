...
/**
 * <p>
 * This interface defines the contract for the complete management of an address.
 * It provides single and batch CRUD operations as well as the means to associate or disassociate an address
 * from an entity. It also provides the ability to audit each operation, if so desired.
 * It has one implementation in this design: <code>AddressManagerLocalDelegate</code>.
 * </p>
 *
 * <p>
