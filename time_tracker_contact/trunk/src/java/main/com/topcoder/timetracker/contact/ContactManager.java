 ...
 * It provides single and batch CRUD operations as well as the means to associate or disassociate a contact from
 * an entity. It also provides the ability to audit each operation, if so desired.
 * It has one implementation in this design: <code>ContactManagerLocalDelegate</code>.
 * </p>
 *
 * <p>
 *  <strong>Thread Safety</strong>
 *  Implementations need not necessarily be thread safe. Each implementation should specify whether it is thread-safe
 *  or not. The application should pick the correct implementation for it's requirements.
 * </p>
 *
...
public interface ContactManager {
     ...
     *  <ul>
     *   <li>
     *   If the changed status of given <code>Contact</code> is found to be false,
