...
function pageChanged(newPage) {
    if (parentWindow != null) {
        parentWindow.call("showLatestClueClick", [newPage]);
    } else {
...
function getWorkingGameID() {
    if (parentWindow != null) {
        parentWindow.eval("getWorkingGameID");
    } else {
        helper.getWorkingGameID();
    }
}
...
function getCurrentTargetID() {
    if (parentWindow != null) {
        parentWindow.eval("getCurrentTargetID");
    } else {
        helper.getCurrentTargetID();
    }
}
...
function addLogInClickHandler(functionName) {
    if (parentWindow != null) {
        ...
        listener.addFunctionName(uiEventType.getField("LOGIN_CLICK").getObject(null), functionName);
...
function removeLogInClickHandler(functionName) {
    if (parentWindow != null) {
        ...
        helper.removeEventListener(listener);
        listener.removeFunctionName(uiEventType.getField("LOGIN_CLICK").getObject(null), functionName);
        helper.addEventListener(listener);
    }
}
...
function addSuccessfulLogInHandler(functionName) {
    if (parentWindow != null) {
        ...
        helper.removeEventListener(listener);
        listener.addFunctionName(uiEventType.getField("SUCCESSFUL_LOGIN").getObject(null), functionName);
        helper.addEventListener(listener);
    }
}
...
function removeSuccessfulLogInHandler(functionName) {
    if (parentWindow != null) {
        ...
        helper.removeEventListener(listener);
        listener.removeFunctionName(uiEventType.getField("SUCCESSFUL_LOGIN").getObject(null), functionName);
        helper.addEventListener(listener);
    }
}
...
function addLogOutClickHandler(functionName) {
    if (parentWindow != null) {
        ...
        helper.removeEventListener(listener);
        listener.addFunctionName(uiEventType.getField("LOGOUT_CLICK").getObject(null), functionName);
        helper.addEventListener(listener);
    }
}
...
function removeLogOutClickHandler(functionName) {
     if (parentWindow != null) {
        ...
        helper.removeEventListener(listener);
        listener.removeFunctionName(uiEventType.getField("LOGOUT_CLICK").getObject(null), functionName);
        helper.addEventListener(listener);
    }
}
...
function addSuccessfulLogOutHandler(functionName) {
    if (parentWindow != null) {
        ...
        helper.removeEventListener(listener);
        listener.addFunctionName(uiEventType.getField("SUCCESSFUL_LOGOUT").getObject(null), functionName);
        helper.addEventListener(listener);
    }
}
...
function removeSuccessfulLogOutHandler(functionName) {
    if (parentWindow != null) {
        ...
        helper.removeEventListener(listener);
        listener.removeFunctionName(uiEventType.getField("SUCCESSFUL_LOGOUT").getObject(null), functionName);
        helper.addEventListener(listener);
    }
}
...
function addShowActiveGamesClickHandler(functionName) {
    if (parentWindow != null) {
        ...
        helper.removeEventListener(listener);
        listener.addFunctionName(uiEventType.getField("SHOW_ACTIVE_GAMES_CLICK").getObject(null), functionName);
        helper.addEventListener(listener);
    }
}
...
function removeShowActiveGamesClickHandler(functionName) {
    if (parentWindow != null) {
        ...
        helper.removeEventListener(listener);
        listener.removeFunctionName(uiEventType.getField("SHOW_ACTIVE_GAMES_CLICK").getObject(null), functionName);
        helper.addEventListener(listener);
    }
}
...
function addShowMyGamesClickHandler(functionName) {
    if (parentWindow != null) {
        ...
        helper.removeEventListener(listener);
        listener.addFunctionName(uiEventType.getField("SHOW_MY_GAMES_CLICK").getObject(null), functionName);
        helper.addEventListener(listener);
    }
}
...
function removeShowMyGamesClickHandler(functionName) {
    if (parentWindow != null) {
        ...
        helper.removeEventListener(listener);
        listener.removeFunctionName(uiEventType.getField("SHOW_MY_GAMES_CLICK").getObject(null), functionName);
        helper.addEventListener(listener);
    }
}
...
function addShowUnlockedDomainsClickHandler(functionName) {
    if (parentWindow != null) {
        ...
        helper.removeEventListener(listener);
        listener.addFunctionName(uiEventType.getField("SHOW_UNLOCKED_DOMAINS_CLICK").getObject(null), functionName);
        helper.addEventListener(listener);
    }
}
...
function removeShowUnlockedDomainsClickHandler(functionName) {
    if (parentWindow != null) {
        ...
        helper.removeEventListener(listener);
        listener.removeFunctionName(uiEventType.getField("SHOW_UNLOCKED_DOMAINS_CLICK").getObject(null), functionName);
        helper.addEventListener(listener);
    }
}
...
function addShowUpcomingGamesClickHandler(functionName) {
    if (parentWindow != null) {
        ...
        helper.removeEventListener(listener);
        listener.addFunctionName(uiEventType.getField("SHOW_UPCOMING_GAMES_CLICK").getObject(null), functionName);
        helper.addEventListener(listener);
    }
}
...
function removeShowUpcomingGamesClickHandler(functionName) {
    if (parentWindow != null) {
        ...
        helper.removeEventListener(listener);
        listener.removeFunctionName(uiEventType.getField("SHOW_UPCOMING_GAMES_CLICK").getObject(null), functionName);
        helper.addEventListener(listener);
    }
}
...
function addShowLeadersClickHandler(functionName) {
    if (parentWindow != null) {
        ...
        helper.removeEventListener(listener);
        listener.addFunctionName(uiEventType.getField("SHOW_LEADERS_CLICK").getObject(null), functionName);
        helper.addEventListener(listener);
    }
}
...
function removeShowLeadersClickHandler(functionName) {
    if (parentWindow != null) {
        ...
        helper.removeEventListener(listener);
        listener.removeFunctionName(uiEventType.getField("SHOW_LEADERS_CLICK").getObject(null), functionName);
        helper.addEventListener(listener);
    }
}
...
function addShowLatestClueClickHandler(functionName) {
    if (parentWindow != null) {
        ...
        helper.removeEventListener(listener);
        listener.addFunctionName(uiEventType.getField("SHOW_LATEST_CLUE_CLICK").getObject(null), functionName);
        helper.addEventListener(listener);
    }
}
...
function removeShowLatestClueClickHandler(functionName) {
    if (parentWindow != null) {
        ...
        helper.removeEventListener(listener);
        listener.removeFunctionName(uiEventType.getField("SHOW_LATEST_CLUE_CLICK").getObject(null), functionName);
        helper.addEventListener(listener);
    }
}
...
function addPageChangedHandler(functionName) {
    if (parentWindow != null) {
        ...
        helper.removeEventListener(listener);
        listener.addFunctionName(uiEventType.getField("PAGE_CHANGED").getObject(null), functionName);
        helper.addEventListener(listener);
    }
}
...
function removePageChangedHandler(functionName) {
    if (parentWindow != null) {
        ...
        helper.removeEventListener(listener);
        listener.removeFunctionName(uiEventType.getField("PAGE_CHANGED").getObject(null), functionName);
        helper.addEventListener(listener);
    }
}
...
function addWorkingGameIDUpdateHandler(functionName) {
    if (parentWindow != null) {
        ...
        helper.removeEventListener(listener);
        listener.addFunctionName(uiEventType.getField("WORKING_GAME_ID_UPDATE").getObject(null), functionName);
        helper.addEventListener(listener);
    }
}
...
function removeWorkingGameIDUpdateHandler(functionName) {
    if (parentWindow != null) {
        ...
        helper.removeEventListener(listener);
        listener.removeFunctionName(uiEventType.getField("WORKING_GAME_ID_UPDATE").getObject(null), functionName);
        helper.addEventListener(listener);
    }
}
