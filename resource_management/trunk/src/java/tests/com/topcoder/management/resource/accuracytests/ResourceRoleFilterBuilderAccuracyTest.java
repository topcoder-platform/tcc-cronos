 ...
 * <code>ResourceRoleFilterBuilder</code> class. It tests the createNameFilter(String),
 * createNoPhaseTypeFilter(), createPhaseTypeIdFilter(long), and createResourceRoleIdFilter(long)
 * methods.
 * </p>
 *
 * @author still
...
public class ResourceRoleFilterBuilderAccuracyTest extends TestCase {
    ...
    /**
     * <p>
     * Accuracy test of the <code>createNoPhaseTypeFilter()</code> method.
     * </p>
     */
    public void testMethod_createNoPhaseTypeFilter() {
        assertNull("This method not supported in the current version.",
            ResourceRoleFilterBuilder.createNoPhaseTypeFilter());
    }
    ...
    public void testMethod_createPhaseTypeIdFilter() {
        ...
        // check the type here.
        assertTrue("The 'PhaseTypeIdFilter' should extend EqualToFilter.",
        ...
        // check the filter's value here.
        assertEquals("The value of filter is incorrect.", phaseTypeId,
