 ...
 * <code>ResourcePersistence</code> interface. It is used to persist the database structure given
 * in the resource_management.sql script. Here it is a mock class of
 * <code>SqlResourcePersistence</code>. It only used for accuracy testing.
 * </p>
 *
 * @author still
 * @version 1.0
...
public class MockSqlResourcePersistence implements ResourcePersistence {
    /**
     * <p>
     * The name of the database connection producer from the DBConnectionFactory.
     * </p>
     */
    ...
    /**
     * <p>
     * Creates a new <code>MockSqlResourcePersistence</code> instance with given
     * <code>DBConnectionFactory</code> instance.
     * </p>
     *
     * @param connectionFactory The connection factory for getting database connection.
     */
     ...
     * <p>
     * Creates a new <code>MockSqlResourcePersistence</code> instance with given
     * <code>DBConnectionFactory</code> instance and connection name.
     * </p>
     *
     * @param connectionFactory The connection factory for getting database connection.
    ...
    /**
     * <p>
     * Adds the given Resource to the persistence. The resource must not already exist (by id) in
    ...
    public void addResource(Resource resource) {
        ...
        String query = "INSERT INTO resource"
            + "(resource_id, resource_role_id, project_id, phase_id, create_user,"
    ...
    /**
     * <p>
     * Deletes the given Resource in the persistence store with its id. The Resource must already
     * be present in the persistence store, otherwise nothing is done.
     * </p>
     *
    ...
    /**
     * <p>
     * Updates the given Resource in the persistence store with its currently set information. The
     * Resource must already be present in the persistence store.
     * </p>
     *
    ...
    /**
     * <p>
     * Loads the resource from the persistence with the given id. Here it simply return a new
     * <code>Resource</code> instance here.
     * </p>
     *
    ...
    public Resource loadResource(long resourceId) {
        ...
        Connection conn = getConnection();
        ResultSet rs = null;
        String query = "SELECT resource_id, resource_role_id, project_id, phase_id,"
     ...
     * (user, project, and notificationType) should already exists in the persistence store,
    ...
    /**
     * <p>
     * Load the Notification for the given "id" triple from the persistence store. Returns null if
     * no entry in the persistence has the given user, project, and notificationType.
     * </p>
     *
    ...
    /**
     * <p>
     * Adds a notification type to the persistence store. The id of the notification type must
     * already be assigned to the NotificationType object passed to this method, and not already
    ...
    /**
     * <p>
     * Removes a notification type from the persistence (by id) store. If no notification type
     * exists with the id of the notification type, nothing is done.
     * </p>
     *
    ...
    public void updateNotificationType(NotificationType notificationType) {
        ...
        Connection conn = getConnection();
        String query =
            "UPDATE notification_type_lu SET name = ?, description = ?, modify_user = ?, modify_date = ? "
    ...
    /**
     * <p>
     * Loads the notification type from the persistence with the given id. Returns null if there is
     * no notification type with the given id.
     * </p>
     *
    ...
    /**
     * <p>
     * Removes a resource role from the persistence store. If no resource role exists with the
     * given id, nothing is done.
     * </p>
     *
    ...
    /**
     * <p>
     * Updates the resource role in the persistence store. The resource role (by id) must exist in
     * the persistence store.
     * </p>
     *
    ...
    /**
     * <p>
     * Loads the resource role from the persistence with the given id. Returns null if there is no
    ...
    /**
     * <p>
     * Loads the resources from the persistence with the given ids. May return a zero-length array.
     * This method is designed to keep the amount of SQL queries to a minimum when searching
     * resources.
     * </p>
     *
    ...
    /**
     * <p>
     * loadNotificationTypes: Loads the notification types from the persistence with the given ids.
    ...
    /**
     * <p>
     * loadResourceRoles: Loads the resource roles from the persistence with the given ids. May
    ...
    /**
     * <p>
     * Load the Notifications for the given "id" triples from the persistence store. May return a
     * 0-length array
     * </p>
     *
    ...
    public Notification[] loadNotifications(long[] userIds, long[] projectId,
        ...
        for (int i = 0; i < userIds.length; i++) {
            Notification notification = loadNotification(userIds[i], projectId[i],
                    notificationTypes[i]);
    ...
    /**
     * This method to convert a <code>java.util.Date</code> instance to <code>Timestamp</code>
     * instance.
     *
