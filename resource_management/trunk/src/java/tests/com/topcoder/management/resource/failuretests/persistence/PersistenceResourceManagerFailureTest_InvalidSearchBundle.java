...
public class PersistenceResourceManagerFailureTest_InvalidSearchBundle extends PersistenceResourceManagerBaseFailureTestCase {
     ...
     */
    private static final String DB_CONNECTION_CONFIG = "test_files/ConnectionFactory.xml";

    /**
     * The config file path for the SearchBundleManager.
     */
    private static final String SEARCH_BUNDLE_MANAGER_CONFIG =
        "test_files/failure/SearchBundleManager_InvalidSearchBundle.xml";
    ...
    public void setUp() throws Exception {
        ...
        executeSQL("test_files/failure/prepare.sql");
    }
    ...
    public void tearDown() throws Exception {
        executeSQL("test_files/failure/clear.sql");
        super.tearDown();
    }
    ...
    protected void loadConfigurations() throws Exception {
        ...
        cm.add(new File(DB_CONNECTION_CONFIG).getAbsolutePath());
        cm.add(new File(SEARCH_BUNDLE_MANAGER_CONFIG).getAbsolutePath());
    }
