 ...
 * createExtensionPropertyNameFilter(String), createExtensionPropertyValueFilter(String),
 * createNoPhaseFilter(), createNoProjectFilter(), createNoSubmissionFilter(),
 * createPhaseIdFilter(long), createProjectIdFilter(long), createResourceRoleIdFilter(long),
 * createResourceRoleIdFilter(long) and createSubmissionIdFilter(long) methods.
 * </p>
 *
 * @author still
 * @version 1.0
...
public class ResourceFilterBuilderAccuracyTest extends TestCase {
    ...
    /**
     * <p>
     * Accuracy test of the <code>createExtensionPropertyNameFilter(String)</code> method.
     * </p>
     */
    ...
    public void testMethod_createExtensionPropertyValueFilter() {
        ...
        // check the filter's value here.
        assertEquals("The value of filter is incorrect.", value,
            ((String) ((EqualToFilter) filter).getValue()));
    }

    /**
     * <p>
     * Accuracy test of the <code>createNoPhaseFilter()</code> method.
     * </p>
     */
    public void testMethod_createNoPhaseFilter() {
        assertNull("This method not supported in the current version.",
            ResourceFilterBuilder.createNoPhaseFilter());
    }

    /**
     * <p>
     * Accuracy test of the <code>createNoProjectFilter()</code> method.
     * </p>
     */
    public void testMethod_createNoProjectFilter() {
        assertNull("This method not supported in the current version.",
            ResourceFilterBuilder.createNoProjectFilter());
    }

    /**
     * <p>
     * Accuracy test of the <code>createNoSubmissionFilter()</code> method.
     * </p>
     */
    public void testMethod_createNoSubmissionFilter() {
        assertNull("This method not supported in the current version.",
            ResourceFilterBuilder.createNoSubmissionFilter());
    }
    ...
    public void testMethod_createPhaseIdFilter() {
        ...
        // check the filter's value here.
        assertEquals("The value of filter is incorrect.", phaseId,
    ...
    /**
     * <p>
     * Accuracy test of the <code>createResourceRoleIdFilter(long)</code> method.
     * </p>
     */
    ...
    /**
     * <p>
     * Accuracy test of the static field of <code>NotificationFilterBuilder</code> class.
     * </p>
     */
    public void testStaticField() {
        ...
        assertEquals("The 'EXTENSION_PROPERTY_VALUE_FIELD_NAME' field is incorrect.", "value",
            ResourceFilterBuilder.EXTENSION_PROPERTY_VALUE_FIELD_NAME);
        assertEquals("The 'PHASE_ID_FIELD_NAME' field is incorrect.", "phase_id",
