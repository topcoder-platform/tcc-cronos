 ...
 * <code>NotificationTypeFilterBuilder</code> class. It tests the createNameFilter(String) and
 * createNotificationTypeIdFilter(long) methods.
 * </p>
 *
 * @author still
 * @version 1.0
...
public class NotificationTypeFilterBuilderAccuracyTest extends TestCase {
     ...
     * </p>
     *
     * @return Test suite of <code>NotificationTypeFilterBuilderAccuracyTest</code>.
     */
    ...
    public void testMethod_createNotificationTypeIdFilter() {
        ...
        // check the type here.
        assertTrue("The 'TypeIdFilter' should extend EqualToFilter.",
        ...
        // check the filter's value here.
        assertEquals("The value of filter is incorrect.", 1,
    ...
    public void testStaticField() {
        ...
        assertEquals("The 'NOTIFICATION_TYPE_ID_FIELD_NAME' field is incorrect.",
            "notification_type_id", NotificationTypeFilterBuilder.NOTIFICATION_TYPE_ID_FIELD_NAME);
    }
}
