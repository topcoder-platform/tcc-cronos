...
public class ResourceRoleFilterBuilder {
    ...
    public static Filter createNoPhaseTypeFilter() {
        // return a new "IsNullFilter" (future Search Builder addition, see forum) for PHASE_TYPE_ID_FIELD_NAME
        // but it is not supported in the current moment, please defter to the forum
        return null;
    }
}
