...
insert into phase (phase_id, project_id, phase_type_id) values(1,1,1);
insert into phase (phase_id, project_id, phase_type_id) values(2,2,2);
insert into phase (phase_id, project_id, phase_type_id) values(3,3,3);
insert into phase (phase_id, project_id, phase_type_id) values(4,4,4);
