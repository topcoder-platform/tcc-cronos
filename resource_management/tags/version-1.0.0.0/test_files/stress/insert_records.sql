...
INSERT INTO resource (resource_id, resource_role_id, project_id, phase_id, create_user, create_date, modify_user, modify_date) values(1, 1, NULL, NULL, 'admin', CURRENT, 'admin', CURRENT);
INSERT INTO resource (resource_id, resource_role_id, project_id, phase_id, create_user, create_date, modify_user, modify_date) values(2, 2, NULL, NULL, 'admin', CURRENT, 'admin', CURRENT);
INSERT INTO resource (resource_id, resource_role_id, project_id, phase_id, create_user, create_date, modify_user, modify_date) values(3, 3, NULL, NULL, 'admin', CURRENT, 'admin', CURRENT);
INSERT INTO resource (resource_id, resource_role_id, project_id, phase_id, create_user, create_date, modify_user, modify_date) values(4, 4, NULL, NULL, 'admin', CURRENT, 'admin', CURRENT);
INSERT INTO resource (resource_id, resource_role_id, project_id, phase_id, create_user, create_date, modify_user, modify_date) values(5, 5, NULL, NULL, 'admin', CURRENT, 'admin', CURRENT);
