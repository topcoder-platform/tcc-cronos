 ...
 * ResourcePersistenceException(String) and ResourcePersistenceException(String, Exception)
 * constructors.
 * </p>
 *
 * @author still
...
public class ResourcePersistenceExceptionAccuracyTest extends TestCase {
     ...
     * </p>
     *
     * @return Test suite of <code>ResourcePersistenceExceptionAccuracyTest</code>.
     */
    ...
    /**
     * <p>
     * Basic test of <code>ResourcePersistenceException(String)</code> constructor.
     * </p>
     */
    public void testResourcePersistenceExceptionCtor1_Basic() {
        // check null here.
        assertNotNull("Create ResourcePersistenceException failed.",
            new ResourcePersistenceException(TEST_MESSAGE));
    }

    /**
     * <p>
     * Detail test of <code>ResourcePersistenceException(String)</code> constructor. Creates a
    ...
    public void testResourcePersistenceExceptionCtor1_Detail() {
        ...
        assertTrue("ResourcePersistenceException should extend BaseException.",
    ...
    /**
     * <p>
     * Basic test of <code>ResourcePersistenceException(String, Exception)</code> constructor.
     * </p>
     */
    public void testResourcePersistenceExceptionCtor2_Basic() {
        // check null here.
        assertNotNull("Create ResourcePersistenceException failed.",
            new ResourcePersistenceException(TEST_MESSAGE, new Exception()));
    }

    /**
     * <p>
     * Test of <code>ResourcePersistenceException(String, Exception)</code> constructor. Creates a
     * instance and get its attributes for test.
     * </p>
     */
