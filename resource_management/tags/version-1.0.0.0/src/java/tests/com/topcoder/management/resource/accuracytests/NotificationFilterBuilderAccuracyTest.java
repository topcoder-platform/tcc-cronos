 ...
 * <code>NotificationFilterBuilder</code> class. It tests the createExternalRefIdFilter(long),
 * createNotificationTypeIdFilter(long) and createProjectIdFilter(long) methods.
 * </p>
 *
 * @author still
 * @version 1.0
...
public class NotificationFilterBuilderAccuracyTest extends TestCase {
    ...
    /**
     * <p>
     * Accuracy test of the <code>createExternalRefIdFilter(long)</code> method.
     * </p>
     */
    public void testMethod_createExternalRefIdFilter() {
        ...
        // check the type here.
        assertTrue("The 'ExternalRefIdFilter' should extend EqualToFilter.",
        ...
        assertEquals("The value of filter is incorrect.", id,
            ((Long) ((EqualToFilter) filter).getValue()).longValue());
    }

    /**
     * <p>
     * Accuracy test of the <code>createNotificationTypeIdFilter(long)</code> method.
     * </p>
     */
    ...
    public void testStaticField() {
        ...
        assertEquals("The 'NOTIFICATION_TYPE_ID_FIELD_NAME' field is incorrect.",
            "notification_type_id", NotificationFilterBuilder.NOTIFICATION_TYPE_ID_FIELD_NAME);
