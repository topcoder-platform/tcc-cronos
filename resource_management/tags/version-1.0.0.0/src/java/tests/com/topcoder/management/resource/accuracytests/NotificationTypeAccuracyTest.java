...
/**
 * <p>
 * This accuracy tests addresses the functionality provided by the <code>NotificationType</code>
 * class. It tests the NotificationType(), NotificationType(long) and NotificationType(long,
 * String) constructors; getDescription(), getId(), getName(), setDescription(String), setId(long)
 * and setName(String) methods.
 * </p>
 *
 * @author still
 * @version 1.0
...
public class NotificationTypeAccuracyTest extends TestCase {
    ...
    /**
     * <p>
     * Accuracy test of <code>NotificationType(long, String)</code> constructor.
     * </p>
     */
    ...
    public void testMethod_getDescription() {
        ...
        assertEquals("The type description should be: " + description + ".", description,
            type.getDescription());
    }
