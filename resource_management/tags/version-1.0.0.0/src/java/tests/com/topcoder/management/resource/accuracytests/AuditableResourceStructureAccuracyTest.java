 ...
 * <code>AuditableResourceStructure</code> class. It tests the AuditableResourceStructure()
 * constructor; getCreationTimestamp(), getCreationUser(), getModificationTimestamp(),
 * getModificationUser(), setCreationTimestamp(Date), setCreationUser(String),
...
public class AuditableResourceStructureAccuracyTest extends TestCase {
    ...
    public void testAuditableResourceStructureCtor() {
        ...
        // check the type here.
        assertTrue("AuditableResourceStructure should extend Serializable.",
    ...
    public void testMethod_getCreationTimestamp() {
        ...
        assertEquals("This creation timestamp is incorrect.", creationTime.getTime(),
            test.getCreationTimestamp().getTime());

        // test with a new time.
        creationTime = new Date(1234567890L);
        test.setCreationTimestamp(creationTime);

        assertEquals("The creation timestamp is incorrect.", creationTime.getTime(),
            test.getCreationTimestamp().getTime());
    ...
    public void testMethod_getModificationTimestamp() {
        ...
        assertEquals("This modification timestamp is incorrect.", modificationTime.getTime(),
            test.getModificationTimestamp().getTime());

        // test with a new time.
        modificationTime = new Date(1234567890L);
        test.setModificationTimestamp(modificationTime);

        assertEquals("The modification timestamp is incorrect.", modificationTime.getTime(),
            test.getModificationTimestamp().getTime());
    ...
    /**
     * <p>
     * Accuracy test of the <code>setModificationTimestamp(Date)</code> method.
     * </p>
     */
    ...
    public void testMethod_getModificationUser() {
        ...
        assertEquals("This modification user is incorrect.", modificationUser,
            test.getModificationUser());
