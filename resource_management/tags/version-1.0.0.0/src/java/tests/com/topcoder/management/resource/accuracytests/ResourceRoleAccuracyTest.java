...
/**
 * <p>
 * This accuracy tests addresses the functionality provided by the <code>ResourceRole</code> class.
 * It tests the ResourceRole(), ResourceRole(long) and ResourceRole(long, String, long)
 * constructors; getDescription(), getId(), getName(), getPhaseType(), setDescription(String),
...
public class ResourceRoleAccuracyTest extends TestCase {
    ...
    /**
     * <p>
     * Accuracy test of <code>ResourceRole(long, String, long)</code> constructor.
     * </p>
     */
    public void testResourceRoleCtor3() {
        ...
        assertNull("The role description should be: null.", role.getDescription());
        assertEquals("The phase type should be: " + phaseType + ".", phaseType,
            role.getPhaseType().longValue());
        assertEquals("The 'UNSET_ID' should be: -1.", -1, ResourceRole.UNSET_ID);
    }
    ...
    public void testMethod_getDescription() {
        ...
        assertEquals("The role description should be: " + description + ".", description,
            role.getDescription());
    }
