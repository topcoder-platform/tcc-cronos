...
/**
 * <p>
 * This accuracy tests addresses the functionality provided by the <code>Notification</code> class.
 * It tests the Notification(long, NotificationType, long) constructor; getExternalId(),
 * getNotificationType() and getProject() methods.
 * </p>
 *
 * @author still
 * @version 1.0
...
public class NotificationAccuracyTest extends TestCase {
    ...
    /**
     * <p>
     * Accuracy test of <code>Notification(long, NotificationType, long)</code> constructor.
     * </p>
     */
    public void testNotificationCtor() {
        ...
        assertEquals("The project id should be: " + project + ".", project,
            notification.getProject());
        assertEquals("The externalId should be: " + externalId + ".", externalId,
    ...
    public void testMethod_getNotificationType() {
        ...
        assertEquals("The type name should be NotificationType#1", "NotificationType#1",
