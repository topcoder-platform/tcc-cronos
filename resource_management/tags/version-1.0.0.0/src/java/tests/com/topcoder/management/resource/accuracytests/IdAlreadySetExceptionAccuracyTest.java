 ...
 * <code>IdAlreadySetException</code> class. It tests the IdAlreadySetException(String)
 * constructor.
 * </p>
 *
 * @author still
...
public class IdAlreadySetExceptionAccuracyTest extends TestCase {
    ...
    public void testIdAlreadySetExceptionCtor1_Basic() {
        // check null here.
        assertNotNull("Create IdAlreadySetException failed.",
            new IdAlreadySetException(TEST_MESSAGE));
    }

    /**
     * <p>
     * Detail test of <code>IdAlreadySetException(String)</code> constructor. Creates a instance
     * and get its attributes for test.
     * </p>
     */
