...
/**
 * Unit test cases for <code>{@link DataAccessException}</code> class.
 *
 * @author flytoj2ee
 * @version 1.0
 */
public class DataAccessExceptionTest extends TestCase {
    ...
    /** The DataAccessException instance for testing. */
    ...
    /**
     * Test the <code>{@link DataAccessException#DataAccessException(String)}</code> with success process.
     */
    ...
    /**
     * Test the <code>{@link DataAccessException#DataAccessException(String, Throwable)}</code> with success process.
     */
    public void testConstructor_StringThrowable_Success() {
        exception = new DataAccessException(message, cause);
        assertNotNull("Unable to create the instance.", exception);
