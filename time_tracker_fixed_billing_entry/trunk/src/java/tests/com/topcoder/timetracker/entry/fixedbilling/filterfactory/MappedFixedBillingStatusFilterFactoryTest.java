...
/**
 * Unit test cases for <code>{@link MappedFixedBillingStatusFilterFactory}</code> class.
 *
 * @author flytoj2ee
 * @version 1.0
 */
public class MappedFixedBillingStatusFilterFactoryTest extends TestCase {
    ...
    /** The MappedFixedBillingStatusFilterFactory instance for testing. */
    private MappedFixedBillingStatusFilterFactory filterFactory;
    ...
    public void setUp() {
        ...
        filterFactory = new MappedFixedBillingStatusFilterFactory();
    }

    /**
     * Test the <code>{@link MappedFixedBillingStatusFilterFactory#MappedFixedBillingStatusFilterFactory()}</code>
    ...
    /**
     * Test the <code>{@link MappedFixedBillingStatusFilterFactory#createDescriptionFilter(String,
    ...
    /**
     * Test the <code>{@link MappedFixedBillingStatusFilterFactory#createCreationDateFilter(Date, Date)}</code> with
    ...
    /**
     * Test the <code>{@link MappedFixedBillingStatusFilterFactory#createModificationDateFilter(Date, Date)}</code>
     * with wrong date values. Should throw an IllegalArgumentException here.
     */
    ...
    /**
     * Test the <code>{@link MappedFixedBillingStatusFilterFactory#createModificationDateFilter(Date, Date)}</code>
     * with invalid date ranges. Should throw an IllegalArgumentException here.
     */
    ...
    /**
     * Test the <code>{@link MappedFixedBillingStatusFilterFactory#createCreationUserFilter(String,
    ...
    /**
     * Test the <code>{@link MappedFixedBillingStatusFilterFactory#createModificationUserFilter(String,
     * StringMatchType)}</code> with null user name. Should throw an IllegalArgumentException here.
     */
    ...
    /**
     * Test the <code>{@link MappedFixedBillingStatusFilterFactory#getColumnNames()}</code> with success process.
     */
