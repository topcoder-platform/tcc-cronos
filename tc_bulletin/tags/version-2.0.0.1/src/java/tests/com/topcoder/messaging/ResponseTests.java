...
/**
 * The unit test for the class {@link Response}.
 * @author yqw
 * @version 2.0
 */
public class ResponseTests extends TestCase {
    ...
    /**
     * The accuracy test for the default constructor {@link Response#Response()}.
     */
     ...
     * {@link Response#Response(String name, Date date, String message)}.
     */
    ...
    /**
     * The accuracy test for the constructor
     * {@link Response#Response(long id, String name, Date date, String message)}.
     */
    ...
    public void testCtor2_id_Negative() {
        try {
            instance = new Response(-2L, "name", date, "mesage");
            fail("IllegalArgumentException should be thrown.");
        } catch (IllegalArgumentException e) {
            // expected
        }
