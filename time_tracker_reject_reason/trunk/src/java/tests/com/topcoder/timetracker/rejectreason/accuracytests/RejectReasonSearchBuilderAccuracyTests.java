...
/**
 * <p>
 * Accuracy tests for <code>RejectReasonSearchBuilder</code>.
 * </p>
 *
 * @author kzhu
 * @version 3.2
 */
public class RejectReasonSearchBuilderAccuracyTests extends TestCase {
    ...
    public void testandFilterAccuracy() throws Exception {
        Filter[] filters = {
                builder.createdByUserFilter("foo"), builder.hasActiveStatusFilter(1), builder.hasActiveStatusFilter(1)
        };
    ...
    public void testnotFilterAccuracy() throws Exception {
        assertNotNull("The not filter should be return.", builder.not(builder.hasActiveStatusFilter(1)));
    }
    ...
    public void testhasCompanyIdFilterAccuracy() throws Exception {
        ...
        assertEquals("The filter should have the right name.", RejectReasonDAO.SEARCH_COMPANY_ID, filter.getName());
    }
    ...
    public void testhasDescriptionAccuracy() throws Exception {
        ...
        assertEquals("The filter should have the right name.", RejectReasonDAO.SEARCH_DESCRIPTION, filter.getName());
    }

    /**
     * <p>
     * Accuracy test for method <code>hasActiveStatus</code>.
     * </p>
     *
     * @throws Exception Exception to JUnit.
     */
    public void testhasActiveStatusFilterAccuracy() throws Exception {
        EqualToFilter filter = (EqualToFilter) builder.hasActiveStatusFilter(1);

        assertEquals("The filter should have the right name.", RejectReasonDAO.SEARCH_ACTIVE_STATUS, filter.getName());
    }
    ...
    public void testcreatedWithInDateRangeFilterAccuracy1()
        ...
        assertEquals("The filter should have the right name.", RejectReasonDAO.SEARCH_CREATED_DATE, filter.getName());
    ...
    public void testcreatedByUserFilterAccuracy() throws Exception {
        ...
        assertEquals("The filter should have the right name.", RejectReasonDAO.SEARCH_CREATED_USER, filter.getName());
    }
    ...
    public void testmodifiedWithInDateRangeFilterAccuracy1()
        ...
        assertEquals("The filter should have the right name.", RejectReasonDAO.SEARCH_MODIFICATION_DATE,
            filter.getName());
        assertTrue("The lower bound should be inclusive.", filter.isLowerInclusive());
        assertTrue("The upper bound should be inclusive.", filter.isUpperInclusive());
    ...
    public void testmodifiedByUserFilterAccuracy() throws Exception {
        ...
        assertEquals("The filter should have the right name.", RejectReasonDAO.SEARCH_MODIFICATION_USER,
            filter.getName());
    }
}
