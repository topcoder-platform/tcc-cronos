...
public class DbRejectReasonDAOAccuracyTests extends TestHelper {
    ...
    public void testConstantField_searchModificationDate() {
        assertEquals("The constant field SEARCH_MODIFICATION_DATE is not set correctly.", "search_modification_date",
            DbRejectReasonDAO.SEARCH_MODIFICATION_DATE);
    }
    ...
    public void testConstantField_searchModificationUser() {
        assertEquals("The constant field SEARCH_MODIFICATION_USER is not set correctly.", "search_modification_user",
            DbRejectReasonDAO.SEARCH_MODIFICATION_USER);
    }
     ...
     * @throws Exception pass to JUnit.
     */
    public void testCreateRejectReason_accuracy_noAudit()
        throws Exception {
        ...
        try {
            ...
            assertEquals("The description is not set correctly.", "description", rejectReason.getDescription());
            ...
            assertEquals("The modification user is not set correctly.", "lever", rejectReason.getModificationUser());
     ...
     * @throws Exception pass to JUnit.
     */
    public void testCreateRejectReason_accuracy_withAudit()
        throws Exception {
        // Create a RejectReason to persist
        RejectReason rejectReason = new RejectReason();
        rejectReason.setCompanyId(3);
    ...
    public void testCreateRejectReason_audit() throws Exception {
        ...
        try {
            ...
            assertEquals("The company id is not audited correctly.", rejectReason.getCompanyId(),
            ...
            assertEquals("The creation date is not set correctly.", rejectReason.getCreationDate(),
     ...
     * @throws Exception pass to JUnit.
     */
    public void testRetrieveRejectReason_notPersisted()
        throws Exception {
    ...
    public void testRetrieveRejectReason_accuracy() throws Exception {
        ...
        try {
            ...
            assertEquals("The company id is not correct.", rejectReason.getCompanyId(), rejectReason2.getCompanyId());
            assertEquals("The description is not correct.", rejectReason.getDescription(),
                rejectReason2.getDescription());
            assertEquals("The active status is not correct.", rejectReason.getActive(), rejectReason2.getActive());
            ...
            assertEquals("The creation user is not correct.", rejectReason.getCreationUser(),
                rejectReason2.getCreationUser());
            assertEquals("The modification date is not correct.", FORMAT.format(rejectReason.getModificationDate()),
                FORMAT.format(rejectReason2.getModificationDate()));
     ...
     * @throws Exception pass to JUnit.
     */
    public void testUpdateRejectReason_accuracy_noAudit()
        throws Exception {
        // Create a RejectReason to persist
        RejectReason rejectReason = new RejectReason();
        rejectReason.setCompanyId(3);
        ...
        try {
            ...
            assertEquals("The id is not correct.", rejectReason.getId(), rejectReason2.getId());
            assertEquals("The company id is not correct.", rejectReason.getCompanyId(), rejectReason2.getCompanyId());
            assertEquals("The description is not updated correctly.", "another description",
                rejectReason2.getDescription());
            ...
            assertTrue("The modification date is not correct.",
                rejectReason2.getModificationDate().compareTo(rejectReason2.getCreationDate()) >= 0);
            assertEquals("The modification user is not updated correctly.", "momo",
                rejectReason2.getModificationUser());
            assertEquals("No audit should be done.", 0, audit.getAuditHeader().size());
        } finally {
            dao.deleteRejectReason(rejectReason, "user", false);
     ...
     * @throws Exception pass to JUnit.
     */
    public void testUpdateRejectReason_accuracy_withAudit()
        throws Exception {
        // Create a RejectReason to persist
        RejectReason rejectReason = new RejectReason();
        rejectReason.setCompanyId(3);
    ...
    public void testUpdateRejectReason_audit() throws Exception {
        ...
        try {
            ...
            assertEquals("The entity id is not audited correctly.", rejectReason.getId(), header.getEntityId());
            assertEquals("The company id is not audited correctly.", rejectReason.getCompanyId(),
                header.getCompanyId());
            assertEquals("The application area is not audited correctly.", DbRejectReasonDAO.APPLICATION_AREA,
     ...
     * @throws Exception pass to JUnit.
     */
    public void testDeleteRejectReason_accuracy_noAudit()
        throws Exception {
        // Create a RejectReason to persist
        RejectReason rejectReason = new RejectReason();
        rejectReason.setCompanyId(3);
        ...
        assertNull("The reject reason should have been deleted.", dao.retrieveRejectReason(rejectReason.getId()));
    }
    ...
    public void testDeleteRejectReason_audit() throws Exception {
        ...
        assertEquals("The entity id is not audited correctly.", rejectReason.getId(), header1.getEntityId());
        assertEquals("The company id is not audited correctly.", rejectReason.getCompanyId(), header1.getCompanyId());
        assertEquals("The creation date is not set correctly.", FORMAT.format(rejectReason.getCreationDate()),
        ...
        assertEquals("The entity id is not audited correctly.", rejectReason.getId(), header2.getEntityId());
        assertEquals("The company id is not audited correctly.", rejectReason.getCompanyId(), header2.getCompanyId());
        assertEquals("The application area is not audited correctly.", DbRejectReasonDAO.APPLICATION_AREA,
            header2.getApplicationArea());
        assertEquals("The creation date is not set correctly.", FORMAT.format(rejectReason.getCreationDate()),
    ...
    public void testListRejectReasons_accuracy() throws Exception {
        ...
        try {
            ...
            assertEquals("The description is not correct.", reason1.getDescription(), reasons[0].getDescription());
            ...
            assertEquals("The creation user is not correct.", reason1.getCreationUser(), reasons[0].getCreationUser());
            assertEquals("The modification date is not correct.", FORMAT.format(reason1.getModificationDate()),
                FORMAT.format(reasons[0].getModificationDate()));
            assertEquals("The modification user is not correct.", reason1.getModificationUser(),
                reasons[0].getModificationUser());
     ...
     * @throws Exception pass to JUnit.
     */
    public void testSearchRejectReasons_notPersisted()
        throws Exception {
     ...
     * @throws Exception pass to JUnit.
     */
    public void testSearchRejectReasons_byDescription()
        throws Exception {
        // Create two RejectReasonsto persist
        RejectReason reason1 = new RejectReason();
        reason1.setCompanyId(1);
     ...
     * @throws Exception pass to JUnit.
     */
    public void testSearchRejectReasons_byActiveStatus()
        throws Exception {
        // Create two RejectReasonsto persist
        RejectReason reason1 = new RejectReason();
        reason1.setCompanyId(1);
     ...
     * @throws Exception pass to JUnit.
     */
    public void testSearchRejectReasons_byCreationUser()
        throws Exception {
        // Create two RejectReasonsto persist
        RejectReason reason1 = new RejectReason();
        reason1.setCompanyId(1);
     ...
     * @throws Exception pass to JUnit.
     */
    public void testSearchRejectReasons_byModificationUser()
        throws Exception {
        // Create two RejectReasonsto persist
        RejectReason reason1 = new RejectReason();
        reason1.setCompanyId(1);
     ...
     * @throws Exception pass to JUnit.
     */
    public void testSearchRejectReasons_byCreationDate()
        throws Exception {
        // Create two RejectReasonsto persist
        RejectReason reason1 = new RejectReason();
        reason1.setCompanyId(1);
        ...
        try {
            ...
            Filter filter = new RejectReasonSearchBuilder().createdWithinDateRangeFilter(new Date(now.getTime()
     ...
     * @throws Exception pass to JUnit.
     */
    public void testSearchRejectReasons_byModificationDate()
        throws Exception {
        // Create two RejectReasonsto persist
        RejectReason reason1 = new RejectReason();
        reason1.setCompanyId(1);
        ...
        try {
            ...
            Date now = new Date(new java.util.Date().getTime());
            Filter filter = new RejectReasonSearchBuilder().modifiedWithinDateRangeFilter(new Date(now.getTime()
                - 1000000), new Date(now.getTime() + 1000000));
            RejectReason[] reasons = dao.searchRejectReasons(filter);
            assertEquals("The number of RejectReasons returned is not correct.", 2, reasons.length);
        } finally {
