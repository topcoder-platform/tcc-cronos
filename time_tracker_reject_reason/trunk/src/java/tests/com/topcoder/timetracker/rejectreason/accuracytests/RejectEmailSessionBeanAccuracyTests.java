...
/**
 * <p>
 * Accuracy tests for <code>RejectEmailSessionBean</code>.
 * </p>
 *
 * @author kzhu
 * @version 3.2
 */
public class RejectEmailSessionBeanAccuracyTests extends TestCase {
    ...
    public void testcreateRejectEmailAccuracy1() throws Exception {
        ...
        email = bean.createRejectEmail(email, "user", false);

        RejectEmail retrieved = bean.retrieveRejectEmail(email.getId());
    ...
    public void testcreateRejectEmailAccuracy2() throws Exception {
        RejectEmail email = AccuracyTestHelper.createRejectEmail(1, 1);
        email = bean.createRejectEmail(email, "user", true);
    ...
    public void testretrieveRejectEmailAccuracy1() throws Exception {
        ...
        email = bean.createRejectEmail(email, "user", false);
        bean.createRejectEmail(AccuracyTestHelper.createRejectEmail(2, 2), "user", false);
    ...
    public void testretrieveRejectEmailAccuracy2() throws Exception {
        assertNull("Null should be return.", bean.retrieveRejectEmail(1));
    }
    ...
    public void testupdateRejectEmailAccuracy1() throws Exception {
        RejectEmail email = AccuracyTestHelper.createRejectEmail(1, 1);
        email = bean.createRejectEmail(email, "user1", false);

        // Update and retrieve
        email.setBody("new message body");
        bean.updateRejectEmail(email, "user2", false);

        RejectEmail email2 = bean.retrieveRejectEmail(email.getId());
    ...
    public void testupdateRejectEmailAccuracy2() throws Exception {
        ...
        // Update and retrieve
        email.setBody("new message body");
        bean.updateRejectEmail(email, "user2", true);
    ...
    public void testdeleteRejectEmailAccuracy1() throws Exception {
        ...
        assertNotNull("The email with the id exist.", bean.retrieveRejectEmail(email.getId()));

        bean.deleteRejectEmail(email, "user", false);

        assertNull("The email with the id should be deleted.", bean.retrieveRejectEmail(email.getId()));
    }
    ...
    public void testdeleteRejectEmailAccuracy2() throws Exception {
        ...
        bean.deleteRejectEmail(email, "user", true);
    ...
    public void testlistRejectEmailsAccuracy1() throws Exception {
        ...
        RejectEmail[] retrieved = bean.listRejectEmails();
    ...
    public void testlistRejectEmailsAccuracy2() throws Exception {
        bean.createRejectEmail(AccuracyTestHelper.createRejectEmail(1, 1), "user", false);
        bean.createRejectEmail(AccuracyTestHelper.createRejectEmail(2, 2), "user", false);
    ...
    public void testsearchRejectEmailsAccuracy1() throws Exception {
        RejectEmail email = bean.createRejectEmail(AccuracyTestHelper.createRejectEmail(1, 1), "user", false);
        bean.createRejectEmail(AccuracyTestHelper.createRejectEmail(2, 2), "user", false);

        RejectEmail[] retrieved = bean.searchRejectEmails((new RejectEmailSearchBuilder()).hasCompanyIdFilter(1));
    ...
    public void testsearchRejectEmailsAccuracy4() throws Exception {
        ...
        email1 = bean.createRejectEmail(email1, "user", false);
        email2 = bean.createRejectEmail(email2, "user", false);

        // Search RejectEmail with modification user 'user'
        Filter filter = new RejectEmailSearchBuilder().modifiedByUserFilter("user");
        RejectEmail[] emails = bean.searchRejectEmails(filter);
    ...
    public void testsearchRejectEmailsAccuracy6() throws Exception {
        ...
        email1 = bean.createRejectEmail(email1, "user1", false);
        email2 = bean.createRejectEmail(email2, "user2", false);
    ...
    public void testsearchRejectEmailsAccuracy() throws Exception {
        ...
        assertEquals("Empty array should be returned.", 0, bean.searchRejectEmails(filter).length);
    }
}
