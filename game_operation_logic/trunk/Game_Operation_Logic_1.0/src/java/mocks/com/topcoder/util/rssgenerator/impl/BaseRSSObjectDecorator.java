 ...
 * <p>Implementation: Simply call setObject(object).</p>
 * <p>Exceptions: IllegalArgumentException - If object is null.</p>
 * 
 * @poseidon-object-id [Im579fc457m10e1824c6ffmm6de9]
 * @param object 
 */
...
/**
 * <p>Purpose: This method returns the underlying object being decorated.</p>
 * <p>Args: None.</p>
 * <p>Implementation: Simply delegate the call to the underlying object.</p>
 * <p>Returns: The underlying object being decorated.</p>
 * <p>Exceptions: IllegalStateException - If the underlying object is null.</p>
 * 
 * @poseidon-object-id [Im579fc457m10e1824c6ffmm6b06]
 * @return 
 */
 ...
 * <p>Exceptions: None.</p>
 * 
 * @poseidon-object-id [Im579fc457m10e1824c6ffmm6aee]
 * @param object 
 */
 ...
 * <p>Args: None.</p>
 * <p>Implementation: Simply delegate to the underlying object.</p>
 * <p>Returns: The name of the element represented by this RSSObject.</p>
 * <p>Exceptions: IllegalStateException - If the underlying object is null.</p>
 * 
 * @poseidon-object-id [Im579fc457m10e1824c6ffmm6a9d]
 * @return 
 */
 ...
 * <p>Exceptions: IllegalStateException - If the underlying object is null.</p>
 * 
 * @poseidon-object-id [Im579fc457m10e1824c6ffmm6a78]
 * @return 
 */
 ...
 * 
 * @poseidon-object-id [Im579fc457m10e1824c6ffmm6a53]
 * @param name 
 * @return 
 */
 ...
 * <p>Exceptions: IllegalStateException - If the underlying object is null.</p>
 * 
 * @poseidon-object-id [Im579fc457m10e1824c6ffmm6a13]
 * @return 
 */
...
/**
 * <p>Purpose: This method returns the child element under the desired name. A null will be returned if none exists. If more than one child element exists under the same name, the first of these (as defined by the underlying implementation) will be returned.</p>
 ...
 * <p>IllegalStateException - If the underlying object is null.</p>
 * 
 * @poseidon-object-id [Im579fc457m10e1824c6ffmm69ee]
 * @param name 
 * @return 
 */
 ...
 * <p>IllegalStateException - If the underlying object is null.</p>
 * 
 * @poseidon-object-id [Im579fc457m10e1824c6ffmm69ae]
 * @param name 
 * @return 
 */
 ...
 * <p>Exceptions: IllegalStateException - If the underlying object is null.</p>
 * 
 * @poseidon-object-id [Im579fc457m10e1824c6ffmm696e]
 * @return 
 */
 ...
 * <p>Exceptions: IllegalStateException - If the underlying object is null.</p>
 * 
 * @poseidon-object-id [Im579fc457m10e1824c6ffmm6949]
 * @return 
 */
 ...
 * <p>IllegalStateException - If the underlying object is null.</p>
 * 
 * @poseidon-object-id [Im579fc457m10e1824c6ffmm6924]
 * @param name 
 */
 ...
 * <p>Exceptions: IllegalStateException - If the underlying object is null.</p>
 * 
 * @poseidon-object-id [Im579fc457m10e1824c6ffmm68e4]
 * @param text 
 */
 ...
 * <p>IllegalStateException - If the underlying object is null.</p>
 * 
 * @poseidon-object-id [Im579fc457m10e1824c6ffmm68a4]
 * @param name 
 * @param value 
 */
 ...
 * <p>Exceptions: IllegalStateException - If the underlying object is null.</p>
 * 
 * @poseidon-object-id [Im579fc457m10e1824c6ffmm683b]
 */
 ...
 * <p>IllegalStateException - If the underlying object is null.</p>
 * 
 * @poseidon-object-id [Im579fc457m10e1824c6ffmm6816]
 * @param name 
 * @param element 
 */
 ...
 * <p>Implementation: Simply delegate to the underlying object.</p>
 * <p>Returns: None.</p>
 * <p>Exceptions: IllegalArgumentException - If the name is null or empty, or if elements contains a null element.</p>
 * <p>IllegalStateException - If the underlying object is null.</p>
 * 
 * @poseidon-object-id [Im579fc457m10e1824c6ffmm67ad]
 * @param name 
 * @param elements 
 */
 ...
 * <p>IllegalStateException - If the underlying object is null.</p>
 * 
 * @poseidon-object-id [Im579fc457m10e1824c6ffmm6744]
 * @param name 
 * @param element 
 */
 ...
 * <p>IllegalStateException - If the underlying object is null.</p>
 * 
 * @poseidon-object-id [Im579fc457m10e1824c6ffmm66db]
 * @param name 
 * @param element 
 */
 ...
 * <p>IllegalStateException - If the underlying object is null.</p>
 * 
 * @poseidon-object-id [Im579fc457m10e1824c6ffmm6672]
 * @param name 
 */
 ...
 * <p>Exceptions: IllegalStateException - If the underlying object is null.</p>
 * 
 * @poseidon-object-id [Im579fc457m10e1824c6ffmm6632]
 */
 ...
 * <p>Exceptions: IllegalStateException - If the underlying object is null.</p>
 * 
 * @poseidon-object-id [Im579fc457m10e1824c6ffmm660d]
 * @return 
 */
 ...
 * <p>Exceptions: IllegalStateException - If the underlying object is null.</p>
 * 
 * @poseidon-object-id [Im579fc457m10e1824c6ffmm65e8]
 * @return 
 */
 ...
 * <p>Args: baseUri - The Base URI desired. Possibly null.</p>
 * <p>Implementation: Simply delegate to the underlying object.</p>
 * <p>Returns: None.</p>
 * <p>Exceptions: IllegalStateException - If the underlying object is null.</p>
 * 
 * @poseidon-object-id [Im579fc457m10e1824c6ffmm65c3]
 * @param baseUri 
 */
 ...
 * <p>Args: language - The language desired. Possibly null or empty.</p>
 * <p>Implementation: Simply delegate to the underlying object.</p>
 * <p>Returns: None.</p>
 * <p>Exceptions: IllegalStateException - If the underlying object is null.</p>
 * 
 * @poseidon-object-id [Im579fc457m10e1824c6ffmm6583]
 * @param language 
 */
 ...
 * <p></p>
 * 
 * @poseidon-object-id [Im12375f2bm10e564f3ea3mm2cff]
 */
