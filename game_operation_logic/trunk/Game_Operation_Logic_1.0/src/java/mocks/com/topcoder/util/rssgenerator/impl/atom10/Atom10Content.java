...
/**
 * Purpose: Extends the RSSTextImpl class to provide an Atom 1.0 conent
 * <p>Implementation: We decorate over some more properties to provide a content object.</p>
 * <p>Thread Safety: This class is not thread safe as its base class is not thread safe either.</p>
 * 
 * @poseidon-object-id [I45cbadbcm10e31f94a38mm4812]
 */
 ...
 * <p>Exceptions: None.</p>
 * 
 * @poseidon-object-id [I45cbadbcm10e31f94a38mm3fe7]
 */
 ...
 * 
 * @poseidon-object-id [I45cbadbcm10e31f94a38mm3fcf]
 * @param object 
 */
...
/**
 * <p>Purpose: Gets the source of the content.</p>
 * <p>Args: None.</p>
 * <p>Implementation: Refer to CS 1.3.1. Decorate over &quot;attribute:source&quot;</p>
 * <p>Returns: The source of this content.</p>
 * <p>Exceptions: IllegalStateException - If the underlying object is null.</p>
 * 
 * @poseidon-object-id [I45cbadbcm10e31f94a38mm3fb7]
 * @return 
 */
...
/**
 * <p>Purpose: Sets the source of the content.</p>
 * <p>Args: source - The source of this content to be set. Possibly null.</p>
 * <p>Implementation: Refer to CS 1.3.1. Decorate over &quot;attribute:source&quot;</p>
 * <p>Returns: None.</p>
 * <p>Exceptions: IllegalStateException - If the underlying object is null.</p>
 * 
 * @poseidon-object-id [I45cbadbcm10e31f94a38mm3f92]
 * @param source 
 */
