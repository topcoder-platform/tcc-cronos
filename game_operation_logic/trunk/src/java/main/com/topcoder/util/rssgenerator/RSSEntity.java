...
/**
 * Purpose: This interface extends the RSSObject contract to represent an entity (person, corporation, etc.). It adds three properties - name, link and email-address. The contract consists of the get/set methods for these properties. Maps to an atom person construct. Other entities such as the RSS 2.0 author,managing editor and web master may also be mapped.
 * <p>Implementation: Implementations might decorate over existsng properties of the RSSObject instance or add member variables to provide the new properties.</p>
 * <p>Thread Safety: Implementations need not be thread safe.</p>
 * 
 * @poseidon-object-id [Im36376badm10e13f61c4dmm7d57]
 */
 ...
 * <p>Exceptions: None.</p>
 * 
 * @poseidon-object-id [Imc11a95dm10e1e826a7fmm3caf]
 * @return 
 */
 ...
 * <p>Exceptions: None.</p>
 * 
 * @poseidon-object-id [Imc11a95dm10e1e826a7fmm3c89]
 * @return 
 */
 ...
 * <p>Exceptions: None.</p>
 * 
 * @poseidon-object-id [Imc11a95dm10e1e826a7fmm3c57]
 * @return 
 */
 ...
 * <p>Exceptions: None.</p>
 * 
 * @poseidon-object-id [Imc11a95dm10e1e826a7fmm3c32]
 * @param name 
 */
 ...
 * <p>Exceptions: None.</p>
 * 
 * @poseidon-object-id [Imc11a95dm10e1e826a7fmm3bf2]
 * @param link 
 */
 ...
 * <p>Exceptions: None.</p>
 * 
 * @poseidon-object-id [Imc11a95dm10e1e826a7fmm3bb2]
 * @param emailAddress 
 */
