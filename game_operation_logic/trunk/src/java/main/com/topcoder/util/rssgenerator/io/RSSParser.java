...
/**
 * Purpose: This interface provides the contract for parsing a character stream containing RSS feeds or items . The contract consists of only two methods - one for parsing feeds and one for parsing items.
 * <p>Implementation: Implementations would parse streams of particular formats - RSS 2.0 or Atom 1.0 say - into RSSFeed and RSSItem instances. The steps involved in the actual parsing are format dependent of course.</p>
 * <p>Thread Safety: Implementations are required to be thread safe.</p>
 * 
 * @poseidon-object-id [Im36376badm10e13f61c4dmm6a59]
 */
 ...
 * 
 * @poseidon-object-id [Imc11a95dm10e1e826a7fmm4fa5]
 * @param source 
 * @return 
 */
 ...
 * <p>IllegalArgumentException - If source is null.</p>
 * 
 * @poseidon-object-id [Imc11a95dm10e1e826a7fmm4f64]
 * @param source 
 * @return 
 */
