...
/**
 * Purpose: Extends the RSSItemImpl class to add properties specific to Atom 1.0
 * <p>Implementation: We decorate over some more properties to provide objects specific to this format. We extend RSSItemImpl</p>
 * <p>Thread Safety: This class is not thread safe as its base class is not thread safe either.</p>
 * 
 * @poseidon-object-id [Im4ae9c223m10e2c2b0f00mm4bc6]
 */
 ...
 * <p>Exceptions: None.</p>
 * 
 * @poseidon-object-id [I45cbadbcm10e31f94a38mm3ee7]
 */
    public  Atom10Item() {        
        // your code here
    } 
 ...
 * <p></p>
 * 
 * @poseidon-object-id [I45cbadbcm10e31f94a38mm3eb8]
 * @param object 
 */
...
/**
 * <p>Purpose: Gets the content of the item.</p>
 * <p>Args: None.</p>
 * <p>Implementation: Refer to CS 1.3.1. Decorate over &quot;element:content&quot;</p>
 * <p>Returns: The content of this item.</p>
 * <p>Exceptions: IllegalStateException - If the underlying object is null.</p>
 * <p></p>
 * 
 * @poseidon-object-id [I45cbadbcm10e31f94a38mm3e49]
 * @return 
 */
...
/**
 * <p>Purpose: Sets the contributors of the item.</p>
 * <p>Args: contributors - The contributors of this item. Posisbly null. Individual elements must not be null.</p>
 * <p>Implementation: Refer to CS 1.3.1. Decorate over &quot;element:contributor&quot;</p>
 * <p>Returns: None.</p>
 * <p>Exceptions: IllegalStateException - If the underlying object is null.</p>
 ...
 * <p></p>
 * 
 * @poseidon-object-id [I45cbadbcm10e31f94a38mm3e24]
 * @param contributors 
 */
 ...
 * 
 * @poseidon-object-id [I45cbadbcm10e31f94a38mm3de4]
 * @param contributor 
 */
...
/**
 * <p>Purpose: removes from the contributors of the item.</p>
 ...
 * <p>IllegalArgumentException - If contributor is null.</p>
 * 
 * @poseidon-object-id [I45cbadbcm10e31f94a38mm3da4]
 * @param contributor 
 */
...
/**
 * <p>Purpose: Clears the contributors of the item.</p>
 * <p>Args: None.</p>
 * <p>Implementation: Refer to CS 1.3.1. Decorate over &quot;element:contributor&quot;</p>
 * <p>Returns: None.</p>
 * <p>Exceptions: IllegalStateException - If the underlying object is null.</p>
 * 
 * @poseidon-object-id [I45cbadbcm10e31f94a38mm3d64]
 */
...
/**
 * <p>Purpose: Sets the content of the item.</p>
 * <p>Args: content - The content to set. Possibly null.</p>
 * <p>Implementation: Refer to CS 1.3.1. Decorate over &quot;element:content&quot;</p>
 * <p>Returns: None.</p>
 * <p>Exceptions: IllegalStateException - If the underlying object is null.</p>
 * 
 * @poseidon-object-id [I45cbadbcm10e31f94a38mm3d24]
 * @param content 
 */
