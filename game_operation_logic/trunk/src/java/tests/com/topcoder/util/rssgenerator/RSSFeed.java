...
/**
 * Purpose: This interface extends the RSSBaseItem contract to represent feeds. An RSSFeed has three addtional properties - the feed generator, images associated with the feed (primarily to represent its logo) and the items associated with a feed. Get.set methods are provided for all three including add/remove/clear methods for the multi-valued properties.
 * <p>Impementation: Implementations can provide the addtional properties either through decoration over the properties of an RSSObject or as member variables.</p>
 * <p>Thread Safety: Implementations need not be thread safe.</p>
 * 
 * @poseidon-object-id [Im36376badm10e13f61c4dmm7ec9]
 */
 ...
 * <p>Exceptions: None.</p>
 * 
 * @poseidon-object-id [Im579fc457m10e1824c6ffmm446a]
 * @return 
 */
 ...
 * <p>Exceptions: None.</p>
 * 
 * @poseidon-object-id [Im579fc457m10e1824c6ffmm4438]
 * @return 
 */
 ...
 * <p>Exceptions: None.</p>
 * 
 * @poseidon-object-id [Im579fc457m10e1824c6ffmm42d6]
 * @return 
 */
 ...
 * <p>Exceptions: None.</p>
 * 
 * @poseidon-object-id [Im579fc457m10e1824c6ffmm4413]
 * @param generator 
 */
 ...
 * 
 * @poseidon-object-id [Im579fc457m10e1824c6ffmm43d3]
 * @param images 
 */
 ...
 * 
 * @poseidon-object-id [Im579fc457m10e1824c6ffmm4393]
 * @param image 
 */
 ...
 * <p>Exceptions: IllegalArgumentException - If image is null.</p>
 * 
 * @poseidon-object-id [Im579fc457m10e1824c6ffmm4353]
 * @param image 
 */
 ...
 * <p>Exceptions: None.</p>
 * 
 * @poseidon-object-id [Im579fc457m10e1824c6ffmm4313]
 */
 ...
 * <p>Exceptions: IllegalArgumentException - If any of the elements of the array is null.</p>
 * 
 * @poseidon-object-id [Im579fc457m10e1824c6ffmm42b0]
 * @param items 
 */
 ...
 * 
 * @poseidon-object-id [Im579fc457m10e1824c6ffmm4270]
 * @param item 
 */
 ...
 * <p>Exceptions: IllegalArgumentException - If item is null.</p>
 * 
 * @poseidon-object-id [Im579fc457m10e1824c6ffmm4230]
 * @param item 
 */
 ...
 * <p>Exceptions: None.</p>
 * 
 * @poseidon-object-id [Im579fc457m10e1824c6ffmm41ef]
 */
