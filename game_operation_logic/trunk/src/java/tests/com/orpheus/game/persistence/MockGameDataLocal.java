...
public class MockGameDataLocal implements GameDataLocal {
	...
	public Game getGame(long gameId) {
		...
		DomainTarget[] domainTargets = new DomainTarget[] { new DomainTargetImpl(
				new Long(5), 0, "www.topcoder.com/game", "id", "abc", 1) };
		// Hosting Slot
		Domain domain = new DomainImpl(new Long(7), 1, "topcoder",
				Boolean.TRUE, images);
		...
		slots = new HostingSlotImpl[] { new HostingSlotImpl(new Long(17),
				domain, 1, new long[] { 1 }, new Long(19), 0, domainTargets,
	...
	public HostingSlot getSlot(long slotId) {
		...
		Date hostingEnd = calendar.getTime();
		int winningBid = 1000;
		return new HostingSlotImpl(new Long(17), domain, 1, new long[] { 1 },
				new Long(19), 0, domainTargets, winningBid, hostingStart,
				hostingEnd);
	}
