...
public class SubmissionManagerBeanUnitTests extends BaseTestCase {
    ...
    /**
     * <p>
     * Unit test for <code>{@link SubmissionManagerBean#initialize()}</code> method.
     * </p>
     * <p>
    ...
    public void testInitialize_EnvNotDefined() throws Exception {
        submissionManager = (SubmissionManager) ctx.lookup("SubmissionManagerBeanWithoutLog");
    ...
    public void testInitialize_EmptyLogName() throws Exception {
        submissionManager = (SubmissionManager) ctx.lookup("SubmissionManagerBeanEmptyLogName");
    ...
    public void testInitialize_TrimmedEmptyLogName() throws Exception {
        submissionManager = (SubmissionManager) ctx.lookup("SubmissionManagerBeanTrimmedEmptyLogName");
     ...
     * </p>
     * <p>
     * If the log name type is invalid, should throw SubmissionManagementConfigurationException.
     * </p>
     *
     * @throws Exception
     *             pass any unexpected exception to JUnit.
    ...
    public void testInitialize_InvalidLogNameType() throws Exception {
        try {
            submissionManager = (SubmissionManager) ctx.lookup("SubmissionManagerBeanTrimmedInvalidType");
     ...
     * </p>
     * <p>
     * If the unit name is not specified, should throw SubmissionManagementConfigurationException.
     * </p>
     *
     * @throws Exception
     *             pass any unexpected exception to JUnit.
    ...
    public void testInitialize_UnitNameNotDefined() throws Exception {
        try {
            submissionManager = (SubmissionManager) ctx.lookup("SubmissionManagerBeanWithoutUnitName");
     ...
     * </p>
     * <p>
     * If the unit name is empty, should throw SubmissionManagementConfigurationException.
     * </p>
     *
     * @throws Exception
     *             pass any unexpected exception to JUnit.
    ...
    public void testInitialize_EmptyUnitName() throws Exception {
        try {
            submissionManager = (SubmissionManager) ctx.lookup("SubmissionManagerBeanEmptyUnitName");
     ...
     * </p>
     * <p>
     * If the unit name is trimmed empty, should throw SubmissionManagementConfigurationException.
     * </p>
     *
     * @throws Exception
     *             pass any unexpected exception to JUnit.
    ...
    public void testInitialize_TrimmedEmptyUnitName() throws Exception {
        try {
            submissionManager = (SubmissionManager) ctx.lookup("SubmissionManagerBeanTrimmedEmptyUnitName");
     ...
     * </p>
     * <p>
     * If the unit name is invalid, should throw SubmissionManagementConfigurationException.
     * </p>
     *
     * @throws Exception
     *             pass any unexpected exception to JUnit.
    ...
    public void testInitialize_InvalidUnitName() throws Exception {
        try {
            submissionManager = (SubmissionManager) ctx.lookup("SubmissionManagerBeanTrimmedNotFoundUnitName");
    ...
    /**
     * <p>
     * Unit test for <code>{@link SubmissionManagerBean#getSubmission(long)}</code> method.
     * </p>
     * <p>
    ...
    public void testGetSubmission_accuracy() throws Exception {
        ...
        // actually not need to fully test the bean, as it is controlled by hibernate.
        assertEquals("status is incorrect.", 1, submission.getStatus().getSubmissionStatusId().longValue());
        assertEquals("incorrect original file name", "test.jar", submission.getOriginalFileName());
    }

    /**
     * <p>
     * Unit test for <code>{@link SubmissionManagerBean#getSubmissionsForContest(long, boolean)}</code> method.
     * </p>
     * <p>
    ...
    public void testGetSubmissionsForContest_empty() throws Exception {
        List<Submission> submissions = submissionManager.getSubmissionsForContest(1, false);
     ...
     *             pass any unexpected exception to JUnit.
     */
    public void testGetSubmissionsForContest_accuracy() throws Exception {
        executeSQL(new String[] {
            INSERT_SUBMISSION_PREFIX + "(1, 1, 1, 1, '2008-03-16 09:00:00', 'test.jar', 'test.jar', 1, 1,"
                    + " '2008-03-16 09:00:00', 1, 1, '2008-03-16 09:00:00', 1, 1)",
            INSERT_SUBMISSION_PREFIX + "(2, 1, 1, 1, '2008-03-16 09:00:00', 'test.jar', 'test.jar', 1, 1,"
                    + " '2008-03-16 09:00:00', 1, 1, '2008-03-16 09:00:00', 1, 1)"});

        List<Submission> submissions = submissionManager.getSubmissionsForContest(1, true);

        assertNotNull("Should not null.", submissions);
        assertEquals("The submissions should have 2 elements.", 2, submissions.size());
     ...
     *             pass any unexpected exception to JUnit.
     */
    public void testGetSubmissionsForContest_accuracy2() throws Exception {
        executeSQL(new String[] {
            INSERT_SUBMISSION_PREFIX + "(1, 1, 1, 1, '2008-03-16 09:00:00', 'test.jar', 'test.jar', 1, 1,"
                    + " '2008-03-16 09:00:00', 1, 1, '2008-03-16 09:00:00', 1, 1)",
            INSERT_SUBMISSION_PREFIX + "(2, 1, 1, 1, '2008-03-16 09:00:00', 'test.jar', 'test.jar', 1, 1,"
        ...
        for (Submission submission : submissions) {
            assertNull("the full submission path should be null.", submission.getFullSubmissionPath());
        }
    }

    /**
     * <p>
     * Unit test for <code>{@link SubmissionManagerBean#getAllSubmissionsByMember(long)}</code> method.
     * </p>
     * <p>
     ...
     * </p>
     * <p>
     * If the submissions of the member is not deleted, should return the active submission list.
     * </p>
     *
     * @throws Exception
     *             pass any unexpected exception to JUnit.
     */
    public void testGetAllSubmissionsByMember_accuracy() throws Exception {
        executeSQL(new String[] {
            INSERT_SUBMISSION_PREFIX + "(1, 1, 1, 1, '2008-03-16 09:00:00', 'test.jar', 'test.jar', 1, 1,"
                    + " '2008-03-16 09:00:00', 1, 1, '2008-03-16 09:00:00', 1, 1)",
            INSERT_SUBMISSION_PREFIX + "(2, 1, 2, 1, '2008-03-16 09:00:00', 'test.jar', 'test.jar', 1, 1,"
                    + " '2008-03-16 09:00:00', 1, 1, '2008-03-16 09:00:00', 1, 1)"});

        List<Submission> submissions = submissionManager.getAllSubmissionsByMember(1);

        assertNotNull("Should not null.", submissions);
        assertEquals("The submissions should have one elements.", 1, submissions.size());
    }
     ...
     *             pass any unexpected exception to JUnit.
     */
    public void testGetAllSubmissionsByMember_Inactive() throws Exception {
        executeSQL(new String[] {
            INSERT_SUBMISSION_PREFIX + "(1, 1, 1, 1, '2008-03-16 09:00:00', 'test.jar', 'test.jar', 1, 1,"
                    + " '2008-03-16 09:00:00', 1, 1, '2008-03-16 09:00:00', 1, 1)",
            INSERT_SUBMISSION_PREFIX + "(2, 2, 1, 1, '2008-03-16 09:00:00', 'test.jar', 'test.jar', 1, 1,"
                    + " '2008-03-16 09:00:00', 1, 1, '2008-03-16 09:00:00', 1, 1)"});
    ...
    /**
     * <p>
     * Unit test for <code>{@link SubmissionManagerBean#updateSubmission(Submission)}</code> method.
     * </p>
     * <p>
    ...
    public void testUpdateSubmission_NullSubmission() throws Exception {
        try {
            ...
            assertTrue("Incorrect cause.", e.getCause() instanceof IllegalArgumentException);
        }
    }
     ...
     * </p>
     * <p>
     * If the submission does not exist in database, should throw EntityNotFoundException.
     * </p>
     *
     * @throws Exception
     *             pass any unexpected exception to JUnit.
     ...
     * </p>
     * <p>
     * If the submission is already deleted, should throw EntityNotFoundException.
     * </p>
     *
     * @throws Exception
     *             pass any unexpected exception to JUnit.
     ...
     * </p>
     * <p>
     * If the submission's rank is changed, should throw SubmissionManagementException.
     * </p>
     *
     * @throws Exception
     *             pass any unexpected exception to JUnit.
    ...
    public void testUpdateSubmission_RankChanged2() throws Exception {
        executeSQL(new String[] {"INSERT INTO submission (submission_id, submission_status_id, submitter_id,"
     ...
     * </p>
     * <p>
     * If the submission's prizes set is changed, should throw SubmissionManagementException.
     * </p>
     *
     * @throws Exception
     *             pass any unexpected exception to JUnit.
    ...
    public void testUpdateSubmission_PrizesChanged() throws Exception {
        executeSQL(new String[] {"INSERT INTO submission (submission_id, submission_status_id, submitter_id,"
                + " contest_id, create_date, original_file_name, system_file_name, submission_type_id, mime_type_id,"
                + " submission_date, height, width, modify_date, or_submission_id, path_id) VALUES (1, 1, 1, 1,"
                + " '2008-03-16 09:00:00', 'test.jar', 'test.jar', 1, 1, '2008-03-16 09:00:00',"
                + " 1, 1, '2008-03-16 09:00:00', 1, 1)"});
        Submission submission = new Submission();
        submission.setSubmissionId(1L);
    ...
    public void testUpdateSubmission_accuracy() throws Exception {
        ...
        assertEquals("Incorrect or submission.", 2, submission.getOrSubmission().longValue());
        assertEquals("Incorrect modify date.", newDate.getTime(), submission.getModifyDate().getTime(), 1000);
    }

    /**
     * <p>
     * Unit test for <code>{@link SubmissionManagerBean#removeSubmission(long)}</code> method.
     * </p>
     * <p>
    ...
    public void testRemoveSubmission_NotFound() throws Exception {
        assertFalse("False should return.", submissionManager.removeSubmission(1L));
    }
     ...
     * </p>
     * <p>
     * if the submission to remove is still active, should return true with the submission deleted.
     * </p>
     *
     * @throws Exception
     *             pass any unexpected exception to JUnit.
    ...
    /**
     * <p>
     * Unit test for <code>{@link SubmissionManagerBean#updateSubmissionStatus(long, long)}</code> method.
     * </p>
     * <p>
     * if the submission to remove does not exist, should throw EntityNotFoundException.
     * </p>
     *
     * @throws Exception
     *             pass any unexpected exception to JUnit.
     ...
     * </p>
     * <p>
     * if the submission to remove is already deleted, should throw EntityNotFoundException.
     * </p>
     *
     * @throws Exception
     *             pass any unexpected exception to JUnit.
     */
    public void testUpdateSubmissionStatus_AlreadyDeleted() throws Exception {
        executeSQL(new String[] {INSERT_SUBMISSION_PREFIX
                + "(1, 2, 1, 1, '2008-03-16 09:00:00', 'test.jar', 'test.jar', 1, 1,"
                + " '2008-03-16 09:00:00', 1, 1, '2008-03-16 09:00:00', 1, 1)"});
     ...
     *             pass any unexpected exception to JUnit.
     */
    public void testUpdateSubmissionStatus_StatusNotFound() throws Exception {
        executeSQL(new String[] {INSERT_SUBMISSION_PREFIX
                + "(1, 1, 1, 1, '2008-03-16 09:00:00', 'test.jar', 'test.jar', 1, 1,"
                + " '2008-03-16 09:00:00', 1, 1, '2008-03-16 09:00:00', 1, 1)"});
    ...
    /**
     * <p>
     * Unit test for <code>{@link SubmissionManagerBean#addPrize(Prize)}</code> method.
     * </p>
     * <p>
    ...
    /**
     * <p>
     * Unit test for <code>{@link SubmissionManagerBean#updatePrize(Prize)}</code> method.
     * </p>
     * <p>
     * If the prize is null, should throw IllegalArgumentException.
     * </p>
     ...
     * </p>
     * <p>
     * If the prize to update does not exist, should throw EntityNotFoundException.
     * </p>
     *
     * @throws Exception
     *             pass any unexpected exception to JUnit.
    ...
    public void testUpdatePrize_accuracy() throws Exception {
        executeSQL(new String[] {INSERT_PRIZE_PREFIX + "(1, 1, 1, 1, '2008-03-16 09:00:00')"});
        ...
        assertEquals("Incorrect amount.", 10.0, prize.getAmount().doubleValue(), 1e-3);
    }

    /**
     * <p>
     * Unit test for <code>{@link SubmissionManagerBean#removePrize(long)}</code> method.
     * </p>
     * <p>
    ...
    /**
     * <p>
     * Unit test for <code>{@link SubmissionManagerBean#getPrize(long)}</code> method.
     * </p>
     * <p>
    ...
    public void testGetPrize_Found() throws Exception {
        ...
        assertEquals("Incorrect amount", 1, prize.getAmount().doubleValue(), 1e-3);
    }

    /**
     * <p>
     * Unit test for <code>{@link SubmissionManagerBean#addPrizeToSubmission(long, long)}</code> method.
     * </p>
     * <p>
     ...
     *             pass any unexpected exception to JUnit.
     */
    public void testAddPrizeToSubmission_PrizeNotFound() throws Exception {
        executeSQL(new String[] {INSERT_SUBMISSION_PREFIX
                + "(1, 1, 1, 1, '2008-03-16 09:00:00', 'test.jar', 'test.jar', 1, 1,"
                + " '2008-03-16 09:00:00', 1, 1, '2008-03-16 09:00:00', 1, 1)"});
     ...
     *             pass any unexpected exception to JUnit.
     */
    public void testAddPrizeToSubmission_SubmissionNotFound() throws Exception {
        executeSQL(new String[] {INSERT_PRIZE_PREFIX + "(1, 1, 1, 1, '2008-03-16 09:00:00')"});
     ...
     *             pass any unexpected exception to JUnit.
     */
    public void testAddPrizeToSubmission_SubmissionDeleted() throws Exception {
        executeSQL(new String[] {
            INSERT_SUBMISSION_PREFIX + "(1, 2, 1, 1, '2008-03-16 09:00:00', 'test.jar', 'test.jar', 1, 1,"
                    + " '2008-03-16 09:00:00', 1, 1, '2008-03-16 09:00:00', 1, 1)",
     ...
     * </p>
     * <p>
     * If the submission rank does not exist, should throw IllegalArgumentException.
     * </p>
     *
     * @throws Exception
     *             pass any unexpected exception to JUnit.
     ...
     * </p>
     * <p>
     * If the submission rank and the prize place is inconsistent, should throw IllegalArgumentException.
     * </p>
     *
     * @throws Exception
     *             pass any unexpected exception to JUnit.
     */
    public void testAddPrizeToSubmission_RankPlaceInconsist() throws Exception {
        executeSQL(new String[] {
            "INSERT INTO submission (submission_id, submission_status_id, submitter_id,"
                    + " contest_id, create_date, original_file_name, system_file_name, submission_type_id,"
                    + " mime_type_id, submission_date, height, width, modify_date, or_submission_id, path_id, rank)"
                    + " VALUES (1, 1, 1, 1, '2008-03-16 09:00:00', 'test.jar', 'test.jar', 1, 1,"
    ...
    /**
     * <p>
     * Unit test for <code>{@link SubmissionManagerBean#removePrizeFromSubmission(long, long)}</code> method.
     * </p>
     * <p>
     * If the prize does not exist, should throw EntityNotFoundException.
     * </p>
     ...
     *             pass any unexpected exception to JUnit.
     */
    public void testRemovePrizeFromSubmission_PrizeNotFound() throws Exception {
        executeSQL(new String[] {INSERT_SUBMISSION_PREFIX
                + "(1, 1, 1, 1, '2008-03-16 09:00:00', 'test.jar', 'test.jar', 1, 1,"
                + " '2008-03-16 09:00:00', 1, 1, '2008-03-16 09:00:00', 1, 1)"});
     ...
     *             pass any unexpected exception to JUnit.
     */
    public void testRemovePrizeFromSubmission_SubmissionNotFound() throws Exception {
        executeSQL(new String[] {INSERT_PRIZE_PREFIX + "(1, 1, 1, 1, '2008-03-16 09:00:00')"});
     ...
     *             pass any unexpected exception to JUnit.
     */
    public void testRemovePrizeFromSubmission_SubmissionDeleted() throws Exception {
        executeSQL(new String[] {
            INSERT_SUBMISSION_PREFIX + "(1, 2, 1, 1, '2008-03-16 09:00:00', 'test.jar', 'test.jar', 1, 1,"
                    + " '2008-03-16 09:00:00', 1, 1, '2008-03-16 09:00:00', 1, 1)",
            INSERT_PRIZE_PREFIX + "(1, 1, 1, 1, '2008-03-16 09:00:00')"});
     ...
     *             pass any unexpected exception to JUnit.
     */
    public void testRemovePrizeFromSubmission_acccuracy1() throws Exception {
        executeSQL(new String[] {
            INSERT_SUBMISSION_PREFIX + "(1, 1, 1, 1, '2008-03-16 09:00:00', 'test.jar', 'test.jar', 1, 1,"
                    + " '2008-03-16 09:00:00', 1, 1, '2008-03-16 09:00:00', 1, 1)",
            INSERT_PRIZE_PREFIX + "(1, 1, 1, 1, '2008-03-16 09:00:00')",
     ...
     *             pass any unexpected exception to JUnit.
     */
    public void testRemovePrizeFromSubmission_acccuracy2() throws Exception {
        executeSQL(new String[] {
            INSERT_SUBMISSION_PREFIX + "(1, 1, 1, 1, '2008-03-16 09:00:00', 'test.jar', 'test.jar', 1, 1,"
                    + " '2008-03-16 09:00:00', 1, 1, '2008-03-16 09:00:00', 1, 1)",
            INSERT_PRIZE_PREFIX + "(1, 1, 1, 1, '2008-03-16 09:00:00')"});
    ...
    /**
     * <p>
     * Unit test for <code>{@link SubmissionManagerBean#addSubmissionPayment(SubmissionPayment)}</code> method.
     * </p>
     * <p>
     ...
     *             pass any unexpected exception to JUnit.
     */
    public void testAddSubmissionPayment_nullSubmissionPayment() throws Exception {
        try {
     ...
     * </p>
     * <p>
     * If the submission this submissionPayment for does not found, should throw EntityNotFoundException.
     * </p>
     *
     * @throws Exception
     *             pass any unexpected exception to JUnit.
     */
    public void testAddSubmissionPayment_SubmissionNotFound() throws Exception {
        Submission submission = new Submission();
        submission.setSubmissionId(1L);
     ...
     * </p>
     * <p>
     * If the submission this submissionPayment for is deleted, should throw EntityNotFoundException.
     * </p>
     *
     * @throws Exception
     *             pass any unexpected exception to JUnit.
     */
    public void testAddSubmissionPayment_SubmissionDeleted() throws Exception {
        executeSQL(new String[] {INSERT_SUBMISSION_PREFIX
                + "(1, 2, 1, 1, '2008-03-16 09:00:00', 'test.jar', 'test.jar', 1, 1,"
                + " '2008-03-16 09:00:00', 1, 1, '2008-03-16 09:00:00', 1, 1)"});
        Submission submission = new Submission();
     ...
     * </p>
     * <p>
     * If the submissionPayment already exists, should throw EntityExistsException.
     * </p>
     *
     * @throws Exception
     *             pass any unexpected exception to JUnit.
     */
    public void testAddSubmissionPayment_alreadyExist() throws Exception {
        executeSQL(new String[] {
            INSERT_SUBMISSION_PREFIX + "(1, 1, 1, 1, '2008-03-16 09:00:00', 'test.jar', 'test.jar', 1, 1,"
                    + " '2008-03-16 09:00:00', 1, 1, '2008-03-16 09:00:00', 1, 1)",
            INSERT_SUBMISSION_PAYMENTS_PREFIX + "(1, 1, 1)"});
        Submission submission = new Submission();
        submission.setSubmissionId(1L);
    ...
    /**
     * <p>
     * Unit test for <code>{@link SubmissionManagerBean#updateSubmissionPayment(SubmissionPayment)}</code> method.
     * </p>
     * <p>
     * If the submissionPayment is null, should throw IllegalArgumentException.
     * </p>
     ...
     *             pass any unexpected exception to JUnit.
     */
    public void testUpdateSubmissionPayment_nullSubmissionPayment() throws Exception {
        try {
     ...
     *             pass any unexpected exception to JUnit.
     */
    public void testUpdateSubmissionPayment_SubmissionNotFound() throws Exception {
        Submission submission = new Submission();
        submission.setSubmissionId(1L);
        SubmissionPayment submissionPayment = new SubmissionPayment();
        submissionPayment.setSubmission(submission);
     ...
     *             pass any unexpected exception to JUnit.
     */
    public void testUpdateSubmissionPayment_SubmissionDeleted() throws Exception {
        executeSQL(new String[] {INSERT_SUBMISSION_PREFIX
                + "(1, 2, 1, 1, '2008-03-16 09:00:00', 'test.jar', 'test.jar', 1, 1,"
                + " '2008-03-16 09:00:00', 1, 1, '2008-03-16 09:00:00', 1, 1)"});
        Submission submission = new Submission();
     ...
     * </p>
     * <p>
     * If the submissionPayment does not exist, should throw EntityNotFoundException.
     * </p>
     *
     * @throws Exception
     *             pass any unexpected exception to JUnit.
     */
    public void testUpdateSubmissionPayment_alreadyExist() throws Exception {
        executeSQL(new String[] {INSERT_SUBMISSION_PREFIX
                + "(1, 1, 1, 1, '2008-03-16 09:00:00', 'test.jar', 'test.jar', 1, 1,"
                + " '2008-03-16 09:00:00', 1, 1, '2008-03-16 09:00:00', 1, 1)"});
        Submission submission = new Submission();
     ...
     *             pass any unexpected exception to JUnit.
     */
    public void testUpdateSubmissionPayment_accuracy() throws Exception {
        executeSQL(new String[] {
            INSERT_SUBMISSION_PREFIX + "(1, 1, 1, 1, '2008-03-16 09:00:00', 'test.jar', 'test.jar', 1, 1,"
                    + " '2008-03-16 09:00:00', 1, 1, '2008-03-16 09:00:00', 1, 1)",
            INSERT_SUBMISSION_PAYMENTS_PREFIX + "(1, 1, 1)"});
    ...
    /**
     * <p>
     * Unit test for <code>{@link SubmissionManagerBean#getSubmissionPayment(long)}</code> method.
     * </p>
     * <p>
    ...
    public void testGetSubmissionPayment_NotFound() throws Exception {
        assertNull("Should return null.", submissionManager.getSubmissionPayment(1L));
    }
    ...
    public void testGetSubmissionPayment_Deleted() throws Exception {
        executeSQL(new String[] {
            INSERT_SUBMISSION_PREFIX + "(1, 1, 1, 1, '2008-03-16 09:00:00', 'test.jar', 'test.jar', 1, 1,"
                    + " '2008-03-16 09:00:00', 1, 1, '2008-03-16 09:00:00', 1, 1)",
            INSERT_SUBMISSION_PAYMENTS_PREFIX + "(1, 2, 1)"});
    ...
    public void testGetSubmissionPayment_accuracy() throws Exception {
        ...
        assertNotNull("Should not return null.", submissionManager.getSubmissionPayment(1L));
    }

    /**
     * <p>
     * Unit test for <code>{@link SubmissionManagerBean#addSubmissionReview(SubmissionReview)}</code> method.
     * </p>
     * <p>
     ...
     *             pass any unexpected exception to JUnit.
     */
    public void testAddSubmissionReview_nullSubmissionReview() throws Exception {
        try {
     ...
     * </p>
     * <p>
     * If the submission this submissionReview for does not found, should throw EntityNotFoundException.
     * </p>
     *
     * @throws Exception
     *             pass any unexpected exception to JUnit.
     */
    public void testAddSubmissionReview_SubmissionNotFound() throws Exception {
        Submission submission = new Submission();
        submission.setSubmissionId(1L);
     ...
     * </p>
     * <p>
     * If the submission this submissionReview for is deleted, should throw EntityNotFoundException.
     * </p>
     *
     * @throws Exception
     *             pass any unexpected exception to JUnit.
     */
    public void testAddSubmissionReview_SubmissionDeleted() throws Exception {
        executeSQL(new String[] {INSERT_SUBMISSION_PREFIX
                + "(1, 2, 1, 1, '2008-03-16 09:00:00', 'test.jar', 'test.jar', 1, 1,"
                + " '2008-03-16 09:00:00', 1, 1, '2008-03-16 09:00:00', 1, 1)"});
        Submission submission = new Submission();
     ...
     * </p>
     * <p>
     * If the submissionReview already exists, should throw EntityExistsException.
     * </p>
     *
     * @throws Exception
     *             pass any unexpected exception to JUnit.
     */
    public void testAddSubmissionReview_alreadyExist() throws Exception {
        executeSQL(new String[] {
            INSERT_SUBMISSION_PREFIX + "(1, 1, 1, 1, '2008-03-16 09:00:00', 'test.jar', 'test.jar', 1, 1,"
                    + " '2008-03-16 09:00:00', 1, 1, '2008-03-16 09:00:00', 1, 1)",
            INSERT_SUBMISSION_REVIEW_PREFIX + "(1, 1, 'Hello', 1, '2008-03-16 09:00:00')"});
        Submission submission = new Submission();
        submission.setSubmissionId(1L);
    ...
    /**
     * <p>
     * Unit test for <code>{@link SubmissionManagerBean#updateSubmissionReview(SubmissionReview)}</code> method.
     * </p>
     * <p>
     * If the submissionReview is null, should throw IllegalArgumentException.
     * </p>
     ...
     *             pass any unexpected exception to JUnit.
     */
    public void testUpdateSubmissionReview_nullSubmissionReview() throws Exception {
        try {
     ...
     *             pass any unexpected exception to JUnit.
     */
    public void testUpdateSubmissionReview_SubmissionNotFound() throws Exception {
        Submission submission = new Submission();
        submission.setSubmissionId(1L);
        SubmissionReview submissionReview = new SubmissionReview();
        submissionReview.setSubmission(submission);
     ...
     *             pass any unexpected exception to JUnit.
     */
    public void testUpdateSubmissionReview_SubmissionDeleted() throws Exception {
        executeSQL(new String[] {INSERT_SUBMISSION_PREFIX
                + "(1, 2, 1, 1, '2008-03-16 09:00:00', 'test.jar', 'test.jar', 1, 1,"
                + " '2008-03-16 09:00:00', 1, 1, '2008-03-16 09:00:00', 1, 1)"});
        Submission submission = new Submission();
    ...
    /**
     * <p>
     * Unit test for <code>{@link SubmissionManagerBean#getSubmissionReview(long)}</code> method.
     * </p>
     * <p>
    ...
    public void testGetSubmissionReview_NotFound() throws Exception {
        assertNull("Should return null.", submissionManager.getSubmissionReview(1L));
    }
    ...
    public void testGetSubmissionReview_accuracy() throws Exception {
        ...
        assertNotNull("Should not return null.", submissionManager.getSubmissionReview(1L));
    }

    /**
     * <p>
     * Unit test for <code>{@link SubmissionManagerBean#removeSubmissionReview(long)}</code> method.
     * </p>
     * <p>
     ...
     *             pass any unexpected exception to JUnit.
     */
    public void testRemoveSubmissionReview_SubmissionNotFound() throws Exception {
     ...
     *             pass any unexpected exception to JUnit.
     */
    public void testRemoveSubmissionReview_SubmissionDeleted() throws Exception {
        executeSQL(new String[] {
            INSERT_SUBMISSION_PREFIX + "(1, 2, 1, 1, '2008-03-16 09:00:00', 'test.jar', 'test.jar', 1, 1,"
                    + " '2008-03-16 09:00:00', 1, 1, '2008-03-16 09:00:00', 1, 1)",
            INSERT_SUBMISSION_REVIEW_PREFIX + "(1, 1, 'Hello', 1, '2008-03-16 09:00:00')"});
    ...
    /**
     * <p>
     * Unit test for <code>{@link SubmissionManagerBean#getSubmissionPrizes(long)}</code> method.
     * </p>
     * <p>
     * if the submission does not exist, should throw EntityNotFoundException.
     * </p>
    ...
    /**
     * <p>
     * Unit test for <code>{@link SubmissionManagerBean#updateSubmissionResult(Submission)}</code> method.
     * </p>
     * <p>
     * If the submission is null, should throw IllegalArgumentException.
     * </p>
     ...
     * </p>
     * <p>
     * If the submission's rank is not set, should throw IllegalArgumentException.
     * </p>
     *
     * @throws Exception
     *             pass any unexpected exception to JUnit.
     */
    public void testUpdateSubmissionResult_MissingRank() throws Exception {
        try {
     ...
     *             pass any unexpected exception to JUnit.
     */
    public void testUpdateSubmissionResult_EntityNotFound() throws Exception {
        Submission submission = new Submission();
        submission.setSubmissionId(1L);
        submission.setRank(1);
        try {
     ...
     *             pass any unexpected exception to JUnit.
     */
    public void testUpdateSubmissionResult_EntityDeleted() throws Exception {
        executeSQL(new String[] {INSERT_SUBMISSION_PREFIX
                + "(1, 2, 1, 1, '2008-03-16 09:00:00', 'test.jar', 'test.jar', 1, 1,"
                + " '2008-03-16 09:00:00', 1, 1, '2008-03-16 09:00:00', 1, 1)"});
        Submission submission = new Submission();
     ...
     *             pass any unexpected exception to JUnit.
     */
    public void testUpdateSubmissionResult_accuracy1() throws Exception {
        executeSQL(new String[] {INSERT_SUBMISSION_PREFIX
                + "(1, 1, 1, 1, '2008-03-16 09:00:00', 'test.jar', 'test.jar', 1, 1,"
                + " '2008-03-16 09:00:00', 1, 1, '2008-03-16 09:00:00', 1, 1)"});
        Submission submission = new Submission();
     ...
     *             pass any unexpected exception to JUnit.
     */
    public void testUpdateSubmissionResult_accuracy2() throws Exception {
        executeSQL(new String[] {
            ...
            "INSERT INTO submission (submission_id, submission_status_id, submitter_id, contest_id, create_date,"
                    + " original_file_name, system_file_name, submission_type_id, mime_type_id, submission_date,"
                    + " height, width, modify_date, or_submission_id, path_id, rank) VALUES (2, 1, 1, 1,"
                    + " '2008-03-16 09:00:00', 'test.jar', 'test.jar', 1, 1, '2008-03-16 09:00:00',"
            ...
            "INSERT INTO submission (submission_id, submission_status_id, submitter_id, contest_id, create_date,"
                    + " original_file_name, system_file_name, submission_type_id, mime_type_id, submission_date,"
                    + " height, width, modify_date, or_submission_id, path_id, rank) VALUES (4, 1, 1, 1,"
                    + " '2008-03-16 09:00:00', 'test.jar', 'test.jar', 1, 1, '2008-03-16 09:00:00',"
     ...
     *             pass any unexpected exception to JUnit.
     */
    public void testUpdateSubmissionResult_accuracy3() throws Exception {
        executeSQL(new String[] {
            "INSERT INTO submission (submission_id, submission_status_id, submitter_id, contest_id, create_date,"
                    + " original_file_name, system_file_name, submission_type_id, mime_type_id, submission_date,"
                    + " height, width, modify_date, or_submission_id, path_id, rank) VALUES (1, 1, 1, 1,"
     ...
     *             pass any unexpected exception to JUnit.
     */
    public void testUpdateSubmissionResult_accuracy4() throws Exception {
        executeSQL(new String[] {
            "INSERT INTO submission (submission_id, submission_status_id, submitter_id, contest_id, create_date,"
                    + " original_file_name, system_file_name, submission_type_id, mime_type_id, submission_date,"
                    + " height, width, modify_date, or_submission_id, path_id, rank) VALUES (1, 1, 1, 1,"
