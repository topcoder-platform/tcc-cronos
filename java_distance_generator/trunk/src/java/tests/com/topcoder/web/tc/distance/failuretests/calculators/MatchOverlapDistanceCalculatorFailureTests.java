...
/**
 * <p>
 * Failure test cases for MatchOverlapDistanceCalculator.
 * </p>
 *
 * @author ivern, TheCois
 * @version 1.0
 */
public class MatchOverlapDistanceCalculatorFailureTests extends TestCase {
    /**
     * <p>
     * A MatchOverlapDistanceCalculator instance for testing.
     * </p>
     */
    ...
    public static Test suite() {
        return new TestSuite(MatchOverlapDistanceCalculatorFailureTests.class);
    }
    
    /**
     * <p>
     * Tests MatchOverlapDistanceCalculator#getDistance(Member,List&lt;Member&gt;,EnumSet&lt;CompetitionType&gt;)
     ...
     * <p>
     * Tests MatchOverlapDistanceCalculator#getDistance(Member,List&lt;Member&gt;,EnumSet&lt;CompetitionType&gt;)
     * for failure.  It tests the case that when the method is called with an empty member list, and expects an
     * IllegalArgumentException.
     * </p>
     * @throws Exception to JUnit
     */
    public void testGetDistanceEmptyMembers() {
        try {
            calculator.getDistance(memberDataAccess.getMember(144400),
