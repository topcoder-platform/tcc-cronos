...
/**
 * Unit tests for <code>JiraProfileCompletenessChecker</code> class.
 *
 * @author nowind_lee
 * @version 1.0
 */
public class JiraProfileCompletenessCheckerTest extends TestCase {

    /**
     * Represents the <code>JiraProfileCompletenessChecker</code> instance used to test against.
     */
    private JiraProfileCompletenessChecker t;
    ...
    protected void setUp() throws Exception {
        t = new JiraProfileCompletenessChecker();
    ...
    /**
     * Accuracy test for constructor <code>JiraProfileCompletenessChecker()</code>.
     *
    ...
    public void testIsProfileComplete_Accuracy1() throws Exception {
        ...
        assertTrue(logMessage
            .contains("[Entering method {JiraProfileCompletenessChecker.isProfileComplete}]"));
        assertTrue(logMessage
            .contains("[Exiting method {JiraProfileCompletenessChecker.isProfileComplete}]"));
