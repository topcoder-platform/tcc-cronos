...
/**
 * <p>Failure tests for {@link OnlineReviewUserIdRetriever} class.</p>
 *
 * @author jmn
 * @version 1.0
 */
public class OnlineReviewUserIdRetrieverFailureTests {
     ...
     */
    private OnlineReviewUserIdRetriever instance;
    ...
    public static junit.framework.Test suite() {
        return new JUnit4TestAdapter(OnlineReviewUserIdRetrieverFailureTests.class);
    }
    ...
    public void setUp() throws Exception {
        ...
        instance = new OnlineReviewUserIdRetriever();
        instance.setLog(new Log4jLogFactory().createLog("test"));
        instance.setUserSessionKey(USER_SESSION);
    }

    /**
     * <p>Tests <code>{@link OnlineReviewUserIdRetriever#OnlineReviewUserIdRetriever()}</code> constructor.</p>
     */
    @Test
    ...
    /**
     * <p>Tests {@link OnlineReviewUserIdRetriever#getUserId(javax.servlet.http.HttpServletRequest)} method when request
     * is null.</p>
     *
    ...
    /**
     * <p>Tests {@link OnlineReviewUserIdRetriever#getUserId(javax.servlet.http.HttpServletRequest)} method.</p>
     *
