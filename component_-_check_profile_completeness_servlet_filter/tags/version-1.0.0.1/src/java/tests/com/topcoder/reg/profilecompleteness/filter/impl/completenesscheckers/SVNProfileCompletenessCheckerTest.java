...
/**
 * Unit tests for <code>SVNProfileCompletenessChecker</code> class.
 *
 * @author nowind_lee
 * @version 1.0
 */
public class SVNProfileCompletenessCheckerTest extends TestCase {

    /**
     * Represents the <code>SVNProfileCompletenessChecker</code> instance used to test against.
     */
    private SVNProfileCompletenessChecker t;
    ...
    protected void setUp() throws Exception {
        t = new SVNProfileCompletenessChecker();
    ...
    /**
     * Accuracy test for constructor <code>SVNProfileCompletenessChecker()</code>.
     *
    ...
    public void testIsProfileComplete_Accuracy1() throws Exception {
        ...
        assertTrue(logMessage
            .contains("[Entering method {SVNProfileCompletenessChecker.isProfileComplete}]"));
        assertTrue(logMessage
            .contains("[Exiting method {SVNProfileCompletenessChecker.isProfileComplete}]"));
