...
/**
 * Unit tests for <code>CompetitionProfileCompletenessChecker</code> class.
 *
 * @author nowind_lee
 * @version 1.0
 */
public class CompetitionProfileCompletenessCheckerTest extends TestCase {

    /**
     * Represents the <code>CompetitionProfileCompletenessChecker</code> instance used to test
     * against.
     */
    private CompetitionProfileCompletenessChecker t;
    ...
    protected void setUp() throws Exception {
        t = new CompetitionProfileCompletenessChecker();
        log = new MockLog();
    ...
    /**
     * Accuracy test for constructor <code>CompetitionProfileCompletenessChecker()</code>.
     *
    ...
    public void testIsProfileComplete_Accuracy1() throws Exception {
        ...
        assertTrue(logMessage
            .contains("[Entering method {CompetitionProfileCompletenessChecker.isProfileComplete}]"));
        assertTrue(logMessage
            .contains("[Exiting method {CompetitionProfileCompletenessChecker.isProfileComplete}]"));
    ...
    public void testIsProfileComplete_Accuracy2() throws Exception {
        t.setLog(log);
        user.setCoder(null); // coder is null
