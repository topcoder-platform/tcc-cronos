...
/**
 * <p>Failure tests for {@link VMProfileCompletenessChecker} class.</p>
 *
 * @author jmn
 * @version 1.0
 */
public class VMProfileCompletenessCheckerFailureTests {

    /**
     * <p>Represents the instance of the tested class.</p>
     */
    private VMProfileCompletenessChecker instance;
    ...
    public static junit.framework.Test suite() {
        return new JUnit4TestAdapter(VMProfileCompletenessCheckerFailureTests.class);
    }
    ...
    public void setUp() throws Exception {
        ...
        instance = new VMProfileCompletenessChecker();
        instance.setLog(new Log4jLogFactory().createLog("test"));
    }

    /**
     * <p>Tests {@link VMProfileCompletenessChecker#VMProfileCompletenessChecker()} constructor.</p>
     */
    @Test
    ...
    /**
     * <p>Tests {@link VMProfileCompletenessChecker#isProfileComplete(com.topcoder.web.common.model.User)} method.</p>
     *
