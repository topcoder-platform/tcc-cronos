...
/**
 * <p>
 * Accuracy test for {@link OnlineReviewProfileCompletenessChecker}.
 * </p>
 *
 * @author gets0ul
 * @version 1.0
 */
public class OnlineReviewProfileCompletenessCheckerAccuracyTest {
    /**
     * The OnlineReviewProfileCompletenessChecker instance to test against.
     */
    private OnlineReviewProfileCompletenessChecker checker;
    ...
    public static junit.framework.Test suite() {
        return new JUnit4TestAdapter(OnlineReviewProfileCompletenessCheckerAccuracyTest.class);
    }
    ...
    /**
     * <p>
     * Tests OnlineReviewProfileCompletenessChecker constructor.
     * </p>
     * <p>
    ...
    public void testCtor() {
        Assert.assertNotNull("OnlineReviewProfileCompletenessChecker is not instantiated", checker);
    }

    /**
     * <p>
     * Tests {@link OnlineReviewProfileCompletenessChecker#isProfileComplete(com.topcoder.web.common.model.User)}
     * method when user as customer is complete.
     * </p>
     * <p>
     ...
     * <p>
     * Tests {@link OnlineReviewProfileCompletenessChecker#isProfileComplete(com.topcoder.web.common.model.User)}
     * method when user as competitor is complete.
     * </p>
     * <p>
     * Expects true is returned.
     * </p>
     ...
     * <p>
     * Tests {@link OnlineReviewProfileCompletenessChecker#isProfileComplete(com.topcoder.web.common.model.User)}
     * method when user is not complete in the superclass.
     * </p>
     * <p>
     ...
     * <p>
     * Tests {@link OnlineReviewProfileCompletenessChecker#isProfileComplete(com.topcoder.web.common.model.User)}
     * method when user is customer and contact is null.
     * </p>
     * <p>
     * Expects false is returned.
     * </p>
     ...
     * <p>
     * Tests {@link OnlineReviewProfileCompletenessChecker#isProfileComplete(com.topcoder.web.common.model.User)}
     * method when user is customer and company is null.
     * </p>
     * <p>
     * Expects false is returned.
     * </p>
     ...
     * <p>
     * Tests {@link OnlineReviewProfileCompletenessChecker#isProfileComplete(com.topcoder.web.common.model.User)}
     * method when user is customer and company name is null.
     * </p>
     * <p>
     * Expects false is returned.
     * </p>
     ...
     * <p>
     * Tests {@link OnlineReviewProfileCompletenessChecker#isProfileComplete(com.topcoder.web.common.model.User)}
     * method when user is customer and demographic responses is null.
     * </p>
     * <p>
     * Expects false is returned.
     * </p>
     ...
     * <p>
     * Tests {@link OnlineReviewProfileCompletenessChecker#isProfileComplete(com.topcoder.web.common.model.User)}
     * method when user is customer and demographic responses is empty.
     * </p>
     * <p>
     * Expects false is returned.
     * </p>
     ...
     * <p>
     * Tests {@link OnlineReviewProfileCompletenessChecker#isProfileComplete(com.topcoder.web.common.model.User)}
     * method when user is customer and time zone is null.
     * </p>
     * <p>
     * Expects false is returned.
     * </p>
     ...
     * <p>
     * Tests {@link OnlineReviewProfileCompletenessChecker#isProfileComplete(com.topcoder.web.common.model.User)}
     * method when user is competitor and coder is null.
     * </p>
     * <p>
     * Expects false is returned.
     * </p>
