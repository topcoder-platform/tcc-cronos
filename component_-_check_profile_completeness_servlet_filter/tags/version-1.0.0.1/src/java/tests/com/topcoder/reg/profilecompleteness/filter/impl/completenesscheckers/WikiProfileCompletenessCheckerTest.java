...
/**
 * Unit tests for <code>WikiProfileCompletenessChecker</code> class.
 *
 * @author nowind_lee
 * @version 1.0
 */
public class WikiProfileCompletenessCheckerTest extends TestCase {

    /**
     * Represents the <code>WikiProfileCompletenessChecker</code> instance used to test against.
     */
    private WikiProfileCompletenessChecker t;
    ...
    protected void setUp() throws Exception {
        t = new WikiProfileCompletenessChecker();
        log = new MockLog();
    ...
    /**
     * Accuracy test for constructor <code>WikiProfileCompletenessChecker()</code>.
     *
    ...
    public void testIsProfileComplete_Accuracy1() throws Exception {
        ...
        assertTrue(logMessage
            .contains("[Entering method {WikiProfileCompletenessChecker.isProfileComplete}]"));
        assertTrue(logMessage
            .contains("[Exiting method {WikiProfileCompletenessChecker.isProfileComplete}]"));
