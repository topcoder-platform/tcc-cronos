...
/**
 * Unit tests for <code>StudioProfileCompletenessChecker</code> class.
 *
 * @author nowind_lee
 * @version 1.0
 */
public class StudioProfileCompletenessCheckerTest extends TestCase {

    /**
     * Represents the <code>StudioProfileCompletenessChecker</code> instance used to test against.
     */
    private StudioProfileCompletenessChecker t;
    ...
    protected void setUp() throws Exception {
        t = new StudioProfileCompletenessChecker();
        log = new MockLog();
    ...
    /**
     * Accuracy test for constructor <code>StudioProfileCompletenessChecker()</code>.
     *
    ...
    public void testIsProfileComplete_Accuracy1() throws Exception {
        ...
        assertTrue(logMessage
            .contains("[Entering method {StudioProfileCompletenessChecker.isProfileComplete}]"));
        assertTrue(logMessage
            .contains("[Exiting method {StudioProfileCompletenessChecker.isProfileComplete}]"));
