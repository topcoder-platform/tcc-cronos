...
/**
 * Unit tests for <code>VMProfileCompletenessChecker</code> class.
 *
 * @author nowind_lee
 * @version 1.0
 */
public class VMProfileCompletenessCheckerTest extends TestCase {

    /**
     * Represents the <code>VMProfileCompletenessChecker</code> instance used to test against.
     */
    private VMProfileCompletenessChecker t;
    ...
    protected void setUp() throws Exception {
        t = new VMProfileCompletenessChecker();
    ...
    /**
     * Accuracy test for constructor <code>VMProfileCompletenessChecker()</code>.
     *
    ...
    public void testIsProfileComplete_Accuracy1() throws Exception {
        ...
        assertTrue(logMessage
            .contains("[Entering method {VMProfileCompletenessChecker.isProfileComplete}]"));
        assertTrue(logMessage
            .contains("[Exiting method {VMProfileCompletenessChecker.isProfileComplete}]"));
     ...
     * Accuracy test for <code>isProfileComplete(User user)</code>.
     *
     * It should return false if user information is incomplete.
     *
     * @throws Exception
     *             to jUnit
     */
    public void testIsProfileComplete_Accuracy13() throws Exception {
        t.setLog(log);
        // as a competitor
        setUserAs(user, RegistrationType.COMPETITION_ID);
     ...
     *             to jUnit
     */
    public void testIsProfileComplete_Accuracy14() throws Exception {
        t.setLog(log);
        // as a customer
        setUserAs(user, RegistrationType.CORPORATE_ID);
        user.setUserSecurityKey(null);
