...
public class MockCacheClient implements CacheClient {
    ...
    /**
     * Returns a mapping between a String to ResultSetContainer for Basic Authentication. The
     * ResultSetContainer will return either "status" or "password" for first row.
     *
     * @param address
