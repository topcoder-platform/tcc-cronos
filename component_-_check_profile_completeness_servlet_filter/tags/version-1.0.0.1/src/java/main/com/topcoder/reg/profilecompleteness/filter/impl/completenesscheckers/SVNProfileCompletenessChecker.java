 ...
 *
 * <pre>
 * SVNProfileCompletenessChecker checker = new SVNProfileCompletenessChecker();
 ...
 * @version 1.0
 */
public class SVNProfileCompletenessChecker extends BaseProfileCompletenessChecker {

    /**
     * The default do nothing constructor.
     */
    public SVNProfileCompletenessChecker() {
        // do nothing
    }
    ...
    public boolean isProfileComplete(User user) throws ProfileCompletenessCheckerException {
        String method = "SVNProfileCompletenessChecker.isProfileComplete";
