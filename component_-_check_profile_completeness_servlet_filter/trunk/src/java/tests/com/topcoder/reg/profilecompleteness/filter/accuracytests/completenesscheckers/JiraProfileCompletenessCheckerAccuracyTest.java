...
/**
 * <p>
 * Accuracy test for {@link JiraProfileCompletenessChecker}.
 * </p>
 *
 * @author gets0ul
 * @version 1.0
 */
public class JiraProfileCompletenessCheckerAccuracyTest {
    /**
     * The JiraProfileCompletenessChecker instance to test against.
     */
    private JiraProfileCompletenessChecker checker;
    ...
    public static junit.framework.Test suite() {
        return new JUnit4TestAdapter(JiraProfileCompletenessCheckerAccuracyTest.class);
    }
    ...
    /**
     * <p>
     * Tests JiraProfileCompletenessChecker constructor.
     * </p>
     * <p>
    ...
    public void testCtor() {
        Assert.assertNotNull("JiraProfileCompletenessChecker is not instantiated", checker);
    }

    /**
     * <p>
     * Tests {@link JiraProfileCompletenessChecker#isProfileComplete(com.topcoder.web.common.model.User)} method
     * when user as customer is complete.
     * </p>
     * <p>
     ...
     * <p>
     * Tests {@link JiraProfileCompletenessChecker#isProfileComplete(com.topcoder.web.common.model.User)} method
     * when user as competitor is complete.
     * </p>
     * <p>
     * Expects true is returned.
     * </p>
     ...
     * <p>
     * Tests {@link JiraProfileCompletenessChecker#isProfileComplete(com.topcoder.web.common.model.User)} method
     * when user is customer and contact is null.
     * </p>
     * <p>
     * Expects false is returned.
     * </p>
     ...
     * <p>
     * Tests {@link JiraProfileCompletenessChecker#isProfileComplete(com.topcoder.web.common.model.User)} method
     * when user is customer and company is null.
     * </p>
     * <p>
     * Expects false is returned.
     * </p>
     ...
     * <p>
     * Tests {@link JiraProfileCompletenessChecker#isProfileComplete(com.topcoder.web.common.model.User)} method
     * when user is customer and company name is null.
     * </p>
     * <p>
     * Expects false is returned.
     * </p>
     ...
     * <p>
     * Tests {@link JiraProfileCompletenessChecker#isProfileComplete(com.topcoder.web.common.model.User)} method
     * when user is customer and demographic responses is null.
     * </p>
     * <p>
     * Expects false is returned.
     * </p>
     ...
     * <p>
     * Tests {@link JiraProfileCompletenessChecker#isProfileComplete(com.topcoder.web.common.model.User)} method
     * when user is customer and demographic responses is empty.
     * </p>
     * <p>
     * Expects false is returned.
     * </p>
     ...
     * <p>
     * Tests {@link JiraProfileCompletenessChecker#isProfileComplete(com.topcoder.web.common.model.User)} method
     * when user is customer and time zone is null.
     * </p>
     * <p>
     * Expects false is returned.
     * </p>
     ...
     * <p>
     * Tests {@link JiraProfileCompletenessChecker#isProfileComplete(com.topcoder.web.common.model.User)} method
     * when user is competitor and coder is null.
     * </p>
     * <p>
     * Expects false is returned.
     * </p>
