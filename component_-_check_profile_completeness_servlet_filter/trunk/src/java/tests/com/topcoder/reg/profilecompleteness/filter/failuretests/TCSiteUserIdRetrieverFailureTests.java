...
/**
 * <p>Failure tests for {@link TCSiteUserIdRetriever} class.</p>
 *
 * @author jmn
 * @version 1.0
 */
public class TCSiteUserIdRetrieverFailureTests {
     ...
     */
    private TCSiteUserIdRetriever instance;
    ...
    public static junit.framework.Test suite() {
        return new JUnit4TestAdapter(TCSiteUserIdRetrieverFailureTests.class);
    }
    ...
    public void setUp() throws Exception {
        ...
        instance = new TCSiteUserIdRetriever();
        instance.setLog(new Log4jLogFactory().createLog("test"));
        instance.setUserSessionKey(USER_SESSION);
    }

    /**
     * <p>Tests <code>{@link TCSiteUserIdRetriever#TCSiteUserIdRetriever()}</code> constructor.</p>
     */
    @Test
    ...
    /**
     * <p>Tests {@link TCSiteUserIdRetriever#getUserId(javax.servlet.http.HttpServletRequest)} method when request is
     * null.</p>
     *
    ...
    /**
     * <p>Tests {@link TCSiteUserIdRetriever#getUserId(javax.servlet.http.HttpServletRequest)} method.</p>
     *
