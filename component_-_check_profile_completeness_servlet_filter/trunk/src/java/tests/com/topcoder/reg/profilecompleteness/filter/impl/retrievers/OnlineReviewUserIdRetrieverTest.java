...
/**
 * Unit tests for <code>OnlineReviewUserIdRetriever</code> class.
 *
 * @author nowind_lee
 * @version 1.0
 */
public class OnlineReviewUserIdRetrieverTest extends TestCase {
    ...
    /**
     * Represents the <code>OnlineReviewUserIdRetriever</code> instance used to test against.
     */
    private OnlineReviewUserIdRetriever t;
    ...
    protected void setUp() throws Exception {
        t = new OnlineReviewUserIdRetriever();
        log = new MockLog();
    ...
    /**
     * Accuracy test for constructor <code>OnlineReviewUserIdRetriever()</code>.
     *
    ...
    public void testGetUserId_Accuracy1() {
        ...
        assertTrue(logMessage
            .contains("[Entering method {OnlineReviewUserIdRetriever.getUserId}]"));
        assertTrue(logMessage
            .contains("[Exiting method {OnlineReviewUserIdRetriever.getUserId}]"));
