 ...
 *
 * <pre>
 * DirectProfileCompletenessChecker checker = new DirectProfileCompletenessChecker();
 ...
 * @version 1.0
 */
public class DirectProfileCompletenessChecker extends BaseProfileCompletenessChecker {

    /**
     * The default do nothing constructor.
     */
    public DirectProfileCompletenessChecker() {
        // do nothing
    }
    ...
    public boolean isProfileComplete(User user) throws ProfileCompletenessCheckerException {
        String method = "DirectProfileCompletenessChecker.isProfileComplete";
    ...
    private boolean check(User user) throws ProfileCompletenessCheckerException {
        if (!super.isProfileComplete(user) || !isCustomer(user)) {
            return false;
        }
        Contact contact = user.getContact();
        Set<DemographicResponse> demographicResponses = user.getDemographicResponses();
        return contact != null && contact.getCompany() != null
