 ...
 *
 * <pre>
 * ForumProfileCompletenessChecker checker = new ForumProfileCompletenessChecker();
 ...
 * @version 1.0
 */
public class ForumProfileCompletenessChecker extends BaseProfileCompletenessChecker {

    /**
     * The default do nothing constructor.
     */
    public ForumProfileCompletenessChecker() {
        // do nothing
    }
    ...
    public boolean isProfileComplete(User user) throws ProfileCompletenessCheckerException {
        String method = "ForumProfileCompletenessChecker.isProfileComplete";
