...
/**
 * Accuracy tests for class <code>ResubmitSpecificationReviewAction</code>.
 *
 * @author onsky
 * @version 1.0
 */
public class ResubmitSpecificationReviewActionAccuracyTest extends TestCase {
    ...
    /**
     * <p>
     * Tests the accuracy of constructor ResubmitSpecificationReviewAction(String).
     * </p>
     *
     * @throws Exception to JUnit.
     */
    public void testResubmitSpecificationReviewAction_Accuracy() throws Exception {
        ResubmitSpecificationReviewAction action = new ResubmitSpecificationReviewAction();
