...
/**
 * <p>
 * The mock <code>ContestServiceFacade</code>.
 * </p>
 *
 * @author moon.river
 * @version 1.0
...
public class MockContestServiceFacade implements ContestServiceFacade {
    ...
    /**
     * The map containing studio competitions used for unit testing.
     */
    private static Map<Long, StudioCompetition> studioCompetitions = new HashMap<Long, StudioCompetition>();

    /**
     * The map containing software competitions used for unit testing.
     */
    ...
    /**
     * Getter for map containing studio competitions used for unit testing.
     *
     * @return map containing studio competitions used for unit testing
     */
    ...
    /**
     * Getter for map containing software competitions used for unit testing.
     *
     * @return map containing software competitions used for unit testing
     */
     ...
     *
     * @throws Exception if some error occurs preparing the mock data
     */
    private static void prepareStudioComps() throws Exception {
        ...
        studioComp.setStartTime(datatypeFactory.newXMLGregorianCalendar(new GregorianCalendar(2010, 1, 1)));
        ...
        studioComp.setStartTime(datatypeFactory.newXMLGregorianCalendar(new GregorianCalendar(2010, 1, 2)));
        studioCompetitions.put(studioComp.getId(), studioComp);

        studioComp = new StudioCompetition();
        studioComp.setId(3);
        studioComp.setCategory("studio category 3");
        studioComp.setStartTime(datatypeFactory.newXMLGregorianCalendar(new GregorianCalendar(2010, 1, 3)));
        studioCompetitions.put(studioComp.getId(), studioComp);

        studioComp = new StudioCompetition();
        studioComp.setId(4);
        studioComp.getContestData().setName("studio comp4");
        studioComp.setStartTime(datatypeFactory.newXMLGregorianCalendar(new GregorianCalendar(2010, 1, 4)));
        studioCompetitions.put(studioComp.getId(), studioComp);
    }
    ...
    private static void prepareSoftwareComps() {
        ...
        softwareComp.setProjectData(new FullProjectData());
        softwareComp.getProjectData().setStartDate(new GregorianCalendar(2010, 2, 1).getTime());
        softwareCompetitions.put(softwareComp.getId(), softwareComp);

        softwareComp = new SoftwareCompetition();
        softwareComp.setId(2);
        softwareComp.setProjectData(new FullProjectData());
        softwareComp.getProjectData().setStartDate(new GregorianCalendar(2010, 2, 2).getTime());
        softwareCompetitions.put(softwareComp.getId(), softwareComp);

        softwareComp = new SoftwareCompetition();
        softwareComp.setId(3);
        softwareComp.setProjectData(new FullProjectData());
        softwareComp.getProjectData().setStartDate(new GregorianCalendar(2010, 2, 3).getTime());
        softwareCompetitions.put(softwareComp.getId(), softwareComp);
    }
     ...
     * @throws Exception if some error occurs preparing the mock data
     */
    public static void initMockData() throws Exception {
        prepareStudioComps();
