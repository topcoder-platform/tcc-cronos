...
/**
 * <p>
 * This action is responsible for handling the request to view a specification review.
 * It extends <code>SpecificationReviewAction</code>.
 * </p>
 *
 * <p>
 * <code>SpecificationReviewService</code> and <code>SpecReviewCommentService</code> are used to
 * perform the request. The result data is aggregated into <code>ViewSpecificationReviewActionResultData</code>.
 * </p>
 *
 * <p>
...
public class ViewSpecificationReviewAction extends SpecificationReviewAction {
    ...
    /**
     * <p>
     * Represents the specification review service used to retrieve the specification review and its status.
     * </p>
     *
     * <p>
     * Initially set to null, once set cannot be null. It set by setter and accessed by getter. Used
    ...
    /**
     * <p>
     * Represents the specification review comment service used to retrieve the specification review comments.
     * </p>
     *
     * <p>
     * Initially set to null, once set cannot be null. It set by setter and accessed by getter. Used
     ...
     * <code>ViewSpecificationReviewActionException</code> with a proper message, stored in the model
     * using the <code>setException</code> method, and <code>Action.ERROR</code> is returned.
     * </p>
     *
     * <p>
     * If any required field hasn't been injected then <code>ViewSpecificationReviewActionException</code>
    ...
    public String execute() {
        try {
            ...
            if (specReviewCommentService == null) {
                return Helper.handleActionError(this, new ViewSpecificationReviewActionException(
            ...
            SpecificationReview specificationReview =
                specificationReviewService.getSpecificationReview(getTCSubject(), getContestId());
            SpecificationReviewStatus specificationReviewStatus =
                specificationReviewService.getSpecificationReviewStatus(getTCSubject(), getContestId());
            List<SpecReviewComment> specReviewComments =
                specReviewCommentService.getSpecReviewComments(getTCSubject(), getContestId(), isStudio());
            ...
            return Helper.handleActionError(this, new ViewSpecificationReviewActionException(
                "An error occurred in execute method for ViewSpecificationReviewAction.", e));
        }
    }
