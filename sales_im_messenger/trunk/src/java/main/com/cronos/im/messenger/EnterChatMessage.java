...
/**
 * <p>
 * This is the message to signal a user to enter a chat session, after he has accepted for chatting.
 ...
 * @version 1.0
 */
public class EnterChatMessage extends XMLMessage {

    /**
     * Create a new message instance.
     */
    public EnterChatMessage() {
    }

    /**
     * Return the xml representation of the message.
     * The xml string must follow the xsd scheme located in docs/EnterChatMessage.xsd.
    ...
    public String toXMLString(DateFormatContext context)
        ...
        try {
            ...
            xmlStringBuffer.append("<message type=\"EnterChatMessage\">");
            ...
            sbMessage.append("Exception occurred when building xml message: ")
                .append(e.getMessage());
