...
/**
 * <p>
 * This exception is thrown by implementations of ReviewPaymentCalculator when some unexpected error occurs. Also this
...
public class ReviewPaymentCalculatorException extends BaseCriticalException {
     ...
     */
    public ReviewPaymentCalculatorException(String message) {
        super(message);
    }
     ...
     */
    public ReviewPaymentCalculatorException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     */
    public ReviewPaymentCalculatorException(String message, ExceptionData data) {
        super(message, data);
    }
     ...
     *            ExceptionData() will be automatically used instead.
     */
    public ReviewPaymentCalculatorException(String message, Throwable cause, ExceptionData data) {
