...
/**
 * <p>
 * This exception is thrown by implementations of ReviewPaymentCalculator when some error occurs while initializing an
...
public class ReviewPaymentCalculatorConfigurationException extends BaseRuntimeException {
     ...
     */
    public ReviewPaymentCalculatorConfigurationException(String message) {
        super(message);
    }
     ...
     */
    public ReviewPaymentCalculatorConfigurationException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     */
    public ReviewPaymentCalculatorConfigurationException(String message, ExceptionData data) {
        super(message, data);
    }
     ...
     *            ExceptionData() will be automatically used instead.
     */
    public ReviewPaymentCalculatorConfigurationException(String message, Throwable cause, ExceptionData data) {
