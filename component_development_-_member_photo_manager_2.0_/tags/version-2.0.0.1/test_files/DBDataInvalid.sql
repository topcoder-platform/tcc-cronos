...
INSERT INTO member_image(member_image_id,member_id,image_id,removed,created_by,created_date,updated_by,updated_date) VALUES(2,222444555,2,'F','admin',TO_DATE('2011-14-01 12:00:00', '%Y-%d-%m %H:%M:%S'),'admin',TO_DATE('2011-14-01 12:00:00', '%Y-%d-%m %H:%M:%S'));
