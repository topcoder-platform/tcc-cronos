...
/**
 * <p>
 * This interface represents the MemberPhotoManager interface. This interface defines the specific methods available
 * for the MemberPhotoManager interface: retrieve member photo, save member photo and remove member photo.
 * </p>
 *
 * <p>
...
public interface MemberPhotoManager {
    ...
    /**
     * <p>
     * Defines the operation that saves a member photo for the given image and member id in the
     * persistence.
     * </p>
     *
     * <p>
    ...
    /**
     * <p>
     * Defines the operation that saves a member photo for the given file name and member id in
     * the persistence.
     * </p>
     *
     * <p>
