 ...
 * Auction Persistence will be released this class can be safely removed.
 * </p>
 * <p>
 * <b>The documentation is left as it was in the development distribution of the Auction Persistence
 * component.</b>
 * </p>
 * <p>
...
public class CustomBid implements Bid {
    ...
    /**
     * <p>
     * Represents the maximum amount a sponsor is willing to pay. It will be set in the constructor,
     * and will not change. Accessed via the getter.
     * </p>
     * <p>
     * This number will be non-negative once set, but this is up to the persistence to decide what
     * is allowed.
     ...
     * @param maxAmount the maximum amount of this bid
