...
final class TestsHelper {
     ...
     * </p>
     */
    static final String CONFIG_FILE = "failuretests/config.xml";
     ...
     * </p>
     * @param type
     *            type attribute of the handler tag.
     * @param children
     *            child tags of the handler tag.
     * @param values
     *            values of the child tags.
     * @return create handler Element.
     * @throws Exception
     *             to JUnit.
     */
    static Element createHandlerElement(String type, String[] children, String[] values) throws Exception {
