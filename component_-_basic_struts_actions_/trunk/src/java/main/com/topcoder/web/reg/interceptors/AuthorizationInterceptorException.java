 ...
 * @version 1.0
 */
public class AuthorizationInterceptorException extends BaseCriticalException {
    /**
     * <p>
     ...
     */
    public AuthorizationInterceptorException(String message) {
        super(message);
    }
     ...
     */
    public AuthorizationInterceptorException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     *            the exception data.
     */
    public AuthorizationInterceptorException(String message, ExceptionData data) {
        super(message, data);
    }
     ...
     *            the exception data.
     */
    public AuthorizationInterceptorException(String message, Throwable cause, ExceptionData data) {
