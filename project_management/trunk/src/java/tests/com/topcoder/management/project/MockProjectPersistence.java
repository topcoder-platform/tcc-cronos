...
public class MockProjectPersistence implements ProjectPersistence {
    ...
    public ProjectType[] getAllProjectTypes() throws PersistenceException {
        return new ProjectType[]{
            new ProjectType(1, "type1"),
            new ProjectType(2, "type2")
        };
    }
    ...
    public ProjectCategory[] getAllProjectCategories() throws PersistenceException {
        return new ProjectCategory[]{
            new ProjectCategory(1, "category1", getAllProjectTypes()[0]),
    ...
    public ProjectStatus[] getAllProjectStatuses() throws PersistenceException {
        return new ProjectStatus[]{
            new ProjectStatus(1, "status1"),
            new ProjectStatus(2, "status2")
        };
    }
    ...
    public ProjectPropertyType[] getAllProjectPropertyTypes() throws PersistenceException {
        return new ProjectPropertyType[]{
            new ProjectPropertyType(1, "propertyType1"),
