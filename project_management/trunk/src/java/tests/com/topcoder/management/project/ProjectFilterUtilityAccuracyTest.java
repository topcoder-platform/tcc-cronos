...
public class ProjectFilterUtilityAccuracyTest extends TestCase {
    ...
    /**
     * Accuracy test of <code>buildTypeIdEqualFilter(long typeId)</code>
     * method.
     *
     * @throws Exception
     *             throw exception to JUnit.
    ...
    /**
     * Accuracy test of <code>buildTypeNameEqualFilter(String name)</code>
     * method.
     *
     * @throws Exception
     *             throw exception to JUnit.
    ...
    /**
     * Accuracy test of <code>buildCategoryIdEqualFilter(long categoryId)</code>
     * method.
     *
     * @throws Exception
     *             throw exception to JUnit.
    ...
    /**
     * Accuracy test of <code>buildCategoryIdInFilter(List categoryIds)</code>
     * method.
     *
     * @throws Exception
     *             throw exception to JUnit.
    ...
    /**
     * Accuracy test of <code>buildCategoryNameEqualFilter(String name)</code>
     * method.
     *
     * @throws Exception
     *             throw exception to JUnit.
    ...
    /**
     * Accuracy test of <code>buildCategoryNameInFilter(List names)</code>
     * method.
     *
     * @throws Exception
     *             throw exception to JUnit.
    ...
    /**
     * Accuracy test of <code>buildStatusIdEqualFilter(long statusId)</code>
     * method.
     *
     * @throws Exception
     *             throw exception to JUnit.
    ...
    /**
     * Accuracy test of <code>buildStatusIdInFilter(List statusIds)</code>
     * method.
     *
     * @throws Exception
     *             throw exception to JUnit.
    ...
    /**
     * Accuracy test of <code>buildStatusNameEqualFilter(String name)</code>
     * method.
     *
     * @throws Exception
     *             throw exception to JUnit.
    ...
    /**
     * Accuracy test of <code>buildStatusNameInFilter(List names)</code>
     * method.
     *
     * @throws Exception
     *             throw exception to JUnit.
    ...
    /**
     * Accuracy test of
     * <code>buildProjectPropertyNameEqualFilter(String name)</code> method.
     *
     * @throws Exception
     *             throw exception to JUnit.
     */
    ...
    /**
     * Accuracy test of
     * <code>buildProjectPropertyNameInFilter(List names)</code> method.
     *
     * @throws Exception
     *             throw exception to JUnit.
     */
    ...
    /**
     * Accuracy test of
     * <code>buildProjectPropertyValueEqualFilter(String value)</code> method.
     *
     * @throws Exception
     *             throw exception to JUnit.
     */
    ...
    /**
     * Accuracy test of
     * <code>buildProjectPropertyValueInFilter(List values)</code> method.
     *
     * @throws Exception
     *             throw exception to JUnit.
     */
    ...
    /**
     * Accuracy test of
     * <code>buildProjectPropertyEqualFilter(String name, String value)</code>
     * method.
     *
     * @throws Exception
     *             throw exception to JUnit.
    ...
    /**
     * Accuracy test of
     * <code>buildProjectResourcePropertyNameEqualFilter(String name)</code>
     * method.
     *
     * @throws Exception
     *             throw exception to JUnit.
    ...
    /**
     * Accuracy test of
     * <code>buildProjectResourcePropertyNameInFilter(List names)</code>
     * method.
     *
     * @throws Exception
     *             throw exception to JUnit.
    ...
    /**
     * Accuracy test of
     * <code>buildProjectResourcePropertyValueEqualFilter(String value)</code>
     * method.
     *
     * @throws Exception
     *             throw exception to JUnit.
    ...
    /**
     * Accuracy test of
     * <code>buildProjectPropertyResourceEqualFilter(String name, String value)</code>
     * method.
     *
     * @throws Exception
     *             throw exception to JUnit.
    ...
    public void testBuildProjectPropertyResourceEqualFilterAccuracy() throws Exception {
        AndFilter filter = (AndFilter) ProjectFilterUtility.buildProjectPropertyResourceEqualFilter("name",
            "value");
        List filterList = filter.getFilters();
        assertEquals("length is incorrect.", 2, filterList.size());
        EqualToFilter f1 = (EqualToFilter) filterList.get(0);
    ...
    /**
     * Accuracy test of <code>buildAndFilter(Filter f1, Filter f2)</code>
     * method.
     *
     * @throws Exception
     *             throw exception to JUnit.
    ...
    /**
     * Accuracy test of <code>buildOrFilter(Filter f1, Filter f2)</code>
     * method.
     *
     * @throws Exception
     *             throw exception to JUnit.
