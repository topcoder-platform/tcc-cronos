...
/**
 * <p>This exception is thrown by a phase handler when the input phase is not the type the handler can handle. For
 * example, ScreeningPhaseHandler can only handle Screening phases.</p>
