...
public class SubmissionPhaseHandler extends AbstractPhaseHandler {
     ...
     */
    public SubmissionPhaseHandler(String namespace)
    ...
    public boolean canPerform(Phase phase) throws PhaseHandlingException {
        ...
        if (toStart) {
            ...
            return (dependencyMet && reachEndTime && (arePassedSubmissionsEnough(phase) || !hasAnySubmission(phase)));
        }
    }
    ...
    public void perform(Phase phase, String operator)
        ...
        if (!toStart && !hasAnySubmission(phase)) {
            System.out.println("===========");
     ...
     */
    private boolean hasAnySubmission(Phase phase) throws PhaseHandlingException {
     ...
     */
    private boolean arePassedSubmissionsEnough(Phase phase)
                    throws PhaseHandlingException {
     ...
     */
    private int getManualScreeningPasses(Phase phase)
                    throws PhaseHandlingException {
        Connection conn = null;
        try {
            conn = createConnection();
     ...
     * @throws PhaseHandlingException in case of retrieval error.
     */
    private int getAutoScreeningPasses(Phase phase)
                    throws PhaseHandlingException {
