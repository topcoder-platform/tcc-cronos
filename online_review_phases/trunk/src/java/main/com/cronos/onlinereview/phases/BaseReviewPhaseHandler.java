 ...
 * Review  and Milestone Review phases. If the input is of other phase types, PhaseNotSupportedException will be thrown.
 * </p>
 * <p>
 ...
 * <li>There is at least one active Contest Submission or Milestone Submission.</li>
 * </ul>
 ...
 * </p>
 * @author tuenm, bose_java, argolite, waits, saarixx, myxgyy, FireIce, microsky, flexme, VolodymyrK
 * @version 1.7.5
 */
abstract class BaseReviewPhaseHandler extends AbstractPhaseHandler {

    /**
     * Indicates whether the handler is for the "Milestone Review" phase or for the "Review" phase.
     */
     ...
     * @param isMilestone
     *            True if the phase type is "Milestone Review" and false for "Review" phase type
     * @throws ConfigurationException
     *             if errors occurred while loading configuration settings.
     * @throws IllegalArgumentException
     *             if the input is null or empty string.
     */
    public BaseReviewPhaseHandler(String namespace, boolean isMilestone) throws ConfigurationException {
        super(namespace);
        this.isMilestone = isMilestone;

        if (isMilestone) {
            phaseTypeName = Constants.PHASE_MILESTONE_REVIEW;
            submissionTypeName = Constants.SUBMISSION_TYPE_MILESTONE_SUBMISSION;
            reviewerRoleNames = new String[] {Constants.ROLE_MILESTONE_REVIEWER };
        } else {
     ...
     *             if the input phase type is not "Review" or "Milestone Review" type.
    ...
    private void updateSubmissionScores(Phase phase, String operator, Map<String, Object> values)
        ...
        try {
            ...
            Submission[] subs = PhasesHelper.updateSubmissionsResults(getManagerHelper(), phase, operator,
                true, isMilestone || isStudioProject || appealsResponsePhase == null);
