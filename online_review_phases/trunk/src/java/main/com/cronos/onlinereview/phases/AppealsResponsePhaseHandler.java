 ...
 * appeals response phase. If the input is of other phase types, PhaseNotSupportedException will be thrown.</p>
 *  <p>The appeals response phase can start as soon as the dependencies are met and can stop when the following
 * conditions met: The dependencies are met and all appeals are resolved.</p>
 *  <p>The additional logic for executing this phase is:<br> When Appeals Response is stopping:
 *  <ul>
...
public class AppealsResponsePhaseHandler extends AbstractPhaseHandler {
     ...
     */
    public AppealsResponsePhaseHandler(String namespace)
     ...
     * following conditions: The dependencies are met and All appeals are resolved.</p>
     ...
     *
     * @throws PhaseNotSupportedException if the input phase type is not "Appeals Response" type.
     ...
     *  <p>If the input phase status is Scheduled, then it will do nothing.</p>
     *  <p>If the input phase status is Open, then it will perform the following additional logic to stop the
     * phase:</p>
     *  <ul>
     *      <li>All submissions with failed review scores will be set to the status &quot;Failed
     *      Review&quot;.</li>
     *      <li>Overall score for the passing submissions will be calculated and saved to the
     *      submitters&#146; resource properties together with their placements. The property names are &quot;Final
     *      Score&quot; and &quot;Placement&quot;.</li>
     *      <li>The winner and runner-up will be populated in the project properties. The property names
     *      are &quot;Winner External Reference ID&quot; and &quot;Runner-up External Reference ID&quot;.</li>
     *      <li>Submissions that do not win will be set to the status &quot;Completed Without Win&quot;.</li>
     *  </ul>
     *  <p>If the input phase status is Closed, then PhaseHandlingException will be thrown.</p>
     *
     ...
     */
    private void updateSubmissions(Phase phase, String operator)
