...
/**
 * <p>This class provides the function to get lookup id for a lookup name from the &quot;notification_type_lu&quot;
 * table. Since lookup id/value pairs do not change in the database per installation, this classe caches the id/value
...
public class NotificationTypeLookupUtility {
    ...
    /**
     * Gets the &quot;upload_type_id&quot; for the given value for &quot;name&quot; from
     * &quot;notification_type_lu&quot; table. This method uses caching mechanism for id/value pairs to minimize
     * queries to the database. Hence if the lookup id is present in the cache, it is returned without hitting
     * the database. It is synchronized to ensure thread safety.
     *
