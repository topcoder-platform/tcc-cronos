...
public class ManagerHelper {
     ...
     * ResourceManager instance.
     */
    private static final String PROP_RESOURCE_MGR_RESOURCE_ROLE_BUNDLE_NAME = "ResourceManager.ResourceRoleSearchBundleName";

    /**
     * Property name constant for notification search bundle name when creating
     * ResourceManager instance.
     */
    private static final String PROP_RESOURCE_MGR_NOTIFICATION_BUNDLE_NAME = "ResourceManager.NotificationSearchBundleName";

    /**
     * Property name constant for notification type search bundle name when
     * creating ResourceManager instance.
     */
    private static final String PROP_RESOURCE_MGR_NOTIFICATION_TYPE_BUNDLE_NAME = "ResourceManager.NotificationTypeSearchBundleName";
     ...
     * ResourceManager instance.
     */
    private static final String PROP_RESOURCE_MGR_NOTIFICATION_TYPE_IDGEN_NAME = "ResourceManager.NotificationTypeIdGeneratorName";

    /**
     * Property name constant for resource role IDgenerator name when creating
     * ResourceManager instance.
     */
    private static final String PROP_RESOURCE_MGR_RESOURCE_ROLE_IDGEN_NAME = "ResourceManager.ResourceRoleIdGeneratorName";
     ...
     */
    private static final String PROP_UPLOAD_MGR_SUBMISSION_STATUS_IDGEN_NAME = "UploadManager.SubmissionStatusIdGeneratorName";
    ...
    private UploadManager initUploadManager(String namespace)
        ...
        Object[] params = new Object[] {persistence, uploadSearchBundle,
                        submissionSearchBundle, uploadIdGenerator,
                        uploadTypeIdGenerator, uploadStatusIdGenerator,
                        submissionIdGenerator, submissionStatusIdGenerator};
        Class[] paramTypes = new Class[] {UploadPersistence.class,
     ...
     */
    private ReviewScoreAggregator initScorecardAggregator(String namespace)
                    throws ConfigurationException {
    ...
    private Object createObject(String className, Class expectedType,
        ...
        try {
            ...
            System.out.println(className + " fater");
            return obj;
