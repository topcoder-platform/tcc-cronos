...
public class FinalFixPhaseHandlerTest extends BaseTest {
    ...
    public void testCanPerformWithScheduled() throws Exception {
        ...
        try {
	        ...
	        assertTrue("canPerform should have returned true", handler.canPerform(finalFixPhase));
        } finally {
        	cleanTables();
        }
    }
    ...
    public void testPerformWithScheduled() throws Exception {
        ...
        try {
	        ...
	        Review review1 = createReview(11, aggregator.getId(), submission1.getId(), scorecard1.getId(), true, 80.0f);
            ...
            insertComments(conn, new long[] {1}, new long[] {aggregator.getId()},
                    new long[] {review1.getId()}, new String[] {"comment 1"},
                    new long[] {1});
            ...
            finalWorksheet = PhasesHelper.getFinalReviewWorksheet(conn, handler.getManagerHelper(),
                    finalReviewPhase.getId());
            ...
            assertEquals("review item comments not accepted should not be copied", 0,
