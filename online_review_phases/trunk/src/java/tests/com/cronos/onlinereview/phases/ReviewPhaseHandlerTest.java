...
public class ReviewPhaseHandlerTest extends BaseTest {
    ...
    /**
     * Tests the ReviewPhaseHandler() constructor and canPerform with Scheduled
     * statuses.
     *
     * @throws Exception not under test.
     */
    public void testCanPerformWithScheduled() throws Exception {
        ...
        try {
            ...
            reviewPhase.getAllDependencies()[0].getDependency().setPhaseStatus(
                            PhaseStatus.CLOSED);
    ...
    /**
     * Tests the ReviewPhaseHandler() constructor and canPerform with Open
     * statuses.
     *
     * @throws Exception not under test.
     */
