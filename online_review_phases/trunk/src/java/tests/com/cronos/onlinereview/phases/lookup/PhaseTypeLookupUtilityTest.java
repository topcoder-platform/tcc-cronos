...
public class PhaseTypeLookupUtilityTest extends BaseTest {
    ...
    /**
     * Tests the PhaseTypeLookupUtility.lookUpId(Connection, String) with null connection.
     *
    ...
    /**
     * Tests the PhaseTypeLookupUtility.lookUpId(Connection, String) with null value.
     *
     * @throws Exception not under test.
     */
    ...
    /**
     * Tests the PhaseTypeLookupUtility.lookUpId(Connection, String) with empty value.
     *
     * @throws Exception not under test.
     */
    ...
    /**
     * Tests whether PhaseTypeLookupUtility.lookUpId(Connection, String) returns correct value.
     *
     * @throws Exception not under test.
     */
    ...
    /**
     * Tests the PhaseTypeLookupUtility.lookUpId(Connection, String) with a value that is not mapped to
