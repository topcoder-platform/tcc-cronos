...
public class UploadStatusLookupUtilityTest extends BaseTest {
    ...
    /**
     * Tests the UploadStatusLookupUtility.lookUpId(Connection, String) with null connection.
     *
    ...
    /**
     * Tests the UploadStatusLookupUtility.lookUpId(Connection, String) with null value.
     *
     * @throws Exception not under test.
     */
    ...
    /**
     * Tests the UploadStatusLookupUtility.lookUpId(Connection, String) with empty value.
     *
     * @throws Exception not under test.
     */
    ...
    /**
     * Tests whether UploadStatusLookupUtility.lookUpId(Connection, String) returns correct value.
     *
     * @throws Exception not under test.
     */
    ...
    /**
     * Tests the UploadStatusLookupUtility.lookUpId(Connection, String) with a value that is not mapped to
