...
/**
 * <p>Stress tests for <code>AggregationReviewPhaseHandler</code>.</p>
 * <p>
...
public class AggregationReviewPhaseHandlerTest extends StressBaseTest {
     ...
     */
    private AggregationReviewPhaseHandler handler;
    ...
    protected void setUp() throws Exception {
        ...
        handler = new AggregationReviewPhaseHandler("com.cronos.onlinereview.phases.OtherHandler");
        Project project = new Project(new Date(), new DefaultWorkdays());
        phase = new Phase(project, DEFAULT_ID);

        // set a phase type to the phase
        PhaseType type = new PhaseType(DEFAULT_ID, "Aggregation Review");
        phase.setPhaseType(type);

        // set a phase status to the phase
        PhaseStatus status = new PhaseStatus(DEFAULT_ID, "Open");
