...
public class ResourceRoleLookupUtilityTest extends BaseTest {
    ...
    /**
     * Tests the ResourceRoleLookupUtility.lookUpId(Connection, String) with null connection.
     *
    ...
    /**
     * Tests the ResourceRoleLookupUtility.lookUpId(Connection, String) with null value.
     *
     * @throws Exception not under test.
     */
    ...
    /**
     * Tests the ResourceRoleLookupUtility.lookUpId(Connection, String) with empty value.
     *
     * @throws Exception not under test.
     */
    ...
    /**
     * Tests whether ResourceRoleLookupUtility.lookUpId(Connection, String) returns correct value.
     *
     * @throws Exception not under test.
     */
    ...
    /**
     * Tests the ResourceRoleLookupUtility.lookUpId(Connection, String) with a value that is not mapped to
