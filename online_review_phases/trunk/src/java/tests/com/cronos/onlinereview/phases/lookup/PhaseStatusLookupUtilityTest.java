...
public class PhaseStatusLookupUtilityTest extends BaseTest {
    ...
    /**
     * Tests the PhaseStatusLookupUtility.lookUpId(Connection, String) with null connection.
     *
    ...
    /**
     * Tests the PhaseStatusLookupUtility.lookUpId(Connection, String) with null value.
     *
     * @throws Exception not under test.
     */
    ...
    /**
     * Tests the PhaseStatusLookupUtility.lookUpId(Connection, String) with empty value.
     *
     * @throws Exception not under test.
     */
    ...
    /**
     * Tests whether PhaseStatusLookupUtility.lookUpId(Connection, String) returns correct value.
     *
     * @throws Exception not under test.
     */
    ...
    /**
     * Tests the PhaseStatusLookupUtility.lookUpId(Connection, String) with a value that is not mapped to
