...
public class AppealsResponsePhaseHandlerTest extends BaseTest {
    ...
    public void testCanPerformHandlerWithOpen() throws Exception {
        ...
        try {
            ...
            appealsResponsePhase.getAllDependencies()[0]
    ...
    public void testPerformWithOpenNoWinner() throws Exception {
        ...
        try {
            ...
            insertReviews(conn, new Review[] {review1, review2, review3,
                            review4});
            ...
            com.topcoder.management.project.Project project1 = handler
                            .getManagerHelper().getProjectManager().getProject(
                                            1);
            assertNull("No winner expected", project1
                            .getProperty("Winner External Reference ID"));
            assertNull("No runner up expected", project1
                            .getProperty("Runner-up External Reference ID"));

            // Added in version 1.1
            assertTrue("The post-mortem phase should be inserted.",
