...
public class AppealsResponsePhaseHandler extends AbstractPhaseHandler {
    ...
    public void perform(Phase phase, String operator)
        ...
        if (!toStart) {
            ...
            if (!updateSubmissions(phase, operator)) {
     ...
     * @version 1.1
     */
    private boolean updateSubmissions(Phase phase, String operator)
                    throws PhaseHandlingException {
    ...
    private RankedSubmission breakTies(RankedSubmission submission,
                    Submission[] submissions, RankedSubmission[] placements)
                    throws PhaseHandlingException {
     ...
     */
    private boolean allAppealsResolved(Phase phase)
                    throws PhaseHandlingException {
