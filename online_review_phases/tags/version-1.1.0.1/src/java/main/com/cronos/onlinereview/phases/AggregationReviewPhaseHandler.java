...
public class AggregationReviewPhaseHandler extends AbstractPhaseHandler {
        ...
        if (toStart) {
            ...
            if (PhasesHelper.reachedPhaseEndTime(phase)
                ...
                try {
                    log
                                    .log(Level.DEBUG,
                                                    "Automatically approving pending aggregation reviews");
     ...
     * @since 1.1
     */
    private void approvePendingAggregationReview(Phase phase)
                    throws PhaseHandlingException {
        ...
        try {
            ...
            if (rejected) {
                ...
                int currentPhaseIndex = PhasesHelper.createNewPhases(
                                currentPrj, phase, new PhaseType[] {
                                                aggPhaseType,
                                                aggReviewPhaseType},
     ...
     * @throws PhaseHandlingException if an error occurs when retrieving data.
     */
    private Review getAggregationWorksheet(Phase phase)
                    throws PhaseHandlingException {
        ...
        for (int i = 0; i < comments.length; i++) {
            ...
            if (comment.getCommentType().getName().equals(commentType)
                            && ("Approved".equalsIgnoreCase(extraInfo)
                                            || "Accepted"
                                                            .equalsIgnoreCase(extraInfo) || "Rejected"
