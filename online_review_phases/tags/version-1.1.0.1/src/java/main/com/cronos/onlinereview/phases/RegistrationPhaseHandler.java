...
public class RegistrationPhaseHandler extends AbstractPhaseHandler {
     ...
     */
    public RegistrationPhaseHandler(String namespace)
    ...
    public boolean canPerform(Phase phase) throws PhaseHandlingException {
        ...
        if (toStart) {
            ...
            return (dependencyMet && reachedEndTime && (areRegistrationsEnough(phase) || isRegistrationEmpty(phase)));
        }
    }
    ...
    public void perform(Phase phase, String operator)
        ...
        if (!toStart && isRegistrationEmpty(phase)) {
     ...
     *         processing the phase.
     */
    private boolean isRegistrationEmpty(Phase phase)
                    throws PhaseHandlingException {
     ...
     *         processing the phase.
     */
    private boolean areRegistrationsEnough(Phase phase)
                    throws PhaseHandlingException {
     ...
     */
    private Resource[] searchResources(Phase phase)
                    throws PhaseHandlingException {
