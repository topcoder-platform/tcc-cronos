 ...
 * </p>
 * 
 * @author tuenm, bose_java, pulky, aroglite, TCSDEVELOPER
 * @version 1.1
 */
final class PhasesHelper {
    ...
    static Review[] searchReviewsForResourceRoles(Connection conn,
        ...
        try {
            ...
            Filter fullFilter = SearchBundle.buildAndFilter(resourceRoleFilter,
                            phaseIdFilter);
            Resource[] reviewers = managerHelper.getResourceManager()
            ...
            throw new PhaseHandlingException("Problem with resource retrieval",
                            e);
    ...
    static Submission[] searchSubmissionsForProject(
                    UploadManager uploadManager, long projectId)
                    throws PhaseHandlingException {
    ...
    static Resource[] searchResourcesForRoleNames(ManagerHelper managerHelper,
                    Connection conn, String[] resourceRoleNames, long phaseId)
                    throws PhaseHandlingException {
        List resourceRoleIds = new ArrayList();
    ...
    static Submission[] searchActiveSubmissions(UploadManager uploadManager,
                    Connection conn, long projectId)
                    throws PhaseHandlingException, SQLException {
    ...
    static Review getFinalReviewWorksheet(Connection conn,
                    ManagerHelper managerHelper, long finalReviewPhaseId)
                    throws PhaseHandlingException, SQLException {
        Review[] reviews = searchReviewsForResourceRoles(conn, managerHelper,
            ...
            if (winnerId != null) {
                ...
                AndFilter fullFilter = new AndFilter(
                                Arrays
                                                .asList(new Filter[] {
                                                                ResourceFilterBuilder
                                                                                .createResourceRoleIdFilter(submitterRoleId),
                                                                ResourceFilterBuilder
                                                                                .createProjectIdFilter(projectId),
                                                                ResourceFilterBuilder
                                                                                .createExtensionPropertyNameFilter("External Reference ID"),
                                                                ResourceFilterBuilder
                                                                                .createExtensionPropertyValueFilter(winnerId)}));
    ...
    static int insertFinalFixAndFinalReview(Phase currentPhase,
        ...
        int currentPhaseIndex = PhasesHelper.createNewPhases(currentPrj,
                        currentPhase, new PhaseType[] {finalFixPhaseType,
                                        finalReviewPhaseType}, phaseStatus,
                        phaseManager, operator);
     ...
     * 
     * @throws PhaseManagementException if there was a problem persisting the
     *         phases.
     */
            ...
            AndFilter fullFilter = new AndFilter(
                            Arrays
                                            .asList(new Filter[] {
                                                            ...
                                                            ResourceFilterBuilder
                                                                            .createExtensionPropertyValueFilter(YES_VALUE)}));
