...
public class SubmissionPhaseHandlerAccTestsV11 extends BaseTestCase {
    ...
    public void testCanPerform1() throws Exception {
        ...
        submission.getAllDependencies()[0].getDependency()
    ...
    public void testCanPerform2() throws Exception {
        ...
        // time has passed, but dependency not met.
        submissionPhase.setActualStartDate(new Date(System.currentTimeMillis()
                - 1000));
        ...
        Resource submitter = super.createResource(1, submissionPhase.getId(),
                1, 1);
        ...
        Scorecard scorecard = createScorecard(1, 1, 1, 1, "name", "1.0", 75.0f,
                100.0f);
        Review review = createReview(1, reviewer1.getId(), submission.getId(),
                scorecard.getId(), true, 80.0f);
    ...
    /**
     * Tests the perform with Scheduled and Open statuses and checks
     * whether a post-mortem phase is inserted when there is no submission.
     *
     * @throws Exception to JUnit.
     */
    ...
    /**
     * Tests the perform with Open statuses and a post-mortem phase
     * should NOT be inserted when there are submissions.
     *
     * @throws Exception to JUnit.
     */
    public void testPerform2() throws Exception {
        ...
        Upload upload = super.createUpload(1, project.getId(),
                resource.getId(), 1, 1, "Paramter");
