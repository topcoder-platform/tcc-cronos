...
public class ApprovalPhaseHandlerAccTestsV11 extends BaseTestCase {
    ...
    /**
     * Test the method perform with a rejected approval review, the new
     * final review final fix phases should be inserted.
     *
     * @throws Exception to JUnit
     */
    public void testPerform1() throws Exception {
        ...
        frWorksheet.addComment(createComment(1, approver.getId(), "Rejected",
