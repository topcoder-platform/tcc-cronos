...
/**
 * <p>Stress tests for <code>SubmissionPhaseHandler</code>.</p>
 * <p>
...
public class SubmissionPhaseHandlerTest extends StressBaseTest {
    ...
    protected void setUp() throws Exception {
        ...
        handler = new SubmissionPhaseHandler("com.cronos.onlinereview.phases.OtherHandler");
        Project project = new Project(new Date(), new DefaultWorkdays());
        phase = new Phase(project, DEFAULT_ID);

        // set a phase type to the phase
        PhaseType type = new PhaseType(DEFAULT_ID, "Submission");
