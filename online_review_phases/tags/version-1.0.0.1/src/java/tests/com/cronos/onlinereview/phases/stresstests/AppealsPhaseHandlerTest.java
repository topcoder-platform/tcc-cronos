...
/**
 * <p>Stress tests for <code>AppealsPhaseHandler</code>.</p>
 * <p>
...
public class AppealsPhaseHandlerTest extends StressBaseTest {
     ...
     */
    private AppealsPhaseHandler handler;
    ...
    protected void setUp() throws Exception {
        ...
        handler = new AppealsPhaseHandler("com.cronos.onlinereview.phases.OtherHandler");
        Project project = new Project(new Date(), new DefaultWorkdays());
        phase = new Phase(project, DEFAULT_ID);

        // set a phase type to the phase
        PhaseType type = new PhaseType(DEFAULT_ID, "Appeals");
