...
public class MilestoneScreeningPhaseHandlerTest extends BaseTest {
    ...
    /**
     * <p>
     * Represents the MilestoneScreeningPhaseHandler instance for testing.
     * </p>
     */
    private MilestoneScreeningPhaseHandler handler;
    ...
    public void testCtor() throws Exception {
        handler = new MilestoneScreeningPhaseHandler();
    ...
    public void testCtor2() throws Exception {
        handler = new MilestoneScreeningPhaseHandler(PHASE_HANDLER_NAMESPACE);
    ...
    public void testCanPerformWithInvalidStatus() throws Exception {
        ...
        try {
            Phase phase = createPhase(1, 1, "Invalid", 3, "Milestone Screening");
    ...
    public void testPerformWithInvalidStatus() throws Exception {
        ...
        try {
            Phase phase = createPhase(1, 1, "Invalid", 1, "Milestone Screening");
    ...
    /**
     * <p>
     * Tests the MilestoneScreeningPhaseHandler() constructor and canPerform with Scheduled statuses.
     * </p>
     * <p>
    ...
    /**
     * <p>
     * Tests the MilestoneScreeningPhaseHandler() constructor and canPerform with Open statuses.
     * </p>
     * <p>
     * If the conditions meets, should return true, otherwise return false.
     * </p>
    ...
    public void testPerformWithNullOperator() throws Exception {
        ...
        try {
            Phase phase = createPhase(1, 1, "Scheduled", 1, "Milestone Screening");
    ...
    public void testPerformWithScheduled() throws Exception {
        ...
        // test with scheduled status.
        Phase screeningPhase = createPhase(1, 1, "Scheduled", 2, "Milestone Screening");
