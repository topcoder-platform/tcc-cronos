...
public class MilestoneSubmissionPhaseHandlerTest extends BaseTest {
     ...
     * </p>
     */
    private MilestoneSubmissionPhaseHandler handler;
    ...
    public void testCtor() throws Exception {
        handler = new MilestoneSubmissionPhaseHandler();
    ...
    public void testCtor2() throws Exception {
        handler = new MilestoneSubmissionPhaseHandler(PHASE_HANDLER_NAMESPACE);
    ...
    public void testCanPerformWithInvalidStatus() throws Exception {
        ...
        try {
            Phase phase = createPhase(1, 1, "Invalid", 2, "Milestone Submission");
    ...
    /**
     * <p>
     * Tests the MilestoneSubmissionPhaseHandler() constructor and canPerform with Scheduled statuses.
     * </p>
     * <p>
    ...
    /**
     * <p>
     * Tests the MilestoneSubmissionPhaseHandler() constructor and canPerform with OPEN statuses.
     * </p>
     * <p>
     * If the conditions meets, should return true, otherwise return false.
     * </p>
    ...
    public void testPerformWithInvalidStatus() throws Exception {
        ...
        try {
            Phase phase = createPhase(1, 1, "Invalid", 1, "Milestone Submission");
    ...
    public void testPerformWithNullOperator() throws Exception {
        ...
        try {
            Phase phase = createPhase(1, 1, "Scheduled", 1, "Milestone Submission");
    ...
    public void testPerformWithoutSubmission() throws Exception {
        ...
        try {
            ...
            // test with scheduled status.
            Phase submissionPhase = createPhase(1, 1, "Scheduled", 2, "Milestone Submission");
