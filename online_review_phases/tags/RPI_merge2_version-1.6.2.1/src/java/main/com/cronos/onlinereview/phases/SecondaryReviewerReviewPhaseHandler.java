 ...
 * <li>fix line longer than 120 in field DEFAULT_NAMESPACE.</li>
 * <li>fix line longer than 120 in method allReviewsDone, putPhaseStartInfoValues, updateSubmissionScores</li>
 * </ol>
 * </p>
 *
...
public class SecondaryReviewerReviewPhaseHandler extends AbstractPhaseHandler {
    ...
    public OperationCheckResult canPerform(Phase phase) throws PhaseHandlingException {
        ...
        if (toStart) {
            ...
            boolean deps = ocrSuccess.isSuccess();
            ...
            return new OperationCheckResult(false, reviews ? "Dependencies not met" : "Reviews not done yet");
        }
    }
