 ...
 * <ol>
 * <li>merge the PROP_EMAIL_TEMPLATE_SOURCE definition from 1.6.1.</li>
 * <li>merge the JavaDoc sample Configuration to include property 'EmailTemplateSource' from 1.6.1</li>
 * <li>update method createEmailOptions() to use PROP_EMAIL_TEMPLATE_SOURCE</li>
 * </ol>
 * </p>
 *
 * @author tuenm, bose_java, pulky, argolite, waits, FireIce, microsky, TMALBONPH
 * @version 1.6.2
 */
