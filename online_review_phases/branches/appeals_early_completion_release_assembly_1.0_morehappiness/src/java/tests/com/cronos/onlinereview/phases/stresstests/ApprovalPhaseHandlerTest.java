...
/**
 * <p>Stress tests for <code>ApprovalPhaseHandler</code>.</p>
 * <p>
...
public class ApprovalPhaseHandlerTest extends StressBaseTest {
    ...
    protected void setUp() throws Exception {
        ...
        handler = new ApprovalPhaseHandler("com.cronos.onlinereview.phases.OtherHandler");
        Project project = new Project(new Date(), new DefaultWorkdays());
        phase = new Phase(project, DEFAULT_ID);

        // set a phase type to the phase
        PhaseType type = new PhaseType(DEFAULT_ID, "Approval");
