...
/**
 * <p>This is the helper class to load manager instances from a default configuration namespace. The namespace is
 ...
 * implementations to retrieve manager instances.</p>
...
public class ManagerHelper {
    ...
    /** Property name constant for resource IDgenerator name when creating ResourceManager instance. */
    private static final String PROP_RESOURCE_MGR_RESOURCE_IDGEN_NAME = "ResourceManager.ResourceIdGeneratorName";

    /** Property name constant for notification IDgenerator name when creating ResourceManager instance. */
    ...
    /** Property name constant for resource role IDgenerator name when creating ResourceManager instance. */
    ...
    /** Property name constant for upload IDgenerator name when creating UploadManager instance. */
    private static final String PROP_UPLOAD_MGR_UPLOAD_IDGEN_NAME = "UploadManager.UploadIdGeneratorName";

    /** Property name constant for upload type IDgenerator name when creating UploadManager instance. */
    private static final String PROP_UPLOAD_MGR_UPLOAD_TYPE_IDGEN_NAME = "UploadManager.UploadTypeIdGeneratorName";

    /** Property name constant for upload status IDgenerator name when creating UploadManager instance. */
    private static final String PROP_UPLOAD_MGR_UPLOAD_STATUS_IDGEN_NAME = "UploadManager.UploadStatusIdGeneratorName";

    /** Property name constant for submission IDgenerator name when creating UploadManager instance. */
    ...
    /**
     * Represents the PhaseManager instance. It is initialized in the constructor and never changed after
     * that. It is never null.
     */
    private final PhaseManager phaseManager;

    /**
     * Represents the ScorecardManager instance. It is initialized in the constructor and never changed after
     * that. It is never null.
     */
    private final ScorecardManager scorecardManager;

    /**
     * Represents the ScreeningManager instance. It is initialized in the constructor and never changed after
     * that. It is never null.
     */
    private final ScreeningManager screeningManager;

    /**
     * Represents the ReviewManager instance. It is initialized in the constructor and never changed after
     * that. It is never null.
     */
    private final ReviewManager reviewManager;

    /**
     * Represents the ResourceManager instance. It is initialized in the constructor and never changed after
     * that. It is never null.
     */
    private final ResourceManager resourceManager;

    /**
     * Represents the UploadManager instance. It is initialized in the constructor and never changed after that.
     * It is never null.
     */
    private final UploadManager uploadManager;

    /**
     * Represents the UserRetrieval instance. It is initialized in the constructor and never changed after that.
     * It is never null.
     */
    ...
    /**
     * Creates a new instance of ManagerHelper using the default configuration namespace of this class.
     * This constructor loads the manager instances using the configuration settings in the default namespace.
     * Please see Configuration Parameters section the Component Specification for properties used.
     * Also see class documentation for sample configuration file.
     *
     * @throws ConfigurationException if required properties are missing or error occurs when instantiating
     *                 the managers.
     */
    ...
    /**
     * Creates a new instance of ManagerHelper using the given namespace.
     * This constructor loads the manager instances using the configuration settings from given namespace.
     * Please see Configuration Parameters section the Component Specification for properties used.
     * Also see class documentation for sample configuration file.
     *
    ...
    public ManagerHelper(String namespace) throws ConfigurationException {
        ...
        this.phaseManager = (PhaseManager) initManager(namespace, PROP_PHASE_MGR_CLASS_NAME,
                PROP_PHASE_MGR_NAMESPACE, PhaseManager.class, false);
        this.reviewManager = (ReviewManager) initManager(namespace, PROP_REVIEW_MGR_CLASS_NAME,
                PROP_REVIEW_MGR_NAMESPACE, ReviewManager.class, false);
        this.scorecardManager = (ScorecardManager) initManager(namespace, PROP_SCORECARD_MGR_CLASS_NAME,
                PROP_SCORECARD_MGR_NAMESPACE, ScorecardManager.class, false);
     ...
     *
     * @throws ConfigurationException if required properties are missing or error occurs during instantiation.
     */
     ...
     * properties from the given namespace, and creates UploadPersistence, search bundle and id generator instances
     * which are required to create the UploadManager instance.
     *
     * @param namespace the namespace to load configuration settings from.
     *
     * @return a UploadManager instance.
     *
     * @throws ConfigurationException if required properties are missing or error occurs during various instantiation
     *         processes.
     */
    private UploadManager initUploadManager(String namespace)
        ...
        String uploadSearchBundleName = PhasesHelper.getPropertyValue(namespace,
                PROP_UPLOAD_MGR_UPLOAD_BUNDLE_NAME, true);
        ...
        UploadPersistence persistence = (UploadPersistence) createPersistence(namespace, persistenceClassName,
        ...
        Object[] params = new Object[] {
                persistence, uploadSearchBundle, submissionSearchBundle, uploadIdGenerator, uploadTypeIdGenerator,
                uploadStatusIdGenerator, submissionIdGenerator, submissionStatusIdGenerator
            };
        Class[] paramTypes = new Class[] {
                UploadPersistence.class, SearchBundle.class, SearchBundle.class, IDGenerator.class, IDGenerator.class,
                IDGenerator.class, IDGenerator.class, IDGenerator.class
            };

        return (UploadManager) createObject(uploadManagerClassName, UploadManager.class, params, paramTypes);
    }
    ...
    private ResourceManager initResourceManager(String namespace)
        ...
        SearchBundle notificationTypeSearchBundle =
            searchBundleManager.getSearchBundle(notificationTypeSearchBundleName);
        ...
        Object[] params = new Object[] {
                persistence, resourceSearchBundle, resourceRoleSearchBundle, notificationSearchBundle,
                notificationTypeSearchBundle, resourceIdGenerator, resourceRoleIdGenerator, notificationTypeIdGenerator
            };
        Class[] paramTypes = new Class[] {
                ResourcePersistence.class, SearchBundle.class, SearchBundle.class, SearchBundle.class,
                SearchBundle.class, IDGenerator.class, IDGenerator.class, IDGenerator.class
            };

        return (ResourceManager) createObject(resourceManagerClassName, ResourceManager.class, params, paramTypes);
    }
     ...
     *
     * @throws ConfigurationException if 'SearchBundleManagerNS' property is missing or if error occurs during
     *         instantiation.
     */
    ...
    /**
     * This method is called by initResourceManager() and initUploadManager() to create either
     * ResourcePersistence or UploadPersistence instance. Since constructor signatures for both these classes is same,
     * this common method is used.
     *
     * @param namespace the namespace to load configuration settings from.
     * @param className class name of ResourcePersistence or UploadPersistence implementation.
     * @param expectedType expected type of the returned instance.
     *
     * @return a ResourcePersistence or UploadPersistence instance.
     *
     * @throws ConfigurationException if some property is missing or an error occurs during instantiation.
     */
    private Object createPersistence(String namespace, String className, Class expectedType)
        throws ConfigurationException {
        ...
        if (PhasesHelper.isStringNullOrEmpty(connectionName)) {
            //if connection name not specified, call constructor with DBConnectionFactory argument.
            params = new Object[] { dbConnFactory };
            paramTypes = new Class[] { DBConnectionFactory.class };
        } else {
            //else, call constructor with DBConnectionFactory and connectionName arguments.
    ...
    /**
     * Helper method to instantiate the specified className using reflection. The params is passed to
     * constructor during reflection.
     *
     ...
     */
    private Object createObject(String className, Class expectedType, Object[] params, Class[] paramTypes)
        throws ConfigurationException {
