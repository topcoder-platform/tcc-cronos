...
/**
 * <p>Stress tests for <code>ReviewPhaseHandler</code>.</p>
 * <p>
...
public class ReviewPhaseHandlerTest extends StressBaseTest {
     ...
     */
    private ReviewPhaseHandler handler;
    ...
    protected void setUp() throws Exception {
        ...
        handler = new ReviewPhaseHandler("com.cronos.onlinereview.phases.OtherHandler");
        Project project = new Project(new Date(), new DefaultWorkdays());
        phase = new Phase(project, DEFAULT_ID);

        // set a phase type to the phase
        PhaseType type = new PhaseType(DEFAULT_ID, "Review");
