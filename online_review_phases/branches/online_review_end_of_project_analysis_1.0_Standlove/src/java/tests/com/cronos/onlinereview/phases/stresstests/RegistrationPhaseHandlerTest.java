...
/**
 * <p>Stress tests for <code>RegistrationPhaseHandler</code>.</p>
 * <p>
...
public class RegistrationPhaseHandlerTest extends StressBaseTest {
    ...
    protected void setUp() throws Exception {
        ...
        handler = new RegistrationPhaseHandler("com.cronos.onlinereview.phases.OtherHandler");
        Project project = new Project(new Date(), new DefaultWorkdays());
        phase = new Phase(project, DEFAULT_ID);

        // set a phase type to the phase
        PhaseType type = new PhaseType(DEFAULT_ID, "Registration");
