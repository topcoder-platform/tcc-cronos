...
/**
 * <p>Stress tests for <code>FinalFixPhaseHandler</code>.</p>
 * <p>
...
public class FinalFixPhaseHandlerTest extends StressBaseTest {
     ...
     */
    private FinalFixPhaseHandler handler;
    ...
    protected void setUp() throws Exception {
        ...
        handler = new FinalFixPhaseHandler("com.cronos.onlinereview.phases.OtherHandler");
        Project project = new Project(new Date(), new DefaultWorkdays());
        project.setId(1);
        phase = new Phase(project, DEFAULT_ID);

        // set a phase type to the phase
        PhaseType type = new PhaseType(DEFAULT_ID, "Final Fix");
