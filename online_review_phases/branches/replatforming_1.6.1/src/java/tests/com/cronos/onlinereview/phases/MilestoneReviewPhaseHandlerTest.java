...
/**
 * All tests for MilestoneReviewPhaseHandler class.
 *
 * @author TCSDEVELOPER
 * @version 1.6
 * @since 1.6
 */
public class MilestoneReviewPhaseHandlerTest extends BaseTest {
    /**
     * <p>
     * Represents the MilestoneReviewPhaseHandler instance for testing.
     * </p>
     */
    private MilestoneReviewPhaseHandler handler;
    ...
    /**
     * <p>
     * Tests the MilestoneReviewPhaseHandler() constructor, instance should be created.
     * </p>
     *
     * @throws Exception
    ...
    public void testCtor() throws Exception {
        handler = new MilestoneReviewPhaseHandler();
    ...
    /**
     * <p>
     * Tests the MilestoneReviewPhaseHandler(String) constructor, instance should be created.
     * </p>
     *
     * @throws Exception
     *             pass any unexpected exception to JUnit.
    ...
    public void testCtor2() throws Exception {
        handler = new MilestoneReviewPhaseHandler(PHASE_HANDLER_NAMESPACE);
    ...
    public void testCanPerformWithInvalidStatus() throws Exception {
        ...
        try {
            Phase phase = createPhase(1, 1, "Invalid", 3, "Milestone Review");
    ...
    public void testPerformWithInvalidStatus() throws Exception {
        ...
        try {
            Phase phase = createPhase(1, 1, "Invalid", 1, "Milestone Review");
    ...
    /**
     * <p>
     * Tests the MilestoneReviewPhaseHandler() constructor and canPerform with Scheduled statuses.
     * </p>
     * <p>
     * <ul>
    ...
    /**
     * <p>
     * Tests the MilestoneReviewPhaseHandler() constructor and canPerform with Open statuses.
     * </p>
     * <p>
     * <ul>
     * <li>If time not passed, should return false</li>
    ...
    public void testCanPerformAccuracy1() throws Exception {
        ...
        try {
            ...
            assertTrue("expect true", handler.canPerform(reviewPhase));
    ...
    public void testCanPerformAccuracy2() throws Exception {
        ...
        try {
            ...
            assertFalse("expect false", handler.canPerform(reviewPhase));
    ...
    public void testPerform_Start_noReviewer() throws Exception {
        handler = new MilestoneReviewPhaseHandler(MilestoneReviewPhaseHandler.DEFAULT_NAMESPACE);
