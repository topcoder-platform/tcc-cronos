...
/**
 * <p>
 * This is a test case for <code>UnknownEntityException</code> class.
 * </p>
 * @author TCSDEVELOPER
 * @version 1.0
 */
public class UnknownEntityExceptionTest extends TestCase {
    ...
    public void testCtorWithMsg() throws Exception {
        Exception ex = new UnknownEntityException("msg");
    ...
    public void testCtorWithMsgAndCause() throws Exception {
        ...
        Exception ex = new UnknownEntityException("message", e);
        assertNotNull("'ex' should not be null.", ex);
