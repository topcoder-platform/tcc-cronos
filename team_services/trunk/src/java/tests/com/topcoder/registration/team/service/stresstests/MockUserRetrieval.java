...
public class MockUserRetrieval implements UserRetrieval {
    ...
    public ExternalUser retrieveUser(long id) throws RetrievalException {
        ...
        return new ExternalUserImpl(1, "argolite", "f", "l", "argolite@topcoder.com");
    }
     ...
     * @throws IllegalArgumentException if handles is <code>null</code> or any entry is <code>null</code>, or empty
     *                                  after trim.
     * @throws RetrievalException       if any exception occurred during processing; it will wrap the underlying
     *                                  exception.
     */
     ...
     * </p>
     *
     * @param handles the handles of the users we are interested in finding by the lower-case version of
     *                their handle.
     * @return an array of external users who have the given handles. If none of the given handles
     *         were found, an empty array will be returned. The entries in the array will not
     *         necessarily directly correspond to the entries in the handles array.
     ...
     * @param lastName  the last name of the user(s) to find, or the empty string to represent "any last
     *                  name". Both firstName and lastName cannot be empty.
     ...
     * @throws IllegalArgumentException if firstName or lastName is <code>null</code>, or if BOTH are empty after
