...
public class MockResourceManager implements ResourceManager {
     ...
     * @throws IllegalArgumentException     If resources in the array have a project that is not the same as the project
     *                                      argument
     */
     ...
     * @param operator     the operator making the update
     * @throws IllegalArgumentException     if a required field of the resource role is missing (i.e. name or description of
     ...
     * @param operator     The operator making the update
     * @throws IllegalArgumentException     If the id of the resource role is UNSET_ID, or if resourceRole or operator is
     *                                      null
     * @throws ResourcePersistenceException If there is an error updating the the persistence store.
     */
     ...
     * @throws IllegalArgumentException     If any item of users, project, or notificationType is &lt;= 0, or operator or
     *                                      users is null
     * @throws ResourcePersistenceException If there is an error updating the persistence store
     */
     ...
     * @throws IllegalArgumentException     If any item of users, project, or notificationType is &lt;= 0 or the operator or
     *                                      users is null.
     * @throws ResourcePersistenceException If there is an error updating the persistence store
     */
     ...
     * @param operator         The operator making the update
     * @throws IllegalArgumentException     If a required field of the notification type is missing (i.e. name or description
     ...
     * @param operator         The operator making the update
     * @throws IllegalArgumentException     If the id of the resource role is UNSET_ID, or notificationType or operation is
     *                                      null
     * @throws ResourcePersistenceException If there is an error updating the the persistence store.
     */
