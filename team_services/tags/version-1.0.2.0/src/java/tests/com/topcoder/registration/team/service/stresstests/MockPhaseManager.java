...
public class MockPhaseManager implements PhaseManager {
     ...
     * @throws PhaseManagementException is  not thrown.
     */
     ...
     */
    public Project getPhases(long projectId) throws PhaseManagementException {
        ...
        phase.setPhaseType(new PhaseType(0, "test"));
     ...
     * {@link com.topcoder.management.phase.PhasePersistence#getAllPhaseStatuses getAllPhaseTypes}
     ...
     * {@link com.topcoder.management.phase.PhasePersistence#getAllPhaseStatuses getAllPhaseStatuses}
     * method of this manager's configured persistence object.
     *
     ...
     * operation of the phase's type, the handler's {@link PhaseHandler#perform perform} method is
     * invoked first. Next, the phase's status is set to
     * {@link com.topcoder.management.phase.PhaseStatusEnum#CLOSED CLOSED} and
