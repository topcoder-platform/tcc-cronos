...
/**
 * <p>
 * This is a test case for <code>TeamServicesException</code> class.
 * </p>
 * @author TCSDEVELOPER
 * @version 1.0
 */
public class TeamServicesExceptionTest extends TestCase {
    ...
    public void testCtorWithMsg() throws Exception {
        Exception ex = new TeamServicesException("msg");
    ...
    public void testCtorWithMsgAndCause() throws Exception {
        ...
        Exception ex = new TeamServicesException("message", e);
        assertNotNull("'ex' should not be null.", ex);
