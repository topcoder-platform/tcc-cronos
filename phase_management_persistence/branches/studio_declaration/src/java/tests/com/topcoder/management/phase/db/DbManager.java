...
/**
 * <p>
 * This is a database helper class. It loads data set from file into database. It requires configured connection.
 * </p>
 *
 * @author kr00tki
 * @version 1.0
...
class DbManager {
    ...
    /**
     * Default constructor. It loads configuration from the default namespace.
     *
    ...
    /**
     * Persists given document to database.
     *
    ...
    /**
     * Releases the DbManager. Closes the internal connection.
     *
