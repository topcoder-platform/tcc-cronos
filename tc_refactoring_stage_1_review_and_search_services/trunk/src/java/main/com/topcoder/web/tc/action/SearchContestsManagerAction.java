 ...
 * <ul>
 * <li>filter - the criteria used to filter searching result. Please refer to ContestsFilter and following explanation.
 * </li>
 ...
 * </p>
 * <p>
 * This action is required to be configured with an instance of SearchContestsManager. Below is an example of
...
public class SearchContestsManagerAction extends BaseJSONParameterAction {
     ...
     */
    private static final String CLASS_NAME = SearchContestsManagerAction.class.getName();

    /**
     * Represents the logger used to log information.
     */
    private static final Logger LOGGER = Logger.getLogger(SearchContestsManagerAction.class);

    /**
     * Represents the SearchContestsManager for search contests. It is set through setter and doesn't have a getter. It
     * cannot be null. Its value legality is checked in checkConfiguration() method. It does not need to be initialized
     * when the instance is created.
     */
    private SearchContestsManager searchContestsManager;

    /**
     * Represents the retrieved contests. It is accessed through getter and doesn't have a setter. It cannot be null but
     * can be empty. The contained values can't be null. It does not need to be initialized when the instance is
     * created.
     */
    ...
    public String execute() throws ContestServicesActionException {
        ...
        try {
            ...
            contests = searchContestsManager.searchContests((String) params.get("columnName"),
     ...
     */
    public void setSearchContestsManager(SearchContestsManager searchContestsManager) {
        this.searchContestsManager = searchContestsManager;
    }

    /**
     * <p>
     * Checks whether this object is configured correctly. It will ensure search contests manager is valid.
     * </p>
