 ...
 * <ul>
 * <li>filter - the criteria used to filter searching result. Please refer to UpcomingContestsFilter and following
 * explanation.</li>
 ...
 * <li>winnerHandle - the winner handle of the contests to retrieve. It will use LIKE to match the winner handle.</li>
 * </ul>
 * </p>
 * <p>
 ...
 * </p>
 * <p>
 * This action is required to be configured with an instance of UpcomingContestsManager. Below is an example of
...
public class UpcomingContestsManagerAction extends BaseJSONParameterAction {
     ...
     */
    private static final String CLASS_NAME = UpcomingContestsManagerAction.class.getName();

    /**
     * Represents the logger used to log information.
     */
    private static final Logger LOGGER = Logger.getLogger(UpcomingContestsManagerAction.class);

    /**
     * Represents the UpcomingContestsManager for search review opportunities. It is set through setter and doesn't have
     * a getter. It cannot be null. Its value legality is checked in checkConfiguration() method. It does not need to be
     * initialized when the instance is created.
     */
    private UpcomingContestsManager upcomingContestsManager;

    /**
     * Represents the retrieved upcoming contests. It is accessed through getter and doesn't have a setter. It cannot be
     * null but can be empty. The contained values can't be null. It does not need to be initialized when the instance
     * is created.
     */
    ...
    public String execute() throws ContestServicesActionException {
        ...
        try {
            ...
            upcomingContests = upcomingContestsManager.retrieveUpcomingContests((String) params.get("columnName"),
                    (SortingOrder) params.get("sortingOrder"), (Integer) params.get("pageNumber"),
            ...
            throw ServicesHelper.logException(LOGGER, methodName, new ContestServicesActionException(
                    "Error occurs while searching upcoming contests.", e));
        }
     ...
     */
    public void setUpcomingContestsManager(UpcomingContestsManager upcomingContestsManager) {
        this.upcomingContestsManager = upcomingContestsManager;
    }

    /**
     * <p>
     * Checks whether this object is configured correctly. It will ensure upcoming contests manager is valid.
     * </p>
