...
<body>
	<form action="parameterAction" method="post">
		<input type="hidden" name="target"
			value="searchContestsManagerAction" /> Contest Name:
		...
		<br /> Contest Finalization Date:
		<select name="contestFinalizationType">
			<option value="NONE" selected="true">None</option>
			<option value="BEFORE">Before</option>
			<option value="AFTER">After</option>
			<option value="ON">On</option>
		...
		<input type="text" name="contestFinalizationDate1" /> (yyyy/MM/dd)
		<input type="text" name="contestFinalizationDate2" /> (yyyy/MM/dd)
		<br /> Winner Handle:
		<input type="text" name="winnerHandle" />
