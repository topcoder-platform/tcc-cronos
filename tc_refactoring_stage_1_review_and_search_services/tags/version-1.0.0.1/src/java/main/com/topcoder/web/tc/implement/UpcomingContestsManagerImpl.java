...
/**
 * <p>
 * This is the default implementation of UpcomingContestsManager. It uses Hibernate to perform the searching.
 * </p>
 * <p>
 ...
 * @version 1.0
 */
public class UpcomingContestsManagerImpl extends AbstractManagerImpl implements UpcomingContestsManager {
    ...
    private static final String BASE_HQL = "SELECT pgc.name AS type, pc.name AS subtype,"
            ...
            + " WHERE p.projectStatusId IN (1, 2, 7) AND p.projectCategoryId NOT IN (27) AND p.tcDirectProjectId NOT IN (840)"
    ...
    public List<UpcomingContestDTO> retrieveUpcomingContests(String columnName, SortingOrder sortingOrder,
        ...
        try {
            getHibernateTemplate().execute(
                    new RetrieveUpcomingContestsHibernateCallback(columnName, sortingOrder, pageNumber, pageSize,
                            filter, contests));
    ...
    public List<UpcomingContestDTO> retrieveUpcomingContests(UpcomingContestsFilter filter)
            throws ContestsServiceManagerException {
        String methodName = getClass().getName() + ".retrieveUpcomingContests(UpcomingContestsFilter)";
        ...
        try {
            result = retrieveUpcomingContests(null, null, Filterable.RETURN_ALL_PAGES, Filterable.RETURN_ALL_PAGES,
                    filter);
    ...
    /**
     * <p>
     * This class implements the HibernateCallback interface to perform query for searching upcoming contests.
     * </p>
     * <p>
     ...
     * @version 1.0
     */
    private class RetrieveUpcomingContestsHibernateCallback implements HibernateCallback<Object> {
         ...
         * @param contests
         *            a list of UpcomingContestDTO to store the searching result.
         */
        public RetrieveUpcomingContestsHibernateCallback(String columnName, SortingOrder sortingOrder, int pageNumber,
                int pageSize, UpcomingContestsFilter filter, List<UpcomingContestDTO> contests) {
        ...
        public Object doInHibernate(Session session) throws HibernateException {
            ...
            if (filter.getPrizeStart() != null && filter.getPrizeStart() != Filterable.OPEN_INTERVAL) {
                hql.append(PRIZE_START_CRITERIA);
            }
            if (filter.getPrizeEnd() != null && filter.getPrizeEnd() != Filterable.OPEN_INTERVAL) {
            ...
            for (Object[] row : result) {
                ...
                dto.setRegisterDate((Date) row[2]);
                dto.setSubmitDate((Date) row[3]);
                dto.setDuration((int) ((dto.getSubmitDate().getTime() - dto.getRegisterDate().getTime())
