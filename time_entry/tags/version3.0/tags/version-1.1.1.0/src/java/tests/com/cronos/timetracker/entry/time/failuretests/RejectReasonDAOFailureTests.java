...
public class RejectReasonDAOFailureTests extends TestCase {
    ...
    protected void setUp() throws Exception {
        dao = new MockRejectReasonDAO("mysql", "com.cronos.timetracker.entry.time.failuretests");
    }
    ...
    public void testRejectReasonDAONullConnName() {
        try {
            new RejectReasonDAO(null, "com.cronos.timetracker.entry.time.failuretests");
    ...
    public void testRejectReasonDAOEmptyConnName() {
        try {
            new RejectReasonDAO("       ", "com.cronos.timetracker.entry.time.failuretests");
