...
final class MockRejectReasonDAO extends RejectReasonDAO {
     ...
     * @see com.cronos.timetracker.entry.time.RejectReasonDAO#fillCreatePreparedStatement(java.sql.PreparedStatement, com.cronos.timetracker.entry.time.DataObject, java.lang.String, java.util.Date)
     */
     ...
     * @throws DAOActionException
     * @see com.cronos.timetracker.entry.time.RejectReasonDAO#fillUpdatePreparedStatement(java.sql.PreparedStatement, com.cronos.timetracker.entry.time.DataObject, java.lang.String, java.util.Date)
     */
     ...
     * </p>
     * @return
     * @see com.cronos.timetracker.entry.time.RejectReasonDAO#getCreateSqlString()
     */
     ...
     * </p>
     * @return
     * @see com.cronos.timetracker.entry.time.RejectReasonDAO#getDeleteSqlString()
     */
     ...
     * </p>
     * @return
     * @see com.cronos.timetracker.entry.time.RejectReasonDAO#getReadListSqlString()
     */
     ...
     * </p>
     * @return
     * @see com.cronos.timetracker.entry.time.RejectReasonDAO#getReadSqlString()
     */
     ...
     * </p>
     * @return
     * @see com.cronos.timetracker.entry.time.RejectReasonDAO#getUpdateSqlString()
     */
     ...
     * @return
     * @throws DAOActionException
     * @see com.cronos.timetracker.entry.time.RejectReasonDAO#processReadListResultSet(java.sql.ResultSet)
     */
     ...
     * @return
     * @throws DAOActionException
     * @see com.cronos.timetracker.entry.time.RejectReasonDAO#processReadResultSet(java.sql.ResultSet)
     */
     ...
     * @param creationDate
     * @throws DAOActionException
     * @see com.cronos.timetracker.entry.time.RejectReasonDAO#setCreationParametersInDataObject(com.cronos.timetracker.entry.time.DataObject, java.lang.String, java.util.Date)
     */
     ...
     * @param modificationDate
     * @throws DAOActionException
     * @see com.cronos.timetracker.entry.time.RejectReasonDAO#setModificationParametersInDataObject(com.cronos.timetracker.entry.time.DataObject, java.lang.String, java.util.Date)
     */
     ...
     * @param dataObject
     * @throws DAOActionException
     * @see com.cronos.timetracker.entry.time.RejectReasonDAO#verifyCreateDataObject(com.cronos.timetracker.entry.time.DataObject)
     */
     ...
     * @param dataObject
     * @throws DAOActionException
     * @see com.cronos.timetracker.entry.time.RejectReasonDAO#verifyUpdateDataObject(com.cronos.timetracker.entry.time.DataObject)
     */
