...
CREATE TABLE audit (
    ...
    creation_date datetime year to second NOT NULL,
    creation_user VARCHAR(64) NOT NULL,
    primary key (audit_id) constraint pk_audit
);
...
INSERT INTO id_sequences (name,next_block_start,block_size,exhausted) VALUES('AuditIdGenerator',200,100,0);
INSERT INTO id_sequences (name,next_block_start,block_size,exhausted) VALUES('TimeEntryIdGenerator',200,20,0);
INSERT INTO id_sequences (name,next_block_start,block_size,exhausted) VALUES('TaskTypeIdGenerator',200,1,0);
INSERT INTO id_sequences (name,next_block_start,block_size,exhausted) VALUES('TimeStatusIdGenerator',200,20,0);