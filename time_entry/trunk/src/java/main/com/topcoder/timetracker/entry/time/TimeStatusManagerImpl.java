...
/**
 * <p>
 * This is a default implementation of the <code>TimeStatusManager</code> interface.
 * </p>
 *
 * <p>
 * It utilizes instances of the <code>TimeStatusDAO</code> in order to fulfill the necessary
 * CRUDE and search operations defined for the <code>TimeStatus</code>.
 * </p>
 *
 * <p>
 ...
 * @version 3.2
 */
public class TimeStatusManagerImpl implements TimeStatusManager {
    /**
     * <p>
     * This is the DAO instance that is used to retrieve data from and
     * modify the persistent store when dealing with the TimeStatuses.
     * </p>
     *
     * <p>
    ...
    /**
     * <p>
     * Constructor that accepts the necessary parameters to initialize the <code>TimeStatusManagerImpl</code>.
     * </p>
     *
     * @param timeStatusDao The TimeStatusDAO to use.
     *
     * @throws IllegalArgumentException if any argument is null.
     */
    public TimeStatusManagerImpl(TimeStatusDAO timeStatusDao) {
    ...
    public void createTimeStatus(TimeStatus timeStatus) throws DataAccessException {
        try {
            createTimeStatuses(new TimeStatus[] {timeStatus});
        } catch (BatchOperationException e) {
            Util.extractBatchOperationException(e, "Unable to create the time status.");
        }
    }
    ...
    public void updateTimeStatus(TimeStatus timeStatus) throws UnrecognizedEntityException,
        DataAccessException {
        try {
            updateTimeStatuses(new TimeStatus[] {timeStatus});
        } catch (BatchOperationException e) {
            Util.extractBatchOperationException(e, "Unable to update the time status.");
        }
    }
    ...
    public void deleteTimeStatus(long timeStatusId) throws UnrecognizedEntityException,
        DataAccessException {
        try {
            deleteTimeStatuses(new long[] {timeStatusId});
        } catch (BatchOperationException e) {
            Util.extractBatchOperationException(e, "Unable to delete the time status.");
        }
    }
    ...
    public TimeStatus getTimeStatus(long timeStatusId) throws UnrecognizedEntityException,
        DataAccessException {
        try {
            return this.timeStatusDao.getTimeStatuses(new long[] {timeStatusId})[0];
        } catch (BatchOperationException e) {
            Util.extractBatchOperationException(e, "Unable to get the time status.");
            // never reach here
            return null;
        }
    }
    ...
    public TimeStatus[] searchTimeStatuses(Filter criteria) throws DataAccessException {
        return this.timeStatusDao.searchTimeStatuses(criteria);
    }
    ...
    public void createTimeStatuses(TimeStatus[] timeStatuses) throws BatchOperationException,
        DataAccessException {
        Util.updateTimeTrackerBeanDates(timeStatuses, "timeStatuses", true);

        this.timeStatusDao.createTimeStatuses(timeStatuses);
    }
    ...
    public void updateTimeStatuses(TimeStatus[] timeStatuses) throws BatchOperationException,
        DataAccessException {
        Util.updateTimeTrackerBeanDates(timeStatuses, "timeStatuses", false);

        this.timeStatusDao.updateTimeStatuses(timeStatuses);
    }
    ...
    public void deleteTimeStatuses(long[] timeStatusIds) throws BatchOperationException,
        DataAccessException {
        this.timeStatusDao.deleteTimeStatuses(timeStatusIds);
    ...
    public TimeStatus[] getTimeStatuses(long[] timeStatusIds) throws BatchOperationException,
        DataAccessException {
        return this.timeStatusDao.getTimeStatuses(timeStatusIds);
    }
    ...
    public TimeStatusFilterFactory getTimeStatusFilterFactory() {
        return this.timeStatusDao.getTimeStatusFilterFactory();
    }
    ...
    public TimeStatus[] getAllTimeStatuses() throws DataAccessException {
        return this.timeStatusDao.getAllTimeStatuses();
    }
