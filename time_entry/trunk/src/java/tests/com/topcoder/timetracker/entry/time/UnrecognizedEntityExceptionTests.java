...
public class UnrecognizedEntityExceptionTests extends TestCase {
     ...
     *
     * <p>
     * Verifies UnrecognizedEntityException subclasses DataAccessException.
     * </p>
     */
    public void testUnrecognizedEntityExceptionInheritance1() {
        ...
        assertTrue("UnrecognizedEntityException does not subclass DataAccessException.",
    ...
    public void testUnrecognizedEntityExceptionInheritance2() {
        assertTrue("UnrecognizedEntityException does not subclass DataAccessException.",
            entityException instanceof DataAccessException);
    }
