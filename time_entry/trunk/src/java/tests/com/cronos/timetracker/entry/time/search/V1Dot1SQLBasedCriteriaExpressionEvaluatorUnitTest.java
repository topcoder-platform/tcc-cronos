...
/**
 * <p>
 * Tests functionality and error cases of <code>SQLBasedCriteriaExpressionEvaluator</code> class.
 * </p>
 *
 * @author TCSDEVELOPER
 * @version 2.0
 */
public class V1Dot1SQLBasedCriteriaExpressionEvaluatorUnitTest extends TestCase {
    /**
     * <p>
    ...
    /**
     * Represents the <code>SQLBasedCriteriaExpressionEvaluator</code> instance which will be used for
     * testing.
     */
    private SQLBasedCriteriaExpressionEvaluator evaluator = null;
    ...
    protected void setUp() throws Exception {
        ...
        this.evaluator = new SQLBasedCriteriaExpressionEvaluator(timeEntryDAO);
    ...
    /**
     * <p>
     * Tests the SQLBasedCriteriaExpressionEvaluator(TimeEntryDAO) when the given timeEntryDAO is null,
     * IllegalArgumentException is expected.
     * </p>
     *
     * @throws Exception throw Exception to junit
     */
    public void testSQLBasedCriteriaExpressionEvaluator_NullTimeEntryDAO()
        throws Exception {
        try {
            new SQLBasedCriteriaExpressionEvaluator(null);
    ...
    /**
     * <p>
     * Tests the accuracy of SQLBasedCriteriaExpressionEvaluator(TimeEntryDAO).
     * </p>
     *
     * @throws Exception throw Exception to junit
     */
    public void testSQLBasedCriteriaExpressionEvaluator_Accuracy()
        throws Exception {
        assertNotNull("The SQLBasedCriteriaExpressionEvaluator should be created properly.", evaluator);
        assertEquals("The SQLBasedCriteriaExpressionEvaluator should be created properly.", timeEntryDAO,
            V1Dot1TestHelper.getPrivateField(evaluator.getClass(), evaluator, "dao"));
    }
    ...
    public void testEvaluate_SimpleSearchExpressionAccuracy1() throws Exception {
        ...
        for (int i = 0; i < myTimeEntrys.length; i++) {
            assertEquals("not correctly record returned from the TimeEntries table",
                myTimeEntrys[i], (TimeEntry) ret[i]);
        }
    }
