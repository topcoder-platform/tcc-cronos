...
/**
 * <p>Tests <code>{@link LookupEntity}</code> class.</p>
 *
 * @author TCSDEVELOPER
 * @version 1.0
 */
public class LookupEntityTests {
    ...
    public static junit.framework.Test suite() {
        return new JUnit4TestAdapter(LookupEntityTests.class);
    }
    ...
    public void setUp() throws Exception {
        ...
        instance = new MockLookupEntity();
    }

    /**
     * <p>Tests if <code>{@link LookupEntity}</code> class implements {@link java.io.Serializable} interface.</p>
     */
    @Test
    ...
    /**
     * <p>Tests if <code>{@link LookupEntity}</code> class extends {@link IdentifiableEntity} class.</p>
     */
    @Test
    ...
    /**
     * <p>Tests <code>{@link LookupEntity#LookupEntity()}</code> constructor.</p>
     */
    @Test
    ...
    /**
     * <p>Tests <code>name</code> property, tests both <code>{@link LookupEntity#setName(String)}</code> and
     * <code>{@link LookupEntity#getName()}</code> methods.</p>
     */
    @Test
    ...
    /**
     * <p>Tests <code>id</code> property, tests both <code>{@link LookupEntity#setId(long)}</code> and <code>{@link
     * LookupEntity#getId()}</code> methods.</p>
     */
    @Test
    ...
    /**
     * <p>Tests <code>createUser</code> property, tests both <code>{@link LookupEntity#setCreateUser(String)}</code> and
     * <code>{@link LookupEntity#getCreateUser()}</code> methods.</p>
     */
    @Test
     ...
     * LookupEntity#setCreateDate(java.util.Date)}</code>
     * and <code>{@link LookupEntity#getCreateDate()}</code> methods.</p>
     */
    @Test
    ...
    /**
     * <p>Tests <code>modifyUser</code> property, tests both <code>{@link LookupEntity#setModifyUser(String)}</code> and
     * <code>{@link LookupEntity#getModifyUser()}</code> methods.</p>
     */
    @Test
    ...
    /**
     * <p>Tests <code>modifyDate</code> property, tests both <code>{@link LookupEntity#setModifyDate(Date)}</code> and
     * <code>{@link LookupEntity#getModifyDate()}</code> methods.</p>
     */
    @Test
