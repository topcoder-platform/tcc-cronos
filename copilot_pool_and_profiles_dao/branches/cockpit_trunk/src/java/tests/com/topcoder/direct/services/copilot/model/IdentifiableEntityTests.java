...
/**
 * <p>Tests <code>{@link IdentifiableEntity}</code> class.</p>
 *
 * @author TCSDEVELOPER
 * @version 1.0
 */
public class IdentifiableEntityTests {
    ...
    public static junit.framework.Test suite() {
        return new JUnit4TestAdapter(IdentifiableEntityTests.class);
    }
    ...
    /**
     * <p>Tests if <code>{@link IdentifiableEntity}</code> class implements {@link java.io.Serializable} interface.</p>
     */
    @Test
    public void testSerializable() {
        Class[] interfaces = IdentifiableEntity.class.getInterfaces();
        Assert.assertTrue("Class does not implements Serializable interface.",
                Arrays.asList(interfaces).contains(Serializable.class));
    }

    /**
     * <p>Tests <code>{@link IdentifiableEntity#IdentifiableEntity()}</code> constructor.</p>
     */
    @Test
    ...
    /**
     * <p>Tests <code>id</code> property, tests both <code>{@link IdentifiableEntity#setId(long)}</code> and
     * <code>{@link IdentifiableEntity#getId()}</code> methods.</p>
     */
    @Test
     ...
     * IdentifiableEntity#setCreateUser(String)}</code>
     * and <code>{@link IdentifiableEntity#getCreateUser()}</code> methods.</p>
     */
    @Test
     ...
     * IdentifiableEntity#setCreateDate(java.util.Date)}</code>
     * and <code>{@link IdentifiableEntity#getCreateDate()}</code> methods.</p>
     */
    @Test
     ...
     * IdentifiableEntity#setModifyUser(String)}</code>
     * and <code>{@link IdentifiableEntity#getModifyUser()}</code> methods.</p>
     */
    @Test
    ...
    /**
     * <p>Tests <code>modifyDate</code> property, tests both <code>{@link IdentifiableEntity#setModifyDate(Date)}</code>
     * and <code>{@link IdentifiableEntity#getModifyDate()}</code> methods.</p>
     */
    @Test
