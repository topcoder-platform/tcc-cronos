...
/**
 * <p>Tests <code>{@link CopilotProfileStatus}</code> class.</p>
 *
 * @author TCSDEVELOPER
 * @version 1.0
 */
public class CopilotProfileStatusTests {
    ...
    public static junit.framework.Test suite() {
        return new JUnit4TestAdapter(CopilotProfileStatusTests.class);
    }
    ...
    /**
     * <p>Tests if <code>{@link CopilotProfileStatus}</code> class implements {@link java.io.Serializable}
     * interface.</p>
     */
    @Test
    ...
    /**
     * <p>Tests if <code>{@link CopilotProfileStatus}</code> class extends {@link LookupEntity} class.</p>
     */
    @Test
    ...
    /**
     * <p>Tests <code>{@link CopilotProfileStatus#CopilotProfileStatus()}</code> constructor.</p>
     */
    @Test
    ...
    /**
     * <p>Tests <code>name</code> property, tests both <code>{@link CopilotProfileStatus#setName(String)}</code> and
     * <code>{@link CopilotProfileStatus#getName()}</code> methods.</p>
     */
    @Test
    ...
    /**
     * <p>Tests <code>id</code> property, tests both <code>{@link CopilotProfileStatus#setId(long)}</code> and
     * <code>{@link CopilotProfileStatus#getId()}</code> methods.</p>
     */
    @Test
     ...
     * CopilotProfileStatus#setCreateUser(String)}</code>
     * and <code>{@link CopilotProfileStatus#getCreateUser()}</code> methods.</p>
     */
    @Test
     ...
     * CopilotProfileStatus#setCreateDate(java.util.Date)}</code>
     * and <code>{@link CopilotProfileStatus#getCreateDate()}</code> methods.</p>
     */
    @Test
     ...
     * CopilotProfileStatus#setModifyUser(String)}</code>
     * and <code>{@link CopilotProfileStatus#getModifyUser()}</code> methods.</p>
     */
    @Test
     ...
     * CopilotProfileStatus#setModifyDate(Date)}</code>
     * and <code>{@link CopilotProfileStatus#getModifyDate()}</code> methods.</p>
     */
    @Test
