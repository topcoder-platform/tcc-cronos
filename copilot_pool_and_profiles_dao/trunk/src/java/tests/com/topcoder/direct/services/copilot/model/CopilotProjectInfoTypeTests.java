...
/**
 * <p>Tests <code>{@link CopilotProjectInfoType}</code> class.</p>
 *
 * @author TCSDEVELOPER
 * @version 1.0
 */
public class CopilotProjectInfoTypeTests {
    ...
    public static junit.framework.Test suite() {
        return new JUnit4TestAdapter(CopilotProjectInfoTypeTests.class);
    }
    ...
    /**
     * <p>Tests if <code>{@link CopilotProjectInfoType}</code> class implements {@link java.io.Serializable}
     * interface.</p>
     */
    @Test
    ...
    /**
     * <p>Tests if <code>{@link CopilotProjectInfoType}</code> class extends {@link LookupEntity} class.</p>
     */
    @Test
    ...
    /**
     * <p>Tests <code>{@link CopilotProjectInfoType#CopilotProjectInfoType()}</code> constructor.</p>
     */
    @Test
    ...
    /**
     * <p>Tests <code>name</code> property, tests both <code>{@link CopilotProjectInfoType#setName(String)}</code> and
     * <code>{@link CopilotProjectInfoType#getName()}</code> methods.</p>
     */
    @Test
    ...
    /**
     * <p>Tests <code>id</code> property, tests both <code>{@link CopilotProjectInfoType#setId(long)}</code> and
     * <code>{@link CopilotProjectInfoType#getId()}</code> methods.</p>
     */
    @Test
     ...
     * CopilotProjectInfoType#setCreateUser(String)}</code>
     * and <code>{@link CopilotProjectInfoType#getCreateUser()}</code> methods.</p>
     */
    @Test
     ...
     * CopilotProjectInfoType#setCreateDate(java.util.Date)}</code>
     * and <code>{@link CopilotProjectInfoType#getCreateDate()}</code> methods.</p>
     */
    @Test
     ...
     * CopilotProjectInfoType#setModifyUser(String)}</code>
     * and <code>{@link CopilotProjectInfoType#getModifyUser()}</code> methods.</p>
     */
    @Test
     ...
     * CopilotProjectInfoType#setModifyDate(Date)}</code>
     * and <code>{@link CopilotProjectInfoType#getModifyDate()}</code> methods.</p>
     */
    @Test
