...
/**
 * <p>
 * This class contains Unit tests for UserPreferencesActionExecutionException.
 * </p>
 * @author TCSDEVELOPER
 * @version 1.0
 */
public class UserPreferencesActionExecutionExceptionUnitTest extends TestCase {

    /**
     * <p>
     * Represents UserPreferencesActionExecutionException instance for testing.
     * </p>
     */
    private UserPreferencesActionExecutionException exception;
    ...
    public void setUp() {
        ...
        exception = new UserPreferencesActionExecutionException(message);
    }
    ...
    public void testCtor_MessageData() {
        ...
        exception = new UserPreferencesActionExecutionException(message, data);
        assertNotNull("Exception should be created successfully.", exception);
        assertEquals("Message should be set successfully.", message, exception.getMessage());
    }
    ...
    public void testCtor_MessageDataCause() {
        ...
        exception = new UserPreferencesActionExecutionException(message, cause, data);
        assertNotNull("Exception should be created successfully.", exception);
        assertEquals("Message should be set successfully.", message, exception.getMessage());
    ...
    public void testCtor_MessageCause() {
        Throwable cause = new NullPointerException(message);
        exception = new UserPreferencesActionExecutionException(message, cause);
        assertNotNull("Exception should be created successfully.", exception);
        assertEquals("Message should be set successfully.", message, exception.getMessage());
        assertEquals("Cause should be set successfully.", cause, exception.getCause());
    }
