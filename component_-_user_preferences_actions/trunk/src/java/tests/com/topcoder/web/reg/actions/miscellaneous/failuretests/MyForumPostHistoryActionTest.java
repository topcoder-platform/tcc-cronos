...
/**
 * Failure tests for <code>MyForumPostHistoryAction</code>.
 * @author moon.river
 * @version 1.0
 */
public class MyForumPostHistoryActionTest extends BaseTest {
	...
	public void testPrepare_NullEmailText() throws Exception {
		try {
			instance.setMessageHistoryBean(null);
			instance.prepare();
			fail("UserPreferencesActionConfigurationException expected");
		} catch (UserPreferencesActionConfigurationException e) {
			// good
