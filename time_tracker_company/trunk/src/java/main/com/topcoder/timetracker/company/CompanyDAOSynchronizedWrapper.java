...
/**
 * <p>
 * This class is a syncrhonized wrapper for an implementation of CompanyDAO interface. Please note that this class
 * marks all of the methods as synchronized.
 * </p>
 *
 * <p>
 * <b>Thread Safety: </b>The thread safety guaranteed by this class is by synchronizing as all of its methods. However,
 * generally, the safe usage of this class also depends on how the underlying campanyDAO access the datastore, eg: the
 * JDBC transactions and database read-write lock. This class does not guarantee a safety if there are two different
 * companyDAO objects accessing the same data store. Please consult the companyDAO documentation for this matter.
 * </p>
 *
 * @author bramandia, argolite, TCSDEVELOPER
 * @version 3.2
 */
public class CompanyDAOSynchronizedWrapper {
    /**
     * <p>
     * Represents the underlying company DAO implementation that is to be synchronized.
     * </p>
     *
     * <p>
     * It will not be null, it is immutable. It is initialized in constructor.
     * </p>
     */
    ...
    /**
     * <p>
     * Create a new CompanyDAOSyncrhonizedWrapper to synchronized the given companyDAO object.
     * </p>
     *
     * @param companyDAO the companyDAO to be syncrhonized.
     *
     * @throws IllegalArgumentException if any parameter is null.
     */
    public CompanyDAOSynchronizedWrapper(CompanyDAO companyDAO) {
        TimeTrackerCompanyHelper.validateNotNull(companyDAO, "companyDAO");
     ...
     */
    public synchronized Company createCompany(Company company, String user, boolean doAudit)
        throws CompanyDAOException {
        return companyDAO.createCompany(company, user, doAudit);
    }
     ...
     * @throws CompanyDAOException if a problem occurs while accessing the datastore.
     */
    public synchronized Company retrieveCompany(long id) throws CompanyDAOException {
        return companyDAO.retrieveCompany(id);
    }
     ...
     */
    public synchronized void updateCompany(Company company, String user, boolean doAudit)
        throws CompanyDAOException {
        companyDAO.updateCompany(company, user, doAudit);
    }
     ...
     */
    public synchronized void deleteCompany(Company company, boolean doAudit, String user)
        throws CompanyDAOException {
        companyDAO.deleteCompany(company, doAudit, user);
    }
     ...
     * @throws CompanyDAOException if a problem occurs while accessing the datastore.
     */
    public synchronized Company[] listCompanies() throws CompanyDAOException {
     ...
     * @throws CompanyDAOException if a problem occurs while accessing the datastore.
     */
    public synchronized Company[] search(Filter filter) throws CompanyDAOException {
        return companyDAO.search(filter);
    }
     ...
     * @throws CompanyDAOException if a problem occurs while accessing the datastore.
     */
    public synchronized Company[] createCompanies(Company[] companies, String user, boolean doAudit)
        throws CompanyDAOException {
        return companyDAO.createCompanies(companies, user, doAudit);
    }
     ...
     */
    public synchronized Company[] retrieveCompanies(long[] ids) throws CompanyDAOException {
        return companyDAO.retrieveCompanies(ids);
    }
     ...
     */
    public synchronized void updateCompanies(Company[] companies, String user, boolean doAudit)
        throws CompanyDAOException {
        companyDAO.updateCompanies(companies, user, doAudit);
    }
     ...
     * @throws CompanyNotFoundException if some of the passed companies is not found.
     */
    public synchronized void deleteCompanies(Company[] companies, boolean doAudit, String user)
        throws CompanyDAOException {
        companyDAO.deleteCompanies(companies, doAudit, user);
    }

    /**
     * <p>
     * Return the underlying company DAO.
     * </p>
     *
     * @return the underlying company dao.
     */
     ...
     */
    public synchronized Company[] createCompaniesNonAtomically(Company[] companies, String user, boolean doAudit)
        throws BatchCompanyDAOException {
        return companyDAO.createCompaniesNonAtomically(companies, user, doAudit);
    }
     ...
     * @throws BatchCompanyDAOException if a problem occurs with multiple entities while processing them.
     */
    public synchronized void updateCompaniesNonAtomically(Company[] companies, String user, boolean doAudit)
        throws BatchCompanyDAOException {
        companyDAO.updateCompaniesNonAtomically(companies, user, doAudit);
    }
     ...
     * @throws BatchCompanyDAOException if a problem occurs with multiple entities while processing them.
     */
    public synchronized void deleteCompaniesNonAtomically(Company[] companies, boolean doAudit, String user)
        throws BatchCompanyDAOException {
        companyDAO.deleteCompaniesNonAtomically(companies, doAudit, user);
    }
}
