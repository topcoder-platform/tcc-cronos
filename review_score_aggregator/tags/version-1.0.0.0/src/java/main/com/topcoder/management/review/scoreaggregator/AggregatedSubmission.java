...
public class AggregatedSubmission extends Submission implements Comparable {
     ...
     * </p>
     */
    private final float aggregatedScore;
     ...
     */
    public AggregatedSubmission(long id, float[] scores, float score) {
        super(id, scores);

        Util.checkFloatValue(score, "score");
     ...
     */
    public AggregatedSubmission(Submission sub, float score) {
    ...
    /**
     * <p>
     * Returns the aggregated score as set in the contsructor, from the <code>aggregatedScore</code> field.
     * </p>
     *
     * @return Returns the aggregated score as set in the contsructor
     */
