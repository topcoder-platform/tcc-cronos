...
/**
 * <p>
 * An interface for the web service implementing unified <code>Facade</code> interface to various service
 * components provided by global <code>TopCoder</code> application.
 * </p>
 * 
 * <p>
 ...
 * <p>
 * <p>
 * Version 1.0.2 (Spec Reviews Finishing Touches v1.0) Change Notes: - Made the getSpecReviews method return
 * instance of SpecReview rather than a list. - Added the methods to mark ready for review, review done and
 * resubmit for review.
 * </p>
 * Module Cockpit Share Submission Integration Assembly change: Added method to retrieve all permissions by
 * projectId. </p>
 * 
 ...
 * </p>
 * <p>
 * Changes in v1.3 (Cockpit Spec Review Backend Service Update v1.0): - Added method to create specification
 * review project for an existing project. - Added method to get scorecard and review information for a
 * specific project. - Added method to upload a mock submission / final fixes to the associated specification
 * review of a project to make it ready for review. - Added method to add comments to an existing review.
 * </p>
 * <p>
 * Changes in v1.5 (Cockpit Release Assembly - Contest Repost and New Version v1.0): - Added method to re open
 * failed software contest. - Added method to create new version for development or design contest.
 * </p>
 * 
 * <p>
 * Changes in v1.5.1(Cockpit Security Facade V1.0): - It is not a web-service facade any more. - All the
 * methods accepts a parameter TCSubject which contains all the security info for current user. The
 * implementation EJB should use TCSubject and now get these info from the sessionContext. - Please use the
 * new ContestServiceFacadeWebService as the facade now. That interface will delegates all the methods to this
 * interface.
 * </p>
 * 
...
public interface ContestServiceFacade {
     ...
     * @return a <code>SubmissionData</code> providing details for the submission referenced by the specified
     *         ID or <code>null</code> if such a submission is not found.
     ...
     * 
     * @param submissionId a <code>long</code> providing the ID of a submission which has been paid for.
     * @param submissionPaymentData a <code>SubmissionPaymentData</code> providing the data of successfully
     *            purchased submission.
     * @param securityToken a <code>String</code> providing the security token to be used for tracking the
     *            payment and prevent fraud.
     * @throws PersistenceException if any error occurs when purchasing submission.
     * @throws IllegalArgumentWSException if specified <code>submissionId</code> is negative.
