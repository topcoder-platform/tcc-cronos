...
<h3>GetDocumentFileContestAction</h3>
...
<s:form action="getDocumentFileContestAction">
    <table>
        <tr>
            <td>Contest Id</td>
        ...
        <tr>
            <td>Document Id (choose 1 for text file, 2 for pdf file)</td>
            <td><s:select name="documentId" headerKey="-1"
                list="#{0:0, 1:1, 2:2}" /></td>
        </tr>
        <tr>
            <td><s:submit value="get file" /></td>
            <td></td>
        </tr>
    </table>
</s:form>
