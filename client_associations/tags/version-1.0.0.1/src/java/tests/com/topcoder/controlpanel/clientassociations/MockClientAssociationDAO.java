...
/**
 * <p>
 * Mock implementation of <code>{@link ClientAssociationDAO}</code> interface, should used only for testing purpose.
 * </p>
 * <p>
 * In order to used remotely, it should Serializable.
 * </p>
 *
 * @author TCSDEVELOPER
 * @version 1.0
 */
public class MockClientAssociationDAO implements ClientAssociationDAO, Serializable {
    /**
     * <p>
    ...
    public void assignComponent(long componentId, int clientId) throws ClientAssociationDAOException {
        throw new ClientAssociationDAOException("Failure tests");
    }
