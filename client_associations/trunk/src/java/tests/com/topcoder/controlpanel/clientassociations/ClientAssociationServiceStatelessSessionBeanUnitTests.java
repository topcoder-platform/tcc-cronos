 ...
 * @version 1.0
 */
public class ClientAssociationServiceStatelessSessionBeanUnitTests extends DBTestCase {
    ...
    public static Test suite() {
        return new TestSuite(ClientAssociationServiceStatelessSessionBeanUnitTests.class);
    }
    ...
    protected void setUp() throws Exception {
        ...
        clientAssociationService.initialize();
    }
    ...
    protected void tearDown() throws Exception {
        clientAssociationService.cleanUp();
    ...
    /**
     * <p>
     * Clean the testing dao sub context.
     * </p>
     */
    private static void cleanDAOSubcontext() {
        try {
            new InitialContext().unbind("dao");
        } catch (Exception e) {
            // ignore.
        }
    }
     ...
     * <p>
     * Unit test for
     * <code>{@link ClientAssociationServiceStatelessSessionBean#ClientAssociationServiceStatelessSessionBean()}</code>
     * constructor.
     * </p>
     * <p>
     ...
     * </p>
     */
    public void testClientAssociationServiceStatelessSessionBean_accuracy() {
        clientAssociationService = new ClientAssociationServiceStatelessSessionBean();

        assertNotNull("Instance should be always created.", clientAssociationService);
    }

    /**
     * <p>
     * Unit test for <code>{@link ClientAssociationServiceStatelessSessionBean#initialize()}</code> method.
     * </p>
     * <p>
     * If the binding object is not ClientAssociationDAO type, ClassCastException will throw, and ignored.
     * </p>
     *
     * @throws Exception
     *             pass any unexpected exception to JUnit.
     */
    public void testInitialize_invalidType() throws Exception {
        InitialContext ctx = new InitialContext();
        ctx.createSubcontext("dao").bind("clientAssociationDAO", new Integer(1));

        clientAssociationService = new ClientAssociationServiceStatelessSessionBean();
        clientAssociationService.initialize();

        // ClassCastException will thrown, but it is ignored.
        ctx.unbind("dao");
    }
     ...
     * </p>
     * <p>
     * Should retrieve the DAO through JNDI.
     * </p>
     *
     * @throws Exception
     *             pass any unexpected exception to JUnit.
    ...
    public void testInitialize_accuracy() throws Exception {
        InitialContext ctx = new InitialContext();
        ctx.createSubcontext("dao").bind("clientAssociationDAO", new MockClientAssociationDAO());
