...
insert into client(client_id, name) values (10000, 'tc');

insert into comp_client(component_id,client_id) values (1999, 10000);

insert into user_client(user_id, client_id, admin_ind) values ( 2000, 10000, 2);
