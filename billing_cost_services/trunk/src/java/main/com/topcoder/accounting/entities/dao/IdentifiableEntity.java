 ...
 * @version 1.0
 */
public abstract class IdentifiableEntity implements Serializable, JsonPrintable {
    /**
    ...
    /**
     * <p>
     * Getter method for id, simply return the namesake instance variable.
     * </p>
     *
     * @return the id
     */
    ...
    /**
     * <p>
     * Setter method for id, simply assign the value to the instance variable.
     * </p>
     *
     * @param id
     *            the id to set
    ...
    public boolean equals(Object obj) {
        ...
        if (this.getClass().isInstance(obj)) {
            return id == ((IdentifiableEntity) obj).getId();
        }
        return false;
    }
