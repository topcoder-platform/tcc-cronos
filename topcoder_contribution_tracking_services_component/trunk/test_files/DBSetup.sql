...
-- -----------------------------------------------------
-- Table original_payment
-- -----------------------------------------------------
create table 'informix'.original_payment (
    contest_id INT NOT NULL,
    prize_1st DECIMAL(10,2) NOT NULL,
    prize_2nd DECIMAL(10,2) NOT NULL,
    prize_3rd DECIMAL(10,2) NOT NULL,
    prize_4th DECIMAL(10,2) NOT NULL,
    prize_5th DECIMAL(10,2) NOT NULL,
    prize_copilot DECIMAL(10,2) NOT NULL,
    prize_milestone DECIMAL(10,2) NOT NULL,
    spec_review_cost DECIMAL(10,2) NOT NULL,
    review_cost DECIMAL(10,2) NOT NULL,
    PRIMARY KEY (contest_id),
    FOREIGN KEY (contest_id) REFERENCES project_contest_cp_config (project_id));