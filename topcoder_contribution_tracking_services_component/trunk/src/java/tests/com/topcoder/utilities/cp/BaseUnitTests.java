...
public class BaseUnitTests extends AbstractTransactionalJUnit4SpringContextTests {
    /**
     * <p>
    ...
    protected <T> T getEntity(SessionFactory sessionFactory, Class<T> clazz, long id) {
