...
/**
 * <p>
 * This exception is thrown by implementations of the services when some unexpected error occurred. Also this
 * exception is used as a base class for other specific custom non-runtime exceptions.
 * </p>
 *
 * <p>
...
public class ContributionServiceException extends BaseCriticalException {
    /**
     * <p>
     ...
     */
    public ContributionServiceException(String message, ExceptionData data) {
        super(message, data);
    }
     ...
     *            ExceptionData() will be automatically used instead.
     */
    public ContributionServiceException(String message, Throwable cause, ExceptionData data) {
