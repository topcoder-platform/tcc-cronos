		...
		<div id="container">
			<div id="content">
                <jsp:include page="includes/header.jsp">
                    <jsp:param name="tabLoc" value="forth" />
                </jsp:include>
				<div id="wholeContent">
					<div id="wholeArea">
								...
								<table cellpadding="0" cellspacing="0">
									...
									<tbody>
										<tr class="firstRow">
											...
											<td><input type="text" class="text" id="inputCreateGroupName" /></td>
										</tr>
										<tr>
											...
											<td>
												<div class="multiSelectBox">
													...
													<div class="multiOptionRow multiOptionRowChecked">
														...
														<label for="multiSelect01CheckBox02">Account Name</label>
													</div>
													<div class="multiOptionRow">
														<input type="checkbox" id="multiSelect01CheckBox03" />
														<label for="multiSelect01CheckBox03">Account Name</label>
													</div>
													<div class="multiOptionRow">
														<input type="checkbox" id="multiSelect01CheckBox04" />
														<label for="multiSelect01CheckBox04">Account Name</label>
													</div>
													<div class="multiOptionRow">
														<input type="checkbox" id="multiSelect01CheckBox05" />
														<label for="multiSelect01CheckBox05">Account Name</label>
													</div>
													<div class="multiOptionRow">
														<input type="checkbox" id="multiSelect01CheckBox06" />
														<label for="multiSelect01CheckBox06">Account Name</label>
													</div>
												</div>
											</td>
										</tr>
										<tr>
											...
											<td>
												<div class="multiSelectBox">
													...
													<div class="multiOptionRow multiOptionRowChecked">
														<input type="checkbox" checked="checked" id="multiSelect02CheckBox02" />
														<label for="multiSelect02CheckBox02">Project Name</label>
													</div>
													<div class="multiOptionRow">
														<input type="checkbox" id="multiSelect02CheckBox03" />
														<label for="multiSelect02CheckBox03">Project Name</label>
													</div>
													<div class="multiOptionRow">
														<input type="checkbox" id="multiSelect02CheckBox04" />
														<label for="multiSelect02CheckBox04">Project Name</label>
													</div>
												</div>
											</td>
										</tr>
										<tr>
											...
											<td>
												<div class="restrictionsWrapper">
													<input type="checkbox" checked="checked" id="billingCheck" />
													<label for="billingCheck">Billing Accounts</label>
													<input type="checkbox" checked="checked" id="projectsCheck" />
						...
						<div class="commandOperationBox">
							<a href="javascript:;" class="newButton1 triggerModal" rel="#createGroupConfirmModal"><span class="btnR"><span class="btnC">CREATE GROUP</span></span></a>
...
<div id="new-modal">
	...
	<div id="createGroupConfirmModal" class="outLay">
		...
		<div class="modalBody">
			...
			<div class="noticeContent">&lt;Group Name&gt; has been succesfully created for &lt;Customer Name&gt;. Invitation emails have been sent to the members added to the group.</div>
