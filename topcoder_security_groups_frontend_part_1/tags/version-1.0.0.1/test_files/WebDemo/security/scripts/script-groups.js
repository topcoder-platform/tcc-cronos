...
/* init date-pack */
	...
	$('#addGroupMemberButton').live('click',function(){
		for(i=0;i<5;i++){
			items++;
			$('#groupMemberTable').append('<tr><td class="firstColumn"><input type="text" class="text" /><a href="javascript:;" class="searchDetails triggerModal" rel="#searchModal">Search</a></td><td class="secondColumn"><div class="leftPart"><input type="radio" name="radioGroupMembers'+items+'" checked="checked" value="Group Default" id="gruopRadio'+items+'" /><label for="gruopRadio'+items+'">Group Default</label></div><div class="rightPart"><input type="radio" name="radioGroupMembers'+items+'" value="User Specific" id="userRadio'+items+'" /><label for="userRadio'+items+'">User Specific</label></div></td><td class="thirdColumn"><div class="unit"><input type="radio" disabled="disabled" name="radio'+items+'" /><label for="readRadio'+items+'">Read</label></div><div class="unit"><input type="radio" disabled="disabled" name="radio'+items+'" /><label for="writeRadio'+items+'">Write</label></div><div class="unit"><input type="radio" checked="checked" disabled="disabled" name="radio'+items+'" /><label for="fullRadio'+items+'">Full</label></div></td><td class="forthColumn"><a href="javascript:;" class="newButton2 removeButton"><span class="btnR"><span class="btnC"><span class="btnIcon">Remove</span></span></span></a></td></tr>');
		}
	...
	$('#groupMemberTable input:radio').live('click',function(){
		if($(this).val() == 'Group Default'){
			$(this).parent().parent().parent().find('.thirdColumn').find("input:radio").attr('disabled',true);	
		}else{
			$(this).parent().parent().parent().find('.thirdColumn').find("input:radio").attr('disabled',false);
		}
	});
	...
	$('#groupMemberTables input:radio').live('click',function(){
		if($(this).val() == 'Group Default'){
			$(this).parent().parent().parent().find('input:radio').attr('disabled',true);	
		}else{
			$(this).parent().parent().parent().find('input:radio').attr('disabled',false);
		}
	});
