...
/**
 * <p>
 * Unit test cases for <code>CreateMilestonesAction</code> class.
 * </p>
 *
 * @author fish_ship
 * @version 1.0
 */
public class CreateMilestonesActionTest {
    /**
     * <p>
     * The CreateMilestonesAction instance used for test.
     * </p>
     */
     ...
     * The instance of <code>CreateMilestonesAction</code> should be created.
     * </p>
     */
    @Test
    public void testCtr() {
        Assert.assertNotNull("the instance of CreateMilestonesAction should be created", instance);
    }
    ...
    public void testExecuteActionAccuracy() throws Exception {
        instance = (CreateMilestonesAction) TestHelper.APP_CONTEXT.getBean("createMilestonesAction");
        ...
        milestone.setOwners(null);
        list.add(milestone);
        instance.setMilestones(list);

        instance.executeAction();
        Assert.assertEquals("fail to create", 3, milestoneService.getMilestones().size());
    }
     ...
     * <p>
     * Failure test for <code>executeAction</code> method.<br>
     * Expected AuthorizationException because the fail to get permission.
     * </p>
     *
     * @throws Exception
     *             to JUnit
