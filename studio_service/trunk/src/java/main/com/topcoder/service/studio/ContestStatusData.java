...
/**
 * /**<p> It is the  DTO class which is used to transfer contest status data. The information can be null or can be
 * empty, therefore this check is not present in the setters.  It's the related to the equivalent ContestStatus
 * entity.</p>
 *
...
public class ContestStatusData implements Serializable {
    ...
    /**
     * <p> Return the allowableNextStatus. Make a shallow copy.</p>
     *
    ...
    /**
     * <p> Set the allowableNextStatus. Make a shallow copy.</p>
     *
