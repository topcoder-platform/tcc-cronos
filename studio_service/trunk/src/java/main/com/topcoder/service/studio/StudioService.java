...
/**
 * <p> This is service interface which defines operations available for client. It allows providing different operations
 * under contest and submission. It allows getting, updating, and creating contest data; get, remove and update
 * submission data; get some additional information like content's categories, statuses and file types.</p><p> This
 * interface defines the webservices endpoint with the operation. It uses the annotations to defined the requests and
 * responses definitions.</p>
 *
 * <p> It has the following annotations: "@WebService". All the other annotations (also in the methods) are optional:
 * WebParam, WebMethod are not necessary because if WebMethod is not used then automatically all methods are
 * WebMethod.</p>
 *
...
public interface StudioService {
    ...
    /**
     * <p> Get contests for given project. Return an empty list if there are no contests.
     *
    ...
    /**
     * <p> Upload document to contest. Return document populated with id.
     *
    ...
    /**
     * <p> Remove document from contest.
     *
    ...
    /**
     * <p> Retrieve submission data. return an empty list if there are no submission data
     *
    ...
    /**
     * <p> Retrieve submission by member. return an empty list if there are no submission data
     *
    ...
    /**
     * <p> Get contest statuses. Return an empty list if there are no ContestStatusData
     *
