...
/**
 * <p> This runtime exception extends the BaseRuntimeException, and it is thrown if the configured value is invalid, it
 * is also used to wrap the underlying exceptions when loading the configured values. </p>
 */
