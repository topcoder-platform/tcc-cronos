...
/**
 * This exception extends the ContestManagementException, and this exception is thrown from DocumentContentManager
 * interface and its implementations if any error (not including I/O error) occurs when managing the document content.
 */
