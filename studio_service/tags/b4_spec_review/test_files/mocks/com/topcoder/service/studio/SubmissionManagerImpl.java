...
public class SubmissionManagerImpl implements SubmissionManagerLocal {
    ...
    public SubmissionManagerImpl() {
        //submissions = new HashMap<Long, Submission>();
        submissions = new ArrayList<Submission>();
    }

    /**
     * <p> Gets the submission with the given id. </p>
     *
     * @param submissionId The id of the submission to get
     * @return the submission with the given id, or null if not found
     * @throws SubmissionManagementException If any error occurs during the retrieval
     */
    ...
    /**
     * <p> Gets the submissions for the contest with the given id. Also, the selectFullSubmission flag will determine if
     * the full submission is returned to the caller. </p>
     *
     * @param contestId            The id of the contest of the submissions to get
     * @param selectFullSubmission a flag whether the full submission should be returned
     * @return List of Submission for the contest with the given id, possibly empty if none found.
     * @throws SubmissionManagementException If any error occurs during the retrieval
     */
    public List<Submission> getSubmissionsForContest(long contestId, boolean selectFullSubmission) throws SubmissionManagementException {
        return submissions;
    }

    /**
     * <p> Gets the submissions for the submitter with the given id. </p>
     *
    ...
    /**
     * <p> Updates the submission in persistence. Will not allow changes to rank or prizes. It will interpret an empty
     * prize set as an indication that the prizes should not be changed. </p>
     *
     * @param submission The Submission to update
     * @throws IllegalArgumentException      If the submission argument is null
     * @throws EntityNotFoundException       If the submission does not exist in persistence or is already deleted
     * @throws SubmissionManagementException If any error occurs during the update, or if there is a change in the rank
     *                                       or prize set.
     */
    ...
    /**
     * <p> Removes the submission with the given id from persistence. </p>
     *
     ...
     * @throws SubmissionManagementException If any error occurs during the delete
     */
    ...
    /**
     * <p> Updates the status of the submission with the given id to the status with the given id. </p>
     *
     ...
     * @throws EntityNotFoundException       If the submission or status does not exist in persistence, or submission
     *                                       already deleted
     * @throws SubmissionManagementException If any error occurs during the update
     */
    public void updateSubmissionStatus(long submissionId, long submissionStatusId) throws SubmissionManagementException {
        throw new UnsupportedOperationException("Method is not implemented yet.");
    }

    /**
     * <p> Updates the submission result in persistence. </p> <p> Notes, only rank the prizes set will be changed for
     * all submissions of the contest. </p>
     *
     * @param submission The Submission whose result is to be updated
     * @throws IllegalArgumentException      If the submission argument is null, or its rank is not set.
     * @throws EntityNotFoundException       If the submission does not exist in persistence, or submission already
     *                                       deleted
     * @throws SubmissionManagementException If any error occurs during the update
     */
    ...
    /**
     * <p> Adds the prize to persistence. It will assign a new id. </p>
     *
    ...
    /**
     * <p> Updates the prize in persistence. </p>
     *
     * @param prize The Prize to update
     * @throws IllegalArgumentException      If the prize argument is null
     * @throws EntityNotFoundException       If the prize does not exist in persistence
     * @throws SubmissionManagementException If any error occurs during the update
     */
    ...
    /**
     * <p> Removes the prize with the given id from persistence. </p>
     *
    ...
    /**
     * <p> Gets the prize with the given id. Returns null if not found. </p>
     *
    ...
    /**
     * <p> Adds the prize with the given id to the submission with the given id. Both must currently exist in
     * persistence. </p>
     *
     ...
     * @throws IllegalArgumentException      If the rank of submission is not set, or the rank is not same as the
     *                                       prize's place.
     * @throws EntityNotFoundException       If the prize or submission with the given ids does not exist in
    ...
    /**
     * <p> Removes the prize with the given id from the submission with the given id. Both must currently exist in
     * persistence. No action is taken if the prize is already not in the submission. </p>
     *
     ...
     * @throws EntityNotFoundException       If the prize or submission with the given ids does not exist in
     *                                       persistence, or submission already deleted
     * @throws SubmissionManagementException If any error occurs during the removal
     */
    ...
    /**
     * <p> Adds the submission payment to persistence. The submission must already exist. </p>
     *
     * @param submissionPayment The SubmissionPayment to add
     * @return the added SubmissionPayment
     * @throws IllegalArgumentException      If the submissionPayment argument is null
     * @throws EntityNotFoundException       If the submission that this payment is for does not exist in persistence,
     *                                       or has been already deleted
     * @throws EntityExistsException         If the submission payment already exists in persistence
     * @throws SubmissionManagementException If any error occurs during the add
     */
    public SubmissionPayment addSubmissionPayment(SubmissionPayment submissionPayment) throws SubmissionManagementException {
        throw new UnsupportedOperationException("Method is not implemented yet.");
    }

    /**
     * <p> Updates the submission payment in persistence. The submission and its payment must already exist. </p>
     *
     * @param submissionPayment The submission payment to update
     * @throws IllegalArgumentException      If the submissionPayment argument is null
     * @throws EntityNotFoundException       If the submission that this payment is for does not exist in persistence,
     *                                       or has been already deleted
     * @throws EntityNotFoundException       If the submission payment does not exist in persistence
     * @throws SubmissionManagementException If any error occurs during the update
     */
    ...
    /**
     * <p> Gets the submission payment with the given id. Returns null if not found. </p>
     *
    ...
    /**
     * <p> Adds the submission review to persistence. It will assign a new id. The submission must already exist. </p>
     *
     ...
     * @throws EntityNotFoundException       If the submission that this review is for does not exist in persistence, or
     *                                       has been already deleted
     * @throws EntityExistsException         If the submission review already exists in persistence
     * @throws SubmissionManagementException If any error occurs during the add
     */
    public SubmissionReview addSubmissionReview(SubmissionReview submissionReview) throws SubmissionManagementException {
        throw new UnsupportedOperationException("Method is not implemented yet.");
    }

    /**
     * <p> Updates the submission review in persistence. The submission and its review must already exist. </p>
     *
     * @param submissionReview The submission review to update
     * @throws IllegalArgumentException      If the submissionReview argument is null
     * @throws EntityNotFoundException       If the submission that this review is for does not exist in persistence, or
     *                                       has been already deleted
     * @throws EntityNotFoundException       If the submission review does not exist in persistence
     * @throws SubmissionManagementException If any error occurs during the update
     */
    ...
    /**
     * <p> Gets the submission review for the submission with the given id. Returns null if not found. </p>
     *
     * @param submissionId The id of the submission of the submission review to get
    ...
    /**
     * <p> Removes the submission review for the submission with the given id. Returns true if anything was deleted.
     * </p>
     *
     * @param submissionId The id of the submission of the submission review to delete
     * @return true if deletion occurred, false otherwise
     * @throws SubmissionManagementException If any error occurs during the deletion
     */
    ...
    /**
     * <p> Gets the prizes of the submission with the given id. The submission must currently exist in persistence.
     * </P>
     *
     * @param submissionId the id of the submission whose prizes are to be retrieved
     * @return the retrieved prizes for the given
     * @throws EntityNotFoundException       If the submission with the given id does not exist in persistence, or
