...
/**
 * <p> This exception is thrown automatically by the web service interface when the arguments are illegal. It is related
 ...
 * java. It's necessary to store the information using the fault beans like other exception. WS is WebServices.</p><p>
 * The constructors with IllegalArgumentWSFault and the getter are necessary for the correct webservices
...
public class IllegalArgumentWSException extends IllegalArgumentException {
    ...
    /**
     * <p> Represents the roleNotFound. It is retrieved from IllegalArgumentWSFault.</p>
     */
    private final String illegalArgumentMessage;

    /**
     * <p> Construct the exception. Call the super constructor,set the fault info and set the illegalArgumentMessage
     * from the faultInfo.</p>
     *
    ...
    /**
     * <p> Return the illegalArgument Message</p>
     *
