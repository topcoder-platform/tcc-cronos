...
/**
 * Test case for <code>UnlockedDomainsHandler</code>.
 *
 * @author assistant
 * @version 1.0
 */
public class UnlockedDomainsHandlerTest extends TestCase {
    ...
    /**
     * Test method for UnlockedDomainsHandler(java.lang.String, java.lang.String).
     * In this case, gameIdParamKey is null.
     * Expected : {@link IllegalArgumentException}.
     */
    public void testUnlockedDomainsHandler_StringString_NullgameIdParamKey() {
        try {
            new UnlockedDomainsHandler(null, "id2");
     ...
     * Expected : {@link IllegalArgumentException}.
     */
    public void testUnlockedDomainsHandler_StringString_EmptygameIdParamKey() {
        try {
            new UnlockedDomainsHandler(" ", "id2");
            fail("IllegalArgumentException expected.");
        } catch (IllegalArgumentException e) {
            // should land here
        }
     ...
     * Expected : {@link IllegalArgumentException}.
     */
    public void testUnlockedDomainsHandler_StringString_NulldomainsKey() {
        try {
            new UnlockedDomainsHandler("id1", null);
            fail("IllegalArgumentException expected.");
        } catch (IllegalArgumentException e) {
            // should land here
        }
     ...
     * Expected : {@link IllegalArgumentException}.
     */
    public void testUnlockedDomainsHandler_StringString_EmptydomainsKey() {
        try {
            new UnlockedDomainsHandler("id2", " ");
            fail("IllegalArgumentException expected.");
        } catch (IllegalArgumentException e) {
    ...
    /**
     * Test method for UnlockedDomainsHandler(org.w3c.dom.Element).
     * In this case, the element is null.
     * Expected : {@link IllegalArgumentException}
     */
    public void testUnlockedDomainsHandler_Element_NullElement() {
        try {
     ...
     */
    public void testUnlockedDomainsHandler_Element_MissingGameIdParamKey() throws IOException, ParserConfigurationException, Exception {
        try {
            String xml =
                "<handler type=\"x\">"
     ...
     * @throws Exception to JUnit
     */
    public void testUnlockedDomainsHandler_Element_EmptyGameIdParamKey() throws IOException, ParserConfigurationException, Exception {
        try {
            String xml =
                "<handler type=\"x\">"
     ...
     * @throws Exception to JUnit
     */
    public void testUnlockedDomainsHandler_Element_MissingDomainsKey() throws IOException, ParserConfigurationException, Exception {
        try {
            String xml =
                "<handler type=\"x\">"
     ...
     * @throws Exception to JUnit
     */
    public void testUnlockedDomainsHandler_Element_EmptyDomainsKey() throws IOException, ParserConfigurationException, Exception {
        try {
            String xml =
                "<handler type=\"x\">"
                + "<game_id_param_key> </game_id_param_key>"
