-- Note: that the client table was modified to reflect 3.1 design
-- added sales tax, satart date, end date, active and payment_terms_id
-- please see docs/TimeTrackerClient_Project_ERD.jpg
create table client  (
  ...
  primary key (client_id) constraint pk_client
);
...
-- duplicate of fk_address_state_name
--alter table address
...
--       ADD CONSTRAINT FOREIGN KEY (payment_terms_id)
--       REFERENCES payment_terms
--       constraint fk_project_payment_terms;
