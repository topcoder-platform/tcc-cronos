...
After creating the db tables for unit and stress databases by running test_files/create_db.sql,
there must be runned test_files/create_tables.sql(for unit tests and stress tests databases).
