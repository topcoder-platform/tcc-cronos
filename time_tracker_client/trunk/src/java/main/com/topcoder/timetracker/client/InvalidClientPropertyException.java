...
/**
 * <p>
 * This exception will be thrown by the ClientUtility when the property of the given Client is invalid.
 * </p>
 *
 * <p>
...
public class InvalidClientPropertyException extends ClientUtilityException {
     ...
     */
    public InvalidClientPropertyException(String message) {
        super(message);
    }
     ...
     */
    public InvalidClientPropertyException(String message, Exception cause) {
        super(message, cause);
    }
}
