 ...
 */
    public void addPaymentTerm(PaymentTerm paymentTerm) throws PaymentTermDAOException, DuplicatePaymentTermException;
/**
 ...
 */
    public void updatePaymentTerm(PaymentTerm paymentTerm) throws PaymentTermDAOException, PaymentTermNotFoundException;
/**
 ...
 */
    public PaymentTerm retrievePaymentTerm(long id) throws PaymentTermDAOException, PaymentTermNotFoundException;
/**
 ...
 */
    public PaymentTerm[] retrievePaymentTerms(long[] ids) throws PaymentTermDAOException, PaymentTermNotFoundException, CommonManagementException;
/**
 ...
 * @throws PaymentTermNotFoundException if there is no PaymentTerm with the given id in the data store
 */
    public void deletePaymentTerm(long id) throws PaymentTermNotFoundException, PaymentTermDAOException;
/**
 ...
 */
    public void deletePaymentTerm(PaymentTerm paymentTerm) throws PaymentTermDAOException, PaymentTermNotFoundException;
/**
 ...
 * @throws PaymentTermNotFoundException if there is no PaymentTerm like one of the given ids in the data store
 */
    public void deletePaymentTerms(long[] ids) throws PaymentTermDAOException, PaymentTermNotFoundException;
/**
 ...
 */
    public void deletePaymentTerms(PaymentTerm[] paymentTerm) throws PaymentTermNotFoundException, PaymentTermDAOException;
/**
