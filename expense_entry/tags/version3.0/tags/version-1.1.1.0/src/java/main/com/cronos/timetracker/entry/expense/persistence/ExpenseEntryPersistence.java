 ...
 * deleting and retrieving. The information in expense entry is used directly without any modifications. Usually, user
 * should not use this interface directly.
 * </p>
 *
 * <p>
 * Implementations should provide two constructors accpeting one and two string arguments respectively in order to be
 * used by <code>ExpenseEntryManager</code> class. For one-argument constructor, the argument defines a configuration
 * namespace. For two-argument constructor, the arguments define a connection producer name and a configuration
 * namespace.
 * </p>
 *
 * <p>
...
public interface ExpenseEntryPersistence {
     ...
     */
    boolean addEntry(ExpenseEntry entry) throws PersistenceException;
     ...
     */
    boolean deleteEntry(int entryId) throws PersistenceException;
     ...
     */
    void deleteAllEntries() throws PersistenceException;
     ...
     */
    boolean updateEntry(ExpenseEntry entry) throws PersistenceException;
     ...
     *         invalid.
     */
    ExpenseEntry retrieveEntry(int entryId) throws PersistenceException;
     ...
     *         invalid.
     */
    List retrieveAllEntries() throws PersistenceException;
     ...
     */
    void initConnection(String connectionProducerName) throws PersistenceException;
     ...
     */
    void setConnection(Connection connection) throws PersistenceException;
     ...
     * @since 1.1
     */
    ExpenseEntry[] addEntries(ExpenseEntry[] entries, boolean isAtomic) throws PersistenceException;
     ...
     * @since 1.1
     */
    int[] deleteEntries(int[] entryIds, boolean isAtomic) throws PersistenceException;
     ...
     * @since 1.1
     */
    ExpenseEntry[] updateEntries(ExpenseEntry[] entries, boolean isAtomic)
     ...
     * @since 1.1
     */
    ExpenseEntry[] retrieveEntries(int[] entryIds, boolean isAtomic) throws PersistenceException;
