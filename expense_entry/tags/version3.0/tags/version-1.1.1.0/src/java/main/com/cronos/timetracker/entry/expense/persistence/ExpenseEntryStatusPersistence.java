...
/**
 * <p>
 * Defines functionality to manipulate expense entry statuses in persistence. The operations include adding, updating,
 * deleting and retrieving. The information in expense entry status is used directly without any modifications.
 * Usually, user should not use this interface directly.
 * </p>
 *
 * <p>
