...
public final class TestHelper {
    ...
    public static void assertEquals(ExpenseEntry expected, ExpenseEntry actual) {
        ...
        Assert.assertTrue("The reject reasons are not equal.",
            compareIntArray(expected.getRejectReasonIds(), actual.getRejectReasonIds()));
    }
    ...
    /**
     * Create an ExpenseEntryStatus instance according data in database which has been initialized in initDatabase()
     * method.
     *
    ...
    /**
     * Compares the two array of ExpenseEntryRejectReason instances to judge whether they consist of the same elements
     * disregarding the order of their appearing.
     *
     ...
     */
    public static boolean compareRejectReasonsArray(ExpenseEntryRejectReason[] array1, ExpenseEntryRejectReason[] array2) {
