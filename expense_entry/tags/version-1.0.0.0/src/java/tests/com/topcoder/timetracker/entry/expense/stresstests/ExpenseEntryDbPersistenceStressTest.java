...
public class ExpenseEntryDbPersistenceStressTest extends TestCase {
     ...
     */
    private final int testCount = 200;
    ...
    * Aggragates all tests in this class.
    ...
    public void testExpenseEntryDbPersistenceStress() throws Exception {
        ...
        ExpenseEntryTypeDbPersistence typePersistence = new ExpenseEntryTypeDbPersistence("Connection",
                DB_NAMESPACE);
        ExpenseEntryStatusDbPersistence statusPersistence = new ExpenseEntryStatusDbPersistence("Connection",
                DB_NAMESPACE);
        ...
        try {
            ...
            System.out.println("addEntry for " + testCount + " times takes " + (new Date().getTime() - start)
                + "ms");
            ...
            System.out.println("retrieveEntry for " + testCount + " times takes "
            ...
            System.out.println("updateEntry for " + testCount + " times takes "
                + (new Date().getTime() - start) + "ms");
            ...
            System.out.println("deleteEntry for " + testCount + " times takes "
                + (new Date().getTime() - start) + "ms");
        } finally {
    ...
    public void testExpenseEntryTypeDbPersistenceStress()
        throws Exception {
        ExpenseEntryType type = null;
        ExpenseEntryTypeDbPersistence persistence = new ExpenseEntryTypeDbPersistence("Connection",
                DB_NAMESPACE);
        ...
        try {
            ...
            System.out.println("addType for " + testCount + " times takes " + (new Date().getTime() - start)
                + "ms");
            ...
            System.out.println("retrieveType for " + testCount + " times takes "
                + (new Date().getTime() - start) + "ms");
            ...
            System.out.println("updateType for " + testCount + " times takes "
                + (new Date().getTime() - start) + "ms");
            ...
            System.out.println("deleteType for " + testCount + " times takes "
                + (new Date().getTime() - start) + "ms");
        } finally {
            persistence.closeConnection();
        }
    ...
    public void testExpenseEntryStatusDbPersistenceStress()
        throws Exception {
        ExpenseEntryStatus status = null;
        ExpenseEntryStatusDbPersistence persistence = new ExpenseEntryStatusDbPersistence("Connection",
                DB_NAMESPACE);
        ...
        try {
            ...
            System.out.println("addStatus for " + testCount + " times takes "
                + (new Date().getTime() - start) + "ms");
            ...
            System.out.println("retrieveStatus for " + testCount + " times takes "
                + (new Date().getTime() - start) + "ms");
            ...
            System.out.println("updateStatus for " + testCount + " times takes "
                + (new Date().getTime() - start) + "ms");
            ...
            System.out.println("retrieveAllStatuses for 1 time takes " + (new Date().getTime() - start)
                + "ms");
            ...
            System.out.println("deleteStatus for " + testCount + " times takes "
                + (new Date().getTime() - start) + "ms");
        } finally {
            persistence.closeConnection();
        }
