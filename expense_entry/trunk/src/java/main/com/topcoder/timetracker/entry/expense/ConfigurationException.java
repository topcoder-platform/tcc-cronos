...
/**
 * <p>
 * Defines a custom exception which is thrown if error occurs when reading the configuration value. It happens when
 * the configuration value is missing or invalid.
 * </p>
 *
