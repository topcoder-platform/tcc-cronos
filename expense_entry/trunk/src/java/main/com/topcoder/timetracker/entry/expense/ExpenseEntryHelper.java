 ...
 *
 * <p>
 * Changes in 1.1: the type of <code>value</code> of method <code>validateCommonInfoData</code> is changed to type of
 * <code>BasicInfo</code>.
 * </p>
 *
 * @author TCSDEVELOPER
...
final class ExpenseEntryHelper {
     ...
     *
     * @throws ConfigurationException if the instance of the given class name cannot be created; or the created
     *         instance is not the given type; or the namespace to create DB connection factory is <code>null</code>
     *         or empty string.
     */
    public static Object createInstance(String className, String connectionProducerName, String namespace, Class type)
        ...
        try {
            ...
            if (connectionProducerName == null) {
                ...
                obj = cls.getConstructor(new Class[] {String.class, String.class}).newInstance(new Object[] {
                    connectionProducerName, namespace});
            }
    ...
    /**
     * <p>
     * Validates the data of a <code>BasicInfo</code> instance. All properties exception creation date and modification
     * date should not be <code>null</code>.
     * </p>
     *
     * <p>
     * Changes in 1.1: the type of <code>value</code> is changed to type of <code>BasicInfo</code>.
     * </p>
     *
     * @param value the <code>BasicInfo</code> instance to validate.
     *
     ...
     * @since 1.0
     */
    public static void validateCommonInfoData(BasicInfo value) throws InsufficientDataException {
    ...
    public static void validateExpenseEntryData(ExpenseEntry value) throws InsufficientDataException {
        ...
        if (value.getMileage() == null) {
            throw new InsufficientDataException("Expense mileage is missing.");
        }
     ...
     *         <code>null</code>.
     */
    public static void validateExpenseEntryStatusData(ExpenseEntryStatus value)
     ...
     *         <code>null</code>.
     */
    public static void validateExpenseEntryTypeData(ExpenseEntryType value)
        throws InsufficientDataException {
        // This method is created to leave space to add more validation for future properties.
        validateCommonInfoData(value);
    }
