...
public class UnitTestHelper {
    ...
    public static ExpenseEntry BuildExpenseEntry() throws Exception {
        ...
        entry.setDate(UnitTestHelper.createDate(2005, 2, 5));
        entry.setExpenseType(type);
        entry.setStatus(status);
        entry.setMileage(10);
        entry.setInvoice(UnitTestHelper.BuildInvoice());
     ...
     */
    public static Criteria[] copyCriteriaCollection(Criteria[] criteria) {
    ...
    public static void assertEquals(String message, Date expected, Date actual) {
        if (expected == null) {
            Assert.assertNull("Date should be null.", actual);
    ...
    /**
     * <p>
     * Asserts that two given expense type should be the same. They are considered the same if and only if their fields
     * are the same.
     * </p>
     *
     * @param expected the expected expense type.
     * @param actual the actual expense type.
     */
    public static void assertEquals(ExpenseType expected, ExpenseType actual) {
        ...
        Assert.assertEquals("The creation user should be correct.",
        ...
        Assert.assertEquals("The changed flag should be correct.", expected.isChanged(), actual.isChanged());

        Assert.assertEquals("The active flag should be correct.", expected.getActive(), actual.getActive());
        Assert.assertEquals("The company id should be correct.", expected.getCompanyId(), actual.getCompanyId());
    }

    /**
     * <p>
     * Asserts that two given expense status should be the same. They are considered the same if and only if their
     * fields are the same.
     * </p>
     *
     * @param expected the expected expense status.
     * @param actual the actual expense status.
     */
    public static void assertEquals(ExpenseStatus expected, ExpenseStatus actual) {
        Assert.assertEquals("The ID should be correct.", expected.getId(), actual.getId());
        Assert.assertEquals("The description should be correct.", expected.getDescription(), actual.getDescription());
        assertEquals("The creation date should be correct.", expected.getCreationDate(), actual.getCreationDate());
        assertEquals("The modification date should be correct.", expected.getModificationDate(),
    ...
    public static void assertEquals(ExpenseEntry expected, ExpenseEntry actual) {
        ...
        Assert.assertEquals("The invoice should be correct.", expected.getInvoice(), actual.getInvoice());

        Map expectedRejectReasons = expected.getRejectReasons();
        Map actualRejectReasons = actual.getRejectReasons();
        Assert.assertEquals("The count of the reject reasons should be correct.",
            (expectedRejectReasons == null) ? 0 : expectedRejectReasons.size(),
            (actualRejectReasons == null) ? 0 : actualRejectReasons.size());
    }

    /**
     * <p>
     * Asserts the array of the ExpenseType is the same as the expected result.
     * </p>
     *
     * @param expected the expected ExpenseType array.
     * @param actual the actual ExpenseType array.
     */
    public static void assertEquals(ExpenseType[] expected, ExpenseType[] actual) {
    ...
    /**
     * <p>
     * Asserts the array of the ExpenseStatus is the same as the expected result.
     * </p>
     *
     * @param expected the expected ExpenseStatus array.
     * @param actual the actual ExpenseStatus array.
     */
    public static void assertEquals(ExpenseStatus[] expected, ExpenseStatus[] actual) {
        Assert.assertEquals("The return length should be correct.", expected.length, actual.length);
    ...
    /**
     * <p>
     * Asserts the array of the ExpenseEntry is the same as the expected result.
     * </p>
     *
     * @param expected the expected ExpenseEntry array.
     * @param actual the actual ExpenseEntry array.
     */
    public static void assertEquals(ExpenseEntry[] expected, ExpenseEntry[] actual) {
        Assert.assertEquals("The return length should be correct.", expected.length, actual.length);
