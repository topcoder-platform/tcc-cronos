 ...
 * @version 1.1
 */
public class V1Dot1FieldBetweenCriteriaUnitTest extends TestCase {
    /**
    ...
    public void testFieldBetweenCriteria_NullFromValue() {
        ...
        assertNull("The from value should be correct.",
            V1Dot1TestHelper.getPrivateField(criteria.getClass(), criteria, "fromValue"));
        assertEquals("The to value should be correct.", TO_VALUE,
            V1Dot1TestHelper.getPrivateField(criteria.getClass(), criteria, "toValue"));
    }
    ...
    /**
     * <p>
     * Tests the method of <code>getCreationDateBetweenCriteria(BigDecimal, BigDecimal)</code> when fromValue is
