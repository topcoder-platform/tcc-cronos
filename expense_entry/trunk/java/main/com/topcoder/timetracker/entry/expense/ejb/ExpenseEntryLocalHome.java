...
/**
 * <p>
 * The local home interface of the Expense Entry EJB. It contains one, no-argument create method to create an instance
 * of the local Expense Entry.
 * </p>
 *
 * <p>
 ...
 * @version 3.2
 */
public interface ExpenseEntryLocalHome extends EJBLocalHome {
    /**
     * <p>
     ...
     */
    ExpenseEntryLocal create() throws CreateException;
}
