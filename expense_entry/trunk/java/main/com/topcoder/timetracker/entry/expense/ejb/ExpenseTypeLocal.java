...
/**
 * <p>
 * The local interface of the Expense Type EJB, which provides access to the persistent store for expense types managed
 * by the application. It provides the operations for managing an expense type. <code>ExpenseTypeBean</code> is the
 * corresponding bean that will perform the actual tasks.
 * </p>
 *
 * <p>
 ...
 * @version 3.2
 */
public interface ExpenseTypeLocal extends EJBLocalObject {
    /**
     * <p>
