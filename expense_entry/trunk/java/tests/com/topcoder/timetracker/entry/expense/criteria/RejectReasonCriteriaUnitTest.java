 ...
 * @version 3.2
 */
public class RejectReasonCriteriaUnitTest extends TestCase {
    /**
    ...
    public void testRejectReasonCriteria_Accuracy() {
        assertEquals("The rejectReasonId value should be correct.", "" + ID,
            UnitTestHelper.getPrivateField(criteria.getClass(), criteria, "rejectReasonId").toString());
    }
    ...
    public void testGetParameters_Accuracy() {
        ...
        assertEquals("The parameters should be correct.", new Long(ID), this.criteria.getParameters()[0]);
    }
}
