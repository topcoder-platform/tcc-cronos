...
{
    /// <summary>
    /// Failure tests for <code>RatingDistanceCalculator</code>.
    /// </summary>
    ///
    /// <author>ivern</author>
    ...
    [TestFixture]
    public class RatingDistanceCalculatorFailureTests
    {
        /// <summary>
        /// Represents the <code>RatingDistanceCalculator</code> instance used for testing.
        /// </summary>
        ...
        public void SetUp()
        {
            distance = new RatingDistanceCalculator();
