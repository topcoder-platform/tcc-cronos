...
{
    /// <summary>
    /// Failure tests for <code>OverlapDistanceCalculator</code>.
    /// </summary>
    ///
    /// <author>ivern</author>
    ...
    [TestFixture]
    public class OverlapDistanceCalculatorFailureTests
    {
        /// <summary>
        /// Represents the <code>OverlapDistanceCalculator</code> instance used for testing.
        /// </summary>
        ...
        public void SetUp()
        {
            distance = new OverlapDistanceCalculator();
