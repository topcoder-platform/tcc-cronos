 ...
 * @version 1.0
 */
public class MockReviewPersistence implements ReviewPersistence {
    /**
     * <p>
    ...
    /**
     * <p>
     * This variable represents the map containing review entities of this <code>MockReviewPersistence</code> class. The
     * key of this map is the id of review entity, the value is the corresponding review entity.
     * </p>
     */
    ...
    /**
     * <p>
     * This variable represents the map containing items of this <code>MockReviewPersistence</code> class. The key of
     * this map is the id of items, the value is the corresponding items.
     * </p>
     */
    ...
    /**
     * <p>
     * This method will search the review entities with the given search filters. If the complete argument is false, the
     * assoicated items and comments of the matching review entity will not been retrieved. Here it just return a empty
     * array.
     * </p>
     *
     * @param filter
     ...
     *         type can be found.
     * @throws ReviewPersistenceException to JUnit
     */
    ...
    /**
     * <p>
     * This method will valid the state of this persistence. It will throw <code>ReviewPersistenceException</code> when
     * the persistence is stopped.
     * </p>
     *
     * @throws ReviewPersistenceException
