...
/**
 * <p>
 * This is a test case for <code>RegistrationServiceConfigurationException</code> class.
 * </p>
 * @author moonli
 * @version 1.0
 */
public class RegistrationServiceConfigurationExceptionTest extends TestCase {
    ...
    public void testCtorWithMsg() throws Exception {
        Exception ex = new RegistrationServiceConfigurationException("msg");
    ...
    public void testCtorWithMsgAndCause() throws Exception {
        ...
        Exception ex = new RegistrationServiceConfigurationException("message", e);
        assertNotNull("'ex' should not be null.", ex);
