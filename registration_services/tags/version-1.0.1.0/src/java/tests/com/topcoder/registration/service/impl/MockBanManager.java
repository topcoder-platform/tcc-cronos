...
/**
 * <p>
 * This is a mock implementation of <code>BanManager</code>.
 * </p>
 * @author moonli
 * @version 1.0
 */
public class MockBanManager implements BanManager {
    ...
    /**
     * <p>
     * This method sets a ban to a member. If the member currently has a ban in effect, this ban
     * entry overwrites(removes) the existing ban. The number of days of the ban must be a positive
     * number.
     * </p>
     * @param userId
    ...
    /**
     * <p>
     * This method eliminates the existing ban(if any) for a member currently in effect. If there's
     * no ban in effect, it does nothing.
     * </p>
     * @param userId
    ...
    /**
     * <p>
     * This method returns the expiration date of the current ban in effect for the user. If there's
     * no ban in effect, it returns null.
     * </p>
     * @param userId
     *            the id of the user for which to get ban expiration date.
     * @return the expiration date of the ban if user is currently banned or null if user is
