...
/**
 * The mock class for <code>TeamServices</code>.
 *
 * @author liulike
 * @version 1.0
 */
public class MockTeamServices implements TeamServices {
     ...
     * @param team The team header to either create or update
    ...
    /**
     * Gets all teams that are registered for the project with the given ID. Returns empty array if the there
     * are no teams in this project.
     *
    ...
    /**
     * Gets the team members, including the captain, in this team. It will return at least one member in the
     * array since a team always has a captain.
     *
    ...
    /**
     * Removes a team and all its positions. It will send a notification message to all team members and
     * captain informing of the team removal.
     *
     * @return OperationResult with the results of the operation
    ...
    /**
     * Gets the details, in terms of the position and resource, of each position. If there are no positions
     * yet configured for a team, it returns an empty array.
     *
     * @return ResourcePosition[] The details of all positions in the team
     * @param teamId The ID of the team whose position details are to be retrieved
     * @throws IllegalArgumentException If teamId is negative
     */
    ...
    /**
     * Gets all free agents available to this project. Returns an empty array if there are no available free
     * agents.
     *
     * @return Resource[] of resource whose roles are defined as being free agents
     * @param projectId The ID of the project whose free agents are to be retrieved
     * @throws IllegalArgumentException If projectId is negative
     */
     ...
     *
     * @return OperationResult with the results of the operation
     * @param position TeamPosition to create or update
     * @param teamId The ID of the team this position is part of
     * @param userId The user Id for logging and auditing purposes
     * @throws IllegalArgumentException If position is null, or userId or teamId is negative
     */
     ...
     *
     * @return OperationResult with the results of the operation
     * @param teamId The ID of the team to finalize
     * @param userId The user Id for logging and auditing purposes
     * @throws IllegalArgumentException If teamId or userId is negative
     */
     ...
     * @throws IllegalArgumentException If offer is null, or offer.offerId is negative
     */
     ...
     * @param userId The ID of the user whose offer receivables we want
    ...
    /**
     * Accepts the offer and sets the position resource ID, payment percentage and making the position filled
     * and sends a message to the user informing of the acceptance.
     *
     * @return OperationResult with the results of the operation
     * @param offerId The ID of the offer to accept
     * @param userId The ID of the user who is accepting the offer
     * @throws IllegalArgumentException If offerId or userId is negative
     */
     ...
     * @param userId The ID of the user who is rejecting the offer
     * @throws IllegalArgumentException If offerId or userId is negative
     */
     ...
     *
     * @return OperationResult with the results of the operation
     * @param resourceId The resource to remove from the team
     * @param userId userId The user Id for logging and auditing purposes
     * @throws IllegalArgumentException If resourceId or userId is negative
     */
     ...
     *
     * @return OperationResult with the results of the operation
     * @param projectId The ID of the project whose unfinalized teams are forced to be finalized
     * @param userId userId The user Id for logging and auditing purposes
     * @throws IllegalArgumentException If projectId or userId is negative
     */
