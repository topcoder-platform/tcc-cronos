...
/**
 * The mock class for <code>ResourceManager</code>.
 *
 * @author liulike
 * @version 1.0
 */
public class MockResourceManager implements ResourceManager {
     ...
     *         resource.getResourceRole() is null), or if the resource role is associated with a phase type
     *         and the resource role is not associated with a phase or the resource or the operator is null
     ...
     * @param operator The operator making the update
     * @throws IllegalArgumentException If resource or operator is null or if the id of the resource is
     *         UNSET_ID
     ...
     * @throws IllegalArgumentException if a required field of the resource is not set (if
     *         resource.getResourceRole() is null), or if the resource role is associated with a phase type
     *         and the resource role is not associated with a phase or if operator is null, or the project is
     ...
     * @throws IllegalArgumentException If resources in the array have a project that is not the same as the
     *         project argument
     */
    ...
    /**
     * <p>
     * Searches the resources in the persistence store using the given filter. The filter can be formed using
     * the field names and utility methods in ResourceFilterBuilder. The return will always be a non-null
    ...
    /**
     * <p>
     * Updates the given resource role in the persistence store. If the resource role is new (id is UNSET_ID),
     * then an id should be assigned and the resource role added to the persistence store. Otherwise the
     * resource role data in the persistence store should be updated.
     * </p>
     *
     * @param resourceRole the resource role to update
     * @param operator the operator making the update
     * @throws IllegalArgumentException if a required field of the resource role is missing (i.e. name or
     *         description of the resource role is null) or if resourceRole or operator is null
     ...
     * @param operator The operator making the update
     * @throws IllegalArgumentException If the id of the resource role is UNSET_ID, or if resourceRole or
     *         operator is null
     * @throws ResourcePersistenceException If there is an error updating the the persistence store.
     */
    ...
    /**
     * <p>
     * Searches the resource roles in the persistence store using the given filter. The filter can be formed
     * using the field names and utility methods in ResourceRoleFilterBuilder. The return will always be a
    ...
    /**
     * <p>
     * Adds a list of notifications for the given user ids to the persistence store. All of the notification
     * are added are for the given project and type.
     * </p>
     *
     ...
     * @throws IllegalArgumentException If any item of users, project, or notificationType is &lt;= 0, or
     *         operator or users is null
     * @throws ResourcePersistenceException If there is an error updating the persistence store
     */
    ...
    /**
     * <p>
     * Removes a list of notifications for the given user ids from the persistence store. The notifications
     * removed are for the given project and type.
     * </p>
     *
     ...
     * @throws IllegalArgumentException If any item of users, project, or notificationType is &lt;= 0 or the
     *         operator or users is null.
     * @throws ResourcePersistenceException If there is an error updating the persistence store
     */
    ...
    /**
     * <p>
     * Gets the user id for all notifications for the given project and type. The return will always be a
     * non-null (possibly 0 item) array.
     * </p>
     *
    ...
    /**
     * <p>
     * Searches the notifications in the persistence store using the given filter. The filter can be formed
     * using the field names and utility methods in NotificationFilterBuilder. The return will always be a
     * non-null (possibly 0 item) array.
     * </p>
     *
     * @param filter The filter to use
    ...
    /**
     * <p>
     * Updates the given notification type in the persistence store. If the notification type is new (id is
     * UNSET_ID), then an id should be assigned and the notification type added to the persistence store.
     ...
     * @param operator The operator making the update
     * @throws IllegalArgumentException If a required field of the notification type is missing (i.e. name or
     *         description of the notification type is null), or notification or operator is null
     * @throws ResourcePersistenceException If there is an error updating the persistence
     */
     ...
     * @param operator The operator making the update
     * @throws IllegalArgumentException If the id of the resource role is UNSET_ID, or notificationType or
     *         operation is null
     * @throws ResourcePersistenceException If there is an error updating the the persistence store.
     */
    ...
    /**
     * <p>
     * Searches the notification types in the persistence store using the given filter. The filter can be
     * formed using the field names and utility methods in NotificationTypeFilterBuilder. The return will
