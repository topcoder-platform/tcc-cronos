...
/**
 * <p>
 * This is a test case for <code>RegistrationValidationException</code> class.
 * </p>
 * @author moonli
 * @version 1.0
 */
public class RegistrationValidationExceptionTest extends TestCase {
    ...
    public void testCtorWithMsg() throws Exception {
        Exception ex = new RegistrationValidationException("msg");
    ...
    public void testCtorWithMsgAndCause() throws Exception {
        ...
        Exception ex = new RegistrationValidationException("message", e);
        assertNotNull("'ex' should not be null.", ex);
