...
/**
 * The mock class for <code>RegistrationValidator</code>.
 *
 * @author liulike
 * @version 1.0
 */
public class MockRegistrationValidator implements RegistrationValidator {
     ...
     * implementation. This may include checks as to whether these three parameters are consistent with each
     * other.
     * </p>
     *
     * @return OperationResult the result of the registration validation.
     * @param registration the registration information
     * @param user the full information about the user associated with the registration
     * @param project the full project data related to the registration
     * @throws IllegalArgumentException if any parameter is null
     * @throws RegistrationValidationException if any unexpected error occurs
     */
