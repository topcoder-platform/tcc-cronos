...
/**
 * <p>
 * Stress test for <code>SpecificationReviewStartingAction</code> class.
 * </p>
 * @author morehappiness
 * @version 1.0
 */
public class SpecificationReviewStartingActionStressTests extends StrutsSpringTestCase {
    /**
    ...
    public void test_executeAction() throws Exception {
        ...
        for (int i = 0; i < RUN_TIMES; i++) {
            ...
            ActionProxy proxy = getActionProxy("/SpecificationReviewStartingAction");
