...
/**
 * <p>
 * Unit test for <code>ContestRepostingAction</code> class.
 * </p>
 * @author zju_jay
 * @version 1.0
 */
public class ContestRepostingActionTest extends BaseStrutsSpringTestCase {
    /**
     * Represents the action mapping name of the tested action.
     */
    private static final String ACTION_NAME = "/ContestRepostingAction";
    ...
    public void testExecuteAction_Accuracy() throws Exception {
        ...
        ContestRepostingAction action = (ContestRepostingAction) proxy.getAction();
    ...
    public void testInheritance() throws Exception {
        TestHelper.assertSuperclass(ContestRepostingAction.class, BaseDirectStrutsAction.class);
    }

    /**
     * <p>
     * Tests <code>ContestRepostingAction()</code> method.
     * </p>
     * <p>
    ...
    public void testCtor_Accuracy() {
        assertNotNull("instance should be created all the time.", new ContestRepostingAction());
    }
