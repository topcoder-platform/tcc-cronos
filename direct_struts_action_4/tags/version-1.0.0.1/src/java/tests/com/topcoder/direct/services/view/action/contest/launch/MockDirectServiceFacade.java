...
public class MockDirectServiceFacade implements DirectServiceFacade {
     ...
     * @throws DirectServiceFacadeException if some other error occurred
     */
    public ContestReceiptData getContestReceiptData(TCSubject tcSubject, long contestId,
        boolean isStudio) throws DirectServiceFacadeException {
        return null;
    }
     ...
     * @throws DirectServiceFacadeException if some other error occurred
     */
    public ContestReceiptData sendContestReceiptByEmail(TCSubject tcSubject, long contestId,
        boolean isStudio, String[] additionalEmailAddrs) throws DirectServiceFacadeException {
     ...
     * @throws DirectServiceFacadeException if some other error occurred
     */
    public ProjectBudget updateProjectBudget(TCSubject tcSubject, long billingProjectId,
        double changedAmount) throws DirectServiceFacadeException {
