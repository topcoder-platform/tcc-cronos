...
/**
 * <p>
 * Stress test for <code>ContestDeletingAction</code> class.
 * </p>
 * @author morehappiness
 * @version 1.0
 */
public class ContestDeletingActionStressTests extends StrutsSpringTestCase {
    /**
    ...
    public void test_executeAction() throws Exception {
        ...
        for (int i = 0; i < RUN_TIMES; i++) {
            ...
            ActionProxy proxy = getActionProxy("/ContestDeletingAction");
