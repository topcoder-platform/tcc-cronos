...
/**
 * <p>
 * Stress test for <code>ContestRepostingAction</code> class.
 * </p>
 * @author morehappiness
 * @version 1.0
 */
public class ContestRepostingActionStressTests extends StrutsSpringTestCase {
    /**
    ...
    public void test_executeAction() throws Exception {
        for (int i = 0; i < RUN_TIMES; i++) {
            ...
            ActionProxy proxy = getActionProxy("/ContestRepostingAction");
