...
/**
 * <p>
 * This is an implementation of <code>Contest Service Facade</code> web service in form of
 * stateless session EJB. It holds a reference to {@link StudioService} which is delegated the
...
public class MockContestServiceFacade implements ContestServiceFacade {
    ...
    /**
     * <p>
     * Constructs new <code>ContestServiceFacadeBean</code> instance. This implementation
     * instantiates new instance of payment processor. Current implementation just support
     * processing through PayPalCreditCard. When multiple processors are desired the implementation
     * should use factory design pattern to get the right instance of the payment processor.
     * </p>
     */
    ...
    /**
     * <p>
     * Creates new contest for specified project. Upon creation an unique ID is generated and
     * assigned to returned contest.
     * </p>
     * @param tcSubject TCSubject instance contains the login security info for the current user
     * @param contest a <code>StudioCompetition</code> providing the data for new contest to be
     *        created.
     * @param tcDirectProjectId a <code>long</code> providing the ID of a project the new
     *        competition belongs to. a <code>long</code> providing the ID of a client the new
     *        competition belongs to.
     * @return a <code>StudioCompetition</code> providing the data for created contest and having
     *         the ID auto-generated.
     */
     ...
     * </p>
     * @param tcSubject TCSubject instance contains the login security info for the current user
     * @param tcDirectProjectId a <code>long</code> providing the ID of a project to get the list
     *        of associated contests for.
     * @return a <code>List</code> providing the contests for specified project. Empty list is
     *         returned if there are no such contests found.
     */
     ...
     * </p>
     * @param tcSubject TCSubject instance contains the login security info for the current user
     * @param uploadedDocument an <code>UploadedDocument</code> providing the data for the
     *        uploaded document.
     * @return an <code>UploadedDocument</code> passed as argument and having the document ID
     ...
     * </p>
     * @param tcSubject TCSubject instance contains the login security info for the current user
     * @param documentId a <code>long</code> providing the ID of a document to be associated with
     *        specified contest.
     * @param contestId a <code>long</code> providing the ID of a contest to associate the
     *        specified document with.
     */
     ...
     * </p>
     * @param tcSubject TCSubject instance contains the login security info for the current user
     * @param contestId a <code>long</code> providing the ID of a contest to get the list of
     *        submissions for.
     * @return a <code>List</code> providing the details for the submissions associated with the
     *         specified contest. Empty list is returned if there are no submissions found.
     */
     ...
     * </p>
     * @param tcSubject TCSubject instance contains the login security info for the current user
     * @param submission a <code>SubmissionData</code> providing the data for submission to be
     *        updated.
     */
     ...
     * </p>
     * @param tcSubject TCSubject instance contains the login security info for the current user
     * @return a <code>List</code> listing available contest statuses. Empty list is returned if
     ...
     * @return a <code>List</code> listing all existing contests.
     */
    public List < SimpleProjectContestData > getSimpleProjectContestDataByPID(TCSubject tcSubject,
        long pid) {
        throw new UnsupportedOperationException();
    }
    ...
    /**
     * <p>
     * This is going to fetch all the currently available contests for my project widget related to
     * given project.
     * </p>
     * @param tcSubject TCSubject instance contains the login security info for the current user
     * @param pid given project id
     ...
     * </p>
     * @param tcSubject TCSubject instance contains the login security info for the current user
     * @return a <code>List</code> listing all existing contests. Empty list is returned if there
     *         are no contests found.
     */
     ...
     * @return a <code>List</code> listing all existing contests matching the specified criteria.
     *         Empty list is returned if there are no matching contests found.
     */
    public List < StudioCompetition > searchContests(TCSubject tcSubject,
        ContestServiceFilter filter) {
        throw new UnsupportedOperationException();
    }
     ...
     * </p>
     * @param tcSubject TCSubject instance contains the login security info for the current user
     * @param submissionId a <code>long</code> providing the ID of a submission to get details
     *        for.
     * @return a <code>SubmissionData</code> providing details for the submission referenced by
     *         the specified ID or <code>null</code> if such a submission is not found.
     */
     ...
     * </p>
     * @param tcSubject TCSubject instance contains the login security info for the current user
     * @return a <code>List</code> listing available contest types. Empty list is returned if
     *         there are no types.
     */
     ...
     * </p>
     * @param tcSubject TCSubject instance contains the login security info for the current user
     * @param contentType a <code>String</code> providing the content type to get the matching
     *        MIME type for.
     * @return a <code>long</code> providing the ID of MIME type matching the specified content
     *         type.
     */
    ...
    /**
     * <p>
     * Purchases the specified submission. E.g. records a fact that submission referenced by
     * specified ID has been paid
     * </p>
     * @param tcSubject TCSubject instance contains the login security info for the current user
     * @param submissionId a <code>long</code> providing the ID of a submission which has been
     *        paid for.
     * @param submissionPaymentData a <code>SubmissionPaymentData</code> providing the data of
     *        successfully purchased submission.
     * @param securityToken a <code>String</code> providing the security token to be used for
     *        tracking the payment and prevent fraud.
     */
     ...
     * </p>
     * @param tcSubject TCSubject instance contains the login security info for the current user
     * @param contestId a <code>long</code> providing the ID of a contest to remove payment
     *        details for.
     * @return <code>true</code> if requested contest payment was removed successfully;
     *         <code>false</code> otherwise.
     */
     ...
     * </p>
     * @param tcSubject TCSubject instance contains the login security info for the current user
     * @return a <code>List</code> listing available medium types. Empty list is returned if there
     *         are no types.
     */
     ...
     * </p>
     * @param tcSubject TCSubject instance contains the login security info for the current user
     * @param submissionId a <code>long</code> providing the ID of a submission to set the
     *        placement for.
     ...
     * </p>
     * @param tcSubject TCSubject instance contains the login security info for the current user
     * @param submissionId a <code>long</code> providing the ID of a submission to be marked for
     *        purchase.
     */
     ...
     * @param tcSubject TCSubject instance contains the login security info for the current user
     * @param contestId a <code>long</code> providing the ID of a contest to get history data for.
     * @return a <code>List</code> of history data for the most recent change for specified
     *         contest.
     */
    ...
    /**
     * <p>
     * Sends payments to <code>PACTS</code> application for all unpaid submissions with a prize
     * already assigned. This service is not atomic. If it fails, you'll have to check what payments
     * where actually done trough the <code>submission.paid</code> flag.
     * </p>
     * @param tcSubject TCSubject instance contains the login security info for the current user
     * @param contestId a <code>long</code> providing the ID of a contest to process missing
     *        payments for.
     */
    ...
    /**
     * <p>
     * This method retrieve all the permissions that the user owned for any projects. Returns empty
     * list if no permission found.
     * </p>
     * @param tcSubject TCSubject instance contains the login security info for the current user
    ...
    /**
     * <p>
     * This method retrieve all the permissions that various users own for a given project. Returns
     * empty list if no permission found.
     * </p>
     * @param tcSubject TCSubject instance contains the login security info for the current user
    ...
    /**
     * <p>
     * This method retrieve all the permissions that the user own for a given project. Returns empty
     * list if no permission found.
     * </p>
     * @param tcSubject TCSubject instance contains the login security info for the current user
     * @param userid user id to look for
     ...
     * @param paymentData <code>PaymentData</code> payment information (credit card/po details)
     ...
     * @param paymentData a <code>CreditCardPaymentData</code> payment information (credit card)
     *        that need to be processed.
     * @return a <code>PaymentResult</code> result of the payment processing.
     */
     ...
     * @param tcSubject TCSubject instance contains the login security info for the current user
     * @param completedContestData data of completed contest.
     * @param paymentData a <code>TCPurhcaseOrderPaymentData</code> payment information (po
     ...
     * </p>
     * @param tcSubject TCSubject instance contains the login security info for the current user
     * @return a list containing all active <code>Categories</code>. It can be empty if no
     *         objects found.
     */
    ...
    /**
     * <p>
     * This method finds all given user tc direct projects . Returns empty array if no projects
     * found.
     * </p>
     * @param tcSubject TCSubject instance contains the login security info for the current user
     ...
     * @param tcDirectProjectId the TC direct project id. a <code>long</code> providing the ID of
     *        a client the new competition belongs to.
     ...
     * </p>
     * <p>
     * If the project allows multiple submissions for users, it will add the new submission and
     * return. If multiple submission are not allowed for the project, firstly it will add the new
     * submission, secondly mark previous submissions as deleted and then return.
     * </p>
     * @param tcSubject TCSubject instance contains the login security info for the current user
    ...
    public long uploadSubmission(TCSubject tcSubject, long projectId, String filename,
        DataHandler submission) {
        throw new UnsupportedOperationException();
    }

    /**
     * <p>
     * Adds a new final fix upload for an user in a particular project. This submission always
    ...
    public long uploadFinalFix(TCSubject tcSubject, long projectId, String filename,
        DataHandler finalFix) {
        throw new UnsupportedOperationException();
    }

    /**
     * <p>
     * Adds a new test case upload for an user in a particular project. This submission always
     * overwrite the previous ones.
     * </p>
     * @param tcSubject TCSubject instance contains the login security info for the current user
     * @param projectId the project's id
    ...
    /**
     * create forum with given parameters. It will lookup the ForumsHome interface, and ceate the
     * forum by the ejb home interface. In the old version, this method misses the document, it's
     * added in the version 1.1
     * @param tcSubject TCSubject instance contains the login security info for the current user
    ...
    /**
     * <p>
     * Ranks the submissions, given submission identifiers and the rank. If the isRankingMilestone
     * flag is true, the rank will target milestone submissions.
     * </p>
     * @param tcSubject TCSubject instance contains the login security info for the current user
    ...
    /**
     * <p>
     * BURG-1716: We need to add a method to get software contest by project id, the method will get
     * all OR project related data, then from project property to get comp version id then to call
     * getAssetByVersionId to get assetDTO, please check create software contest to see what data
     * need to be returned.
     * </p>
     * @param tcSubject TCSubject instance contains the login security info for the current user
    ...
    /**
     * <p>
     * Gets the list of project and their permissions (including permissions for the parent tc
     * project).
     * </p>
     * @param tcSubject TCSubject instance contains the login security info for the current user
    ...
    public List < CommonProjectPermissionData > getCommonProjectPermissionDataForUser(
        TCSubject tcSubject, long createdUser) {
        throw new UnsupportedOperationException();
    }
    ...
    /**
     * Save specified review comment and review status for specified section and specified contest
     * id to persistence.
     * @param tcSubject TCSubject instance contains the login security info for the current user
     * @param contestId the contest id
     * @param studio indicates whether the specified contest id is for studio contests.
     ...
     */
    public void saveReviewStatus(TCSubject tcSubject, long contestId, boolean studio,
        String sectionName, String comment, boolean isPass, String role) {
        throw new UnsupportedOperationException();
    }
     ...
     * @param role the user role type
     */
    public void saveReviewComment(TCSubject tcSubject, long contestId, boolean studio,
        String sectionName, String comment, String role) {
        throw new UnsupportedOperationException();
    }
    ...
    /**
     * Marks 'review done' by reviewer of the specs for specified contest. Persistence is updated
     * and all end users having write/full permission on the contest are notified by email.
     * @param tcSubject TCSubject instance contains the login security info for the current user
     ...
     * @param tcDirectProjectId the tc direct project id.
     */
    public void markReviewDone(TCSubject tcSubject, long contestId, String contestName,
        boolean studio, long tcDirectProjectId) {
        throw new UnsupportedOperationException();
    }

    /**
     * Marks 'ready for review' by the writer of the specs for specified contest. Persistence is
     * updated, on update the spec would appear as review opportunity on tc site.
     * @param tcSubject TCSubject instance contains the login security info for the current user
     * @param contestId the specified contest id.
     * @param studio whether contest is studio or not.
     */
    ...
    /**
     * Marks 'resubmit for review' by the writer of the specs for specified contest. Persistence is
     * updated. Reviewer (if any) is notified about the updates.
     * @param tcSubject TCSubject instance contains the login security info for the current user
     * @param contestId the specified contest id.
     * @param contestName the contest name
     * @param studio whether contest is studio or not.
     ...
     */
    public void resubmitForReview(TCSubject tcSubject, long contestId, String contestName,
        boolean studio, long reviewerUserId) {
        throw new UnsupportedOperationException();
    }
    ...
    /**
     * set submission milestone prize If given submission has already been associated with the given
     * milestone prize before, ContestServiceException will be thrown. It's required that the
     * contest field of the submission of given id is one of the contests set of the milestone
     * prize, otherwise, ContestServiceException will be thrown. If the MilestonePrize with given id
     * has reached the max number of submissions, ContestServiceException will be thrown.
     * @param tcSubject TCSubject instance contains the login security info for the current user
    ...
    /**
     * This method creates a Specification Review project associated to a project determined by
     * parameter.
     * @param tcSubject TCSubject instance contains the login security info for the current user
    ...
    public FullProjectData createSpecReview(TCSubject tcSubject, long projectId) {
        return new FullProjectData();
    }

    /**
     * This method retrieves scorecard and review information associated to a project determined by
     * parameter. Note: a single reviewer / review is assumed.
     * @param tcSubject TCSubject instance contains the login security info for the current user
    ...
    public ScorecardReviewData getScorecardAndReview(TCSubject tcSubject, long projectId) {
        return new ScorecardReviewData();
    }

    /**
     * This method uploads a mock file to the corresponding specification review project of the
     * specified project id, so that it can continue with review. Regular submission or final fix
     * will be uploaded according to the open phase.
     * @param tcSubject TCSubject instance contains the login security info for the current user
    ...
    /**
     * This method adds a review comment to a review. It simply delegates all logic to underlying
     * services.
     * @param tcSubject TCSubject instance contains the login security info for the current user
     ...
     * @param autoDevCreating if it is true and it is design contest, then will create development
     *        too
    ...
    public List < ProjectSummaryData > getProjectData(TCSubject tcSubject)
        ...
        data.setProjectId(new Long(1));
        data.setProjectName("mock project");
     ...
     *         caught and logged, but no thrown out.
     */
    public void updateNotificationsForUser(TCSubject subject, long userId,
        List < ProjectNotification > notifications) throws ContestServiceException {
        throw new UnsupportedOperationException();
    }
}
