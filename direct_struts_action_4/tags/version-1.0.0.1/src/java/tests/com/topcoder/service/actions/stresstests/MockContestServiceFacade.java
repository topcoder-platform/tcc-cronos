...
public class MockContestServiceFacade implements ContestServiceFacade {
    ...
    /**
     * <p>
     * Sends payments to <code>PACTS</code> application for all unpaid submussions with a prize
     * already assigned. This service is not atomic. If it fails, you'll have to check what payments
     * where actually done trough the <code>submussion.paid</code> flag.
     * </p>
     * @param tcSubject TCSubject instance contains the login security info for the current user
    ...
    /**
     * <p>
     * BURG-1716: We need to add a method to get software contest by project id, the method wil get
