...
/**
 * <p>
 * This action is responsible for reposting the contest and returning the id of the reposted
 * contest.
 * </p>
 * <p>
 ...
 *
 * <pre>
 *  &lt;bean id=&quot;ContestRepostingAction&quot;
 *  class=&quot;com.topcoder.direct.services.view.action.contest.launch.ContestRepostingAction&quot;
 *  scope=&quot;prototype&quot;&gt;
 ...
 * @version 1.0
 */
public class ContestRepostingAction extends BaseDirectStrutsAction {
    /**
     * Represents the prefix to use for the validation error keys.
     */
    private static final String KEY_PREFIX = "i18n.ContestRepostingAction.";
    /**
     * <p>
     * Represents the Serial Version UID of this class.
     * </p>
     */
    private static final long serialVersionUID = -7837055255964164441L;
    /**
     * <p>
     * Represents the contest id of the contest to repost.
     * </p>
     * <p>
     ...
     */
    public ContestRepostingAction() {
    }

    /**
     * <p>
     * This execute method is responsible for reposting the contest and returning the id of the
     * reposted contest.
     * </p>
     * <p>
    ...
    protected void executeAction() throws Exception {
        try {
            ...
            long newId = getDirectServiceFacade().repostSoftwareContest(tcSubject, contestId);
            setResult(newId);
        } catch (Exception e) {
            setResult(e);
            throw e;
    ...
    /**
     * Get the contest id of the contest to repost.
     * @return the contest id of the contest to repost.
     */
    ...
    /**
     * <p>
     * Set the contest id of the contest to repost.
     * </p>
     * <p>
     * Struts 2 validation is used to check that the argument is greater than 0.
     * </p>
     * @param contestId the contest id of the contest to repost.
     */
