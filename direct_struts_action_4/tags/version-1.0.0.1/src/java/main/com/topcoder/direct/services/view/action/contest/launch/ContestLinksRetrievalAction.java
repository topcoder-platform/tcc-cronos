...
/**
 * <p>
 * This action is responsible for returning the child and parent projects for the contest.
 * </p>
 * <p>
 * <strong>An example of how to configure bean in applicationContext.xml for Spring:</strong>
 *
 * <pre>
 *  &lt;bean id=&quot;ContestLinksRetrievalAction&quot;
 *  class=&quot;com.topcoder.direct.services.view.action.contest.launch.ContestLinksRetrievalAction&quot;
 *  scope=&quot;prototype&quot;&gt;
 ...
 * @version 1.0
 */
public class ContestLinksRetrievalAction extends BaseDirectStrutsAction {
    /**
     * Represents the prefix to use for the validation error keys.
     */
    private static final String KEY_PREFIX = "i18n.ContestLinksRetrievalAction.";
    /**
     * <p>
     * Represents the Serial Version UID of this class.
     * </p>
     */
    private static final long serialVersionUID = -2290531797123893936L;
    /**
     * <p>
     * Represents the contest id to retrieve the links for.
     * </p>
     * <p>
     * Must be positive.
     * </p>
     ...
     */
    public ContestLinksRetrievalAction() {
    }

    /**
     * <p>
     * This execute method is responsible for returning the child and parent projects for the
     * contest.
     * </p>
     * <p>
    ...
    protected void executeAction() throws Exception {
        try {
            ...
            List < Project > parentProjects =
                getDirectServiceFacade().getParentProjects(tcSubject, contestId);
            List < Project > childProjects =
                getDirectServiceFacade().getChildProjects(tcSubject, contestId);

            Map < String, Object > result = new HashMap < String, Object >();
            result.put("parentProjects", parentProjects);
            result.put("childProjects", childProjects);
    ...
    /**
     * Get the contest id to retrieve the links for.
     * @return the contest id to retrieve the links for.
     */
    ...
    /**
     * <p>
     * Set the contest id to retrieve the links for.
     * </p>
     * <p>
     * Struts 2 validation is used to check that the argument is greater than 0.
     * </p>
     * @param contestId the contest id to retrieve the links for.
     */
