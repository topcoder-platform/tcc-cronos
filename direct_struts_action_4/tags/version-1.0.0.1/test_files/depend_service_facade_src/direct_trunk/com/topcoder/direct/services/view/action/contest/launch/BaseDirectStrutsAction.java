...
public abstract class BaseDirectStrutsAction extends AbstractAction implements Preparable {
    ...
    private DirectServiceFacade directServiceFacade;
    /**
     * <p>
    ...
    /**
     * @return the directServiceFacade
     */
    public DirectServiceFacade getDirectServiceFacade() {
        return directServiceFacade;
    }

    /**
     * @param directServiceFacade the directServiceFacade to set
     */
    public void setDirectServiceFacade(DirectServiceFacade directServiceFacade) {
        this.directServiceFacade = directServiceFacade;
    }
}
