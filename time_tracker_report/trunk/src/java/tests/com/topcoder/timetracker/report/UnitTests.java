...
import com.topcoder.timetracker.report.dbhandler.ColumnTypeTest;
import com.topcoder.timetracker.report.dbhandler.DBHandlerFactoryTest;
import com.topcoder.timetracker.report.dbhandler.DBHandlerNotFoundExceptionTest;
import com.topcoder.timetracker.report.dbhandler.InformixDBHandlerAccuracyTest;
import com.topcoder.timetracker.report.dbhandler.InformixDBHandlerTest;
import com.topcoder.timetracker.report.dbhandler.ReportSQLExceptionTest;
import com.topcoder.timetracker.report.htmlreport.AggregatorTest;
import com.topcoder.timetracker.report.htmlreport.ExpenseReportTest;
import com.topcoder.timetracker.report.htmlreport.HTMLRenderUtilAccuracyTest;
import com.topcoder.timetracker.report.htmlreport.HTMLRenderUtilTest;
import com.topcoder.timetracker.report.htmlreport.TimeExpenseReportTest;
import com.topcoder.timetracker.report.htmlreport.TimeReportTest;
...
public class UnitTests extends TestCase {
    ...
    private static final class TimeTrackerDBSetup extends TestSetup {
         ...
         */
        TimeTrackerDBSetup(final Test test) {
            super(test);
        }
