...
public class InformixDBHandlerTest extends TestCase {
    ...
    /**
     * <p>An instance of {@link com.topcoder.timetracker.report.dbhandler.InformixDBHandler} which is tested. This instance is initialized in {@link #setUp()}
     ...
     *
     * @return a <code>TestSuite</code> providing the tests for {@link com.topcoder.timetracker.report.dbhandler.InformixDBHandler} class.
     */
    ...
    /**
     * <p>Failure test. Tests the {@link com.topcoder.timetracker.report.dbhandler.InformixDBHandler#getReportData(com.topcoder.timetracker.report.ReportConfiguration)}
    ...
    /**
     * <p>Failure test. Tests the {@link com.topcoder.timetracker.report.dbhandler.InformixDBHandler#release(java.sql.ResultSet)} method for proper handling the
