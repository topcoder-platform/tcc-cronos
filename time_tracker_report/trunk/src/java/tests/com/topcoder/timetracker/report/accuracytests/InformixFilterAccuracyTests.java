...
public class InformixFilterAccuracyTests extends TestCase {
    ...
    // /**
    // * Test method for 'getFilterEntryDate(Date, Date)'. both from and to are null. expect all
    // filter with value is 1.
    // *
...
//    /**
//     * Test method for 'getFilterEntryDate(Date, Date)'. from is null. expect
//     * LessThanOrEqualToFilter with to as value.
//     *
//     * @throws Exception to JUnit
//     */
...
//
//    /**
//     * Test method for 'getFilterEntryDate(Date, Date)'. to is null. expect
//     * GreaterThanOrEqualToFilter with from as value.
//     *
//     * @throws Exception to JUnit
//     */
...
//    /**
//     * Test method for 'getFilterEntryDate(Date, Date)'. both to and from are valid. expect
//     * AndFilter.
//     *
//     * @throws Exception to JUnit
//     */
