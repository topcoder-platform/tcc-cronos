...
/**
 * <p>
 * This class provides failure tests for <code>ExpenseEntriesReportBuilder</code> class. It tests:
 * <ol>
 * <li>ExpenseEntriesReportBuilder() constructor</li>
 ...
 * @version 3.1
 */
public class TestExpenseEntriesReportBuilderFailure extends BaseTestCase {
    /**
     * <p>
     ...
     * @throws Exception to JUnit
     */
    public void testExpenseEntriesReportBuilder_getReport_Failure_1_NullColumnNotNullOrder() throws Exception {
     ...
     * @throws Exception to JUnit
     */
    public void testExpenseEntriesReportBuilder_getReport_Failure_2_NullColumnNotEmptyOrder()
        throws Exception {
        builder = this.getExpenseEntriesReportBuilder();
        try {
     ...
     * @throws Exception to JUnit
     */
    public void testExpenseEntriesReportBuilder_getReport_Failure_3_ColumnsContainNull1() throws Exception {
        builder = this.getExpenseEntriesReportBuilder();
        try {
     ...
     * @throws Exception to JUnit
     */
    public void testExpenseEntriesReportBuilder_getReport_Failure_4_ColumnsContainNull2() throws Exception {
        builder = this.getExpenseEntriesReportBuilder();
        try {
     ...
     * @throws Exception to JUnit
     */
    public void testExpenseEntriesReportBuilder_getReport_Failure_5_ColumnsContainEmptyString1()
        throws Exception {
        builder = this.getExpenseEntriesReportBuilder();
        try {
     ...
     * @throws Exception to JUnit
     */
    public void testExpenseEntriesReportBuilder_getReport_Failure_6_ColumnsContainEmptyString2()
        throws Exception {
        builder = this.getExpenseEntriesReportBuilder();
        try {
     ...
     * @throws Exception to JUnit
     */
    public void testExpenseEntriesReportBuilder_getReport_Failure_7_ColumnsContainEmptyStringTrimmed1()
        throws Exception {
        builder = this.getExpenseEntriesReportBuilder();
        try {
     ...
     * @throws Exception to JUnit
     */
    public void testExpenseEntriesReportBuilder_getReport_Failure_8_ColumnsContainEmptyStringTrimmed2()
        throws Exception {
        builder = this.getExpenseEntriesReportBuilder();
        try {
     ...
     * @throws Exception to JUnit
     */
    public void testExpenseEntriesReportBuilder_getReport_Failure_9_ValidComlumnsNullOrder() throws Exception {
        builder = this.getExpenseEntriesReportBuilder();
        try {
     ...
     * @throws Exception to JUnit
     */
    public void testExpenseEntriesReportBuilder_getReport_Failure_10_DifferentLengths() throws Exception {
        builder = this.getExpenseEntriesReportBuilder();
        try {
