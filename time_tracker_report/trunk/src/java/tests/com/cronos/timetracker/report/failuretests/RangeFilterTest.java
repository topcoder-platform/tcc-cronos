...
/**
 * <p>A failure test for {@link com.cronos.timetracker.report.RangeFilter} class.</p>
 *
 * @author isv
 * @version 2.0
 */
public class RangeFilterTest extends TestCase {
    ...
    /**
     * <p>An instance of {@link com.cronos.timetracker.report.RangeFilter} which is tested. This instance is
     * initialized in {@link #setUp()} method and released in {@link #tearDown()} method.<p>
     */
    private RangeFilter testedInstance = null;

    /**
     * <p>Gets the test suite for {@link com.cronos.timetracker.report.RangeFilter} class.</p>
     *
     * @return a <code>TestSuite</code> providing the tests for {@link com.cronos.timetracker.report.RangeFilter} class.
     */
    ...
    /**
     * <p>Failure test. Tests the {@link com.cronos.timetracker.report.RangeFilter#RangeFilter(com.cronos.timetracker.report.Column,com.cronos.timetracker.report.FilterCategory)}
    ...
    /**
     * <p>Failure test. Tests the {@link com.cronos.timetracker.report.RangeFilter#addFilterRange(String,String)} method for proper handling the
    ...
    public void testAddFilterRange_String_String_lower_WHITESPACE_ONLY_STRING() {
        try {
            this.testedInstance.addFilterRange(TestDataFactory.WHITESPACE_ONLY_STRING, TestDataFactory.VALID_UPPER_RANGE);
            Assert.fail("IllegalArgumentException should have been thrown");
        } catch (IllegalArgumentException e) {
            // expected behavior
        } catch (Exception e) {
    ...
    public void testAddFilterRange_String_String_upper_WHITESPACE_ONLY_STRING() {
        try {
            this.testedInstance.addFilterRange(TestDataFactory.VALID_LOWER_RANGE, TestDataFactory.WHITESPACE_ONLY_STRING);
            Assert.fail("IllegalArgumentException should have been thrown");
        } catch (IllegalArgumentException e) {
            // expected behavior
        } catch (Exception e) {
