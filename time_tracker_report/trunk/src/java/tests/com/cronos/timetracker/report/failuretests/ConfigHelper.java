...
/**
 * <p>This is a helper class for existing failure test cases which provides a set of helpful methods manipulating with
...
public class ConfigHelper {
    ...
    public static final String[] setProperty(String namespace, String property, String value) {
        ...
        try {
            ...
            configManager.commit(namespace, "test");
            return previousValues;
        } catch (UnknownNamespaceException e) {
        } catch (ConfigManagerException e) {
        }
    ...
    /**
     * <p>A helper method which initializes the specified property with specified values within the specified namespace.
     * </p>
     *
     * @param namespace a <code>String</code> providing the configuration namespace to remove the property from.
     * @param property a <code>String</code> providing the property to remove.
     * @param values a <code>String</code> providing the new values for property.
     * @return a <code>String</code> array providing the existing values for specified property.
     */
    public static final String[] setProperty(String namespace, String property, String[] values) {
        ConfigManager configManager = ConfigManager.getInstance();
