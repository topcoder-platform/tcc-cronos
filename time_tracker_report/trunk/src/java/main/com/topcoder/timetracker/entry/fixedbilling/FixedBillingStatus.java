...
/**
 * <p>
 * This class holds the information of a fixed billing entry status. No parameter checking is
 * provided in this class, since the class acts as a mock class for Time Tracker Report component.
 * All the information is reading from the database, so it is assumed to be valid.
 * </p>
 *
