...
DATE("12/31/2006") - INTERVAL(1) DAY to DAY, 1.0, CURRENT - INTERVAL(1) DAY to DAY,'creationUser1',CURRENT - INTERVAL(1) DAY to DAY,'modificationUser1');
insert into fix_bill_entry (fix_bill_entry_id, company_id, invoice_id, fix_bill_type_id, fix_bill_status_id, description, entry_date, amount, creation_date, creation_user, modification_date, modification_user) values (2,102,2,2,2,"fixbillentryDesc2", DATE("12/31/2006") - INTERVAL(2) DAY to DAY, 2.0, CURRENT - INTERVAL(2) DAY to DAY,'creationUser2',CURRENT - INTERVAL(2) DAY to DAY,'modificationUser2');
insert into fix_bill_entry (fix_bill_entry_id, company_id, invoice_id, fix_bill_type_id, fix_bill_status_id, description, entry_date, amount, creation_date, creation_user, modification_date, modification_user) values (3,103,3,3,3,"fixbillentryDesc3", DATE("12/31/2006") - INTERVAL(3) DAY to DAY, 3.0, CURRENT - INTERVAL(3) DAY to DAY,'creationUser3',CURRENT - INTERVAL(3) DAY to DAY,'modificationUser3');
insert into fix_bill_entry (fix_bill_entry_id, company_id, invoice_id, fix_bill_type_id, fix_bill_status_id, description, entry_date, amount, creation_date, creation_user, modification_date, modification_user) values (4,104,4,4,4,"fixbillentryDesc4", DATE("12/31/2006") - INTERVAL(4) DAY to DAY, 4.0, CURRENT - INTERVAL(4) DAY to DAY,'creationUser4',CURRENT - INTERVAL(4) DAY to DAY,'modificationUser4');
insert into fix_bill_entry (fix_bill_entry_id, company_id, invoice_id, fix_bill_type_id, fix_bill_status_id, description, entry_date, amount, creation_date, creation_user, modification_date, modification_user) values (5,105,5,5,5,"fixbillentryDesc5", DATE("12/31/2006") - INTERVAL(5) DAY to DAY, 5.0, CURRENT - INTERVAL(5) DAY to DAY,'creationUser5',CURRENT - INTERVAL(5) DAY to DAY,'modificationUser5');
