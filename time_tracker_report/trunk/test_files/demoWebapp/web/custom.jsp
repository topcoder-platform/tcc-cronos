...
<%
    ...
    // In a real-world-application, the error-handling would be somewhat more sophisticated,
...
<a href="project.jsp?TYPE=PROJECT&PROJECT=project1">Project Reports are not displayable with this page, as the application-global
        Client filter is not allowed for this report type :-(, so go to this page for Project reports</a></body>
</html>