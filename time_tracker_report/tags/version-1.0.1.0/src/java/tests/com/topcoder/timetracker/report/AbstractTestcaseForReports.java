...
public abstract class AbstractTestcaseForReports extends BaseTimeTrackerReportTest {
    ...
    public void testExecuteFailNamespaceNull() throws Exception {
        try {
            report.execute(null, ReportType.CLIENT, listContainingClientFilter);
            fail("should throw");
    ...
    public void testExecuteFailNamespaceEmpty() throws Exception {
        try {
            report.execute("  ", ReportType.CLIENT, listContainingClientFilter);
            fail("should throw");
    ...
    public void testExecuteFailTypeNull() throws Exception {
        try {
            report.execute(DEFAULT_CONFIGURATION_NAMESPACE, null, listContainingClientFilter);
            fail("should throw");
        } catch (NullPointerException expected) {
            //expected
        }
    ...
    public void testExecuteFailFiltersNull() throws Exception {
        try {
            report.execute(DEFAULT_CONFIGURATION_NAMESPACE, ReportType.CLIENT, null);
            fail("should throw");
        } catch (NullPointerException expected) {
            //expected
        }
    ...
    public void testExecuteFailMissingMandatoryFilters() throws Exception {
        try {
            report.execute(DEFAULT_CONFIGURATION_NAMESPACE, ReportType.CLIENT, filterList);
            fail("should throw");
        } catch (ReportConfigurationException expected) {
            //expected
        }
    ...
    public void testExecuteFailUnknownNamespace() throws Exception {
        try {
            report.execute("blah", ReportType.CLIENT, listContainingClientFilter);
            fail("should throw");
        } catch (ReportConfigurationException expected) {
            //expected
        }
    ...
    public void testExecuteFailCMEmpty() throws Exception {
        try {
            clearConfig();
            report.execute(DEFAULT_CONFIGURATION_NAMESPACE, ReportType.CLIENT, listContainingClientFilter);
            fail("should throw");
        } catch (ReportConfigurationException expected) {
            //expected
        }
    ...
    public void testExecuteFailCustomColumnInvalid() throws Exception {
        try {
            ...
            report.execute(CUSTOM_CONFIGURATION_NAMESPACE, ReportType.CLIENT, listContainingClientFilter);
            fail("should throw");
        } catch (ReportConfigurationException expected) {
            //expected
        }
    ...
    public void testExecuteAccuracy1() throws Exception {
        employeeFilter.addFilterValue("ivern");
        filterList.add(employeeFilter);
        checkRenderResult(DEFAULT_CONFIGURATION_NAMESPACE, ReportType.EMPLOYEE, filterList, "EMPLOYEE_ivern.xml");
        checkRenderResult(CUSTOM_CONFIGURATION_NAMESPACE, ReportType.EMPLOYEE, filterList, "custom_EMPLOYEE_ivern.xml");
    }
     ...
     * Tested Report Type: {@link ReportType#EMPLOYEE}
     * <p/>
     * Tested Filter: {@link Column#EMPLOYEE}, values: "ivern","jhuges"
     *
     * @throws Exception in case an unexpected Exception occurs
     */
     ...
     * Tested Report Type: {@link ReportType#EMPLOYEE}
     * <p/>
     * Tested Filter: {@link Column#EMPLOYEE}, values: "ivern"; {@link Column#BILLABLE}, value:"1"
     *
     * @throws Exception in case an unexpected Exception occurs
     */
    public void testExecuteAccuracy3() throws Exception {
        ...
        checkRenderResult(DEFAULT_CONFIGURATION_NAMESPACE, ReportType.EMPLOYEE, filterList,
            "EMPLOYEE_ivern_BILLABLE_1.xml");
        checkRenderResult(CUSTOM_CONFIGURATION_NAMESPACE, ReportType.EMPLOYEE, filterList,
            "custom_EMPLOYEE_ivern_BILLABLE_1.xml");
    }
     ...
     * Tested Report Type: {@link ReportType#EMPLOYEE}
     * <p/>
     * Tested Filter: {@link Column#EMPLOYEE}, values: "ivern"; {@link Column#DATE}, value: "01-01-2006"-"06-30-2006"
     *
     * @throws Exception in case an unexpected Exception occurs
     */
    public void testExecuteAccuracy4() throws Exception {
        ...
        checkRenderResult(DEFAULT_CONFIGURATION_NAMESPACE, ReportType.EMPLOYEE, filterList,
            "EMPLOYEE_ivern_DATE_01-01-2006_06-30-2006.xml");
        checkRenderResult(CUSTOM_CONFIGURATION_NAMESPACE, ReportType.EMPLOYEE, filterList,
            "custom_EMPLOYEE_ivern_DATE_01-01-2006_06-30-2006.xml");
    }
     ...
     * Tested Report Type: {@link ReportType#EMPLOYEE}
     * <p/>
     * Tested Filter: {@link Column#EMPLOYEE}, values: "ivern"; {@link Column#CLIENT}, value: "client1"
     *
     * @throws Exception in case an unexpected Exception occurs
     */
    public void testExecuteAccuracy5() throws Exception {
        ...
        checkRenderResult(DEFAULT_CONFIGURATION_NAMESPACE, ReportType.EMPLOYEE, filterList,
            "EMPLOYEE_ivern_CLIENT_client1.xml");
        checkRenderResult(CUSTOM_CONFIGURATION_NAMESPACE, ReportType.EMPLOYEE, filterList,
            "custom_EMPLOYEE_ivern_CLIENT_client1.xml");
    }
    ...
    public void testExecuteAccuracy6() throws Exception {
        ...
        checkRenderResult(DEFAULT_CONFIGURATION_NAMESPACE, ReportType.EMPLOYEE, filterList,
            "EMPLOYEE_ivern_PROJECT_project1.xml");
        checkRenderResult(CUSTOM_CONFIGURATION_NAMESPACE, ReportType.EMPLOYEE, filterList,
            "custom_EMPLOYEE_ivern_PROJECT_project1.xml");
    }
    ...
    private void checkRenderResult(final String namespace, final ReportType type, final List filters,
        ...
        String rendered = report.execute(namespace, type, filters);
