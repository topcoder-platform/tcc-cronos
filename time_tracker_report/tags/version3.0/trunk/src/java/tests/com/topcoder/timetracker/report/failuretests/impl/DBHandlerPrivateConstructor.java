...
/**
 * <p>An implementation of {@link com.topcoder.timetracker.report.dbhandler.DBHandler} interface to be
 * utilized for testing purposes.</p>
 *
 * @author  isv
 * @version 2.0
 */
public class DBHandlerPrivateConstructor implements DBHandler {

    private DBHandlerPrivateConstructor() {
    }
