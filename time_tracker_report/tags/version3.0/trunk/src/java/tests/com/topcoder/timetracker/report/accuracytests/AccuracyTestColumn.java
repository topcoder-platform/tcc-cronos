...
public class AccuracyTestColumn extends TestCase {
    ...
    public void testGetName() throws Exception {
        ...
        assertTrue("STATUS is not valid.", Column.STATUS.getName().equals("STATUS"));
        assertTrue("COMPANY is not valid.", Column.COMPANY.getName().equals("COMPANY"));
    }
    ...
    public void testToString() throws Exception {
        ...
        assertTrue("STATUS is not valid.", Column.STATUS.toString().equals("STATUS"));
        assertTrue("COMPANY is not valid.", Column.COMPANY.toString().equals("COMPANY"));
    }
    ...
    public void testGetColumns() throws Exception {
        ...
        assertTrue("There should be eleven members.", columns.size() == 13);
        ...
        assertTrue("STATUS is not valid.", columns.contains(Column.STATUS));
        assertTrue("COMPANY is not valid.", columns.contains(Column.COMPANY));
    }
}
