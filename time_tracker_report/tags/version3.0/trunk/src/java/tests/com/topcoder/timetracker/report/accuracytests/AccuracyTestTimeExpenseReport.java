...
/**
 * Accuracy test for <code>TimeExpenseReport</code>.
 *
 * @author TCSDEVELOPER
 * @version 2.0
 */
public class AccuracyTestTimeExpenseReport extends AccuracyBaseTest {
    ...
    /** The instance of the <code>TimeExpenseReport</code> used for test. */
    private TimeExpenseReport report = null;
    ...
    public static Test suite() {
        return new TestSuite(AccuracyTestTimeExpenseReport.class);
    }
    ...
    /**
     * Tests Creating <code>TimeExpenseReport</code> instance.
     *
    ...
    public void testConstructor() throws Exception {
        ...
        assertTrue("The category of the report is not valid.", report.getCategory().equals(ReportCategory.TIMEEXPENSE));
    }
    ...
    public void testExecuteReport1() throws Exception {
        ...
        System.out.println("The output message from AccuracyTestTimeExpenseReport#testExecuteReport1():");
    ...
    public void testExecuteReport2() throws Exception {
        ...
        System.out.println("The output message from AccuracyTestTimeExpenseReport#testExecuteReport2():");
    ...
    public void testExecuteReport3() throws Exception {
        ...
        System.out.println("The output message from AccuracyTestTimeExpenseReport#testExecuteReport3():");
