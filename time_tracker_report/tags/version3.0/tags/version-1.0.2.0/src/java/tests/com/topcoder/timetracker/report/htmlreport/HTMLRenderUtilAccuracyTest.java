...
public class HTMLRenderUtilAccuracyTest extends BaseTimeTrackerReportTest {
    ...
    public void testRenderTableAccuracy2() throws Exception {
        ...
        checkRenderResult(reportConfiguration, "EMPLOYEE_TIME_EMPLOYEE_ivern.xml");
    }
    ...
    public void testRenderTableAccuracy3() throws Exception {
        ...
        list.add(employeeFilter);
        reportConfiguration.setFilters(list);
        checkRenderResult(reportConfiguration, "EMPLOYEE_TIME_EMPLOYEE_ivern_and_dok.xml");
    }
    ...
    public void testRenderTableAccuracy4() throws Exception {
        ...
        list.add(dateFilter);
        reportConfiguration.setFilters(list);
        checkRenderResult(reportConfiguration, "EMPLOYEE_TIME_DATE_01-01-2005_06-30-2005.xml");
    }
    ...
    public void testRenderTableAccuracy15() throws Exception {
        ...
        list.add(employeeFilter);
        reportConfiguration.setFilters(list);
        checkRenderResult(reportConfiguration, "PROJECT_TIME_EMPLOYEE_ivern.xml");
    }
    ...
    public void testRenderTableAccuracy16() throws Exception {
        ...
        list.add(employeeFilter);
        reportConfiguration.setFilters(list);
        checkRenderResult(reportConfiguration, "PROJECT_TIME_EMPLOYEE_ivern_dok.xml");
    }
    ...
    public void testRenderTableAccuracy17() throws Exception {
        ...
        list.add(dateFilter);
        reportConfiguration.setFilters(list);
        checkRenderResult(reportConfiguration, "PROJECT_TIME_DATE_01-01-2005_06-30-2005.xml");
    }
    ...
    public void testRenderTableAccuracy18() throws Exception {
        ...
        list.add(dateFilter);
        reportConfiguration.setFilters(list);
        checkRenderResult(reportConfiguration, "PROJECT_TIME_DATE_01-01-2005_06-30-2005_01-01-2006_06-30-2006.xml");
    }
    ...
    public void testRenderTableAccuracy22() throws Exception {
        ...
        list.add(dateFilter);
        reportConfiguration.setFilters(list);
        checkRenderResult(reportConfiguration, "CLIENT_TIME_DATE_01-01-2005_06-30-2005.xml");
    }
    ...
    public void testRenderTableAccuracy23() throws Exception {
        ...
        list.add(dateFilter);
        reportConfiguration.setFilters(list);
        checkRenderResult(reportConfiguration, "CLIENT_TIME_DATE_01-01-2005_06-30-2005_01-01-2006_06-30-2006.xml");
    }
    ...
    public void testRenderTableAccuracy29() throws Exception {
        ...
        list.add(employeeFilter);
        reportConfiguration.setFilters(list);
        checkRenderResult(reportConfiguration, "EMPLOYEE_EXPENSE_EMPLOYEE_ivern.xml");
    }
    ...
    public void testRenderTableAccuracy30() throws Exception {
        ...
        list.add(employeeFilter);
        reportConfiguration.setFilters(list);
        checkRenderResult(reportConfiguration, "EMPLOYEE_EXPENSE_EMPLOYEE_ivern_and_dok.xml");
    }
    ...
    public void testRenderTableAccuracy31() throws Exception {
        ...
        list.add(dateFilter);
        reportConfiguration.setFilters(list);
        checkRenderResult(reportConfiguration, "EMPLOYEE_EXPENSE_DATE_01-01-2005_06-30-2005.xml");
    }
    ...
    public void testRenderTableAccuracy42() throws Exception {
        ...
        list.add(dateFilter);
        reportConfiguration.setFilters(list);
        checkRenderResult(reportConfiguration, "PROJECT_EXPENSE_DATE_01-01-2005_06-30-2005.xml");
    }
    ...
    public void testRenderTableAccuracy47() throws Exception {
        ...
        list.add(dateFilter);
        reportConfiguration.setFilters(list);
        checkRenderResult(reportConfiguration, "CLIENT_EXPENSE_DATE_01-01-2005_06-30-2005.xml");
    }
    ...
    public void testRenderTableAccuracy54() throws Exception {
        ...
        list.add(employeeFilter);
        reportConfiguration.setFilters(list);
        checkRenderResult(reportConfiguration, "EMPLOYEE_TIMEEXPENSE_EMPLOYEE_ivern.xml");
    }
    ...
    public void testRenderTableAccuracy55() throws Exception {
        ...
        list.add(employeeFilter);
        reportConfiguration.setFilters(list);
        checkRenderResult(reportConfiguration, "EMPLOYEE_TIMEEXPENSE_EMPLOYEE_ivern_and_dok.xml");
    }
    ...
    public void testRenderTableAccuracy56() throws Exception {
        ...
        list.add(dateFilter);
        reportConfiguration.setFilters(list);
        checkRenderResult(reportConfiguration, "EMPLOYEE_TIMEEXPENSE_DATE_01-01-2005_06-30-2005.xml");
    }
    ...
    public void testRenderTableAccuracy63() throws Exception {
        ...
        list.add(billableFilter);
        reportConfiguration.setFilters(list);
        checkRenderResult(reportConfiguration, "EMPLOYEE_TIMEEXPENSE_BILLABLE_0.xml");
    }
    ...
    public void testRenderTableAccuracy67() throws Exception {
        ...
        list.add(dateFilter);
        reportConfiguration.setFilters(list);
        checkRenderResult(reportConfiguration, "PROJECT_TIMEEXPENSE_DATE_01-01-2005_06-30-2005.xml");
    }
    ...
    public void testRenderTableAccuracy70() throws Exception {
        ...
        list.add(billableFilter);
        reportConfiguration.setFilters(list);
        checkRenderResult(reportConfiguration, "PROJECT_TIMEEXPENSE_BILLABLE_0.xml");
    }
    ...
    public void testRenderTableAccuracy72() throws Exception {
        ...
        list.add(dateFilter);
        reportConfiguration.setFilters(list);
        checkRenderResult(reportConfiguration, "CLIENT_TIMEEXPENSE_DATE_01-01-2005_06-30-2005.xml");
    }
    ...
    public void testRenderTableAccuracy77() throws Exception {
        ...
        list.add(billableFilter);
        reportConfiguration.setFilters(list);
        checkRenderResult(reportConfiguration, "CLIENT_TIMEEXPENSE_BILLABLE_0.xml");
    }
    ...
    public void testRenderTableAccuracy81() throws Exception {
        ...
        assertEquals(aggregator.getCurrentValue(), new BigDecimal("202.39"));
    }
     ...
     * HTMLRenderUtil.Aggregator[])} so that the aggregators are called.
     * <p/>
     * <b>Setup:</b> filer for {@link Column#CLIENT} with client = "client1"
     *
     * @throws Exception in case an unexpected Exception occurs
     */
    public void testRenderTableAccuracy82() throws Exception {
        ...
        reportConfiguration.setFilters(list);
        HTMLRenderUtil.renderTable(reportConfiguration, dbHandlerFactory, new HTMLRenderUtil.Aggregator[]{aggregator});
        assertEquals(aggregator.getCurrentValue(), new BigDecimal("36.03"));
    }
     ...
     *
     * @return the list of default {@link com.topcoder.timetracker.report.ColumnDecorator}s for the given {@link
