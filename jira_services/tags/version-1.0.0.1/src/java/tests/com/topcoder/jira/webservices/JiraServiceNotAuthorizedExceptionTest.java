...
/**
 * Some tests for JiraServiceNotAuthorizedException class.
 *
 * @author TCSDEVELOPER
 * @version 1.0
 */
public class JiraServiceNotAuthorizedExceptionTest extends TestCase {
    /**
    ...
    public static Test suite() {
        return new TestSuite(JiraServiceNotAuthorizedExceptionTest.class);
    }
    ...
    public void testFirstConstructor() {
        try {
            throw new JiraServiceNotAuthorizedException();
        } catch (JiraServiceNotAuthorizedException ex) {
    ...
    public void testSecondConstructor() {
        try {
            throw new JiraServiceNotAuthorizedException(SAMPLE_MESSAGE);
        } catch (JiraServiceNotAuthorizedException ex) {
    ...
    public void testThirdConstructor() {
        try {
            throw new JiraServiceNotAuthorizedException(SAMPLE_CAUSE);
        } catch (JiraServiceNotAuthorizedException ex) {
    ...
    public void testForthConstructor() {
        try {
            throw new JiraServiceNotAuthorizedException(SAMPLE_MESSAGE, SAMPLE_CAUSE);
        } catch (JiraServiceNotAuthorizedException ex) {
            assertEquals("message", SAMPLE_MESSAGE, ex.getMessage());
            assertSame("cause", SAMPLE_CAUSE, ex.getCause());
        }
