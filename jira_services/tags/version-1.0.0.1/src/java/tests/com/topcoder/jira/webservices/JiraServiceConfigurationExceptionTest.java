...
/**
 * Some tests for JiraServiceConfigurationException class.
 *
 * @author TCSDEVELOPER
 * @version 1.0
 */
public class JiraServiceConfigurationExceptionTest extends TestCase {
    /**
    ...
    public static Test suite() {
        return new TestSuite(JiraServiceConfigurationExceptionTest.class);
    }
    ...
    public void testFirstConstructor() {
        try {
            throw new JiraServiceConfigurationException();
        } catch (JiraServiceConfigurationException ex) {
    ...
    public void testSecondConstructor() {
        try {
            throw new JiraServiceConfigurationException(SAMPLE_MESSAGE);
        } catch (JiraServiceConfigurationException ex) {
    ...
    public void testThirdConstructor() {
        try {
            throw new JiraServiceConfigurationException(SAMPLE_CAUSE);
        } catch (JiraServiceConfigurationException ex) {
    ...
    public void testForthConstructor() {
        try {
            throw new JiraServiceConfigurationException(SAMPLE_MESSAGE, SAMPLE_CAUSE);
        } catch (JiraServiceConfigurationException ex) {
            assertEquals("message", SAMPLE_MESSAGE, ex.getMessage());
            assertSame("cause", SAMPLE_CAUSE, ex.getCause());
        }
