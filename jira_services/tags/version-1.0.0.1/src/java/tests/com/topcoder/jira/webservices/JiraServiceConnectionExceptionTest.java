...
/**
 * Some tests for JiraServiceConnectionException class.
 *
 * @author TCSDEVELOPER
 * @version 1.0
 */
public class JiraServiceConnectionExceptionTest extends TestCase {
    /**
    ...
    public static Test suite() {
        return new TestSuite(JiraServiceConnectionExceptionTest.class);
    }
    ...
    public void testFirstConstructor() {
        try {
            throw new JiraServiceConnectionException();
        } catch (JiraServiceConnectionException ex) {
    ...
    public void testSecondConstructor() {
        try {
            throw new JiraServiceConnectionException(SAMPLE_MESSAGE);
        } catch (JiraServiceConnectionException ex) {
    ...
    public void testThirdConstructor() {
        try {
            throw new JiraServiceConnectionException(SAMPLE_CAUSE);
        } catch (JiraServiceConnectionException ex) {
    ...
    public void testForthConstructor() {
        try {
            throw new JiraServiceConnectionException(SAMPLE_MESSAGE, SAMPLE_CAUSE);
        } catch (JiraServiceConnectionException ex) {
            assertEquals("message", SAMPLE_MESSAGE, ex.getMessage());
            assertSame("cause", SAMPLE_CAUSE, ex.getCause());
        }
