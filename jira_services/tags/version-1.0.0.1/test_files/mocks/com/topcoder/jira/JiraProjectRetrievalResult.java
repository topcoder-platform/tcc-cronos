...
/**
 * This java bean holds result of JIRA project retrieval. It consists of retrieval result, project and version. Any
 ...
 * {"project, retrievalResult, version"})</li> </ol> <p> Thread-safety. This class is not thread-safe. It doesn't
 * provide setters for the inner fields but fields still can be changed because getters return objects themselves (not
 * deep copies). The same situation with constructor that propagates parameters themselves. Nevertheless application
 * will use this class in a thread-safe manner. It will not change objects returned from getters and it will not change
...
public class JiraProjectRetrievalResult implements Serializable {
    ...
    /**
     * This field represents the retrieved project. <p> Initialized in constructor. Can be accessed through the
    ...
    public void setRetrievalResult(JiraProjectRetrievalResultAction retrievalResult) {
    ...
    /**
     * This field represents the retrieval result. <p> Initialized in constructor. Can be accessed through the
     * corresponding getter. <p> Can take any value.
     */
    private JiraProjectRetrievalResultAction retrievalResult;

    /**
     * This field represents the retrieved version. <p> Initialized in constructor. Can be accessed through the
     * corresponding getter. <p> Can take any value.
     */
    private JiraVersion version;

    /**
     * Creates a new <code>JiraProjectRetrievalResult</code> with the given project, version and retrieval result.
     *
     ...
     */
    public JiraProjectRetrievalResult(
            JiraProject project, JiraVersion version, JiraProjectRetrievalResultAction retrievalResult) {
        this.project = project;
        this.version = version;
        this.retrievalResult = retrievalResult;
    }
