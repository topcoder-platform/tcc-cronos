...
/**
 * <p>
 * The base class for all test classes which test actions using Spring/Struts environment. It extends
 * <code>StrutsSpringTestCase</code>.
 * </p>
 *
 * @author TCSDEVELOPER
 * @version 1.0
...
public class BaseStrutsSpringTestCase extends StrutsSpringTestCase {
    ...
    /**
     * Makes sure that beans are only loaded from spring one time in order to prevent any memory leaks and
