...
/**
 * <p>
 * Unit tests for <code>ContestReceiptRetrievalAction</code>.
 * </p>
 *
 * @author TCSDEVELOPER
 * @version 1.0
 */
public class ContestReceiptRetrievalActionUnitTest extends BaseStrutsSpringTestCase {
    ...
    private ActionProxy prepareActionProxy() throws Exception {
        ActionProxy proxy = getActionProxy("/contestReceiptRetrievalAction");
        assertTrue("action is of wrong type", proxy.getAction() instanceof ContestReceiptRetrievalAction);
    ...
    /**
     * Accuracy test for executeAction. The contest receipt data should be stored in the model.
     *
     * @throws Exception to JUnit
     */
    @Test
    ...
    public void test_setContestId_ContestIdNotPositive() throws Exception {
        ...
        ContestReceiptRetrievalAction action = (ContestReceiptRetrievalAction) proxy.getAction();
