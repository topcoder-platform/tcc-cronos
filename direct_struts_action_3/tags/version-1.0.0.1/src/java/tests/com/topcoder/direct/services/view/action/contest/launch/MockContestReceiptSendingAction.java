...
/**
 * <p>
 * The mock <code>ContestReceiptSendingAction</code> used in the unit tests.
 * </p>
 *
 * @author TCSDEVELOPER
 * @version 1.0
 */
public class MockContestReceiptSendingAction extends ContestReceiptSendingAction {
    ...
    public void prepare() throws Exception {
        ...
        if (validations.size() != 0) {
            for (String key : validations.keySet()) {
                ...
                } else if (key.equals("additionalEmailAddresses")) {
                    setAdditionalEmailAddresses(value.toString());
                }
            }
        }
