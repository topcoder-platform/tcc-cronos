 ...
 * <pre>
 * &lt;action name="contestReceiptRetrievalAction" class="contestReceiptRetrievalAction"&gt;
 ...
 * @version 1.0
 */
public class ContestReceiptRetrievalAction extends BaseDirectStrutsAction {

    /**
     * Represents the prefix to use for the validation error keys.
     */
    private static final String KEY_PREFIX = "i18n.contestReceiptRetrievalAction.";
     ...
     */
    public ContestReceiptRetrievalAction() {
    }

    /**
     * <p>
     * This executeAction method is responsible for returning the contest receipt.
    ...
    protected void executeAction() throws Exception {
        try {
            ...
            // get the contest receipt data and store it in the model
            setResult(getDirectServiceFacade().getContestReceiptData(tcSubject, contestId, studio));
