 ...
 * that is not valid, which excludes issues such as duplicate ids. The DAO and the associated EJB and client helper
 * methods use it.
 * </p>
 *
...
public class InvalidEntryException extends PersistenceException {
    /**
     * <p>
     * Represents the invalid identifier. It is set in the constructor, may be null and can be generally any value,
     * and will not change.
     * </p>
     */
    ...
    /**
     * <p>
     * Creates new exception with error message and the invalid identifier.
     * </p>
     *
