...
public interface UploadPersistence {
    /**
     * addUploadType: Adds the given uploadType to the persistence. The id of the upload type must already be
    ...
    /**
     * removeUploadType: Removes the given upload type (by id) from the persistence. The id of the upload type can
    ...
    /**
     * updateUploadType: Updates the given upload type in the persistence. The id of the uploadType can not be
    ...
    /**
     * loadUploadType: Loads the UploadType with the given id from persistence. Returns null if there is no
    ...
    /**
     * getAllUploadTypeIds: Gets the ids of all upload types in the persistence. The individual uplaod types can
     * then be loaded with the loadUploadType method.
     *
     *
    ...
    /**
     * removeUploadStatus: Removes the given upload status (by id) from the persistence. The id of the upload
    ...
    /**
     * updateUploadStatus: Updates the given upload status in the persistence. The id of the uploadStatus can not
    ...
    /**
     * getAllUploadStatusIds: Gets the ids of all upload statuses in the persistence. The individual upload
     * statuses can then be loaded with the loadUploadStatus method.
     *
     *
    ...
    /**
     * addSubmissionStatus: Adds the given submission status to the persistence. The id of the submission status
     ...
     * submissionStats can not be UNSET_ID, and all other fields needed for persistence must also be assigned.
     *
     *
    ...
    /**
     * loadSubmissionStatus: Loads the SubmissionStatus with the given id from persistence. Returns null if there
     * is no SubmissionStatus with the given id.
     *
     *
    ...
    /**
     * getAllSubmissionStatusIds: Gets the ids of all submission statuses in the persistence. The individual
     * submission statuses can then be loaded with the loadSubmissionStatus method.
     *
     *
    ...
    /**
     * addUpload: Adds the given upload to the persistence. The id of the upload must already be assigned, as must
     * all the other fields needed for persistence.
     *
     *
    ...
    /**
     * removeUpload: Removes the given upload (by id) from the persistence. The id of the upload can not be
    ...
    /**
     * addSubmission: Adds the given submission to the persistence. The id of the submission must already be
     * assigned, as must all the other fields needed for persistence.
     *
     *
    ...
    /**
     * removeSubmission: Removes the given submission (by id) from the persistence. The id of the submission can
     * not be UNSET_ID, but the other fields do not matter.
     *
     *
    ...
    /**
     * updateSubmission: Updates the given submission in the persistence. The id of the submission can not be
     * UNSET_ID, and all other fields needed for persistence must also be assigned.
     *
     *
     * @param submission The submission to add
    ...
    /**
     * loadSubmission: Loads the Submission with the given id from persistence. Returns null if there is no
    ...
    /**
     * loadUploadStatuses: Loads all UploadStatuses with the given ids from persistence. May return a 0-length
     * array.
     *
     *
    ...
    /**
     * loadSubmissionStatuses: Loads all SubmissionStatuses with the given ids from persistence. May return a
     * 0-length array.
     *
     *
