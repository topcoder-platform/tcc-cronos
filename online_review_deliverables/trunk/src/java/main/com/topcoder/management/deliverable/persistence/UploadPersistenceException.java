...
/**
 * <p>
 * The UploadPersistenceException indicates that there was an error accessing or updating a persisted resource
 * store. This exception is used to wrap the internal error that occurs when accessing the persistence store. For
 * example, in the SqlUploadPersistence implementation it is used to wrap SqlExceptions.
 * </p>
 *
 * <p>
 * This exception is initially thrown in UploadPersistence implementations and from there passes through
...
public class UploadPersistenceException extends PersistenceException {
    ...
    /**
     * UploadPersistenceException constructor: Creates a new UploadPersistenceException.
     *
     *
