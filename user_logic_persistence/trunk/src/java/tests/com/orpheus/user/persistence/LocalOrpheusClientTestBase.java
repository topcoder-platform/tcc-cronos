...
/**
 * <p>
 * The base class of the LocalOrpheusPendingConfirmationStorageTest and
 * LocalOrpheusUserProfilePersistenceTest test cases. It takes care of all the
 * common configuration handling, such as testing for invalid configuration,
 * etc. This test case and its subclasses are tested within the application
 * server containiner. The configuration namespaces are loaded at start-up from
 * within the ConfigManager.properties file.
 * </p>
 *
 * @author mpaulse
 * @version 1.0
 */
public abstract class LocalOrpheusClientTestBase extends ServletTestCase {
     ...
     */
    protected LocalOrpheusClientTestBase(String namespacePrefix, String validClientNamespace, String validConfigFile) {
    ...
    /**
     * <p>
     * Performs the class constructor test with invalid configuration. Some
