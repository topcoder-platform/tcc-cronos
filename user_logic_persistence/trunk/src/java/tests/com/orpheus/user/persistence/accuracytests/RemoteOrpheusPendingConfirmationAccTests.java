...
import com.orpheus.user.persistence.RemoteOrpheusPendingConfirmationStorage;
...
/**
 * Accuracy test cases for <code>RemoteOrpheusPendingConfirmation</code> class.
 *
 * @author tuenm
 * @version 1.0
 */
public class RemoteOrpheusPendingConfirmationAccTests extends TestCase {
    ...
    protected void setUp() throws Exception {
        ...
        storage = new RemoteOrpheusPendingConfirmationStorage(OrpheusPendingConfirmationStorage.class.getName()
                + ".remote");
    }
