...
/**
 * <p>
 * Tests the RemoteOrpheusUserProfilePersistence class.
 * </p>
 *
 * @author mpaulse
 * @version 1.0
 */
public class RemoteOrpheusUserProfilePersistenceTest extends RemoteOrpheusEJBClientTestBase {

    /**
     * <p>
     * A test RemoteOrpheusUserProfilePersistence configuration file containing
     * valid configuration.
     * </p>
     */
    ...
    /**
     * <p>
     * The prefix for the test RemoteOrpheusUserProfilePersistence configuration
     * namespaces.
     * </p>
     */
    ...
    /**
     * <p>
     * The RemoteOrpheusUserProfilePersistence instance to test.
     * </p>
     */
    private RemoteOrpheusUserProfilePersistence persistence = null;
     ...
     * </p>
     */
    public RemoteOrpheusUserProfilePersistenceTest() {
        super(NAMESPACE_PREFIX, NAMESPACE_PREFIX + ".remote", VALID_CONFIG_FILE);
    }

    /**
     * <p>
     * Loads the valid test Object Factory, RemoteOrpheusUserProfilePersistence
     * and UserProfileTranslator configuration namespaces into the Configuration
     * Manager, and creates the test RemoteOrpheusUserProfilePersistence
     * instance.
     * </p>
     *
    ...
    protected void setUp() throws Exception {
        ...
        // Create the RemoteOrpheusUserProfilePersistence instance.
        persistence = new RemoteOrpheusUserProfilePersistence(NAMESPACE_PREFIX + ".remote");
     ...
     * RemoteOrpheusUserProfilePersistence and UserProfileTranslator
    ...
    /**
     * <p>
     * Tests the RemoteOrpheusUserProfilePersistence(String namespace)
    ...
    public void testCtorWithValidArg() {
        ...
        assertNotNull("The RemoteOrpheusUserProfilePersistence instance should not be null", persistence);
    }

    /**
     * <p>
     * Tests that the RemoteOrpheusUserProfilePersistence(String namespace)
    ...
    public void testCtorWithNullArg() throws Exception {
        try {
            new RemoteOrpheusUserProfilePersistence(null);
    ...
    public void testCtorWithEmptyArg() throws Exception {
        try {
            new RemoteOrpheusUserProfilePersistence(" ");
            fail("IllegalArgumentException should be thrown: null argument");
        } catch (IllegalArgumentException e) {
            // Success.
        }
    ...
    /**
     * <p>
     * Performs the RemoteOrpheusUserProfilePersistence(String namespace)
    ...
    protected void performCtorTestWithInvalidConfig(String namespace) throws ConfigManagerException {
        ...
        try {
            new RemoteOrpheusUserProfilePersistence(namespace);
    ...
    public static Test suite() {
        return new TestSuite(RemoteOrpheusUserProfilePersistenceTest.class);
    }
