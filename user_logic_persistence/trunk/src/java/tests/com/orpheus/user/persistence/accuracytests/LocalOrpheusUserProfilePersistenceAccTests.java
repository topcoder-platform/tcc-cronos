...
/**
 * Accuracy test cases for <code>LocalOrpheusUserProfilePersistence</code> class.
 *
 * @author tuenm
 * @version 1.0
 */
public class LocalOrpheusUserProfilePersistenceAccTests extends ServletTestCase {
     ...
     * </p>
     */
    protected LocalOrpheusUserProfilePersistence persistence = null;
    ...
    protected void setUp() throws Exception {
        ...
        persistence = new LocalOrpheusUserProfilePersistence(OrpheusUserProfilePersistence.class.getName()
                + ".local");
