...
/**
 * <p>
 * The remote interface for the {@link UserProfileBean} session bean. It is
 * allows remote clients to persist pending confirmation messages using the
 * session bean. A remote client is a client which runs in a different execution
...
public interface UserProfileRemote extends EJBObject {
     ...
     */
    public void insertProfile(UserProfileDTO profile) throws PersistenceException, RemoteException;
     ...
     * @throws RemoteException if a network error occurs
     */
    public void updateProfile(UserProfileDTO profile) throws PersistenceException, RemoteException;
     ...
     */
    public UserProfileDTO retrieveProfile(long id) throws PersistenceException, RemoteException;
     ...
     * @throws RemoteException if a network error occurs
     */
    public void deleteProfile(long id) throws PersistenceException, RemoteException;
     ...
     * @see #retrieveAllProfiles()
     */
    public UserProfileDTO[] findProfiles(Map criteria) throws PersistenceException, RemoteException;
     ...
     * @see #findProfiles(Map)
     */
    public UserProfileDTO[] retrieveAllProfiles() throws PersistenceException, RemoteException;
