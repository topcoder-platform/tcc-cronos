...
/**
 * <p>
 * The remote interface for the {@link PendingConfirmationBean} session bean. It
 * is allows remote clients to persist pending confirmation messages using the
 ...
 */
public interface PendingConfirmationRemote extends EJBObject {
     ...
     */
    public void store(ConfirmationMessageDTO message) throws PersistenceException, RemoteException;
     ...
     * @throws RemoteException if a network error occurs
     */
    public ConfirmationMessageDTO contains(String address) throws PersistenceException, RemoteException;
     ...
     * @see #getMessages()
     */
    public ConfirmationMessageDTO retrieve(String address) throws PersistenceException, RemoteException;
     ...
     * @throws RemoteException if a network error occurs
     */
    public void delete(String address) throws PersistenceException, RemoteException;
     ...
     * @see #retrieve(String)
     */
    public ConfirmationMessageDTO[] getMessages() throws PersistenceException, RemoteException;
