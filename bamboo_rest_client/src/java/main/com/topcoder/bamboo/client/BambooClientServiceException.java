 ...
 * @since 1.0
 */
public class BambooClientServiceException extends Exception {
    /**
     * <p>
     ...
     */
    public BambooClientServiceException(String message) {
        super(message);
    }
     ...
     */
    public BambooClientServiceException(String message, Throwable cause) {
        super(message, cause);
    }
}
