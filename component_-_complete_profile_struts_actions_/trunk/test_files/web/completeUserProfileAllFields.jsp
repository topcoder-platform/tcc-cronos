...
<html>
<head>
	<title>User Profile All Fields</title>
</head>
<body>
 ...
 <s:form action="completeUserProfileAllFields" namespace="/">
	<s:fielderror />
	...
	<s:if test="%{securityKey != null}">	
	<s:textfield name="securityKey" label="securityKey" />	
	</s:if>
	<s:else>    	
    <s:textfield name="securityKey" label="securityKey" value="%{user.userSecurityKey.securityKey}" />	
	</s:else>
