...
/**
 * <p>
 * This class contains Unit tests for CompleteProfileActionConfigurationException.
 * </p>
 * @author sokol
 * @version 1.0
 */
public class CompleteProfileActionConfigurationExceptionUnitTest extends TestCase {

    /**
     * <p>
     * Represents CompleteProfileActionConfigurationException instance for testing.
     * </p>
     */
    private CompleteProfileActionConfigurationException exception;
    ...
    public void setUp() {
        ...
        exception = new CompleteProfileActionConfigurationException(message);
    }
    ...
    public void testCtor_MessageData() {
        ...
        exception = new CompleteProfileActionConfigurationException(message, data);
        assertNotNull("Exception should be created successfully.", exception);
        assertEquals("Message should be set successfully.", message, exception.getMessage());
    }
    ...
    public void testCtor_MessageDataCause() {
        ...
        exception = new CompleteProfileActionConfigurationException(message, cause, data);
        assertNotNull("Exception should be created successfully.", exception);
        assertEquals("Message should be set successfully.", message, exception.getMessage());
    ...
    public void testCtor_MessageCause() {
        Throwable cause = new NullPointerException(message);
        exception = new CompleteProfileActionConfigurationException(message, cause);
        assertNotNull("Exception should be created successfully.", exception);
        assertEquals("Message should be set successfully.", message, exception.getMessage());
        assertEquals("Cause should be set successfully.", cause, exception.getCause());
    }
