...
/**
 * <p>
 * This class contains Unit tests for CompleteProfileActionException.
 * </p>
 * @author sokol
 * @version 1.0
 */
public class CompleteProfileActionExceptionUnitTest extends TestCase {

    /**
     * <p>
     * Represents CompleteProfileActionException instance for testing.
     * </p>
     */
    private CompleteProfileActionException exception;
    ...
    public void setUp() {
        ...
        exception = new CompleteProfileActionException(message);
    }
    ...
    public void testCtor_MessageData() {
        ...
        exception = new CompleteProfileActionException(message, data);
        assertNotNull("Exception should be created successfully.", exception);
        assertEquals("Message should be set successfully.", message, exception.getMessage());
    }
    ...
    public void testCtor_MessageDataCause() {
        ...
        exception = new CompleteProfileActionException(message, cause, data);
        assertNotNull("Exception should be created successfully.", exception);
        assertEquals("Message should be set successfully.", message, exception.getMessage());
    ...
    public void testCtor_MessageCause() {
        Throwable cause = new NullPointerException(message);
        exception = new CompleteProfileActionException(message, cause);
        assertNotNull("Exception should be created successfully.", exception);
        assertEquals("Message should be set successfully.", message, exception.getMessage());
        assertEquals("Cause should be set successfully.", cause, exception.getCause());
    }
