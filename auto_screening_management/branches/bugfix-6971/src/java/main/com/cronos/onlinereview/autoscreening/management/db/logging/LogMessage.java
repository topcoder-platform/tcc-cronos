...
public class LogMessage {
     ...
     */
    public LogMessage(Long id, String operator, String message, Throwable error) {
        this.id = id;
     ...
     * @param message a free text message.
     */
    public LogMessage(Long id, String operator, String message) {
        this(id, operator, message, null);
    }
    ...
    public String getLogMessage() {
        if (logMessage == null) {
            ...
            buffer.append("Screening Task: ").append("upload_id: ")
