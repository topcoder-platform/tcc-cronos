...
/**
 * <p>
 * Test cases of PersistenceException. Tests the class for proper saving the provided arguments.
 * </p>
 *
 * @author haozhangr
 * @version 1.0
...
public class PersistenceExceptionTests extends TestCase {
    ...
    /**
     * <p>
     * An instance of <code>PersistenceException</code> which is tested.
     * </p>
     */
    private PersistenceException target = null;

    /**
     * <p>
     * setUp() routine. Creates test PersistenceException instance.
     * </p>
     */
    protected void setUp() {
        this.target = new PersistenceException(MESSAGE);
    }
     ...
     *
     * <p>
     * Verifies PersistenceException subclasses ScreeningManagementException.
     * </p>
     */
    public void testInheritance() {
        assertTrue("PersistenceException does not subclass ScreeningManagementException.",
                target instanceof ScreeningManagementException);
    }

    /**
     * <p>
     * Accuracy test. Tests the <code>PersistenceException(String)</code> Create for proper
    ...
    public void testCreate_String_Throwable_3_accuracy() {
        target = new PersistenceException(null, CAUSE);
    ...
    public void testCreate_String_Throwable_4_accuracy() {
        target = new PersistenceException(MESSAGE, null);
    ...
    public void testCreate_String_Throwable_5_accuracy() {
        target = new PersistenceException(null, null);
        assertNull("The NULL message should be saved as is", target.getMessage());
        assertNull("The NULL cause should be saved as is", target.getCause());
    }
}
