...
/**
 * <p>
 * Accuracy test for <code>Submission</code> class.
 * </p>
 *
 * @author TCSDEVELOPER
 * @version 1.0
 */
public class SubmissionUnitTest extends TestCase {
    /**
     * <p>
     * Returns all tests.
     * </p>
    ...
    public static Test suite() {
        return new TestSuite(SubmissionUnitTest.class);
    }
     ...
     * </p>
     */
    public void testSubmissionMapping() {
        ...
        try {
            ...
            //session.save(submission);
            Submission persisted = (Submission) session.load(Submission.class,
                    submission.getSubmissionId());
            assertNotNull("The result mapping is wrong.", persisted.getResult());
