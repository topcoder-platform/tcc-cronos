				...
				<div id="header"> <a href="javascript:;" class="logo">Groups</a>
					...
					<div id="tabs1">
						<ul>
							...
							<li class="on forthTabs"> <a href="administrator-create-new-administrator.html"><span class="dashboardSpan">Create New Administrator User</span></a> </li>
								...
								<table cellpadding="0" cellspacing="0">
									...
									<tbody>
										<tr>
											...
											<td><select class="newAdminSelect"><option><s:property value="handle" default="gevak"/></option></select></td>
										</tr>
										<tr>
											<td class="firstColumn">Enter the member handle / email address of the users you want to invite to the groups:</td>
											<td>
												<input type="text" class="text newAdminText" />
												<a href="javascript:;" class="searchIcon triggerModal" rel="#searchModal">Search</a>
												<div class="clear"></div>
												<p class="alertIcon">Enter the handle if the member is already a registered member. Enter the email address of the user if the user is a new user.</p>
											</td>
										</tr>
									</tbody>
								</table>
							</div>
							<s:url action="createCustomerAdmin" var="urlTag" >
							    <s:param name="handle">gevak</s:param>
							</s:url>
							<!-- create new admin button -->
							<div class="createAdminButton">
								<a href="<s:property value="#urlTag"/>" class="newButton1" rel="#createAdminModal"><span class="btnR"><span class="btnC">CREATE</span></span></a>
							</div>
	...
	<div id="searchModal" class="outLay">
		<div class="modalHeader">
			<div class="modalHeaderRight">
				<div class="modalHeaderCenter">
					Search User Handle
					<a href="javascript:;" title="Close" class="closeModal">Close</a>
				</div>
			</div>
		</div>
		<!-- end .modalHeader -->
