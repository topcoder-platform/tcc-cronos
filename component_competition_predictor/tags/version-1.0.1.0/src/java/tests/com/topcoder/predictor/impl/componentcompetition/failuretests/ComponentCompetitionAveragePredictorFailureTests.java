...
/**
 * The failure tests of the class <code>ComponentCompetitionAveragePredictor</code>.
 *
 * @author telly12
 * @version 1.0
 */
public class ComponentCompetitionAveragePredictorFailureTests extends TestCase {
    /**
     * The ComponentCompetitionAveragePredictor instance for failure test.
     */
    private ComponentCompetitionAveragePredictor instance
    ...
    /**
     * The failure test of the method <code>setPredictors</code>,
     * fail for the predictors contains null,
     * IllegalArgumentException should be thrown.
     *
     * @throws Exception to JUnit
     */
    @SuppressWarnings("unchecked")
    public void test_setPredictors_failure1() throws Exception {
        try {
            instance.setPredictors(new Predictor[]{null});
            fail("IllegalArgumentException should be thrown.");
        } catch (IllegalArgumentException e) {
            //pass
        }
