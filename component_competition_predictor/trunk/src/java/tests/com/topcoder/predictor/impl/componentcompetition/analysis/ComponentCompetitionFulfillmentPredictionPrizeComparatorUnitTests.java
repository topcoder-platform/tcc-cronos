...
/**
 * <p>
 * Unit tests for ComponentCompetitionFulfillmentPredictionPrizeComparator class.
 * </p>
 *
 * @author TCSDEVELOPER
 * @version 1.0
 */
public class ComponentCompetitionFulfillmentPredictionPrizeComparatorUnitTests extends TestCase {

    /**
     * An instance of ComponentCompetitionFulfillmentPredictionPrizeComparator for the following tests.
     */
    private ComponentCompetitionFulfillmentPredictionPrizeComparator tester = null;
    ...
    protected void setUp() throws Exception {
        tester = new ComponentCompetitionFulfillmentPredictionPrizeComparator(1.0, 3.0, 100000);
    ...
    public void test_ctor() {
        // no exception
        new ComponentCompetitionFulfillmentPredictionPrizeComparator(1.0, 3.0, 100);
    }
    ...
    /**
     * <p>
     * Failure test for the constructor. IllegalArgumentException should be thrown for negative targetDuration.
     * </p>
     */
    ...
    public void test_ctor_failure4() {
        try {
            new ComponentCompetitionFulfillmentPredictionPrizeComparator(4.0, 3.0, 100);
            fail("IllegalArgumentException should be thrown for negative targetDuration.");
        } catch (IllegalArgumentException e) {
            // ok
        }
    ...
    public void test_compare1() {
        ComponentCompetitionFulfillmentPrediction prediction1 = new ComponentCompetitionFulfillmentPrediction(0.5,
                        situation, predictor);
    ...
    public void test_compare2() {
        ...
        ComponentCompetitionFulfillmentPrediction prediction1 = new ComponentCompetitionFulfillmentPrediction(1.1,
                        situation, predictor);
        situation = new ComponentCompetitionSituation();
        situation.setEndDate(new Date(300000));
        situation.setPostingDate(new Date(100000));
        ComponentCompetitionFulfillmentPrediction prediction2 = new ComponentCompetitionFulfillmentPrediction(2.0,
                        situation, predictor);
        // both predictions are in the range;
        // prediction1's timeline is shorter than target, but prediction2's timeline is larger than target,
    ...
    public void test_equals_2() {
        ComponentCompetitionFulfillmentPredictionPrizeComparator c =
            new ComponentCompetitionFulfillmentPredictionPrizeComparator(2.0, 3.0, 100000);
        boolean result = tester.equals(c);
    ...
    public void test_hashCode() {
        int expected = new Double(1.0).hashCode() ^ new Double(3.0).hashCode() ^ new Long(100000).hashCode();
    ...
    public void test_getTargetDuration() {
        assertEquals("The getTargetDuration method returns incorrect result.", 100000, tester.getTargetDuration());
    }
