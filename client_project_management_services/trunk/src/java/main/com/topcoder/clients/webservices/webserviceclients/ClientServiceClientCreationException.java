 ...
 *  the client web service client failed (wraps the MalformedURLException
...
public class ClientServiceClientCreationException extends ServiceClientCreationException {

    /**
     * Constructs a new 'ClientServiceClientCreationException'
     * instance with the given message.
     *
     * @param message
     *      the exception message
     */
    public ClientServiceClientCreationException(String message) {
        super(message);
    }
     ...
     *      the exception cause
     */
    public ClientServiceClientCreationException(String message, Throwable cause) {
        super(message, cause);
    }
}
