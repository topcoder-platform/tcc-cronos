...
public class MockProjectManager implements ProjectManager {
     ...
     * @param client used to create the project
     *
     * @return the created project
     *
     * @throws ProjectManagerException if throwPME is true
     */
     ...
     * @return null
     *
     * @throws ProjectManagerException not used
     */
    public ProjectStatus createProjectStatus(ProjectStatus status)
        throws ProjectManagerException {
        return null;
    }
     ...
     *
     * @throws ProjectManagerException if throwPME is true
     * @throws ProjectEntityNotFoundException won't throw
     */
     ...
     *
     * @throws ProjectManagerException if failOnOperation is true
     * @throws ProjectEntityNotFoundException if failOnOperation is true
     */
    public ProjectStatus deleteProjectStatus(ProjectStatus status)
        throws ProjectManagerException, ProjectEntityNotFoundException {
        checkFail();
     ...
     * </p>
     *
     * @param status status which found projects will contain
     *
     * @return projects for given status.
     *
     * @throws ProjectManagerException if failOnOperation is true
     */
    public List<Project> getProjectsForStatus(ProjectStatus status)
        throws ProjectManagerException {
     ...
     * </p>
     *
     * @param id for which to get project
     *
     ...
     * </p>
     *
     * @param client client which projects to find
     *
     * @return all projects for passed client
     *
     * @throws ProjectManagerException if failOnOperation is true
     */
    public List<Project> retrieveProjectsForClient(Client client)
        throws ProjectManagerException {
        return retrieveAllProjects();
    }
     ...
     * @throws ProjectManagerException if failOnOperation is true
     */
    public List<Project> searchProjects(Filter filter)
        throws ProjectManagerException {
        return retrieveAllProjects();
    }
     ...
     * </p>
     *
     * @param name name for which projects will be found
     *
     ...
     * @return null
     *
     * @throws ProjectEntityNotFoundException not used
     * @throws ProjectManagerException not used
     */
     ...
     * @throws ProjectEntityNotFoundException if failOnOperation is true
     */
    public ProjectStatus updateProjectStatus(ProjectStatus status)
        throws ProjectManagerException, ProjectEntityNotFoundException {
        if (throwPME) {
    ...
    /**
     * <p>
     * Throws ProjectManagerException if throwPME flag is true. Throws IllegalArgumentException if throwIAE flag is
     * true.
     * </p>
     *
