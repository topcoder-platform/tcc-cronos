...
public class MockEntityStatusTracker implements EntityStatusTracker {
    ...
    /**
     * An instance of MockEntityStatusTracker just jused.
     */
    private static MockEntityStatusTracker instance = null;

    /**
     * Get just-used instance of MockEntityStatusTracker.
     * 
     * @return just-used instance of MockEntityStatusTracker.
     */
    public static MockEntityStatusTracker getInstance() {
        return instance;
    }
    ...
    /**
     * <p>
     * Set the current status of the given Entity instance to the given status. In addition, the user who made
