...
/**
 * <p>
 * Mock class of Messenger.
 * </p>
 *
 * @author singlewood
 * @version 1.0
 */
public class MessengerFMock implements Messenger {
    ...
    /**
     * Post the message to the all the users in the session, except the user who sends the
     * message.
     *
     * @param msg The message to post.
