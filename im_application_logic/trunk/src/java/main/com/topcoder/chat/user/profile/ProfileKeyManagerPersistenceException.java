...
/**
 * <p>
 * This exception is thrown by <code>ProfileKeyManager</code> to indicate some persistence
 * related failure unrelated to the logical cases of a <code>ProfileKey</code> not existing
 * in the persistence and of a profile already existing in the persistence.
 * </p>
 *
 * <p>
 ...
 * @version 2.0
 */
public class ProfileKeyManagerPersistenceException extends BaseException {
    /**
     * <p>
     ...
     */
    public ProfileKeyManagerPersistenceException(String message) {
        super(message);
    }
     ...
     */
    public ProfileKeyManagerPersistenceException(Throwable cause) {
        super(cause);
    }
     ...
     */
    public ProfileKeyManagerPersistenceException(String message, Throwable cause) {
        super(message, cause);
    }
}
