...
/**
 * <p>
 * This interface defines base functionality of this component.
 * </p>
 *
 * <p>
 * This interface provides methods to create and retrieve session; add, remove
 * and request user to session; get recently requested users etc.
 * </p>
 *
 * <p>
 * This interface also provides methods to manage listeners.
 * </p>
 *
 * <p>
 * It has one default implementation <code>ChatSessionManagerImpl</code>.
 * </p>
 *
 * <p>
...
public interface ChatSessionManager {
     ...
     * elements of array may be null if the corresponding session can not be found
     *
     ...
     * @throws ChatSessionIncorrectEntityIdException if user was already added to session or the
     ...
     * If such session was found, it should return true, otherwise false.
     * </p>
     *
     * @param user user id, any possible long value
     * @return true if some session has the given user, otherwise false
     *
     * @throws ChatSessionDataStoreException when impossible to check if session
     * contains the given user for some reasons
     */
     ...
     *
     * <p>
     * If the recent for this manager is negative, then the users that create all the sessions
     * requested by the given user will be retrieved.
     * </p>
     *
     * <p>
     ...
     *
     * <p>
     * If the recent for this manager is positive, then the users that create the sessions that
     * were requested by the given user before special moment of time which is calculated like
     * current date minus numbers of days equals recent value will be retrieved.
     * </p>
     *
     * @param user user id, any possible long value
     ...
     *
     * <p>
     * If the given recent is positive, then the users that create the sessions that were requested by
     ...
     * </p>
     *
     * @return array of <code>ChatSessionEventListener</code> instances in this manager,
     * null impossible but may be empty array
     */
