...
public class IMServiceHandler implements ServiceHandler {
     ...
     * @param messenger
     *            messenger used to send the message. Can't be null.
     ...
     *                if any argument except the logger is null or the responderWaitTime or
     ...
     *            logger used to log the messages. Can be null.
     * @param namespace
     *            namespace to load the configuration. Can't be null or empty.
     * @exception IllegalArgumentException
     *                if any argument except the logger is null or the responderWaitTime or
     ...
     *            category of the service. Can't be null.
     * @param responder
     *            actual responder of this service handler for the requester and category.
     * @exception IllegalArgumentException
     *                if any argument is null.
     */
