...
public class AccuracyTestResponseDAO implements ScreeningResponseDAO {
     ...
     */
    public AccuracyTestResponseDAO(DBConnectionFactory connectionFactory, IDGenerator idGenerator) {
     ...
     */
    public AccuracyTestResponseDAO(DBConnectionFactory connectionFactory, String connectionName,
