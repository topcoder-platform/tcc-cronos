...
/**
 * <p>
 * The main class in this component. It is backed by a SpecificationFactory,
 * which it queries for specifications for objects. Gives four main methods to
 * create object where the user can specify two keys, the JAR file or
 * ClassLoader, the params to use in the construction, and the initialization
 * strategy. It also has four convenience methods that let the user only pass
 * the minimum amount of parameters. These can be useful when the construction
 * is to be done off the specification factory.
 * </p>
 * <p>
...
public class ObjectFactory {
     ...
     *             information
     */
    public Object createObject(String key, String identifier)
        throws InvalidClassSpecificationException {
     ...
     *             information
     */
    public Object createObject(Class type, String identifier)
        throws InvalidClassSpecificationException {
        ObjectFactoryHelper.checkObjectNotNull(type, "type");
        ObjectFactoryHelper.checkStringNotNullOrEmpty(identifier, "identifier");
     ...
     * indentifier is optional. If a specific jar is required, then a URL to it
     ...
     * default setting will be used. If these pecifications are not recognized,
     ...
     *             information
     */
    public Object createObject(String key, String identifier, URL jar, Object[] params,
        Class[] paramTypes, String initStrategy) throws InvalidClassSpecificationException {
        return createObject(key, identifier, (jar == null) ? null : new URLClassLoader(
            new URL[] {jar}), params, paramTypes, initStrategy);
    }
     ...
     *             information
     */
    public Object createObject(Class type, String identifier, URL jar, Object[] params,
        Class[] paramTypes, String initStrategy) throws InvalidClassSpecificationException {
        ObjectFactoryHelper.checkObjectNotNull(type, "type");

        return createObject(type, identifier, (jar == null) ? null : new URLClassLoader(
            new URL[] {jar}), params, paramTypes, initStrategy);
    }
     ...
     * Creates an object using the passed specifications with the configured
     * initialization strategy. The key needs to be supplied, but the extra
     * indentifier is optional. A specific class loader can be used, otherwise,
    ...
    public Object createObject(Class type, String identifier, ClassLoader loader, Object[] params,
        ...
        Object result = createObject(type.getName(), identifier, loader, params, paramTypes,
            initStrategy);

        if (!type.isAssignableFrom(getArrayComponentType(result.getClass()))) {
            throw new InvalidClassSpecificationException("The type returned should be "
                + type.getName() + ", but is " + result.getClass().getName() + ".");
        }
    ...
    public Object createObject(String key, String identifier, ClassLoader loader, Object[] params,
        ...
        if (initStrategy.equals(REFLECTION_ONLY)) {
            ...
            try {
                ...
                ObjectSpecification objSpec = this.specificationFactory.getObjectSpecification(key,
                    identifier);
                ...
                if (initStrategy.equals(SPECIFICATION_ONLY)) {
                    throw new InvalidClassSpecificationException(
                        "error occurs when getting specifications.", e);
                } else {
    ...
    private Object getObjectBySpecification(ObjectSpecification objSpec)
        ...
        if (objSpec.getSpecType().equals(ObjectSpecification.NULL_SPECIFICATION)) {
            ...
            try {
                ...
                Object object = Array.newInstance(this.resolveClass(objSpec.getType(),
                    resolveClassLoader(objSpec.getJar())), dims);
     ...
     */
    private Object getObjectBySimpleType(String type, String value)
        throws InvalidClassSpecificationException {
        try {
     ...
     */
    private Class[] createParameterObjects(Object[] params)
        throws InvalidClassSpecificationException {
        ...
        for (int i = 0; i < params.length; i++) {
            if (params[i] instanceof ObjectSpecification) {
                ...
                try {
                    classes[i] = this.resolveClass(spec.getType(), this.resolveClassLoader(spec
                        .getJar()));
     ...
     *             if any error occurs when creating the object.
     */
    private Object createComplexSpecification(ObjectSpecification spec, Object[] params,
        Class[] paramTypes) throws InvalidClassSpecificationException {
        try {
            // create the object according to the params and paramTypes.
            return createObjectByReflection(spec.getType(), resolveClassLoader(spec.getJar()),
                params, paramTypes);
        } catch (IllegalArgumentException e) {
     ...
     */
    private Object createObjectByReflection(String type, ClassLoader loader, Object[] params,
        Class[] paramTypes) throws InvalidClassSpecificationException {
        try {
            ...
            // Try to create the object by try every constructor
    ...
    private Object createObjectByEnumeration(String type, ClassLoader loader, Object[] params)
        ...
        // Second, try to create an instance from the construtors.
    ...
    private static String checkStrategyString(String strategy) {
        ...
        if (!(strategy.equals(BOTH) || strategy.equals(REFLECTION_ONLY) || strategy
            .equals(SPECIFICATION_ONLY))) {
