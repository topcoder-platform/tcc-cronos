...
class DatabaseUtils {
     ...
     *         value was null)
     * @throws IllegalArgumentException
     *             if connection is null, or if queryString is null or empty
     *             (trimmed), or if argumentTypes is null or contains null, or
     *             if queryArgs is null or the length of it is different from
     *             that of argumentTypes, or if columnTypes is null or contains
     *             null or the the number of columns returned is different from
     *             that of columnTypes
     * @throws DAOException
     *             if any error happens
     */
    static Object[][] doQuery(Connection connection, String queryString, DataType[] argumentTypes,
        Object[] queryArgs, DataType[] columnTypes) throws DAOException {
        if (connection == null) {
     ...
     *         value was null)
     * @throws IllegalArgumentException
     *             if connectionFactory is null, or if queryString is null or
     *             empty (trimmed), or if argumentTypes is null or contains
     *             null, or if queryArgs is null or the length of it is
     *             different from that of argumentTypes, or if columnTypes is
     *             null or contains null or the the number of columns returned
     *             is different from that of columnTypes
     * @throws DAOException
     *             if any error happens
     */
    ...
    static int doDMLQuery(Connection connection, String queryString, DataType[] argumentTypes,
        Object[] queryArgs) throws DAOException {
        if (connection == null) {
            throw new IllegalArgumentException("connection should not be null.");
        }
        if (queryString == null) {
     ...
     *             if connectionFactory is null, or if queryString is null or
     *             empty (trimmed), or if argumentTypes is null or contains
     *             null, or if queryArgs is null or length of it is different
     *             from that of argumentTypes
     * @throws DAOException
     *             if the query fails
     */
    ...
    static Connection createConnection(DBConnectionFactory connectionFactory,
        String connectionName, boolean autoCommit, boolean readOnly) throws DAOException {
        ...
        try {
            ...
            throw new DAOException("Error occurs when getting the connection using "
    ...
    /**
     * Wraps a long value to a Long object. If the long value is Long.MIN_VALUE,
    ...
    /**
     * Unwraps a Long object to a long value. If the Long object is null,
