...
public class DAOLoggerTest extends BaseTestCase {
    ...
    public void testFailureCtor1() throws Exception {
        ...
        try {
            ...
            assertEquals("check message", "screeningResponseDAO should not be null", e.getMessage());
        }
    }
    ...
    public void testFailureSetOperator1() throws Exception {
        ...
        try {
            ...
            assertEquals("check message", "operator should not be null.", e.getMessage());
        }
    }
    ...
    public void testFailureSetOperator2() throws Exception {
        ...
        try {
            ...
            assertEquals("check message", "operator should not be empty (trimmed).", e.getMessage());
        }
    }
    ...
    public void testFailureLogResponse1() throws Exception {
        ...
        try {
            logger.logResponse(null, new ScreeningLogic(new ComponentSpecificationRule(),
                ResponseLevel.PASS, ResponseLevel.WARN, ResponseLevel.FAIL, 1, 1, 1),
                new RuleResult[] {});
            fail("IllegalArgumentException should be thrown.");
        } catch (IllegalArgumentException e) {
            assertEquals("check message", "screeningTask should not be null.", e.getMessage());
        }
    }
    ...
    public void testFailureLogResponse2() throws Exception {
        ...
        try {
            ...
            assertEquals("check message", "screeningLogic should not be null.", e.getMessage());
        }
    }
    ...
    public void testFailureLogResponse3() throws Exception {
        ...
        try {
            logger.logResponse(new ScreeningTask(), new ScreeningLogic(
                new ComponentSpecificationRule(), ResponseLevel.PASS, ResponseLevel.WARN,
                ResponseLevel.FAIL, 1, 1, 1), null);
            fail("IllegalArgumentException should be thrown.");
        } catch (IllegalArgumentException e) {
            assertEquals("check message", "ruleResult should not be null.", e.getMessage());
        }
    }
    ...
    public void testFailureLogResponse4() throws Exception {
        ...
        try {
            logger.logResponse(new ScreeningTask(), new ScreeningLogic(
                new ComponentSpecificationRule(), ResponseLevel.PASS, ResponseLevel.WARN,
                ResponseLevel.FAIL, 1, 1, 1), new RuleResult[] {null});
            fail("IllegalArgumentException should be thrown.");
        } catch (IllegalArgumentException e) {
            assertEquals("check message", "ruleResult should not contain null elements.", e
                .getMessage());
        }
    }
    ...
    public void testFailureLogResponse5() throws Exception {
        ...
        try {
            logger.logResponse(new ScreeningTask(), new ScreeningLogic(
                new ComponentSpecificationRule(), ResponseLevel.PASS, ResponseLevel.WARN,
                ResponseLevel.FAIL, 1, 1, 1), new RuleResult[] {});
            ...
            assertEquals("check message",
                "The operator name of this DAOLogger instance has not been specified. "
                    + "Use setOperator() to set the operator name.", e.getMessage());
        }
    }
}