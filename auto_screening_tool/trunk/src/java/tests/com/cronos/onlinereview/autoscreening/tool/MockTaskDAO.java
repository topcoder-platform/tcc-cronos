...
import com.cronos.onlinereview.autoscreening.tool.DatabaseUtils.DataType;
...
public class MockTaskDAO implements ScreeningTaskDAO {
     ...
     */
    public MockTaskDAO(DBConnectionFactory connectionFactory, UserRetrieval userRetrieval) {
     ...
     */
    public MockTaskDAO(DBConnectionFactory connectionFactory, String connectionName,
