...
public class PDFCOOReportSerializer extends BaseCOOReportSerializer {
    ...
    public byte[] serializeCOOReportToByteArray(COOReport report)
        ...
        try {
            ...
            XComponent xComponent = getXTextDocument(this.getTemplateFilename());
            ...
            while (e.hasMoreElements()) {
                ...
                if (fieldCode.trim().startsWith("MERGEFIELD")) {
                    ...
                    // process field code.
                    processFieldCode(fieldCode, report, xPropertySet, xComponent, dependencies);
                }
            }
            ...
            throw Helper.logError(getLogger(), new COOReportSerializerException("illgeal argumet found.", e));
    ...
    private void processFieldCode(String fieldCode, COOReport report,
            ...
            List<ComponentDependency> dependencies) throws Exception {
        String value = null;
        if (fieldCode.equals("componentName")) {
            value = report.getContestData().getComponentName();
        } else if (fieldCode.equals("contestEndDate")) {
            value = report.getContestData().getContestEndDate().toString();
        } else if (fieldCode.equals("designWinner")) {
            value = report.getContestData().getDesignWinner();
            ...
            // remove the template field value
            value = "";
            ...
            generateDependency(component, xComponent, "Dependencies");
     ...
     * @param document the XComponent in open office.
    ...
    private void generateDependency(List<Component> components,
            XComponent document, String tag) throws Exception {
        ...
        // insert the tag for this table.
        xText.insertString(xText.getEnd(), tag, false);
     ...
     *
     * @param fileName Path of word document file.
     ...
     */
    private XComponent getXTextDocument(String fileName)
