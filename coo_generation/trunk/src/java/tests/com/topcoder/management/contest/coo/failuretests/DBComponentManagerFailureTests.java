...
public class DBComponentManagerFailureTests {
    ...
    /**
     * Method under test DBComponentManager.retrieveComponent(String, String).
     * Failure testing of exception in case version is null.
     * @throws Exception wraps all exceptions
     */
    @Test
    public final void testRetrieveComponentFailureVersionNull() throws Exception {
        try {
            dbComponentManager.retrieveComponent("name", null);
            Assert.fail("IllegalArgumentException is expected since version is null");
        } catch (IllegalArgumentException e) {
            // good
        }
    }
    ...
    /**
     * Method under test DBComponentManager.retrieveComponent(String, String).
     * Failure testing of exception in case version is empty.
     * @throws Exception wraps all exceptions
     */
    @Test
    public final void testRetrieveComponentFailureVersionEmpty() throws Exception {
        try {
            dbComponentManager.retrieveComponent("name", "");
            Assert.fail("IllegalArgumentException is expected since version is empty");
        } catch (IllegalArgumentException e) {
            // good
        }
    }
    ...
    /**
     * Method under test DBComponentManager.retrieveComponent(String, String).
     * Failure testing of exception in case version is empty trimmed.
     * @throws Exception wraps all exceptions
     */
    @Test
    public final void testRetrieveComponentFailureVersionEmptyTrimmed() throws Exception {
        try {
            dbComponentManager.retrieveComponent("name", "     ");
            Assert.fail("IllegalArgumentException is expected since version is empty trimmed");
        } catch (IllegalArgumentException e) {
            // good
        }
    }
