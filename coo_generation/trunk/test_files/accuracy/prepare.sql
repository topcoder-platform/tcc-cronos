...
"Antlr","2.7.6","www.antlr.org","Antlr 3 License (BSD Style)","Parser Generator","path","alias","note","JAVA");
insert into third_party_library values(
"junit","3.8.2","www.junit.org","CPL","Unit testing","path","alias","note","JAVA");
