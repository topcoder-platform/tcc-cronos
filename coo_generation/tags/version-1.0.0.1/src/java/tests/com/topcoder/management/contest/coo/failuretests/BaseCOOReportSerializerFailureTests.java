...
public class BaseCOOReportSerializerFailureTests {
    ...
    public void setUp() throws Exception {
        ...
        configurationObject.setPropertyValue("templateFilename", "template.xml");
        baseCOOReportSerializer = new BaseCOOReportSerializer(configurationObject) {

            public byte[] serializeCOOReportToByteArray(COOReport report) throws COOReportSerializerException {
                return null;
            }
        };
    }
