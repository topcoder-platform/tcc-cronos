 ...
 *
 * <p>Version 3.0 has added support for priority messages via message headers.</p>
 *
 * @author      sord
 * @author      BEHiker57W
 * @author      smell
...
public class EmailEngine implements ConfigManagerInterface {
    ...
    public static void send(TCSEmailMessage message) throws ConfigManagerException, SendingException {
        ...
        //send(from, to, cc, bcc, subject, data, attachments, headers);
    }


    /**
     * <p>This method actually contacts a SMTP server and transmits the message.</p>
     *
     * <p>It first tries to get the configuration of the SMTP server via ConfigManager. In case the search for
     * configuration fails, the default configuration will be used instead.</p>
     *
     * <p>Version 3.0 of Email Engine have added support for priority messages. The priority of message is implemented
     * as message headers and the headers are passed as parameter in the headers <code>Map</code>.</p>
     *
     ...
     *
     * @throws NullPointerException     if any of from, to, subject, data or attachments is <code>null</code>
    ...
    protected static void send(Address from, Address[] to, Address[] cc, Address[] bcc, String subject, String data,
                               Map attachments, Map headers) throws ConfigManagerException, SendingException {
        checkNull(from, "from");
        checkNull(to, "to");
        ...
        if (host == null || host.equals("")) {
            trace.info(PROPERTY_SMTP_HOST_ADDR + " has an invalid value in the EmailEngine configuration file:" + host);
            host = SMTP_HOST_ADDR;
        ...
        try {
            ...
            trace.info(PROPERTY_SMTP_HOST_PORT + " has an invalid value in the EmailEngine configuration file:" + port);
            port = SMTP_HOST_PORT;
