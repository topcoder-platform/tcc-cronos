...
/**
 * <p>
 * This class extends the <code>HttpServlet</code>, and it allows web site
 * administrators to remove particular member photos. After the photo is
 * removed, an notification email will be sent to user via <code>Email
 * Engine</code>, whose email body is generated from a template using the
 * <strong>Document Generator</strong>.
 * </p>
 * <p>
 * It will also retrieve the necessary member information for the email body
 * from the MemberInformationRetriever. The <code>MemberPhotoManager</code> is
 * used to remove the photo in persistence, and get the image file in order to
 * remove it from local file system. It will validated the submitted form data,
 * if validation fails, it will forward to a configured validation error URL,
 * and if everything goes well, it will forward to a configured success URL.
 * </p>
 * <p>
 * File processing should be synchronized since multiple servlets may access the
 ...
 * 3. a directory for removed images has been added where the removed images
 * will be stored.
 * </p>
 * <p>
 * <i>Sample code: </i><br>
 ...
 * </p>
 * <p>
 * <strong>Thread safety:</strong> The injected instance variables are immutable
 * after injection. So this class is thread-safe when serving user requests.
 * </p>
...
public class MemberPhotoRemovalServlet extends HttpServlet {
    ...
    /**
     * <p>
     * Represent the directory to remove member photo from this directory.
     * </p>
     * <p>
     * It's injected by the Spring.
     * </p>
    ...
    /**
     * <p>
     * Represents the request attribute name of the error message if the member
     * has no photo.
     * </p>
     * <p>
     * It's injected by the Spring.
    ...
    /**
     * <p>
     * Represents the session key for the isAdministrator flag, which indicating
    ...
    /**
     * <p>
     * Represents the request attribute name of the error message if the user is
    ...
    /**
     * <p>
     * Represents the document generator to generate the email body from
     * template.
     * </p>
     * <p>
     * It's injected by the Spring.
    ...
    /**
     * <p>
     * Represents the MemberInformationRetriever to retrieve the member
     * information.
     * </p>
     * <p>
     * It's injected by the Spring.
    ...
    /**
     * <p>
     * Represent the file containing the template data for the email body of the
     * notification email.
     * </p>
     * <p>
     * It's injected by the Spring.
     ...
     * </p>
     * <p>
     * It's created upon initialization with the class name of this class as the
     * logger name.
     * </p>
     * <p>
     * After injection, it must be non-null, non-empty string.
    ...
    /**
     * <p>
     * Represents the flag that controls if the email notification is sent or
     * not.
     * </p>
     * <p>
     * It's injected by the Spring.
     ...
     * </p>
     */
    public MemberPhotoRemovalServlet() {
    }
    /**
     * <p>
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        logMsg(MessageFormat.format("{0} : Entering "
                + "MemberPhotoRemovalServlet#doPost"
                + "(HttpServletRequest, HttpServletResponse)"
                + " - request {1}, response {2},", new Date(), request,
                response));
        try {
            ...
            try {
                ...
                long memberId =
                        Long.parseLong(request
                                .getParameter(memberIdParameterName));

                // get removal reason explanation
                String removalReason =
                        request.getParameter(removalReasonParameterName);
                ...
                if ((isAdministrator == null) || !isAdministrator) {
                    ...
                    request.setAttribute(notAdministratorErrorName,
                ...
                if (image == null) {
                    validationError = true;
                    request.setAttribute(memberHasNoPhotoErrorName,
                            "The member has no photo to remove.");
                }

                // Report validation errors
                if (validationError) {
                    request.getRequestDispatcher(validationErrorForwardUrl)
                            .forward(request, response);
                    return;
                }

                // remove image
                memberPhotoManager.removeMemberPhoto(memberId, memberInformationRetriever.getMemberInformation(memberId).getHandle());
                synchronized (this) {
                ...
                sb.append(processStr(memberInfo.getName()));
                sb.append("</memberName><memberHandle>");
                sb.append(processStr(memberInfo.getHandle()));
                ...
                try {
                    template =
                            documentGenerator
                                    .getTemplate(emailBodyTemplateFileName);
                } catch (IllegalArgumentException e) {
                    throw new MemberPhotoRemovalException("Error occurs when getTemplate:template is empty.",e);
                }
                String emailBody =
                        documentGenerator.applyTemplate(template,
                                bodyTemplateData);
                ...
                if (emailSendFlag) {
                    ...
                    message.setToAddress(memberInfo.getEmailAddress(),
                            TCSEmailMessage.TO);
                ...
                request.getRequestDispatcher(successResultForwardUrl).forward(
                        request, response);

            } catch (NumberFormatException e) {
                throw new MemberPhotoRemovalException(
                        "The input is not a number or is null value.", e);
            } catch (ClassCastException e) {
                throw new MemberPhotoRemovalException(
                        "The 'isAdministrator' is not valid boolean value.", e);
            } catch (MemberPhotoNotFoundException e) {
                throw new MemberPhotoRemovalException(
                        "Member photo not found.", e);
            } catch (MemberPhotoManagementException e) {
                throw new MemberPhotoRemovalException(
                        "Error occurs when manage member photo.", e);
            } catch (ServletException e) {
                throw new MemberPhotoRemovalException(
                        "Servlet exception occurs.", e);
            } catch (SecurityException e) {
                throw new MemberPhotoRemovalException(
                        "Security exception occurs.", e);
            } catch (MemberInformationRetrievalException e) {
                throw new MemberPhotoRemovalException(
                        "Error occurs when retrieve member information.", e);
            } catch (TemplateSourceException e) {
                throw new MemberPhotoRemovalException(
                        "Template source exception occurs.", e);
            } catch (TemplateFormatException e) {
                throw new MemberPhotoRemovalException(
                        "Template format exception occurs.", e);
            } catch (TemplateDataFormatException e) {
                throw new MemberPhotoRemovalException(
                        "Template data format exception occurs.", e);
                ...
                throw new MemberPhotoRemovalException(
                        "Error occurs about ConfigManagerException.", e);
            }
        } catch (IllegalArgumentException e) {
            ...
            throw logMsg("unexpected error occurs. details:" + e.getMessage(),
                    e);
        } finally {
            logMsg(MessageFormat.format("{0} : Exiting "
                    + "MemberPhotoRemovalServlet#doPost"
    ...
    public void setRemovalReasonParameterName(String removalReasonParameterName) {
        Helper.checkString(removalReasonParameterName,
                "removalReasonParameterName");
    ...
    public void setMemberHasNoPhotoErrorName(String memberHasNoPhotoErrorName) {
        Helper.checkString(memberHasNoPhotoErrorName,
                "memberHasNoPhotoErrorName");
    ...
    public void setIsAdministratorSessionKey(String isAdministratorSessionKey) {
        Helper.checkString(isAdministratorSessionKey,
                "isAdministratorSessionKey");
    ...
    public void setNotAdministratorErrorName(String notAdministratorErrorName) {
        Helper.checkString(notAdministratorErrorName,
                "notAdministratorErrorName");
    ...
    public void setValidationErrorForwardUrl(String validationErrorForwardUrl) {
        Helper.checkString(validationErrorForwardUrl,
                "validationErrorForwardUrl");
     ...
     * Setter for the namesake instance variable.
     * </p>
     * @param documentGenerator the document generator.
     * @throws IllegalArgumentException if the argument is null.
     */
    public void setDocumentGenerator(DocumentGenerator documentGenerator) {
        Helper.checkNull(documentGenerator, "documentGenerator");
     ...
     * @throws IllegalArgumentException if the argument is null.
     */
    public void setMemberInformationRetriever(
            MemberInformationRetriever memberInformationRetriever) {
        Helper.checkNull(memberInformationRetriever,
                "memberInformationRetriever");
    ...
    public void setEmailBodyTemplateFileName(String emailBodyTemplateFileName) {
        Helper.checkString(emailBodyTemplateFileName,
    ...
    public void setPhotoImageRemovedDirectory(String photoImageRemovedDirectory) {
        Helper.checkString(photoImageRemovedDirectory,
                "photoImageRemovedDirectory");
    ...
    private void checkState() {
        ...
        Helper.checkState(removalReasonParameterName,
                "removalReasonParameterName");

        // check 'isAdministratorSessionKey' field state
        Helper.checkState(isAdministratorSessionKey,
                "isAdministratorSessionKey");

        // check 'notAdministratorErrorName' field state
        Helper.checkState(notAdministratorErrorName,
                "notAdministratorErrorName");
        ...
        Helper.checkState(memberHasNoPhotoErrorName,
                "memberHasNoPhotoErrorName");

        // check 'validationErrorForwardUrl' field state
        Helper.checkState(validationErrorForwardUrl,
                "validationErrorForwardUrl");

        // check 'memberInformationRetriever' field state
        checkObjectState(memberInformationRetriever,
                "memberInformationRetriever");

        // check 'emailBodyTemplateFileName' field state
        Helper.checkState(emailBodyTemplateFileName,
                "emailBodyTemplateFileName");
        ...
        // check 'photoImageDirectory' field state
        // Helper.checkState(photoImageDirectory, "photoImageDirectory");

        // check 'emailSendFlag' field state
        checkObjectState(emailSendFlag, "emailSendFlag");

        // check 'photoImageRemovedDirectory' field state
        Helper.checkState(photoImageRemovedDirectory,
                "photoImageRemovedDirectory");
    }

    /**
     * <p>
     * Checks whether an object is null, if it is,
     ...
     * Setter for the namesake instance variable.
     * </p>
     * @param imageDirectoryName  photo image submitted directory.
     * @throws IllegalArgumentException if the argument is null or empty string.
     */
    public void setImageDirectoryName (
            String imageDirectoryName ) {
        Helper.checkString(imageDirectoryName ,
                "imageDirectoryName ");
