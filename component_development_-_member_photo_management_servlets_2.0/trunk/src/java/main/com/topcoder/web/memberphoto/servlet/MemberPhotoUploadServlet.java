...
public class MemberPhotoUploadServlet extends HttpServlet {
     ...
     * </p>
     * <p>
     * The URL can contain a place-holder string: '${memberId}' (without quotes), it will be replaced by the
     * real memberId.
     * </p>
     * <p>
     * It's injected by the Spring.
    ...
    /**
     * <p>
     * Represents the request attribute name of the error message if the uploaded file size excceded the max
        ...
        try {
            ...
            try {
                ...
                if ((submittedAction == null)
                    || (!submittedAction.equals("preview") && !submittedAction.equals("crop") && !submittedAction
                        .equals("commit"))) {
                ...
                try {
                    int targetImageLeftCornerX = Integer.parseInt(request
                        .getParameter(targetImageLeftCornerXParameterName));
                    int targetImageLeftCornerY = Integer.parseInt(request
                        .getParameter(targetImageLeftCornerYParameterName));
                    int targetImageRightCornerX = Integer.parseInt(request
                        .getParameter(targetImageRightCornerXParameterName));
                    int targetImageRightCornerY = Integer.parseInt(request
                ...
                if (memberId != sessionMemberId) {
                    validationError = true;
                    request
                        .setAttribute(memberIdErrorName, "The member id doesn't match the one in session.");
                }
                ...
                if ((imageWidth != targetImageWidth) || (imageHeight != targetImageHeight)) {
                    ...
                    // crop the image.
                    if (wRatio > hRatio) {
                        resizedImage = resizedImage.getSubimage(0, (resizedHeight - targetImageHeight) / 2,
                            targetImageWidth, targetImageHeight);
                    } else {
                        resizedImage = resizedImage.getSubimage((resizedWidth - targetImageWidth) / 2, 0,
                            targetImageWidth, targetImageHeight);
                    }
                } else {
                ...
                if (submittedAction.equals("preview")) {
                    String path = photoImagePreviewDirectory + "/" + memberId + imagepostfix;
                ...
                if (submittedAction.equals("commit")) {
                    ...
                    memberPhotoManager.saveMemberPhoto(memberId, memberId + imagepostfix,
                        memberInformationRetriever.getMemberInformation(memberId).getHandle());
     ...
     */
    private void upLoadPicture(long memberId, BufferedImage resizedImage, String directory)
        throws IOException {
        ...
        // Store image
        String path = directory + "/" + memberId + imagepostfix;
        synchronized (this) {
