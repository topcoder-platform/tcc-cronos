...
public class MemberPhotoRemovalServlet extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            try {
                ...
                if (image == null) {
                    validationError = true;
                    request.setAttribute(memberHasNoPhotoErrorName, "The member has no photo to remove.");
                }
                ...
                // remove image
                memberPhotoManager.removeMemberPhoto(memberId, memberInformationRetriever
                    .getMemberInformation(memberId).getHandle());
                synchronized (this) {
                    ...
                    move(image.getFileName(),
                        photoImageRemovedDirectory + File.separator + image.getFileName());
                }

                // get member information
                MemberInformation memberInfo = memberInformationRetriever.getMemberInformation(memberId);
                ...
                try {
                    template = documentGenerator.getTemplate(emailBodyTemplateFileName);
                } catch (IllegalArgumentException e) {
                    throw new MemberPhotoRemovalException("Error occurs when getTemplate:template is empty.",
                        e);
                }
                ...
                if (emailSendFlag) {
                    ...
                    message.setToAddress(memberInfo.getEmailAddress(), TCSEmailMessage.TO);
                ...
                throw new MemberPhotoRemovalException("Servlet exception occurs.", e);
            } catch (SecurityException e) {
                throw new MemberPhotoRemovalException("Security exception occurs.", e);
            } catch (MemberInformationRetrievalException e) {
                throw new MemberPhotoRemovalException("Error occurs when retrieve member information.", e);
            } catch (TemplateSourceException e) {
                throw new MemberPhotoRemovalException("Template source exception occurs.", e);
    ...
    private void checkState() {
        ...
        checkObjectState(memberInformationRetriever, "memberInformationRetriever");
    ...
    public void setImageDirectoryName(String imageDirectoryName) {
        Helper.checkString(imageDirectoryName, "imageDirectoryName ");
