...
/**
 * <p>
 * This class extends the HttpServlet, and it allows web site administrators to list/view particular member photos. <br>
 * The listing is paged based on the input parameters or specific defaults are assumed (see method doc) The
 * MemberPhotoManager is used to get the photos information from persistence, and get the image file in order to allow
 * the user to view the file(s) It will validated the submitted form data, if validation fails, it will forward to a
 * configured validation error url, and if everything goes well, it will forward to a configured success url.
 * </p>
 * <p>
 ...
 * </p>
 * <p>
 * <b>Thread-safety:</b> The injected instance variables are immutable after injection. So this class is thread-safe
 * when serving user requests.
 * </p>
...
public class MemberPhotoListServlet extends HttpServlet {
    ...
    /**
     * <p>
     * Represents the session key for the isAdministrator flag, which indicating the user is an administrator or not.
     * </p>
     * <p>
     * It's injected by the Spring.
     * </p>
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
        ...
        try {
            ...
            try {
                ...
                Boolean isAdministrator = (Boolean) request.getSession().getAttribute(isAdministratorSessionKey);
                ...
                PagedResult < MemberImage > result = memberPhotoManager.getMemberPhotos((int) pageNo, (int) pageSize);
                ...
                throw new MemberPhotoListingException("MemberPhotoManagementException occurs when get photo list.", e);
            }
