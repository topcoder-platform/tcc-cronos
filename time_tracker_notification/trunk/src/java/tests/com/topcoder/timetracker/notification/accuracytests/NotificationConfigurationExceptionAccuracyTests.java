...
/**
 * <p>
 * Unit test cases for NotificationConfigurationException.
 * </p>
 *
 * <p>
 ...
 * @version 3.2
 */
public class NotificationConfigurationExceptionAccuracyTests extends TestCase {
    /**
     * <p>
    ...
    /**
     * <p>
     * An exception instance used to create the NotificationConfigurationException.
     * </p>
     */
     ...
     *
     * <p>
     * Verifies NotificationConfigurationException subclasses Exception.
     * </p>
     */
    public void testNotificationConfigurationExceptionInheritance1() {
        NotificationConfigurationException exception = new NotificationConfigurationException(ERROR_MESSAGE);
        assertTrue("NotificationConfigurationException does not subclass Exception.", exception instanceof Exception);
    }
     ...
     * </p>
     */
    public void testNotificationConfigurationExceptionInheritance2() {
        NotificationConfigurationException exception = new NotificationConfigurationException(ERROR_MESSAGE,
            CAUSE_EXCEPTION);
        assertTrue("NotificationConfigurationException does not subclass Exception.", exception instanceof Exception);
    }
