 ...
 * the user is not found in the jive forum.
 * </p>
 *
 * <p>
 ...
 * @version 1.0
 */
public class UserNotFoundException extends JiveForumManagementException {
    /**
     * <p>Serial version uid for the Serializable class.</p>
     */
    private static final long serialVersionUID = -8169882603668357898L;
     ...
     */
    public UserNotFoundException(String message, ExceptionData data) {
        super(message, data);
    }
