 ...
 * @version 1.0
 */
public class AccuracyForumMessage implements ForumMessage {
    public long getID() {
    ...
    public Attachment createAttachment(String arg0, String arg1, InputStream arg2) throws AttachmentException,
    ...
    public void deleteAttachment(Attachment arg0) throws AttachmentException, UnauthorizedException {
        // TODO Auto-generated method stub
    }

    public Iterator getAttachments() {
        List<Attachment> list = new ArrayList<Attachment>();
        list.add(new AccuracyAttachment());
