 ...
 * @version 1.0
 */
public class AccuracyForumCategory implements ForumCategory {
    ...
    public void setForumIndex(Forum arg0, int arg1) throws UnauthorizedException {
    }

    public void moveForum(Forum arg0, ForumCategory arg1) throws UnauthorizedException {
    }
    ...
    public Iterator getCategories() {
        if (id == 1) {
            ...
            AccuracyForumCategory category = new AccuracyForumCategory();
            category.setID(11);
            list.add(category);
    ...
    public void setCategoryIndex(ForumCategory arg0, int arg1) throws UnauthorizedException {
        // TODO Auto-generated method stub
    }

    public void moveCategory(ForumCategory arg0, ForumCategory arg1) throws UnauthorizedException {
        // TODO Auto-generated method stub
    }

    public ForumCategory createCategory(String name, String desc) throws UnauthorizedException {
        if (exception) {
            throw new UnauthorizedException("Simulated Exception.");
        }

        AccuracyForumCategory newCategory = new AccuracyForumCategory();
        newCategory.setID(1);
    ...
    public PermissionsManager getPermissionsManager() throws UnauthorizedException {
        return new AccuracyPermissionsManager();
    }
