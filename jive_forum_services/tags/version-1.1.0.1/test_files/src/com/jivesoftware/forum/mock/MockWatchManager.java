...
public class MockWatchManager implements WatchManager {
    ...
    public void setBatchTimer(User arg0, CronTimer arg1)
    ...
    public Watch createWatch(User user, ForumThread forumThread)
        throws UnauthorizedException {
        threadWatched = true;
    ...
    public Watch createWatch(User user, ForumCategory forumCategory)
        throws UnauthorizedException {
    ...
    public int getWatchCount(User arg0, Forum arg1)
        throws UnauthorizedException {
        // TODO Auto-generated method stub
        return 0;
    }

    public int getWatchCount(User arg0, ForumCategory arg1)
        throws UnauthorizedException {
        return 0;
    }

    public int getTotalWatchCount(User arg0, int arg1)
        throws UnauthorizedException {
        return 0;
    }

    public Iterator getAllWatches(User arg0, int arg1)
        throws UnauthorizedException {
        return null;
    }

    public Iterator getWatches(User arg0, Forum arg1)
        throws UnauthorizedException {
        return null;
    }

    public Iterator getWatches(User arg0, ForumCategory arg1)
        throws UnauthorizedException {
        return null;
    }
    ...
    public Watch getWatch(User arg0, ForumThread arg1)
        throws UnauthorizedException {
        return null;
    }
    ...
    public Watch getWatch(User arg0, ForumCategory arg1)
        throws UnauthorizedException {
        return null;
    }

    public boolean isWatched(User user, ForumCategory forumCategory)
        throws UnauthorizedException {
        if (watched) {
            return true;
        }
    ...
    public boolean isWatched(User user, ForumThread forumThread)
        throws UnauthorizedException {
        if (watched) {
            return true;
        }
