...
public class MockForum implements Forum {
    private long id;
    ...
    public void setNNTPName(String arg0)
    ...
    public void setModerationDefaultThreadValue(int arg0)
    ...
    public void setModerationDefaultMessageValue(int arg0)
        throws UnauthorizedException {
        // TODO Auto-generated method stub
    }
    ...
    public ForumThread createThread(ForumMessage message)
        throws UnauthorizedException {
        MockForumThread thread = new MockForumThread();
        thread.setRootForumMessage((MockForumMessage) message);
    ...
    public void addThread(ForumThread arg0)
    ...
    public void moveThread(ForumThread arg0, Forum arg1)
        throws UnauthorizedException, IllegalArgumentException {
    }

    public ForumThreadIterator getThreads() {
        if (id == 11) {
            MockForumThreadIterator it = new MockForumThreadIterator();
            it.setSize(1);
