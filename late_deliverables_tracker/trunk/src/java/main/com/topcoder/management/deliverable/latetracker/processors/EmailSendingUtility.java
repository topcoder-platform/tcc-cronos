...
/**
 * <p>
 * This is a helper utility class that is used by
 * <code>LateDeliverableProcessorImpl</code> for sending warning email messages to the
 * users who have late deliverables. This class supports constructing email message
 * subjects and bodies from templates. It uses Document Generator component for this. This
 * class uses Email Engine component to perform the actual sending of email messages.
 * </p>
 * <p>
 * Thread Safety: This class is immutable and thread safe. It uses thread safe EmailEngine
 * class.
 * </p>
 *
...
public class EmailSendingUtility {
    ...
    /**
     * Sends an email message generated from templates to the specified recipients. The
     * email message is assumed to have HTML content.
     *
     ...
     * @throws IllegalArgumentException
     *             if <code>subjectTemplateText</code> is <code>null</code>,
     *             <code>bodyTemplatePath</code> is <code>null</code> or empty,
     *             <code>recipient</code> is <code>null</code> or empty,
     *             <code>params</code> is null or contains <code>null</code> or empty
     *             key or <code>null</code> value.
    ...
    public void sendEmail(String subjectTemplateText, String bodyTemplatePath, String recipient,
        Map<String, String> params) throws EmailSendingException {
        ...
        try {
            ...
            for (Entry<String, String> entry : params.entrySet()) {
                ...
                ExceptionUtils.checkNullOrEmpty(entry.getValue(), null, null,
                    "The parameter 'params' should not contain null or empty key.");
            }
            ...
            Node[] nodes = createNodes(params);

            // Generate email title from template
            String emailSubject = applyTemplate(documentGenerator, emailSubjectTemplate, nodes);

            // Generate email body from template
            String emailBody = applyTemplate(documentGenerator, emailBodyTemplate, nodes);
    ...
    /**
     * Constructs nodes for template variables from given parameters.
     *
     * @param params
     *            the parameters used to create nodes.
     * @return the created nodes with the key and value populated.
     */
    private static Node[] createNodes(Map<String, String> params) {
        ...
        for (Map.Entry<String, String> entry : params.entrySet()) {
            ...
            nodes[paramNum] = new Field(key, value, null, true);
            paramNum++;
        }
    ...
    /**
     * Applies the template with given nodes.
     *
    ...
    private static String applyTemplate(DocumentGenerator documentGenerator, Template template,
        Node[] nodes) throws EmailSendingException {
        // Create template fields data
        TemplateFields data = new TemplateFields(nodes, template);

        try {
            return documentGenerator.applyTemplate(data);
        } catch (TemplateFormatException e) {
