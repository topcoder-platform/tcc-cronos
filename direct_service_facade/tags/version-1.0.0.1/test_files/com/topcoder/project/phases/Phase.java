...
/**
 * <p>
 * Represent the phase making up of the project. Any phase can only belong to one project and has a non-negative
 * length in milliseconds. The phase also has the id, type and status attributes.
 * </p>
 * <p>
...
public class Phase extends AttributableObject {
    ...
    /**
     * Represents the phase type. Initialized in the constructor and could be accessed via getter and setter method.
    ...
    /**
     * Scheduled start timestamp is the original plan for the project start timeline. Initialized in the constructor
     * and could be accessed via getter and setter method. The value could be null.
     */
     ...
     * calculated. Initialized in the constructor and could be accessed via getter and setter method. The value could
     * be null.
     */
    ...
    /**
     * Represents the cached start date of this phase. It will be reset when calculating the phase start/end date
     * after any part of the project was changed.
     */
    ...
    /**
     * Gets the scheduled start date of this phase. Scheduled start timestamp is the original plan for the project
     * start timeline. This date is optional. This method will return a copy of <code>scheduledStartDate</code>
    ...
    /**
     * Sets the scheduled start date of this phase. Scheduled start timestamp is the original plan for the project
     * start timeline. Could be null, but cannot be after <code>scheduledEndDate</code>.
     * 
     ...
     * <p>
     * For the sake of efficiency, this method will not detect the loop dependency. Loop dependency will be detected
     * in <code>calcEndDate()</code> and <code>calcStartDate()</code> method.
     * </p>
     * 
     * @param dependency
    ...
    /**
     * Remove the dependency from the dependency set. If the given phase does not exist in the dependency list,
     * nothing will happen. After the removal, this phase will not depend on the removed one any more.
     * 
     * @param dependency
