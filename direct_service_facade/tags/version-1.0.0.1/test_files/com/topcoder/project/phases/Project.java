 ...
 * <code>Project</code> instance which is composed of a collection of phases depending on each other.
 * </p>
 * <p>
 ...
 * finished, each phase has a start date and length to finish, at the same time, the project has a start date so that
 * we can know when will the project be finished.
 * </p>
 * <p>
...
public class Project extends AttributableObject {
     ...
     * methods. Updated the type of phases for Flex Cockpit Launch Contest - Integrate Software Contests v1.0 Other
     * corresponding instances has also been updated.
     */
    private Set<Phase> phases = new HashSet<Phase>();

    /**
     * Represents the start date of the project, it is initialized in the constructor, and changed in the setter
     * method.
     */
    private Date startDate;

    /**
     * Represents the project id. Initialized in the constructor and could be accessed via getter and setter method.
     * The value could not be negative.
     */
    private long id;

    /**
     * The changed flag indicates whether the project and its phases are modified after last start/end date
     * calculation. The default value is true. It will be set to false in <code>calculateProjectDate</code>.
     */
     ...
     * 
     * @param phases
     *            the phases set. Flex Cockpit Launch Contest - Integrate Software Contests v1.0
     */
     ...
     * </p>
     * 
     * @return the phases set. Flex Cockpit Launch Contest - Integrate Software Contests v1.0
     */
