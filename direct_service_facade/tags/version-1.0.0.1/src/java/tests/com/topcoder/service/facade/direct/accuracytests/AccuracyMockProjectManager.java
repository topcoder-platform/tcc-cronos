...
public class AccuracyMockProjectManager implements ProjectManager {

    public AccuracyMockProjectManager() {
    }
    ...
    public Project getProject(long id) throws PersistenceException {
        ...
        spec.setProjectSpecId(100);
        project.setProjectSpec(spec);
        return project;
    }
