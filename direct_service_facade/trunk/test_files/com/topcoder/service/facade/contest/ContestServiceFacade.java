...
import com.topcoder.management.review.data.Comment; //import com.topcoder.project.service.ScorecardReviewData;
...
import com.topcoder.service.studio.contest.ContestManagementException; //import com.topcoder.service.studio.contest.DocumentType;
import com.topcoder.service.studio.contest.SimpleContestData; //import com.topcoder.service.studio.contest.SimpleProjectContestData;
 ...
 * <p>
 * <p>
 * Version 1.0.2 (Spec Reviews Finishing Touches v1.0) Change Notes: - Made the getSpecReviews method return instance
 * of SpecReview rather than a list. - Added the methods to mark ready for review, review done and resubmit for
 * review.
 * </p>
 ...
 * 
 * Four methods are added setSubmissionMilestonePrize(submissionId:long,milestonePrizeId:long):void
 ...
 * -----
 * <p>
 * Changes in v1.1.1 - Cockpit Release Assembly 11 Add method getDesignComponents to get design components.
 * </p>
 * <p>
 ...
 * </p>
 * <p>
 * Changes in v1.3 (Cockpit Spec Review Backend Service Update v1.0): - Added method to create specification review
 * project for an existing project. - Added method to get scorecard and review information for a specific project. -
 * Added method to upload a mock submission / final fixes to the associated specification review of a project to make
 * it ready for review. - Added method to add comments to an existing review.
 * </p>
 * <p>
 * Changes in v1.5 (Cockpit Release Assembly - Contest Repost and New Version v1.0): - Added method to re open failed
 * software contest. - Added method to create new version for development or design contest.
 * </p>
 * 
 * <p>
 * Changes in v1.5.1(Cockpit Security Facade V1.0): - It is not a web-service facade any more. - All the methods
 * accepts a parameter TCSubject which contains all the security info for current user. The implementation EJB should
 * use TCSubject and now get these info from the sessionContext. - Please use the new ContestServiceFacadeWebService
 * as the facade now. That interface will delegates all the methods to this interface.
 * </p>
 * 
 * <p>
 * Changes in v1.6 (Direct Search Assembly): - Add getProjectData function
 * </p>
 * 
...
public interface ContestServiceFacade {
     ...
     *            a <code>long</code> providing the ID of a project the new competition belongs to.
     ...
     *             if specified <code>competition</code> is <code>null</code> or if the specified
     ...
     * @return a <code>List</code> providing the contests for specified project. Empty list is returned if there are
     *         no such contests found.
     * @throws PersistenceException
     *             if some persistence errors occur.
     ...
     *             if the specified status is not allowed to be set for specified contest.
     ...
     * @return a <code>List</code> listing all existing contests matching the specified criteria. Empty list is
     *         returned if there are no matching contests found.
     * @throws PersistenceException
     *             if any error occurs when getting contest.
     ...
     *             if some persistence errors occur.
     * @throws IllegalArgumentWSException
     *             if the specified <code>contentType</code> is <code>null</code> or empty.
     * @tested
     */
    ...
    /**
     * <p>
     * Purchases the specified submission. E.g. records a fact that submission referenced by specified ID has been
     * paid for in the course of payment transaction referenced by the specified <code>PayPal</code> order ID.
     * </p>
     * 
     * 
     * @param submissionId
     ...
     * @param payPalOrderId
     *            a <code>String</code> providing the <code>PayPal</code> order ID referencing the payment
     *            transaction.
     * @param securityToken
     ...
     *            TCSubject instance contains the login security info for the current user
     * @param tcSubject
     *            the TCSubject instance with login profile info
     * 
     * @param history
     ...
     * <li>Creates new forum for the contest, forum name being contest name. It uses studio service for doing the
     * same.</li>
     * </ul>
     * </li>
     * </ul>
     ...
     * @param paymentData
     *            <code>PaymentData</code> payment information (TCSubject tcSubject,credit card/po details) that need
     *            to be processed.
     ...
     * @param paymentData
     *            payment information (TCSubject tcSubject,credit card/po details) that need to be processed.
     * 
     * @return a <code>PaymentResult</code> result of the payment processing.
     * 
     * @throws ContestServiceException
     ...
     * @param paymentData
     *            a <code>PaymentData</code> payment information (TCSubject tcSubject,credit card/po details) that
     ...
     * related data, then from project property to get comp version id then to call getAssetByVersionId to get
     * assetDTO, please check create software contest to see what data need to be returned.
     * </p>
     * <p>
     * Update in v1.5.1: add parameter TCSubject which contains the security info for current user.
     * </p>
    ...
    /**
     * <p>
     * Gets the list of project and their permissions (TCSubject tcSubject,including permissions for the parent tc
     * project)
     * </p>
     * 
     * <p>
    ...
    /**
     * Marks 'ready for review' by the writer of the specs for specified contest. Persistence is updated, on update
     * the spec would appear as review opportunity on tc site.
     * <p>
     * Update in v1.5.1: add parameter TCSubject which contains the security info for current user.
     * </p>
     * 
     ...
     * (TCSubject tcSubject,if any) is notified about the updates.
     * <p>
     * Update in v1.5.1: add parameter TCSubject which contains the security info for current user.
     * </p>
     * 
     ...
     * 
     * @throws ContestServiceException
     *             if any unexpected error occurs in the underlying services
     * 
     * @since 1.4
     */
     ...
     * @since 1.4
     */
    // public ScorecardReviewData getScorecardAndReview(TCSubject tcSubject,long projectId) throws
    // ContestServiceException;

    /**
     * This method uploads a mock file to the corresponding specification review project of the specified project id,
     * so that it can continue with review. Regular submission or final fix will be uploaded according to the open
     * phase.
     * <p>
     * Update in v1.5.1: add parameter TCSubject which contains the security info for current user.
     * </p>
     ...
     * 
     * @throws ContestServiceException
     *             if any unexpected error occurs in the underlying services, if the associated specification review
     *             project id cannot be found or if neither submission or final fixes phase are open.
     * 
     * @since 1.4
     */
