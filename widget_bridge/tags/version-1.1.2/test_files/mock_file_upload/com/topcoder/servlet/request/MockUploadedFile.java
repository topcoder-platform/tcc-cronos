...
/**
 * <p>
 * A mock class which extends the <code>UploadedFile</code> abstract class for
 * testing.
 * </p>
 * 
 * @author PE
...
public class MockUploadedFile extends UploadedFile {
     ...
     * 
     * @param fileId
     *            the unique id that identifies the uploaded file.
     * @param contentType
    ...
    public InputStream getInputStream() {
        return new java.io.ByteArrayInputStream(new byte[] {});
    }
}
