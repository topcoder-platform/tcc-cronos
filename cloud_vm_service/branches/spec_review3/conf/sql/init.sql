insert into vm_account (vm_account_id, aws_access_key_id, aws_security_access_key, user_id, create_date, modify_date)
  values (1, 'AKIAIAUCU32DF6IIQJVA', 'DND8RfLk3NBnF5o4RkhjPmUAKP0iq9yxG5iYDmaD', 132456, current, current);
insert into vm_account (vm_account_id, aws_access_key_id, aws_security_access_key, user_id, create_date, modify_date)
  values (2, 'AKIAIAUCU32DF6IIQJVA', 'DND8RfLk3NBnF5o4RkhjPmUAKP0iq9yxG5iYDmaD', 124764, current, current);
...
insert into vm_image (vm_image_id, aws_image_id, vm_security_group_id, vm_instance_type_id, vm_availability_zone_id, vm_key_pair_id, create_date, modify_date)
  values (1, 'ami-3c47a355', 1, 1, 1, 1, current, current);
insert into vm_image (vm_image_id, aws_image_id, vm_security_group_id, vm_instance_type_id, vm_availability_zone_id, vm_key_pair_id, create_date, modify_date)
  values (2, 'ami-235fba4a', 1, 2, 3, 1, current, current);
insert into vm_image (vm_image_id, aws_image_id, vm_security_group_id, vm_instance_type_id, vm_availability_zone_id, vm_key_pair_id, create_date, modify_date)
  values (3, 'ami-3c47a355', 1, 7, 1, 1, current, current);
insert into vm_image (vm_image_id, aws_image_id, vm_security_group_id, vm_instance_type_id, vm_availability_zone_id, vm_key_pair_id, create_date, modify_date)
  values (4, 'ami-3c47a355', 1, 1, 3, 1, current, current);
...
insert into user_security_key (user_id, security_key, security_key_type_id) values (124916, 'some key data', 1); 