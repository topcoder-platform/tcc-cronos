 ...
 * bound to non-MockContestManager instance.
 * </p>
 *
 * @author TCSDEVELOPER
 * @version 1.0
 */
public class InvalidObjectContextFactory implements InitialContextFactory {
    /**
    ...
    public Context getInitialContext(Hashtable<?, ?> environment)
        ...
        Context ctx = new MockInitialContext();
        ctx.bind(CockpitPhaseManagerTest.CONTEST_MANAGER_JNDI_NAME, null);
