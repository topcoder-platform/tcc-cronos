...
public class MockContestManager implements ContestManager {
     ...
     * Not implemented.
     *
     * @param contestConfig contest config.
     * @return none
     * @throws ContestManagementException never thrown.
     ...
     * Not implemented.
     *
     * @param contestChannel contest channel.
     * @return none
     * @throws ContestManagementException never thrown
     */
     ...
     * @throws ContestManagementException if any error occurs while adding contest status.
     */
     ...
     * Not implemented.
     *
     * @param contestTypeConfig contest type config.
     * @return none.
     * @throws ContestManagementException never thrown.
     * @throws UnsupportedOperationException always thrown.
     */
     ...
     * @throws ContestManagementException if any error occurs while creating the contest.
     */
     ...
     * @throws ContestManagementException if any error occurs while retrieving all contest statuses.
     */
     ...
     * Not implemented.
     *
     * @param contestConfigId contest config id.
     * @return none
     * @throws ContestManagementException never thrown.
     * @throws UnsupportedOperationException always thrown.
     */
     ...
     * Not implemented.
     *
     * @param contestChannelId contest channel id.
     * @return none
     * @throws ContestManagementException never thrown.
     * @throws UnsupportedOperationException always thrown.
     */
     ...
     *
     * @param contestStatusId contest status id.
     ...
     * Not implemented.
     *
     * @param contestTypeConfigId contest type config id.
     * @return none
     * @throws ContestManagementException never thrown.
     * @throws UnsupportedOperationException always thrown.
     */
     ...
     * @throws ContestManagementException if any error occurs while updating contest status.
     */
    public void updateContestStatus(long contestId, long newStatusId)
        throws ContestManagementException {
        if (!contests.containsKey(contestId)) {
            throw new EntityNotFoundException("No contest found for id '" + contestId + "'");
        }

        if (!contestStatuses.containsKey(newStatusId)) {
            throw new EntityNotFoundException("No contest status found for id '" + newStatusId + "'");
        }
