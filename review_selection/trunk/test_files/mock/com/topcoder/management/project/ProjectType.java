 ...
 * </p>
 *
 * @author tuenm, iamajia, TCSDEVELOPER
 * @version 1.1
 * @since 1.0
 */
public class ProjectType implements Serializable {
    ...
    /**
     * <p>A <code>boolean</code> flag indicating whether this project type is generic or not. The generic project types
     * can not be used for project creation.</p>
     *
     * @since 1.1
     */
    private boolean generic = false;

    private int reviewSystemVersion;
     ...
     *             empty string.
     */
    public ProjectType(long id, String name, int version) {
     ...
     */
    public ProjectType(long id, String name, String description, int version) {
        setId(id);
        setName(name);
    ...
    /**
     */
    public void setReviewSystemVersion(int version) {
        this.reviewSystemVersion = version;
    }

    /**
     */
    public int getReviewSystemVersion() {
    ...
    /**
     * <p>Checks whether this project type is generic or not. The generic project types can not be used for project
     * creation.</p>
     *
    ...
    /**
     * <p>Sets the flag indicating whether this project type is generic or not. The generic project types can not be
     * used for project creation.</p>
     *
