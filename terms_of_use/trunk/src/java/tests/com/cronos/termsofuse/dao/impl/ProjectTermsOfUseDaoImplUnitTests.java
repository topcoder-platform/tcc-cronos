...
public class ProjectTermsOfUseDaoImplUnitTests extends BaseUnitTests {
     ...
     * boolean includeNonMemberAgreeable)</code>.<br>
     * The result should be correct.
     * </p>
     *
     * @throws Exception
    ...
    public void test_getTermsOfUse_1() throws Exception {
        Map<Integer, List<TermsOfUse>> res = instance.getTermsOfUse(1, new int[] {1, 2}, true);
    ...
    public void test_getTermsOfUse_2() throws Exception {
        Map<Integer, List<TermsOfUse>> res = instance.getTermsOfUse(1, new int[] {1, 2}, false);
    ...
    public void test_getTermsOfUse_3() throws Exception {
        Map<Integer, List<TermsOfUse>> res = instance.getTermsOfUse(Integer.MAX_VALUE, new int[] {1, 2}, true);
     ...
     * boolean includeNonMemberAgreeable)</code> with resourceRoleIds is <code>null</code>.<br>
     * <code>IllegalArgumentException</code> is expected.
     * </p>
     *
     * @throws Exception
    ...
    public void test_getTermsOfUse_resourceRoleIdsNull() throws Exception {
        instance.getTermsOfUse(projectId, null, true);
    }

    /**
     * <p>
     * Failure test for the method <code>getTermsOfUse(int projectId, int[] resourceRoleIds,
     * boolean includeNonMemberAgreeable)</code> with resourceRoleIds is empty.<br>
     * <code>IllegalArgumentException</code> is expected.
     * </p>
     *
     * @throws Exception
    ...
    public void test_getTermsOfUse_resourceRoleIdsEmpty() throws Exception {
        instance.getTermsOfUse(projectId, new int[0], true);
    }

    /**
     * <p>
     * Failure test for the method <code>getTermsOfUse(int projectId, int[] resourceRoleIds,
     * boolean includeNonMemberAgreeable)</code> with a persistence error has occurred.<br>
     * <code>TermsOfUsePersistenceException</code> is expected.
     * </p>
     *
     * @throws Exception
    ...
    public void test_getTermsOfUse_PersistenceError() throws Exception {
        ...
        instance.getTermsOfUse(1, new int[] {1, 2}, true);
    }
