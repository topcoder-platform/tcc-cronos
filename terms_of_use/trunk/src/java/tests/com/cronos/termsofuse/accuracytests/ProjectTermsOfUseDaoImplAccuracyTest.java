...
public class ProjectTermsOfUseDaoImplAccuracyTest extends BaseAccuracyTest {
    ...
    public void testGetTermsOfUse1() throws Exception {
        ...
        Map<Integer, List<TermsOfUse>> actual = dao.getTermsOfUse(projectId, resourceRoleIds, null);
        ...
        for (int i = 0; i < actual.get(0).size(); i++) {
            assertEquals("Correct terms of use should be placed on position " + i + " in resulted list.", i + 1, actual
                    .get(0).get(i).getTermsOfUseId());
        }
        ...
        assertTrue("Group 1 should have 1 terms of use.",
                compareTermsOfUse(createTermsOfUse(1, 1, "t1", "url1", agreeabilityType), actual.get(1).get(0)));
    }
    ...
    public void testGetTermsOfUse2() throws Exception {
        ...
        assertTrue("Group 2 should have 1 terms of use.",
                compareTermsOfUse(createTermsOfUse(2, 1, "t2", "url2", noagreeabilityType), actual.get(2).get(0)));
    }
    ...
    public void testGetTermsOfUse_Agreeable() throws Exception {
        ...
        projectId = 1;
        int[] resourceRoleIds = new int[] {1, 2 };
        Map<Integer, List<TermsOfUse>> actual = dao.getTermsOfUse(projectId, resourceRoleIds, new int[] {2 });
        assertEquals("One group should present in mapping.", 1, actual.size());
        assertEquals("Group 1 should have 1 terms of use.", 1, actual.get(1).size());
        TermsOfUseAgreeabilityType agreeabilityType = createTermsOfUseAgreeabilityType(2, "Electronically-agreeable",
                "Electronically-agreeable");
    ...
    public void testGetTermsOfUse_NonAgreeable() throws Exception {
        // retrieve only Non-agreeable terms of use for each group of project 1 and resource roles 1,2
        projectId = 1;
        int[] resourceRoleIds = new int[] {1, 2 };
        Map<Integer, List<TermsOfUse>> actual = dao.getTermsOfUse(projectId, resourceRoleIds, new int[] {1 });
