...
public class TermsOfUseUnitTests {
    ...
    public void testCtor() {
        ...
        assertFalse("'electronicallySignable' should be correct.", instance.isElectronicallySignable());
        assertNull("'url' should be correct.", instance.getUrl());
        assertFalse("'memberAgreeable' should be correct.", instance.isMemberAgreeable());
    }
    ...
    /**
     * <p>
     * Accuracy test for the method <code>isElectronicallySignable()</code>.<br>
     * The value should be properly retrieved.
     * </p>
     */
    @Test
    public void test_isElectronicallySignable() {
        boolean value = true;
        instance.setElectronicallySignable(value);

        assertTrue("'isElectronicallySignable' should be correct.", instance.isElectronicallySignable());
    }

    /**
     * <p>
     * Accuracy test for the method <code>setElectronicallySignable(boolean electronicallySignable)</code>.<br>
     * The value should be properly set.
     * </p>
     */
    @Test
    public void test_setElectronicallySignable() {
        boolean value = true;
        instance.setElectronicallySignable(value);

        assertTrue("'setElectronicallySignable' should be correct.", (Boolean) TestsHelper.getField(instance,
    ...
    /**
     * <p>
     * Accuracy test for the method <code>isMemberAgreeable()</code>.<br>
     * The value should be properly retrieved.
     * </p>
     */
    @Test
    public void test_isMemberAgreeable() {
        boolean value = true;
        instance.setMemberAgreeable(value);

        assertTrue("'isMemberAgreeable' should be correct.", instance.isMemberAgreeable());
    }

    /**
     * <p>
     * Accuracy test for the method <code>setMemberAgreeable(boolean memberAgreeable)</code>.<br>
     * The value should be properly set.
     * </p>
     */
    @Test
    public void test_setMemberAgreeable() {
        boolean value = true;
        instance.setMemberAgreeable(value);

        assertTrue("'setMemberAgreeable' should be correct.", (Boolean) TestsHelper.getField(instance,
            "memberAgreeable"));
    }
}
