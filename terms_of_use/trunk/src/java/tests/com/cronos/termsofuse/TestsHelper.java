...
public class TestsHelper {
    ...
    public static void checkTermsOfUse(String method, TermsOfUse termsOfUse, Object[] values)
        ...
        assertEquals("'" + method + "' should be correct.",
            (Boolean) values[index++], termsOfUse.isElectronicallySignable());
        assertEquals("'" + method + "' should be correct.", (String) values[index++], termsOfUse.getUrl());
        assertEquals("'" + method + "' should be correct.", (Boolean) values[index], termsOfUse.isMemberAgreeable());
    }
    ...
    public static void loadDB(Connection connection) throws Exception {
        ...
        termsOfUseDao.createTermsOfUse(getTermsOfUse(1, "t1", false, "url1", true), "text1");
        termsOfUseDao.createTermsOfUse(getTermsOfUse(1, "t2", true, "url2", false), "text2");
        termsOfUseDao.createTermsOfUse(getTermsOfUse(1, "t3", true, "url3", false), "text3");
        termsOfUseDao.createTermsOfUse(getTermsOfUse(2, "t4", false, "url4", true), "text4");
     ...
     */
    private static TermsOfUse getTermsOfUse(int termsOfUseTypeId, String title, boolean electronicallySignable,
        ...
        terms.setElectronicallySignable(electronicallySignable);
        terms.setUrl(url);
        terms.setMemberAgreeable(memberAgreeable);
