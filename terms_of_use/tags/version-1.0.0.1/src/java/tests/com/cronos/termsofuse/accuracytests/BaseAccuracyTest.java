...
public class BaseAccuracyTest extends TestCase {
     ...
     * </p>
     */
    private static final String INSERT_TERMS_OF_USE_QUERY =
            "INSERT INTO terms_of_use (terms_of_use_id, terms_text, terms_of_use_type_id, title, "
                    + "electronically_signable, url, member_agreeable) VALUES (?, ?, ?, ?, ?, ?, ?)";
    ...
    private static void initDatabase() throws Exception {
        ...
        insertTermsOfUse(createTermsOfUse(1L, 1, "t1", false, "url1", true), "text1");
        insertTermsOfUse(createTermsOfUse(2L, 1, "t2", true, "url2", false), "text2");
        insertTermsOfUse(createTermsOfUse(3L, 1, "t3", true, "url3", false), "text3");
        insertTermsOfUse(createTermsOfUse(4L, 2, "t4", false, "url4", true), "text4");
     ...
     * </p>
     * @param termsOfUse the terms of use to insert
     * @param text the terms text
     * @throws Exception if any error occurs
     */
    private static void insertTermsOfUse(TermsOfUse termsOfUse, String text) throws Exception {
        ...
        try {
            ...
            ps.setBoolean(5, termsOfUse.isElectronicallySignable());
            ps.setString(6, termsOfUse.getUrl());
            ps.setBoolean(7, termsOfUse.isMemberAgreeable());
            ps.executeUpdate();
        } finally {
     ...
     * @param electronicallySignable the electronically signable flag
     * @param url the url
     * @param memberAgreeable the member agreeable flag
     * @return created TermsOfUse instance with given values
     */
    protected static TermsOfUse createTermsOfUse(long id, int typeId, String title, boolean electronicallySignable,
            String url, boolean memberAgreeable) {
        TermsOfUse termsOfUse = new TermsOfUse();
        termsOfUse.setTermsOfUseId(id);
        termsOfUse.setTermsOfUseTypeId(typeId);
        termsOfUse.setTitle(title);
        termsOfUse.setUrl(url);
        termsOfUse.setElectronicallySignable(electronicallySignable);
        termsOfUse.setMemberAgreeable(memberAgreeable);
        return termsOfUse;
    }
     ...
     * </p>
     * @param filePath the file path of SQL scripts
     * @throws Exception if any error occurs
     */
    ...
    private static Connection getConnection() throws Exception {
        DBConnectionFactoryImpl dbConnectionFactory =
                new DBConnectionFactoryImpl(getConfiguration(TERMS_OF_USE_CONFIGURATION).getChild(
                        DB_CONNECTION_FACTORY_CONFIGURATION));
     ...
     * </p>
     * @param query the query to get row count
     ...
     * </p>
     * @param termsOfUse the terms of use to compare
     * @param otherTermsOfUse the terms of use to compare
     ...
     * </p>
     * @param type1 the terms of use type to compare
     * @param type2 the terms of use type to compare
