...
<div id="container">
    ...
    <div id="wrap">
        <div id="breadcrumb-admin">
            &raquo; Utilities &nbsp; &raquo; Create Ball Color &nbsp; <span class="active"> &raquo; Success &nbsp;</span>
        </div>
                ...
                <td>
                    <div id="table-form">
                        <table border="0" cellpadding="0" cellspacing="0" width="360">
                            ...
                            <tr>
                                <td>
                                    <a href="#">The new Ball color ${param['colorName']} has been created successfully</a>
                                </td>
                            </tr>
                        </table>
                    </div>
