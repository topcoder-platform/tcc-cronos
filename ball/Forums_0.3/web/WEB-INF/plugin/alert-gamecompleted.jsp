...
<head>
    <title>The Ball :: Game Completed</title>
...
<div id="containerPlugin">
    ...
    <div id="pluginTitle">
         <span class="fBold cRed">ERROR CODE: GAME ALREADY COMPLETED BY PLAYER</span>
    </div>

    <div id="wrapPlugin">
        <br/>
        You have already completed the requested game.
        <br/><br/>
    </div>
</div>
