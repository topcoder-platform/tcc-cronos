...
<head>
    <title>The Ball :: Puzzle Expired</title>
...
<div id="containerPlugin">
    ...
    <div id="pluginTitle">Sorry, the period for solving the puzzle has expired.</div>
    <div id="wrapPlugin">
                    ...
                    <table border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td width="645" class="link">
                                ...
                                <p align="center">You were not able to solve the puzzle within the time limit needed to
                                    win the Game.  But don’t worry, you can try your luck again by following the ball to
                                    its next home at:&nbsp; <br/>
                                    <strong>
