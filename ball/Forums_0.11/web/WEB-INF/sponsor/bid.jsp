...
<head>
    <title>The Ball :: Auctions :: Place a Bid</title>
...
<div id="wrap">
<h1><img src="${ctx}/i/h/title_bidonatimeslot.gif" alt="Bid on a Timeslot"/></h1>

<div id="breadcrumb">
    &raquo; 1. View Games with Available Timeslots &nbsp;
    <span class="active">&raquo; 2. Bid on a Timeslot</span> &nbsp;
    <span class="next">&raquo; 3. Bid Confirmation</span>
</div>
...
<div id="table-details" style="width:313px">
    <form action="${ctx}/server/sponsor/confirmBid.do" name="BidForm" id="BidForm" method="POST">
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="313">
            <tr>
                ...
                <th style="text-align:right; font-weight:normal;">Help</th>
            </tr>
            <dd:dropdownlist>
                ${auction:error('domainId', validationErrors)}
                <tr>
                    <td class="bold">Select a Website: </td>
                    <td>
                        <dd:dropdown id="sel0" classStyle="dropDown" prompt="Select Domain" name="domainId"
                                     data="${domains}"/>
                    </td>
                </tr>
                ${auction:error('imageId', validationErrors)}
                <tr>
                    <td class="bold">Select an Image: </td>
                    <td>
                        <dd:dropdown id="sel1" classStyle="dropDown" prompt="Select Image" name="imageId"
                                     data="${images}"/>
                    </td>
                </tr>
            </dd:dropdownlist>
            ...
            <tr>
                ...
                <td>
                    $<input name="maxBid" type="text" id="maxBid" class="inputBox" style="width:143px;" maxlength="9"
                           value="${param['maxBid']}" onkeypress="return acceptDigit(event);"/> &nbsp;
                    <span class="fItalic subcontent"><br/>
                        (min. $<fmt:formatNumber value="${auction:getMinimuAllowedBid(auction, leaders)}"
                                                 pattern="###0"/>)
                    </span>
                </td>
            </tr>
        ...
        <div class="buttons">
            <a href="#" title="Submit Bid" onclick="submitForm(document.BidForm);return false;">
