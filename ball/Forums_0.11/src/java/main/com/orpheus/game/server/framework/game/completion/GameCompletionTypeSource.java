 ...
 * @version 1.0
 */
public interface GameCompletionTypeSource {
     ...
     * @throws GameCompletionException if there is no bounce point calculator type mapped to specified ID or an unexpected
