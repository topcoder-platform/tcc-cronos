...
/**
 * <p>This interface defines the behavior of objects that represent the semantics of particular types of game
 * completions. Such a type acts like a mini-manager or factory for bounce point calculators represented by this type.
 * </p>
 *
 ...
 * @version 1.0
 */
public interface GameCompletionType {

    /**
     * <p>Gets the ID of this game completion type uniquelly identifying this type among other bounce point
