...
<head>
    <title>The Ball :: Puzzle Not Solved</title>
...
<div id="containerPlugin">
    ...
    <div id="pluginTitle">Sorry, you have not solved the puzzle.</div>
    <div id="wrapPlugin">
                    ...
                    <table border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td width="645" class="link">
                                ...
                                <p align="center">Sorry, you were not able to solve the puzzle successfully and win the
                                    Game. But don’t worry, you can try your luck again by following the ball to its next
                                    home at:&nbsp; <br/>
                                    <strong>${nextDomain.domainName}&nbsp;</strong>
                                </p>
