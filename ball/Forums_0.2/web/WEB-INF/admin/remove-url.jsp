...
<head>
    <title>The Ball :: Remove Slot</title>
...
<div id="container">
    ...
    <span class="fBold">&nbsp;Are you sure you want to remove this URL?</span>

    <p align="center">
        <img border="0" src="${ctx}/i/b/btn_admin_ok.gif" width="26" height="15"
             onClick="window.open('${ctx}/server/admin/deleteSlot.do?gameId=${param['gameId']}&slotId=${param['slotId']}', 'Orpheus');window.close();"
             alt="Remove" style="cursor:pointer;"/>
