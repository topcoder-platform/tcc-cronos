...
/**
 * <p>A comparator tobe used for sorting the list of games listed by plugin <code>All Games</code> page by the values
 ...
 * @version 1.0
 */
public class AllGamesListSorter extends SortListListComparator implements Serializable {
