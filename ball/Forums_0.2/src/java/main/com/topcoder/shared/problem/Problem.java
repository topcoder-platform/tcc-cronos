...
public class Problem extends BaseElement implements Element, Serializable, CustomSerializable {
    ...
    /**
     * Returns the problem component considered the main component.  ie whose
     * getComponentTypeID() returns ProblemConstants.MAIN_COMPONENT
     *
     ...
     * @return the problem component at the given index or null if i doesn't exist
     *         (note: will throw an IndexOutOfBoundsException if < 0)
     */
     ...
     * (Simply if all the components are valid)
     *
    ...
    /**
     * Returns an XML representation of the problem
     * TODO: does anyone care this doesn't do anything?
     * @return blank string
     */
    public String toXML() {
