/*
 * SimpleCustomSerializerProvider
 * 
 * Created 10/20/2006
 */
...
/**
 * Simple CustomSerializerProvider implementation, it allows to register a 
 * CustomSerializer for a specific clazz.
 * 
 * @author Diego Belfer (mural)
 * @version $Id: SimpleCustomSerializerProvider.java,v 1.2 2006/12/01 17:56:55 thefaxman Exp $
 */
public class SimpleCustomSerializerProvider implements CustomSerializerProvider {
    ...
    /**
     * Register the <code>serializer</code> for the given class.<p>
     * If one serializer was already registered for the class, it will be
     * unregistered. 
     * 
     * 
