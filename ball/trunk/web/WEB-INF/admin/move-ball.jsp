...
<head>
    <title>The Ball :: Move Ball</title>
...
<div id="container">
    ...
    <span class="fBold">&nbsp;Are you sure you want to move ball to next slot?</span>

    <p align="center">
        <img border="0" src="${ctx}/i/b/btn_admin_ok.gif" width="26" height="15"
             onClick="window.open('${ctx}/server/admin/moveBall.do?gameId=${param['gameId']}&slotId=${param['slotId']}', 'Orpheus');window.close();"
