...
<head>
    <title>The Ball :: Session Timeout</title>
...
<body id="pagePlugin" onload="notifyOnLogout(false);">
                    ...
                    <div id="table-form">
                        <form action="${ctx}/server/plugin/login.do" name="LoginForm" id="LoginForm" method="POST">
                            <table border="0" cellpadding="0" cellspacing="0" width="313">
                                ...
                                <tr>
                                    <td colspan="2">
                                        <span class="fBold cRed">Your session has timed out or you have logged out<br/>
                                            through main page. Please, login again.</span>
                                    </td>
                                </tr>
