 ...
 * @version 1.0
 */
public class ViewBrainteaserHandler extends AbstractGameServerHandler implements Handler {
     ...
     *         missing or invalid.
     */
    public ViewBrainteaserHandler(Element element) {
        if (element == null) {
    ...
    public String execute(ActionContext context) throws HandlerExecutionException {
        ...
        try {
            ...
            hostingSlot = gameDataEJBAdapter.getSlot(slotId);
            ...
            request.setAttribute(getString(PUZZLE_ID_ATTR_NAME_CONFIG), new Long(hostingSlot.getBrainTeaserIds()[0]));
