...
<%  HashMap errors = (HashMap)request.getAttribute(BaseProcessor.ERRORS_KEY);
    ...
    Hashtable collapseReadPostTable = ForumsUtil.getCollapseReadPostTable(user, thread, lastReadDate);
...
<table cellpadding="0" cellspacing="0" class="rtTable" style="margin-bottom: 6px;">
      ...
      <%   double pct = ratingCount<=0 ? 0 : 100*(double)(posRatings)/(double)(ratingCount);
           ...
           if (collapseReadPostTable != null && ((Boolean)collapseReadPostTable.get(message)).booleanValue() == true) {
