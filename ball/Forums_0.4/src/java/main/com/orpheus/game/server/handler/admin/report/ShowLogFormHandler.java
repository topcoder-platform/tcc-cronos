...
/**
 * <p>A custom {@link Handler} implementation to be used for retrieving the data necessary to present the <code>View Log
 * Form</code> to administrator.</p>
 *
 * @author isv
 * @version 1.0
 */
public class ShowLogFormHandler extends AbstractGameServerHandler implements Handler {
    ...
    /**
     * <p>Constructs new <code>ShowLogFormHandler</code> instance initialized based on the configuration parameters
     ...
     *         missing or invalid.
     */
    public ShowLogFormHandler(Element element) {
        if (element == null) {
    ...
    public String execute(ActionContext context) throws HandlerExecutionException {
        ...
        try {
            ...
            request.setAttribute(getString(GAMES_ATTR_NAME_CONFIG), gameDataEJBAdapter.findGames(null, null));
            return null;
        } catch (Exception e) {
            throw new HandlerExecutionException("Could not prepare the View Log data", e);
        }
    }
}
