...
<!--
    ...
    function SwapImage5() {
        document.image5.src = "${ctx}/i/nav/public_forums_on.gif"
    }
    function SwapImage5Back() {
        document.image5.src = "${ctx}/i/nav/public_forums_off.gif"
    }
-->
</script>
        ...
        <li>
            <a href="${ctx}/forums" title="Forums">
                <c:if test="${subbar eq 'forums'}">
                    <img src="${ctx}/i/nav/public_forums_on.gif" name="image5" alt="Forums"
                         onMouseOver="SwapImage5()" onMouseOut="SwapImage5()"/>
                </c:if>
                <c:if test="${subbar ne 'forums'}">
                    <img src="${ctx}/i/nav/public_forums_off.gif" name="image5" border="0" alt="Forums"
                         onMouseOver="SwapImage5()" onMouseOut="SwapImage5Back()"/>
                </c:if>
            </a>
        </li>
        <li>
            <img src="${ctx}/i/nav/public_endbar.gif" alt="spacer"/>
        </li>
    </ul>
