 ...
 *
 * A CSharpCodeViewer object is used to syntax highlight code. To make use of this class, first set
 ...
 * input that has been tagged with [c#][/c#] tags.
 */
public class CSharpViewer {
    ...
    private static void loadCSharpKeywords() {
        // From MSDN: http://msdn.microsoft.com/library/default.asp?url=/library/en-us/csspec/html/CSharpSpecStart.asp
        String[] keywordsCSharp = { 
                ...
                "volatile",     "while"};
        for (int i=0; i<keywordsCSharp.length; i++) {
            reservedWords.put(keywordsCSharp[i], keywordsCSharp[i]);
        }
    }
}