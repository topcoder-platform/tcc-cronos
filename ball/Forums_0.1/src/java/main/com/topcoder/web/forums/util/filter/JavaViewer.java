 ...
 *
 * A JavaCodeViewer object is used to syntax highlight code. To make use of this class, first set
 ...
 * input that has been tagged with [java][/java] tags.
 */
public class JavaViewer {
    ...
    private static void loadJavaKeywords() {
