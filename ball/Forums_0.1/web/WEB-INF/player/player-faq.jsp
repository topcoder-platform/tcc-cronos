...
<head>
    <title>The Ball :: Player FAQ</title>
...
<div id="container">
    ...
    <div id="wrap">
        <h1><img src="${ctx}/i/h/title_playerfaq.gif" alt="My ames" width="109" height="20"/></h1>
        <ol>
        ...
        <ol>
            ...
            <li><a name="5"></a><span class="faq">Do I have to install a plug-in?</span><br/>
            ...
            <li><a name="6"></a>
                <span class="faq">Can I install the plug-in in more than one place, or play from two different computers?</span>
                <br/>
