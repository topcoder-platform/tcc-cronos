...
public class CalculationManager {
     ...
     */
    public float getScore(Scorecard scorecard, Review review) throws CalculationException {
        ...
        synchronized (scMatrix) {
            ...
            for (int i = 0; i < items.length; ++i) {
                ...
                // Evaluate the score.
                final float itemScore = calculator.evaluateItem(item, question);
            ...
            return (float) scMatrix.getMathMatrix().getWeightedScore();
        }
    }
    ...
    private static Object createInstance(Class theClass, String namespace) throws ConfigurationException {
        ...
        try {
            if (namespace == null) {
                ctor = theClass.getConstructor(null);
                ctorArgs = null;
            } else {
