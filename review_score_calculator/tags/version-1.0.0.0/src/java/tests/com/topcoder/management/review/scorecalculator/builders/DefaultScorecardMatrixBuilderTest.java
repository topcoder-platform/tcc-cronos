...
public class DefaultScorecardMatrixBuilderTest extends TestCase {
    ...
    /**
     * Ensures that the buildScorecardMatrix method throws a ScorecardStructureException when given a scorecard
     * with a zero weighted group.
     */
    public void testBuildThrowsOnZeroWeightedGroup() {
        group.resetWeight();
        checkBuildThrowsSSE("the scorecard has a group with no weight.");
    }

   /**
    * Ensures that the buildScorecardMatrix method throws a ScorecardStructureException when given a scorecard
    * with a zero weighted section.
    */
    public void testBuildThrowsOnZeroWeightedSection() {
        section.resetWeight();
        checkBuildThrowsSSE("the scorecard has a group with a section with no weight.");
    }

    /**
     * Ensures that the buildScorecardMatrix method throws a ScorecardStructureException when given a scorecard
     * with a zero weighted question.
     */
    public void testBuildThrowsOnZeroWeightedQuestion() {
        question.resetWeight();
        checkBuildThrowsSSE("the scorecard has a group with a section with a question with no weight.");
    }
    ...
    /**
     * Ensures that the buildScorecardMatrix method throws a ScorecardStructureException when given a scorecard
     * with a question with an uninitialized question id.
     */
    public void testBuildThrowsOnNoQuestionId() {
        question.resetId();
        checkBuildThrowsSSE("the scorecard has a group with a section with a question with no id.");
    }
