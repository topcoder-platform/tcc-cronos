...
public class CalculationManagerGetScoreTest extends TestCase {
    ...
    /**
     * Ensures that the getScore method throws a ScorecardStructureException when given a scorecard with an
     * uninitialized identifier.
     */
    public void testGetScoreThrowsOnUninitializedScorecardIdWithCache() {
        scorecard.resetId();
        checkGetScoreThrowsSSE("a scorecard with an uninitialized id.");
    }
    ...
    /**
     * Ensures that the getScore method throws a ReviewStructureException when given a review, whose number of
     * items is less than the number of scorecard questions.
     */
    public void testGetScoreThrowsOnReviewHasTooLittleItems() {
        Question question2 = new Question();
        question2.setDescription("How are you?");
        question2.setId(2);
        question2.setWeight(100);
        question2.setQuestionType(questionType);

        section.addQuestion(question2);

        checkGetScoreThrowsRSE("a review with too few items.");
    }

    /**
     * Ensures that the getScore method throws a ReviewStructureException when given a review, whose number of
     * items is greater than the number of scorecard questions.
     */
    public void testGetScoreThrowsOnReviewHasTooManyItems() {
        Item item2 = new Item();
        item2.setAnswer("3/4");
        item2.setQuestion(2);
        ...
        checkGetScoreThrowsRSE("a review with too many items.");
    }

    /**
     * Ensures that the getScore method throws a ReviewStructureException when given a review that contains
     * an item without an initialized question.
     */
    public void testGetScoreThrowsOnReviewItemHasNoQuestion() {
        item.resetQuestion();
        checkGetScoreThrowsRSE("a review that has an item with no question id set.");
    }

    /**
     * Ensures that the getScore method throws a ReviewStructureException when given a review that contains an item
     * with an initialized question that doesn't exist in the scorecard.
     */
    public void testGetScoreThrowsOnReviewItemHasNoExistQuestion() {
        item.setQuestion(255);
        checkGetScoreThrowsRSE("a review that has an item with a question id that does not exist in the scorecard.");
    }
    ...
    /**
     * Ensures that the getScore method throws a ReviewStructureException when given a review that contains an
     * item with an uninitialized question type id.
     */
    public void testGetScoreThrowsOnReviewItemHasUninitializedQuestionTypeId() {
        questionType.resetId();
        checkGetScoreThrowsRSE("a review that has an item with a question whose type id is uninitailized.");
    }
