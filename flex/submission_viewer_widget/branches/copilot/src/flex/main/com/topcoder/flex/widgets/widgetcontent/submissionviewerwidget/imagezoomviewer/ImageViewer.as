package com.topcoder.flex.widgets.widgetcontent.submissionviewerwidget.imagezoomviewer
{
	import com.topcoder.flex.widgets.widgetcontent.submissionviewerwidget.imagezoomviewer.modes.PanZoomCommandMode;
    ...
    public class ImageViewer extends UIComponent
    {
        ...
        private var _loadProgressMeter:int = 0;
        private var _maxBytes:int = 5 * 1024 * 1024 * 8; // 5 MB  
        ...
        */         
        ...
        {
        	trace("Loading image: " + value);
            // setting imageURL triggers loading sequence        
            if (value == _imageURL)
                return;
                
            if (_progressSWF && _progressSWF.parent) {
            	removeChild(_progressSWF);
            }
            
            if (_percentLoadedLabel && _percentLoadedLabel.parent) {
            	removeChild(_percentLoadedLabel);
            }
            
            _loadProgressMeter = 0;
            _bitmap = null;
        ...
        */
        ...
        private function formatUI():void
        {
            ...
            _percentLoadedLabel.text = "Loading image..."
            _percentLoadedLabel.visible = true;
        ...
        */
        ...
        private function handleLoadComplete(e:Event):void
        {
            ...
            if (_progressSWF.parent) {
            	removeChild(_progressSWF);
            }
            
            if (_percentLoadedLabel.parent) {
            	removeChild(_percentLoadedLabel);
            }
