package com.topcoder.flex.widgets.widgetcontent.submissionviewerwidget.imagezoomviewer.utils
{
	...
	public class ContentRectangle extends Rectangle
	{
		...
		private function fitToRectangle(rectangle:Rectangle):void
		{
			...
			trace("Scale Ratio X: " + _scaleRatioX);
			trace("Scale Ratio Y: " + _scaleRatioY);
