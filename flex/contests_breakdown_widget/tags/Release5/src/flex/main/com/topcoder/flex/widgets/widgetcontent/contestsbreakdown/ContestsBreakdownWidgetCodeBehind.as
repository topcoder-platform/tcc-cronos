...
package com.topcoder.flex.widgets.widgetcontent.contestsbreakdown {
    ...
    /**
     * <p>
     * This is the code behind script part for the pie chart widget. It implements the IWidget interface.
     * It extends from the Box.
     * </p>
     ...
     * @version 1.0
     */
     public class ContestsBreakdownWidgetCodeBehind extends Box implements IWidget {
        /**
	...
	private var _allowclose:Boolean=true;
         ...
         */
        public function ContestsBreakdownWidgetCodeBehind() {
            super();            
        }
        /**
        ...
        /**
         * The pie chart contents.
         */
        [Bindable]public function get chartData():ArrayCollection {
        ...
        public function reload():void {
            ...
            var temp:ArrayCollection = new ArrayCollection(this._chartData.source);
            this._chartData = temp;
        }
