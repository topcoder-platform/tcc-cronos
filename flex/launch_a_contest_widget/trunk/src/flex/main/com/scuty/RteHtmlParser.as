package com.scuty
{
	...
	// from http://blog.flashweb.org/archives/7
	public class RteHtmlParser
	{
		...
		private function set_new_name(xml:XML):XML
		{
			...
			// set new UL
			if (SET_UL.toLocaleUpperCase() != 'UL' && SET_UL != null) {
			...
			// set new BR
			if (SET_BR.toLocaleUpperCase() != 'BR' && SET_BR != null) {
		...
		private function manage_space(node:XMLNode):XMLNode
		{
			...
			{
				if (n.nodeType == 3) n.nodeValue = escape(n.nodeValue);
