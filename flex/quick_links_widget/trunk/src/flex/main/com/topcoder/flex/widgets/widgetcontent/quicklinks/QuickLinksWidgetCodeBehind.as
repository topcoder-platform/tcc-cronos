 ...
 */
package com.topcoder.flex.widgets.widgetcontent.quicklinks {
    ...
    /**
     * <p>
     * This is the code behind script part for the quick links widget. It implements the IWidget interface.
     ...
     * @version 1.0
     */
     public class QuickLinksWidgetCodeBehind extends Box implements IWidget {
        /**
	...
	private var _allowclose:Boolean=true;
        ...
        /**
         * QuickLinksWidgetCodeBehind constructor.
         */
        public function QuickLinksWidgetCodeBehind() {
            super();            
        }
        /**
