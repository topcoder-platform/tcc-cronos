package peekpanel
{
    ...
    */
    ...
    extends Canvas
    {
        ...
        private var dragVector:Vector2 = null;
        ...
        private var foldVector:Vector2 = null;
        ...
        */
        ...
        private function updateFoldMeasurements():void
        {
            ...
            dragVector = new Vector2(peekStartPosition, peekCurrentPosition);
        ...
        */
        ...
        {
            var tempVector:Vector2 = dragVector.clone();
            tempVector.length /= 2;
            var startToCurrentCenter:Point = tempVector.p1.clone();
            var centerToGrab:Vector2 = new Vector2(startToCurrentCenter, peekStartPosition);
        ...
        private function getTopPoly():Array
        {
            ...
            var testVector:Vector2 = new Vector2(cPoints[0], cPoints[1]);
            switch (foldCorner)
            {
                case (FOLD_TOP_LEFT):
                {
        ...
        private function getVectorIntersects(angleVector:Vector2):Array
        {
