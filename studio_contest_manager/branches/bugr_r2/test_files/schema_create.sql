...
create table contest_detailed_status_relation 
(
from_contest_status_id decimal(3,0) not null ,
to_contest_status_id decimal(3,0) not null ,
primary key (from_contest_status_id,to_contest_status_id) constraint pk_contest_detailed_status_relation
);
...
alter table image_type_lu add constraint primary key
(image_type_id)
