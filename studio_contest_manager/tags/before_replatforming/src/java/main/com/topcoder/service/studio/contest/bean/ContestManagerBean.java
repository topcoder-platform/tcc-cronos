...
public class ContestManagerBean implements ContestManagerRemote, ContestManagerLocal {
    ...
    public List<SimplePipelineData> getSimplePipelineData(long userId, Date startDate, Date endDate,
        ...
        try {
            ...
            sb.append("             and cfg.contest_id = c.contest_id), 0) ");
            sb.append("     else ");
            sb.append("         nvl((select nvl(sum(nvl(pr.amount, 0)), 0) ");
            ...
            sb.append("             and cc.contest_id = c.contest_id), 0) + ");
            sb.append("         nvl((select nvl( sum(cast(m.amount*number_of_submissions as DECIMAL(10,2))), 0) ");
            ...
            sb.append("             where  cc.contest_id = c.contest_id), 0)  + ");
            sb.append("        nvl((select (cast(nvl(property_value, '0') as DECIMAL(10,2))) ");
            sb.append("             from contest_config cfg, contest cc   ");
            sb.append("             where cfg.contest_id = cc.contest_id and property_id = 24 ");
            sb.append("             and cfg.contest_id = c.contest_id), 0) ");
