...
/**
 * <p>
 * This bean class implements the <code>ContestManagerLocal</code> and <code>ContestManagerRemote</code>
 * interfaces. It is a stateless session bean with @Stateless annotation. It would simply use the JPA
 * to manage the entities in the persistence. It uses contains to maintain the transaction issues.
 * </p>
 *
 * <p>
 * It should have annotations:<br/>
 * 1. @Stateless<br/>
 * 2. @TransactionManagement(TransactionManagementType.CONTAINER)<br/>
 * 3. @DeclareRoles("Administrator")<br/>
 * </p>
 *
 * <p>
 * And all public methods in this bean should have the following annotations:<br/>
 * 1. @PermitAll   -- indicating only "Administrator" role is allowed to perform the operation.<br/>
 * 2. @TransactionAttribute(TransactionAttributeType.REQUIRED) -- indicating the transaction is required.
 * </p>
 *
 * <p>
 ...
 * by EJB container. They would be never be changed afterwards. So they won't affect the thread-safety of
 * this class when its EJB methods are called. So this class can be used thread-safely in EJB container.
 * </p>
 *
...
public class ContestManagerBean implements ContestManagerRemote,
     ...
     * It is marked with @Resource annotation. It's non-null after injected when this bean is instantiated.
     * And its reference is not changed afterwards. It is used in the initialize method to lookup JNDI
     * resources.
     * </p>
     */
    @Resource
    ...
    /**
     * <p>
     * This field represent the default document path id, it is used to retrieve the <code>FilePath</code>
     * object to set to the added document if its path is not set. It is initialized in the initialize
     * method, and never changed afterwards. It  can be any long value. It must be non-null after set.
     * </p>
     */
     ...
     * <code>SessionContext</code>. It is initialized in the <code>initialize</code> method, and never
     * changed afterwards. It must be non-null, non-empty string.
     * </p>
     */
     ...
     * in the initialize method, and never changed afterwards. It can be null, and if so, logging is disabled.
     * </p>
     */
    private Log logger;
    ...
    /**
     * <p>
     * This field represents the <code>DocumentContentManager</code> object to manage the document content.
     * It is initialized in the <code>initialize</code> method, and never changed afterwards.
     * It must be non-null after set.
     * </p>
     */
    ...
    /**
     * <p>
     * This field represents the id of contest status indicating the contest is active. It is initialized
     * in the <code>initialize</code> method, and never changed afterwards. It  can be any long value.
     * It must be non-null after set.
     * </p>
     */
     ...
     * This method should be marked with @PostConstruct annotation. This method will
     * load the unitName and other parameters from the sessionContext via the lookup method.
     * </p>
     *
    ...
    private void initialize() {
        ...
        String documentManagerClassName = getStringParameter("documentContentManagerClassName",
                true, false);

        String attributeKeys = getStringParameter("documentContentManagerAttributeKeys",
                true, false);
        ...
        try {
            ...
            throw new ContestConfigurationException("There are security problem to access the constructor.",
                e);
        } catch (InstantiationException e) {
            throw new ContestConfigurationException("The class is a abstract class.",
                e);
        } catch (IllegalAccessException e) {
            throw new ContestConfigurationException("Access control fails in the constructor.",
                e);
        } catch (InvocationTargetException e) {
            throw new ContestConfigurationException("Error occurs when calling the constructor.",
                e);
     ...
     * @param required if it's true, the parameter should be present
     * @param canEmpty if it's false, the parameter should not be empty string
     * @return the parameter value
     *
     * @throws ContestConfigurationException
     *         if required is true and the parameter is missing,
     *         or if the parameter isn't a String value,
     *         or if canEmpty is false and the parameter is a empty string.
     */
     ...
     * @return the parameter value
     *
     * @throws ContestConfigurationException if the parameter is missing or it isn't a Long value.
     */
    ...
    /**
     * <p>
     * Gets contest by id, and return the retrieved contest. If the contest doesn't
    ...
    /**
     * <p>
     * Gets projects' contests by the project id. A list of contests associated with
     * the given tcDirectProjectId should be returned. If there is no such contests,
    ...
    public List<Contest> getContestsForProject(long tcDirectProjectId)
        ...
        try {
            ...
            Query query = em.createQuery(
                    "select c from Contest c where c.tcDirectProjectId = :tcDirectProjectId");
    ...
    public void updateContest(Contest contest)
        ...
        try {
            ...
            if (result.getStatus().getContestStatusId()
                          .equals(activeContestStatusId)) {
                ...
                if ((contest.getContestType() == null)
                    ...
                    throw wrapContestManagementException(
                        "The contest type doesn't match.");
                }

                if (!contest.getCreatedUser().equals(result.getCreatedUser())) {
                    throw wrapContestManagementException(
                        "The created user doesn't match.");
                }
                ...
                if (!result.getStartDate().equals(contest.getStartDate())) {
                    throw wrapContestManagementException(
                        "The start date doesn't match.");
                }

                if ((contest.getStatus() == null)
                    || !result.getStatus().getContestStatusId()
                                   .equals(contest.getStatus().getContestStatusId())) {
                    throw wrapContestManagementException(
     ...
     * @throws ContestManagementException if two sets don't match
     */
    ...
    public void updateContestStatus(long contestId, long newStatusId)
        ...
        try {
            ...
            if (contestStatus == null) {
                throw wrapEntityNotFoundException(
                    "The contest status with id '" + newStatusId + "' doesn't exist.");
            }
            ...
            if (status == null) {
                throw wrapContestManagementException(
                    "The contest's status should not be null.");
            }

            if (status.getStatuses() == null) {
                throw wrapContestManagementException(
                    "The next statuses list should not be null.");
            }
    ...
    public long getClientForContest(long contestId)
        ...
        try {
            ...
            if (project == null) {
                throw wrapEntityNotFoundException(
                    "The project with id '" + contest.getTcDirectProjectId() + "' doesn't exist.");
            }
    ...
    /**
     * <p>Updates the contest status.</p>
     *
    ...
    public void updateContestStatus(ContestStatus contestStatus)
        ...
        try {
            ...
            if ((contestStatus.getContestStatusId() == null) || (em.find(ContestStatus.class,
                        contestStatus.getContestStatusId()) == null)) {
                throw wrapEntityNotFoundException(
                    "The contest status with id '" + contestStatus.getContestStatusId() + "' doesn't exist.");
            }
    ...
    /**
     * <p>
     * Removes contest status, return true if the contest status exists and removed
    ...
    public boolean removeContestStatus(long contestStatusId)
        ...
        try {
            ...
            ContestStatus status = em.find(ContestStatus.class,
     ...
     * @throws EntityAlreadyExistsException if the document already exists in the persistence.
     * @throws ContestManagementException if any other error occurs.
     */
    @PermitAll
    @TransactionAttribute(TransactionAttributeType.REQUIRED)
    public Document addDocument(Document document)
        ...
        try {
            ...
            if (document.getPath() == null) {
                ...
                if (docPath == null) {
                    throw wrapContestManagementException(
                        "The file path with specified defaultDocumentPathId doesn't exist.");
                }
    ...
    /**
     * <p>Updates the specified document.</p>
     *
    ...
    public void updateDocument(Document document)
        ...
        try {
            ...
            if ((document.getDocumentId() == null)
                || (em.find(Document.class, document.getDocumentId()) == null)) {
                throw wrapEntityNotFoundException(
                    "The document with id '" + document.getDocumentId() + "' doesn't exist.");
            }
    ...
    /**
     * <p>
     * Removes the specified document, return true if the document exists and removed
     * successfully, return false if it doesn't exist.
     * </p>
     *
     * @param documentId the document id
    ...
    public ContestChannel addContestChannel(ContestChannel contestChannel)
        ...
        try {
            ...
            if ((contestChannel.getContestChannelId() != null)
                ...
                EntityAlreadyExistsException e = new EntityAlreadyExistsException(
                        "The contest channel with id '" + contestChannel.getContestChannelId() + "' already exists.");
                logException(e,
                    "The contest channel with id '" + contestChannel.getContestChannelId() + "' already exists.");
                sessionContext.setRollbackOnly();
    ...
    /**
     * <p>Updates the contest channel.</p>
     *
     * @param contestChannel the contest category to update.
     * @throws IllegalArgumentException if the arg is null.
    ...
    public void updateContestChannel(ContestChannel contestChannel)
        ...
        try {
            ...
            if ((contestChannel.getContestChannelId() == null)
                || (em.find(ContestChannel.class, contestChannel.getContestChannelId()) == null)) {
                throw wrapEntityNotFoundException(
                    "The contest channel with id '" + contestChannel.getContestChannelId() + "' doesn't exist.");
            }
    ...
    /**
     * <p>
     * Removes contest category, return true if the contest category exists and removed
     * successfully, return false if it doesn't exist.
     * </p>
     *
     ...
     * @throws ContestManagementException if fails to remove the contest category when it exists
     */
    @PermitAll
    @TransactionAttribute(TransactionAttributeType.REQUIRED)
    ...
    /**
     * <p>
     * Gets contest channel, and return the retrieved contest channel.
    ...
    public ContestConfig addConfig(ContestConfig contestConfig)
        ...
        try {
            ...
            if (em.find(ContestConfig.class, contestConfig.getContestConfigId()) != null ) {
                EntityAlreadyExistsException e = new EntityAlreadyExistsException(
                        "The contest config with id '" + contestConfig.getContestConfigId() + "' already exists.");
                logException(e,
                    "The contest config with id '" + contestConfig.getContestConfigId() + "' already exists.");
                sessionContext.setRollbackOnly();
    ...
    public void updateConfig(ContestConfig contestConfig)
        ...
        try {
            ...
            if ( em.find(ContestConfig.class, contestConfig.getContestConfigId()) == null ) {
                throw wrapEntityNotFoundException(
                    "The contest config with id '" + contestConfig.getContestConfigId() + "' doesn't exist");
            }
     ...
     * It will use DocumentContentManager to get document content. It can also return
     * empty array if the document content is empty.
     * </p>
     *
     *
     * @param documentId the document id
     ...
     * </p>
     *
     * @param document the document to get path
     ...
     * return false otherwise.  It will use DocumentContentManager to check document
     * content's existence.
     * </p>
     *
     * @param documentId the document id
    ...
    /**
     * <p>
     * Gets all contest categories to return.  If no contest category exists, return an empty list.
     * </p>
     *
    ...
    public ContestTypeConfig addContestTypeConfig(
        ContestTypeConfig contestTypeConfig) throws ContestManagementException {
        try {
            ...
            if (em.find(ContestTypeConfig.class, new Long(contestTypeConfig.getContestTypeConfigId())) != null) {
                EntityAlreadyExistsException e = new EntityAlreadyExistsException(
                    "The contest type config with id '"
                    + contestTypeConfig.getContestTypeConfigId() + "' already exists.");
                logException(e,
                    "The contest type config with id '"
                    + contestTypeConfig.getContestTypeConfigId() + "' already exists.");
                sessionContext.setRollbackOnly();
    ...
    public void updateContestTypeConfig(ContestTypeConfig contestTypeConfig)
        ...
        try {
            ...
            if (em.find(ContestTypeConfig.class, new Long(contestTypeConfig.getContestTypeConfigId())) == null) {
                throw wrapEntityNotFoundException(
                    "The contest type config with id '"
                    + contestTypeConfig.getContestTypeConfigId() + "' doesn't exist");
            }
    ...
    /**
     * <p>
     * Gets contest type configuration parameter by id, and return the retrieved contest type
     * configuration parameter. Return null if it doesn't exist.
     * </p>
     *
    ...
    public ContestTypeConfig getContestTypeConfig(long contestTypeConfigId)
        ...
        try {
            ...
            ContestTypeConfig contestTypeConfig = em.find(ContestTypeConfig.class,
                    new Long(contestTypeConfigId));
    ...
    /**
     * <p>
     * Removes prize from contest. Return true if the prize exists in the contest
     * and removed successfully, return false if it doesn't exist in contest.
     * </p>
     *
     * @param prizeId the prize id
    ...
    /**
     * <p>
     * Retrieves all prizes in the given contest to return. An empty list is returned
     * if there is no such prizes.
     * </p>
     *
     * @param contestId the contest id
    ...
    public List<Prize> getContestPrizes(long contestId)
        ...
        try {
            ...
            Query query = em.createQuery(
                    "select p from Prize p where :contest member of p.contests");
     ...
     * @throws ContestManagementException if fail to get the EntityManager from the sessionContext.
     */
    private EntityManager getEntityManager() throws ContestManagementException {
        try {
            ...
            throw wrapContestManagementException(e,
                "The jndi name for '" + unitName + "' should be EntityManager instance.");
        }
    }
     ...
     * </p>
     *
     * @param param1 the first parameter values
    ...
    /**
     * <p>
     * Creates an <code>EntityNotFoundException</code> with specified message, and
     * log the exception, set the sessionContext to correct state.
     * </p>
     *
    ...
    /**
     * <p>
     * Creates a <code>ContestManagementException</code> with inner exception and message.
     * It will log the exception, and set the sessionContext to rollback only.
     * </p>
     *
