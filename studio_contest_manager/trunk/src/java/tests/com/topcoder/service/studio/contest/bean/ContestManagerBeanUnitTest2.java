...
public class ContestManagerBeanUnitTest2 extends TestCase {
    ...
    public void testAddContestChannel() throws Exception {
        ...
        ContestChannel persist = entityManager.find(ContestChannel.class, channel.getContestChannelId());

        assertEquals("The channel should match.", "desc", persist.getDescription());
    }
     ...
     *
     * <p>
     * If entity manager is closed, <code>ContestManagementException</code> is expected.
     * </p>
     *
     * @throws Exception
     *             to JUnit.
     ...
     *
     * <p>
     * If any transaction exception occurs, <code>ContestManagementException</code> is expected.
     * </p>
     *
     * @throws Exception
     *             to JUnit.
    ...
    public void testUpdateContestChannel() throws Exception {
        ...
        assertEquals("The persistence should match.", "desc1", persist.getDescription());
    }
    ...
    public void testGetContestChannel() throws Exception {
        ...
        assertEquals("The persistence should match.", persist.getDescription(), channel.getDescription());
    }
     ...
     *
     * <p>
     * If the contest config already exists, <code>EntityAlreadyExistsException</code> is expected.
     * </p>
     *
     * @throws Exception
     *             to JUnit.
    ...
    public void testSaveDocumentContent_Failure1() throws Exception {
        SocketDocumentContentServer server = new SocketDocumentContentServer(40001, 0);
        server.start();
    ...
    public void testAddPrizeToContest() throws Exception {
        ...
        assertTrue("The prize should be added to the contest.", persist.getContests().contains(contest));
    }
     ...
     *
     * <p>
     * If the prize with specified id doesn't exist, <code>EntityNotFoundException</code> is expected.
     * </p>
     *
     * @throws Exception
     *             to JUnit.
     ...
     *
     * <p>
     * If the contest with specified id doesn't exist, <code>EntityNotFoundException</code> is expected.
     * </p>
     *
     * @throws Exception
     *             to JUnit.
     ...
     *
     * <p>
     * If entityManager is closed, <code>ContestManagementException</code> is expected.
     * </p>
     *
     * @throws Exception
     *             to JUnit.
    ...
    public void testRemovePrizeFromContest() throws Exception {
        ...
        boolean result = bean.removePrizeFromContest(contest.getContestId(), prize.getPrizeId());
    ...
    public void testUpdateContest() throws Exception {
        ...
        assertEquals("The name should be updated.", "new name", persist.getName());
    }
    ...
    public void testUpdateContestStatus() throws Exception {
        ...
        bean.updateContestStatus(contest.getContestId(), newStatus.getContestStatusId());
     ...
     *
     * <p>
     * The contest can't be updated the specified status, <code>ContestStatusTransitionException</code> is expected.
     * </p>
     *
     * @throws Exception
     *             to JUnit.
     ...
     *
     * <p>
     * The entitymanager is closed, <code>ContestManagementException</code> is expected.
     * </p>
     *
     * @throws Exception
     *             to JUnit.
     ...
     *
     * <p>
     * The entitymanager throws persistence exception, <code>ContestManagementException</code> is expected.
     * </p>
     *
     * @throws Exception
     *             to JUnit.
     ...
     *
     * <p>
     * The entitymanager throws transaction exception, <code>ContestManagementException</code> is expected.
     * </p>
     *
     * @throws Exception
     *             to JUnit.
