...
/**
 * <p>
 * This is main interface of <strong>Contest Manager</strong> component. It provides operations
 * on contest like add new contest, get contest, update contest, update contest status; CRUD
 * operations on contest status; CRUD operations on competition document; get client by contest
 * and project; CRUD operations on the contest category; CRUD operations for the configuration
 * parameters; Operations to save, retrieve or check existence of document content; operations
 * to get all contest statues, categories and studio file types.
 * </p>
 *
 * <p>
 ...
 * It's up to concrete implemenations.
 * </p>
 *
