...
/**
 * This java bean holds result of JIRA project creation. It consists of creation result, project and
 * version. Any attribute in this bean is optional.
 * <p>
 ...
 * <li>XmlType(name = "jiraProject", propOrder = {"project, actionTaken, version"})</li>
 * </ol>
 * <p>
...
public class JiraProjectCreationResult implements Serializable {
    ...
    /**
     * This field represents the created project.
     * <p>
    ...
    /**
     * This field represents the result of project creation.
     * <p>
     * Initialized in constructor. Can be accessed through the corresponding getter.
     * <p>
     * Can take any value.
     */
    private final JiraProjectCreationAction actionTaken;

    /**
     * This field represents the created version.
     * <p>
     * Initialized in constructor. Can be accessed through the corresponding getter.
     * <p>
     * Can take any value.
    ...
    /**
     * Creates a new <code>JiraProjectCreationResult</code> with the given project, version and
     * creation result.
     *
     ...
     */
    public JiraProjectCreationResult(JiraProject project, JiraVersion version,
        JiraProjectCreationAction actionTaken) {
