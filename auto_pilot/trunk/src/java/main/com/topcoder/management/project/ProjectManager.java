...
/**
 * <p>
 * This interface defines the contract for project manager. A project manager implementation has the
 * responsibility to validate and create/update/retrieve/search project instances in the
 * persistence. The manager read configuration settings to load the configured persistence and
 * validator implementation.
 * </p>
 * <p>
 * The manager also provide methods to load an array of project associated with an external user id,
 * get all project categories, project statuses and scorecard assignments from the persistence.
 * </p>
 * <p>
...
public interface ProjectManager {
     ...
     * @param reason the reason of update project.
     * @throws IllegalArgumentException if any input is null or the operator is empty string.
     * @throws PersistenceException if error occurred while accessing the database.
     * @throws ValidationException if error occurred while validating the project instance.
     */
