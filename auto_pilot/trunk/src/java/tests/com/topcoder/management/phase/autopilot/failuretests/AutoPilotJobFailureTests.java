...
public class AutoPilotJobFailureTests extends FailureTestsHelper {
    ...
    /**
     * Tests run method. ProjectPilot fails, RuntimeException will be thrown, with cause an instance of
    ...
    public void testRun1ProjectPilotFail() throws Exception {
        try {
            ...
            assertTrue("cause not as expected", e.getCause() instanceof PhaseOperationException);
        }
    }
    ...
    /**
     * Tests run(long[]) method. ProjectPilot fails, PhaseOperationException will be thrown.
     *
     * @throws Exception pass to JUnit.
     */
