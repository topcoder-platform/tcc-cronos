...
public class TemplateHierarchy {
     ...
     * hierarchy.
     * @throws IllegalArgumentException the templateHierarchy is the top level hierarchy or templateHierarchy's
    ...
    public void addNestedHierarchy(TemplateHierarchy templateHierarchy) {
        checkNull(templateHierarchy, "templateHierarchy");
        ...
        //
        // NOTE: I uses the reference rather than the id to determine whether 2 TemplateHierarchy instances are same
    ...
    synchronized void setFileServerUri(String fileServerUri) {
        ...
        checkString(fileServerUri, "fileServerUri");
