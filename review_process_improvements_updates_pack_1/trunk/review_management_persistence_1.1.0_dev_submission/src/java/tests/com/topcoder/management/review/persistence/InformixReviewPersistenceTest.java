...
public class InformixReviewPersistenceTest extends TestCase {
     ...
     * </p>
     */
    private static String DEFAULT_CONFIG_FILE = "ReviewManagerPersistence_Informix.xml";
     ...
     * </p>
     */
    private static String INVALID_CONFIG_FILE = "ReviewManagerPersistence_Informix_Invalid.xml";
     ...
     * </p>
     */
    private static String SEARCH_BUNDLE_CONFIG_FILE = "search_bundle_manager.xml";
     ...
     * </p>
     */
    private static String DB_FACTORY_CONFIG_FILE = "dbfactory.xml";
    ...
    private Review getSampleReview() {
        ...
        evaluationType.setId(1);
        evaluationType.setName("etype 1");
        evaluationType.setDescription("des");

        Review review = new Review();
        review.setInitialScore(new Float("97.4"));
        review.setAuthor(1);
    ...
    protected void setUp() throws Exception {
        ...
        Helper.doDMLQuery(conn, "INSERT INTO comment_type_lu"
                ...
                new Object[] {});
        // insert data into evaluation_type_lu table
        Helper.doDMLQuery(conn, "INSERT INTO 'informix'.evaluation_type_lu(evaluation_type_id,"
                + "name,description,create_user,create_date,modify_user,modify_date) VALUES"
                + "(1, 'etype 1', 'Serious - 10 points', 'System', current, 'System', current);",
                new Object[] {});
        Helper.doDMLQuery(conn, "INSERT INTO 'informix'.evaluation_type_lu(evaluation_type_id,"
                + "name,description,create_user,create_date,modify_user,modify_date) VALUES"
                + "(2, 'etype 2', 'Serious - 10 points', 'System', current, 'System', current);",
                new Object[] {});
        Helper.doDMLQuery(conn, "INSERT INTO 'informix'.evaluation_type_lu(evaluation_type_id,"
                + "name,description,create_user,create_date,modify_user,modify_date) VALUES"
                + "(3, 'etype 3', 'Serious - 10 points', 'System', current, 'System', current);",
                new Object[] {});
        ...
        Helper.doDMLQuery(conn,
                ...
                new Object[] {});
        Helper.doDMLQuery(conn,
                "INSERT INTO scorecard_question (scorecard_question_id) values (2)",
                new Object[] {});
        Helper.doDMLQuery(conn,
                "INSERT INTO scorecard_question (scorecard_question_id) values (3)",
                new Object[] {});
    ...
    protected void tearDown() throws Exception {
        ...
        Helper.doDMLQuery(conn, "DELETE FROM evaluation_type_lu", new Object[] {});
        ...
        Helper.doDMLQuery(conn, "INSERT INTO id_sequences(name, next_block_start, "
                + "block_size, exhausted) VALUES('review_comment_id_seq', 1, 1, 0);",
                new Object[] {});
        Helper.doDMLQuery(conn, "INSERT INTO id_sequences(name, next_block_start, "
    ...
    /**
     * <p>
     * Accuracy test of the constructor <code>InformixReviewPersistence(DBConnectionFactory
     * dbFactory,
    ...
    public void testAccuracyConstructorA1() throws Exception {
        ReviewPersistence persistence =
                new InformixReviewPersistence(new DBConnectionFactoryImpl(), "InformixConnection",
                        new SearchBundle("bundle", new HashMap(), "context"));
    ...
    /**
     * <p>
     * Failure test of the constructor <code>InformixReviewPersistence(DBConnectionFactory
     * dbFactory,
     * String connectionName, SearchBundle searchBundle)</code>.
     * </p>
     * <p>
    ...
    public void testFailureConstructorB1() throws Exception {
        ...
        try {
            ...
            assertTrue(e.getMessage().indexOf(
                    "Configuration namespace [com.topcoder.management.review."
                            + "persistence.InformixReviewPersistence] does not exist") >= 0);
        }
    }
    ...
    public void testFailureConstructorC3() throws Exception {
        try {
            ...
            assertTrue(e.getMessage().indexOf(
                    "Configuration namespace [do_not_exist] does not exist") >= 0);
        }
    }
     ...
     * </p>
     * <p>
     * the namespace specified by factory_namespace doesn't exist. ConfigurationException is
     * expected.
     * </p>
     * @throws Exception
     *             throw any exception to JUnit
    ...
    public void testFailureConstructorC10() throws Exception {
        try {
            ...
            assertTrue(e.getMessage().indexOf(
                    "Error occurs when invoking the constructor of"
                            + " class [com.topcoder.db.connectionfactory.DBCo"
                            + "nnectionFactoryImpl]") >= 0);
        }
    }
    ...
    public void testFailureConstructorC11() throws Exception {
        try {
            ...
            assertTrue(e.getMessage().indexOf("Unable to find class [do_not_exist]") >= 0);
        }
    }
    ...
    public void testFailureConstructorC13() throws Exception {
        try {
            ...
            assertTrue(e.getMessage().indexOf(
                    "Unable to find the constructor with one String "
                            + "parameter of class [java.util.ArrayList]") >= 0);
        }
    }
     ...
     * </p>
     * <p>
     * the namespace specified by search_bundle_manager_namespace does not exist.
     * ConfigurationException is expected.
     * </p>
     * @throws Exception
     *             throw any exception to JUnit
    ...
    public void testFailureConstructorC16() throws Exception {
        try {
            ...
            assertTrue(e.getMessage().indexOf(
                    "Unable to create a new instance of SearchBundleManager"
                            + " class from namespace [do_not_exist]") >= 0);
        }
    }
     ...
     * </p>
     * <p>
     * check if the review object is stored in the database correctly and its properties are
     * updated.
     * </p>
     * @throws Exception
     *             throw any exception to JUnit
    ...
    public void testAccuracyCreateReview1() throws Exception {
        ...
        Object[][] rows =
                Helper.doQuery(conn, "SELECT * FROM review", new Object[] {}, new DataType[] {
                        ...
                        Helper.STRING_TYPE, Helper.DATE_TYPE, Helper.FLOAT_TYPE});
        ...
        assertEquals("check initial_score", review.getInitialScore(), row[10]);
        ...
        for (int i = 0; i < rows.length; ++i) {
            ...
            assertEquals("check evaluation_type_id", review.getComment(i).getEvaluationType()
                    .getId(), ((Long) row[11]).longValue());
        }
        ...
        rows =
                Helper.doQuery(conn,
                        "SELECT * FROM review_item_comment ORDER BY review_item_id, sort",
     ...
     * </p>
     * <p>
     * check if the review object's properties are reset to their initial values when any error
     * occurs during the
     * creation.
     * </p>
     * @throws Exception
    ...
    public void testAccuracyCreateReview2() throws Exception {
        ...
        Helper.doDMLQuery(conn, "INSERT INTO review (review_id,resource_id,"
                + "submission_id,scorecard_id,committed,score,initial_score,"
                + "create_user,create_date,modify_user,modify_date)"
                + " VALUES (10, 1, 1, 1, 1, 1.0, 1.0, 'user', CURRENT, 'user', CURRENT)",
                new Object[] {});
        ...
        Helper.doDMLQuery(
                ...
                "INSERT INTO review_item_comment (review_item_comment_id,resource_id,"
                        + "review_item_id,comment_type_id,evaluation_type_id,content,extra_info,sort,"
                        + "create_user,create_date,modify_user,modify_date)"
                        + " VALUES (4, 1, 10, 1, 1, 'content', 'extrainfo', 0,"
     ...
     * </p>
     * <p>
     * review is invalid. review comment extra info is not of String type. IllegalArgumentException
     * is expected.
     * </p>
     * @throws Exception
     *             throw any exception to JUnit
     ...
     * </p>
     * <p>
     * review is invalid. item comment extra info is not of String type. IllegalArgumentException is
     * expected.
     * </p>
     * @throws Exception
     *             throw any exception to JUnit
     ...
     * </p>
     * <p>
     * review is invalid. duplicate comment references in different items. IllegalArgumentException
     * is expected.
     * </p>
     * @throws Exception
     *             throw any exception to JUnit
     ...
     * </p>
     * <p>
     * review is invalid. duplicate comment references in review comments and item comments.
    ...
    public void testFailureCreateReview22() throws Exception {
        ...
        Helper.doDMLQuery(conn, "INSERT INTO review (review_id,"
                ...
                + "create_user, create_date, modify_user, modify_date,initial_score) values "
                + "(5, 1, 1, 1, 0, 'topcoder', CURRENT, 'topcoder', CURRENT, 1.0)", new Object[] {});
        conn.close();
    ...
    public void testFailureCreateReview23() throws Exception {
        ...
        try {
            ...
            assertTrue(e.getMessage().indexOf("Unable to generate id for review") >= 0);
        }
    }
    ...
    public void testFailureCreateReview24() throws Exception {
        ...
        try {
            ...
            assertTrue(e.getMessage().indexOf("Unable to generate id for review comment") >= 0);
        }
    }
    ...
    public void testFailureCreateReview25() throws Exception {
        ...
        try {
            ...
            assertTrue(e.getMessage().indexOf("Unable to generate id for review item") >= 0);
        }
    }
    ...
    public void testFailureCreateReview26() throws Exception {
        ...
        try {
            ...
            assertTrue(e.getMessage().indexOf("Unable to generate id for review item comment") >= 0);
        }
    }
     ...
     * </p>
     * <p>
     * check if the review object is updated in the database correctly and its properties are
     * updated.
     * </p>
     * @throws Exception
     *             throw any exception to JUnit
    ...
    public void testAccuracyUpdateReview1() throws Exception {
        ...
        EvaluationType evaluationType = new EvaluationType();
        evaluationType.setId(2);
        evaluationType.setName("etype 2");
        evaluationType.setDescription("d");
        Comment[] comments = review.getAllComments();
        comments[0].setId(4);
        comments[0].setComment("comment 4");
        comments[1].setCommentType(commentType);
        comments[1].setEvaluationType(evaluationType);
        ...
        newComment.setEvaluationType(evaluationType);
        ...
        for (int i = 0; i < review.getNumberOfItems(); ++i) {
            ...
            for (int j = 0; j < item.getNumberOfComments(); ++j) {
                ...
                assertEquals("check extra info", comment.getExtraInfo(), row[5]);
                assertEquals("check sort", j, ((Long) row[6]).longValue());
                assertEquals("check evaluation_type_id", comment.getEvaluationType().getId(),
                        ((Long) row[11]).longValue());
            }
        }
    ...
    /**
     * <p>
     * Failure test of the method <code>udpateReview(Review review, String operator)</code>.
     * </p>
     * <p>
     * operator is null. IllegalArgumentException is expected.
     * </p>
    ...
    public void testFailureUpdateReview5() throws Exception {
        ...
        Helper.doDMLQuery(conn, "INSERT INTO review (review_id,resource_id,"
                + "submission_id,scorecard_id,committed,score,initial_score,"
                + "create_user,create_date,modify_user,modify_date)"
                + " VALUES (1, 1, 1, 1, 1, 1.0, 1.0, 'user', CURRENT, 'user', CURRENT)",
                new Object[] {});
        conn.close();
    ...
    public void testFailureUpdateReview26() throws Exception {
        ...
        try {
            ...
            assertEquals("Unable to generate id for review item.,"
                    + " caused by The specified IDName does not exist in the database.", e
                    .getMessage());
            assertTrue(e.getMessage().indexOf("Unable to generate id for review item") >= 0);
        }
    }
    ...
    public void testAccuracyGetReview1() throws Exception {
        ...
        assertEquals("check initial_score", review.getInitialScore(), review1.getInitialScore());
        ...
        for (int i = 0; i < review.getNumberOfComments(); ++i) {
            ...
            assertEquals("check evaluation_type_id", review.getComment(i).getEvaluationType()
                    .getId(), review1.getComment(i).getEvaluationType().getId());
        }
        ...
        for (int i = 0; i < review.getNumberOfItems(); ++i) {
            ...
            for (int j = 0; j < item.getNumberOfComments(); ++j) {
                ...
                assertEquals("check evaluation_type_id", comment.getEvaluationType().getId(),
                        comment1.getEvaluationType().getId());
            }
        }
    }
    ...
    /**
     * <p>
     * Accuracy test of the method <code>getAllEvaluationTypes()</code>.
     * </p>
     * <p>
     * check if the review object is get correctly from the database.
     * </p>
     ...
     *             throw any exception to JUnit
     */
    public void testAccuracyGetAllEvaluationTypes() throws Exception {

        ReviewPersistence persistence = new InformixReviewPersistence();
        EvaluationType[] types = persistence.getAllEvaluationTypes();

        assertEquals("# of types", 3, types.length);
        assertEquals("id of type", 1, types[0].getId());
        assertEquals("id of type", 2, types[1].getId());
        assertEquals("id of type", 3, types[2].getId());
        assertEquals("name of type", "etype 1", types[0].getName());
        assertEquals("name of type", "etype 2", types[1].getName());
        assertEquals("name of type", "etype 3", types[2].getName());
    }

    /**
     * The failure test of getAllEvaluationTypes.
     * @throws ReviewPersistenceException
     *             if error.
     */
    public void test_getAllEvaluationTypes() throws Exception {
        ConfigManager cm = ConfigManager.getInstance();
        Iterator it = cm.getAllNamespaces();
        while (it.hasNext()) {
            cm.removeNamespace((String) it.next());
        ...
        try {
            ...
            ReviewPersistence persistence = new InformixReviewPersistence();
            persistence.getAllEvaluationTypes();
            fail("ReviewPersistenceException should be thrown.");
    ...
    /**
     * <p>
     * Accuracy test of the method <code>addReviewComment(long reviewId, Comment comment, String
     * operator)</code>.
     * </p>
     * <p>
    ...
    public void testAccuracyAddReviewComment1() throws Exception {
        ...
        Object[][] rows =
                Helper.doQuery(conn, "SELECT * FROM review_comment WHERE review_comment_id=3",
                        new Object[] {}, new DataType[] {Helper.LONG_TYPE, Helper.LONG_TYPE,
                                Helper.LONG_TYPE, Helper.LONG_TYPE, Helper.STRING_TYPE,
                                Helper.STRING_TYPE, Helper.LONG_TYPE, Helper.STRING_TYPE,
                                Helper.DATE_TYPE, Helper.STRING_TYPE, Helper.DATE_TYPE,
    ...
    /**
     * <p>
     * Failure test of the method <code>addReviewComment(long reviewId, Comment comment, String
     * operator)</code>.
     * </p>
     * <p>
    ...
    public void testFailureAddReviewComment5() throws Exception {
        ...
        evaluationType.setId(1);
        evaluationType.setName("type 1");
        evaluationType.setDescription("description");
        comment.setAuthor(1);
        comment.setComment("comment");
        comment.setCommentType(commentType);
        comment.setEvaluationType(evaluationType);
    ...
    /**
     * <p>
     * Accuracy test of the method <code>addItemComment(long itemId, Comment comment, String
     * operator)</code>.
     * </p>
     * <p>
    ...
    public void testAccuracyAddItemComment1() throws Exception {
        ...
        Object[][] rows =
                Helper.doQuery(conn,
                        "SELECT * FROM review_item_comment WHERE review_item_comment_id=5",
                        new Object[] {}, new DataType[] {Helper.LONG_TYPE, Helper.LONG_TYPE,
                                Helper.LONG_TYPE, Helper.LONG_TYPE, Helper.STRING_TYPE,
                                Helper.STRING_TYPE, Helper.LONG_TYPE, Helper.STRING_TYPE,
                                Helper.DATE_TYPE, Helper.STRING_TYPE, Helper.DATE_TYPE,
    ...
    /**
     * <p>
     * Failure test of the method <code>addItemComment(long itemId, Comment comment, String
     * operator)</code>.
     * </p>
     * <p>
    ...
    public void testAccuracySearchReviews1() throws Exception {
        ...
        ReviewPersistence persistence = new InformixReviewPersistence();
        // ReviewPersistence persistence = new InformixReviewPersistence(new
        ...
        Review[] reviews =
                persistence.searchReviews(new EqualToFilter("scorecardType", new Long(1)), false);
    ...
    public void testAccuracySearchReviews2() throws Exception {
        ...
        Review[] reviews =
                persistence.searchReviews(new EqualToFilter("submission", new Long(1)), false);
        assertEquals("# of reviews", 1, reviews.length);
        assertEquals("review id", 1, reviews[0].getId());
        // check only the review object is retrieved.
        assertEquals("# of review comments", 0, reviews[0].getNumberOfComments());
    ...
    public void testAccuracySearchReviews3() throws Exception {
        ...
        Review[] reviews =
                persistence.searchReviews(new EqualToFilter("reviewer", new Long(1)), false);
        assertEquals("# of reviews", 1, reviews.length);
        assertEquals("review id", 1, reviews[0].getId());
        // check only the review object is retrieved.
        assertEquals("# of review comments", 0, reviews[0].getNumberOfComments());
    ...
    public void testAccuracySearchReviews4() throws Exception {
        ...
        Review[] reviews =
                persistence.searchReviews(new EqualToFilter("project", new Long(1)), false);
