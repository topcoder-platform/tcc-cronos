...
public class DemoTest extends TestCase {
    ...
    protected void setUp() throws Exception {
        ...
        Helper.doDMLQuery(conn, "INSERT INTO evaluation_type_lu"
                + " (evaluation_type_id, name, description, create_user,"
                + " create_date, modify_user, modify_date) values"
                + "(1, 'type 1', 'comment type 1', 'topcoder', CURRENT, 'topcoder', CURRENT)",
                new Object[] {});
        Helper.doDMLQuery(conn, "INSERT INTO evaluation_type_lu"
    ...
    public void testCreation() throws Exception {
        ...
        SearchBundle searchBundle =
                new SearchBundle("empty_search_bundle", new HashMap(), "context");
