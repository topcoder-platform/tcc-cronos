...
public class CommentTypeUnitTests extends TestCase {
    ...
    public void testImplements() {
        assertTrue("CommentType should implement Serializable interface",
    ...
    /**
     * Test the constructor <code>CommentType(long)</code> with zero id, <code>IllegalArgumentException</code> should be
     * thrown.
     */
    ...
    /**
     * Test the constructor <code>CommentType(long)</code> with positive id, instance of <code>CommentType</code> should
     * be created.
     */
    ...
    public void testGetName() {
        assertTrue("getName method should return 'CommentType'",
                type.getName().equals("CommentType"));
    }
