...
public class ReviewEditorUnitTests extends TestCase {
    ...
    public void testImplements() {
        assertTrue("ReviewEditor should implement Serializable interface",
                editor instanceof Serializable);
    }
    ...
    /**
     * Test the constructor <code>ReviewEditor(String)</code> with non-null user, instance of <code>ReviewEditor</code>
     * should be created.
     */
    public void testConstructorWithNonNullUser() {
        ...
        assertTrue("creationUser field of the review should be 'New User'", edt.getReview()
                .getCreationUser().equals("New User"));
        assertTrue("creationTimestamp field of the review should be set", edt.getReview()
                .getCreationTimestamp().equals(now));
        assertTrue("creationUser field of the review should be 'New User'", edt.getReview()
                .getModificationUser().equals("New User"));
        assertTrue("creationTimestamp field of the review should be set", edt.getReview()
                .getModificationTimestamp().equals(now));
        ...
        assertTrue("creationUser field of the review should be ''", edt1.getReview()
                .getCreationUser().equals(""));
        assertTrue("creationTimestamp field of the review should be set", edt1.getReview()
                .getCreationTimestamp().equals(now));
        assertTrue("creationUser field of the review should be ''", edt1.getReview()
                .getModificationUser().equals(""));
        assertTrue("creationTimestamp field of the review should be set", edt1.getReview()
                .getModificationTimestamp().equals(now));
        ...
        assertTrue("creationUser field of the review should be '   '", edt2.getReview()
                .getCreationUser().equals("   "));
        assertTrue("creationTimestamp field of the review should be set", edt2.getReview()
                .getCreationTimestamp().equals(now));
        assertTrue("creationUser field of the review should be '   '", edt2.getReview()
                .getModificationUser().equals("   "));
        assertTrue("creationTimestamp field of the review should be set", edt2.getReview()
    ...
    public void testSetIdWithPositiveId() {
        ...
        assertTrue("modificationUser field of the review should be set", review
                .getModificationUser().equals(USER));
        assertTrue("modificationTimestamp field of the review should be set", review
                .getModificationTimestamp().equals(now));
    }
