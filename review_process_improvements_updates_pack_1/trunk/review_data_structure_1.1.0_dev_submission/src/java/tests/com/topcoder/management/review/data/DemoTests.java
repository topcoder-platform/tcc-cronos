 ...
 * </p>
 * <p>
 * All of the classes that make up this model (<code>Review</code>, <code>Item</code>, <code>Comment</code>, and
 * <code>CommentType</code>) possess a Java Bean-like interface. That is, they all have a no argument constructor, and
 * all properties have both getter and setter methods. Convenience constructors for setting some fields are also
 * provided.
 * </p>
 * <p>
...
public class DemoTests extends TestCase {
    ...
    public void testCreatingAndUsingReviewHierarchy() throws Exception {
        ...
        // Similarly create evaluation type
        EvaluationType evaluationType = new EvaluationType(1, "Serious");
        ...
        reviewComment.setEvaluationType(evaluationType);
        ...
        for (int i = 0; i < comments.length; i++) {
            ...
            EvaluationType evaluationType1 = comment.getEvaluationType();
            String evaluationTypeName = evaluationType1.getName();
        }
