...
public class ReviewUnitTests extends TestCase {
    ...
    /**
     * Test the constructor <code>Review(long, String)</code> with zero id, <code>IllegalArgumentException</code> should
     * be thrown.
     */
    ...
    /**
     * Test the method <code>setAuthor(long)</code> with negative author, <code>IllegalArgumentException</code> should
     * be thrown.
     */
    ...
    /**
     * Test the method <code>setSubmission(long)</code> with negative submission, <code>IllegalArgumentException</code>
     * should be thrown.
     */
    ...
    /**
     * Test the method <code>setScorecard(long)</code> with zero scorecard, <code>IllegalArgumentException</code> should
     * be thrown.
     */
    ...
    /**
     * Test the method <code>setScore(Float)</code> with negative score, <code>IllegalArgumentException</code> should be
     * thrown.
     */
    ...
    /**
     * Test the method <code>setScore(Float)</code> with POSITIVE_INFINITY score, <code>IllegalArgumentException</code>
     * should be thrown.
     */
    ...
    /**
     * Test the method <code>setInitialScore(Float)</code> with negative score, <code>IllegalArgumentException</code>
     * should be thrown.
     */
    public void testSetInitialScoreWithNegativeScore() {
        try {
            review.setInitialScore(new Float(-1));
            fail("IllegalArgumentException should be thrown");
        } catch (IllegalArgumentException e) {
            // success
        }
    ...
    /**
     * Test the method <code>setInitialScore(Float)</code> with POSITIVE_INFINITY score,
     * <code>IllegalArgumentException</code> should be thrown.
     */
    public void testSetInitialScoreWithInfinityScore() {
        try {
            review.setInitialScore(new Float(Float.POSITIVE_INFINITY));
            fail("IllegalArgumentException should be thrown");
        } catch (IllegalArgumentException e) {
            // success
        }
    ...
    /**
     * Test the method <code>setInitialScore(Float)</code> with NaN score, <code>IllegalArgumentException</code> should
     * be
     * thrown.
     */
    public void testSetInitialScoreWithNaNScore() {
        try {
            review.setInitialScore(new Float(Float.NaN));
            fail("IllegalArgumentException should be thrown");
        } catch (IllegalArgumentException e) {
            // success
        }
    ...
    /**
     * Test the method <code>setInitialScore(Float)</code> with valid score, the score field should be set successfully.
     */
    public void testSetInitialScoreWithValidScore() {
        review.setInitialScore(new Float(1));
        assertTrue("initialScore field should be 1", review.getInitialScore().floatValue() == 1);

        review.setInitialScore(new Float(0));
        assertTrue("initialScore field should be 0", review.getInitialScore().floatValue() == 0);

        // null is acceptable
        review.setInitialScore(null);
        assertNull("initialScore field should be null", review.getInitialScore());
    }

    /**
     * Test the method <code>getInitialScore()</code>, the score value should be returned successfully.
     */
    public void testGetInitialScore() {
        assertTrue("getInitialScore method should return 20.06",
                review.getInitialScore().equals(score));
    }

    /**
     * Test the method <code>resetScore()</code>, the score field should be set to null.
     */
    public void testResetInitialScore() {
        review.resetInitialScore();
        assertNull("initialScore field should be null", review.getInitialScore());
    }

    /**
     * Test the method <code>addComment(Comment)</code> with null comment, <code>IllegalArgumentException</code> should
     * be thrown.
     */
    ...
    public void testAddCommentsWithValidComments() {
        ...
        assertTrue("one inexistent comment should be added",
                review.getNumberOfComments() == count + 1);
    }
    ...
    /**
     * Test the method <code>removeComments(Comment[])</code> with null comments, <code>IllegalArgumentException</code>
     * should be thrown.
     */
    ...
    public void testRemoveCommentsWithValidComments() {
        ...
        assertTrue("one existent comment should be removed",
                review.getNumberOfComments() == count - 1);
    }
    ...
    public void testGetCommentWithValidIndex() {
        assertTrue("the corresponding comment should be retrieved",
                review.getComment(0).equals(comm1));
        assertTrue("the corresponding comment should be retrieved",
                review.getComment(1).equals(comm2));
    }
    ...
    public void testGetNumberOfComments() {
        assertTrue("the size of the comments list should be returned",
                review.getNumberOfComments() == 2);
    }
    ...
    /**
     * Test the method <code>removeItems(Item[])</code> with null items, <code>IllegalArgumentException</code> should be
     * thrown.
     */
    ...
    /**
     * Test the method <code>getItem(int)</code> with negative itemIndex, <code>IndexOutOfBoundsException</code> should
     * be thrown.
     */
    ...
    /**
     * Test the method <code>getItem(int)</code> with too big itemIndex, <code>IndexOutOfBoundsException</code> should
     * be thrown.
     */
    ...
    public void testGetCreationUser() {
        assertTrue("getCreationUser method should return 'Creation'", review.getCreationUser()
                .equals("Creation"));
    }
    ...
    public void testSetCreationTimestamp() {
        ...
        assertTrue("creationTimestamp field should be set",
                review.getCreationTimestamp().equals(newDate));
    ...
    public void testGetCreationTimestamp() {
        assertTrue("getCreationTimestamp method should return correctly", review
                .getCreationTimestamp().equals(date));
    }
    ...
    public void testSetModificationUser() {
        ...
        assertTrue("modificationUser field should be 'UserM'",
                review.getModificationUser().equals("UserM"));
        ...
        // all whitespace is acceptable
        review.setModificationUser("   ");
        assertTrue("modificationUser field should be '   '",
                review.getModificationUser().equals("   "));
    }
    ...
    public void testGetModificationUser() {
        assertTrue("getModificationUser method should return 'Modification'", review
                .getModificationUser().equals("Modification"));
    }
    ...
    public void testSetModificationTimestamp() {
        ...
        assertTrue("modificationTimestamp field should be set", review.getModificationTimestamp()
                .equals(newDate));
    ...
    public void testGetModificationTimestamp() {
        assertTrue("getModificationTimestamp method should return correctly", review
                .getModificationTimestamp().equals(date));
    }
}
