...
public class CommentUnitTests extends TestCase {
    ...
    public void testImplements() {
        assertTrue("Comment should implement Serializable interface",
                comment instanceof Serializable);
    }
    ...
    /**
     * Test the constructor <code>Comment(long)</code> with negative id, <code>IllegalArgumentException</code> should be
     * thrown.
     */
    ...
    /**
     * Test the constructor <code>Comment(long, long)</code> with zero id, <code>IllegalArgumentException</code> should
     * be thrown.
     */
    ...
    /**
     * Test the constructor <code>Comment(long, long)</code> with negative author, <code>IllegalArgumentException</code>
     * should be thrown.
     */
    ...
    /**
     * Test the constructor <code>Comment(long, long, String)</code> with zero id, <code>IllegalArgumentException</code>
     * should be thrown.
     */
    ...
    /**
     * Test the constructor <code>Comment(long, long, String)</code> null comment, <code>IllegalArgumentException</code>
     * should be thrown.
     */
    ...
    public void testGetCommentType() {
        assertTrue("getCommentType method should return correctly", comment.getCommentType()
                .equals(type));
    }
    ...
    public void testSetComment() {
        ...
        assertTrue("comment field should be 'other comment'",
                comment.getComment().equals("other comment"));
    ...
    public void testGetComment() {
        assertTrue("getComment method should return correctly",
                comment.getComment().equals("It's a comment"));
    }
    ...
    public void testGetExtraInfo() {
        assertTrue("getExtraInfo method should return correctly",
                comment.getExtraInfo().equals(serializable));
    }
