 ...
 * <code>Item</code> classes, each data field has a three method (get/set/reset) combination for manipulating that data
 * field.
 * </p>
 * <p>
...
public class Comment implements Serializable {
     ...
     * </p>
     * <p>
     * The default (unassigned value) for this field is -1, which indicates that the id of the <code>Comment</code> has
     ...
     * (in the constructor or through the <code>setId</code> method). It is expected that all <code>Comment</code>
     ...
     * </p>
     * <p>
     * This field is intended to allow as generic a type as possible, and a <code>Serializable</code> enables this class
     * to guarantee that serialization will succeed.
     * </p>
     * <p>
     * The default (unassigned value) for this field is null, which indicates that the extra information of the
     * <code>Comment</code> has not yet been set through a call to <code>setExtraInfo</code> (or has been set back to
     * this value by a call to <code>resetExtraInfo</code>). Non-null values indicate that the client using the
     ...
     * <code>Comment</code> has not yet been set through the constructor or a call to <code>setComment</code> (or has
     * been set back to this value by a call to <code>resetComment</code>). Non-null values indicate that the client
     * using the component has assigned the actual text (in the constructor or through the <code>setComment</code>
     * method).
     * </p>
     * <p>
     * This field is initialized to null (default value), and also can be initialized in the constructor. It is mutable,
     * and can be any string (empty string, all whitespace, etc) or null (default value). This field can be set using
     * the <code>setComment</code> and <code>resetComment</code> methods and retrieved using the <code>getComment</code>
     * method.
     * </p>
     */
    ...
    /**
     * <p>
     * The evaluation type of this comment. Can be any value. Has getter and setter.
     * </p>
     * @since 1.1
     */
    ...
    /**
     * <p>
     * Creates a new <code>Comment</code> instance, leaving all fields as their default unassigned values (-1 for id and
     * author, null for commentType, comment and extraInfo).
     * </p>
     */
    public Comment() {
        // nothing needed
    ...
    /**
     * <p>
     * Creates a new <code>Comment</code> instance, setting id to the given value and leaving all other fields as their
     * default unassigned values (-1 for author, null for commentType, comment and extraInfo).
     * </p>
     * @param id
    ...
    /**
     * <p>
     * Creates a new <code>Comment</code> instance, setting id, author, commentType and comment to the given values and
     * leaving extraInfo as its default unassigned values (null).
     * </p>
     * @param id
     *            The identifier for the <code>Comment</code>
     * @param author
    ...
    /**
     * <p>
     * Retrieves the evaluation type of this comment.
     * </p>
     * @return
     *         the evaluation type of this comment
     * @since 1.1
     */
    ...
    /**
     * <p>
     * Sets the evaluation type of this comment.
     * </p>
    ...
    /**
     * <p>
     * Resets the evaluation type of the comment to its unassigned value, which is null.
     * </p>
     * @since 1.1
     */
    public void resetEvaluationType() {
        evaluationType = null;
    }
}
