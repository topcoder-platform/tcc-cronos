...
public class Item implements Serializable {
     ...
     * </p>
     * <p>
     * The default (unassigned value) for this field is -1, which indicates that the id of the <code>Item</code> has not
     * yet been set through the constructor or a call to <code>setId</code> (or has been set back to this value by a
     * call to <code>resetId</code>). Positive values indicate that the client using the component has assigned an id
     * (in the constructor or through the <code>setId</code> method). It is expected that all <code>Item</code>
     ...
     * has not yet been set through the constructor or a call to <code>setQuestion</code> (or has been set back to this
     * value by a call to <code>resetQuestion</code>). Positive values indicate that the client using the component has
     * assigned a question (in the constructor or through the <code>setQuestion</code> method).
     * </p>
     * <p>
     * This field is initialized to -1 (default value), and also can be initialized in the constructor. It is mutable,
     * and can be positive or equal to -1 (default value). This field can be set using the <code>setQuestion</code> and
     * <code>resetQuestion</code> methods and retrieved using the <code>getQuestion</code> method.
     * </p>
     */
     ...
     * <code>Item</code> has not yet been set through a call to <code>setDocument</code> (or has been set back to this
     * value by a call to <code>resetDocument</code>). Non-null values indicate that the client using the component has
     * assigned an optional attachment (through the <code>setDocument</code> method).
     * </p>
     * <p>
     ...
     * </p>
     * <p>
     * The <code>answer</code> argument can be null, indicating that no answer is associated with the <code>Item</code>.
     * </p>
     * @param answer
     *            The answer associated with the <code>Item</code>
     */
     ...
     * </p>
     * <p>
     * The <code>question</code> is only an identifier, this component does not define an abstract <code>Question</code>
     ...
     * </p>
     * <p>
     * The returned value is only an identifier, this component does not define an abstract <code>Question</code> class,
     * and it is up to the application to determine how the question identifier is used.
     * </p>
     * <p>
