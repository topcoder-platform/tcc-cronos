 ...
 * functionalities to create, update and search reviews. Additionally, application users can also add comment for review
 * and item, and get all the comment types from the persistence. The constructor of the implementation must take a
 * string argument as namespace.
 * </p>
 * <p>
...
public interface ReviewPersistence {
     ...
     *                if any other error occurred.
     */
    public Review getReview(long id) throws ReviewEntityNotFoundException, ReviewPersistenceException;
    ...
    /**
     * <p>
     * Add comment to review with given review id. this method is responsible for creating the Comment, but not for the
     * CommentType of the given comment.
     * </p>
     * @param reviewId
     *            the review id
     * @param comment
     ...
     *                if any other error occurred.
     */
    public void addReviewComment(long reviewId, Comment comment, String operator) throws ReviewEntityNotFoundException,
            ReviewPersistenceException;

    /**
     * <p>
     * Add the comment to the item with given item id. this method is responsible for creating the Comment, but not for
     ...
     *                if any other error occurred.
     */
    public void addItemComment(long itemId, Comment comment, String operator) throws ReviewEntityNotFoundException,
            ReviewPersistenceException;
    ...
    /**
     * <p>
     * Get all the EvaluationType instances from the persistence. Return empty array if no type is
     * found.
     * </p>
