...
/**
 * <p>
 * This <code>ReviewManager</code> interface defines the contract of managing the review entities. It provides the
 * management functionalities to create, update and search review entities. It can also be used to add comment for
 * review and item, and get all the comment types from the manager.
 * </p>
 * <p>
 * Thread safety: Implementation of this class is not required to be thread-safe.
 * </p>
 * @author woodjhon, icyriver, saarixx, TCSDEVELOPER
 * @version 1.1
 */
public interface ReviewManager {
     ...
     * associated items and comments of the matching review entity will not been retrieved.
     * </p>
     * <p>
    ...
    /**
     * <p>
     * This method will add the comment to the item with given item id. This method is also responsible for creating the
     * <code>Comment</code> instance.
     * </p>
     * @param itemId
     *            the item id.
    ...
    /**
     * <p>
     * Get all the EvaluationType instances from the manager. Return empty array if no type is found.
     * </p>
     * @throws ReviewManagementException
