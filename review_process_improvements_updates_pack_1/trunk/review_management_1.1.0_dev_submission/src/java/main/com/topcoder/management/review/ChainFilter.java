 ...
 * filters with "chain" operation. It will be used for complex search conditions. It supports and,
 * or and not operations.
 * </p>
 * <p>
 * Examples of usage of <code>ChainFilter</code> :
 * <pre>
...
public class ChainFilter {
    ...
    /**
     * <p>
     * Creates the <code>ChainFilter</code> instance with the given instance of <code>Filter</code>.
     * </p>
     * @param filter
     *            the filter to set.
     * @throws IllegalArgumentException
     *             if the passed filter is null.
     */
     ...
     * <code>ChainFilter</code> instance which combines current filter with the passed filter by
     * 'and' operation.
     * </p>
     * @param rhs
     *            the filter to be chained.
