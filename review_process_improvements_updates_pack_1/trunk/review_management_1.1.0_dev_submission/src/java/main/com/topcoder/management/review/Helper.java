...
final class Helper {
     ...
     */
    public static Object createObject(String className, String typeParam) throws ConfigurationException {
        try {
            ...
            throw new ConfigurationException("Error occurs during creating the object for class: " + className, ex);
     ...
     */
    public static Property getProperty(String namespace, String name) throws ConfigurationException {
        ...
        try {
            ...
            throw new ConfigurationException("Error occurs when geting property: " + name + " fromo namespace: "
                    + namespace);
        }
     ...
     * @throws ConfigurationException
     *             if isRequired flag is true and value doesn't exists or the
     *             value is empty.
     */
    public static String getValue(Property property, String name, boolean isRequired) throws ConfigurationException {
