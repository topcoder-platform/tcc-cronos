...
/**
 * <p>
 * This <code>DefaultReviewManager</code> class is the default implementation of <code>
 * {@link ReviewManager}</code>. It
 * actually delegates the work to the pluggable persistence to create, update and search review
 * entities. The review
 * entity ids will be generated by the inner persistence class. Additionally, It can also be used to
 * add comment for
...
public class DefaultReviewManager implements ReviewManager {
    ...
    /**
     * <p>
     * This variable represents the name of persistence property for creating the
     * <code>DefaultReviewManager</code>
     * class.
     * </p>
     */
    ...
    /**
     * <p>
     * This method will create the review entity in the manager. Here it simply delegates this work
     * to the pluggable
     * persistence.
     * </p>
     * @param review
    ...
    /**
     * <p>
     * This method will update the review entity in the manager. Here it simply delegates this work
     * to the pluggable
     * persistence.
     * </p>
     * @param review
    ...
    /**
     * <p>
     * This method will add comment to review with given review id. Here it simply delegates this
     * work to the pluggable
     * persistence.
     * </p>
     * @param reviewId
    ...
    /**
     * <p>
     * This method will add the comment to the item with given item id. Here it simply delegates
     * this work to the
    ...
    /**
     * <p>
     * This method will get all the <code>CommentType</code> instance from the manager. Here it
     * simply delegates this
    ...
    /**
     * Get all the EvaluationType instances from the manager. Return empty array if no type is
     * found.
     * @throws ReviewManagementException
    ...
    public EvaluationType[] getAllEvaluationTypes() throws ReviewManagementException {
        return persistence.getAllEvaluationTypes();
    }
}
