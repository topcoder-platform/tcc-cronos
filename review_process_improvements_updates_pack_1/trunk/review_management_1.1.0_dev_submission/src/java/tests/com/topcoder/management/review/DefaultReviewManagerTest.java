...
public class DefaultReviewManagerTest extends TestCase {
    ...
    private static final String TEST_NAMESPACE =
            "com.topcoder.management.review.DefaultReviewManager.OnlyClass";
     ...
     * </p>
     * @throws Exception
     *             if any exception occurs when creating.
     */
    ...
    public void testDefaultReviewManagerCtor1_Detail() throws Exception {
        ...
        assertEquals("The inner persistence from config xml file is incorrect.",
                ...
                ((MockReviewPersistence) TestHelper.getFieldValue(manager, "persistence"))
                        .getNamespace());
    }
     ...
     * </p>
     * @throws Exception
     *             if any other exception occurs when creating review entiry.
     */
    public void testCreateReview_Simple_Once() throws Exception {
        ...
        // get and test it.
        assertEquals("The review entiry does not create into persistence correctly.", 1, manager
                .getReview(1).getId());
     ...
     * </p>
     * @throws Exception
     *             if any other exception occurs when updating review entiry.
     */
    public void testUpdateReview_Simple_Once() throws Exception {
        ...
        // get and test it.
        assertEquals("The review entiry does not update into persistence correctly.", 1, manager
                .getReview(1).getId());
    ...
    public void testUpdateReview_Complex_Once() throws Exception {
        ...
        assertEquals("The review entiry does not update into persistence correctly.",
                "updateReviewer", manager.getReview(1).getModificationUser());
        assertEquals("The review entiry does not update into persistence correctly.", 1, manager
                .getReview(1).getNumberOfComments());
        assertEquals("The review entiry does not update into persistence correctly.", 2, manager
                .getReview(1).getNumberOfItems());
    }
    ...
    public void testUpdateReview_Complex_MoreTimes() throws Exception {
        ...
        assertEquals("The review entiry does not update into persistence correctly.",
                "updateReviewer9", manager.getReview(1).getModificationUser());
        assertEquals("The review entiry does not update into persistence correctly.", 9, manager
                .getReview(1).getNumberOfItems());
    }
     ...
     * </p>
     * @throws Exception
     *             if any other exception occurs when updating.
     */
     ...
     * </p>
     * @throws Exception
     *             if any other exception occurs when getting review entiry.
     */
    public void testGetReview_Once() throws Exception {
        ...
        // get and test it.
        assertEquals("The review entiry getting from persistence is incorrect.", 1, manager
                .getReview(1).getId());
        assertEquals("The review entiry getting from persistence is incorrect.", operator, manager
    ...
    public void testGetReview_MoreTimes() throws Exception {
        ...
        // get and test it.
        for (int i = 1; i < 10; i++) {
            assertEquals("The review entiry getting from persistence is incorrect.", i, manager
                    .getReview(i).getId());
     ...
     * </p>
     * @throws Exception
     *             if any other exception occurs when getting.
     */
     ...
     * </p>
     * @throws Exception
     *             if any other exception occurs when searching review entiry.
     */
     ...
     * </p>
     * @throws Exception
     *             if any other exception occurs when adding comment for review entiry.
     */
     ...
     * </p>
     * @throws Exception
     *             if any other exception occurs when adding.
     */
    ...
    public void testAddItemComment_Once() throws Exception {
        ...
        // get and test it.
        Review getReview = manager.getReview(1);
        assertEquals("The comment for item does not add into persistence correctly.", 1, getReview
                .getItem(0).getNumberOfComments());
    }
    ...
    public void testAddItemComment_MoreTimes() throws Exception {
        ...
        // get and test it.
        Review getReview = manager.getReview(1);
        assertEquals("The comment for item does not add into persistence correctly.", 2, getReview
                .getItem(0).getNumberOfComments());
        assertEquals("The comment for item does not add into persistence correctly.", 1, getReview
                .getItem(1).getNumberOfComments());
    }
    ...
    /**
     * <p>
     * Test of <code>getAllEvaluationTypes()</code> method.
     * </p>
     * @throws Exception
     *             if any other exception occurs when adding evaluation for review entiry.
     */
    public void testGetAllEvaluationTypes() throws Exception {
        EvaluationType[] types = manager.getAllEvaluationTypes();

        // check the types.
        assertEquals("The evaluation type from manager is incorrect.", 3, types.length);
        assertEquals("The evaluation type from manager is incorrect.", "Comment",
                types[0].getName());
        assertEquals("The evaluation type from manager is incorrect.", "Recommend",
                types[1].getName());
        assertEquals("The evaluation type from manager is incorrect.", "Required",
                types[2].getName());
    }

    /**
     * <p>
     * Tests <code>getAllEvaluationTypes()</code> method for failure.
     * </p>
     * <p>
     * It try to get evaluation type from the invalid persistence,
     * <code>ReviewManagementException</code> is expected.
     * </p>
     * @throws Exception
     *             if any other exception occurs when adding.
     */
    public void testGetAllEvaluationTypesForException_PersistenceException() throws Exception {
        try {
            // invalid the persistence here.
            ((MockReviewPersistence) persistence).stopState();
            manager.getAllEvaluationTypes();
