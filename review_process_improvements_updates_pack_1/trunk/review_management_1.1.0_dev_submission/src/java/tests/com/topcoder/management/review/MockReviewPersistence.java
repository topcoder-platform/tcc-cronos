...
class MockReviewPersistence implements ReviewPersistence {
    ...
    /**
     * <p>
     * This variable represents the evaluation type of this <code>MockReviewPersistence</code>
     * class.
     * </p>
     */
    private static EvaluationType evaluationType1 = new EvaluationType(1, "Comment");
     ...
     * </p>
     */
    private static EvaluationType evaluationType2 = new EvaluationType(2, "Recommend");
     ...
     * </p>
     */
    private static EvaluationType evaluationType3 = new EvaluationType(3, "Required");
     ...
     * @throws IllegalArgumentException
     *             if any argument is null, or operator is empty string,
     *             or review fails to pass the validation.
     * @throws DuplicateReviewEntityException
     *             if review entity id already exists in the
     *             persistence.
    ...
    public void createReview(Review review, String operator) throws ReviewPersistenceException {
        ...
        if (reviewsMap.containsKey(key)) {
            throw new DuplicateReviewEntityException(
                    "The review entity already exists in the persistence.", review.getId());
        }
     ...
     * @throws IllegalArgumentException
     *             if arguments is null, or operator is empty string,
     *             or review fails to pass the validation.
     * @throws ReviewEntityNotFoundException
     *             if given review entity does not exist in the
     *             persistence.
     * @throws ReviewPersistenceException
     *             if any other error occurred.
     */
    public void updateReview(Review review, String operator) throws ReviewPersistenceException {
        ...
        if (!reviewsMap.containsKey(key)) {
            throw new ReviewEntityNotFoundException(
                    "The review entity does not exist in the persistence.", review.getId());
        }
    ...
    public Review getReview(long id) throws ReviewPersistenceException {
        ...
        if (review == null) {
            throw new ReviewEntityNotFoundException(
                    "The review entity does not exist in the persistence.", id);
        }
     ...
     * @throws IllegalArgumentException
     *             if any argument is null, or reviewId is not positive,
     ...
     *            the operator who adds the comment.
     * @throws IllegalArgumentException
     *             if any argument is null, or itemId is not positive,
     *             or operator is empty string.
     * @throws ReviewEntityNotFoundException
    ...
    /**
     * <p>
     * This method will get all the <code>EvaluationType</code> instance from the persistence.
     * </p>
     * @return the array of all <code>EvaluationType</code> instance from the persistence, or empty
     *         array if no evaluation type can be found.
     * @throws ReviewPersistenceException
     *             if failed to get the evaluation types.
     */
    public EvaluationType[] getAllEvaluationTypes() throws ReviewPersistenceException {
        // check the persistence state here.
        validState();

        return new EvaluationType[] {evaluationType1, evaluationType2, evaluationType3};
    }
