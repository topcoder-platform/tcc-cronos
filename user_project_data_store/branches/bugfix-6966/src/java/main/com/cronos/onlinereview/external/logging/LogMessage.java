 ...
 */
package com.cronos.onlinereview.external.logging;
...
public class LogMessage {
     ...
     */
    public LogMessage(String type, Long id, String message, Throwable error) {
        this.id = id;
     ...
     * @param message a free text message.
     */
    public LogMessage(String type, Long id, String message) {
    ...
    public String getLogMessage() {
        if (logMessage == null) {
            ...
            buffer.append("type: ").append((type == null) ? "Unknown" : type).append(" id: ")
                  .append((id == null) ? "Unknown" : id.toString()).append(" - ").append(message);
