...
/**
 * <p>Tests the ExternalObjectImpl class.</p>
 *
 * @author TCSDEVELOPER
 * @version 1.0
 */
public class ExternalObjectImplUnitTest extends TestCase {
    ...
    /**
     * <p>The default id of the ObjectImpl.</p>
     */
    private static final long DEFAULTID = 123;

    /**
     * <p>An ExternalObjectImpl instance for testing.</p>
     */
    ...
    /**
     * <p>Tests the accuracy of the ctor(long).</p>
     * <p>The ExternalObjectImpl instance should be created successfully.</p>
     */
    public void testCtor_Long() {

        assertNotNull("ExternalObjectImpl should be accurately created.", objectImpl);
        assertTrue("objectImpl should be instance of ExternalObjectImpl.",
                objectImpl instanceof ExternalObjectImpl);
    }

    /**
     * <p>Tests the failure of the ctor(long).</p>
