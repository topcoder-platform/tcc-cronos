...
public class MockBaseDBRetrieval extends BaseDBRetrieval {
     ...
     * factory.
     */
    public MockBaseDBRetrieval(String namespace)
        throws ConfigException {
    ...
    /**
     * <p>The retrieveObjects method delegates to its super.retrieveObjects(PreparedStatement).</p>
     *
    ...
    /**
     * <p>The createObject method implements the super's abstract method.</p>
     *
    ...
    protected ExternalObject createObject(ResultSet rs)
        ...
        return new ExternalProjectImpl(id, defaultVersionID, defaultVersionString);
    }

    /**
     * <p>The getConnection method delegates to its super.getConnection().</p>
     *
    ...
    /**
     * <p>The close method delegates to its super.close(PreparedStatement, Connection).</p>
     *
