...
public class RatingTypeUnitTest extends TestCase {
    ...
    /**
     * <p>The name of the development rating type, and the property name that stores the Assembly
     * phase number.</p>
     */
    ...
    /**
     * <p>The default integer code of the assembly phase.</p>
     */
    private static final int DEFAULTASSEMBLYCODE = 114;

    /**
     * <p>An RatingType instance for testing.</p>
     */
    ...
    /**
     * <p>Set defaultRatingType to null.</p>
     *
     * @throws Exception to JUnit.
     */
    ...
    /**
     * <p>Tests the accuracy of the getRatingType(String).</p>
     * <p>The RatingType instance should be created successfully.</p>
     */
    public void testGetRatingType_String() {

        assertNotNull("RatingInfo should be accurately created.", defaultRatingType);
        assertTrue("defaultRatingType should be instance of RatingType.",
                defaultRatingType instanceof RatingType);

        assertEquals("The name should be set correctly.",
                DESIGN_NAME, defaultRatingType.getName());
        assertEquals("The id should be set correctly.",
                DEFAULTDESIGNCODE, defaultRatingType.getId());
    }

    /**
     * <p>Tests the accuracy of the getRatingType(String).</p>
     * <p>The RatingType instance should be created successfully.</p>
     * <p>The type has been configured in the SampleConfig.xml</p>
     */
    public void testGetRatingType_String_Configured() {
        ...
        assertEquals("The name should be set correctly.",
                ASSEMBLY_NAME, defaultRatingType.getName());
        assertEquals("The id should be set correctly.",
                DEFAULTASSEMBLYCODE, defaultRatingType.getId());
    }

    /**
     * <p>Tests the accuracy of the getRatingType(String).</p>
     * <p>The RatingType instance should be created successfully.</p>
     * <p>The type has not been configured in the SampleConfig.xml</p>
     */
    public void testGetRatingType_String_Nonconfigured() {
        ...
        assertEquals("The name should be set correctly.",
                "None", defaultRatingType.getName());
        assertEquals("The id should be set correctly.",
                0, defaultRatingType.getId());
    }

    /**
     * <p>Tests the failure of the getRatingType(String).</p>
     * <p>If the given typeName is null, IllegalArgumentException should be thrown.</p>
     */
    ...
    /**
     * <p>Tests the failure of the getRatingType(String).</p>
     * <p>If the given typeName is empty after trimed, IllegalArgumentException should be thrown.</p>
     */
    ...
    /**
     * <p>Tests the accuracy of the getRatingType(int).</p>
     * <p>The RatingType instance should be created successfully.</p>
     */
    public void testGetRatingType_Int() {
        ...
        assertEquals("The name should be set correctly.",
                DEVELOPMENT_NAME, defaultRatingType.getName());
        assertEquals("The id should be set correctly.",
                DEFAULTDEVCODE, defaultRatingType.getId());
    }

    /**
     * <p>Tests the accuracy of the getRatingType(int).</p>
     * <p>The RatingType instance should be created successfully.</p>
     * <p>If the ratingType is not found, null should be returned.</p>
     */
    ...
    /**
     * <p>Tests the failure of the getRatingType(int).</p>
     * <p>If the given id is not positive, IllegalArgumentException should be thrown.</p>
     * <p>This test gives a zero as the parameter.</p>
     */
     ...
     * <p>Tests the failure of the getRatingType(int).</p>
     * <p>If the given id is not positive, IllegalArgumentException should be thrown.</p>
     * <p>This test gives a negative number as the parameter.</p>
     */
    ...
    /**
     * <p>Tests the accuracy of the method toString().</p>
     */
    public void testToString() {

        assertEquals("The string should be the same.",
                DESIGN_NAME, defaultRatingType.toString());
    }

    /**
     * <p>Tests the accuracy of the method hashCode().</p>
     */
    public void testHashCode() {

        assertEquals("The hashCode should be the same.",
                DESIGN_NAME.hashCode(), defaultRatingType.hashCode());
    }

    /**
     * <p>Tests the accuracy of the method equals().</p>
     * <p>The given parameter object is just equal to the defaultRatingType, they are both the RatingType
     * and they have the same hashCode.</p>
     */
    ...
    /**
     * <p>Tests the accuracy of the method equals().</p>
     * <p>The given parameter object is not equal to the defaultRatingType, they are both the RatingType
     * but they don't have the same hashCode.</p>
     */
    ...
    /**
     * <p>Tests the accuracy of the method equals().</p>
     * <p>The given parameter object is not equal to the defaultRatingType, the given object is null.</p>
     */
    public void testEquals_NonEqualsObject2() {

        assertFalse("These two objects should be non-equal.",
                defaultRatingType.equals(null));
    }

    /**
     * <p>Tests the accuracy of the method equals().</p>
     * <p>The given parameter object is not equal to the defaultRatingType, the given object is not null
     * but it is not the RatingType instance.</p>
     */
    public void testEquals_NonEqualsObject3() {

        assertFalse("These two objects should be non-equal.",
                defaultRatingType.equals(new Object()));
    }
}
