...
public final class UnitTestHelper {
    ...
    /**
     * <p>Creates a new instance of <code>UnitTestHelper</code> class. The private constructor prevents
     ...
     */
    public static void insertIntoComponentVersions(Connection conn)
        throws SQLException {
     ...
     * @throws SQLException if any db operation failed.
     */
    public static void insertIntoCompForumXref(Connection conn)
        throws SQLException {
     ...
     * @throws SQLException if any db operation failed.
     */
    public static void insertIntoComponentCataLog(Connection conn)
        throws SQLException {
     ...
     * @throws SQLException if any db operation failed.
     */
    public static void insertIntoEmail(Connection conn)
        throws SQLException {
     ...
     * @throws SQLException if any db operation failed.
     */
    public static void insertIntoUser(Connection conn)
        throws SQLException {
    ...
    /**
     * <p>Inserts into the user_rating table for testing.</p>
     *
     * @param conn the connection used.
     *
     * @throws SQLException if any db operation failed.
     */
    public static void insertIntoUserRating(Connection conn)
        throws SQLException {
    ...
    /**
     * <p>Inserts into the user_reliability table for testing.</p>
     *
     * @param conn the connection used.
     *
     * @throws SQLException if any db operation failed.
     */
    public static void insertIntoUserReliability(Connection conn)
        throws SQLException {
        ...
        Date currentDate = new Date(System.currentTimeMillis());
        PreparedStatement psInsert = conn.prepareStatement(
                "insert into user_reliability values(?, ?, ?, ?, ?)");
    ...
    /**
     * <p>Deletes from the comp_catalog, comp_versions and comp_forum_xref table after testing.</p>
     *
     * @param conn the connection used.
     ...
     * @throws SQLException if any db operation failed.
     */
    public static void cleanupTable(Connection conn, String tableName)
        throws SQLException {
