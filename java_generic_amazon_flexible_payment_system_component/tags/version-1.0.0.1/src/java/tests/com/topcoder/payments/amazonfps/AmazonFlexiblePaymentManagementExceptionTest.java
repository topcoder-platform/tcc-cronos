...
/**
 * <p>
 * Unit tests for {@link AmazonFlexiblePaymentManagementException} class.
 * </p>
 *
 * @author KennyAlive
 * @version 1.0
 */
public class AmazonFlexiblePaymentManagementExceptionTest {
    /**
    ...
    public static junit.framework.Test suite() {
        return new JUnit4TestAdapter(AmazonFlexiblePaymentManagementExceptionTest.class);
    }

    /**
     * <p>
     * Accuracy test for <code>AmazonFlexiblePaymentManagementException(String message)</code> constructor.
     * </p>
     *
     * <p>
    ...
    public void test_constructorMessage() {
        AmazonFlexiblePaymentManagementException instance = new AmazonFlexiblePaymentManagementException(MESSAGE);
    ...
    public void test_constructorMessage_2() {
        AmazonFlexiblePaymentManagementException instance = new AmazonFlexiblePaymentManagementException(null);
        assertNull("The message should be set to null", instance.getMessage());
    }

    /**
     * <p>
     * Accuracy test for <code>AmazonFlexiblePaymentManagementException(String message, Throwable cause)</code>
     * constructor.
     * </p>
     *
     * <p>
    ...
    public void test_constructorMessageCause() {
        AmazonFlexiblePaymentManagementException instance =
                new AmazonFlexiblePaymentManagementException(MESSAGE, CAUSE);
    ...
    /**
     * <p>
     * Accuracy test for <code>AmazonFlexiblePaymentManagementException(String message, ExceptionData data)</code>
     * constructor.
     * </p>
     *
     * <p>
    ...
    public void test_constructorMessageData() {
        AmazonFlexiblePaymentManagementException instance =
                new AmazonFlexiblePaymentManagementException(MESSAGE, EXCEPTION_DATA);
    ...
    /**
     * <p>
     * Accuracy test for <code>AmazonFlexiblePaymentManagementException(String, Throwable, ExceptionData)</code>
     * constructor.
     * </p>
     *
     * <p>
    ...
    public void test_constructorMessageCauseData() {
        AmazonFlexiblePaymentManagementException instance =
                new AmazonFlexiblePaymentManagementException(MESSAGE, CAUSE, EXCEPTION_DATA);
