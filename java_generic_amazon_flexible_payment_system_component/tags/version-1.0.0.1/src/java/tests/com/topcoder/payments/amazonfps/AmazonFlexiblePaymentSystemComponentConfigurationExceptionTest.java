...
/**
 * <p>
 * Unit tests for {@link AmazonFlexiblePaymentSystemComponentConfigurationException} class.
 * </p>
 *
 * @author KennyAlive
 * @version 1.0
 */
public class AmazonFlexiblePaymentSystemComponentConfigurationExceptionTest {
    /**
    ...
    public static junit.framework.Test suite() {
        return new JUnit4TestAdapter(AmazonFlexiblePaymentSystemComponentConfigurationExceptionTest.class);
    }

    /**
     * <p>
     * Accuracy test for <code>AmazonFlexiblePaymentSystemComponentConfigurationException(String message)</code>
     * constructor.
     * </p>
     *
     * <p>
    ...
    public void test_constructorMessage() {
        AmazonFlexiblePaymentSystemComponentConfigurationException instance =
                new AmazonFlexiblePaymentSystemComponentConfigurationException(MESSAGE);
    ...
    public void test_constructorMessage_2() {
        AmazonFlexiblePaymentSystemComponentConfigurationException instance =
                new AmazonFlexiblePaymentSystemComponentConfigurationException(null);
        assertNull("The message should be set to null", instance.getMessage());
    }

    /**
     * <p>
     * Accuracy test for <code>AmazonFlexiblePaymentSystemComponentConfigurationException(String, Throwable)</code>
     * constructor.
     * </p>
     *
     * <p>
    ...
    public void test_constructorMessageCause() {
        AmazonFlexiblePaymentSystemComponentConfigurationException instance =
                new AmazonFlexiblePaymentSystemComponentConfigurationException(MESSAGE, CAUSE);
    ...
    /**
     * <p>
     * Accuracy test for <code>AmazonFlexiblePaymentSystemComponentConfigurationException(String, ExceptionData)</code>
     * constructor.
     * </p>
     *
     * <p>
    ...
    public void test_constructorMessageData() {
        AmazonFlexiblePaymentSystemComponentConfigurationException instance =
                new AmazonFlexiblePaymentSystemComponentConfigurationException(MESSAGE, EXCEPTION_DATA);
    ...
    /**
     * <p>
     * Accuracy test for <code>AmazonFlexiblePaymentSystemComponentConfigurationException(String, Throwable,
    ...
    public void test_constructorMessageCauseData() {
        AmazonFlexiblePaymentSystemComponentConfigurationException instance =
                new AmazonFlexiblePaymentSystemComponentConfigurationException(MESSAGE, CAUSE, EXCEPTION_DATA);
