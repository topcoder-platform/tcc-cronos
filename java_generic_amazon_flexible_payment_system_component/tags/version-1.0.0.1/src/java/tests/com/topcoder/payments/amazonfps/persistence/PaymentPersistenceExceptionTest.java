...
/**
 * <p>
 * Unit tests for {@link PaymentPersistenceException} class.
 * </p>
 *
 * @author KennyAlive
 * @version 1.0
 */
public class PaymentPersistenceExceptionTest {
    /**
    ...
    public static junit.framework.Test suite() {
        return new JUnit4TestAdapter(PaymentPersistenceExceptionTest.class);
    }

    /**
     * <p>
     * Accuracy test for <code>PaymentPersistenceException(String message)</code> constructor.
     * </p>
     *
     * <p>
    ...
    public void test_constructorMessage() {
        PaymentPersistenceException instance = new PaymentPersistenceException(MESSAGE);
    ...
    public void test_constructorMessage_2() {
        PaymentPersistenceException instance = new PaymentPersistenceException(null);
        assertNull("The message should be set to null", instance.getMessage());
    }

    /**
     * <p>
     * Accuracy test for <code>PaymentPersistenceException(String message, Throwable cause)</code> constructor.
     * </p>
     *
     * <p>
    ...
    public void test_constructorMessageCause() {
        PaymentPersistenceException instance = new PaymentPersistenceException(MESSAGE, CAUSE);
    ...
    /**
     * <p>
     * Accuracy test for <code>PaymentPersistenceException(String message, ExceptionData data)</code> constructor.
     * </p>
     *
     * <p>
    ...
    public void test_constructorMessageData() {
        PaymentPersistenceException instance = new PaymentPersistenceException(MESSAGE, EXCEPTION_DATA);
    ...
    /**
     * <p>
     * Accuracy test for <code>PaymentPersistenceException(String message, Throwable cause, ExceptionData data)</code>
     * constructor.
     * </p>
     *
     * <p>
    ...
    public void test_constructorMessageCauseData() {
        PaymentPersistenceException instance = new PaymentPersistenceException(MESSAGE, CAUSE, EXCEPTION_DATA);
