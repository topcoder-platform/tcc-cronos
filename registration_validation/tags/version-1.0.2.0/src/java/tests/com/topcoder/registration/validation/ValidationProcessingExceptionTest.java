...
/**
 * <p>
 * Unit test cases for ValidationProcessingException.
 * </p>
 *
 * <p>
 ...
 * @version 1.0
 */
public class ValidationProcessingExceptionTest extends TestCase {
    /**
     * <p>
    ...
    /**
     * <p>
     * An exception instance used to create the ValidationProcessingException.
     * </p>
     */
     ...
     * </p>
     */
    public void testValidationProcessingException1() {
        ValidationProcessingException exception = new ValidationProcessingException(
                ERROR_MESSAGE);
        assertNotNull("Unable to instantiate ValidationProcessingException.",
                exception);
        assertEquals(
     ...
     * </p>
     */
    public void testValidationProcessingException2() {
        ValidationProcessingException exception = new ValidationProcessingException(
     ...
     *
     * <p>
     * Verifies ValidationProcessingException subclasses BaseException.
     * </p>
     */
    public void testValidationProcessingExceptionInheritance1() {
        ValidationProcessingException exception = new ValidationProcessingException(
                ERROR_MESSAGE);
        assertTrue(
                "ValidationProcessingException does not subclass Exception.",
     ...
     *
     * <p>
     * Verifies ValidationProcessingException subclasses
     * RegistrationValidationException.
     * </p>
     */
    public void testValidationProcessingExceptionInheritance2() {
        ValidationProcessingException exception = new ValidationProcessingException(
                ERROR_MESSAGE, CAUSE_EXCEPTION);
        assertTrue(
                "ValidationProcessingException does not subclass Exception.",
