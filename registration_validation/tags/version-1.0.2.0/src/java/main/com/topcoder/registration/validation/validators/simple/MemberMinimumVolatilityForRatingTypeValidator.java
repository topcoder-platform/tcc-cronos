 ...
 * @version 1.0
 */
public class MemberMinimumVolatilityForRatingTypeValidator extends
     ...
     *
     */
    private static final String CLASS_NAME = "MemberMinimumVolatilityForRatingTypeValidator";

    /**
     * <p>
     * Name of the property that stores the minimum volatility the user must
     ...
     *
     */
    private static final String MINMUM_VOLATILITY_PROPERTYNAME = "minimumVolatility";
    ...
    /**
     * <p>
     * Represents the minimum volatility the user must have for the given rating
     * type.
     * </p>
     * <p>
     ...
     *
     */
    private final int minimumVolatility;
    ...
    /**
     * Initializes the resource bundle, the minimum volatility and the rating
     * type based on the input parameters.
     *
     *
     * @param bundleInfo
     *            The resource bundle info
     * @param minimumVolatility
     *            the minimum volatility the user must have for the given rating
     *            type
     * @param ratingType
     ...
     * @throws IllegalArgumentException
     *             if minimumVolatility is negative or ratingType is null
     */
    public MemberMinimumVolatilityForRatingTypeValidator(BundleInfo bundleInfo,
            int minimumVolatility, RatingType ratingType) {
        super(bundleInfo);
        RegistrationValidationHelper.validateNotNegative(minimumVolatility,
                "minimumVolatility");
     ...
     */
    public MemberMinimumVolatilityForRatingTypeValidator(String namespace) {
        super("temporary");
        ...
        // Sets the minimum volatility
        this.minimumVolatility = RegistrationValidationHelper.getInteger(
                namespace, MINMUM_VOLATILITY_PROPERTYNAME).intValue();
    }

    /**
     * <p>
     * Checks if the user has a minimum required volatility.
     * </p>
     *
    ...
    public String getMessage(Object obj) {
        ...
        try {
            ...
            int volatility = ratingInfo.getVolatility();

            // Initializes the message to be null.
            // The message will be filled if the validation is failed.
            String message = null;

            // Fills the message if the user's volatility less than
            // this.minimumVolatility
            if (volatility < this.minimumVolatility) {
                ...
                data = RegistrationValidationHelper.appendInnerDataValue(data,
                        "MINIMUM_VOLATILITY", "" + this.minimumVolatility);
