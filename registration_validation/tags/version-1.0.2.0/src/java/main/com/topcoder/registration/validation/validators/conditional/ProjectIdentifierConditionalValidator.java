...
/**
 * A conditional validator that checks if the project is of a given ID to see if
 * validation should be performed. The validation only proceeds to an inner
 * validator if it is.
 * <p>
 ...
 * @version 1.0
 */
public class ProjectIdentifierConditionalValidator extends
     ...
     *
     */
    private static final String CLASS_NAME = "ProjectIdentifierConditionalValidator";
    ...
    /**
     * <p>
     * Name of the property that stores the the ID the project would have to
     ...
     *
     */
    private static final String PROJECT_ID_PROPERTYNAME = "projectId";
    ...
    /**
     * Initializes the inner validator and the project ID based on the input
     * parameters.
     *
     *
     ...
     *            validator is meet
     * @param projectId
     *            the ID the project would have to perform the validation
     * @throws IllegalArgumentException
     *             if innerValidator is null or projectId is negative
     */
    public ProjectIdentifierConditionalValidator(
            ConfigurableValidator innerValidator, long projectId) {
        super("temporary");
        RegistrationValidationHelper.validateNotNull(innerValidator,
                "innerValidator");
        RegistrationValidationHelper
                .validateNotNegative(projectId, "projectId");
        this.innerValidator = innerValidator;
        this.projectId = projectId;
    }

    /**
     * Initializes the inner validator and the project ID from configuration
     ...
     *             validator
     */
    public ProjectIdentifierConditionalValidator(String namespace) {
        super("temporary");
        ...
        try {
            ...
            // Gets the project id from the corresponding property
            this.projectId = RegistrationValidationHelper.getLong(namespace,
                    PROJECT_ID_PROPERTYNAME).longValue();
    ...
    /**
     * <p>
     * Checks if the project is of a given ID to see if validation should be
     * performed.
     * </p>
     *
     *
    ...
    public String getMessage(Object obj) {
        ...
        try {
            ...
            // Gets the project ID
            long id = validationInfo.getProject().getProjectHeader().getId();

            // Performs the inner validation if the project is of the
            // given ID
            if (id == this.projectId) {
                return innerValidator.getMessage(obj);
            }
