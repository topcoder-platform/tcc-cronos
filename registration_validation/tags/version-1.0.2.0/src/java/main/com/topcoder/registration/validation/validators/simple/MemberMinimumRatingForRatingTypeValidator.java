 ...
 * @version 1.0
 */
public class MemberMinimumRatingForRatingTypeValidator extends
     ...
     *
     */
    private static final String CLASS_NAME = "MemberMinimumRatingForRatingTypeValidator";

    /**
     * <p>
     * Name of the property that stores the minimum rating the user must have
     * for the given rating type.
     * </p>
     * <p>
     ...
     *
     */
    private static final String MINMUM_RATING_PROPERTYNAME = "minimumRating";
    ...
    /**
     * <p>
     * Represents the minimum rating the user must have for the given rating
     * type.
     * </p>
     * <p>
    ...
    /**
     * Initializes the resource bundle, the minimum rating and the rating type
     ...
     * @param minimumRating
     *            the minimum rating the user must have for the given rating
     *            type
     * @param ratingType
     ...
     * @throws IllegalArgumentException
     *             if minimumRating is negative or ratingType is null
     */
    public MemberMinimumRatingForRatingTypeValidator(BundleInfo bundleInfo,
            int minimumRating, RatingType ratingType) {
        super(bundleInfo);
        RegistrationValidationHelper.validateNotNegative(minimumRating,
                "minimumRating");
    ...
    /**
     * Initializes the resource bundle, the minimum rating and the rating type
     * from configuration information of the <b>ConfigManager</b>.
     *
     * @param namespace
     ...
     */
    public MemberMinimumRatingForRatingTypeValidator(String namespace) {
        super("temporary");
        ...
        this.minimumRating = RegistrationValidationHelper.getInteger(namespace,
                MINMUM_RATING_PROPERTYNAME).intValue();
    }

    /**
     * <p>
     * Checks if the user has a minimum required rating.
     * </p>
     *
