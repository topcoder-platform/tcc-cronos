 ...
 * <code>MemberNotRegisteredWithRoleForProjectValidator extends</code> class.
 * 
 * @author TCSDEVELOPER
 * @version 1.0
 */
public class AccuracyTestMemberNotRegisteredWithRoleForProjectValidator extends TestCase {
	/**
	...
	/**
	 * The MemberNotRegisteredWithRoleForProjectValidator instance used to test.
	 */
	...
	protected void setUp() throws Exception {
		...
		validator = new MemberNotRegisteredWithRoleForProjectValidator(
				"MemberNotRegisteredWithRoleForProjectValidator.ns");
	...
	/**
	 * Function test : Tests
	 * <code>MemberNotRegisteredWithRoleForProjectValidator(BundleInfo bundleInfo,
	 ...
	 *             to JUnit.
	 */
	public void testMemberNotRegisteredWithRoleForProjectValidator1Accuracy() throws Exception {
		assertNotNull("Null is allowed.", new MemberNotRegisteredWithRoleForProjectValidator(bundleInfo, 4));
	}
	...
	public void testGetMessageAccuracy2() throws Exception {
		validator = new MemberNotRegisteredWithRoleForProjectValidator(bundleInfo, 3);
		AccuracyTestHelper.setLog(validator);
		String msg = validator.getMessage(AccuracyTestHelper.createValidationInfo());
