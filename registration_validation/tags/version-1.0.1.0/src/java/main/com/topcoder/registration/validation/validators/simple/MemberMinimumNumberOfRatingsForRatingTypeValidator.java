...
/**
 * A simple validator that checks if the user has a minimum required number of
 * ratings.
 * <p>
 ...
 * @version 1.0
 */
public class MemberMinimumNumberOfRatingsForRatingTypeValidator extends
     ...
     *
     */
    private static final String CLASS_NAME = "MemberMinimumNumberOfRatingsForRatingTypeValidator";

    /**
     * <p>
     * Name of the property that stores the minimum number of ratings the user
     * must have for the given rating type.
     * </p>
     * <p>
     ...
     *
     */
    private static final String MINMUM_NUM_RATINGS_PROPERTYNAME = "minimumNumRatings";
     ...
     *
     */
    private final int minimumNumRatings;
    ...
    /**
     * Initializes the resource bundle, the minimum number of ratings and the
     * rating type based on the input parameters.
     *
     * @param bundleInfo
     *            The resource bundle info
     * @param minimumNumRatings
     *            the minimum number of ratings the user must have for the given
     *            rating type
     * @param ratingType
     ...
     * @throws IllegalArgumentException
     *             if minimumNumRatings is negative or ratingType is null
     */
    public MemberMinimumNumberOfRatingsForRatingTypeValidator(
            BundleInfo bundleInfo, int minimumNumRatings, RatingType ratingType) {
        super(bundleInfo);
        RegistrationValidationHelper.validateNotNegative(minimumNumRatings,
                "minimumNumRatings");
        RegistrationValidationHelper.validateNotNull(ratingType, "ratingType");
        this.minimumNumRatings = minimumNumRatings;
        this.ratingType = ratingType;
    }

    /**
     * Initializes the resource bundle, the minimum number of ratings and the
     * rating type from configuration information from the <b>ConfigManager</b>.
     *
     * @param namespace
     ...
     */
    public MemberMinimumNumberOfRatingsForRatingTypeValidator(String namespace) {
        super("temporary");
        ...
        // Sets the minimum number of ratings
        this.minimumNumRatings = RegistrationValidationHelper.getInteger(
                namespace, MINMUM_NUM_RATINGS_PROPERTYNAME).intValue();
    }

    /**
     * <p>
     * Checks if the user has a minimum required number of ratings.
     * </p>
     *
    ...
    public String getMessage(Object obj) {
        ...
        try {
            ...
            // Gets the number of ratings of the user.
            ...
            int numRatings = ratingInfo.getNumRatings();

            // Initializes the message to be null.
            // The message will be filled if the validation is failed.
            String message = null;

            // Fills the message if the user's number of ratings less than
            // this.minimumNumRatings
            if (numRatings < this.minimumNumRatings) {
                ...
                data = RegistrationValidationHelper.appendInnerDataValue(data,
                        "MINIMUM_NUM_RATINGS", "" + this.minimumNumRatings);
                data = RegistrationValidationHelper.appendInnerDataValue(data,
