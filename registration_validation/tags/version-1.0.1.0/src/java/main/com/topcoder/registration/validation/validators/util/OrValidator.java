...
/**
 * A wrapper around the Data Validation&rsquo;s OrValidator to provide logging
 ...
 * @version 1.0
 */
public class OrValidator extends com.topcoder.util.datavalidator.OrValidator
     ...
     *
     */
    private static final String CLASS_NAME = "OrValidator";
    ...
    /**
     * Creates a new OrValidator, with initially associated to the given
     ...
     */
    public OrValidator(ConfigurableValidator[] validators,
     ...
     *             validators
     */
    public OrValidator(String namespace) {
        super();
     ...
     * associated validators is empty, this returns false.
     *
     *
