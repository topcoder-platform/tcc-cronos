...
/**
 * This class contains unit tests for <code>ProjectOfCategoryValidator</code>
 * class.
 * 
 * @author TCSDEVELOPER
 * @version 1.0
 */
public class AccuracyTestProjectOfCategoryValidator extends TestCase {
	/**
	...
	/**
	 * The ProjectOfCategoryValidator instance used to test.
	 */
	...
	protected void setUp() throws Exception {
		...
		validator = new ProjectOfCategoryValidator("ProjectOfCategoryValidator.ns");
	...
	/**
	 * Function test : Tests
	 * <code>ProjectOfCategoryValidator(BundleInfo bundleInfo,
	 ...
	 *             to JUnit.
	 */
	public void testProjectOfCategoryValidator1Accuracy() throws Exception {
		assertNotNull("Null is allowed.", new ProjectOfCategoryValidator(bundleInfo, 1));
	}
	...
	public void testGetMessageAccuracy2() throws Exception {
		validator = new ProjectOfCategoryValidator(bundleInfo, 3);
		AccuracyTestHelper.setLog(validator);
