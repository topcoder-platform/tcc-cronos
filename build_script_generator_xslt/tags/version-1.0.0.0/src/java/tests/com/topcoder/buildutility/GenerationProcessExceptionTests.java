...
/**
 * Unit tests for the <code>GenerationProcessException</code> class. Verify the correct functioning of both
 * constructors.
 *
 * @author marijnk
 * @version 1.0
...
public class GenerationProcessExceptionTests extends TestCase {
    ...
    public void testConstructorMessage() {
        GenerationProcessException e = new GenerationProcessException("foobar");
    ...
    public void testConstructorMessageCause() {
        ...
        GenerationProcessException e = new GenerationProcessException("foobar", cause);
