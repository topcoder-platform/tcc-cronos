...
/**
 * <p>
 * <code>RelativeWeekTimeStartDateGenerator</code> is the initial built-in
 * implementation of <code>{@link StartDateGenerator}</code> interface.
 * </p>
 * <p>
 ...
 * <b>weekOffset</b>
 * <br>
 * Week offset determines in WHICH week the time will be generated.
 * <br>
 * For example, a weekOffset 1 tells us that a relative time in the
 * NEXT(from current) week will be generated, a weekOffset 0 tell us that
 * a relative time in THIS(current) week will be generated.
 * </li>
 * <li>
 * <b>dayOfWeek</b>
 * <br>
 * dayOfWeek is a number which determines in WHICH day the time will be generated.
 * The values is from 1 to 7, which represents SUNDAY to SATURDAY respectively
 * (this is consistent with the <code>java.util.Calendar</code> definitions).
 * <br>
 * For example, a dayOfWeek 1 tells us that a relative time in SUNDAY will be generated.
 * </li>
 * <li>
 * <b>hour</b>
 * <br>
 * hour determines the hour component of the time to generate.
 * hour values are in 24-hour clock, values 0-23 is acceptable.
 * <br>
 * For example, an hour 9 tells us that the hour component is 9 AM,
 * while an hour 15 tells us that the hour component is 3 PM.
 * </li>
 * <li>
 * <b>minute</b>
 * <br>
 * minute component of the time to generate, values 0-59 are acceptable.
 * </li>
 * <li>
 * <b>second</b>
 * <br>
 * second component of the time to generate, values 0-59 are acceptable.
 * </li>
 * </ol>
 * <p>
 * For example, given the next values: (weekOffSet, dayOfWeek, hour, minute,
 * second) = (1, 5, 9, 0, 0), then 9:00:00 AM next Thursday will be generated,
 * just as the TCS project posting time in the next week.
 * </p>
 * <p>
 * <code>RelativeWeekTimeStartDateGenerator</code> can be created from configuration,
 * please consult the component specification and sample configuration file
 * (docs/Relative_Week_Time_Start_Date_Generator.xml) for details.
 * </p>
 * <p>
...
public class RelativeWeekTimeStartDateGenerator implements StartDateGenerator {
    ...
    /**
     * <p>
     * Check if a given integer falls in the given range. If it is out of the
     * given range, <code>IllegalArgumentException</code> will be thrown, otherwise the
     * integer will be returned.
     * </p>
     * @param range the valid range, the first element is the min value, the second is the max value
     * @param actual the actual value
     * @param paramName the name of the param
     * @return the actual integer if it falls in the given range
     * @throws IllegalArgumentException if actual doesn't fall in the given range
     */
