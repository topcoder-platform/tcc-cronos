...
/**
 * <p>
 * Stress test for <code>ActionRequiredPhaseHandler</code> class. Mainly focus on the following
 * function's performance:
 * <ul>
 * <li>AbandonedPhaseHandler#perform(Phase, String)</li>
 * </ul>
 * </p>
 *
 * @author Littleken
 * @version 1.0
 */
public class ActionRequiredPhaseHandlerStressTest extends StressTestCase {

    /**
     * <p>
     * Test method <code>ActionRequiredPhaseHandler#perform(Phase, String)</code> for stress
     * tests.
     * </p>
     *
     * @throws Exception
     *             to JUnit.
     */
    public void testActionRequiredPhaseHandlerPerformStress() throws Exception {
        long totalTime = 0;

        // Starts the SMTP server.
        startServer();

        ActionRequiredPhaseHandler handler = new ActionRequiredPhaseHandler();
        ...
        try {
            for (int i = 0; i < LOOP; ++i) {
                ...
                // Contest status has been update as "Action Required", should not be null.
        ...
        System.out.println("Run ActionRequiredPhaseHandler#perform(Phase, String) for " + LOOP + " times consumes "
    ...
    private Phase getPhase() throws Exception {
        ...
        // Sets phase type.
        PhaseType abandonedPhaseType = new PhaseType(2, "Action Required");
