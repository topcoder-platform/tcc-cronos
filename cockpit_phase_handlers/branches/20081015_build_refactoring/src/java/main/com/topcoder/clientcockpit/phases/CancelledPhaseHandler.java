 ...
 *
 * <p>
 * The "Cancelled" phase can always be started or ended as long as it has not already been ended.
 * </p>
 *
 * <p>
 ...
 *
 *     PhaseType cancelledType = ...;
 *
 *     //Create handler
 *     CancelledPhaseHandler handler = new CancelledPhaseHandler();
 *
 *     //Register handler to start and end operations
 *     manager.registerHandler(handler, cancelledType, PhaseOperationEnum.START);
 *     manager.registerHandler(handler, cancelledType, PhaseOperationEnum.END);
 *
 *     Phase phase = ...;
 *     //Set phase type
 *     phase.setPhaseType(cancelledType);
 *
 ...
 *     //And the phase.project.contest.status has been updated by handler to "Cancelled"
 *
 *     //End
 ...
 */
public class CancelledPhaseHandler extends AbstractPhaseHandler {
     ...
     */
    public CancelledPhaseHandler() throws PhaseHandlingException {
        super();
    }
     ...
     *
     */
    public CancelledPhaseHandler(ContestManager bean) throws PhaseHandlingException {
        super(bean);
    }
     ...
     * @throws PhaseHandlingException If error while looking up <code>ContestManager</code> by JNDI.
     */
    public CancelledPhaseHandler(String namespace) throws PhaseHandlingException {
        super(namespace);
    }
     ...
     *
     */
    public CancelledPhaseHandler(String namespace, ContestManager bean) throws PhaseHandlingException {
     ...
     *     If given phase type is not "Cancelled", false is returned.
     * </p>
     *
     * <p>
    ...
    public boolean canPerform(Phase phase) throws PhaseHandlingException {
        return super.canPerform(phase, CockpitPhase.CANCELLED);
    }

    /**
     * <p>
     * This method will execute extra logic if the phase was started or ended. The phase must be a "Cancelled" phase.
     * </p>
     *
     * <p>
     ...
     *
     * @throws IllegalArgumentException If phase is null or if the phase is not a Cancelled phase
     *         (<code>phase.phaseType.name</code> is not "Cancelled").
     * @throws PhaseHandlingException If phase's <code>phaseType</code> or <code>phaseStatus</code> property is null.
     *         Or if its project does not contain a valid <em>contest</em> attribute.
    ...
    public void perform(Phase phase, String operator) throws PhaseHandlingException {
        super.perform(phase, CockpitPhase.CANCELLED);
    }
}
