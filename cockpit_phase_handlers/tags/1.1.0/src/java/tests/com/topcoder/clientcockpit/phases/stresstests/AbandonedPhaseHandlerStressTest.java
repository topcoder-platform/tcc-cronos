...
/**
 * <p>
 * Stress test for <code>AbandonedPhaseHandler</code> class. Mainly focus on the following
 ...
 * @version 1.0
 */
public class AbandonedPhaseHandlerStressTest extends StressTestCase {

    /**
     * <p>
     * Test method <code>AbandonedPhaseHandler#perform(Phase, String)</code> for stress tests.
     * </p>
     *
     * @throws Exception
     *             to JUnit.
     */
    public void testAbandonedPhaseHandlerPerformStress() throws Exception {
        long totalTime = 0;
        ...
        System.out.println("Run AbandonedPhaseHandler#perform(Phase, String) for " + LOOP + " times consumes "
    ...
    private Phase getPhase() throws Exception {
        ...
        // Sets phase type.
        PhaseType abandonedPhaseType = new PhaseType(1, "Abandoned");
