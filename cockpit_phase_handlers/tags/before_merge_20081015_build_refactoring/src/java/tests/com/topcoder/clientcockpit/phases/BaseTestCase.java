...
public class BaseTestCase extends TestCase {
     ...
     * @param winnerAnnoucementDeadline winner pickup dead line.
     * @param status contest status.
     *
     * @return instance of <code>Contest</code> created.
     */
    protected Contest createContest(Date startDate, Date endDate, Date winnerAnnoucementDeadline,
     ...
     * </p>
     *
     * @param throwError Indicates whether need raise exception when <code>ContestManager.updateContest(Contest)</code>.
     *
     * @throws Exception to JUnit.
     */
    ...
    private void assertEmailRawContent() {
        ...
        assertTrue(emailChecker.getReceived().indexOf(
            "Date is " + DATE + ", operator is guy, cost is 2$.") > 0);
    }
     ...
     * </p>
     *
     * @param phase to populate attributes.
     * @param contest contest.
     *
    ...
    protected void populateAttributes(Phase phase, Contest contest) {
        ...
        phase.getProject().setAttribute(TestHelper.PROJECT_ATTR_RESOURCE_EMAILS, (ArrayList) toAddresses);
