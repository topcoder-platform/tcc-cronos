...
/**
 * <p>
 * Stress test for <code>CancelledPhaseHandler</code> class. Mainly focus on the following
 * function's performance:
 * <ul>
 * <li>CancelledPhaseHandler#perform(Phase, String)</li>
 * </ul>
 * </p>
 *
 * @author Littleken
 * @version 1.0
 */
public class CancelledPhaseHandlerStressTest extends StressTestCase {

    /**
     * <p>
     * Test method <code>CancelledPhaseHandler#perform(Phase, String)</code> for stress tests.
     * </p>
     *
     * @throws Exception
     *             to JUnit.
     */
    public void testCancelledPhaseHandlerPerformStress() throws Exception {
        long totalTime = 0;
        ...
        System.out.println("Run CancelledPhaseHandler#perform(Phase, String) for " + LOOP + " times consumes "
    ...
    private Phase getPhase() throws Exception {
        ...
        // Sets phase type.
        PhaseType abandonedPhaseType = new PhaseType(4, "Cancelled");
