...
public class TestHelper {
     ...
     * </p>
     */
    public static final String DEFAULT_NAMESPACE = AbstractPhaseHandler.class.getPackage().getName();
    ...
    public interface CockpitPhaseType {
         ...
         * </p>
         */
        public static final PhaseType INSUFFICIENT_SUBMISSIONS_RE_RUN_POSSIBLE =
            new PhaseType(6, "Insufficient Submissions - ReRun Possible");
