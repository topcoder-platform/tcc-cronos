...
/**
 * <p>
 * Accuracy tests for the <code>InsufficientSubmissionsPhaseHandler</code> class.
 * </p>
 *
 * @author TCSDEVELOPER
 * @version 1.0
 */
public class InsufficientSubmissionsPhaseHandlerAccuracyTest extends BaseTestCase {

    /**
     * <p>
     * Accuracy test for the constructor <code>InsufficientSubmissionsPhaseHandler()</code>, expects the instance
     * is created properly.
     * </p>
     *
     * @throws Exception
    ...
    /**
     * <p>
     * Accuracy test for the constructor <code>InsufficientSubmissionsPhaseHandler(ContestManager)</code>, expects
    ...
    /**
     * <p>
     * Accuracy test for the constructor <code>InsufficientSubmissionsPhaseHandler(String)</code>, expects the
    ...
    /**
     * <p>
     * Accuracy test for the constructor <code>InsufficientSubmissionsPhaseHandler(String, ContestManager)</code>,
    ...
    public void testCanPerformAccuracy1() throws Exception {
        ...
        assertFalse("The ActionRequired phase can not be performed.", this.getInsufficientSubmissionsPhaseHandler()
                .canPerform(phase));
    }
    ...
    public void testCanPerformAccuracy2() throws Exception {
        Phase phase = this.createPhase(PhaseStatus.CLOSED, CockpitPhaseType.INSUFFICIENT_SUBMISSIONS);
    ...
    public void testCanPerformAccuracy3() throws Exception {
        ...
        assertFalse("The Extended phase can not be performed.", this.getInsufficientSubmissionsPhaseHandler()
                .canPerform(phase));
    }
    ...
    public void testCanPerformAccuracy4() throws Exception {
        ...
        assertFalse("The InsufficientSubmissions phase can not start.", this.getInsufficientSubmissionsPhaseHandler()
                .canPerform(phase));
    }
    ...
    public void testCanPerformAccuracy5() throws Exception {
        ...
        assertTrue("The InDanger phase can end.", this.getInsufficientSubmissionsPhaseHandler().canPerform(phase));
    }
    ...
    public void testCanPerformAccuracy7() throws Exception {
        ...
        assertFalse("The InsufficientSubmissions phase can not end.", this.getInsufficientSubmissionsPhaseHandler()
                .canPerform(phase));
    }
    ...
    public void testPerformAccuracy2() throws Exception {
        Phase phase = this.createPhase(PhaseStatus.OPEN, CockpitPhaseType.INSUFFICIENT_SUBMISSIONS);
        Contest contest = this.createContest(null, null, null, CockpitContestStatus.INSUFFICIENT_SUBMISSIONS);
        this.populateAttributes(phase, contest);
        this.mockContestManager(false);
