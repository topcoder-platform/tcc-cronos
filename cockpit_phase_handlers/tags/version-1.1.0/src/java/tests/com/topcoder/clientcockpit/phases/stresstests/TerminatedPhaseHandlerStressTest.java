...
/**
 * <p>
 * Stress test for <code>TerminatedPhaseHandler</code> class. Mainly focus on the following
 * function's performance:
 * <ul>
 * <li>TerminatedPhaseHandler#perform(Phase, String)</li>
 * </ul>
 * </p>
 *
 * @author Littleken
 * @version 1.0
 */
public class TerminatedPhaseHandlerStressTest extends StressTestCase {

    /**
     * <p>
     * Test method <code>TerminatedPhaseHandler#perform(Phase, String)</code> for stress tests.
     * </p>
     *
     * @throws Exception
     *             to JUnit.
     */
    public void testTerminatedPhaseHandlerPerformStress() throws Exception {
        long totalTime = 0;
        ...
        try {
            for (int i = 0; i < LOOP; ++i) {
                ...
                // Contest status has been update as "Terminated", should not be null.
        ...
        System.out.println("Run TerminatedPhaseHandler#perform(Phase, String) for " + LOOP + " times consumes "
    ...
    private Phase getPhase() throws Exception {
        ...
        // Sets phase type.
        PhaseType abandonedPhaseType = new PhaseType(15, "Terminated");
