...
/**
 * <p>
 * Stress test for <code>InsufficientSubmissionsPhaseHandler</code> class. Mainly focus on the
 * following function's performance:
 * <ul>
 * <li>InsufficientSubmissionsPhaseHandler#perform(Phase, String)</li>
 * </ul>
 * </p>
 *
 * @author Littleken
 * @version 1.0
 */
public class InsufficientSubmissionsPhaseHandlerStressTest extends StressTestCase {

    /**
     * <p>
     * Test method <code>InsufficientSubmissionsPhaseHandler#perform(Phase, String)</code> for
     * stress tests.
     * </p>
     *
     * @throws Exception
     *             to JUnit.
     */
    public void testInsufficientSubmissionsPhaseHandlerPerformStress() throws Exception {
        long totalTime = 0;
        ...
        try {
            for (int i = 0; i < LOOP; ++i) {
                ...
                // Contest status has been update as "Insufficient Submissions",
                // should not be null.
        ...
        System.out.println("Run InsufficientSubmissionsPhaseHandler#perform(Phase, String) for " + LOOP
    ...
    private Phase getPhase() throws Exception {
        ...
        // Sets phase type.
        PhaseType abandonedPhaseType = new PhaseType(10, "Insufficient Submissions");
