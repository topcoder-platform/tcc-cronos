...
/**
 * <p>
 * Stress test for <code>NoWinnerChosenPhaseHandler</code> class. Mainly focus on the following
 * function's performance:
 * <ul>
 * <li>NoWinnerChosenPhaseHandler#perform(Phase, String)</li>
 * </ul>
 * </p>
 *
 * @author Littleken
 * @version 1.0
 */
public class NoWinnerChosenPhaseHandlerStressTest extends StressTestCase {

    /**
     * <p>
     * Test method <code>NoWinnerChosenPhaseHandler#perform(Phase, String)</code> for stress
     * tests.
     * </p>
     *
     * @throws Exception
     *             to JUnit.
     */
    public void testNoWinnerChosenPhaseHandlerPerformStress() throws Exception {
        long totalTime = 0;
        ...
        try {
            for (int i = 0; i < LOOP; ++i) {
                ...
                // Contest status has been update as "No Winner Chosen",
                // should not be null.
        ...
        System.out.println("Run NoWinnerChosenPhaseHandler#perform(Phase, String) for " + LOOP + " times consumes "
    ...
    private Phase getPhase() throws Exception {
        ...
        // Sets phase type.
        PhaseType abandonedPhaseType = new PhaseType(12, "No Winner Chosen");
