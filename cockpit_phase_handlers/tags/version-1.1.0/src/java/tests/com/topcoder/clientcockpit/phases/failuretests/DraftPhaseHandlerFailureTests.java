...
/**
 * <p>
 * Failure test cases for DraftPhaseHandler.
 * </p>
 *
 * @author victorsam
 * @version 1.0
 */
public class DraftPhaseHandlerFailureTests extends TestCase {

    /**
     * <p>
     * The DraftPhaseHandler instance for testing.
     * </p>
     */
    private DraftPhaseHandler instance;
    ...
    protected void setUp() throws Exception {
        ...
        instance = new DraftPhaseHandler();
    }
    ...
    public static Test suite() {
        return new TestSuite(DraftPhaseHandlerFailureTests.class);
    }

    /**
     * <p>
     * Tests ctor DraftPhaseHandler#DraftPhaseHandler(String,ContestManager) for failure.
    ...
    public void testCtor1_NullNamespace() throws Exception {
        try {
            new DraftPhaseHandler(null, new MockContestManager());
    ...
    public void testCtor1_EmptyNamespace() throws Exception {
        try {
            new DraftPhaseHandler(" ", new MockContestManager());
            fail("IllegalArgumentException expected.");
        } catch (IllegalArgumentException iae) {
            //good
        }
    ...
    public void testCtor1_NullBean() throws Exception {
        try {
            new DraftPhaseHandler("com.topcoder.clientcockpit.phases", null);
            fail("IllegalArgumentException expected.");
        } catch (IllegalArgumentException iae) {
            //good
        }
    ...
    /**
     * <p>
     * Tests ctor DraftPhaseHandler#DraftPhaseHandler(String) for failure.
     * It tests the case that when namespace is null and expects IllegalArgumentException.
     * </p>
     * @throws Exception to JUnit
     */
    ...
    /**
     * <p>
     * Tests ctor DraftPhaseHandler#DraftPhaseHandler(ContestManager) for failure.
     * It tests the case that when bean is null and expects IllegalArgumentException.
     * </p>
     * @throws Exception to JUnit
     */
    ...
    /**
     * <p>
     * Tests DraftPhaseHandler#canPerform(Phase) for failure.
    ...
    /**
     * <p>
     * Tests DraftPhaseHandler#perform(Phase,String) for failure.
     * It tests the case that when phase is null and expects IllegalArgumentException.
     * </p>
     * @throws Exception to JUnit
     */
