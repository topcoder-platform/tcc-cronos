...
/**
 * <p>
 * Failure test cases for TerminatedPhaseHandler.
 * </p>
 *
 * @author victorsam
 * @version 1.0
 */
public class TerminatedPhaseHandlerFailureTests extends TestCase {

    /**
     * <p>
     * The TerminatedPhaseHandler instance for testing.
     * </p>
     */
    private TerminatedPhaseHandler instance;
    ...
    protected void setUp() throws Exception {
        ...
        instance = new TerminatedPhaseHandler();
    }
    ...
    public static Test suite() {
        return new TestSuite(TerminatedPhaseHandlerFailureTests.class);
    }

    /**
     * <p>
     * Tests ctor TerminatedPhaseHandler#TerminatedPhaseHandler(String,ContestManager) for failure.
    ...
    public void testCtor1_NullNamespace() throws Exception {
        try {
            new TerminatedPhaseHandler(null, new MockContestManager());
    ...
    public void testCtor1_EmptyNamespace() throws Exception {
        try {
            new TerminatedPhaseHandler(" ", new MockContestManager());
            fail("IllegalArgumentException expected.");
        } catch (IllegalArgumentException iae) {
            //good
        }
    ...
    public void testCtor1_NullBean() throws Exception {
        try {
            new TerminatedPhaseHandler("com.topcoder.clientcockpit.phases", null);
            fail("IllegalArgumentException expected.");
        } catch (IllegalArgumentException iae) {
            //good
        }
    ...
    /**
     * <p>
     * Tests ctor TerminatedPhaseHandler#TerminatedPhaseHandler(String) for failure.
     * It tests the case that when namespace is null and expects IllegalArgumentException.
     * </p>
     * @throws Exception to JUnit
     */
    ...
    /**
     * <p>
     * Tests ctor TerminatedPhaseHandler#TerminatedPhaseHandler(ContestManager) for failure.
     * It tests the case that when bean is null and expects IllegalArgumentException.
     * </p>
     * @throws Exception to JUnit
     */
    ...
    /**
     * <p>
     * Tests TerminatedPhaseHandler#canPerform(Phase) for failure.
    ...
    /**
     * <p>
     * Tests TerminatedPhaseHandler#perform(Phase,String) for failure.
     * It tests the case that when phase is null and expects IllegalArgumentException.
     * </p>
     * @throws Exception to JUnit
     */
    public void testPerform_NullPhase() throws Exception {
        try {
            instance.perform(null, "Terminated");
            fail("IllegalArgumentException expected.");
        } catch (IllegalArgumentException iae) {
            //good
        }
