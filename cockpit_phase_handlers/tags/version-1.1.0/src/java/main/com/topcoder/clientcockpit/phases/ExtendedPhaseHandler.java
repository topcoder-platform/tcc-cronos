 ...
 *
 *     PhaseType extendedType = ...;
 *
 *     //Create handler
 *     ExtendedPhaseHandler handler = new ExtendedPhaseHandler();
 *
 *     //Register handler to start and end operations
 *     manager.registerHandler(handler, extendedType, PhaseOperationEnum.START);
 *     manager.registerHandler(handler, extendedType, PhaseOperationEnum.END);
 *
 *     Phase phase = ...;
 *     //Set phase type
 *     phase.setPhaseType(extendedType);
 *
 ...
 *     //And the phase.project.contest.status has been updated by handler to "Extended"
 *
 *     //End
 ...
 */
public class ExtendedPhaseHandler extends AbstractPhaseHandler {
     ...
     */
    public ExtendedPhaseHandler() throws PhaseHandlingException {
        super();
    }
     ...
     *
     */
    public ExtendedPhaseHandler(ContestManager bean) throws PhaseHandlingException {
        super(bean);
    }
     ...
     * @throws PhaseHandlingException If error while looking up <code>ContestManager</code> by JNDI.
     */
    public ExtendedPhaseHandler(String namespace) throws PhaseHandlingException {
        super(namespace);
    }
     ...
     *
     */
    public ExtendedPhaseHandler(String namespace, ContestManager bean) throws PhaseHandlingException {
     ...
     *     If given phase type is not "Extended", false is returned.
     * </p>
     *
     * <p>
     ...
     * <ul>
     *     <li>If contest fails to get the required number of submissions during its first run through, then the phase
     *     can be started;
     *     </li>
    ...
    public boolean canPerform(Phase phase) throws PhaseHandlingException {
        return super.canPerform(phase, CockpitPhase.EXTENDED);
    }

    /**
     * <p>
     * Override the base method to determine whether the Extended phase can start.
     * </p>
     *
    ...
    protected boolean canStart(Phase phase, Contest contest) throws PhaseHandlingException {
        //Start case: if a contest fails to get the required number of submissions during its first run through.
        return !isEnoughSubmissionsReceived(phase, contest);
    }

    /**
     * <p>
     * Override the base method to determine whether the Extended phase can end.
     * </p>
     *
    ...
    /**
     * <p>
     * This method will execute extra logic if the phase was started or ended. The phase must be an "Extended" phase.
     * </p>
     *
     * <p>
     ...
     *
     * @throws IllegalArgumentException If phase is null or if the phase is not an Extended phase
     *         (<code>phase.phaseType.name</code> is not "Extended").
     * @throws PhaseHandlingException If phase's <code>phaseType</code> or <code>phaseStatus</code> property is null.
     *         Or if its project does not contain a valid <em>contest</em> attribute.
    ...
    public void perform(Phase phase, String operator) throws PhaseHandlingException {
        super.perform(phase, CockpitPhase.EXTENDED);
    }
}
