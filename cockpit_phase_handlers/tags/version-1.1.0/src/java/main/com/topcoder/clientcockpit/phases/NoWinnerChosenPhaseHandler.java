 ...
 *
 *     PhaseType noWinnerChosenType = ...;
 *
 *     //Create handler
 *     NoWinnerChosenPhaseHandler handler = new NoWinnerChosenPhaseHandler();
 *
 *     //Register handler to start and end operations
 *     manager.registerHandler(handler, noWinnerChosenType, PhaseOperationEnum.START);
 *     manager.registerHandler(handler, noWinnerChosenType, PhaseOperationEnum.END);
 *
 *     Phase phase = ...;
 *     //Set phase type
 *     phase.setPhaseType(noWinnerChosenType);
 *
 ...
 *     //And the phase.project.contest.status has been updated by handler to "NoWinnerChosen"
 *
 *     //End
 ...
 */
public class NoWinnerChosenPhaseHandler extends AbstractPhaseHandler {
     ...
     */
    public NoWinnerChosenPhaseHandler() throws PhaseHandlingException {
        super();
    }
     ...
     *
     */
    public NoWinnerChosenPhaseHandler(ContestManager bean) throws PhaseHandlingException {
        super(bean);
    }
     ...
     * @throws PhaseHandlingException If error while looking up <code>ContestManager</code> by JNDI.
     */
    public NoWinnerChosenPhaseHandler(String namespace) throws PhaseHandlingException {
        super(namespace);
    }
     ...
     *
     */
    public NoWinnerChosenPhaseHandler(String namespace, ContestManager bean) throws PhaseHandlingException {
     ...
     *     If given phase type is not "No Winner Chosen", false is returned.
     * </p>
     *
     * <p>
     ...
     * <ul>
     *     <li>If <code>Contest.endDate</code> has been reached and the minimum number of submissions has been reached,
     *     then the phase can be started;
     *     </li>
     ...
     *         Or if phase's project does not contain a valid <em>MinimumSubmissions</em> attribute(which should be a
     *         non-null <code>Number</code>).
     */
    public boolean canPerform(Phase phase) throws PhaseHandlingException {
        return super.canPerform(phase, CockpitPhase.NO_WINNER_CHOSEN);
    }

    /**
     * <p>
     * Override the base method to determine whether the No Winner Chosen phase can start.
     * </p>
     *
    ...
    protected boolean canStart(Phase phase, Contest contest) throws PhaseHandlingException {
        //Start case: if Contest.endDate has been reached and the minimum number of submissions has been reached
        return isEndDateReached(contest) && isEnoughSubmissionsReceived(phase, contest);
    }

    /**
     * <p>
     * This method will execute extra logic if the phase was started or ended.
     * The phase must be a "No Winner Chosen" phase.
     * </p>
     *
     * <p>
     ...
     *
     * @throws IllegalArgumentException If phase is null or if the phase is not a No Winner Chosen phase
     *         (<code>phase.phaseType.name</code> is not "No Winner Chosen").
     * @throws PhaseHandlingException If phase's <code>phaseType</code> or <code>phaseStatus</code> property is null.
     *         Or if its project does not contain a valid <em>contest</em> attribute.
    ...
    public void perform(Phase phase, String operator) throws PhaseHandlingException {
        super.perform(phase, CockpitPhase.NO_WINNER_CHOSEN);
    }
}
