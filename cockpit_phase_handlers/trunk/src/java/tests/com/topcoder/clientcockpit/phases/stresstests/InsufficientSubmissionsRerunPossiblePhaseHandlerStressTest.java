...
/**
 * <p>
 * Stress test for <code>InsufficientSubmissionsRerunPossiblePhaseHandler</code> class. Mainly
 * focus on the following function's performance:
 * <ul>
 * <li>InsufficientSubmissionsRerunPossiblePhaseHandler#perform(Phase, String)</li>
 * </ul>
 * </p>
 *
 * @author Littleken
 * @version 1.0
 */
public class InsufficientSubmissionsRerunPossiblePhaseHandlerStressTest extends StressTestCase {

    /**
     * <p>
     * Test method
     * <code>InsufficientSubmissionsRerunPossiblePhaseHandler#perform(Phase, String)</code> for
     * stress tests.
     * </p>
     *
     * @throws Exception
     *             to JUnit.
     */
    public void testInsufficientSubmissionsRerunPossiblePhaseHandlerPerformStress() throws Exception {
        long totalTime = 0;

        // Starts the SMTP server.
        startServer();

        InsufficientSubmissionsRerunPossiblePhaseHandler handler = new InsufficientSubmissionsRerunPossiblePhaseHandler();
        ...
        try {
            for (int i = 0; i < LOOP; ++i) {
                ...
                // Contest status has been update as "Insufficient Submissions - ReRunPossible",
                // should not be null.
        ...
        System.out.println("Run InsufficientSubmissionsRerunPossiblePhaseHandler#perform(Phase, String) for " + LOOP
    ...
    private Phase getPhase() throws Exception {
        ...
        // Sets phase type.
        PhaseType abandonedPhaseType = new PhaseType(11, "Insufficient Submissions - ReRun Possible");
