...
/**
 * <p>
 * Stress test for <code>InDangerPhaseHandler</code> class. Mainly focus on the following
 * function's performance:
 * <ul>
 * <li>InDangerPhaseHandler#perform(Phase, String)</li>
 * </ul>
 * </p>
 *
 * @author Littleken
 * @version 1.0
 */
public class InDangerPhaseHandlerStressTest extends StressTestCase {

    /**
     * <p>
     * Test method <code>InDangerPhaseHandler#perform(Phase, String)</code> for stress tests.
     * </p>
     *
     * @throws Exception
     *             to JUnit.
     */
    public void testInDangerPhaseHandlerPerformStress() throws Exception {
        long totalTime = 0;
        ...
        try {
            for (int i = 0; i < LOOP; ++i) {
                ...
                contest.setWinnerAnnoucementDeadline(new Date(System.currentTimeMillis() + 1200 * 1000));
                ...
                // Contest status has been update as "In Danger", should not be null.
        ...
        System.out.println("Run InDangerPhaseHandler#perform(Phase, String) for " + LOOP + " times consumes "
    ...
    private Phase getPhase() throws Exception {
        ...
        // Sets phase type.
        PhaseType abandonedPhaseType = new PhaseType(9, "In Danger");
