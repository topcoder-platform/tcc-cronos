...
/**
 * <p>
 * Stress test for <code>RePostPhaseHandler</code> class. Mainly focus on the following function's
 * performance:
 * <ul>
 * <li>RePostPhaseHandler#perform(Phase, String)</li>
 * </ul>
 * </p>
 *
 * @author Littleken
 * @version 1.0
 */
public class RePostPhaseHandlerStressTest extends StressTestCase {

    /**
     * <p>
     * Test method <code>RePostPhaseHandler#perform(Phase, String)</code> for stress tests.
     * </p>
     *
     * @throws Exception
     *             to JUnit.
     */
    public void testRePostPhaseHandlerPerformStress() throws Exception {
        long totalTime = 0;
        ...
        try {
            for (int i = 0; i < LOOP; ++i) {
                ...
                // Contest status has been update as "Repost",
                // should not be null.
        ...
        System.out.println("Run RePostPhaseHandler#perform(Phase, String) for " + LOOP + " times consumes " + totalTime
                + " milliseconds.");
    }
    ...
    private Phase getPhase() throws Exception {
        ...
        // Sets phase type.
        PhaseType abandonedPhaseType = new PhaseType(13, "Repost");
