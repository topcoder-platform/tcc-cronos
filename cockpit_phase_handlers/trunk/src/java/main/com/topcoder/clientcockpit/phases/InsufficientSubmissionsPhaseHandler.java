 ...
 *        changed to "InsufficientSubmissions".</li>
 ...
 *
 *     PhaseType insufficientSubmissionsType = ...;
 *
 *     //Create handler
 *     InsufficientSubmissionsPhaseHandler handler = new InsufficientSubmissionsPhaseHandler();
 *
 *     //Register handler to start and end operations
 *     manager.registerHandler(handler, insufficientSubmissionsType, PhaseOperationEnum.START);
 *     manager.registerHandler(handler, insufficientSubmissionsType, PhaseOperationEnum.END);
 *
 *     Phase phase = ...;
 *     //Set phase type
 *     phase.setPhaseType(insufficientSubmissionsType);
 *
 ...
 *     //And the phase.project.contest.status has been updated by handler to "InsufficientSubmissions"
 *
 *     //End
 ...
 */
public class InsufficientSubmissionsPhaseHandler extends AbstractPhaseHandler {
     ...
     */
    public InsufficientSubmissionsPhaseHandler() throws PhaseHandlingException {
        super();
    }
     ...
     *
     */
    public InsufficientSubmissionsPhaseHandler(ContestManager bean) throws PhaseHandlingException {
        super(bean);
    }
     ...
     * @throws PhaseHandlingException If error while looking up <code>ContestManager</code> by JNDI.
     */
    public InsufficientSubmissionsPhaseHandler(String namespace) throws PhaseHandlingException {
        super(namespace);
    }
     ...
     *
     */
    public InsufficientSubmissionsPhaseHandler(String namespace, ContestManager bean) throws PhaseHandlingException {
     ...
     *     If given phase type is not "Insufficient Submissions", false is returned.
     * </p>
     *
     * <p>
     ...
     * <ul>
     *     <li>If the minimum number of submissions has not been reached, and the contest has been rerun (check if
     *     <code>contest.status.name</code> is "Rerun"), then the phase can be started;
     *     </li>
     *     <li>If the <code>Contest.winnerAnnouncementDeadline</code> is reached, then the phase can be ended.</li>
     * </ul>
     * </p>
     *
     * <p>
     * The <code>Contest</code> attribute should be non-null and contains non-null <code>winnerAnnoucementDeadline
     * </code> and non-null <code>status</code> properties.
     * </p>
     *
     * <p>
     ...
     *         Or if phase's project does not contain a valid <em>MinimumSubmissions</em> attribute(which should be
     *         a non-null <code>Number</code>).
     */
    public boolean canPerform(Phase phase) throws PhaseHandlingException {
        return super.canPerform(phase, CockpitPhase.INSUFFICIENT_SUBMISSIONS);
    }

    /**
     * <p>
     * Override the base method to determine whether the Insufficient Submissions phase can start.
     * </p>
     *
     ...
     * @throws PhaseHandlingException If <code>Contest.status</code> is null or phase's project does not contain
...
//System.out.println("---------- [InsufficientSubmissions]: can start for contest id " + contest.getContestId() + " is: " + result);
    ...
    /**
     * <p>
     * Override the base method to determine whether the Insufficient Submissions phase can end.
     * </p>
     *
    ...
    protected boolean canEnd(Phase phase, Contest contest) throws PhaseHandlingException {
        ...
        //End case: if the Contest.winnerAnnouncementDeadline is reached
     ...
     * "Insufficient Submissions" phase.
     * </p>
     *
     * <p>
     ...
     *
     * @throws IllegalArgumentException If phase is null or if the phase is not an Insufficient Submissions phase
     *         (<code>phase.phaseType.name</code> is not "Insufficient Submissions").
     * @throws PhaseHandlingException If phase's <code>phaseType</code> or <code>phaseStatus</code> property is null.
     *         Or if its project does not contain a valid <em>contest</em> attribute.
    ...
    public void perform(Phase phase, String operator) throws PhaseHandlingException {
        super.perform(phase, CockpitPhase.INSUFFICIENT_SUBMISSIONS);
    }
}
