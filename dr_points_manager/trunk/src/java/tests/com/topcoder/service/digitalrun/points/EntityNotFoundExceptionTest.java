...
public class EntityNotFoundExceptionTest extends TestCase {
    ...
    public final void testCtor1_Accuracy() {
        ...
        assertTrue("EntityNotFoundException should subclass DigitalRunPointsManagerException",
    ...
    public void testCtor4_Accuracy() {
        EntityNotFoundException impl = new EntityNotFoundException(ERROR_MESSAGE, cause, exceptionData);
        assertNotNull("Unable to instantiate EntityNotFoundException.", impl);
        assertTrue("EntityNotFoundException should subclass DigitalRunPointsManagerException",
                impl instanceof DigitalRunPointsManagerException);
        assertEquals("Error message is not properly propagated to super class.", ERROR_MESSAGE, impl
