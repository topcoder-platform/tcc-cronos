...
/**
 * <p>
 * A mock up class of context for JNDI tests.
 * </p>
 *
 * @author TCSDEVELOPER
 * @version 1.0
...
class MockContext implements Context {
    ...
    /**
     * <p>
     * Creates an instance of MockContext.
     * </p>
     */
    public MockContext() {
        // do nothing
    ...
    public Object lookup(String name) throws NamingException {
        try {
            if (name.equals("systemConfigurationPropertyService")) {
                return new SystemConfigurationPropertyServiceBean();
            } else if (name.equals("reportService")) {
                return new ReportServiceBean();
            }
            throw new NamingException("don't know name.");
        } catch (Exception e) {
            throw new NamingException("error in lookup: " + name + " error: "
                    + e.getMessage());
        }
...
/**
 * <p>
 * A class to mock up InitialContextFactory for JNDI tests.
 * </p>
 *
 * @author TCSDEVELOPER
 * @version 1.0
