 ...
 * </p>
 * <p>
 * <b>Version 1.1 change:</b> Add the method
...
class Helper {
 ...
 private static class DoubleType extends DataType {
     ...
     * @param columnType the type as which to return the value, use one of the
     *            values STRING_TYPE, DATE_TYPE or LONG_TYPE or FLOAT_TYPE here
     ...
     *             or queryString is empty (trimmed), or the given query did
     *             return multiple (or zero) rows or columns
     * @throws PersistenceException if the query fails
     */
    static Object doSingleValueQuery(Connection connection, String queryString,
            Object[] queryArgs, DataType columnType)
        ...
        try {
            ...
            if (columnCount == 1 && resultSet.next()) {
                ...
                throw new IllegalArgumentException("The given query ["
                        + queryString
     ...
     * @throws IllegalArgumentException if tableName or columnName is null or
     *             empty, or id is not positive, or conn is null
     * @throws PersistenceException if error happens during querying
     */
    static boolean checkEntityExists(String tableName, String columnName,
            long id, Connection conn) throws PersistenceException {
        ...
        Long entryCount = (Long) Helper
                .doSingleValueQuery(conn, "SELECT COUNT(*) FROM " + tableName
                        + " WHERE " + columnName + "=?",
                        new Object[] {new Long(id)}, Helper.LONG_TYPE);
     ...
     * @throws IllegalArgumentException if the given long value is negative or
     *             zero.
     */
