 ...
 * <code>commit()</code>, <code>setAutoCommit(boolean)</code> or <code>rollback()</code> to manage the transaction as in
 * the version 1.0.1.
 * </p>
 * <p>
 * <b>Note:</b> The <code>InformixProjectPersistence</code> class in version 1.1 is completely compatible with the
 * <code>InformixProjectPersistence</code> class in version 1.0.1 and has no additional functionality. However, the bulk
 * of the logic that was in this class in version 1.0.1 has been moved into an abstract superclass that is the base for
 * <code>UnmanagedTransactionInformixProjectPersistence</code> as well.
 * </p>
 * <p>
 * Thread Safety: The implementation is not thread safe due to the base class is not thread safe.
 * </p>
 *
...
public class InformixProjectPersistence extends AbstractInformixProjectPersistence {
    ...
    private static final Log LOGGER = com.topcoder.util.log.LogFactory.getLog(InformixProjectPersistence.class
        .getName());
    ...
    /**
     * <p>
     * Concrete implementation of the corresponding abstract method in <code>AbstractInformixProjectPersistence.</code>.
     * </p>
     * <p>
     ...
     * <p>
     * Concrete implementation of the corresponding abstract method in <code>AbstractInformixProjectPersistence.</code>
     * used to commit the transaction and close the connection after an operation successfully completes.
     * </p>
     *
     * @param connection
     ...
     * <p>
     * Concrete implementation of the corresponding abstract method in <code>AbstractInformixProjectPersistence.</code>
     * used to rollback the transaction and close the connection after an operation fails to complete.
     * </p>
     *
     * @param connection
     *            a connection to close
