...
/**
 * <p>
 * It is a subclass of <code>AbstractInformixProjectPersistence</code> providing the unmanaged-transaction version of DB
 ...
 * <code>commit()</code>, <code>setAutoCommit(boolean)</code> or <code>rollback()</code>. The transaction is expected to
 * be handled externally to the component such as EJB.
 * </p>
 * <p>
...
public class UnmanagedTransactionInformixProjectPersistence extends AbstractInformixProjectPersistence {
    ...
    private static final Log LOGGER = com.topcoder.util.log.LogFactory
        .getLog(UnmanagedTransactionInformixProjectPersistence.class.getName());
     ...
     * <p>
     * Concrete implementation of the corresponding abstract method in <code>AbstractInformixProjectPersistence.</code>
     * used to close the connection after an operation successfully completes.
     * </p>
     *
     * @param connection
     ...
     * <p>
     * Concrete implementation of the corresponding abstract method in <code>AbstractInformixProjectPersistence.</code>
     * used to close the connection after an operation fails to complete.
     * </p>
     *
     * @param connection
     *            a Connection to close
