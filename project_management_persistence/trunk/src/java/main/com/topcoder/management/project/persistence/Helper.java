...
class Helper {
    ...
    static Object[][] doQuery(Connection connection, String queryString, Object[] queryArgs,
        DataType[] columnTypes) throws PersistenceException {
        Helper.assertObjectNotNull(connection, "connection");
        Helper.assertStringNotNullNorEmpty(queryString, "queryString");
     ...
     * @throws IllegalArgumentException
     *             if tableName or columnName is null or empty, or id is not
     *             positive, or conn is null
     * @throws PersistenceException
     ...
     *            the parameter name
     * @param required
     *            true, if the parameter is require; false, if the parameter is
     *            optional
     ...
     *             specified when required is true, or the value is empty
     *             (trimmed) when not null.
     */
