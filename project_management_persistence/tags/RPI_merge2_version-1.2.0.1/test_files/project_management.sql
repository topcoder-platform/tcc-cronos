...
alter table project_info_audit add(action_user_id decimal(12,0));
...
INSERT INTO id_sequences(name, next_block_start, block_size, exhausted) VALUES('file_type_id_seq', 1, 20, 0);
INSERT INTO id_sequences(name, next_block_start, block_size, exhausted) VALUES('prize_id_seq', 1, 20, 0);
INSERT INTO id_sequences(name, next_block_start, block_size, exhausted) VALUES('studio_spec_id_seq', 1, 20, 0);
