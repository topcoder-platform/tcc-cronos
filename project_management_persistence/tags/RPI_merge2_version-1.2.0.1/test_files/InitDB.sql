...
INSERT INTO project_type_lu (project_type_id, name, description, create_user, create_date, modify_user, modify_date, is_generic) VALUES (1, 'More', 'More projects of this type', 'System', CURRENT, 'System', CURRENT, 't');
INSERT INTO project_type_lu (project_type_id, name, description, create_user, create_date, modify_user, modify_date, is_generic) VALUES (2, 'Less', 'Less projects of this type', 'System', CURRENT, 'System', CURRENT, 't');
INSERT INTO project_type_lu (project_type_id, name, description, create_user, create_date, modify_user, modify_date, is_generic) VALUES (3, 'No', 'No project of this type', 'System', CURRENT, 'System', CURRENT, 't');
...
INSERT INTO review_applications (id, reviewer_id, project_id, application_date, is_primary) VALUES (1, 1, 1, CURRENT, 't');
INSERT INTO review_applications (id, reviewer_id, project_id, application_date, is_primary) VALUES (2, 2, 1, CURRENT, 'f');
INSERT INTO review_applications (id, reviewer_id, project_id, application_date, is_primary) VALUES (3, 2, 2, CURRENT, 'f');
INSERT INTO review_applications (id, reviewer_id, project_id, application_date, is_primary) VALUES (4, 3, 4, CURRENT, 'f');
