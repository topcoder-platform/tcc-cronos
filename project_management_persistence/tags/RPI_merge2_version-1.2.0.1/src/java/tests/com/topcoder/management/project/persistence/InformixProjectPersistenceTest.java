 ...
 * Version 1.2.1:
 *   <ol>
 *     <li>Add code for column project_studio_spec_id and tc_direct_project_id in testAccuracyCreateProject1
 * testAccuracyCreateProject2 and testCreateProjectRollback.</li>
 *     <li>There is difference between Review Process Improvements Project and TC - Studio Replatforming Project,
 * Refer to TC - Studio Replatforming Project, update the code to use TestHelper.</li>
 *   </ol>
 * </p>
 *
 * @author urtks, fuyun, TCSDEVELOPER, TCSDEVELOPER
 * @version 1.2.1
 * @since 1.0
 */
public class InformixProjectPersistenceTest extends TestCase {
     ...
     *
     * @since 1.2 (TC - Studio Replatforming Project Overview)
     */
    ...
    public void testFailureConstructor4() throws Exception {
        try {
            ...
            assertEquals(
                "Configuration parameter [ConnectionFactoryNS] under"
    ...
    public void testFailureConstructor6() throws Exception {
        try {
            ...
            assertEquals("Unable to create a new instance of DBConnectionFactoryImpl class "
                + "from namespace [do_not_exist].", e.getMessage());
        }
    }
    ...
    public void testFailureConstructor8() throws Exception {
        try {
            ...
            assertEquals("Configuration parameter [ProjectIdSequenceName] under namespace "
                + "[InformixProjectPersistence.CustomNamespace.EmptyProjectIdSequenceName] " + "is empty (trimmed).",
                e.getMessage());
        }
    }
    ...
    public void testFailureConstructor9() throws Exception {
        try {
            ...
            assertEquals("Unable to create IDGenerator for 'do_not_exist'.", e.getMessage());
        }
    }
    ...
    public void testFailureGetAllProjectPropertyTypes1() throws Exception {
        ...
        try {
            ...
            assertEquals("Error occurs when getting the connection 'do_not_exist'.", e.getMessage());
        }
    }
    ...
    /**
     * <p>
     * Accuracy test of the method <code>createProject(Project project, String operator)</code>.
     * </p>
     * <p>
    ...
    public void testAccuracyCreateProject1() throws Exception {
        ...
        persistence.createProject(project, "999");

        // first check if the project's properties are updated.
        assertEquals("check project creation user", "999", project.getCreationUser());
        assertTrue("check creation date is near current time", (new Date().getTime() - project.getCreationTimestamp()
            .getTime()) <= 10 * 60 * 1000);
        assertEquals("check project modification user", "999", project.getModificationUser());
        ...
        Object[][] rows = Helper.doQuery(conn, "SELECT * FROM project", new Object[] {}, new DataType[] {
            Helper.LONG_TYPE, Helper.LONG_TYPE, Helper.LONG_TYPE, Helper.STRING_TYPE, Helper.DATE_TYPE,
            Helper.STRING_TYPE, Helper.DATE_TYPE, Helper.LONG_TYPE, Helper.LONG_TYPE});
        assertEquals("only one result", 1, rows.length);
        Object[] row = rows[0];

        assertEquals("check project_id", project.getId(), ((Long) row[0]).longValue());
        assertEquals("check project_status_id", project.getProjectStatus().getId(), ((Long) row[1]).longValue());
        assertEquals("check project_category_id", project.getProjectCategory().getId(), ((Long) row[2]).longValue());
        ...
        assertEquals("check project_studio_spec_id", project.getProjectStudioSpecification().getId(), row[7]);
        assertEquals("check tc_direct_project_id", project.getTcDirectProjectId(), ((Long) row[8]).longValue());

        // query the project_info table
        rows = Helper.doQuery(conn, "SELECT * FROM project_info ORDER BY project_info_type_id", new Object[] {},
            new DataType[] {Helper.LONG_TYPE, Helper.LONG_TYPE, Helper.STRING_TYPE, Helper.STRING_TYPE,
     ...
     * </p>
     * <p>
     * Check if the project object's properties (id, create_user...) are not set if any exception is thrown.
     * </p>
     *
     * @throws Exception throw any exception to JUnit
     */
    ...
    public void testAccuracyGetProject1() throws Exception {
        ...
        persistence.createProject(project1, "999");
        persistence.createProject(project2, "999");
    ...
    public void testAccuracyGetProjects1() throws Exception {
        ...
        assertEquals("check project status id", project2.getProjectStatus().getId(), projects[1].getProjectStatus()
            .getId());
        assertEquals("check project status name", project2.getProjectStatus().getName(), projects[1]
    ...
    public void testAccuracyGetProjects5() throws Exception {
        ...
        // get the project
        Project[] projects = persistence.getProjects(new long[] {project1.getId(), project1.getId(),
            project2.getId(), project2.getId()});
    ...
    /**
     * <p>
     * Accuracy test of the method <code>updateProject(Project project, String reason, String operator)</code>.
     * </p>
     * <p>
    ...
    public void testAccuracyUpdateProject1() throws Exception {
        ...
        persistence.updateProject(project2, "some reason", "999");

        Project project3 = persistence.getProject(project2.getId());

        // first check if the project's properties are correct.
        assertEquals("check project id", project2.getId(), project3.getId());
        assertEquals("check project creation user", project1.getCreationUser(), project3.getCreationUser());
        assertEquals("check creation date", project1.getCreationTimestamp(), project3.getCreationTimestamp());
        assertEquals("check project modification user", project2.getModificationUser(), project3
            .getModificationUser());
        assertEquals("check modification date", project2.getModificationTimestamp(), project3
            .getModificationTimestamp());
        ...
        // create the connection
        Connection conn = new DBConnectionFactoryImpl(DBConnectionFactoryImpl.class.getName()).createConnection();
        Object[][] rows = Helper.doQuery(conn, "SELECT * FROM project_audit", new Object[] {}, new DataType[] {
        ...
        assertEquals("check create_user", "999", (String) row[3]);
    }
    ...
    public void testFailureUpdateProjects1() throws Exception {
        ...
        try {
            persistence.updateProject(null, "some reason", "999");
        } catch (IllegalArgumentException e) {
            assertEquals("project should not be null.", e.getMessage());
        }
    }
    ...
    public void testFailureUpdateProjects2() throws Exception {
        ...
        try {
            persistence.updateProject(project, "some reason", "999");
        } catch (IllegalArgumentException e) {
    ...
    public void testFailureUpdateProjects9() throws Exception {
        ...
        try {
            ...
            assertEquals(
                "Unable to find ProjectPropertyType name " + "[do_not_exist] in project_info_type_lu table.", e
                    .getMessage());
        }
    }
     ...
     * </p>
     * <p>
     * Verifies that the transaction will be rolled back if fails to insert the project properties.
     * </p>
     *
    ...
    public void testUpdateProjectRollback() throws Exception {
        ...
        try {
            persistence.updateProject(project, "reason", "999");
            fail("PersistenceException is expected.");
        } catch (PersistenceException pe) {
            // success
        }
