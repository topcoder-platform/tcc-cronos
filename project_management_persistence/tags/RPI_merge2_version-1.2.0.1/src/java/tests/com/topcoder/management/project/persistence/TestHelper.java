 ...
 *   <ol>
 *     <li>Add one record(audit_action_type_id is 3) in audit_action_type_lu table.</li>
 *     <li>Replaced <code>prize_type_lu.description</code> column with
 *     <code>prize_type_lu.prize_type_desc</code> column to match actual DB schema.</li>
 *     <li>Delete records in table project_studio_specification.</li>
 *   </ol>
 * </p>
 *
 * @author TCSDEVELOPER, TCSDEVELOPER
 * @version 1.2.1
 * @since 1.2 (TC - Studio Replatforming Project)
 */
public final class TestHelper {
    ...
    static void prepareData(AbstractInformixProjectPersistence persistence) throws Exception {
        ...
        Helper.doDMLQuery(conn, "INSERT INTO audit_action_type_lu " + "(audit_action_type_id, name, description, "
            ...
            + "'topcoder', CURRENT, 'topcoder', CURRENT)", new Object[]{});
        Helper.doDMLQuery(conn, "INSERT INTO audit_action_type_lu " + "(audit_action_type_id, name, description, "
            + "create_user, create_date, modify_user, modify_date) " + "VALUES (3, 'audit 3', 'audit 3', "
            + "'topcoder', CURRENT, 'topcoder', CURRENT)", new Object[]{}); // Added in 1.2.1

        // insert data into prize_type_lu table
        // Updated in 1.2.1 change description to prize_type_desc
        Helper.doDMLQuery(conn, "INSERT INTO prize_type_lu " + "(prize_type_id, prize_type_desc) "
    ...
    static void clearData(AbstractInformixProjectPersistence persistence) throws Exception {
        ...
        Helper.doDMLQuery(conn, "DELETE FROM project_studio_specification", new Object[]{}); // Added in 1.2.1
