 ...
 *
 * <p>
 * Updated in version 1.2 (TC - Studio Replatforming Project). Add CRUD methods for following entities, it
 * also maintain the relationships between project and following entities.
 * <ul>
 * <li>FileType</li>
 * <li>Prize</li>
 ...
 *
 * <p>
 * Version 1.2 (Review Process Improvements Project)
 * <ul>
 ...
 * </p>
 *
 * @author tuenm, urtks, bendlund, fuyun, moonli, pvmagacho, flytoj2ee, TCSDEVELOPER, TCSDEVELOPER
 * @version 1.2.1
 * @since 1.0
 */
public abstract class AbstractInformixProjectPersistence implements ProjectPersistence {
    ...
    private void updateProject(Project project, String reason, String operator, Connection conn)
        ...
        Object[] queryArgs = new Object[] {new Long(project.getProjectStatus().getId()),
            new Long(project.getProjectCategory().getId()), operator, modifyDate,
            project.getTcDirectProjectId() == 0 ? null : project.getTcDirectProjectId(), projectId};
