 ...
 * </p>
 *
 * @author urtks, fuyun, pvmagacho, TCSDEVELOPER, TCSDEVELOPER
 * @version 1.2.1
 * @since 1.0
 */
class Helper {
     ...
     * <p>
     * This constant provides the <code>DataType</code> instance that can be used in the query methods to specify that
     * a <code>ResultSet</code> column of a query result should be returned as value of type <code>Boolean</code> or
     * as <code>null</code> in case the <code>ResultSet</code> value was <tt>null</tt>.
     *
     * @since 1.2 (Review Process Improvements Project and TC - Studio Replatforming Project)
     */
     ...
     *
     * @author TCSDEVELOPER
     * @version 1.2 (TC - Studio Replatforming Project)
     * @since 1.2 (TC - Studio Replatforming Project)
     */
     ...
     *
     * @author pvmagacho
     * @version 1.2 (Review Process Improvements Project and TC - Studio Replatforming Project)
     */
    ...
    static String getConfigurationParameterValue(ConfigManager cm, String namespace, String name, boolean required,
        ...
        String value = null; // Add  = null refer to TC - Studio Replatforming Project
