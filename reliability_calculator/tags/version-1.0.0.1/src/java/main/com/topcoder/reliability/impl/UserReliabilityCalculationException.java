...
/**
 * <p>
 * This exception is thrown by implementations of UserReliabilityCalculator when some error occurs while calculating
...
public class UserReliabilityCalculationException extends ReliabilityCalculationException {
     ...
     */
    public UserReliabilityCalculationException(String message) {
        super(message);
    }
     ...
     */
    public UserReliabilityCalculationException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     */
    public UserReliabilityCalculationException(String message, ExceptionData data) {
        super(message, data);
    }
     ...
     *            will be automatically used instead.
     */
    public UserReliabilityCalculationException(String message, Throwable cause, ExceptionData data) {
