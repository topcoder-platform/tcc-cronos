...
-- the project 1 is in registration phase
insert into project_phase (project_phase_id, project_id, phase_type_id, phase_status_id, scheduled_start_time, scheduled_end_time, actual_end_time, duration, create_user, create_date, modify_user, modify_date) values(1, 1, 1, 2, TO_DATE('2010-01-01 09:00', '%Y-%m-%d %H:%M'), TO_DATE('2010-01-02 09:00', '%Y-%m-%d %H:%M'), null, 4, 132456, current, 132456, current);
...
-- the project 4 is in screening phase, 132456 not submitted
insert into project_phase (project_phase_id, project_id, phase_type_id, phase_status_id, scheduled_start_time, scheduled_end_time, actual_end_time, duration, create_user, create_date, modify_user, modify_date) values(41, 4, 2, 3, TO_DATE('2010-01-03 09:00', '%Y-%m-%d %H:%M'), TO_DATE('2010-01-04 09:00', '%Y-%m-%d %H:%M'), TO_DATE('2010-01-04 09:00', '%Y-%m-%d %H:%M'), 4, 132456, current, 132456, current);
insert into project_phase (project_phase_id, project_id, phase_type_id, phase_status_id, scheduled_start_time, scheduled_end_time, actual_end_time, duration, create_user, create_date, modify_user, modify_date) values(42, 4, 3, 2, TO_DATE('2010-01-04 09:00', '%Y-%m-%d %H:%M'), TO_DATE('2010-01-05 09:00', '%Y-%m-%d %H:%M'), null, 4, 132456, current, 132456, current);
...
-- the project 6 is in review phase, 132456 failed screening
...
insert into project_phase (project_phase_id, project_id, phase_type_id, phase_status_id, scheduled_start_time, scheduled_end_time, actual_end_time, duration, create_user, create_date, modify_user, modify_date) values(62, 6, 4, 2, TO_DATE('2010-01-05 09:00', '%Y-%m-%d %H:%M'), TO_DATE('2010-01-05 09:00', '%Y-%m-%d %H:%M'), null, 4, 132456, current, 132456, current);
...
insert into project_result (user_id, project_id, passed_review_ind) values (132456, 1, NULL);
...
insert into project_result (user_id, project_id, passed_review_ind) values (132456, 4, NULL);
insert into project_result (user_id, project_id, passed_review_ind) values (132456, 5, NULL);
insert into project_result (user_id, project_id, passed_review_ind) values (132456, 6, NULL);
...
insert into resource (resource_id, resource_role_id, create_user, create_date, modify_user, modify_date) values (3, 1, 132456, current, 132456, current);
insert into resource (resource_id, resource_role_id, create_user, create_date, modify_user, modify_date) values (5, 1, 132456, current, 132456, current);
insert into resource (resource_id, resource_role_id, create_user, create_date, modify_user, modify_date) values (6, 1, 132456, current, 132456, current);
insert into resource (resource_id, resource_role_id, create_user, create_date, modify_user, modify_date) values (7, 1, 132456, current, 132456, current);
insert into resource (resource_id, resource_role_id, create_user, create_date, modify_user, modify_date) values (8, 1, 132456, current, 132456, current);
