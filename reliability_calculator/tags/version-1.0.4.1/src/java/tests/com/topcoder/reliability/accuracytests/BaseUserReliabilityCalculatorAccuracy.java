...
/**
 * Accuracy test for <code>BaseUserReliabilityCalculator</code>.
 *
 * @author TCSDEVELOPER
 * @version 1.0
 */
public class BaseUserReliabilityCalculatorAccuracy extends TestCase {
    /**
     * The <code>BaseUserReliabilityCalculator</code> instance for testing.
     */
    private BaseUserReliabilityCalculator instance = new MockBaseUserReliabilityCalculator();
    ...
    public void testCtor() {
        ...
        assertTrue("The result should match.",
            instance instanceof UserReliabilityCalculator);
    }
    ...
    public void testConfigure() throws Exception {
        ...
        instance = new MockBaseUserReliabilityCalculator();
        instance.configure(configObj);

        assertNull("The log isn't set.",
            ((MockBaseUserReliabilityCalculator) instance).getLog());
    ...
    public void testCalculate2() throws Exception {
        ...
        assertEquals("The value should match.", 0.0,
    ...
    public void testCalculate3() throws Exception {
        ...
        assertEquals("The reliability should match.", 0.6,
