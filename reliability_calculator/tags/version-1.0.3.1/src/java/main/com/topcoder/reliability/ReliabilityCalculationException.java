...
/**
 * <p>
 * This exception is thrown by implementations of ReliabilityCalculator when some other error occurs while calculating
 * or updating the reliability. Also this exception is used as a base class for other specific custom exceptions.
 * </p>
 *
 * <p>
...
public class ReliabilityCalculationException extends BaseCriticalException {
     ...
     */
    public ReliabilityCalculationException(String message) {
        super(message);
    }
     ...
     */
    public ReliabilityCalculationException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     */
    public ReliabilityCalculationException(String message, ExceptionData data) {
        super(message, data);
    }
     ...
     *            will be automatically used instead.
     */
    public ReliabilityCalculationException(String message, Throwable cause, ExceptionData data) {
