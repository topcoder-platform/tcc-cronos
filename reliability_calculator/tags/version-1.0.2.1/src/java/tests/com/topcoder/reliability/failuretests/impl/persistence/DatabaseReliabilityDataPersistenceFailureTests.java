...
public class DatabaseReliabilityDataPersistenceFailureTests {
    ...
    /**
     * Tests the method getIdsOfUsersWithReliability with persistence error. Expect ReliabilityDataPersistenceException.
     *
     * @throws Exception
     *             to JUnit.
     */
    ...
    /**
     * Tests the method updateCurrentUserReliability with persistence error. Expect ReliabilityDataPersistenceException.
     *
     * @throws Exception
     *             to JUnit.
     */
