...
public class DatabaseReliabilityDataPersistenceAccuracy extends TestCase {
    ...
    protected void setUp() throws Exception {
        ...
        ConfigurationObject myconfig = filePersistence.loadFile("myconfig", new File("test_files/accuracy/db.xml"));
        ...
        BufferedReader in = new BufferedReader(new FileReader("test_files/accuracy/cleandb.sql"));
        String line = null;
    ...
    public void testCtor() {
        ...
        assertTrue("The result should match.", instance instanceof ReliabilityDataPersistence);
    }
    ...
    public void testConfigure() throws Exception {
        ...
        Field connectionNameField = instance.getClass().getDeclaredField("connectionName");
        connectionNameField.setAccessible(true);
        Field factoryField = instance.getClass().getDeclaredField("dbConnectionFactory");
        factoryField.setAccessible(true);
        assertNotNull("the log should be set.", field.get(instance));
        assertNotNull("the log should be set.", connectionNameField.get(instance));
    ...
    public void testGetUserParticipationData() throws Exception {
        ...
        try {
            ...
            cal.set(1990, 1, 1, 0, 0);
            Date d = cal.getTime();
            List < UserProjectParticipationData > result = instance.getUserParticipationData(2, 2, d);
    ...
    public void testUpdateCurrentUserReliability() throws Exception {
        ...
        try {
            ...
            connection.setAccessible(true);
            Connection conn = (Connection) connection.get(instance);
            PreparedStatement pstmt = conn.prepareStatement("select rating from user_reliability where user_id = ?");
            pstmt.setLong(1, 123);
