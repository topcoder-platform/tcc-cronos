...
/**
 * <p>
 * Unit tests for <code>ProjectStatusServiceClientCreationException</code> class.
 * </p>
 *
 * @author TCSDEVELOPER
 * @version 1.0
 */
public class ProjectStatusServiceClientCreationExceptionTest extends TestCase {
    ...
    public void testCtorWithMsg() {
        ProjectStatusServiceClientCreationException exception = new ProjectStatusServiceClientCreationException(
                "test_message");
