...
public class ProjectFilterUtilityFailureTest extends TestCase {
    ...
    /**
     * Failure test of <code>buildProjectTypeReviewSystemVersion(long version)</code> method.
     *
     * <p>
     * version = 0.
     * </p>
     ...
     *             throw exception to JUnit.
     */
    public void testBuildProjectTypeReviewSystemVersionAccuracy1() throws Exception {
        try {
            ProjectFilterUtility.buildProjectTypeReviewSystemVersion(0);
            fail("Expect IllegalArgumentException.");
        } catch (IllegalArgumentException e) {
            // expect
        }
     ...
     *             throw exception to JUnit.
     */
    public void testBuildProjectTypeReviewSystemVersionAccuracy2() throws Exception {
        try {
            ProjectFilterUtility.buildProjectTypeReviewSystemVersion(-1);
            fail("Expect IllegalArgumentException.");
        } catch (IllegalArgumentException e) {
            // expect
        }
