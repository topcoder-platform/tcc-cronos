...
public abstract class AbstractInformixProjectPersistenceTest extends TestCase {
    ...
    /**
     * <p>
     * An instance of {@link AbstractInformixProjectPersistence} which is tested. This instance is initialized in
     * {@link #setUp()} method and released in {@link #tearDown()} method.
     * <p>
     */
    ...
    protected void setUp() throws Exception {
        ...
        ConfigHelper.loadConfiguration(new File("failure/config_persistence.xml"));
     ...
     *
     * @param persistence the project persistence instance which is used to test.
     */
     ...
     *
     * <p>
     * Passes <code>null</code> as <code>project</code> and expects the <code>IllegalArgumentException</code> to be
     * thrown.
     * </p>
     */
     ...
     *
     * <p>
     * Passes <code>null</code> as <code>operator</code> and expects the <code>IllegalArgumentException</code> to be
     * thrown.
     * </p>
     */
     ...
     *
     * <p>
     * Passes <code>null</code> as <code>reason</code> and expects the <code>IllegalArgumentException</code> to be
     * thrown.
     * </p>
     */
    ...
    /**
     * <p>
     * Failure test. Tests the {@link AbstractInformixProjectPersistence#getProjects(long[])} method for proper
    ...
    private void insertData() throws SQLException {
        ...
        try {
            ...
            stmt.executeUpdate("INSERT INTO project_type_lu (project_type_id, name, description, create_user, "
                + "create_date, modify_user, modify_date, is_generic, review_system_version) VALUES "
                + "(1, 'project_type', " + "'type_description', 'operator', CURRENT, 'operator', CURRENT, 't', 1)");
            ...
            stmt.executeUpdate("INSERT INTO project (project_id, project_status_id, project_category_id,"
