...
public class AbstractInformixProjectPersistenceCtorTest extends TestCase {
     ...
     *
     * <p>
     * Passes <code>null</code> as <code>namespace</code> and expects the <code>IllegalArgumentException</code> to be
     * thrown.
     * </p>
     */
     ...
     *
     * <p>
     * Replaces the <code>ProjectAuditIdSequenceName</code> configuration property with invalid value and expects the
     * <code>PersistenceException</code> to be thrown.
     * </p>
     */
    ...
    private class ProjectPersistenceForFailure extends AbstractInformixProjectPersistence {
         ...
         * @throws ConfigurationException if error occurs while loading configuration settings, or required
        ...
        protected Log getLogger() {
            return LogFactory.getLog(ProjectPersistenceForFailure.class.getName());
        }
