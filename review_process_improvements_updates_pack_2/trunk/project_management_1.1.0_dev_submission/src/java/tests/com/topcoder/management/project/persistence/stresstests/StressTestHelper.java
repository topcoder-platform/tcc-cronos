...
public class StressTestHelper extends TestCase {
    ...
    public static final String NAMESPACE = "com.topcoder.management.project.persistence.InformixProjectPersistence";
    ...
    public static void clearAllTestRecords() throws Exception {
        ...
        Connection connection = new DBConnectionFactoryImpl("com.topcoder.db.connectionfactory.DBConnectionFactoryImpl")
            .createConnection();
    ...
    static Project getSampleProject() {
        ...
        ProjectType type = new ProjectType(1, "Topcoder", 0);
    ...
    static Project getUpdatedProject() {
        ...
        // create a ProjectType object
        ProjectType type = new ProjectType(2, "Customer", 0);
