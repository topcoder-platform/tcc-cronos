...
/**
 * <p>
 * A mock implementation of {@link ConnectionProducer} class to be used for testing. Overrides the protected methods
...
public class MockConnectionProducer implements ConnectionProducer {
    ...
    /**
     * <p>
     * A <code>Map</code> mapping the <code>String</code> method signatures to <code>Map</code>s mapping the <code>
     * String</code>
     * names of the arguments to <code>Object</code>s representing the values of arguments which have been provided by
    ...
    /**
     * <p>
     * A <code>Map</code> mapping the <code>String</code> method signatures to <code>Exception</code>s to be thrown by
     * methods.
     * </p>
     */
    ...
    /**
     * <p>
     * A <code>Map</code> mapping the <code>String</code> method signatures to <code>Object</code>s to be returned by
     * methods.
     * </p>
     */
    ...
    /**
     * <p>
     * A <code>Throwable</code> representing the exception to be thrown from any method of the mock class.
     * </p>
     */
    ...
    /**
     * <p>
     * Constructs new <code>MockConnectionProducer</code> instance.
     * </p>
     */
    ...
    /**
     * <p>
     * A mock implementation of the method. The method either throws an exception which might have been specified
     * through {@link #throwException(String, Throwable)} method or return a result specified through
     * {@link #setMethodResult(String, Object)} method.
     * </p>
     *
    ...
    /**
     * <p>
     * Sets the result to be returned by the specified method.
     * </p>
     *
    ...
    /**
     * <p>
     * Gets the value of the specified argument which has been passed to the specified method by the caller.
     * </p>
     *
     * @param methodSignature a <code>String</code> uniquelly distinguishing the target method among other methods
    ...
    /**
     * <p>
     * Sets the exception to be thrown when the specified method is called.
     * </p>
     *
     * @param methodSignature a <code>String</code> uniquelly distinguishing the target method among other methods
    ...
    /**
     * <p>
     * Releases the state of <code>MockConnectionProducer</code> so all collected method arguments, configured method
     * results and exceptions are lost.
     * </p>
     */
    ...
    /**
     * <p>
     * Initializes the initial state for all created instances of <code>MockConnectionProducer</code> class.
     * </p>
     */
