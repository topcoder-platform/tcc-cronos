...
public class DemoTest extends TestCase {
    ...
    protected void setUp() throws Exception {
        ...
        Helper.doDMLQuery(conn, "INSERT INTO project_type_lu "
            ...
            + "'topcoder', CURRENT, 'topcoder', CURRENT, 't', 1)", new Object[] {});
        Helper.doDMLQuery(conn, "INSERT INTO project_type_lu "
            + "(project_type_id, name, description, "
            + "create_user, create_date, modify_user, modify_date, is_generic, review_system_version) "
            + "VALUES (2, 'Customer', 'Customer Component', "
            + "'topcoder', CURRENT, 'topcoder', CURRENT, 't', 2)", new Object[] {});
        ...
        Helper.doDMLQuery(conn, "INSERT INTO project_info_type_lu "
            ...
            + "'topcoder', CURRENT, 'topcoder', CURRENT, 1)", new Object[] {});
        Helper.doDMLQuery(conn, "INSERT INTO project_info_type_lu "
            + "(project_info_type_id, name, description, "
            + "create_user, create_date, modify_user, modify_date, review_system_version) "
            + "VALUES (2, 'property 2', 'project property 2', "
            + "'topcoder', CURRENT, 'topcoder', CURRENT, 2)", new Object[] {});
        Helper.doDMLQuery(conn, "INSERT INTO project_info_type_lu "
            + "(project_info_type_id, name, description, "
            + "create_user, create_date, modify_user, modify_date, review_system_version) "
            + "VALUES (3, 'property 3', 'project property 3', "
            + "'topcoder', CURRENT, 'topcoder', CURRENT, 3)", new Object[] {});
        Helper.doDMLQuery(conn, "INSERT INTO project_info_type_lu "
            + "(project_info_type_id, name, description, "
            + "create_user, create_date, modify_user, modify_date, review_system_version) "
            + "VALUES (4, 'property 4', 'project property 4', "
            + "'topcoder', CURRENT, 'topcoder', CURRENT, 4)", new Object[] {});
