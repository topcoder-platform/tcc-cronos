...
public class InformixProjectPersistenceTest extends TestCase {
    ...
    private Project getSampleProject1() {
        ...
        ProjectType type = new ProjectType(1, "Topcoder", 1);
    ...
    private Project getSampleProject2() {
        ...
        // create a ProjectType object
        ProjectType type = new ProjectType(2, "Customer", 1);
    ...
    protected void setUp() throws Exception {
        ...
        Helper.doDMLQuery(conn, "INSERT INTO project_type_lu " + "(project_type_id, name, description, "
            + "create_user, create_date, modify_user, modify_date, is_generic, review_system_version) "
            + "VALUES (1, 'Topcoder', 'Topcoder Component', " + "'topcoder', CURRENT, 'topcoder', CURRENT, 't', 1)",
            new Object[] {});
        Helper.doDMLQuery(conn, "INSERT INTO project_type_lu " + "(project_type_id, name, description, "
            + "create_user, create_date, modify_user, modify_date, is_generic, review_system_version) "
            + "VALUES (2, 'Customer', 'Customer Component', " + "'topcoder', CURRENT, 'topcoder', CURRENT, 't', 2)",
            new Object[] {});
        ...
        Helper.doDMLQuery(conn, "INSERT INTO project_info_type_lu " + "(project_info_type_id, name, description, "
            + "create_user, create_date, modify_user, modify_date, " + "review_system_version)"
    ...
    public void testFailureCreateProject7() throws Exception {
        ...
        Helper.doDMLQuery(conn, "INSERT INTO project_info_type_lu (project_info_type_id, "
            + "name, description, create_user, create_date, modify_user, modify_date, review_system_version) "
            + "VALUES (5, 'property 1', 'project property 1', 'topcoder', CURRENT," + "'topcoder', CURRENT, 5)",
            new Object[] {});
        conn.close();
