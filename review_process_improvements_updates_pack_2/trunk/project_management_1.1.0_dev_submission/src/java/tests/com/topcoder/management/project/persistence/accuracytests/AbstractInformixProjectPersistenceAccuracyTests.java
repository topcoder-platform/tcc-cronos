...
public class AbstractInformixProjectPersistenceAccuracyTests extends TestCase {
    ...
    public void testCreateProject() throws Exception {
        ...
        // set two projects
        instance.createProject(project1, "999");
        instance.createProject(project2, "999");
    ...
    public void testUpdateProject() throws Exception {
        ...
        assertTrue("The original record should still exist.", existsRecords(con, sql, new Object[] {
            new Long(project.getId()), new Long(1), "999"}));
        // new record exists
    ...
    public void testGetProjects() throws Exception {
        ...
        instance.createProject(project1, "999");
        instance.createProject(project2, "999");
        instance.createProject(project3, "999");
    ...
    private Project getProject(int categoryId, int statusId) {
        ...
        ProjectType type = new ProjectType(1, "something", 1);
