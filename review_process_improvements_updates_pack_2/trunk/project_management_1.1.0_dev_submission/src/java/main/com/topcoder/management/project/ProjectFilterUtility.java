...
/**
 * <p>
 * This class contains methods to build filter instances to use in project searching. It can build filter to search
 * for project based on various criteria such as:
 * </p>
 * <ul>
 ...
 * used be the client to create search filter. The created filter is used in SearchProjects() method of
 * ProjectManager.
 *
 * <p>
 * Version 1.1
...
public class ProjectFilterUtility {
    ...
    /**
     * Represents the alias for project type id column. It is used to build search filter for this column. This
    ...
    /**
     * Represents the alias for project resource property name column. It is used to build search filter for this
    ...
    /**
     * Represents the alias for project resource property value column. It is used to build search filter for this
     * column. This constant also defined in configuration settings for search builder.
     */
    public static final String PROJECT_RESOURCE_PROPERTY_VALUE = "ProjectResourcePropertyValue";

    /**
     * Represents the alias for project type review system version column. It is used to build search filter for this
     * column. This constant also defined in configuration settings for search builder.
     *
     * @since 1.1
     */
    public static final String PROJECT_TYPE_REVIEW_SYS_VER = "ProjectTypeReviewSystemVersion";
     ...
     * @throws IllegalArgumentException if one id in the list is less than or equals to zero or the list is null or
     *             empty or the content of the list is not of Long type.
     */
    public static Filter buildTypeIdInFilter(List<Long> typeIds) {
    ...
    /**
     * Build the filter to search for project with type name in the given type name list. Type names must not be null
     * or empty. The content of the input list must be of String type.
     *
     * @return the filter to search for project.
     * @param names The type names list to build filter.
     * @throws IllegalArgumentException if one name in the list is empty string or the list is null or empty or the
     *             content of the list is not of String type.
     */
    public static Filter buildTypeNameInFilter(List<String> names) {
     ...
     *             empty or the content of the list is not of Long type.
     */
    public static Filter buildCategoryIdInFilter(List<Long> categoryIds) {
     ...
     *             content of the list is not of String type.
     */
    public static Filter buildCategoryNameInFilter(List<String> names) {
        assertStringListValid(names, "names");
     ...
     *             empty or the content of the list is not of Long type.
     */
    public static Filter buildStatusIdInFilter(List<Long> statusIds) {
        assertLongListValid(statusIds, "statusIds");
        return SearchBundle.buildInFilter(PROJECT_STATUS_ID, statusIds);
    }

    /**
     * Build the filter to search for project with the given status name. Status name must not be null or empty
     * string.
     *
     * @return the filter to search for project.
     ...
     *             content of the list is not of String type.
     */
    public static Filter buildStatusNameInFilter(List<String> names) {
        assertStringListValid(names, "names");
     ...
     *             content of the list is not of String type.
     */
    public static Filter buildProjectPropertyNameInFilter(List<String> names) {
        assertStringListValid(names, "names");
     ...
     * @throws IllegalArgumentException if one value in the list is empty string or the list is null or empty or the
     *             content of the list is not of String type.
     */
    public static Filter buildProjectPropertyValueInFilter(List<String> values) {
    ...
    /**
     * Build the filter to search for project with the given resource property name. Name must not be null or empty
     * string.
     *
     * @return the filter to search for project.
    ...
    /**
     * Build the filter to search for project with the given list of resource property names. Names must not be null
     * or empty string. The content of the input list must be of String type.
     *
     * @return the filter to search for project.
     ...
     *             content of the list is not of String type.
     */
    public static Filter buildProjectResourcePropertyNameInFilter(List<String> names) {
        assertStringListValid(names, "names");
        return SearchBundle.buildInFilter(PROJECT_RESOURCE_PROPERTY_NAME, names);
    }

    /**
     * Build the filter to search for project with the given resource property value. Value must not be null or empty
     * string.
     *
     * @return the filter to search for project.
     * @param value The property value to build filter.
    ...
    /**
     * Build the filter to search for project with the given list of resource property values. Values must not be null
     * or empty string. The content of the input list must be of String type.
     *
     * @return the filter to search for project.
     ...
     *             content of the list is not of String type.
     */
    public static Filter buildProjectResourcePropertyValueInFilter(List<String> values) {
        assertStringListValid(values, "values");
    ...
    /**
     * <p>
     * Build the filter to search for project with the given resource property name/value pair. Name and value must
    ...
    /**
     * Build the filter to search for project with the given project type review system version.
     *
     ...
     * @since 1.1
     */
    public static Filter buildProjectTypeReviewSystemVersion(long version) {
        Helper.checkNumberPositive(version, "version");
        return SearchBundle.buildEqualToFilter(PROJECT_TYPE_REVIEW_SYS_VER, version);
    }
     ...
     * @throws IllegalArgumentException if one element in the list is less than or equals to zero or the list is null
     *             or empty or the content of the list is not of Long type.
     */
    private static void assertLongListValid(List<Long> list, String name) {
     ...
     * @param list the list to validate
     * @param name the name of list
     * @throws IllegalArgumentException if one element in the list is empty string or the list is null or empty or the
     *             content of the list is not of String type.
     */
    private static void assertStringListValid(List<String> list, String name) {
        Helper.checkObjectNotNull(list, name);
        Helper.checkNumberPositive(list.size(), name + "'s size");
        // validate each element
