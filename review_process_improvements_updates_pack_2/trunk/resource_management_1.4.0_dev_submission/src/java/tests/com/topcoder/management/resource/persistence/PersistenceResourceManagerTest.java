 ...
 *
 * <p>
 * Changes in version 1.1, add one more test case for searching resource with
 * ResourceFilterBuilder#createAnySubmissionIdFilter() filter which is introduced in version 1.1.
 * </p>
 * <p>
 * Update in version 1.3, update some test cases since the search-build configuration is updated.
 *                        Add test cases for new methods.
 * </p>
 *
 * @author kinfkong, Xuchen, waits
 * @version 1.3
 * @since 1.0
 */
public class PersistenceResourceManagerTest extends TestCase {
    ...
    protected void setUp() throws Exception {
        ...
        notificationSearchBundle = searchBundleManager
        ...
        notificationTypeSearchBundle = searchBundleManager
    ...
    /**
     * Tests constructor PersistenceResourceManager(ResourcePersistence, SearchBundle, SearchBundle, SearchBundle,
     * SearchBundle, IDGenerator, IDGenerator, IDGenerator).
     *
    ...
    public void testPersistenceResourceManagerEigthArgs_NullPersistence() {
        try {
            new PersistenceResourceManager(null, resourceSearchBundle, resourceRoleSearchBundle,
    ...
    public void testPersistenceResourceManagerEigthArgs_NullResourceSearchBundle() throws Exception {
        try {
            new PersistenceResourceManager(persistence, null, resourceRoleSearchBundle, notificationSearchBundle,
                    notificationTypeSearchBundle, resourceIdGenerator, resourceRoleIdGenerator,
    ...
    public void testPersistenceResourceManagerEigthArgs_NullResourceRoleSearchBundle() {
        try {
            new PersistenceResourceManager(persistence, resourceSearchBundle, null, notificationSearchBundle,
                    notificationTypeSearchBundle, resourceIdGenerator, resourceRoleIdGenerator,
                    notificationTypeIdGenerator);
    ...
    public void testPersistenceResourceManagerEigthArgs_NullNotificationSearchBundle() {
        try {
            new PersistenceResourceManager(persistence, resourceSearchBundle, resourceRoleSearchBundle, null,
                    notificationTypeSearchBundle, resourceIdGenerator, resourceRoleIdGenerator,
                    notificationTypeIdGenerator);
    ...
    public void testPersistenceResourceManagerEigthArgs_NullNotificationTypeSearchBundle() {
        try {
            new PersistenceResourceManager(persistence, resourceSearchBundle, resourceRoleSearchBundle,
                    notificationSearchBundle, null, resourceIdGenerator, resourceRoleIdGenerator,
                    notificationTypeIdGenerator);
    ...
    public void testPersistenceResourceManagerEigthArgs_NullResourceIdGenerator() {
        try {
            new PersistenceResourceManager(persistence, resourceSearchBundle, resourceRoleSearchBundle,
                    notificationSearchBundle, notificationTypeSearchBundle, null, resourceRoleIdGenerator,
                    notificationTypeIdGenerator);
    ...
    public void testPersistenceResourceManagerEigthArgs_NullResourceRoleIdGenerator() {
        try {
            new PersistenceResourceManager(persistence, resourceSearchBundle, resourceRoleSearchBundle,
                    notificationSearchBundle, notificationTypeSearchBundle, resourceIdGenerator, null,
                    notificationTypeIdGenerator);
    ...
    public void testPersistenceResourceManager_TwoArgs_Accuracy() throws Exception {
        ...
        PersistenceResourceManager pm = new PersistenceResourceManager(persistence, searchBundleManager);

        assertNotNull("The persistence resource manager cannot be created.", pm);
    }
    ...
    public void testUpdateResource_UpdateRecord() throws Exception {
        ...
        assertTrue("The record has not been updated.", existsRecord(sql, new Object[] {new Long(2),
            "DEVELOPER_UPDATE_RESOURCE"}));
    }
    ...
    public void testUpdateResources_accuracy() throws Exception {
        ...
        Resource[] resources = new Resource[] {new Resource(1), new Resource(4), new Resource(6), new Resource()};
    ...
    public void testSearchResources_WrongConfig_InvalidSQL() throws Exception {
        ...
        setAllFieldsSearchable(searchBundleManager1
                .getSearchBundle(PersistenceResourceManager.RESOURCE_SEARCH_BUNDLE_NAME));
    ...
    public void testSearchResources_SubmissionIdFilter() throws Exception {
        ...
        long[] expected = new long[] {1, 2, 3, 4, 5, 6, 7, 8, 9};

        // check the accuracy of the returned result
        assertEquals("Should contain 9 elements.", 9, resources.length);
    ...
    public void testUpdateResourceRole_NewResourceRole() throws Exception {
        ...
        assertTrue("The record does not added.", existsRecord(sql, new Object[] {"DEVELOPER_UPDATE_RESOURCE",
            "DEVELOPER_UPDATE_RESOURCE"}));

        CustomResultSet rs = doSQLQuery(sql, new Object[] {"DEVELOPER_UPDATE_RESOURCE", "DEVELOPER_UPDATE_RESOURCE"});
        rs.next();
    ...
    public void testAddNotifications_Accuracy() throws Exception {
        ...
        for (int i = 0; i < users.length; i++) {
            ...
            assertTrue("The record is not added.", existsRecord(sql, new Object[] {new Long(users[i]),
                new Long(notificationType), new Long(project), operator}));
        }
    }
    ...
    public void testRemoveNotifications_Accuracy() throws Exception {
        ...
        for (int i = 0; i < users.length; i++) {
            ...
            assertFalse("The record is not removed.", existsRecord(sql, new Object[] {new Long(users[i]),
                new Long(notificationType), new Long(project), operator}));
        }
    }
    ...
    public void testSearchNotifications_NotificationTypeIdFilter() throws Exception {
        ...
        Notification[] expected = new Notification[] {getNotification(1, 1, 1), getNotification(1, 2, 1),
                getNotification(1, 3, 1), getNotification(2, 1, 1), getNotification(2, 2, 1), getNotification(2, 3, 1),
                getNotification(3, 1, 1), getNotification(3, 2, 1), getNotification(3, 3, 1),};
    ...
    public void testSearchNotifications_ProjectIdFilter() throws Exception {
        ...
        Notification[] expected = new Notification[] {getNotification(1, 1, 1), getNotification(1, 2, 1),
                getNotification(1, 3, 1), getNotification(1, 1, 2), getNotification(1, 2, 2), getNotification(1, 3, 2),
                getNotification(1, 1, 3), getNotification(1, 2, 3), getNotification(1, 3, 3),};
    ...
    public void testSearchNotifications_ExternalRefIdFilter() throws Exception {
        ...
        Notification[] expected = new Notification[] {getNotification(1, 3, 1), getNotification(1, 3, 2),
                getNotification(1, 3, 3), getNotification(2, 3, 1), getNotification(2, 3, 2), getNotification(2, 3, 3),
                getNotification(3, 3, 1), getNotification(3, 3, 2), getNotification(3, 3, 3),};
    ...
    public void testRemoveNotificationType_remove() throws Exception {
        ...
        assertEquals("The modification user does not set back.", "TEST_DEVELOPER", notificationType
                .getModificationUser());
    }
    ...
    // ///////////////////////////////////////////////////////////////////////
    // // start v1.3 test cases added
    // /////////////////////////////////////////////////////////////////////

    /**
     * Tests addNotifications(long, long[], long, String).
     *
     * With null projects, IllegalArgumentException should be thrown.
     *
     * @throws Exception to JUnit
     * @since 1.3
     */
    public void testAddNotifications_13_NullProjects() throws Exception {
        try {
            manager.addNotifications(1, null, 2, "DEVELOPER_ADD_NOTIFICATION");
            fail("projects can not be null.");
        } catch (IllegalArgumentException e) {
            // success
        }
    }
     ...
     * Tests addNotifications(long, long[], long, String).
     *
     * With empty projects, IllegalArgumentException should be thrown.
     *
     * @throws Exception to JUnit
     * @since 1.3
     */
    public void testAddNotifications_13_emptyProjects() throws Exception {
        try {
            manager.addNotifications(1, new long[0], 2, "DEVELOPER_ADD_NOTIFICATION");
            fail("projects can not be empty.");
        } catch (IllegalArgumentException e) {
            // success
        }
    }
     ...
     * @since 1.3
     */
    public void testAddNotifications_13_NullOperator() throws Exception {
        try {
            manager.addNotifications(1, new long[] {1, 2, 3}, 2, null);
            fail("operator can not be null.");
        } catch (IllegalArgumentException e) {
            // success
        }
     ...
     * @since 1.3
     */
    public void testAddNotifications_13_Accuracy() throws Exception {
        long[] projects = new long[] {1, 2, 3};
        long user = 1;
        long notificationType = 3;
        ...
        manager.addNotifications(user, projects, notificationType, operator);

        // checks if the record exists
        for (int i = 0; i < projects.length; i++) {
            String sql = "SELECT * FROM notification WHERE "
                    + "external_ref_id = ? AND notification_type_id = ? AND project_id = ? AND create_user = ?";
            assertTrue("The record is not added.", existsRecord(sql, new Object[] {new Long(user),
                new Long(notificationType), new Long(projects[i]), operator}));
        }
    }
     ...
     * Tests addNotifications(long, long[], long, String).
     *
     * With non-positive user id, IllegalArgumentException should be thrown.
     *
     * @throws Exception to JUnit
     * @since 1.3
     */
    public void testAddNotifications_13_NonPostiveUser() throws Exception {
        try {
            manager.addNotifications(-1, new long[] {1, 2, 3}, 2, null);
     ...
     * @since 1.3
     */
    public void testAddNotifications_13_NonPostiveNotificationType() throws Exception {
        try {
            manager.addNotifications(1, new long[] {1, 2, 3}, -2, null);
            fail("notificationType must be positive");
        } catch (IllegalArgumentException e) {
     ...
     * Tests addNotifications(long[], long, long, String).
     *
     * With non-positive project ids, IllegalArgumentException should be thrown.
     *
     * @throws Exception to JUnit
     * @since 1.3
     */
    public void testAddNotifications_13_NonPostiveProjectIds() throws Exception {
        try {
            manager.addNotifications(1, new long[] {1, -2, 3}, 2, null);
            fail("Project ids cannot contain non-positive id.");
        } catch (IllegalArgumentException e) {
            // success
        }
    }
     ...
     * @since 1.3
     */
    public void testRemoveNotifications_13_NullProjects() throws Exception {
        try {
            manager.removeNotifications(1, null, 2, "DEVELOPER_ADD_NOTIFICATION");
            fail("projects can not be null.");
        } catch (IllegalArgumentException e) {
            // success
        }
     ...
     * @since 1.3
     */
    public void testRemoveNotifications_13_EmptyProjects() throws Exception {
        try {
            manager.removeNotifications(1, new long[0], 2, "DEVELOPER_ADD_NOTIFICATION");
            fail("projects can not be empty.");
        } catch (IllegalArgumentException e) {
            // success
        }
     ...
     * @since 1.3
     */
    public void testRemoveNotifications_13_NullOperator() throws Exception {
        try {
            manager.removeNotifications(1, new long[] {1, 2, 3}, 2, null);
            fail("operator can not be null.");
        } catch (IllegalArgumentException e) {
            // success
        }
     ...
     * @since 1.3
     */
    public void testRemoveNotifications_13_Accuracy() throws Exception {
        long[] projects = new long[] {1, 2, 3};
        long user = 1;
        long notificationType = 3;
        ...
        // remove them
        manager.removeNotifications(user, projects, notificationType, operator);
        ...
        for (int i = 0; i < projects.length; i++) {
            ...
            // the record does not exists.
            assertFalse("The record is not removed.", existsRecord(sql, new Object[] {new Long(user),
                new Long(notificationType), new Long(projects[i]), operator}));
        }
    }
     ...
     * @since 1.3
     */
    public void testRemoveNotifications_13_NonPostiveUser() throws Exception {
        try {
            manager.removeNotifications(-1, new long[] {1, 2, 3}, 2, null);
            fail("user id must be positive.");
        } catch (IllegalArgumentException e) {
     ...
     * @since 1.3
     */
    public void testRemoveNotifications_13_NonPostiveNotificationType() throws Exception {
        try {
            manager.removeNotifications(1, new long[] {1, 2, 3}, -2, null);
            fail("notificationType must be positive");
        } catch (IllegalArgumentException e) {
     ...
     * @since 1.3
     */
    public void testRemoveNotifications_13_NonPostiveProjectIds() throws Exception {
        try {
            manager.removeNotifications(1, new long[] {1, -2, 3}, 2, null);
            fail("Project ids cannot contain non-positive id.");
        } catch (IllegalArgumentException e) {
    ...
    /**
     * Tests method: getNotificationsForUser(long, long).
     *
     * With non-positive user id, IlelgalArgumentException should be thrown.
     *
     * @throws Exception to JUnit
     * @since 1.3
     */
    public void testGetNotificationsForUser_13_NonPositiveUserId() throws Exception {
        try {
            manager.getNotificationsForUser(-1, 2);
            fail("The user id must be positive.");
        } catch (IllegalArgumentException e) {
            // success
        }
    }
     ...
     * Tests method: getNotificationsForUser(long, long).
     *
     * With non-positive notification id, IlelgalArgumentException should be thrown.
     *
     * @throws Exception to JUnit
     * @since 1.3
     */
    public void testGetNotificationsForUser_13_NonPositiveNotificationTypeId() throws Exception {
        try {
            manager.getNotificationsForUser(1, -2);
            fail("The notification type id must be positive.");
        } catch (IllegalArgumentException e) {
     ...
     * @since 1.3
     */
    public void testGetNotificationsForUser_Accuracy() throws Exception {
        long[] notifications = manager.getNotificationsForUser(1, 2);
        long[] expected = new long[] {1, 2, 3};
    ...
    /**
     * Tests method: searchResources(long, long). The project id is negative. IAE expected.
     *
     * @throws Exception to JUnit
     * @since 1.3
     */
    public void testsearchResources_negative_projectId_roleId() throws Exception {
        try {
            manager.searchResources(-1, 1);
            fail("The project id id must be positive.");
        } catch (IllegalArgumentException e) {
            // success
        }
    }
     ...
     * @since 1.3
     */
    public void testsearchResources_projectId_negative_roleId() throws Exception {
        try {
            manager.searchResources(1, -1);
            fail("The role id id must be positive.");
        } catch (IllegalArgumentException e) {
            // success
        }
    }
    ...
    private void insertRecords() throws Exception {
        ...
        doSQLUpdate(con, sql, new Object[] {new Long(1), new Long(1), new Long(1), new Long(1)});

        doSQLUpdate(con, sql, new Object[] {new Long(2), new Long(1), new Long(2), new Long(1)});

        doSQLUpdate(con, sql, new Object[] {new Long(3), new Long(1), new Long(3), new Long(1)});

        doSQLUpdate(con, sql, new Object[] {new Long(4), new Long(2), new Long(1), new Long(1)});

        doSQLUpdate(con, sql, new Object[] {new Long(5), new Long(2), new Long(2), new Long(1)});

        doSQLUpdate(con, sql, new Object[] {new Long(6), new Long(2), new Long(3), new Long(1)});

        doSQLUpdate(con, sql, new Object[] {new Long(7), new Long(3), new Long(1), new Long(1)});

        doSQLUpdate(con, sql, new Object[] {new Long(8), new Long(3), new Long(2), new Long(1)});

        doSQLUpdate(con, sql, new Object[] {new Long(9), new Long(3), new Long(3), new Long(1)});
        ...
        doSQLUpdate(con, sql, new Object[] {new Long(4), new Long(1), "value 3"});
        doSQLUpdate(con, sql, new Object[] {new Long(5), new Long(1), "value 3"});
        doSQLUpdate(con, sql, new Object[] {new Long(6), new Long(1), "value 3"});
        doSQLUpdate(con, sql, new Object[] {new Long(7), new Long(1), "value 3"});
        doSQLUpdate(con, sql, new Object[] {new Long(8), new Long(1), "value 3"});
        doSQLUpdate(con, sql, new Object[] {new Long(9), new Long(1), "value 3"});
        ...
        doSQLUpdate(con, sql, new Object[] {new Long(4), new Long(2), "value 3"});
        doSQLUpdate(con, sql, new Object[] {new Long(5), new Long(2), "value 3"});
        doSQLUpdate(con, sql, new Object[] {new Long(6), new Long(2), "value 3"});
        doSQLUpdate(con, sql, new Object[] {new Long(7), new Long(2), "value 3"});
        doSQLUpdate(con, sql, new Object[] {new Long(8), new Long(2), "value 3"});
        doSQLUpdate(con, sql, new Object[] {new Long(9), new Long(2), "value 3"});
        ...
        doSQLUpdate(con, sql, new Object[] {new Long(4), new Long(3), "value 3"});
        doSQLUpdate(con, sql, new Object[] {new Long(5), new Long(3), "value 3"});
        doSQLUpdate(con, sql, new Object[] {new Long(6), new Long(3), "value 3"});
        doSQLUpdate(con, sql, new Object[] {new Long(7), new Long(3), "value 3"});
        doSQLUpdate(con, sql, new Object[] {new Long(8), new Long(3), "value 3"});
        doSQLUpdate(con, sql, new Object[] {new Long(9), new Long(3), "value 3"});
        ...
        sql = "INSERT INTO notification (project_id, external_ref_id, notification_type_id,"
                + " create_user, create_date, modify_user, modify_date)"
                + " VALUES(?, ?, ?, 'developer', CURRENT, 'developer', CURRENT)";
    ...
    private void removeTables() throws Exception {
        String[] tables = new String[] {"notification", "notification_type_lu", "resource_submission", "resource_info",
    ...
    private boolean checkNotificationEquals(Notification n1, Notification n2) {
        return (n1.getProject() == n2.getProject())
                && (n1.getNotificationType().getId() == n2.getNotificationType().getId())
                && (n1.getExternalId() == n2.getExternalId());
    }
    ...
    private void setAllFieldsSearchable(SearchBundle searchBundle) {
        ...
        fields.put(ResourceFilterBuilder.SUBMISSION_ID_FIELD_NAME, new OrValidator(StringValidator
                .containsSubstring("null"), LongValidator.isPositive()));
