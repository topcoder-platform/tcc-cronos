 ...
 *
 * <p>
 * For version 1.3, demos how to add/remove/get notification for projects.
 * </p>
 *
 * @author kinfkong, Rica, Xuchen, waits
 * @version 1.3
 * @since 1.0
 */
public class Demo extends TestCase {
    ...
    /**
     * Shows how to add and remove notifications for given user and notification type. For array of projects.
     *
     * @throws Exception to JUnit
     */
    public void testDemo_addAndRemoveNotifications_13() throws Exception {
        long projects[] = new long[] {1, 2};
        long user = 1;
        long notificationType = 1;
        String operator = "demo_user";
        //add
        ...
        //get
        manager.getNotificationsForUser(user, notificationType);
    }
