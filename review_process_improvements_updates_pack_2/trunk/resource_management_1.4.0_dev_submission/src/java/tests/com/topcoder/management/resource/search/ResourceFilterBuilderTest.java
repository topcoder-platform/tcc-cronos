...
public class ResourceFilterBuilderTest extends TestCase {
    ...
    public void testCreateResourceIdFilter_Accuracy() {
        ...
        assertTrue("It should be an instance of EqualToFilter.",
        ...
        // check the value
        assertEquals("The value is not property set.", 1,
    ...
    public void testCreateExtensionPropertyValueFilter_Accuracy() {
        // create the filter
        Filter filter = ResourceFilterBuilder.createExtensionPropertyValueFilter(
                "This is a name");
        ...
        // check the value
        assertEquals("The value is not property set.", "This is a name",
    ...
    public void testCreateExtensionPropertyNameFilter_Accuracy() {
        // create the filter
        Filter filter = ResourceFilterBuilder.createExtensionPropertyNameFilter(
                "This is a name");
    ...
    public void testCreateNoProjectFilter() {
        ...
        assertTrue("The filter should be a null filter.",
    ...
    public void testCreateAnySubmissionIdFilter_NonPositiveElement() {
        try {
            ResourceFilterBuilder.createAnySubmissionIdFilter(new long[] {
                    1, 2, -1
                });
            fail("It should throw IllegalArgumentException.");
        } catch (IllegalArgumentException e) {
    ...
    public void testCreateAnySubmissionIdFilter_EmptyArray() {
        ...
        assertTrue("It should be an instance of NullFilter.",
            filter instanceof NullFilter);

        // check the name
        assertEquals("The name is not property set.",
            ResourceFilterBuilder.SUBMISSION_ID_FIELD_NAME,
            ((NullFilter) filter).getName());

        // check the value
        assertNull("The value is not property set.",
            ((NullFilter) filter).getValue());
    }
    ...
    public void testCreateAnySubmissionIdFilter_Accuracy1() {
        Filter filter = ResourceFilterBuilder.createAnySubmissionIdFilter(new long[] {
                    1, 2, 3
                });

        // It should be an instance of InFilter
        assertTrue("It should be an instance of InFilter.",
            filter instanceof InFilter);

        // check the name
        assertEquals("The name is not property set.",
            ResourceFilterBuilder.SUBMISSION_ID_FIELD_NAME,
            ((InFilter) filter).getName());
        ...
        assertEquals("The value is not property set.", expectedListSet,
            new HashSet(((InFilter) filter).getList()));
    }
