...
public class GameImplUnitTests extends TestCase {
     ...
     *             to JUnit
     */
    public void testGetBallColor_1_accuracy() throws Exception {
     ...
     *             to JUnit
     */
    public void testSetBallColor_1_accuracy() throws Exception {
        target.setBallColor(ballColor);
     ...
     *             to JUnit
     */
    public void testGetBlocks_1_accuracy() throws Exception {
     ...
     *             to JUnit
     */
    public void testSetBlocks_1_accuracy() throws Exception {
        target.setBlocks(blocks);
     ...
     *             to JUnit
     */
    public void testGetEndDate_1_accuracy() throws Exception {
     ...
     *             to JUnit
     */
    public void testSetEndDate_1_accuracy() throws Exception {
        target.setEndDate(endDate);
     ...
     *             to JUnit
     */
    public void testGetKeyCount_1_accuracy() throws Exception {
     ...
     *             to JUnit
     */
    public void testSetKeyCount_1_accuracy() throws Exception {
        target.setKeyCount(keyCount);
     ...
     *             to JUnit
     */
    public void testGetName_1_accuracy() throws Exception {
        target.setName(name);
     ...
     *             to JUnit
     */
    public void testSetName_1_accuracy() throws Exception {
        target.setName(name);
        assertEquals("Name set incorrectly.", name, target.getName());
    }
     ...
     *             to JUnit
     */
    public void testGetStartDate_1_accuracy() throws Exception {
     ...
     *             to JUnit
     */
    public void testSetStartDate_1_accuracy() throws Exception {
        target.setStartDate(startDate);
