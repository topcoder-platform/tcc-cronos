...
import com.orpheus.administration.handlers.PendingWinnerRejectionHandler;
...
/**
 * <p>
 * Failure test for <code>PendingWinnerRejectionHandler</code> class.
 * </p>
 *
 * @author tuenm
 * @version 1.0
 */
public class PendingWinnerRejectionHandlerFailureTests extends TestCase {
    ...
    /**
     * The PendingWinnerRejectionHandler instance to test.
     */
    private PendingWinnerRejectionHandler handler = null;
    ...
    protected void setUp() throws Exception {
        ...
        handler = new PendingWinnerRejectionHandler(element);
    }
    ...
    public void testConstructorMissingHandlerTag() throws Exception {
        try {
            ...
            new PendingWinnerRejectionHandler(element);
