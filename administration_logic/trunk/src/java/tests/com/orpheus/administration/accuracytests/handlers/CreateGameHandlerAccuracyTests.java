...
public class CreateGameHandlerAccuracyTests extends TestCase {
    ...
    public void testConstructorAccuracy() throws Exception {
        ...
        assertEquals("auctionEndTimePropName", this.auctionEndTimePropName,
                Helper.getPrivateField(CreateGameHandler.class, target,
                        "auctionEndTimePropName"));
        assertEquals("auctionMgrAttrName", this.auctionMgrAttrName, Helper
        ...
        assertEquals("ballColorIdAttrName", this.ballColorIdAttrName,
                Helper.getPrivateField(CreateGameHandler.class, target,
                        "ballColorIdAttrName"));
        assertEquals("blockCountAttrName", this.blockCountAttrName, Helper
                .getPrivateField(CreateGameHandler.class, target,
                        "blockCountAttrName"));
        assertEquals("blockInfoParamName", this.blockInfoParamName, Helper
                .getPrivateField(CreateGameHandler.class, target,
                        "blockInfoParamName"));
        assertEquals("dtFormatParamName", this.dtFormatParamName, Helper
                .getPrivateField(CreateGameHandler.class, target,
                        "dtFormatParamName"));
        assertEquals("failedResult", this.failedResult, Helper
                .getPrivateField(CreateGameHandler.class, target,
                        "failedResult"));
        assertEquals("failRequestAttrName", this.failRequestAttrName,
                Helper.getPrivateField(CreateGameHandler.class, target,
                        "failRequestAttrName"));
        assertEquals("gameDataJndiName", this.gameDataJndiName, Helper
                .getPrivateField(CreateGameHandler.class, target,
                        "gameDataJndiName"));
        assertEquals("keyCountAttrName", this.keyCountAttrName, Helper
                .getPrivateField(CreateGameHandler.class, target,
                        "keyCountAttrName"));
        assertEquals("maxSlotTimePropName", this.maxSlotTimePropName,
                Helper.getPrivateField(CreateGameHandler.class, target,
                        "maxSlotTimePropName"));
        assertEquals("minimumBid", new Integer(this.minimumBid), Helper
                .getPrivateField(CreateGameHandler.class, target, "minimumBid"));
        assertEquals("slotCountPropName", this.slotCountPropName, Helper
                .getPrivateField(CreateGameHandler.class, target,
                        "slotCountPropName"));
        assertEquals("startDateAttrName", this.startDateAttrName, Helper
                .getPrivateField(CreateGameHandler.class, target,
                        "startDateAttrName"));
    }
