...
import com.orpheus.administration.handlers.SponsorImageApprovalHandler;
import com.topcoder.web.frontcontroller.Handler;

/**
 * <p>
 * Stress test for <code>{@link com.orpheus.administration.handlers.SponsorImageApprovalHandler}</code> class.
 * </p>
 * @author FireIce
 * @version 1.0
 */
public class SponsorImageApprovalHandlerStressTest extends AbstractHandlerStressTest {
    ...
    protected Handler getHandler() throws Exception {
        ...
        return new SponsorImageApprovalHandler(StressTestHelper.loadXmlString(xml));
    }
    ...
    protected String getHandlerName() {
        return "SponsorImageApprovalHandler";
    }
