...
/**
 * <p>
 * Stress test for <code>{@link com.orpheus.administration.handlers.DomainRejectionHandler}</code> class.
 * </p>
 * @author FireIce
 * @version 1.0
 */
public class DomainRejectionHandlerStressTest extends AbstractHandlerStressTest {
    ...
    protected Handler getHandler() throws Exception {
        ...
        return new DomainRejectionHandler(StressTestHelper.loadXmlString(xml));
    }
