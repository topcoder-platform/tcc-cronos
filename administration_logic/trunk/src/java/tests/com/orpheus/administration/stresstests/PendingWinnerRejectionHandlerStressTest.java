...
/**
 * <p>
 * Stress test for <code>{@link com.orpheus.administration.handlers.PendingWinnerRejectionHandler}</code> class.
 * </p>
 * @author FireIce
 * @version 1.0
 */
public class PendingWinnerRejectionHandlerStressTest extends AbstractHandlerStressTest {
    ...
    protected Handler getHandler() throws Exception {
        ...
        return new PendingWinnerRejectionHandler(StressTestHelper.loadXmlString(xml));
    }
    ...
    protected String getHandlerName() {
        return "PendingWinnerRejectionHandler";
    }
