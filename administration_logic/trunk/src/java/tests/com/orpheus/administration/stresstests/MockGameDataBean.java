...
public class MockGameDataBean implements SessionBean {
     ...
     * that are null will be automatically assigned acceptable values. No hosting slots are created for the game at this
     * time. The returned Game object will represent the persisted data, including any IDs assigned to the game and
     * blocks. Uses the GameDataDAOFActory to obtain the GameDataDAO to perform this action.
     * <p>
     ...
     * <li>Call and return gameDataDAO.createSlots(blockId, bidIds):HostingSlot[]</li>
     ...
     * reflect the persistent representation, including any automatically assigned IDs. Uses the GameDataDAOFActory to
     ...
     * @throws DuplicateEntryException
     *             If id or imageInfo.id is not null but already exists in persistence
     * @throws PersistenceException
     *             If there is any problem in the persistence layer.
     * @throws IllegalArgumentException
     *             If domain is null
     ...
     * next available sequence number after those of the game's existing blocks (or 1 if there are no other blocks), no
     * hosting slots, and the specified maximum hosting time per slot. It returns a HostingBlock object representing the
     * new block. Uses the GameDataDAOFActory to obtain the GameDataDAO to perform this action.
     * <p>
     * <strong>Implementation Notes</strong>
     * </p>
     * <ul type="disc">
     * <li>Get DAO from factory: GameDataDAOFactory.getGameDataDAO()</li>
     * <li>Call and return gameDataDAO.addBlock(gameId, slotMaxHostingTime):HostingBlock</li>
     * <li>If exception thrown, call sessionContext.setRollbackOnly()</li>
     * </ul>
    ...
    /**
     * Retrieves a Game object representing the Game having the specified ID. Uses the GameDataDAOFActory to obtain the
     ...
     * <ul type="disc">
     * <li>Get DAO from factory: GameDataDAOFactory.getGameDataDAO()</li>
     * <li>Call and return gameDataDAO.getGame(gameId):Game</li>
     * <li>If exception thrown, call sessionContext.setRollbackOnly()</li>
     * </ul>
     * @return the game
     * @param gameId
    ...
    public Game getGame(long gameId) {
        ...
        HostingBlockImpl hostingBlockImpl = new HostingBlockImpl();
        hostingBlockImpl.setId(new Long(gameId));
        HostingSlotImpl hostingSlotImpl = new HostingSlotImpl();
        hostingSlotImpl.setId(new Long(gameId));
        hostingSlotImpl.setHostingStart(new Date(new Date().getTime() + 2000));
        hostingSlotImpl.setHostingEnd(new Date(new Date().getTime() + 1000));
        hostingBlockImpl.setSlots(new HostingSlot[] {hostingSlotImpl});
        game.setBlocks(new HostingBlock[] {hostingBlockImpl});
        return game;
    }

    /**
     * Retrieves a HostingBlock object representing the hosting block having the specified ID. Uses the
     * GameDataDAOFActory to obtain the GameDataDAO to perform this action.
     * <p>
     * <strong>Implementation Notes</strong>
     * </p>
     * <ul type="disc">
     * <li>Get DAO from factory: GameDataDAOFactory.getGameDataDAO()</li>
     * <li>Call and return gameDataDAO.getBlock(blockId):HostingBlock</li>
     * <li>If exception thrown, call sessionContext.setRollbackOnly()</li>
     * </ul>
     * @return the block
     * @param blockId
    ...
    /**
     * Retrieves a HostingSlot object representing the slot having the specified ID. Uses the GameDataDAOFActory to
     * obtain the GameDataDAO to perform this action.
     * <p>
     * <strong>Implementation Notes</strong>
     * </p>
     * <ul type="disc">
     * <li>Get DAO from factory: GameDataDAOFactory.getGameDataDAO()</li>
     * <li>Call and return gameDataDAO.getSlot(slotId):HostingSlot</li>
     * <li>If exception thrown, call sessionContext.setRollbackOnly()</li>
     * </ul>
     * @return the slot
     * @param slotId
    ...
    public HostingSlot getSlot(long slotId) {
        ...
        hostingSlotImpl.setHostingEnd(new Date(new Date().getTime() + 10000));
        hostingSlotImpl.setHostingStart(new Date(new Date().getTime() + 20000));
        DomainTargetImpl dt = new DomainTargetImpl();
        dt.setIdentifierText("Identifier Text");
        hostingSlotImpl.setDomainTargets(new DomainTarget[]{dt});
        return hostingSlotImpl;
    }

    /**
     * Retrieves the DownloadData object corresponding to the specified ID. Uses the GameDataDAOFActory to obtain the
     * GameDataDAO to perform this action.
     * <p>
     * <strong>Implementation Notes</strong>
     * </p>
    ...
    /**
     * Retrieves a Domain object representing the domain corresponding to the specified ID. Uses the GameDataDAOFActory
     * to obtain the GameDataDAO to perform this action.
     * <p>
     * <strong>Implementation Notes</strong>
     * </p>
     * <ul type="disc">
     * <li>Get DAO from factory: GameDataDAOFactory.getGameDataDAO()</li>
     * <li>Call and return gameDataDAO.getDomain(domainId):Domain</li>
     * <li>If exception thrown, call sessionContext.setRollbackOnly()</li>
     * </ul>
     * @return the domain
     * @param domainId
     ...
     * returned array is the key text associated with the slot completion by the specified player of the slot whose ID
     * appears at the same index in the input slotIds. If the specified player has not completed any particular slot
     * specified among the slot IDs then the corresponding element or the returned array is null. Uses the
     * GameDataDAOFActory to obtain the GameDataDAO to perform this action.
     * <p>
     * <strong>Implementation Notes</strong>
     * </p>
     * <ul type="disc">
     * <li>Get DAO from factory: GameDataDAOFactory.getGameDataDAO()</li>
     * <li>Call and return gameDataDAO.getKeysForPlayer(playerId, slotIds):String[]</li>
     * <li>If exception thrown, call sessionContext.setRollbackOnly():</li>
     * </ul>
    ...
    /**
     * Retrieves the PuzzleData associated with the specified puzzle ID. Uses the GameDataDAOFActory to obtain the
     * GameDataDAO to perform this action.
     * <p>
     * <strong>Implementation Notes</strong>
     * </p>
     * <ul type="disc">
     * <li>Get DAO from factory: GameDataDAOFactory.getGameDataDAO()</li>
     * <li>Call and return gameDataDAO.getPuzzle(long puzzleId):PuzzleData</li>
     * <li>If exception thrown, call sessionContext.setRollbackOnly()</li>
     * </ul>
    ...
    /**
     * Increments the download count for the plugin identified by the specified name. Uses the GameDataDAOFActory to
     * obtain the GameDataDAO to perform this action.
     * <p>
     * <strong>Implementation Notes</strong>
     * </p>
    ...
    /**
     * Records the specified player's registration for the specified game. Uses the GameDataDAOFActory to obtain the
     * GameDataDAO to perform this action.
     * <p>
     * <strong>Implementation Notes</strong>
     * </p>
     ...
     * generates a key for the player to associate with the completion. Uses the GameDataDAOFActory to obtain the
     * GameDataDAO to perform this action.
     * <p>
     * <strong>Implementation Notes</strong>
     * </p>
     * <ul type="disc">
     * <li>Get DAO from factory: GameDataDAOFactory.getGameDataDAO()</li>
     * <li>Call and return gameDataDAO.recordSlotCompletion(playerId, slotId, Date date):SlotCompletion</li>
     * <li>If exception thrown, call sessionContext.setRollbackOnly()</li>
     * </ul>
     ...
     * establishment of winner eligibility. Uses the GameDataDAOFActory to obtain the GameDataDAO to perform this
     * action.
     * <p>
     * <strong>Implementation Notes</strong>
     * </p>
     ...
     * assigned to the binary object is returned. Uses the GameDataDAOFActory to obtain the GameDataDAO to perform this
     * action.
     * <p>
     * <strong>Implementation Notes</strong>
     * </p>
     * <ul type="disc">
     * <li>Get DAO from factory: GameDataDAOFactory.getGameDataDAO()</li>
     * <li>Call and return gameDataDAO.recordBinaryObject(name, mediaType, content):long</li>
     * <li>If exception thrown, call sessionContext.setRollbackOnly()</li>
     * </ul>
    ...
    /**
     * Updates the persistent hosting slot information for the existing slots represented by the specified HostingSlot
     * objects, so that the persistent representation matches the provided objects. Nested DomainTarget objects may or
     * may not already be recorded in persistence; the component assumes that DomainTarget's with null IDs are new, and
     * that others already exist in the database. The component will assign IDs for new DomainTargets as needed. This
     * method will also update the following additional HostingSlot properties (only): sequence number, hosting start,
     * hosting end, brain teaser IDs, puzzle ID. It will return an array containing the revised hosting slots. Uses the
     * GameDataDAOFActory to obtain the GameDataDAO to perform this action.
     * <p>
     * <strong>Implementation Notes</strong>
     * </p>
     ...
     * @throws EntryNotFoundException
     *             If HsotingSlot.id or DomainTarget.id, if not null, is not in persistence
     * @throws PersistenceException
     *             If there is any problem in the persistence layer.
     * @throws IllegalArgumentException
     *             If slots is null
     ...
     * appropriate persistent record is identified by the Domain's ID. Uses the GameDataDAOFActory to obtain the
     * GameDataDAO to perform this action.
     * <p>
     * <strong>Implementation Notes</strong>
     * </p>
     ...
     *            domain to update
     * @throws EntryNotFoundException
     *             If Domain.id or ImageInfo.id, if not null, is not in persistence
     * @throws PersistenceException
     *             If there is any problem in the persistence layer.
     * @throws IllegalArgumentException
     *             If domain is null
    ...
    /**
     * Deletes the hosting slot having the specified ID. Uses the GameDataDAOFActory to obtain the GameDataDAO to
     * perform this action.
     * <p>
     * <strong>Implementation Notes</strong>
     * </p>
     ...
     * representing the results. Uses the GameDataDAOFActory to obtain the GameDataDAO to perform this action.
     * <p>
     * <strong>Implementation Notes</strong>
     * </p>
     * <ul type="disc">
    ...
    /**
     * Looks up all ongoing games in which a domain matching the specified string is a host in a slot that the specified
     * player has not yet completed, and returns an array of all such games. Uses the GameDataDAOFActory to obtain the
     * GameDataDAO to perform this action.
     * <p>
     * <strong>Implementation Notes</strong>
     * </p>
     * <ul type="disc">
     * <li>Get DAO from factory: GameDataDAOFactory.getGameDataDAO()</li>
     * <li>Call and return gameDataDAO.findGamesByDomain(domain, playerId):Game[]</li>
     * <li>If exception thrown, call sessionContext.setRollbackOnly()</li>
     * </ul>
     ...
     *            the player id
     * @throws EntryNotFoundException
     *             If there is no domain with the given name, or no player with such an id in persistence
     * @throws PersistenceException
     *             If there is any problem in the persistence layer.
     * @throws IllegalArgumentException
     ...
     * HostingSlot objects. Returned slots are in ascending order by first completion time, or equivalently, in
     * ascending order by hosting block sequence number and hosting slot sequence number. Uses the GameDataDAOFActory to
     * obtain the GameDataDAO to perform this action.
     * <p>
     * <strong>Implementation Notes</strong>
     * </p>
    ...
    /**
     * Looks up all recorded completion events that have the specified hosting slot in the specified game. Uses the
     * GameDataDAOFActory to obtain the GameDataDAO to perform this action.
     * <p>
     * <strong>Implementation Notes</strong>
     * </p>
     * <ul type="disc">
     * <li>Get DAO from factory: GameDataDAOFactory.getGameDataDAO()</li>
     * <li>Call and return gameDataDAO.findSlotCompletions(gameId, slotId):SlotCompletion[]</li>
     * <li>If exception thrown, call sessionContext.setRollbackOnly()</li>
     * </ul>
    ...
    /**
     * Retrieves game information for games meeting the specified game status criteria. Uses the GameDataDAOFActory to
     * obtain the GameDataDAO to perform this action.
     * <p>
     * <strong>Implementation Notes</strong>
     * </p>
     ...
     * @param isStarted
     *            a Boolean having value true to restrict to games that have started or false to restrict to games that
     *            have not yet started; null to ignore whether games have started
     * @param isEnded
     *            a Boolean having value true to restrict to games that have ended or false to restrict to games that
    ...
    /**
     * Looks up all the games for which the specified player is registered, and returns an array of their IDs. Uses the
     * GameDataDAOFActory to obtain the GameDataDAO to perform this action.
     * <p>
     * <strong>Implementation Notes</strong>
     * </p>
     ...
     * them. Uses the GameDataDAOFActory to obtain the GameDataDAO to perform this action.
     * <p>
     * <strong>Implementation Notes</strong>
     * </p>
     * <ul type="disc">
     * <li>Get DAO from factory: GameDataDAOFactory.getGameDataDAO()</li>
     * <li>Call and return gameDataDAO.findDomainsForSponsor(sponsorId):Domain[]</li>
     * <li>If exception thrown, call sessionContext.setRollbackOnly()</li>
     * </ul>
    ...
    /**
     * Finds the first HostingSlot in the hosting sequence for the specified game that is assigned the specified domain
     * and has not yet been completed by the specified player. Uses the GameDataDAOFActory to obtain the GameDataDAO to
     * perform this action.
     * <p>
     * <strong>Implementation Notes</strong>
     * </p>
     * <ul type="disc">
     * <li>Get DAO from factory: GameDataDAOFactory.getGameDataDAO()</li>
     * <li>Call and return gameDataDAO.findSlotForDomain(gameId, playerId, domain):HostingSlot</li>
     * <li>If exception thrown, call sessionContext.setRollbackOnly()</li>
     * </ul>
     * @return hosting slot
     * @param gameId
     ...
     *            the domain
     * @throws EntryNotFoundException
     *             If there is no domain with the given name, or no player or game with such an id in persistence
     * @throws PersistenceException
     *             If there is any problem in the persistence layer.
     * @throws IllegalArgumentException
     *             If domain is null/empty
    ...
    /**
     * Provides information about all ball colors available to the application. Uses the GameDataDAOFActory to obtain
     * the GameDataDAO to perform this action.
     * <p>
     * <strong>Implementation Notes</strong>
     * </p>
     * <ul type="disc">
