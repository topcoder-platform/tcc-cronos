...
public class DomainTargetImplUnitTests extends TestCase {
     ...
     *             to JUnit
     */
    public void testGetClueImageId_1_accuracy() throws Exception {
     ...
     *             to JUnit
     */
    public void testSetClueImageId_1_accuracy() throws Exception {
        target.setClueImageId(CLUE_IMAGE_ID);
     ...
     *             to JUnit
     */
    public void testGetIdentifierHash_1_accuracy() throws Exception {
     ...
     *             to JUnit
     */
    public void testSetIdentifierHash_1_accuracy() throws Exception {
        target.setIdentifierHash(IDENTIFIER_HASH);
     ...
     *             to JUnit
     */
    public void testGetIdentifierText_1_accuracy() throws Exception {
     ...
     *             to JUnit
     */
    public void testSetIdentifierText_1_accuracy() throws Exception {
        target.setIdentifierText(IDENTIFIER_TEXT);
     ...
     *             to JUnit
     */
    public void testGetUriPath_1_accuracy() throws Exception {
     ...
     *             to JUnit
     */
    public void testSetUriPath_1_accuracy() throws Exception {
        target.setUriPath(URI_PATH);
