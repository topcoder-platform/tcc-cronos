...
/**
 * <p>
 * Test the <code>ConfigurationException</code> class.
 * </p>
 *
 * @author TCSDEVELOPER
 * @version 1.0
...
public class ConfigurationExceptionUnitTests extends TestCase {
     ...
     *
     * <p>
     * Verifies ConfigurationException subclasses AdministrationException.
     * </p>
     */
    public void testInheritance() {
        assertTrue(
                "ConfigurationException does not subclass AdministrationException.",
                target instanceof AdministrationException);
    }

    /**
     * <p>
     * Accuracy test. Tests the <code>ConfigurationException(String)</code>
     ...
     * <code>ConfigurationException(String, Throwable)</code> Create for
