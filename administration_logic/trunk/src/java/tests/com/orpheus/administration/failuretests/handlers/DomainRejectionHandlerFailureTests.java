...
import com.orpheus.administration.handlers.DomainRejectionHandler;
...
/**
 * <p>
 * Failure test for <code>DomainRejectionHandler</code> class.
 * </p>
 *
 * @author tuenm
 * @version 1.0
 */
public class DomainRejectionHandlerFailureTests extends TestCase {

    /**
     * The Xml string used in test cases.
     */
    private String xml = "<handler type=\"domainApproval\"><object-factory-ns>"
            + "objFactoryNS</object-factory-ns><admin-data-jndi-name>"
            + "AdminDataHome</admin-data-jndi-name><game-data-jndi-name>"
            + "GameDataHome</game-data-jndi-name><domain-id-request-param>"
    ...
    /**
     * The DomainRejectionHandler instance to test.
     */
    private DomainRejectionHandler handler = null;
    ...
    protected void setUp() throws Exception {
        ...
        handler = new DomainRejectionHandler(element);
    }
    ...
    public void testConstructorMissingHandlerTag() throws Exception {
        try {
            ...
            new DomainRejectionHandler(element);
