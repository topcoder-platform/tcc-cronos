...
/**
 * <p>
 * Failure test for <code>DeleteSlotHandler</code> class.
 * </p>
 *
 * @author tuenm
 * @version 1.0
 */
public class DeleteSlotHandlerFailureTests extends TestCase {

    /**
     * The Xml string used in test cases.
     */
    private String xml = "<handler type=\"deleteSlot\"><game-data-jndi-name>"
    ...
    /**
     * The DeleteSlotHandler instance to test.
     */
    private DeleteSlotHandler handler = null;
    ...
    protected void setUp() throws Exception {
        ...
        handler = new DeleteSlotHandler(element);
    }
