...
/**
 * <p>
 * Stress test for <code>{@link com.orpheus.administration.handlers.SponsorApprovalHandler}</code> class.
 * </p>
 * @author FireIce
 * @version 1.0
 */
public class SponsorApprovalHandlerStressTest extends AbstractHandlerStressTest {
    ...
    protected Handler getHandler() throws Exception {
        ...
        return new SponsorApprovalHandler(StressTestHelper.loadXmlString(xml));
    }
