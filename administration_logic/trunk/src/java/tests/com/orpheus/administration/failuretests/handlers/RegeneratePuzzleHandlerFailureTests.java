...
/**
 * <p>
 * Failure test for <code>RegeneratePuzzleHandler</code> class.
 * </p>
 *
 * @author tuenm
 * @version 1.0
 */
public class RegeneratePuzzleHandlerFailureTests extends TestCase {

    /**
     * The Xml string used in test cases.
     */
    private String xml = "<handler type=\"regeneratePuzzle\">"
            + "<game-data-jndi-name>"
    ...
    /**
     * The RegeneratePuzzleHandler instance to test.
     */
    private RegeneratePuzzleHandler handler = null;
    ...
    protected void setUp() throws Exception {
        ...
        handler = new RegeneratePuzzleHandler(element);
    }
    ...
    public void testConstructorMissingHandlerTag() throws Exception {
        try {
            ...
            new RegeneratePuzzleHandler(element);
