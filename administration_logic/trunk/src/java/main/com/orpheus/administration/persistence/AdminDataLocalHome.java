...
/**
 * <p>This is the local home interface for managing administration data. The local client will obtain it to get the local interface.</p>
 ...
 */
    public com.orpheus.administration.persistence.AdminDataLocal create();
