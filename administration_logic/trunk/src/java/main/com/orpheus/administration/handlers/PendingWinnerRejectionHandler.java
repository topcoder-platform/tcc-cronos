 ...
 * in order to reject the pending winner.<br/> Thread-Safety: This class is
 ...
 * @version 1.0
 */
public class PendingWinnerRejectionHandler extends
     ...
     */
    public PendingWinnerRejectionHandler(Element handlerElement) {
        super(handlerElement);
    }

    /**
     * Implementation of abstract method defined in super class. Will simply
     * return false in order to reject the pending winner.
     *
     *
     * @return false.
     */
