...
public class GameDataManagerImpl extends BaseGameDataManager {
     ...
     */
    private static final String NEW_GAME_POLL_INTERVAl = "new_game_poll_interva";
     ...
     * started games game entries that shoudl bestarted at some regular,
     ...
     * At any point all methods in the API shoudl test this variable and
     * if the variable is true IllegalStateException should ne thrown.
     * </p>
     *
     */
        ...
        for (int i = 0; i < jndiNames.length; i++) {
            try {
                ...
                if (LOCAL.equalsIgnoreCase(jndiDesignations[i])) {
                    ...
                    GameDataHome home = (GameDataHome) ctx.lookup(jndiNames[i]);
    ...
    private class GameStartNotifier extends Thread {
         ...
         * </p>
         *
         * @param sleepInterval interval which dictates how often teh thread checks if a game has started.
         ...
         * This is simply achieved by changing the value of stopped to false.
         * </p>
         *
         */
    ...
    private class NewGameAvailableNotifier extends Thread {
        ...
        /**
         * <p>
         * Represents the flag (used to stop the thread) that tells the thread if it shoudl stop execution or not.
         ...
         * </p>
         *
         * @param sleepInterval interval which dictates how often teh thread polls the server, the unit is milliseconds.
         ...
         * </p>
         *
         * @param sleepInterval interval which dictates how often teh thread polls the server.
         * The unit is in milliseconds (ms)
         * @param listener the NewGameAvailableListener instance.
         ...
         * This is simply achieved by changing teh value of stopped to false.
         * </p>
         *
         */
        public void stopNotifier() {
