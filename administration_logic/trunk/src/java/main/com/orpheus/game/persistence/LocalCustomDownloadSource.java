...
public class LocalCustomDownloadSource extends CustomDownloadSource {
    ...
    /**
     * <p>Represents the local ejb instance used for all calls. Created in the consructor, will not be null, and will not change.</p>
     * 
     */
    private final com.orpheus.game.persistence.GameDataLocal gameDataEJB;


    /**
     * <p>Instantiates new LocalCustomDownloadSource instance from the given namespace. It will use ConfigManager to obtain a reference to the EJB GameDataLocal.</p>
     ...
     * <li>GameDataLocalHomel home = (GameDataLocalHome) ic.lookup(reference)</li>
     * <li>GameDataLocal auctionEJB = home.create()</li>
     * <li>Set to field.</li>
     * </ul>
     * 
     * 
