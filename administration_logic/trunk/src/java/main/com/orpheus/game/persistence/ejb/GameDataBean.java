...
/**
 * The EJB that handles the actual client requests. It accepts all client operations, but simply delegates
 * all operations to the GameDataDAO it obtains from the GameDataDAOFactory.
 * <p><strong>Thread Safety</strong></p>
 * <p>This object is mutable and thread-safe, as the container handles this.</p>
 * 
 */
public class GameDataBean implements javax.ejb.SessionBean {
    /**
     * Represents the session context of this bean. It is used to indicate to the container if the bean
     * wants to rollback a transaction. This would usually occur if an application exception occurs.
     * Set in the setSessionContext() method by the container.
     * 
     */
     ...
     * Uses the GameDataDAOFActory to obtain the GameDataDAO to perform this action.
     * <p><strong>Implementation Notes</strong></p>
     * <ul type="disc">
     * <li>Get DAO from factory: GameDataDAOFactory.getGameDataDAO()</li>
     ...
     * objects. Any null Domain or ImageIndo IDs are assigned
     ...
     * the player to associate with the completion.
     * Uses the GameDataDAOFActory to obtain the GameDataDAO to perform this action.
     * <p><strong>Implementation Notes</strong></p>
     * <ul type="disc">
     * <li>Get DAO from factory: GameDataDAOFactory.getGameDataDAO()</li>
    ...
    /**
     * Looks up all recorded completion events that have
     * the specified hosting slot in the specified game.
     * Uses the GameDataDAOFActory to obtain the GameDataDAO to perform this action.
     * <p><strong>Implementation Notes</strong></p>
     * <ul type="disc">
     * <li>Get DAO from factory: GameDataDAOFactory.getGameDataDAO()</li>
