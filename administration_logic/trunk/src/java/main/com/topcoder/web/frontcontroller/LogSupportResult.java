...
/**
 * <p>
 * This interface extends the Result interface and provides the support required for performing the 
 * Logging and tracing using the Logging Wrapper 1.2 component during the various stages of execution of 
 * the Request. This method overrides the only method defined by the Result interface with additonal
 ...
 * 
 */
public interface LogSupportResult extends com.topcoder.web.frontcontroller.Result {

/**
 * <p>
 * Executes the Result as defined in the overloaded method in the base interface and performs the Logging at 
 ...
 * @throws ResultExecutionException: if there are problems in executing this Result implementation
 * @throws IllegalArgumentException: if any of the parameters passed is null
 */
    public void execute(com.topcoder.web.frontcontroller.ActionContext context, com.topcoder.util.log.Log logger, com.topcoder.util.log.Level level);
}
