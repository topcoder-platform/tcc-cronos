 ...
 * @version 1.0
 */
public class ChatSessionManagerTester implements ChatSessionManager {
    /**
     * <p>
     ...
     *
     * @return array of <code>ChatSession</code> instances, null impossible but may be empty array, elements of array
     *         may be null if the corresponding session can not be found
     *
     * @throws ChatSessionDataStoreException when impossible to retrieve sessions for some reasons
     */
     ...
     */
    public void requestUserToSession(ChatSession session, long user)
     ...
     * @param user user id, any possible long value
     *
     * @throws ChatSessionIncorrectEntityIdException if user was already added to session or the session id does not
     *         exist
     * @throws ChatSessionModeIncorrectOperationException if session is 1-1 or sales and it already contains two
     *         participants
     ...
     * @throws ChatSessionIncorrectEntityIdException if user or session is not present in data base
     */
    public void removeUserFromSession(ChatSession session, long user)
        throws ChatSessionDataStoreException, ChatSessionIncorrectEntityIdException {
    }
    ...
    /**
     * <p>
     * This method is used to check if some user is added to some session. If such session was found, it should return
     ...
     *
     * @throws ChatSessionDataStoreException when impossible to check if session contains the given user for some
     *         reasons
     */
    ...
    /**
     * <p>
     * This method is used to retrieve the users that create the sessions that were requested by the given user under
     * some time conditions.
     * </p>
     *
     * <p>
     * If the recent for this manager is negative, then the users that create all the sessions requested by the given
     ...
     *
     * <p>
     * If the recent for this manager is positive, then the users that create the sessions that were requested by the
     * given user before special moment of time which is calculated like current date minus numbers of days equals
     * recent value will be retrieved.
     * </p>
     *
     * @param user user id, any possible long value
     *
     ...
     */
    public long[] getRecentlyRequestedUsers(long user)
        throws ChatSessionDataStoreException, ChatSessionIncorrectEntityIdException {
        return null;
    }
     ...
     *
     * <p>
     * If the given recent is negative, then the users that create all the sessions requested by the given user will be
     * retrieved.
     * </p>
     *
     * <p>
     ...
     *
     * <p>
     * If the given recent is positive, then the users that create the sessions that were requested by the given user
     * before special moment of time which is calculated like current date minus numbers of days equals recent value
     * will be retrieved.
     * </p>
     *
     * @param user user id, any possible long value
     ...
     * @throws ChatSessionIncorrectEntityIdException if user is not requested
     */
    public long[] getRecentlyRequestedUsers(long user, int recent)
        throws ChatSessionDataStoreException, ChatSessionIncorrectEntityIdException {
        return null;
    }
     ...
     * </p>
     *
     * @param listener <code>ChatSessionEventListener</code> instance, null impossible
     */
     ...
     * </p>
     *
     * @return array of <code>ChatSessionEventListener</code> instances in this manager, null impossible but may be
     *         empty array
     */
