...
/**
 * <p>
 * Stress test cases for AcceptChatRequestHandler class.
 * </p>
 *
 * @author 80x86
 * @version 1.0
 */
public class AcceptChatRequestHandlerStressTests extends TestCase {
    ...
    public void testHandle() throws Exception {
        String requestXml = "<request type=\"AcceptChatRequest\"> <user_id>333</user_id> <session_id>666</session_id> </request>";
        ...
        System.out.println("Handling " + StressTestHelper.MAX_COUNT
                + " requests using AcceptChatRequestHandler will cost "
