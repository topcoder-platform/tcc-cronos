...
public class MockMessagePool implements MessagePool {
     ...
     * 
     * @param isPushed
     *            a control flag used to define, what accessed time should be used for searching. true �C
     *            search by the time of the last push operation to the pool, false �C search by the time of the
     ...
     * If the isBefore flag is true, then the searched time should be before the requested time, if false �C
     ...
     *            should work. true �C search before the requested time, false �C search after the requested
     *            time.
     * @return the information about the pool found. Can contain 1 element (the pool found), or be empty (no
     *         pool found). Can not be null. No elements of the array can be null.
     */
     ...
     * time, if false �C then the searched time should be after the requested time. So, for each user the
     ...
     * is true, then the searched time should be before the requested time, if false �C then the searched time
     ...
     * requested time, if false �C then the searched time should be after the requested time. Any number search
     ...
     * before the requested time, if false �C then the searched time should be after the requested time. So,
     ...
     * time should be inside (inclusive) the requested time interval, if false �C then the searched time should
     ...
     *            algorithm should work. true �C search inside (inclusive) the requested time interval, false �C
     ...
     * then the searched time should be inside (inclusive) the requested time interval, if false �C then the
     ...
     * @param isBetween
     *            a control flag to define, from which side of the requested time interval the searching
     *            algorithm should work. true �C search inside (inclusive) the requested time, false �C search
     ...
     * (inclusive) the requested time interval, if false �C then the searched time should be outside
