...
/**
 * <p>
 * This handler is only for users with manager role. The handler will pull the pending messages from the user
 * message pool. The request message for this handler is defined in docs/ReadManagerUserMessage.xsd. The
 ...
 * @version 1.0
 */
public class ReadManagerUserMessageHandler extends AbstractRequestHandler {

    /**
     * Empty constructor.
     */
    public ReadManagerUserMessageHandler() {
    }

    /**
     * Read user message for manager role.
     * 
     * @param xmlRequest
    ...
    public void handle(Element xmlRequest, HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            if (!roles.contains(IMAjaxSupportUtility.getManagerRoleName())) {
