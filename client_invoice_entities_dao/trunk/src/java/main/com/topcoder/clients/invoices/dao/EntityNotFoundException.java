...
/**
 * <p>This exception is thrown by implementations of GenericDAO when entity with the given ID doesn't
 ...
 * @version 1.0
 */
public class EntityNotFoundException extends InvoiceDAOException {
    /**
