 ...
 * @version 1.0
 */
public class ExtendedCsvDependencyReportGenerator extends CsvDependencyReportGenerator {

    /**
     * <p>
     * Creates an instance of <code>ExtendedCsvDependencyReportGenerator</code> with the given dependencies and
     ...
     */
    public ExtendedCsvDependencyReportGenerator(List < DependenciesEntry > dependencies,
    ...
    /**
     * <p>
     * Creates an instance of <code>ExtendedCsvDependencyReportGenerator</code> with the given
     ...
     *         nor "false", case sensitive; Or the enum value does not present a valid enum, case insensitive).
     */
    public ExtendedCsvDependencyReportGenerator(DependenciesEntryPersistence persistence,
