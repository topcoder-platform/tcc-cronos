...
/**
 * Failure tests for class CsvDependencyReportGenerator.
 *
 * @author extra
 * @version 1.0
 */
public class CsvDependencyReportGeneratorFailureTest extends TestCase {

    /**
     * The csv dependency report generator.
     */
    private CsvDependencyReportGenerator generator;
    ...
    protected void setUp() throws Exception {
        ...
        generator = new CsvDependencyReportGenerator(entries, configuration);
