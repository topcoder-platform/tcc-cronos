...
/**
 * <p>
 * Failure test for <code>BaseDependencyReportGenerator</code>.
 * </p>
 *
 * @author TCSDEVELOPER
 * @version 1.0
 */
public class BaseDependencyReportGeneratorTestExp extends BaseTestCase {
    ...
    public void testCtor1_NullList() throws Exception {
        try {
            new MockDependencyReportGenerator((List) null, new DefaultConfigurationObject("test"));
    ...
    public void testCtor1_EmptyList() throws Exception {
        try {
            new MockDependencyReportGenerator(new ArrayList(), new DefaultConfigurationObject("test"));
            fail("IllegalArgumentException expected");
        } catch (IllegalArgumentException e) {
            //pass
        }
    ...
    public void testCtor1_ListContainsNull() throws Exception {
        try {
            new MockDependencyReportGenerator(Arrays.asList(new DependenciesEntry[]{null}),
    ...
    public void testCtor2_NullPersistence() throws Exception {
        try {
            new MockDependencyReportGenerator((DependenciesEntryPersistence) null,
                new DefaultConfigurationObject("test"));
            fail("IllegalArgumentException expected");
        } catch (IllegalArgumentException e) {
            //pass
    ...
    public void testCtor2_NullConfigurationObject() throws Exception {
        ...
        try {
            new MockDependencyReportGenerator(PERSISTENCE, null);
            fail("IllegalArgumentException expected");
        } catch (IllegalArgumentException e) {
            //pass
        }
    ...
    public void testCtor2_DependencyTypes_ValueNotTypeOfString() throws Exception {
        ...
        co.setPropertyValue("dependency_types", new Date());
        try {
            new MockDependencyReportGenerator(PERSISTENCE, co);
            fail("DependencyReportConfigurationException expected");
        } catch (DependencyReportConfigurationException e) {
            //pass
        }
