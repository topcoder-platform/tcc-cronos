...
/**
 * <p>
 * Failure test for <code>CsvDependencyReportGenerator</code>.
 * </p>
 *
 * @author TCSDEVELOPER
 * @version 1.0
 */
public class CsvDependencyReportGeneratorTestExp extends BaseTestCase {

    /**
     * <p>
     * Test constructor
     * {@link CsvDependencyReportGenerator#CsvDependencyReportGenerator(java.util.List, ConfigurationObject)}.
     * </p>
     *
     * <p>
    ...
    public void testCtor1_NullList() throws Exception {
        try {
            new CsvDependencyReportGenerator((List) null, new DefaultConfigurationObject("test"));
    ...
    public void testCtor1_EmptyList() throws Exception {
        try {
            new CsvDependencyReportGenerator(new ArrayList(), new DefaultConfigurationObject("test"));
            fail("IllegalArgumentException expected");
        } catch (IllegalArgumentException e) {
            //pass
        }
    ...
    public void testCtor1_ListContainsNull() throws Exception {
        try {
            new CsvDependencyReportGenerator(Arrays.asList(new DependenciesEntry[]{null}),
     ...
     * <p>
     * Test constructor
     * {@link CsvDependencyReportGenerator#CsvDependencyReportGenerator(
    ...
    public void testCtor2_NullPersistence() throws Exception {
        try {
            new CsvDependencyReportGenerator((DependenciesEntryPersistence) null,
                new DefaultConfigurationObject("test"));
            fail("IllegalArgumentException expected");
        } catch (IllegalArgumentException e) {
            //pass
    ...
    public void testCtor2_NullConfigurationObject() throws Exception {
        ...
        try {
            new CsvDependencyReportGenerator(PERSISTENCE, null);
            fail("IllegalArgumentException expected");
        } catch (IllegalArgumentException e) {
            //pass
        }
    ...
    public void testCtor2_ErrorWhileLoadingDependenciesFromPersistence() throws Exception {
        ...
        EasyMock.replay(PERSISTENCE);
        try {
            new CsvDependencyReportGenerator(PERSISTENCE, new DefaultConfigurationObject("test"));
    ...
    public void testCtor2_DependencyTypes_ValueNotTypeOfString() throws Exception {
        ...
        co.setPropertyValue("dependency_types", new Date());
        try {
            new CsvDependencyReportGenerator(PERSISTENCE, co);
            fail("DependencyReportConfigurationException expected");
        } catch (DependencyReportConfigurationException e) {
            //pass
        }
    ...
    /**
     * <p>
     * Test method {@link CsvDependencyReportGenerator#generate(java.util.List, java.io.OutputStream, boolean)}.
     * </p>
     *
     * <p>
     * Given list is null, <code>IllegalArgumentException</code> expected.
    ...
    /**
     * <p>
     * Test method {@link CsvDependencyReportGenerator#generateAll(java.io.OutputStream, boolean)}.
     * </p>
     *
     * <p>
     * Given out put stream is null, <code>IllegalArgumentException</code> expected.
    ...
    /**
     * <p>
     * Test method {@link CsvDependencyReportGenerator#writeReport(List, OutputStream)}.
     * </p>
     *
     * <p>
     * Given list is null, <code>IllegalArgumentException</code> expected.
    ...
    public void testWriteReport_NullList() throws Exception {
        ...
        ExtendedCsvDependencyReportGenerator generator =
            new ExtendedCsvDependencyReportGenerator(
                Arrays.asList(new DependenciesEntry[]{entry1}),
                new DefaultConfigurationObject("test"));
