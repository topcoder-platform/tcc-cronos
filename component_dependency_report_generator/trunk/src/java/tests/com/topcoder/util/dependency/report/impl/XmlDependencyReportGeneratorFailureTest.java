...
/**
 * Failure tests for class XmlDependencyReportGenerator.
 *
 * @author extra
 * @version 1.0
 */
public class XmlDependencyReportGeneratorFailureTest extends TestCase {

    /**
     * The Xml dependency report generator.
     */
    private XmlDependencyReportGenerator generator;
    ...
    protected void setUp() throws Exception {
        ...
        generator = new XmlDependencyReportGenerator(entries, configuration);
