 ...
 * @version 1.0
 */
public class ExtendedHtmlDependencyReportGenerator extends HtmlDependencyReportGenerator {

    /**
     * <p>
     * Creates an instance of <code>ExtendedHtmlDependencyReportGenerator</code> with the given dependencies and
     ...
     */
    public ExtendedHtmlDependencyReportGenerator(List < DependenciesEntry > dependencies,
    ...
    /**
     * <p>
     * Creates an instance of <code>ExtendedHtmlDependencyReportGenerator</code> with the given
     ...
     *         nor "false", case sensitive; Or the enum value does not present a valid enum, case insensitive).
     */
    public ExtendedHtmlDependencyReportGenerator(DependenciesEntryPersistence persistence,
