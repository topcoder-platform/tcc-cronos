...
/**
 * <p>
 * Failure test for <code>HtmlDependencyReportGenerator</code>.
 * </p>
 *
 * @author TCSDEVELOPER
 * @version 1.0
 */
public class HtmlDependencyReportGeneratorTestExp extends BaseTestCase {

    /**
     * <p>
     * Test constructor
     * {@link HtmlDependencyReportGenerator#HtmlDependencyReportGenerator(java.util.List, ConfigurationObject)}.
     * </p>
     *
     * <p>
    ...
    public void testCtor1_NullList() throws Exception {
        try {
            new HtmlDependencyReportGenerator((List) null, new DefaultConfigurationObject("test"));
    ...
    public void testCtor1_EmptyList() throws Exception {
        try {
            new HtmlDependencyReportGenerator(new ArrayList(), new DefaultConfigurationObject("test"));
            fail("IllegalArgumentException expected");
        } catch (IllegalArgumentException e) {
            //pass
        }
    ...
    public void testCtor1_ListContainsNull() throws Exception {
        try {
            new HtmlDependencyReportGenerator(Arrays.asList(new DependenciesEntry[]{null}),
     ...
     * <p>
     * Test constructor
     * {@link HtmlDependencyReportGenerator#HtmlDependencyReportGenerator(
    ...
    public void testCtor2_NullPersistence() throws Exception {
        try {
            new HtmlDependencyReportGenerator((DependenciesEntryPersistence) null,
                new DefaultConfigurationObject("test"));
            fail("IllegalArgumentException expected");
        } catch (IllegalArgumentException e) {
            //pass
    ...
    public void testCtor2_NullConfigurationObject() throws Exception {
        ...
        try {
            new HtmlDependencyReportGenerator(PERSISTENCE, null);
            fail("IllegalArgumentException expected");
        } catch (IllegalArgumentException e) {
            //pass
        }
    ...
    public void testCtor2_ErrorWhileLoadingDependenciesFromPersistence() throws Exception {
        ...
        EasyMock.replay(PERSISTENCE);
        try {
            new HtmlDependencyReportGenerator(PERSISTENCE, new DefaultConfigurationObject("test"));
    ...
    public void testCtor2_DependencyTypes_ValueNotTypeOfString() throws Exception {
        ...
        co.setPropertyValue("dependency_types", new Date());
        try {
            new HtmlDependencyReportGenerator(PERSISTENCE, co);
            fail("DependencyReportConfigurationException expected");
        } catch (DependencyReportConfigurationException e) {
            //pass
        }
    ...
    /**
     * <p>
     * Test method {@link HtmlDependencyReportGenerator#generate(java.util.List, java.io.OutputStream, boolean)}.
     * </p>
     *
     * <p>
     * Given list is null, <code>IllegalArgumentException</code> expected.
    ...
    /**
     * <p>
     * Test method {@link HtmlDependencyReportGenerator#generateAll(java.io.OutputStream, boolean)}.
     * </p>
     *
     * <p>
     * Given out put stream is null, <code>IllegalArgumentException</code> expected.
    ...
    /**
     * <p>
     * Test method {@link HtmlDependencyReportGenerator#writeReport(List, OutputStream)}.
     * </p>
     *
     * <p>
     * Given list is null, <code>IllegalArgumentException</code> expected.
    ...
    public void testWriteReport_NullList() throws Exception {
        ...
        ExtendedHtmlDependencyReportGenerator generator =
            new ExtendedHtmlDependencyReportGenerator(
                Arrays.asList(new DependenciesEntry[]{entry1}),
                new DefaultConfigurationObject("test"));
