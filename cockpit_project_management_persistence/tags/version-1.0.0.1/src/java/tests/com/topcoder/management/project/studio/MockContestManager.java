...
public class MockContestManager implements ContestManager {
    ...
    /**
     * <p>
     * Updates contest data. Note that all data can be updated only if contest is not active. If contest is active
     * it is possible to increase prize amount and duration.
     * </p>
     * @param contest
    ...
    /**
     * <p>
     * Removes contest status, return true if the contest status exists and removed successfully, return false if
     * it doesn't exist.
     * </p>
    ...
    /**
     * <p>
     * Removes document, return true if the document exists and removed successfully, return false if it doesn't
     * exist.
     * </p>
     * @param documentId
     *        the document id
     ...
     * @param contestId
     *        the contest id
     * @return true if the document exists in the contest and removed successfully, returns false if it doesn't
     *         exist in contest
     * @throws EntityNotFoundException
     *         if there is no corresponding document or contest in persistence.
     * @throws ContestManagementException
    ...
    /**
     * <p>
     * Removes contest channel, return true if the contest category exists and removed successfully, return false
     * if it doesn't exist.
     * </p>
    ...
    /**
     * <p>
     * Gets contest type configuration parameter by id, and return the retrieved contest type configuration
     * parameter. Return null if it doesn't exist.
     * </p>
     ...
     * @param prizeId
     *        the prize id
     * @return true if the prize exists in the contest and removed successfully, return false if it doesn't exist
     *         in contest.
     * @throws EntityNotFoundException
     *         if there is no corresponding prize or contest in persistence.
     * @throws ContestManagementException
