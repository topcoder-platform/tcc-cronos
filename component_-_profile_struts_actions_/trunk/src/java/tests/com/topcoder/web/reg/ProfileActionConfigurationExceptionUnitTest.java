...
/**
 * <p>
 * This class contains Unit tests for ProfileActionConfigurationException.
 * </p>
 * @author TCSDEVELOPER
 * @version 1.0
 */
public class ProfileActionConfigurationExceptionUnitTest extends TestCase {

    /**
     * <p>
     * Represents ProfileActionConfigurationException instance for testing.
     * </p>
     */
    private ProfileActionConfigurationException exception;
    ...
    public void setUp() {
        ...
        exception = new ProfileActionConfigurationException(message);
    }
    ...
    public void testCtor_MessageData() {
        ...
        exception = new ProfileActionConfigurationException(message, data);
        assertNotNull("Exception should be created successfully.", exception);
        assertEquals("Message should be set successfully.", message, exception.getMessage());
    }
    ...
    public void testCtor_MessageDataCause() {
        ...
        exception = new ProfileActionConfigurationException(message, cause, data);
        assertNotNull("Exception should be created successfully.", exception);
        assertEquals("Message should be set successfully.", message, exception.getMessage());
    ...
    public void testCtor_MessageCause() {
        Throwable cause = new NullPointerException(message);
        exception = new ProfileActionConfigurationException(message, cause);
        assertNotNull("Exception should be created successfully.", exception);
        assertEquals("Message should be set successfully.", message, exception.getMessage());
        assertEquals("Cause should be set successfully.", cause, exception.getCause());
    }
