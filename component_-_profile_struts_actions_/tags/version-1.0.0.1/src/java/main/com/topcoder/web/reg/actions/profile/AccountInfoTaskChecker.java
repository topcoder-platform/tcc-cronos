...
/**
 * <p>
 * This class implements ProfileTaskChecker to provide a check of the account information task and determine how many
 ...
 * @version 1.0
 */
public class AccountInfoTaskChecker extends BaseProfileTaskChecker {

    /**
     * <p>
     * Creates an instance of AccountInfoTaskChecker.
     * </p>
     */
    public AccountInfoTaskChecker() {
    }
    ...
    public ProfileTaskReport getTaskReport(User user) {
        ...
        if (Helper.checkNotNullNorEmpty(user.getHandle())) {
            completedFieldCount++;
        }
