...
/**
 * <p>
 * Accuracy test for <code>{@link DocumentPersistenceException}</code> class.
 * </p>
 *
 * @author liuliquan
 * @version 1.0
 */
public class DocumentPersistenceExceptionAccTests extends TestCase {
    ...
    public static Test suite() {
        return new TestSuite(DocumentPersistenceExceptionAccTests.class);
    }
