...
/**
 * <p>
 * Accuracy test for <code>{@link AuthorizationException}</code> class.
 * </p>
 *
 * @author liuliquan
 * @version 1.0
 */
public class AuthorizationExceptionAccTests extends TestCase {
    ...
    public static Test suite() {
        return new TestSuite(AuthorizationExceptionAccTests.class);
    }
