...
public abstract class BaseTestCase extends TestCase {
     ...
     * </p>
     */
    private static final String STRESS_PROPERTIES_FILE = "test_files/stresstests/stresstests.properties";
    ...
    protected void setUp() throws Exception {
        ...
        ConfigurationFileManager configurationFileManager = new ConfigurationFileManager(STRESS_PROPERTIES_FILE);
