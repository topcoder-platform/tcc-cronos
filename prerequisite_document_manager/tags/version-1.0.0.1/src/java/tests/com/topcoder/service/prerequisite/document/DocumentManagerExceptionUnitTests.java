...
/**
 * <p>
 * Unit test for <code>{@link DocumentManagerException}</code> class.
 * </p>
 *
 * @author TCSDEVELOPER
 * @version 1.0
 */
public class DocumentManagerExceptionUnitTests extends TestCase {
    ...
    public static Test suite() {
        return new TestSuite(DocumentManagerExceptionUnitTests.class);
    }
