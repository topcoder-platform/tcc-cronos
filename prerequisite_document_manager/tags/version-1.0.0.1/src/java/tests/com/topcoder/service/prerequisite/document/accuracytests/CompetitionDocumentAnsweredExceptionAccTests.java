...
/**
 * <p>
 * Accuracy test for <code>{@link CompetitionDocumentAnsweredException}</code> class.
 * </p>
 *
 * @author liuliquan
 * @version 1.0
 */
public class CompetitionDocumentAnsweredExceptionAccTests extends TestCase {
    ...
    public static Test suite() {
        return new TestSuite(CompetitionDocumentAnsweredExceptionAccTests.class);
    }
