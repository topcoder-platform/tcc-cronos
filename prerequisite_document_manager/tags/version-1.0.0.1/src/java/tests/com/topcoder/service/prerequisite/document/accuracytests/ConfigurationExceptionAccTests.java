...
/**
 * <p>
 * Accuracy test for <code>{@link ConfigurationException}</code> class.
 * </p>
 *
 * @author liuliquan
 * @version 1.0
...
public class ConfigurationExceptionAccTests extends TestCase {
    ...
    public static Test suite() {
        return new TestSuite(ConfigurationExceptionAccTests.class);
    }
    ...
    /**
     * Tests accuracy of <code>ConfigurationException(String, ExceptionData)</code> constructor. The detail error
     * message and the exception data should be correct.
     */
    public void testConfigurationExceptionStringExceptionDataAccuracy() {
