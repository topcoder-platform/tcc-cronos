 ...
 * @throws PersistenceException if error occurred while accessing the database.
 */
    public Scorecard getScorecard(long id) throws PersistenceException, ValidationException;
/**
 ...
 * @throws PersistenceException if error occurred while accessing the database.
 */
    public Scorecard[] searchScorecards(Filter filter, boolean complete) throws PersistenceException, ValidationException;
/**
 ...
 * @throws PersistenceException if error occurred while accessing the database.
 */
    public ScorecardType[] getAllScorecardTypes() throws PersistenceException, ValidationException;
/**
 ...
 * @throws PersistenceException if error occurred while accessing the database.
 */
    public QuestionType[] getAllQuestionTypes() throws PersistenceException, ValidationException;
/**
 ...
 * @throws PersistenceException if error occurred while accessing the database.
 */
    public ScorecardStatus[] getAllScorecardStatuses() throws PersistenceException, ValidationException;
/**
