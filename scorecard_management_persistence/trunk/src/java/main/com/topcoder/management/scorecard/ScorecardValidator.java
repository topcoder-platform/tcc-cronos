 ...
 * throw ValidationException on the first item that is not follow the a rule. The exception should contains
 * meaningful error message about the validation problem.
 * The set of rules is the logic of implementation classes.
 *
 *
