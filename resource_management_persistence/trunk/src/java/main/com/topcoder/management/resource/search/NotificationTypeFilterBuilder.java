...
/**
 * <p>
 * The NotificationTypeFilterBuilder class supports building filters for searching for NotificationTypes.
 * </p>
 *
 * <p>
...
public class NotificationTypeFilterBuilder {
    ...
    public static Filter createNotificationTypeIdFilter(long notificationTypeId) {
        Helper.checkPositiveValue(notificationTypeId, "notificationTypeId");

        return SearchBundle.buildEqualToFilter(NOTIFICATION_TYPE_ID_FIELD_NAME, new Long(notificationTypeId));
    }
     ...
     * @param name
     *            The notification type name to filter on
     * @throws IllegalArgumentException
     *             If name is null
     */
