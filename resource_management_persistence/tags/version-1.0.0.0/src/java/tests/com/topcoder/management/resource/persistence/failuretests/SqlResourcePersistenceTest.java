 ...
 */
package com.topcoder.management.resource.persistence.failuretests;
...
/**
 * Unit test for SqlResourcePersistence class.
 *
 * @author King_Bette
 * @version 1.0
 */
public class SqlResourcePersistenceTest extends TestCase {
    ...
    public static Test suite() {
        return new TestSuite(SqlResourcePersistenceTest.class);
    }
