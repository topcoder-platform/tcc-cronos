...
class Helper {
     ...
     * <p>
     * This constant provides the <code>DataType</code> instance that can be used in the query methods to specify that
     * a <code>ResultSet</code> column of a query result should be returned as value of type <code>Double</code> or
     * as <code>null</code> in case the <code>ResultSet</code> value was <tt>null</tt>.
     */
     ...
     * <p>
     * This constant provides the <code>DataType</code> instance that can be used in the query methods to specify that
     * a <code>ResultSet</code> column of a query result should be returned as value of type <code>Integer</code> or
     * as <code>null</code> in case the <code>ResultSet</code> value was <tt>null</tt>.
     */
     ...
     * This class is a wrapper for type safe retrieval of values from a <code>ResultSet</code>. The values retrieved
     * by the <code>getValue(java.sql.ResultSet, int)</code> implementation of this <code>DataType</code> are assured
     * to be of type <code>Double</code> or to be <tt>null</tt> in case the <code>ResultSet</code> value was
     * <tt>null</tt>.
     *
     * @author TCSDEVELOPER
     * @version 1.0
     ...
     * This class is a wrapper for type safe retrieval of values from a <code>ResultSet</code>. The values retrieved
     * by the <code>getValue(java.sql.ResultSet, int)</code> implementation of this <code>DataType</code> are assured
     * to be of type <code>Integer</code> or to be <tt>null</tt> in case the <code>ResultSet</code> value was
     * <tt>null</tt>.
     *
     * @author TCSDEVELOPER
     * @version 1.0
     ...
     * @throws ReviewerStatisticsPersistenceException if the query fails
     */
    static Object doSingleValueQuery(Connection connection, String queryString, Object[] queryArgs,
        DataType columnType) throws ReviewerStatisticsPersistenceException {
        ...
        try {
            ...
            throw new ReviewerStatisticsPersistenceException("Error occurs while executing query [" + queryString
     ...
     * @throws ReviewerStatisticsPersistenceException if any error happens
     */
     ...
     * @throws ReviewerStatisticsPersistenceException error occurs when closing the prepared statement
     */
    static void closeStatement(PreparedStatement ps) throws ReviewerStatisticsPersistenceException {
        if (ps != null) {
            try {
                ps.close();
            } catch (SQLException e) {
                throw new ReviewerStatisticsPersistenceException("Error occurs when closing the prepared statement.",
                    e);
            }
        }
    }
     ...
     * @throws ReviewerStatisticsPersistenceException error occurs when closing the result set.
     */
    static void closeResultSet(ResultSet rs) throws ReviewerStatisticsPersistenceException {
        if (rs != null) {
            try {
                rs.close();
            } catch (SQLException e) {
                throw new ReviewerStatisticsPersistenceException("Error occurs when closing the result set.", e);
            }
        }
    }
     ...
     * @throws ReviewerStatisticsPersistenceException error occurs when doing commit
     */
    static void commitTransaction(Connection conn) throws ReviewerStatisticsPersistenceException {
        if (conn != null) {
            try {
                conn.commit();
            } catch (SQLException e) {
                throw new ReviewerStatisticsPersistenceException("Error occurs when doing commit.", e);
            }
        }
    }
     ...
     *
     * @param conn the connection
     * @throws ReviewerStatisticsPersistenceException error occurs when doing rollback
     */
    static void rollBackTransaction(Connection conn) throws ReviewerStatisticsPersistenceException {
        if (conn != null) {
            try {
                conn.rollback();
            } catch (SQLException e) {
                throw new ReviewerStatisticsPersistenceException("Error occurs when doing rollback.", e);
            }
        }
    }
     ...
     *             null
     * @throws ReviewerStatisticsPersistenceException if error happens during querying
     */
     ...
     */
    private static void assertArrayNotNullNorHasNull(Object[] array, String name) {
