...
/**
 * Stress test for class <code>BinaryFileDependenciesEntryPersistence</code>.
 *
 * @author PE
 * @version 1.0
 */
public class BinaryFileDependenciesEntryPersistenceStressTest extends TestCase {
    /**
     * <p>
     * Represents the test file to be used in tests.
     * </p>
     */
    private static final String OUTPUT_FILE = "test_files/stress_test_files/persistence.bin";
    ...
    protected void setUp() throws Exception {
        persistence = new BinaryFileDependenciesEntryPersistence(OUTPUT_FILE);
    }
    ...
    /**
     * Stress Test for the functionality of class <code>BinaryFileDependenciesEntryPersistence</code>.
     *
     * @throws Exception to JUnit
     */
    public void testBinaryFileDependenciesEntryPersistence_SaveLoad()
        throws Exception {
        ...
        StressTestHelper.printResult("testBinaryFileDependenciesEntryPersistence_SaveLoad");
