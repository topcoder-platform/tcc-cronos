...
/**
 * <p>
 * Unit tests for <code>BinaryFileDependenciesEntryPersistence</code> class.
 * </p>
 *
 * @author TCSDEVELOPER
 * @version 1.0
 */
public class BinaryFileDependenciesEntryPersistenceTest extends TestCase {
    /**
     * <p>
     * Test file to be used in tests.
     * </p>
     */
    private static final String BINARY_OUTPUT_FILE = "test_files" + File.separator + "testBinaryPersistence.binary";

    /**
     * <p>
     * <code>BinaryFileDependenciesEntryPersistenceTest</code> instance to be tested.
     * </p>
     */
    ...
    protected void setUp() throws Exception {
        super.setUp();
        persistence = new BinaryFileDependenciesEntryPersistence(BINARY_OUTPUT_FILE);
    }
    ...
    /**
     * <p>
     * Gets the test suite for <code>BinaryFileDependenciesEntryPersistence</code> class.
     * </p>
     *
     * @return a <code>TestSuite</code> providing the tests for <code>BinaryFileDependenciesEntryPersistence</code>
     *         class.
     */
    public static Test suite() {
        return new TestSuite(BinaryFileDependenciesEntryPersistenceTest.class);
    }

    /**
     * <p>
     * Accuracy test for constructor <code>BinaryFileDependenciesEntryPersistence(String)</code>.
     * </p>
     * <p>
    ...
    /**
     * <p>
     * Failure test for constructor <code>BinaryFileDependenciesEntryPersistence(String)</code>.
     * </p>
     * <p>
    ...
    /**
     * <p>
     * Accuracy test for constructor <code>BinaryFileDependenciesEntryPersistence(ConfigurationObject)</code>.
     * </p>
     * <p>
     * Uses the constructor to create a non-null instance. No exception should be thrown.
     * </p>
    ...
    public void testCtor2_Accuracy() throws Exception {
        ...
        config.setPropertyValue("file_name", BINARY_OUTPUT_FILE);
        assertNotNull("It should return non-null instance.", new BinaryFileDependenciesEntryPersistence(config));
    }

    /**
     * <p>
     * Failure test for constructor <code>BinaryFileDependenciesEntryPersistence(ConfigurationObject)</code>.
     * </p>
     * <p>
    ...
    public void testLoad_Failure1() {
        try {
            persistence = new BinaryFileDependenciesEntryPersistence("test_files" + File.separator + "wrong_file.xml");
            persistence.load();
    ...
    public void testSave_Failure2() {
        try {
            persistence = new BinaryFileDependenciesEntryPersistence("test_files" + File.separator + "wrong_folder"
