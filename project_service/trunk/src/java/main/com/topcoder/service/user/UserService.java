...
public interface UserService {
     ...
     * @since Cockpit Release Assembly for Receipts
     */
    String getEmailAddress(long userid) throws UserServiceException;
     ...
     */
    String getEmailAddress(String userHandle) throws UserServiceException;
     ...
     *             if any error occurs when getting user details
     */
    long getUserId(String userHandle) throws UserServiceException;

    /**
     * <p>
     * This method returns true if given user handle belongs to an administrator otherwise it returns false.
     * </p>
     *
     * @param userHandle
     *            user handle to look for
     *
     * @return returns true if given user handle belongs to an administrator otherwise it returns false.
     *
     * @throws UserServiceException
     *             if any error occurs when getting user details.
     * @since Jira & Confluence User Sync Service
     */
    boolean isAdmin(String userHandle) throws UserServiceException;
