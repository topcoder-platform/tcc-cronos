...
import com.topcoder.service.project.Demo;
 ...
 *   <ul>
 *     <li>Lookup Project Service Remote EJB with user/admin role;</li>
 *     <li>Lookup User Service Remote EJB with user/admin role;</li>
 *     <li>Lookup Project Service Local EJB bridge with user/admin role;</li>
 *     <li>Lookup Project Service WS client with user/admin role;</li>
...
public abstract class BaseUnitTestCase extends TestCase {
    ...
    /**
     * <p>
     * Creates a test suite aggregating all unit tests in the given class with
     * a custom set up and tear down methods that clean the database.
     * </p>
     * @param testCaseClass the class containing all the unit tests
     * @return Test suite aggregating all Unit tests in this class
     */
    protected static Test suite(Class<? extends TestCase> testCaseClass) {

        final TestSuite suite = new TestSuite();
        // add this class' tests
        suite.addTestSuite(testCaseClass);

        /**
         * <p>
         * Used to set up and tear down the test suite.
         * </p>
         *
         * @version 1.1
         */
    ...
    /**
     * <p>
     * Lookup the <code>UserServiceRemote</code> with administrator role.
     * </p>
     *
     * @return The <code>UserServiceRemote</code> with administrator role.
     *
     * @throws Exception
     *             pass any unexpected exception to JUnit.
     */
    protected UserServiceRemote lookupUserServiceRemoteWithAdminRole() throws Exception {

        //See /test_files/lib/mock.jar/MockUserGroupManager
        return (UserServiceRemote) getInitialContext("admin").lookup("remote/UserServiceBean");
    }
     ...
     *             pass any unexpected exception to JUnit.
     */
    protected UserServiceRemote lookupUserServiceRemoteWithUserRole() throws Exception {

        //See /test_files/lib/mock.jar/MockUserGroupManager
        return (UserServiceRemote) getInitialContext("username").lookup("remote/UserServiceBean");
    }
     ...
     * @param params the names parameters in the SQL statement
     *
     * @throws Exception to JUnit
     */
    public static void executeStatement(String stmt, Map<String, Object> params) throws Exception {
