 ...
 * <code>{@link SpecReviewService}</code> contract. It allows the <code>{@link SpecReviewService}</code> to also be
 * accessed as a local bean.
 * </p>
 * <p>
 * Implementations will simply need to implement the base contract - <code>{@link SpecReviewService}</code>. The marker
 ...
 */
@Remote
public interface SpecReviewServiceRemote extends SpecReviewService {
}
