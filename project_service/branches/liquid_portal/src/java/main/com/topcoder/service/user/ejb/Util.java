...
*/
    ...
    private static Key loadKey(String alias)
            throws ConfigManagerException, UserServiceException {
        ...
        try {
            ...
            e.printStackTrace();
            throw new UserServiceException("Password encryption error in com.topcoder.security.Util.loadKey: " + e.getMessage());
        }
    }
    ...
    private static Key storeKeyStore(KeyStore ks, String alias)
        ...
        try {
            ...
            e.printStackTrace();
            throw new UserServiceException("Password encryption error in com.topcoder.security.Util.storeKeyStore: " + e.getMessage());
        }
    }
    ...
    private static byte[] encdec(byte[] passwd, String alias, int cipherMode)
        ...
        try {
            ...
            e.printStackTrace();
            throw new UserServiceException("Password encrption error in com.topcoder.security.Util.encdec: " + e.getMessage());
        }
    }
    ...
    public static String encodePassword(String password, String alias)
        ...
        try {
            ...
            throw new UserServiceException("ConfigManagerException in com.topcoder.security.Util.encodePassword: " + e.getMessage());
        }
    }
