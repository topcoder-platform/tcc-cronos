...
public class UserServiceBean implements UserServiceRemote, UserServiceLocal {
    ...
    public String getEmailAddress(long userid) throws UserServiceException {
        try {
            ...
            logParameters(userid);

            EntityManager em = getEntityManager();
            Query query = em.createNativeQuery(
                    "select max(address) from email where primary_ind = 1 and user_id = " + userid);
   ...
   /**
    ...
    /**
     * <p>
     * This method retrieves the user handle for given user id.
     * </p>
     *
     * @param userId
     *            user id to look for
    ...
    /**
     * <p>
     * This method returns true if given user handle is administrator otherwise it returns false.
     *
     ...
     *            user handle to look for
     *
     * @return returns true if given user handle is administrator otherwise it returns false.
     *
     * @throws UserServiceException
     *             if any error occurs when getting user details.
     * @since Jira & Confluence User Sync Service
