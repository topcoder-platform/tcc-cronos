...
public class ProjectServiceBeanUnitTests extends BaseTestCase {
    ...
    /**
     * <p>
     * Unit test for <code>{@link ProjectServiceBean#createProject(ProjectData)}</code> method.
     * </p>
     * <p>
    ...
    /**
     * <p>
     * Unit test for <code>{@link ProjectServiceBean#updateProject(ProjectData)}</code> method.
     * </p>
     * <p>
     * If the passed project data is null, should throw IllegalArgumentFault.
     * </p>
    ...
    /**
     * <p>
     * Unit test for <code>{@link ProjectServiceBean#deleteProject(long)}</code> method.
     * </p>
     * <p>
    ...
    public void testDeleteProject_NotFound() throws Exception {
        assertFalse("Should return false.", projectService.deleteProject(1L));
    }
    ...
    public void testDeleteProject_accuracy() throws Exception {
        ...
        assertTrue("project should be deleted.", projectService.deleteProject(1L));
    }
}
