...
/**
 * <p>This interface represents the remote interface for <code>GamePlanService</code> session bean.</p>
 *
 ...
 */
@Remote
public interface GamePlanServiceRemote extends GamePlanService {
}
