...
public final class StressHelper1_1 extends TestCase {
    ...
    static final void loadAllConfiguration() {
        ...
        loadConfiguration("com.topcoder.timetracker.project.persistence.DatabaseSearchUtility.clients",
        		DIR + "timetrackerproject.xml", ConfigManager.CONFIG_MULTIPLE_XML_FORMAT);
        loadConfiguration("com.topcoder.timetracker.project.persistence.DatabaseSearchUtility.projects",
        		DIR + "timetrackerproject.xml", ConfigManager.CONFIG_MULTIPLE_XML_FORMAT);
    }
    ...
    static final void releaseNamespaces() {
        ...
        releaseNamespace("com.topcoder.timetracker.project.persistence.DatabaseSearchUtility.clients");
        releaseNamespace("com.topcoder.timetracker.project.persistence.DatabaseSearchUtility.projects");
    }
