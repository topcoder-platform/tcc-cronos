...
public class FailureTestHelper {
     ...
     */
    public static final String CONFIG_FILE = "failure/TimeTrackerProject.xml";

    /**
     * The configuration file of the DatabaseSearchUtility class.
     */
    public static final String SEARCH_UTILITY_CONFIG_FILE = "failure/DBSearchUtility.xml";
     ...
     */
    public static final String DB_CONFIG_FILE = "failure/DBConnectionFactory.xml";
    ...
    /**
     * Creates a project manager with insufficient data for testing. The project of this project manager is not
     * set.
     *
