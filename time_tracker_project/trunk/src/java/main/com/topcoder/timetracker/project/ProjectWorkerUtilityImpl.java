...
/**
 * <p>
 * This is a default implementation of the <code>ProjectWorkerUtility</code> interface.
 * </p>
 *
 * <p>
 * It delegates to a <code>ProjectWorkerDAO</code> to perform most of the work.
 * </p>
 *
 * <p>
 ...
 * @version 3.2
 */
public class ProjectWorkerUtilityImpl implements ProjectWorkerUtility {
    /**
     * <p>
     * This is an implementation of the <code>ProjectWorkerDAO</code> that is used to retrieve and modify the
     * persistent store with regards to the ProjectWorker objects.
     * </p>
     *
     * <p>
     ...
     * </p>
     */
    private final ProjectWorkerDAO workerDao;
     ...
     */
    public ProjectWorkerUtilityImpl(ProjectWorkerDAO workerDao) {
        Util.checkNull(workerDao, "workerDao");
     ...
     *
     * <p>
     * This implementation will set the ProjectWorker's creation and modification date and user to the current
     ...
     *
     * @throws IllegalArgumentException if worker is null, or the worker contains null property which is
    ...
    public void addProjectWorker(ProjectWorker worker, boolean audit) throws DataAccessException {
        addProjectWorkers(new ProjectWorker[] {worker}, audit);
    }
     ...
     *
     * <p>
     * This implementation will set the ProjectWorker's modification date and user to the current
     ...
     * @param audit Indicates whether an audit should be performed.
     *
     * @throws IllegalArgumentException if worker is null, or the worker contains null property
    ...
    public void updateProjectWorker(ProjectWorker worker, boolean audit) throws UnrecognizedEntityException,
        DataAccessException {
        updateProjectWorkers(new ProjectWorker[] {worker}, audit);
    }
    ...
    public void removeProjectWorker(long projectId, long userId, boolean audit) throws UnrecognizedEntityException,
        DataAccessException {
        removeProjectWorkers(new long[] {projectId}, new long[] {userId}, audit);
    }
     ...
     * {@link ProjectWorkerUtilityImpl#getProjectWorkerFilterFactory()}, or a composite Search Filters
     * (such as <code>AndFilter</code>,
     * <code>OrFilter</code> and <code>NotFilter</code> from Search Builder component) that combines the
     * filters created using <code>ProjectWorkerFilterFactory</code>.
     * </p>
     *
     * <p>
    ...
    public ProjectWorker[] searchProjectWorkers(Filter filter) throws DataAccessException {
        return workerDao.searchProjectWorkers(filter);
    }
    ...
    public ProjectWorker[] enumerateProjectWorkers() throws DataAccessException {
        return workerDao.enumerateProjectWorkers();
    }

    /**
     * <p>
     * This is a batch version of the {@link ProjectWorkerUtilityImpl#addProjectWorker(ProjectWorker, boolean)} method.
     * </p>
     *
    ...
    public void addProjectWorkers(ProjectWorker[] workers, boolean audit) throws DataAccessException {
        Util.updateTimeTrackerBeanDates(workers, "workers", true);

        workerDao.addProjectWorkers(workers, audit);
    }

    /**
     * <p>
     * This is a batch version of the
     * {@link ProjectWorkerUtilityImpl#updateProjectWorker(ProjectWorker, boolean)} method.
     * </p>
     *
     * @param workers An array of workers for which this operation should be performed.
     * @param audit Indicates whether an audit should be performed.
    ...
    public void updateProjectWorkers(ProjectWorker[] workers, boolean audit) throws UnrecognizedEntityException,
        ...
        workerDao.updateProjectWorkers(workers, audit);
    }

    /**
     * <p>
     * This is a batch version of the {@link ProjectWorkerUtilityImpl#removeProjectWorker(long, long, boolean)}
     * method.
     * </p>
     *
    ...
    public void removeProjectWorkers(long[] projectIds, long[] userIds, boolean audit)
        ...
        workerDao.removeProjectWorkers(projectIds, userIds, audit);
    }
     ...
     * the given factory should be used with {@link ProjectWorkerUtilityImpl#searchProjectWorkers(Filter)} method.
     * </p>
     *
    ...
    public ProjectWorkerFilterFactory getProjectWorkerFilterFactory() {
        return workerDao.getProjectWorkerFilterFactory();
    }
}