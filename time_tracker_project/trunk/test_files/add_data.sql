...
insert into user_account(user_account_id, company_id, user_name, password, account_status_id, creation_date,
       creation_user,
       modification_date,
       modification_user) values(2, 1, 'john', 'tc_super', 1, CURRENT, '', CURRENT, '');
...
insert into client(
     ...
     modification_date ,
     modification_user
) values (1, 'microsoft', 1, CURRENT, USER, CURRENT, USER);
...
insert into client(
     ...
     modification_date ,
     modification_user
) values (2, 'google', 2, CURRENT, USER, CURRENT, USER);
...
insert into client_project(
     ...
     modification_date ,
     modification_user
) values (1, 1, CURRENT, USER, CURRENT, USER);
