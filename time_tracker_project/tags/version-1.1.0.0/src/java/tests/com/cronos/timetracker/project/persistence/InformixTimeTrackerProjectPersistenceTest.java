...
public class InformixTimeTrackerProjectPersistenceTest extends TestCase {
    ...
    /**
     * Test of constructor with null db namespace. Expects NullPointerException for one-argument constructor and
     * two-argument constructor. Expects IllegalArgumentException for four-argument constructor.
     *
     * @throws Exception if any unexpected exception occurs.
     */
    public void testConstructor_NullDbNamespace() throws Exception {
        ...
        try {
            new InformixTimeTrackerProjectPersistence(null, TestHelper.CONNECTION_PRODUCER_NAME,
                TestHelper.PROJECT_SEARCH_UTILITY_NAMESPACE, TestHelper.CLIENT_SEARCH_UTILITY_NAMESPACE);
            fail("Creates InformixTimeTrackerProjectPersistence with null db namespace");
    ...
    /**
     * Test of constructor with null connection producer name. Expects NullPointerException for two-argument
     * constructor. Expects IllegalArgumentException for four-argument constructor.
     *
     * @throws Exception if any unexpected exception occurs.
     */
    ...
    /**
     * Test of constructor with null project search utility namespace. Expects IllegalArgumentException.
     *
     * @throws Exception if any unexpected exception occurs.
     *
     * @since 1.1
     */
    public void testConstructor_NullProjectNamespace()
        throws Exception {
        try {
            new InformixTimeTrackerProjectPersistence(TestHelper.DB_NAMESPACE, TestHelper.CONNECTION_PRODUCER_NAME,
                null, TestHelper.CLIENT_SEARCH_UTILITY_NAMESPACE);
    ...
    /**
     * Test of constructor with empty project search utility namespace. Expects IllegalArgumentException.
     *
     * @throws Exception if any unexpected exception occurs.
     *
     * @since 1.1
     */
    public void testConstructor_EmptyProjectNamespace()
        throws Exception {
        try {
            new InformixTimeTrackerProjectPersistence(TestHelper.DB_NAMESPACE, TestHelper.CONNECTION_PRODUCER_NAME, "",
    ...
    /**
     * Test of constructor with null client search utility namespace. Expects IllegalArgumentException.
     *
     * @throws Exception if any unexpected exception occurs.
     *
     * @since 1.1
    ...
    /**
     * Test of constructor with empty client search utility namespace. Expects IllegalArgumentException.
     *
     * @throws Exception if any unexpected exception occurs.
     *
     * @since 1.1
     */
    public void testConstructor_EmptyClientNamespace()
        throws Exception {
        try {
            new InformixTimeTrackerProjectPersistence(TestHelper.DB_NAMESPACE, TestHelper.CONNECTION_PRODUCER_NAME,
    ...
    public void testGetAllClientProjects_NonExistProjects()
        throws Exception {
        assertTrue("Returns an incorrect list of client projects",
            persistence.getAllClientProjects(clientId).isEmpty());
    }
    ...
    /**
     * Test of searchForProjects method with null filter. Expects IllegalArgumentException.
     *
     * @throws Exception if any unexpected exception occurs.
     *
     * @since 1.1
    ...
    /**
     * Test of searchForProjects method with matching filter. Verifies if it returns the matching projects.
     *
     * @throws Exception if any unexpected exception occurs.
     *
     * @since 1.1
    ...
    public void testSearchForProjects_MatchFilter() throws Exception {
        ...
        assertTrue("Fails to search projects", TestHelper.compareProjects(project, projects[0]));
    }

    /**
     * Test of searchForProjects method with non-matching filter. Verifies if it returns an empty array.
     *
     * @throws Exception if any unexpected exception occurs.
     *
     * @since 1.1
     */
    public void testSearchForProjects_NonMatchFilter()
        throws Exception {
        Project[] projects = persistence.searchForProjects(filter);
    ...
    /**
     * Test of searchForClients method with null filter. Expects IllegalArgumentException.
     *
     * @throws Exception if any unexpected exception occurs.
     *
     * @since 1.1
    ...
    /**
     * Test of searchForClients method with matching filter. Verifies if it returns the matching clients.
     *
     * @throws Exception if any unexpected exception occurs.
     *
     * @since 1.1
    ...
    public void testSearchForClients_MatchFilter() throws Exception {
        ...
        assertTrue("Fails to search clients", TestHelper.compareClients(client, clients[0]));
    }

    /**
     * Test of searchForClients method with non-matching filter. Verifies if it returns an empty array.
     *
     * @throws Exception if any unexpected exception occurs.
     *
     * @since 1.1
    ...
    /**
     * Test of addClients method with non-existing clients. Verifies if the clients were added to the Clients table.
     *
     * @throws Exception if any unexpected exception occurs.
     *
     * @since 1.1
    ...
    public void testAddClients_NonExistClients() throws Exception {
        ...
        for (int i = 0; i < clientIds.length; i++) {
            assertNotNull("Fails to add clients", persistence.getClient(clientIds[i]));
        }
    }

    /**
     * Test of addClients method with existing clients in atomic mode. Expects BatchOperationException. Also verifies
     * if the non-existing clients were not added to the Clients table.
     *
     * @throws Exception if any unexpected exception occurs.
     *
     * @since 1.1
    ...
    public void testAddClients_ExistClients_Atomic() throws Exception {
        ...
        for (int i = 1; i < clientIds.length; i++) {
            assertNull("Fails to add clients", persistence.getClient(clientIds[i]));
        }
    }

    /**
     * Test of addClients method with existing clients in non-atomic mode. Expects BatchOperationException. Also
     * verifies if the non-existing clients were added to the Clients table.
     *
     * @throws Exception if any unexpected exception occurs.
     *
     * @since 1.1
     */
    public void testAddClients_ExistClients_NonAtomic()
        throws Exception {
        // make sure some client exists
        persistence.addClient(clients[0]);
    ...
    /**
     * Test of removeClients method with null client ids. Expects IllegalArgumentException.
     *
     * @throws Exception if any unexpected exception occurs.
     *
     * @since 1.1
    ...
    /**
     * Test of removeClients method with empty client ids. Expects IllegalArgumentException.
     *
     * @throws Exception if any unexpected exception occurs.
     *
     * @since 1.1
    ...
    /**
     * Test of removeClients method with existing client ids. Verifies if the clients were removed from the Clients
     * table.
     *
     * @throws Exception if any unexpected exception occurs.
     *
    ...
    public void testRemoveClients_ExistClientIds() throws Exception {
        ...
        for (int i = 0; i < clientIds.length; i++) {
            assertNull("Fails to remove clients", persistence.getClient(clientIds[i]));
        }
    }

    /**
     * Test of removeClients method with non-existing client ids in atomic mode. Expects BatchOperationException. Also
     * verifies if the existing clients were not removed from the Clients table.
     *
     * @throws Exception if any unexpected exception occurs.
     *
     * @since 1.1
     */
    public void testRemoveClients_NonExistClientIds_Atomic()
        throws Exception {
        ...
        for (int i = 1; i < clientIds.length; i++) {
            assertNotNull("Fails to remove clients", persistence.getClient(clientIds[i]));
        }
    }

    /**
     * Test of removeClients method with non-existing client ids in non-atomic mode. Expects BatchOperationException.
     * Also verifies if the existing clients were removed from the Clients table.
     *
     * @throws Exception if any unexpected exception occurs.
     *
     * @since 1.1
    ...
    /**
     * Test of updateClients method with existing clients. Updates the name fields. Verifies if the name fields were
     * updated in the Clients table.
     *
     * @throws Exception if any unexpected exception occurs.
     *
     * @since 1.1
    ...
    public void testUpdateClients_ExistClients() throws Exception {
        ...
        for (int i = 0; i < clientIds.length; i++) {
            assertEquals("Fails to update clients", "update", persistence.getClient(clientIds[i]).getName());
        }
    }

    /**
     * Test of updateClients method with non-existing clients in atomic mode. Expects BatchOperationException. Verifies
     * if the existing clients were not updated in the Clients table.
     *
     * @throws Exception if any unexpected exception occurs.
     *
     * @since 1.1
     */
    public void testUpdateClients_NonExistClients_Atomic()
        throws Exception {
        // make sure some client does not exist
        persistence.addClients(clients, atomic);
        persistence.removeClient(clientIds[0]);
        ...
        for (int i = 1; i < clientIds.length; i++) {
            assertEquals("Fails to update clients", "name", persistence.getClient(clientIds[i]).getName());
        }
    }

    /**
     * Test of updateClients method with non-existing clients in non-atomic mode. Expects BatchOperationException.
     * Verifies if the existing clients were updated in the Clients table.
     *
     * @throws Exception if any unexpected exception occurs.
     *
     * @since 1.1
     */
    public void testUpdateClients_NonExistClients_NonAtomic()
        throws Exception {
        // make sure some client does not exist
        persistence.addClients(clients, atomic);
        persistence.removeClient(clientIds[0]);
    ...
    /**
     * Test of getClients method with null client ids. Expects IllegalArgumentException.
     *
     * @throws Exception if any unexpected exception occurs.
     *
     * @since 1.1
    ...
    /**
     * Test of getClients method with empty client ids. Expects IllegalArgumentException.
     *
     * @throws Exception if any unexpected exception occurs.
     *
     * @since 1.1
    ...
    /**
     * Test of getClients method with existing client ids. Verifies if the clients are returned. Verifies if the fields
     * of the returned clients are populated.
     *
     * @throws Exception if any unexpected exception occurs.
     *
     * @since 1.1
    ...
    public void testGetClients_ExistClientIds() throws Exception {
        ...
        for (int i = 0; i < clients.length; i++) {
            assertTrue("Fails to get clients", TestHelper.compareClients(this.clients[i], clients[i]));
        }
    }

    /**
     * Test of getClients method with non-existing client ids in atomic mode. Expects BatchOperationException.
     *
     * @throws Exception if any unexpected exception occurs.
     *
     * @since 1.1
     */
    public void testGetClients_NonExistClientIds_Atomic()
        throws Exception {
        // make sure some client does not exist
        persistence.addClients(clients, atomic);
        persistence.removeClient(clientIds[0]);
    ...
    /**
     * Test of getClients method with some non-existing client ids in non-atomic mode. Verifies if the clients are
     * returned, with null element for non-existing client. Verifies if the fields of the returned clients are
     * populated.
     *
     * @throws Exception if any unexpected exception occurs.
     *
    ...
    /**
     * Test of getClients method with all non-existing client ids in non-atomic mode. Expects BatchOperationException.
     *
     * @since 1.1
     */
    ...
    /**
     * Test of addProjects method with null projects. Expects IllegalArgumentException.
     *
     * @throws Exception if any unexpected exception occurs.
     *
     * @since 1.1
    ...
    /**
     * Test of addProjects method with empty projects. Expects IllegalArgumentException.
     *
     * @throws Exception if any unexpected exception occurs.
     *
     * @since 1.1
    ...
    /**
     * Test of addProjects method with bad projects containing null element. Expects IllegalArgumentException.
     *
     * @throws Exception if any unexpected exception occurs.
     *
     * @since 1.1
    ...
    /**
     * Test of addProjects method with non-existing projects. Verifies if the projects were added to the Projects
     * table.
     *
     * @throws Exception if any unexpected exception occurs.
     *
    ...
    public void testAddProjects_NonExistProjects() throws Exception {
        ...
        for (int i = 0; i < projectIds.length; i++) {
            assertNotNull("Fails to add projects", persistence.getProject(projectIds[i]));
        }
    }

    /**
     * Test of addProjects method with existing projects in atomic mode. Expects BatchOperationException. Also verifies
     * if the non-existing projects were not added to the Projects table.
     *
     * @throws Exception if any unexpected exception occurs.
     *
     * @since 1.1
     */
    public void testAddProjects_ExistProjects_Atomic()
        throws Exception {
        ...
        for (int i = 1; i < projectIds.length; i++) {
            assertNull("Fails to add projects", persistence.getProject(projectIds[i]));
        }
    }

    /**
     * Test of addProjects method with existing projects in non-atomic mode. Expects BatchOperationException. Also
     * verifies if the non-existing projects were added to the Projects table.
     *
     * @throws Exception if any unexpected exception occurs.
     *
     * @since 1.1
     */
    public void testAddProjects_ExistProjects_NonAtomic()
        throws Exception {
        // make sure some project exists
        persistence.addProject(projects[0]);
    ...
    /**
     * Test of removeProjects method with null project ids. Expects IllegalArgumentException.
     *
     * @throws Exception if any unexpected exception occurs.
     *
     * @since 1.1
    ...
    /**
     * Test of removeProjects method with empty project ids. Expects IllegalArgumentException.
     *
     * @throws Exception if any unexpected exception occurs.
     *
     * @since 1.1
    ...
    /**
     * Test of removeProjects method with existing project ids. Verifies if the projects were removed from the Projects
     * table.
     *
     * @throws Exception if any unexpected exception occurs.
     *
    ...
    public void testRemoveProjects_ExistProjectIds() throws Exception {
        ...
        for (int i = 0; i < projectIds.length; i++) {
            assertNull("Fails to remove projects", persistence.getProject(projectIds[i]));
        }
    }

    /**
     * Test of removeProjects method with non-existing project ids in atomic mode. Expects BatchOperationException.
     * Also verifies if the existing projects were not removed from the Projects table.
     *
     * @throws Exception if any unexpected exception occurs.
     *
     * @since 1.1
     */
    public void testRemoveProjects_NonExistProjectIds_Atomic()
        throws Exception {
        ...
        for (int i = 1; i < projectIds.length; i++) {
            assertNotNull("Fails to remove projects", persistence.getProject(projectIds[i]));
        }
    }

    /**
     * Test of removeProjects method with non-existing project ids in non-atomic mode. Expects BatchOperationException.
     * Also verifies if the existing projects were removed from the Projects table.
     *
     * @throws Exception if any unexpected exception occurs.
     *
     * @since 1.1
    ...
    /**
     * Test of updateProjects method with null projects. Expects IllegalArgumentException.
     *
     * @throws Exception if any unexpected exception occurs.
     *
     * @since 1.1
    ...
    /**
     * Test of updateProjects method with empty projects. Expects IllegalArgumentException.
     *
     * @throws Exception if any unexpected exception occurs.
     *
     * @since 1.1
    ...
    /**
     * Test of updateProjects method with bad projects containing null element. Expects IllegalArgumentException.
     *
     * @throws Exception if any unexpected exception occurs.
     *
     * @since 1.1
    ...
    /**
     * Test of updateProjects method with existing projects. Updates the name fields. Verifies if the name fields were
     * updated in the Projects table.
     *
     * @throws Exception if any unexpected exception occurs.
     *
     * @since 1.1
    ...
    public void testUpdateProjects_ExistProjects() throws Exception {
        ...
        for (int i = 0; i < projectIds.length; i++) {
            assertEquals("Fails to update projects", "update", persistence.getProject(projectIds[i]).getName());
        }
    }

    /**
     * Test of updateProjects method with non-existing projects in atomic mode. Expects BatchOperationException.
     * Verifies if the existing projects were not updated in the Projects table.
     *
     * @throws Exception if any unexpected exception occurs.
     *
     * @since 1.1
     */
    public void testUpdateProjects_NonExistProjects_Atomic()
        throws Exception {
        // make sure some project does not exist
        persistence.addProjects(projects, atomic);
        persistence.removeProject(projectIds[0]);
        ...
        for (int i = 1; i < projectIds.length; i++) {
            assertEquals("Fails to update projects", "name", persistence.getProject(projectIds[i]).getName());
        }
    }

    /**
     * Test of updateProjects method with non-existing projects in non-atomic mode. Expects BatchOperationException.
     * Verifies if the existing projects were updated in the Projects table.
     *
     * @throws Exception if any unexpected exception occurs.
     *
     * @since 1.1
    ...
    /**
     * Test of getProjects method with null project ids. Expects IllegalArgumentException.
     *
     * @throws Exception if any unexpected exception occurs.
     *
     * @since 1.1
    ...
    /**
     * Test of getProjects method with empty project ids. Expects IllegalArgumentException.
     *
     * @throws Exception if any unexpected exception occurs.
     *
     * @since 1.1
    ...
    /**
     * Test of getProjects method with existing project ids. Verifies if the projects are returned. Verifies if the
    ...
    public void testGetProjects_ExistProjectIds() throws Exception {
        ...
        for (int i = 0; i < projects.length; i++) {
            assertTrue("Fails to get projects", TestHelper.compareProjects(this.projects[i], projects[i]));
        }
    }

    /**
     * Test of getProjects method with non-existing project ids in atomic mode. Expects BatchOperationException.
     *
     * @throws Exception if any unexpected exception occurs.
     *
     * @since 1.1
     */
    public void testGetProjects_NonExistProjectIds_Atomic()
        throws Exception {
        // make sure some project does not exist
        persistence.addProjects(projects, atomic);
        persistence.removeProject(projectIds[0]);
    ...
    /**
     * Test of getProjects method with some non-existing project ids in non-atomic mode. Verifies if the projects are
     * returned, with null element for non-existing project. Verifies if the fields of the returned projects are
     * populated.
     *
     * @throws Exception if any unexpected exception occurs.
     *
    ...
    /**
     * Test of getProjects method with all non-existing project ids in non-atomic mode. Expects
    ...
    /**
     * Test of addWorkers method with null workers. Expects IllegalArgumentException.
     *
     * @throws Exception if any unexpected exception occurs.
     *
     * @since 1.1
    ...
    /**
     * Test of addWorkers method with empty workers. Expects IllegalArgumentException.
     *
     * @throws Exception if any unexpected exception occurs.
     *
     * @since 1.1
    ...
    /**
     * Test of addWorkers method with bad workers containing null element. Expects IllegalArgumentException.
     *
     * @throws Exception if any unexpected exception occurs.
     *
     * @since 1.1
    ...
    /**
     * Test of addWorkers method with non-existing workers. Verifies if the workers were added to the ProjectWorkers
     * table.
     *
     * @throws Exception if any unexpected exception occurs.
     *
    ...
    public void testAddWorkers_NonExistWorkers() throws Exception {
        ...
        for (int i = 0; i < workerIds.length; i++) {
            assertNotNull("Fails to add workers", persistence.getWorker(workerIds[i], projectId));
        }
    }

    /**
     * Test of addWorkers method with existing workers in atomic mode. Expects BatchOperationException. Verifies if the
     * non-existing workers were not added to the ProjectWorkers table.
     *
     * @throws Exception if any unexpected exception occurs.
     *
     * @since 1.1
    ...
    public void testAddWorkers_ExistWorkers_Atomic() throws Exception {
        ...
        for (int i = 1; i < workerIds.length; i++) {
            assertNull("Fails to add workers", persistence.getWorker(workerIds[i], projectId));
        }
    }

    /**
     * Test of addWorkers method with existing workers in non-atomic mode. Expects BatchOperationException. Verifies if
     * the non-existing workers were added to the ProjectWorkers table.
     *
     * @throws Exception if any unexpected exception occurs.
     *
     * @since 1.1
     */
    public void testAddWorkers_ExistWorkers_NonAtomic()
        throws Exception {
        // make sure some worker exists
        persistence.addProject(project);
        persistence.addWorker(workers[0]);
    ...
    /**
     * Test of removeWorkers method with null worker ids. Expects IllegalArgumentException.
     *
     * @throws Exception if any unexpected exception occurs.
     *
     * @since 1.1
    ...
    /**
     * Test of removeWorkers method with empty worker ids. Expects IllegalArgumentException.
     *
     * @throws Exception if any unexpected exception occurs.
     *
     * @since 1.1
    ...
    /**
     * Test of removeWorkers method with existing worker ids. Verifies if the workers were removed from the
     * ProjectWorkers table.
     *
     * @throws Exception if any unexpected exception occurs.
     *
     * @since 1.1
    ...
    public void testRemoveWorkers_ExistWorkerIds() throws Exception {
        ...
        for (int i = 0; i < workerIds.length; i++) {
            assertNull("Fails to remove workers", persistence.getWorker(workerIds[i], projectId));
        }
    }

    /**
     * Test of removeWorkers method with non-existing worker ids in atomic mode. Expects BatchOperationException.
     * Verifies if the existing workers were not removed from the ProjectWorkers table.
     *
     * @throws Exception if any unexpected exception occurs.
     *
     * @since 1.1
     */
    public void testRemoveWorkers_NonExistWorkerIds_Atomic()
        throws Exception {
        ...
        for (int i = 1; i < workerIds.length; i++) {
            assertNotNull("Fails to remove workers", persistence.getWorker(workerIds[i], projectId));
        }
    }

    /**
     * Test of removeWorkers method with non-existing worker ids in non-atomic mode. Expects BatchOperationException.
     * Verifies if the existing workers were removed from the ProjectWorkers table.
     *
     * @throws Exception if any unexpected exception occurs.
     *
     * @since 1.1
    ...
    /**
     * Test of updateWorkers method with null workers. Expects IllegalArgumentException.
     *
     * @throws Exception if any unexpected exception occurs.
     *
     * @since 1.1
    ...
    /**
     * Test of updateWorkers method with empty workers. Expects IllegalArgumentException.
     *
     * @throws Exception if any unexpected exception occurs.
     *
     * @since 1.1
    ...
    /**
     * Test of updateWorkers method with bad workers containing null element. Expects IllegalArgumentException.
     *
     * @throws Exception if any unexpected exception occurs.
     *
     * @since 1.1
    ...
    /**
     * Test of updateWorkers method with existing workers. Updates the pay rate fields. Verifies if the pay rate fields
     * were updated in the ProjectWorkers table.
     *
     * @throws Exception if any unexpected exception occurs.
     *
     * @since 1.1
    ...
    public void testUpdateWorkers_ExistWorkers() throws Exception {
        ...
        for (int i = 0; i < workerIds.length; i++) {
            ProjectWorker worker = persistence.getWorker(workerIds[i], projectId);

            assertTrue("Fails to update workers", worker.getPayRate().compareTo(new BigDecimal(20)) == 0);
        }
    }

    /**
     * Test of updateWorkers method with non-existing workers in atomic mode. Expects BatchOperationException. Verifies
     * if the existing workers were not updated in the ProjectWorkers table.
     *
     * @throws Exception if any unexpected exception occurs.
     *
     * @since 1.1
     */
    public void testUpdateWorkers_NonExistWorkers_Atomic()
        throws Exception {
        // make sure some worker does not exist
        persistence.addProject(project);
        persistence.addWorkers(workers, atomic);
        ...
        for (int i = 1; i < workerIds.length; i++) {
            ...
            assertTrue("Fails to update workers", worker.getPayRate().compareTo(new BigDecimal(10)) == 0);
        }
    }

    /**
     * Test of updateWorkers method with non-existing workers in non-atomic mode. Expects BatchOperationException.
     * Verifies if the existing workers were updated in the ProjectWorkers table.
     *
     * @throws Exception if any unexpected exception occurs.
     *
     * @since 1.1
     */
    public void testUpdateWorkers_NonExistWorkers_NonAtomic()
        throws Exception {
        // make sure some worker does not exist
        persistence.addProject(project);
        persistence.addWorkers(workers, atomic);
    ...
    /**
     * Test of getWorkers method with null worker ids. Expects IllegalArgumentException.
     *
     * @throws Exception if any unexpected exception occurs.
     *
     * @since 1.1
    ...
    /**
     * Test of getWorkers method with empty worker ids. Expects IllegalArgumentException.
     *
     * @throws Exception if any unexpected exception occurs.
     *
     * @since 1.1
    ...
    /**
     * Test of getWorkers method with existing worker ids. Verifies if the workers are returned. Verifies if the fields
     * of the returned workers are populated.
     *
     * @throws Exception if any unexpected exception occurs.
     *
     * @since 1.1
    ...
    public void testGetWorkers_ExistWorkerIds() throws Exception {
        ...
        ProjectWorker[] workers = persistence.getWorkers(workerIds, projectId, atomic);

        for (int i = 0; i < workers.length; i++) {
            assertTrue("Fails to get workers", TestHelper.compareProjectWorkers(this.workers[i], workers[i]));
        }
    }

    /**
     * Test of getWorkers method with non-existing worker ids in atomic mode. Expects BatchOperationException.
     *
     * @throws Exception if any unexpected exception occurs.
     *
     * @since 1.1
     */
    public void testGetWorkers_NonExistWorkerIds_Atomic()
        throws Exception {
        // make sure some worker does not exist
        persistence.addProject(project);
        persistence.addWorkers(workers, atomic);
    ...
    /**
     * Test of getWorkers method with some non-existing worker ids in non-atomic mode. Verifies if the workers are
     * returned, with null element for non-existing worker. Verifies if the fields of the returned workers are
     * populated.
     *
     * @throws Exception if any unexpected exception occurs.
     *
    ...
    public void testGetWorkers_SomeNonExistWorkerIds_NonAtomic()
        ...
        ProjectWorker[] workers = persistence.getWorkers(workerIds, projectId, false);
    ...
    /**
     * Test of getWorkers method with all non-existing worker ids in non-atomic mode. Expects BatchOperationException.
     *
     * @since 1.1
     */
    ...
    /**
     * Test of addTimeEntries method with null entry ids. Expects IllegalArgumentException.
     *
     * @throws Exception if any unexpected exception occurs.
     *
     * @since 1.1
    ...
    /**
     * Test of addTimeEntries method with empty entry ids. Expects IllegalArgumentException.
     *
     * @throws Exception if any unexpected exception occurs.
     *
     * @since 1.1
    ...
    /**
     * Test of addTimeEntries method with null user. Expects IllegalArgumentException.
     *
     * @throws Exception if any unexpected exception occurs.
     *
     * @since 1.1
    ...
    /**
     * Test of addTimeEntries method with empty user. Expects IllegalArgumentException.
     *
     * @throws Exception if any unexpected exception occurs.
     *
     * @since 1.1
    ...
    /**
     * Test of addTimeEntries method with non-existing entry ids. Verifies if the time entries were added to the
     * ProjectTimes table.
     *
     * @throws Exception if any unexpected exception occurs.
     *
    ...
    public void testAddTimeEntries_NonExistEntryIds() throws Exception {
        ...
        assertEquals("Fails to add time entries", entryIds.length, persistence.getTimeEntries(projectId).size());
    }

    /**
     * Test of addTimeEntries method with existing entry ids in atomic mode. Expects BatchOperationException. Verifies
     * if the non-existing time entries were not added to the ProjectTimes table.
     *
     * @throws Exception if any unexpected exception occurs.
     *
     * @since 1.1
     */
    public void testAddTimeEntries_ExistEntryIds_Atomic()
        throws Exception {
        ...
        assertEquals("Fails to add time entries", 1, persistence.getTimeEntries(projectId).size());
    }

    /**
     * Test of addTimeEntries method with existing entry ids in non-atomic mode. Expects BatchOperationException.
     * Verifies if the non-existing time entries were added to the ProjectTimes table.
     *
     * @throws Exception if any unexpected exception occurs.
     *
     * @since 1.1
     */
    public void testAddTimeEntries_ExistEntryIds_NonAtomic()
        throws Exception {
        // make sure some time entry exists
        persistence.addProject(project);
        persistence.addTimeEntry(entryIds[0], projectId, user);
    ...
    /**
     * Test of removeTimeEntries method with null entry ids. Expects IllegalArgumentException.
     *
     * @throws Exception if any unexpected exception occurs.
     *
     * @since 1.1
    ...
    /**
     * Test of removeTimeEntries method with empty entry ids. Expects IllegalArgumentException.
     *
     * @throws Exception if any unexpected exception occurs.
     *
     * @since 1.1
    ...
    /**
     * Test of removeTimeEntries method with existing entry ids. Verifies if the time entries were removed from the
     * ProjectTimes table.
     *
     * @throws Exception if any unexpected exception occurs.
     *
    ...
    public void testRemoveTimeEntries_ExistEntryIds() throws Exception {
        ...
        assertTrue("Fails to remove time entries", persistence.getTimeEntries(projectId).isEmpty());
    }

    /**
     * Test of removeTimeEntries method with non-existing entry ids in atomic mode. Expects BatchOperationException.
     * Verifies if the existing time entries were not removed from the ProjectTimes table.
     *
     * @throws Exception if any unexpected exception occurs.
     *
     * @since 1.1
    ...
    public void testRemoveTimeEntries_NonExistEntryIds_Atomic()
        ...
        assertEquals("Fails to remove time entries", entryIds.length - 1, persistence.getTimeEntries(projectId).size());
    }

    /**
     * Test of removeTimeEntries method with non-existing entry ids in non-atomic mode. Expects
     * BatchOperationException. Verifies if the existing time entries were removed from the ProjectTimes table.
     *
     * @throws Exception if any unexpected exception occurs.
     *
     * @since 1.1
    ...
    /**
     * Test of addExpenseEntries method with null entry ids. Expects IllegalArgumentException.
     *
     * @throws Exception if any unexpected exception occurs.
     *
     * @since 1.1
    ...
    /**
     * Test of addExpenseEntries method with empty entry ids. Expects IllegalArgumentException.
     *
     * @throws Exception if any unexpected exception occurs.
     *
     * @since 1.1
    ...
    /**
     * Test of addExpenseEntries method with null user. Expects IllegalArgumentException.
     *
     * @throws Exception if any unexpected exception occurs.
     *
     * @since 1.1
    ...
    /**
     * Test of addExpenseEntries method with empty user. Expects IllegalArgumentException.
     *
     * @throws Exception if any unexpected exception occurs.
     *
     * @since 1.1
    ...
    /**
     * Test of addExpenseEntries method with non-existing entry ids. Verifies if the expense entries were added to the
     ...
     * @since 1.1
     */
    public void testAddExpenseEntries_NonExistEntryIds()
        throws Exception {
        persistence.addProject(project);
        persistence.addExpenseEntries(entryIds, projectId, user, atomic);

        assertEquals("Fails to add expense entries", entryIds.length, persistence.getExpenseEntries(projectId).size());
    }

    /**
     * Test of addExpenseEntries method with existing entry ids in atomic mode. Expects BatchOperationException.
     * Verifies if the non-existing expense entries were not added to the ProjectExpenses table.
     *
     * @throws Exception if any unexpected exception occurs.
     *
     * @since 1.1
     */
    public void testAddExpenseEntries_ExistEntryIds_Atomic()
        throws Exception {
        ...
        assertEquals("Fails to add expense entries", 1, persistence.getExpenseEntries(projectId).size());
    }

    /**
     * Test of addExpenseEntries method with existing entry ids in non-atomic mode. Expects BatchOperationException.
     * Verifies if the non-existing expense entries were added to the ProjectExpenses table.
     *
     * @throws Exception if any unexpected exception occurs.
     *
     * @since 1.1
    ...
    /**
     * Test of removeExpenseEntries method with null entry ids. Expects IllegalArgumentException.
     *
     * @throws Exception if any unexpected exception occurs.
     *
     * @since 1.1
     */
    public void testRemoveExpenseEntries_NullEntryIds()
        throws Exception {
        try {
    ...
    /**
     * Test of removeExpenseEntries method with empty entry ids. Expects IllegalArgumentException.
     *
     * @throws Exception if any unexpected exception occurs.
     *
     * @since 1.1
     */
    public void testRemoveExpenseEntries_EmptyEntryIds()
        throws Exception {
        try {
    ...
    /**
     * Test of removeExpenseEntries method with existing entry ids. Verifies if the expense entries were removed from
     * the ProjectExpenses table.
     *
     * @throws Exception if any unexpected exception occurs.
     *
     * @since 1.1
     */
    public void testRemoveExpenseEntries_ExistEntryIds()
        throws Exception {
        ...
        assertTrue("Fails to remove expense entries", persistence.getExpenseEntries(projectId).isEmpty());
    }

    /**
     * Test of removeExpenseEntries method with non-existing entry ids in atomic mode. Expects BatchOperationException.
     * Verifies if the existing expense entries were not removed from the ProjectExpenses table.
     *
     * @throws Exception if any unexpected exception occurs.
     *
     * @since 1.1
    ...
    /**
     * Test of removeExpenseEntries method with non-existing entry ids in non-atomic mode. Expects
     * BatchOperationException. Verifies if the existing expense entries were removed from the ProjectExpenses table.
     *
     * @throws Exception if any unexpected exception occurs.
     *
     * @since 1.1
