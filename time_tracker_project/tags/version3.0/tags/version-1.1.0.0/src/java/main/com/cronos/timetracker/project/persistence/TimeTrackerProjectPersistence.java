 ...
 * </li>
 * <li>
 * a constructor that accepts four String arguments specifying the namespace of the DB Connection Factory configuration
 * file, the connection producer name, project search utility namespace and client search utility namespace.
 * </li>
 * </ul>
 * </p>
 *
...
public interface TimeTrackerProjectPersistence {
     ...
     *         exception)
     */
    boolean removeWorker(int workerId, int projectId) throws PersistenceException;
     ...
     * @since 1.1
     */
    Project[] searchForProjects(Filter searchFilter) throws PersistenceException;
     ...
     * @since 1.1
     */
    void addClients(Client[] clients, boolean atomic) throws BatchOperationException;
     ...
     * @since 1.1
     */
    void addTimeEntries(int[] entryIds, int projectId, String user, boolean atomic)
        throws BatchOperationException;
     ...
     * @since 1.1
     */
    void addExpenseEntries(int[] entryIds, int projectId, String user, boolean atomic)
        throws BatchOperationException;
