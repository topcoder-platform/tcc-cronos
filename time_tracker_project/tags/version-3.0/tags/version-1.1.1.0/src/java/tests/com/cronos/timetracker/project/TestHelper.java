...
public class TestHelper {
     ...
     */
    public static final String NAMESPACE = "com.cronos.timetracker.project";

    /**
     * The namespace of the time tracker project pertaining to a simple persistence.
     */
    public static final String SIMPLE_NAMESPACE = "com.cronos.timetracker.project.simple";
     ...
     */
    public static final String PROJECT_SEARCH_UTILITY_NAMESPACE = "com.cronos.timetracker.project.persistence."
        + "DatabaseSearchUtility.projects";

    /**
     * The namespace used by the client search utility.
     */
    public static final String CLIENT_SEARCH_UTILITY_NAMESPACE = "com.cronos.timetracker.project.persistence."
