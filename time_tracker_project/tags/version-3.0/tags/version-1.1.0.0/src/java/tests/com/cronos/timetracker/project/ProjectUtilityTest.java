...
public class ProjectUtilityTest extends TestCase {
    ...
    /**
     * Test of searchProjects method. Verifies if the persistence method was called appropriately by checking the last
     * method being called and the arguments passed.
     *
     * @throws Exception if any unexpected exception occurs.
     *
    ...
    public void testSearchProjects() throws Exception {
        ...
        assertEquals("Fails to call method", "searchForProjects", persistence.getLastMethod());
    ...
    /**
     * Test of addProjects method with projects with insufficient data. Expects InsufficientDataException.
     *
     * @throws Exception if any unexpected exception occurs.
     *
     * @since 1.1
     */
    public void testAddProjects_InsufficientProjects()
        throws Exception {
        try {
            utility.addProjects(new Project[] {TestHelper.createInsufficientProject()}, atomic);
    ...
    /**
     * Test of addProjects method with valid projects. Verifies if the persistence method was called appropriately by
     * checking the last method being called and the arguments passed.
     *
     * @throws Exception if any unexpected exception occurs.
     *
    ...
    public void testAddProjects_ValidProjects() throws Exception {
        ...
        assertEquals("Fails to call method", "addProjects", persistence.getLastMethod());
        assertEquals("Fails to pass arguments", projects, persistence.getLastProjects());
        assertEquals("Fails to pass arguments", atomic, persistence.getLastAtomic());
    }

    /**
     * Test of removeProjects method. Verifies if the persistence method was called appropriately by checking the last
     * method being called and the arguments passed.
     *
     * @throws Exception if any unexpected exception occurs.
     *
    ...
    public void testRemoveProjects() throws Exception {
        ...
        assertEquals("Fails to call method", "removeProjects", persistence.getLastMethod());
        assertEquals("Fails to pass arguments", projectIds, persistence.getLastProjectIds());
        assertEquals("Fails to pass arguments", atomic, persistence.getLastAtomic());
    }
    ...
    /**
     * Test of updateProjects method with projects with insufficient data. Expects InsufficientDataException.
     *
     * @throws Exception if any unexpected exception occurs.
     *
     * @since 1.1
     */
    public void testUpdateProjects_InsufficientProjects()
        throws Exception {
        try {
            utility.updateProjects(new Project[] {TestHelper.createInsufficientProject()}, atomic);
    ...
    /**
     * Test of updateProjects method with valid projects. Verifies if the persistence method was called appropriately
     * by checking the last method being called and the arguments passed.
     *
     * @throws Exception if any unexpected exception occurs.
     *
     * @since 1.1
    ...
    public void testUpdateProjects_ValidProjects() throws Exception {
        ...
        assertEquals("Fails to call method", "updateProjects", persistence.getLastMethod());
        assertEquals("Fails to pass arguments", projects, persistence.getLastProjects());
        assertEquals("Fails to pass arguments", atomic, persistence.getLastAtomic());
    }

    /**
     * Test of getProjects method. Verifies if the persistence method was called appropriately by checking the last
     * method being called and the arguments passed.
     *
     * @throws Exception if any unexpected exception occurs.
     *
    ...
    public void testGetProjects() throws Exception {
        ...
        assertEquals("Fails to call method", "getProjects", persistence.getLastMethod());
        assertEquals("Fails to pass arguments", projectIds, persistence.getLastProjectIds());
        assertEquals("Fails to pass arguments", atomic, persistence.getLastAtomic());
    }
    ...
    /**
     * Test of addWorkers method with workers with insufficient data. Expects InsufficientDataException.
     *
     * @throws Exception if any unexpected exception occurs.
     *
     * @since 1.1
    ...
    public void testAddWorkers_InsufficientWorkers() throws Exception {
        try {
            utility.addWorkers(new ProjectWorker[] {TestHelper.createInsufficientWorker()}, atomic);
    ...
    /**
     * Test of addWorkers method with valid workers. Verifies if the persistence method was called appropriately by
     * checking the last method being called and the arguments passed.
     *
     * @throws Exception if any unexpected exception occurs.
     *
    ...
    public void testAddWorkers_ValidWorkers() throws Exception {
        ...
        assertEquals("Fails to call method", "addWorkers", persistence.getLastMethod());
        assertEquals("Fails to pass arguments", workers, persistence.getLastWorkers());
        assertEquals("Fails to pass arguments", atomic, persistence.getLastAtomic());
    }

    /**
     * Test of removeWorkers method with worker ids. Verifies if the persistence method was called appropriately by
     * checking the last method being called and the arguments passed.
     *
     * @throws Exception if any unexpected exception occurs.
     *
    ...
    public void testRemoveWorkers_WorkerIds() throws Exception {
        ...
        assertEquals("Fails to call method", "removeWorkers", persistence.getLastMethod());
        assertEquals("Fails to pass arguments", workerIds, persistence.getLastWorkerIds());
        assertEquals("Fails to pass arguments", projectId, persistence.getLastProjectId());
        assertEquals("Fails to pass arguments", atomic, persistence.getLastAtomic());
    }
    ...
    /**
     * Test of updateWorkers method with workers with insufficient data. Expects InsufficientDataException.
     *
     * @throws Exception if any unexpected exception occurs.
     *
     * @since 1.1
     */
    public void testUpdateWorkers_InsufficientWorkers()
        throws Exception {
        try {
            utility.updateWorkers(new ProjectWorker[] {TestHelper.createInsufficientWorker()}, atomic);
    ...
    /**
     * Test of updateWorkers method with valid workers. Verifies if the persistence method was called appropriately by
     * checking the last method being called and the arguments passed.
     *
     * @throws Exception if any unexpected exception occurs.
     *
    ...
    public void testUpdateWorkers_ValidWorkers() throws Exception {
        ...
        assertEquals("Fails to call method", "updateWorkers", persistence.getLastMethod());
        assertEquals("Fails to pass arguments", workers, persistence.getLastWorkers());
        assertEquals("Fails to pass arguments", atomic, persistence.getLastAtomic());
    }

    /**
     * Test of getWorkers method with worker ids. Verifies if the persistence method was called appropriately by
     * checking the last method being called and the arguments passed.
     *
     * @throws Exception if any unexpected exception occurs.
     *
    ...
    /**
     * Test of addTimeEntries method. Verifies if the persistence method was called appropriately by checking the last
     * method being called and the arguments passed.
     *
     * @throws Exception if any unexpected exception occurs.
     *
    ...
    public void testAddTimeEntries() throws Exception {
        ...
        assertEquals("Fails to call method", "addTimeEntries", persistence.getLastMethod());
        assertEquals("Fails to pass arguments", entryIds, persistence.getLastEntryIds());
        assertEquals("Fails to pass arguments", projectId, persistence.getLastProjectId());
        assertEquals("Fails to pass arguments", user, persistence.getLastUser());
        assertEquals("Fails to pass arguments", atomic, persistence.getLastAtomic());
    }
    ...
    /**
     * Test of removeTimeEntries method. Verifies if the persistence method was called appropriately by checking the
     * last method being called and the arguments passed.
     *
     * @throws Exception if any unexpected exception occurs.
     *
    ...
    public void testRemoveTimeEntries() throws Exception {
        ...
        assertEquals("Fails to call method", "removeTimeEntries", persistence.getLastMethod());
        assertEquals("Fails to pass arguments", entryIds, persistence.getLastEntryIds());
        assertEquals("Fails to pass arguments", projectId, persistence.getLastProjectId());
        assertEquals("Fails to pass arguments", atomic, persistence.getLastAtomic());
    }
    ...
    /**
     * Test of addExpenseEntries method. Verifies if the persistence method was called appropriately by checking the
     * last method being called and the arguments passed.
     *
     * @throws Exception if any unexpected exception occurs.
     *
    ...
    public void testAddExpenseEntries() throws Exception {
        ...
        assertEquals("Fails to call method", "addExpenseEntries", persistence.getLastMethod());
        assertEquals("Fails to pass arguments", entryIds, persistence.getLastEntryIds());
        assertEquals("Fails to pass arguments", projectId, persistence.getLastProjectId());
        assertEquals("Fails to pass arguments", user, persistence.getLastUser());
        assertEquals("Fails to pass arguments", atomic, persistence.getLastAtomic());
    ...
    /**
     * Test of removeExpenseEntries method. Verifies if the persistence method was called appropriately by checking the
     * last method being called and the arguments passed.
     *
     * @throws Exception if any unexpected exception occurs.
     *
    ...
    public void testRemoveExpenseEntries() throws Exception {
        ...
        assertEquals("Fails to call method", "removeExpenseEntries", persistence.getLastMethod());
        assertEquals("Fails to pass arguments", entryIds, persistence.getLastEntryIds());
        assertEquals("Fails to pass arguments", projectId, persistence.getLastProjectId());
        assertEquals("Fails to pass arguments", atomic, persistence.getLastAtomic());
    }
