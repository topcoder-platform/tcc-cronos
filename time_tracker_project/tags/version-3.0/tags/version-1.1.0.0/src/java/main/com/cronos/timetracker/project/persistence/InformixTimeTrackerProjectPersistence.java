 ...
 *
 * <p>
 * This class provides three constructors to obey the configuration contract of the interface. The default constant
 * will be used if the corresponding field is not specified.
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * Since version 1.1 it supports batch processing of the client/project CRUD operations, and client/project search
 * functionality. The atomicity can be specified for those batch operations. If it is true, the successful operations
 * are rolled back when one operation in a batch fails, and a BatchOperationException will be thrown. If it is false,
 * the operation continues for every element before throwing the BatchOperationException.
 * </p>
 *
 * <p>
 * This class is not thread-safe. The methods should not be called concurrently on a single instance. However, the
 * database operations are made atomic using JDBC transactions. So multiple instances of this class can access the
...
public class InformixTimeTrackerProjectPersistence implements TimeTrackerProjectPersistence {
    ...
    /**
     * <p>
     * The default ConfigManager namespace to be used for loading the configuration of DatabaseSearchUtility used to
     * search the projects.
     * </p>
     */
    public static final String DEFAULT_PROJECT_SEARCH_UTILITY_NAMESPACE = "com.cronos.timetracker.project.persistence."
     ...
     * </p>
     */
    public static final String DEFAULT_CLIENT_SEARCH_UTILITY_NAMESPACE = "com.cronos.timetracker.project.persistence."
     ...
     * </p>
     */
    private static final String SQL_SEL_PROJECT_MANAGER_ID = "SELECT UsersID FROM ProjectManagers WHERE ProjectsID = ?";
     ...
     * </p>
     */
    private static final String SQL_SEL_PROJECT_WORKER_IDS = "SELECT UsersID FROM ProjectWorkers WHERE ProjectsID = ?";
     ...
     * </p>
     */
    private static final String SQL_INS_PROJECT_WORKER = "INSERT INTO ProjectWorkers VALUES "
        + "(?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    /**
     * <p>
     * The DatabaseSearchUtility used to search the projects. It is initialized in constructor and then never changed.
     * It cannot be null. It is used by the searchForProjects() method.
     * </p>
     */
    ...
    /**
     * <p>
     * The DatabaseSearchUtility used to search the clients. It is initialized in constructor and then never changed.
     * It cannot be null. It is used by the searchForClients() method.
     * </p>
     */
    ...
    /**
     * <p>
     * The cache for prepared statements. It is a mapping from SQL query (String) to the corresponding prepared
     * statement (PreparedStatement). It is initialized in constructor and the reference can never change. It cannot
     * be null. All prepared statements to be executed are retrieved from this map. If not exists, the prepared
     * statement is lazily initialized.
     * </p>
     */
    private Map pstmts;
    ...
    /**
     * <p>
     * Creates a new instance of this class. The default connection producer name, project search utility namespace and
     * client search utility namespace will be used.
     * </p>
     *
     ...
     * @throws PersistenceException if the connection to the database cannot be established, or any error happens when
    ...
    /**
     * <p>
     * Creates a new instance of this class. The default project search utility namespace and client search utility
    ...
    public InformixTimeTrackerProjectPersistence(String dbNamespace, String connectionProducerName)
        ...
        init(dbNamespace, connectionProducerName, DEFAULT_PROJECT_SEARCH_UTILITY_NAMESPACE,
            DEFAULT_CLIENT_SEARCH_UTILITY_NAMESPACE);
    }

    /**
     * <p>
     * Creates a new instance of this class with the given connection producer name, project search utility namespace
     * and client search utility namespace.
     * </p>
     *
     * @param dbNamespace the namespace of the DB Connection Factory configuration file
     * @param connectionProducerName the connection producer name used to obtain the connection
     * @param projectSearchUtilityNamespace the configuration namespace used to load configuration for the
     *        DatabaseSearchUtility used to search projects
     * @param clientSearchUtilityNamespace the configuration namespace used to load configuration for the
     *        DatabaseSearchUtility used to search clients
     *
     * @throws IllegalArgumentException if any of the parameters is null or the empty String
     * @throws PersistenceException if the connection to the database cannot be established, or any error happens when
     *         loading the configuration
     *
     * @since 1.1
     */
    public InformixTimeTrackerProjectPersistence(String dbNamespace, String connectionProducerName,
        String projectSearchUtilityNamespace, String clientSearchUtilityNamespace)
        throws PersistenceException {
        DBUtil.checkStringIAE(dbNamespace, "dbNamespace");
        DBUtil.checkStringIAE(connectionProducerName, "connectionProducerName");
        DBUtil.checkStringIAE(projectSearchUtilityNamespace, "projectSearchUtilityNamespace");
        DBUtil.checkStringIAE(clientSearchUtilityNamespace, "clientSearchUtilityNamespace");

        init(dbNamespace, connectionProducerName, projectSearchUtilityNamespace, clientSearchUtilityNamespace);
    }
    ...
    public boolean updateClient(Client client) throws PersistenceException {
        ...
        try {
            ...
            pstmt.setTimestamp(2, DBUtil.toSQLDate(date));
    ...
    public boolean updateProject(Project project) throws PersistenceException {
        ...
        try {
            ...
            pstmt.setTimestamp(3, DBUtil.toSQLDate(project.getStartDate()));
            pstmt.setTimestamp(4, DBUtil.toSQLDate(project.getEndDate()));
    ...
    public boolean updateWorker(ProjectWorker projectWorker)
        ...
        try {
            ...
            pstmt.setTimestamp(1, DBUtil.toSQLDate(projectWorker.getStartDate()));
    ...
    public boolean removeWorker(int workerId, int projectId)
        throws PersistenceException {
        // call the actual implementation - no transaction is used here for one SQL statement
    ...
    public Project[] searchForProjects(Filter searchFilter)
        ...
        PreparedStatement pstmt = projectSearchUtility.prepareSearchStatement(searchFilter);
        ResultSet rs = null;
    ...
    public Client[] searchForClients(Filter searchFilter)
        ...
        PreparedStatement pstmt = clientSearchUtility.prepareSearchStatement(searchFilter);
        ResultSet rs = null;
        ...
        for (int i = 0; i < workers.length; i++) {
            try {
                ...
                if (!addWorkerImpl(workers[i])) {
                    throw new PersistenceException("Project worker already exists");
                }
        ...
        for (int i = 0; i < workerIds.length; i++) {
            try {
                ...
                if (!removeWorkerImpl(workerIds[i], projectId)) {
                    throw new PersistenceException("Project worker does not exist");
                }
        ...
        for (int i = 0; i < entryIds.length; i++) {
            try {
                ...
                if (!addExpenseEntryImpl(entryIds[i], projectId, user)) {
                    throw new PersistenceException("Expense entry already exists");
                }
        ...
        for (int i = 0; i < entryIds.length; i++) {
            try {
                ...
                if (!removeExpenseEntry(entryIds[i], projectId)) {
                    throw new PersistenceException("Expense entry does not exist");
                }
    ...
    private Project getProjectImpl(ResultSet rs) throws PersistenceException {
        try {
            ...
            project.setStartDate(DBUtil.toUtilDate(rs.getTimestamp(4)));
            project.setEndDate(DBUtil.toUtilDate(rs.getTimestamp(5)));
            project.setCreationDate(DBUtil.toUtilDate(rs.getTimestamp(6)));
            project.setCreationUser(rs.getString(7));
            project.setModificationDate(DBUtil.toUtilDate(rs.getTimestamp(8)));
            project.setModificationUser(rs.getString(9));

            int projectId = project.getId();

            // populate the project manager id of project
            project.setManagerId(getInteger(SQL_SEL_PROJECT_MANAGER_ID, projectId, 1));

            // populate the project workers ids of project
            project.setWorkersIds(new HashSet(getIntegers(SQL_SEL_PROJECT_WORKER_IDS, projectId, 1)));
     ...
     * @throws PersistenceException if something wrong happens while populating the fields
     */
    private ProjectWorker getWorkerImpl(ResultSet rs) throws PersistenceException {
        try {
    ...
    private Client getClientImpl(ResultSet rs) throws PersistenceException {
        try {
            ...
            client.setCreationDate(DBUtil.toUtilDate(rs.getTimestamp(3)));
            client.setCreationUser(rs.getString(4));
            client.setModificationDate(DBUtil.toUtilDate(rs.getTimestamp(5)));
     ...
     * @throws PersistenceException if something wrong happens while removing the project (such as SQL exception)
     */
    private boolean removeProjectImpl(int projectId) throws PersistenceException {
        try {
    ...
    private boolean addWorkerImpl(ProjectWorker projectWorker)
        ...
        try {
            ...
            pstmt.setTimestamp(3, DBUtil.toSQLDate(projectWorker.getStartDate()));
    ...
    /**
     * <p>
     * Initializes the database connection, project search utility and client search utility. If any error happens, the
     * connection is closed if it was opened.
     * </p>
     *
     * @param dbNamespace the namespace of the DB Connection Factory configuration file
     * @param connectionProducerName the connection producer name used to obtain the connection
     ...
     *         loading the configuration
     */
    private void init(String dbNamespace, String connectionProducerName, String projectSearchUtilityNamespace,
        String clientSearchUtilityNamespace) throws PersistenceException {
        try {
            // obtain the connection using the DB Connection Factory
            connection = new DBConnectionFactoryImpl(dbNamespace).createConnection(connectionProducerName);
        ...
        try {
            ...
            projectSearchUtility = new DatabaseSearchUtility(connection, projectSearchUtilityNamespace);
            clientSearchUtility = new DatabaseSearchUtility(connection, clientSearchUtilityNamespace);
        } catch (ConfigurationException e) {
            DBUtil.close(connection);
            throw new PersistenceException("Some error occurs in configuration file", e);
        }
    ...
    /**
     * <p>
     * Gets the prepared statement corresponding to the sql query from the cache. If not exists, the prepared statement
     * is lazily initialized and added to the cache.
     * </p>
     *
     * <p>
     * This method throws SQLException so that the caller can wrap this exception with specific message.
