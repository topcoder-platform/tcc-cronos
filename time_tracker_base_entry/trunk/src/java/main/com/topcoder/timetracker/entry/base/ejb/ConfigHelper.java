...
final class ConfigHelper {
    ...
    /**
     * Obtains the string property from given namespace. If the property is missing but required, or the
     * required value is trimmed empty string, ConfigurationException will be thrown.
     *
     ...
     *
     * @throws ConfigurationException if the property is invalid
     */
    static String getStringProperty(String namespace, String propertyName, boolean required)
        ...
        try {
            ...
            throw new ConfigurationException("namespace:" + namespace + " is not found", e);
        }

        if (value != null) {
            //property value should not be empty string
            if (value.trim().length() == 0) {
                throw new ConfigurationException("property:" + propertyName + " is empty string");
            }
        } else if (required) {
            //property is missing
            throw new ConfigurationException("property:" + propertyName + " is required but missing");
        }
