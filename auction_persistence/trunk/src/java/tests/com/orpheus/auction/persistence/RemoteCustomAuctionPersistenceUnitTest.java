...
/**
 * <p>
 * Tests functionality and error cases of <code>RemoteCustomAuctionPersistence</code> class.
 * </p>
 *
 * @author TCSDEVELOPER
 * @version 1.0
 */
public class RemoteCustomAuctionPersistenceUnitTest extends CustomAuctionPersistenceTestCase {
    /** Represents the valid namespace for testing. */
    private static final String NAME_SPACE = "com.orpheus.auction.persistence.RemoteCustomAuctionPersistence";

    /** Represents the <code>RemoteCustomAuctionPersistence</code> instance used for testing. */
    private RemoteCustomAuctionPersistence persistence;
     ...
     */
    public RemoteCustomAuctionPersistenceUnitTest(String testName) {
        super(testName);
    }
    ...
    protected void setUp() throws Exception {
        super.setUp();
        persistence = (RemoteCustomAuctionPersistence) getPersistence();
    }

    /**
     * Accuracy test for the constructor <code>RemoteCustomAuctionPersistence(String)</code> when the namespace is
     * correct. Everything should be successfully initialized.
     *
     * @throws Exception pass any unexpected exception to JUnit.
     */
    public void testRemoteCustomAuctionPersistence_Accuracy() throws Exception {
        assertNotNull("The RemoteCustomAuctionPersistence instance should be created.", persistence);
    ...
    /**
     * Creates an instance of <code>RemoteCustomAuctionPersistence</code>.
     *
     * @return an instance of <code>RemoteCustomAuctionPersistence</code>.
     *
     * @throws Exception pass any unexpected exception to JUnit.
     */
    protected CustomAuctionPersistence createPersistence() throws Exception {
        return new RemoteCustomAuctionPersistence(NAME_SPACE);
    }
}
