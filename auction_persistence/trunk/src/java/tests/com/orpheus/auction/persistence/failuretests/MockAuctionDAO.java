...
/**
 * <p>
 * Mock implementation of <code>AuctionDAO</code> interface, only for testing purpose.
 * </p>
 * @author FireIce
 * @version 1.0
 */
public class MockAuctionDAO implements AuctionDAO {
     ...
     *             If the passed auction does not contain an ID, or hosting_block does not have such an Id, or the
     *             bidderId of any bidder does not exist.
     ...
     * @throws EntryNotFoundException
     *             If there is not yet any persistent representation of the specified auction in the persistent store,
     *             or if a passed bid in the persistence store has an auctionId that is not the passed auctionID.
     * @throws InvalidEntryException
     *             If the passed auction does not contain an ID, or the bidderId of any bidder does not exist.
     * @throws PersistenceException
     *             If there is any problem in the persistence layer.
     */
     ...
     *             persistent store.
     * @throws InvalidEntryException
     *             If a passed bid in the persistence store has an auctionId that is not the passed auctionID, or the
     *             bidderId of any bidder does not exist.
     * @throws PersistenceException
     *             If there is any problem in the persistence layer.
     */
     ...
     * parameter. Returns empty array if no auctions found.
     * </p>
     * <p>
