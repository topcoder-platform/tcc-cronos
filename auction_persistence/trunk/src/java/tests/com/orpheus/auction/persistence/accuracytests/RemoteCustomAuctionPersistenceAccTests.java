...
/**
 * Accuracy test case for class RemoteCustomAuctionPersistence.
 * @author waits
 * @version 1.0
 */
public class RemoteCustomAuctionPersistenceAccTests extends TestCase {
    ...
    /** RemoteCustomAuctionPersistence instnace to test against. */
    private RemoteCustomAuctionPersistence persistence = null;
    ...
    protected void setUp() throws Exception {
        ...
        SessionBeanDescriptor sampleServiceDescriptor = new SessionBeanDescriptor("auction/AuctionEJB",
                AuctionRemoteHome.class, AuctionRemote.class, new AuctionBean());
        ...
        //create instance
        this.persistence = new RemoteCustomAuctionPersistence(TestHelper.REMOTE_NAMESPACE);
    }
