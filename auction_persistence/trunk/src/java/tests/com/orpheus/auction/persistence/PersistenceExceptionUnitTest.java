...
public class PersistenceExceptionUnitTest extends TestCase {
     ...
     *
     * <p>
     * Verifies PersistenceException subclasses AuctionPersistenceException.
     * </p>
     */
    public void testPersistenceExceptionInheritance1() {
        assertTrue("PersistenceException does not subclass AuctionPersistenceException.",
            new PersistenceException(ERROR_MESSAGE) instanceof AuctionPersistenceException);
    }
    ...
    public void testPersistenceExceptionInheritance2() {
        assertTrue("PersistenceException does not subclass AuctionPersistenceException.",
            new PersistenceException(ERROR_MESSAGE, new Exception()) instanceof AuctionPersistenceException);
    }
}
