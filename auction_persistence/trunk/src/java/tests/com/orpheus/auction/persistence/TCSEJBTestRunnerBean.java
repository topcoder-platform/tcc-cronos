...
/**
 * A substitute EJBTestRunner implementation that passes a session context to test cases if they support it.
 *
...
public class TCSEJBTestRunnerBean implements SessionBean {
    /** The SessionContext on which the EJBTestRunner is run. */
     ...
     *
     * @throws RemoteTestException If any throwable is thrown during  execution of the method, it is wrapped with a
     *         RemoteTestException and  rethrown.
     */
    ...
    /**
     * Gets a instance of the test class with the specified class name and initialized to execute the specified method.
     *
     * @param className the name of the test class
     * @param methodName the name of the test method
     *
     * @return a new instance of the test class with the specified class name and initialized to execute the specified
     *         method.
     */
    private EJBTestCase getTestInstance(String className, String methodName) {
        ...
        try {
            constructor = testClass.getConstructor(new Class[] {String.class, SessionContext.class});
            testCase = (EJBTestCase) constructor.newInstance(new Object[] {methodName, ctx});
        } catch (NoSuchMethodException nsme) {
            try {
                constructor = testClass.getConstructor(new Class[] {String.class});
                testCase = (EJBTestCase) constructor.newInstance(new Object[] {methodName});
            } catch (Exception e) {
                e.printStackTrace();
    ...
    /**
     * <p>
     * A part of <code>javax.ejb.SessionBean</code> interface. Current implementation does nothing.
     * </p>
     */
     ...
     * </p>
     *
     * @param ctx the session context of ejb.
     */
