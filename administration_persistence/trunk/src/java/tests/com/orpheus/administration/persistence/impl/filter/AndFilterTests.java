...
/**
 * Unit tests for the <code>AndFilter</code> class.
 *
 * @author TCSDEVELOPER
 * @version 1.0
 */

public class AndFilterTests extends AbstractAssociativeFilterTestCase {
    /**
    ...
    public void test_ctor2_null_augend() {
        try {
            new AndFilter(null, new EqualToFilter("test", "test"));
    ...
    public void test_ctor2_null_addend() {
        try {
            new AndFilter(new EqualToFilter("test", "test"), null);
            fail("should have thrown IllegalArgumentException");
        } catch (IllegalArgumentException ex) {
            // pass
        }
    ...
    public void test_ctor2() {
        ...
        List filters = new AndFilter(filter1, filter2).getFilters();
    ...
    public void test_ctor1() {
        ...
        assertEquals("getFilters() should return the filters passed to ctor1()",
                     new HashSet(filters), new HashSet(new AndFilter(filters).getFilters()));
    }
}
