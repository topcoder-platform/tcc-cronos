...
public class TranslationExceptionTests extends TestCase {
    /**
     * Tests that <code>TranslationException</code> inherits from <code>AdministrationException</code>.
     */
    public void test_inheritance() {
        assertTrue("TranslationExceptionTests should inherit from AdministrationException",
                   AdministrationException.class.isAssignableFrom(TranslationException.class));
    }
    ...
    public void test_ctor1_message() {
        ...
        assertEquals("getMessage() should return the message passed to the constructor",
                     message, new TranslationException(message).getMessage());
    }
    ...
    public void test_ctor2_message() {
        ...
        assertTrue("getMessage() should contain the message passed to the constructor",
                   new TranslationException(message, new RuntimeException()).
    ...
    public void test_ctor2_cause() {
        ...
        assertEquals("getCause() should return the cause passed to the constructor", cause,
                     new TranslationException("hi", cause).getCause());
    }
}
