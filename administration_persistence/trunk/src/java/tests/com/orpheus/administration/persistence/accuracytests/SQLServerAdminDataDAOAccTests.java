...
/**
 * <p>Accuracy test cases for class SQLServerAdminDataDAO.</p>
 * @author waits
 * @version 1.0
 */
public class SQLServerAdminDataDAOAccTests extends TestCase {
    /** Represents the connection instance for testing. */
    private Connection connection = null;

    /** SQLServerAdminDataDAO instance to test against. */
    private SQLServerAdminDataDAO dao = null;
    ...
    protected void setUp() throws Exception {
        ...
        //create instance
        dao = new SQLServerAdminDataDAO(TestHelper.ADMIN_DATA_DAO_NAMESPACE);
    }
    ...
    public void testStorePuzzle() throws Exception {
        ...
        //store the puzzle
        long[] puzzleIds = dao.storePuzzles(toStore);
    ...
    public void testSetDomainApproval() throws Exception {
        ...
        dao.setDomainApproval(domainId, true);
    ...
    public void testSetImageApproval() throws Exception {
        ...
        dao.setImageApproval(imageId, true);
    ...
    public void testApproveWinner() throws Exception {
        ...
        dao.approveWinner(winner, new Date(4000));
    ...
    public void testGetAdminSummary() throws Exception {
        ...
        AdminSummary adminSummary = dao.getAdminSummary();
