...
/**
 * <p>Extension of <code>AbstractAssociativeFilter</code> to support <i>OR</i> relationships. This class is
...
public class OrFilter extends AbstractAssociativeFilter {
    /**
     * Creates a new <code>OrFilter</code> joining the two specified filters.
     *
     * @param first the first filter in the association
     * @param second the second filter in the associatoin
    ...
    /**
     * Creates a new <code>OrFilter</code> joining the specified list of filters. The list is copied by the
