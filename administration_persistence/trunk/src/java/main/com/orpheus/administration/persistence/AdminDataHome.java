...
/**
 * <p>This is the remote home interface for managing administration data. The remote client will obtain it to get
...
public interface AdminDataHome extends EJBHome {
    /**
     ...
     */
    public AdminData create() throws CreateException, RemoteException;
}
