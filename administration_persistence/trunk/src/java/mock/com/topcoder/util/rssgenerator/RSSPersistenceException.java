...
/**
 * Purpose: This exception is thrown when an error occurs during the persistence of RSS feeds or items by the data store. <p>Implementation: It extends the RSSException to allow for an eror message and inner exception wrapping. It defines constructors with signatures similar to those of its super class.</p> <p>Thread Safety: This class is thread safe as it has no state and its super class is also thread safe.</p>
 * 
 */
