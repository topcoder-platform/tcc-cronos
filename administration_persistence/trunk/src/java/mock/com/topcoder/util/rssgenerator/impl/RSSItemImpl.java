...
/**
 * Purpose: This class implements the RSSItem interface by decorating over an RSSObject instance. <p>Implementation: It extends the RSSBaseItemImpl class and hence has to implement only the two methods defined in the RSSItem interface. Both of them are implemented by decorating over a &quot;sourceId&quot; child element. Refer to CS 1.3.1 to see how the decoration is done.</p> <p>Thread Safety: This class is not thread safe despite having no members, as its base class is not thread safe.</p>
 * 
 */
...
/**
 * <p>Purpose: This method returns the ID of the source feed of this item.</p> <p>Args: None.</p> <p>Implementation: Refer to CS 1.3.1. Decorate over &quot;element:sourceId&quot;.</p> <p>Returns: The ID of the source feed of this item.</p> <p>Exceptions: None.</p>
 * 
 * 
 * @return 
 */
...
/**
 * <p>Purpose: This method sets the ID of the source feed of this item.</p> <p>Args: id - The source ID of this item. Possibly null indicating no source ID or empty.</p> <p>Implementation: Refer to CS 1.3.1. Decorate over &quot;element:sourceId&quot;.</p> <p>Returns: None.</p> <p>Exceptions: None.</p>
 * 
 * 
 * @param id 
 */
