...
/**
 * Purpose: This exceptions is thrown by all methods of the RSSParser contract if any error occurs during the parsing. <p>Implementation: It extends RSSException, which is the geeneric exception of the component. It adds constructors for easy construction of the exception on the lines of its super class.</p> <p>Thread Safety: This class is thread safe as it has no state and its super class is thread safe.</p>
 * 
 */
