...
/**
 * Purpose: Extends the RSSFeedImpl class to add properties specific to Atom 1.0 <p>Implementation: We decorate over some more properties to provide objects specific to this format. We extend RSSFeedImpl</p> <p>Thread Safety: This class is not thread safe as its base class is not thread safe either.</p>
 * 
 */
...
/**
 * <p>Purpose: Gets the contributors of the feed.</p> <p>Args: None.</p> <p>Implementation: Refer to CS 1.3.1. Decorate over &quot;element:contributor&quot;</p> <p>Returns: The contributors of this feed.</p> <p>Exceptions: IllegalStateException - If the underlying object is null.</p>
 * 
 * 
 * @return 
 */
...
/**
 * <p>Purpose: Gets the subtitle of the feed.</p> <p>Args: None.</p> <p>Implementation: Refer to CS 1.3.1. Decorate over &quot;element:subtitle&quot;</p> <p>Returns: The subtitle of this feed.</p> <p>Exceptions: IllegalStateException - If the underlying object is null.</p>
 * 
 * 
 * @return 
 */
...
/**
 * <p>Purpose: removes from the contributors of the feed.</p> <p>Args: contributors - The contributor to remove. Must not be null.</p> <p>Implementation: Refer to CS 1.3.1. Decorate over &quot;element:contributor&quot;</p> <p>Returns: None.</p> <p>Exceptions: IllegalStateException - If the underlying object is null.</p> <p>IllegalArgumentException - If contributor is null.</p>
 * 
 * 
 * @param contributor 
 */
...
/**
 * <p>Purpose: Clears the contributors of the feed.</p> <p>Args: None.</p> <p>Implementation: Refer to CS 1.3.1. Decorate over &quot;element:contributor&quot;</p> <p>Returns: None.</p> <p>Exceptions: IllegalStateException - If the underlying object is null.</p>
 * 
 */
...
/**
 * <p>Purpose: Sets the subtitle of the feed.</p> <p>Args: subtitle - The subtitle to set. Possibly null or empty.</p> <p>Implementation: Refer to CS 1.3.1. Decorate over &quot;element:subtitle&quot;</p> <p>Returns: None.</p> <p>Exceptions: IllegalStateException - If the underlying object is null.</p>
 * 
 * 
 * @param subtitle 
 */
