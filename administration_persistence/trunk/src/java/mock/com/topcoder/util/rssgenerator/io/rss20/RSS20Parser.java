...
/**
 * Purpose: This class parses streams in the RSS 2.0 format. It implements the RSSParser contract and assumes the stream to be character data in the XML format. <p>Implementation: The two methods of the contract are implemented using parsing algorithms tailored to the RSS 2.0 format. We use the Lightweight XML Parser component to parse XML data.</p> <p>Thread Safety: This class is thread safe as it has no state.</p>
 * 
 */
public class RSS20Parser implements com.topcoder.util.rssgenerator.io.RSSParser {
...
/**
 * <p>Purpose: This method parses the given character stream into an RSSItem object and returns it.</p> <p>Args: source - The character stream containing the RSS item data. Must not be null.</p> <p>Implementation: Please refer to the CS 1.3.3</p> <p>Returns: An RSSItem object, created by parsing the given stream.</p> <p>Exceptions: RSSParseException - If any exception occurs during the parsing.</p> <p>IllegalArgumentException - If source is null.</p>
 * 
 * 
 * @param source 
 * @return 
