...
/**
 * Purpose: This class writes out streams in the Atom 1.0 format. It implements the RSSWriter contract and writes character data in the XML format. <p>Implementation: The two methods of the contract are implemented using writing algorithms tailored to the Atom 1.0 format.</p> <p>Thread Safety: This class is thread safe as it has no state.</p>
 * 
 */
...
/**
 * <p>Purpose: Writes the given item into the given character stream.</p> <p>Args: item - The item to be written. Must not be null.</p> <p>destination - The character stream to which the item must be written. Must not be null.</p> <p>Implementation: Please refer to the CS 1.3.9</p> <p>Returns: None.</p> <p>Exceptions: RSSWriteException - If any exception occurs during the writing of the item.</p> <p>IllegalArgumentException - If either item or destination is null.</p>
 * 
 * 
 * @param item 
 * @param destination 
