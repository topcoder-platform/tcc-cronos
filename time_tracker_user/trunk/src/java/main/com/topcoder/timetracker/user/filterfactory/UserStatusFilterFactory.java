 ...
 * UserStatuses. It offers a convenient way of specifying search criteria to use. The factory is capable of
 * producing filters that conform to a specific schema, and is associated with the UserStatusManager that supports
 * the given schema.
 * </p>
 * <p>
 * The filters that are produced by this factory should only be used by the UserStatusManager or UserStatusDAO
 * implementation that produced this UserStatusFilterFactory instance. This ensures that the Filters can be
 ...
 * @since 3.2.1
 */
public class UserStatusFilterFactory {
     ...
     * </p>
     */
    private UserStatusFilterFactory() {
        // nothing to do
    }

    /**
     * <p>
     * Creates a Filter that will select UserStatuses based on the UserStatus's companyId.
     * </p>
     *
     * @param companyId
    ...
    /**
     * <p>
     * Creates a Filter that will select UserStatuses based on the UserStatus's description.
     * </p>
     *
     * @param description
     *            Full description to filter user statuses by.
     * @return A filter that will be based off the specified criteria.
     * @throws IllegalArgumentException
    ...
    /**
     * <p>
     * Creates a Filter that will select UserStatuses based on the UserStatus's active flag.
     * </p>
     *
     * @param active
     *            A boolean value that specifies whether only active or inactive user statuses should be filtered.
     * @return A filter that will be based off the specified criteria.
     */
