...
/**
 * <p>
 * This is an implementation of the <code>UserFilterFactory</code> that may be used for building
 * searches.
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The filters that are produced by this factory should only be used by the <code>UserManager</code>
 * or <code>UserDAO</code> implementation that produced this <code>UserFilterFactory</code> instance.
 * </p>
 *
 * <p>
...
public class MappedUserFilterFactory extends MappedBaseFilterFactory implements UserFilterFactory {
     ...
     *
     * @throws IllegalArgumentException if columnNames contains null or empty
     * String keys or values, or if it is missing a Map Entry for the static
    ...
    public MappedUserFilterFactory(Map columnNames) {
        ...
        Util.checkMapForKeys(columnNames, new String[] {USERNAME_COLUMN_NAME, PASSWORD_COLUMN_NAME,
            ...
            ADDRESS1_COLUMN_NAME, ADDRESS2_COLUMN_NAME, CITY_COLUMN_NAME, STATE_COLUMN_NAME, ZIPCODE_COLUMN_NAME,
            COMPANY_ID_COLUMN_NAME, STATUS_COLUMN_NAME});
    }
    ...
    public Filter createPhoneNumberFilter(StringMatchType matchType, String phoneNumber) {
        ...
        return Util.createFilter(matchType, (String) getColumnNames().get(PHONE_NUMBER_COLUMN_NAME), phoneNumber);
    }
    ...
    public Filter createAddressFilter(StringMatchType matchType, String address) {
        ...
        return new OrFilter(Util.createFilter(matchType, (String) columnsMap.get(ADDRESS1_COLUMN_NAME), address),
            Util.createFilter(matchType, (String) columnsMap.get(ADDRESS2_COLUMN_NAME), address));
    }
    ...
    /**
     * <p>
     * This creates a Filter that will select User based on the id of the Time Tracker Company that
