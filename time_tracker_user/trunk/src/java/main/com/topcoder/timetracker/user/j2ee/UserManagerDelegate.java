...
public class UserManagerDelegate implements UserManager {
     ...
     * </p>
     * <p>
     * The <b>contextName</b> property is used to retrieve the <code>Context</code> from JNDI while the
     * <b>localHomeName</b> property is used to look up the local interface for <code>UserManager</code>
     * business services.
     * </p>
     *
     * @param namespace
    ...
    public UserManagerDelegate(String namespace) throws ConfigurationException {
        local =
            (UserManagerLocal) Util.createLocalObject(namespace, UserManagerLocalHome.class,
     ...
     *
     * <p>
     * Note, <code>com.topcoder.timetracker.user.UnrecognizedEntityException</code> will be thrown as an cause of
     * <code>com.topcoder.timetracker.user.BatchOperationException</code> if a user with the provided id was not
