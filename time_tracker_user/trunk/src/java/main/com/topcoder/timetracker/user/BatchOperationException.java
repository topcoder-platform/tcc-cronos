 ...
 *
 * <p>
 * It will contain an array of causes: each element that managed to be processed successfully will have a null for
 * the corresponding element in the causes array, and each element that failed to be processed would have an
 * Exception detailing the reason for failure in the causes array.
 * </p>
 *
 * <p>
...
public class BatchOperationException extends DataAccessException {
     ...
     * @param causes
     *            An array of causes for the exception.
     */
