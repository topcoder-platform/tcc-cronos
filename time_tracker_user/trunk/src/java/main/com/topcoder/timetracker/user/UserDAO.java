 ...
 * and searching of Time Tracker User data from a persistent store.
 * </p>
 *
 * <p>
...
public interface UserDAO {
     ...
     * </p>
     *
     * @param user An array of users for which the operation should be performed.
     * @param audit Indicates whether an audit should be performed.
     *
     * @throws IllegalArgumentException if users is null, empty or contains null values, or some
     * user contains null property which is required in the persistence
     ...
     * @throws BatchOperationException if a problem occurs during the batch operation.
     */
    public void updateUsers(User[] user, boolean audit) throws DataAccessException, BatchOperationException;
     ...
     * </p>
     *
     * @param userId An array of userIds for which the operation should be performed.
     * @param audit Indicates whether an audit should be performed.
     *
     ...
     * @throws BatchOperationException if a problem occurs during the batch operation.
     */
    public void removeUsers(long[] userId, boolean audit) throws DataAccessException, BatchOperationException;
