...
/**
 * Unit test for <code>UserTypeManagerSessionBean</code>.
 *
 * @author enefem21
 * @version 3.2.1
 * @since 3.2.1
 */
public class UserTypeManagerSessionBeanTest extends TestCase {

    /** Unit under test. */
    private UserTypeManagerSessionBean userTypeManagerSessionBean;
    ...
    public static Test suite() {
        return new TestSuite(UserTypeManagerSessionBeanTest.class);
    }
    ...
    protected void setUp() throws Exception {
        ...
        UserTypeManagerLocalHome home = (UserTypeManagerLocalHome) context.lookup("UserTypeManagerLocalHome");

        UserTypeManagerLocal service = home.create();

        userTypeManagerSessionBean = (UserTypeManagerSessionBean) ((EjbBeanAccess) service).getBean();
    }
     ...
     */
    public void testUserTypeManagerSessionBeanAccuracy() {
        assertNotNull("The object is not created properly", new UserTypeManagerSessionBean());
    }
    ...
    public void testCreateUserTypeAccuracy() throws Exception {
        ...
        userTypeManagerSessionBean.createUserType(userType);

        userType = userTypeManagerSessionBean.getUserType(userType.getId());
    ...
    public void testCreateUserTypeNull() throws Exception {
        try {
            userTypeManagerSessionBean.createUserType(null);
    ...
    /**
     * Test <code>createUserType</code> for failure. Condition: configuration is not ready. Expect:
     * <code>DataAccessException</code>.
     *
     * @throws Exception
     *             to JUnit
     */
    public void testCreateUserTypeConfigError() throws Exception {
    ...
    public void testUpdateUserTypeAccuracy() throws Exception {
        ...
        userTypeManagerSessionBean.updateUserType(userType);
    ...
    public void testUpdateUserTypeNull() throws Exception {
        try {
            userTypeManagerSessionBean.updateUserType(null);
            fail("Should throw IllegalArgumentException");
        } catch (IllegalArgumentException e) {
            // expected
        }
    ...
    public void testRemoveUserTypeAccuracy() throws Exception {
        ...
        userTypeManagerSessionBean.removeUserType(userType.getId());

        UserType[] userTypes = userTypeManagerSessionBean.getAllUserTypes();
    ...
    public void testRemoveUserTypeNegative() throws Exception {
        try {
            userTypeManagerSessionBean.removeUserType(-5);
            fail("Should throw IllegalArgumentException");
        } catch (IllegalArgumentException e) {
            // expected
        }
    ...
    public void testGetUserTypeNegative() throws Exception {
        try {
            userTypeManagerSessionBean.getUserType(-5);
            fail("Should throw IllegalArgumentException");
        } catch (IllegalArgumentException e) {
            // expected
        }
    ...
    public void testAddUserTypesAccuracy() throws Exception {
        ...
        userType.setCreationDate(new Date());
        userType.setModificationDate(new Date());
        userTypeManagerSessionBean.addUserTypes(new UserType[] {userType});

        UserType[] userTypes = userTypeManagerSessionBean.getUserTypes(new long[] {userType.getId()});
    ...
    public void testAddUserTypesNull() throws Exception {
        try {
            userTypeManagerSessionBean.addUserTypes(null);
            fail("Should throw IllegalArgumentException");
        } catch (IllegalArgumentException e) {
            // expected
        }
    ...
    public void testAddUserTypesEmpty() throws Exception {
        try {
            userTypeManagerSessionBean.addUserTypes(new UserType[0]);
            fail("Should throw IllegalArgumentException");
        } catch (IllegalArgumentException e) {
            // expected
        }
    ...
    public void testUpdateUserTypesAccuracy() throws Exception {
        ...
        userTypeManagerSessionBean.updateUserTypes(new UserType[] {userType});
    ...
    public void testUpdateUserTypesNull() throws Exception {
        ...
        try {
            userTypeManagerSessionBean.updateUserTypes(null);
            fail("Should throw IllegalArgumentException");
        } catch (IllegalArgumentException e) {
            // expected
        }
    ...
    public void testUpdateUserTypesEmpty() throws Exception {
        ...
        try {
            userTypeManagerSessionBean.updateUserTypes(new UserType[0]);
            fail("Should throw IllegalArgumentException");
        } catch (IllegalArgumentException e) {
            // expected
        }
    ...
    public void testRemoveUserTypesAccuracy() throws Exception {
        ...
        userTypeManagerSessionBean.removeUserTypes(new long[] {userType.getId()});
        UserType[] userTypes = userTypeManagerSessionBean.getAllUserTypes();
    ...
    public void testRemoveUserTypesNull() throws Exception {
        try {
            userTypeManagerSessionBean.removeUserTypes(null);
            fail("Should throw IllegalArgumentException");
        } catch (IllegalArgumentException e) {
            // expected
        }
    ...
    public void testRemoveUserTypesEmpty() throws Exception {
        try {
            userTypeManagerSessionBean.removeUserTypes(new long[0]);
            fail("Should throw IllegalArgumentException");
        } catch (IllegalArgumentException e) {
            // expected
        }
    ...
    public void testRemoveUserTypesNegativeId() throws Exception {
        try {
            userTypeManagerSessionBean.removeUserTypes(new long[] {-1});
            fail("Should throw IllegalArgumentException");
        } catch (IllegalArgumentException e) {
            // expected
        }
    ...
    public void testRemoveUserTypesUnrecognized() throws Exception {
        ...
        try {
            userTypeManagerSessionBean.removeUserTypes(new long[] {10});
            fail("Should throw BatchOperationException");
        } catch (BatchOperationException e) {
            if (!(e.getCauses()[0] instanceof UnrecognizedEntityException)) {
                fail("The error should be UnrecognizedEntityException");
    ...
    public void testGetUserTypesNull() throws Exception {
        try {
            userTypeManagerSessionBean.getUserTypes(null);
            fail("Should throw IllegalArgumentException");
        } catch (IllegalArgumentException e) {
            // expected
        }
    ...
    public void testGetUserTypesEmpty() throws Exception {
        try {
            userTypeManagerSessionBean.getUserTypes(new long[0]);
            fail("Should throw IllegalArgumentException");
        } catch (IllegalArgumentException e) {
            // expected
        }
    ...
    public void testGetUserTypesUnrecognizedEntity() throws Exception {
        try {
            userTypeManagerSessionBean.getUserTypes(new long[] {10});
            fail("Should throw BatchOperationException");
        } catch (BatchOperationException e) {
            if (!(e.getCauses()[0] instanceof UnrecognizedEntityException)) {
                fail("The error should be UnrecognizedEntityException");
    ...
    public void testSearchUserTypesAccuracy1() throws Exception {
        UserType[] userTypes =
            userTypeManagerSessionBean.searchUserTypes(UserTypeFilterFactory.createCompanyIdFilter(10));
    ...
    public void testSearchUserTypesNull() throws Exception {
        try {
            userTypeManagerSessionBean.searchUserTypes(null);
            fail("Should throw IllegalArgumentException");
        } catch (IllegalArgumentException e) {
            // expected
        }
    ...
    public void testSearchUserTypesWrongFilter() throws Exception {
        try {
            userTypeManagerSessionBean.searchUserTypes(new EqualToFilter("no_column", "value"));
            fail("Should throw DataAccessException");
        } catch (DataAccessException e) {
            // expected
        }
    ...
    public void testEjbCreateAccuracy() {
        userTypeManagerSessionBean.ejbCreate();
    ...
    public void testEjbActivateAccuracy() {
        userTypeManagerSessionBean.ejbActivate();
    ...
    public void testEjbPassivateAccuracy() {
        userTypeManagerSessionBean.ejbPassivate();
    ...
    public void testEjbRemoveAccuracy() {
        userTypeManagerSessionBean.ejbRemove();
    ...
    public void testSetSessionContextAccuracy() {
        userTypeManagerSessionBean.setSessionContext(null);

        assertNull("Failed to set the session context.", userTypeManagerSessionBean.getSessionContext());
    }
    ...
    public void testGetSessionContextAccuracy() {
        assertNotNull("Failed to get the session context.", userTypeManagerSessionBean.getSessionContext());
    }
