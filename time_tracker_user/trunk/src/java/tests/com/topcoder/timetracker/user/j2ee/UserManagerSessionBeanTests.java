...
/**
 * <p>
 * Unit test cases for UserManagerDelegate and UserManagerSessionBean.
 * </p>
 *
 * <p>
 * In this test case, MockEJB is used to deploy the UserManagerSessionBean and
 * UserManagerDelegate is used to visit the UserManagerSessionBean.
 * </p>
 *
 * @author TCSDEVELOPER
 * @version 3.2
...
public class UserManagerSessionBeanTests extends TestCase {
    ...
    protected void setUp() throws Exception {
        ...
        SessionBeanDescriptor sampleServiceDescriptor = new SessionBeanDescriptor("UserManagerLocalHome",
            UserManagerLocalHome.class, UserManagerLocal.class, bean);
    ...
    public void testSearchUsers() throws Exception {
        Filter userNameFilter = delegate.getUserFilterFactory().createUsernameFilter(StringMatchType.EXACT_MATCH,
            "admin");
    ...
    public void testAuthenticateUser() throws Exception {
        ...
        assertFalse("Should fail authentication because of unknown user name.", delegate.authenticateUser("new_comer",
            "tc_super"));
        assertFalse("Should fail authentication because of unknown user name.", delegate.authenticateUser("admin",
            "try_it_out"));
    }
    ...
    public void testGetUserFilterFactory_DataAccessException() throws Exception {
        ...
        assertNull("Expects null when fails to get user manager implementation.", delegate.getUserFilterFactory());
    }
