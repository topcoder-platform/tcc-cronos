...
/**
 * Unit test for <code>UserTypeFilterFactory</code>.
 *
 * @author enefem21
 * @version 3.2.1
 * @since 3.2.1
 */
public class UserTypeFilterFactoryTest extends TestCase {
    ...
    public static Test suite() {
        return new TestSuite(UserTypeFilterFactoryTest.class);
    }
    ...
    public void testCreateCompanyIdFilterAccuracy() {
        EqualToFilter filter = (EqualToFilter) UserTypeFilterFactory.createDescriptionFilter("description");
    ...
    public void testCreateCompanyIdFilterNegative() {
        try {
            UserTypeFilterFactory.createCompanyIdFilter(-3);
    ...
    public void testCreateDescriptionFilterAccuracy() {
        EqualToFilter descriptionFilter =
            (EqualToFilter) UserTypeFilterFactory.createDescriptionFilter("testDescription");
    ...
    public void testCreateActiveFilterAccuracy() {
        EqualToFilter activeFilter = (EqualToFilter) UserTypeFilterFactory.createActiveFilter(true);
    ...
    public void testCreateCreationDateFilterAccuracy1() {
        ...
        BetweenFilter filter =
            (BetweenFilter) UserTypeFilterFactory.createCreationDateFilter(instance1.getTime(), instance2
                .getTime());
    ...
    public void testCreateCreationDateFilterAccuracy2() {
        ...
        GreaterThanOrEqualToFilter filter =
            (GreaterThanOrEqualToFilter) UserTypeFilterFactory.createCreationDateFilter(instance1.getTime(),
                null);
    ...
    public void testCreateCreationDateFilterAccuracy3() {
        ...
        LessThanOrEqualToFilter filter =
            (LessThanOrEqualToFilter) UserTypeFilterFactory.createCreationDateFilter(null, instance1
                .getTime());
    ...
    public void testCreateModificationDateFilterAccuracy1() {
        ...
        BetweenFilter filter =
            (BetweenFilter) UserTypeFilterFactory.createModificationDateFilter(instance1.getTime(), instance2
                .getTime());
    ...
    public void testCreateModificationDateFilterAccuracy2() {
        ...
        GreaterThanOrEqualToFilter filter =
            (GreaterThanOrEqualToFilter) UserTypeFilterFactory.createModificationDateFilter(instance1
                .getTime(), null);
    ...
    public void testCreateModificationDateFilterAccuracy3() {
        ...
        LessThanOrEqualToFilter filter =
            (LessThanOrEqualToFilter) UserTypeFilterFactory.createModificationDateFilter(null, instance1
                .getTime());
    ...
    public void testCreateCreationUserFilterAccuracy() {
        EqualToFilter creationUserFilter =
            (EqualToFilter) UserTypeFilterFactory.createCreationUserFilter("testCreationUser");
    ...
    public void testCreateModificationUserFilterAccuracy() {
        EqualToFilter modificationUserFilter =
            (EqualToFilter) UserTypeFilterFactory.createModificationUserFilter("testModificationUser");
