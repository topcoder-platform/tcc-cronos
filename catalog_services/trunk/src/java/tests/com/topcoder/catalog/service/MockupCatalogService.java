...
/**
 * <p>This class emulates behavior of the <code>CatalogService</code> component inside an EJB container.</p>
 *
 * @author Retunsky
 * @version 1.0
 */
public class MockupCatalogService implements CatalogService, Serializable {
    /**
     * <p>Instance of catalog service to delegate calls to.</p>
     */
    private final CatalogService catalogService;

    /**
     * <p>Creates mockup by given <code>CatalogServiceImpl</code> delegate.</p>
     * <p>Injects entityManager to it.</p>
