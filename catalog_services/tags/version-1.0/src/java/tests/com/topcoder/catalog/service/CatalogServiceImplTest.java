...
/**
 * <p>This class tests <code>CatalogServiceImpl</code> class.</p>
 *
 * @author Retunsky
 * @version 1.0
 */
public class CatalogServiceImplTest extends CatalogServiceImplBaseTst {
    /**
     * <p>Tests <tt>getPhases</tt> method.</p>
     *
    ...
    /**
     * <p>Tests <tt>getActiveTechnologies</tt> method.</p>
     *
     * @throws Exception to jUnit
     */
    ...
    /**
     * <p>Tests <tt>getActiveCategories</tt> method.</p>
     *
     * @throws Exception to jUnit
     */
    ...
    /**
     * <p>Tests <tt>getAssetById</tt> method with the current version.</p>
     *
     * @throws Exception to jUnit
     */
    ...
    /**
     * <p>Tests <tt>getAssetById</tt> method with the latest version.</p>
     *
     * @throws Exception to jUnit
     */
    ...
    /**
     * <p>Tests <tt>getAssetByVersionId</tt> method.</p>
     *
     * @throws Exception to jUnit
     */
    ...
    /**
     * <p>Tests <tt>createAsset</tt> method.</p>
     *
     * @throws Exception to jUnit
     */
    public void testCreateAsset() throws Exception {
        ...
        final Component entity = (Component) getEntityManager().createQuery("from Component").getSingleResult();
        ...
        assertEquals("Invalid detailed description populated",
            newAsset.getDetailedDescription(), entity.getDescription());
        assertEquals("Invalid functional description populated",
            newAsset.getFunctionalDescription(), entity.getFunctionalDesc());
        assertEquals("Invalid root category",
            newAsset.getRootCategory().getId(), entity.getRootCategory().getId());
    ...
    /**
     * <p>Tests <tt>createAsset</tt> method with clients.</p>
     *
     * @throws Exception to jUnit
     */
    ...
    /**
     * <p>Tests <tt>createAsset</tt> method with empty clients list.</p>
     *
     * @throws Exception to jUnit
     */
    ...
    /**
     * <p>Tests <tt>createAsset</tt> method with users.</p>
     *
     * @throws Exception to jUnit
     */
    ...
    /**
     * <p>Tests <tt>createAsset</tt> method with empty users list.</p>
     *
     * @throws Exception to jUnit
     */
    ...
    /**
     * <p>Tests <tt>createAsset</tt> method with forum.</p>
     *
     * @throws Exception to jUnit
     */
    ...
    /**
     * <p>Tests <tt>createAsset</tt> method with link.</p>
     *
     * @throws Exception to jUnit
     */
    ...
    /**
     * <p>Tests <tt>createVersion</tt> method.</p>
     *
     * @throws Exception to jUnit
     */
    ...
    /**
     * <p>Tests <tt>updateAsset</tt> method.</p>
     *
     * @throws Exception to jUnit
     */
    public void testUpdateAsset() throws Exception {
        ...
        updated.setCategories(Arrays.asList(updated.getCategories().get(0))); // leave only one element
    ...
    /**
     * <p>Tests <tt>updateAsset</tt> method without version.</p>
     *
     * @throws Exception to jUnit
     */
    ...
    /**
     * <p>Tests <tt>assignUserToAsset</tt> method.</p>
     *
     * @throws Exception to jUnit
     */
    ...
    /**
     * <p>Tests <tt>assignUserToAsset</tt> method when the association already exists.</p>
     *
     * @throws Exception to jUnit
     */
    ...
    /**
     * <p>Tests <tt>removeUserFromAsset</tt> method.</p>
     *
     * @throws Exception to jUnit
     */
    ...
    /**
     * <p>Tests <tt>findAsset</tt> method.</p>
     *
     * @throws Exception to jUnit
     */
    public void testFindAsset() throws Exception {
        ...
        final List<Category> categories = Arrays.asList(
            getEntityManager().find(Category.class, 1L),
        ...
        for (int i = 1; i <= 0x1F; i++) {
            final Long pUserId =
                (i & 0x10) != 0 ? userId : null;
            final Long pClientId =
                (i & 0x08) != 0 ? clientId : null;
            final List<Category> pCategories =
                (i & 0x04) != 0 ? categories : null;
            final String pName =
                (i & 0x02) != 0 ? name : (i & 0x01) == 0 ? " " : null;
            final String pDescription =
                (i & 0x01) != 0 ? descriptions[(i / 2) % 3] : (i & 0x02) == 0 ? " " : null;
            final SearchCriteria criteria =
                new SearchCriteria(pUserId, pClientId, pCategories, pName, pDescription);
    ...
    /**
     * <p>Retrieves user-to-component association.</p>
     * @param userId user's id to associate with a component
     * @param component component to associate a user with
    ...
    private CompUser getUserAssetAssociation(long userId, Component component) throws Exception {
        try {
            return (CompUser) getEntityManager()
                .createQuery("SELECT u FROM CompUser u where u.userId=:userId and u.component.id=:componentId")
