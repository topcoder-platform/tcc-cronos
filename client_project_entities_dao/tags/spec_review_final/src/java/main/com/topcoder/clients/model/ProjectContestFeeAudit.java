...
/**
 * <p>
 * This class represents the audit fields for <code>ProjectContestFee</code>. It
 * is derived from <code>AuditableEntity</code> class.
 * </p>
 * <p>
...
@XmlType(name = "projectContestFeeAudit", propOrder = { "createUsername",
...
public abstract class ProjectContestFeeAudit implements Serializable {
	 ...
	 *
	 * @param createDate
	 *            the new createDate to be used for 'createDate' property. It
	 *            can be any value.
	 */
	 ...
	 *
	 * @param deleted
	 *            the new deleted to be used for 'deleted' property. It can be
	 *            any value.
	 */
	 ...
	 *
	 * @param modifyDate
	 *            the new modifyDate to be used for 'modifyDate' property. It
	 *            can be any value.
	 */
