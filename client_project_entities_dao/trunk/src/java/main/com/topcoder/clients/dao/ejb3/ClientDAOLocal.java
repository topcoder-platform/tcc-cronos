...
public interface ClientDAOLocal extends ClientDAO {
    /**
     * <p>
     * This static final String field represents the 'JNDI_NAME' identifier of the ClientDAOLocal
     * interface. Represents the JNDI name of this local interface.
     * </p>
     * <p>
     * It is initialized to a default value: ClientDAO.BEAN_NAME + "/local" String during runtime.
     * </p>
     */
