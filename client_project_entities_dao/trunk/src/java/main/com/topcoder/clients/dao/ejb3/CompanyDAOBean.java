 ...
 * </p>
 * <p>
 * This class implements the method available for the CompanyDAO business interface: retrieve
 * clients for company and retrieve projects for company.
 * </p>
 * <p>
...
public class CompanyDAOBean extends GenericEJB3DAO < Company, Long > implements CompanyDAO,
    CompanyDAOLocal, CompanyDAORemote {
    /**
     * The query string for method getClientsForCompany.
     */
    private static final String QUERY_CLIENTS =
    ...
    /**
     * Performs the retrieval of the list with clients for the given company from the persistence.
     * If nothing is found, return an empty list. Return only the entities that are not marked as
     * deleted.
     * @param company the given company to retrieve it's clients. Should not be null.
     ...
     * @throws EntityNotFoundException if company is not found in the persistence.
     ...
     */
    public List < Client > getClientsForCompany(Company company) throws EntityNotFoundException,
        DAOException {
        ...
        try {
            ...
            throw Helper.wrapWithDAOException(e, "Failed to get clients for company.");
        }
    }

    /**
     * Performs the retrieval of the list with projects for the given company from the persistence.
     * If nothing is found, return an empty list. Return only the entities that are not marked as
     * deleted.
     * @param company the given company to retrieve it's projects. Should not be null.
     ...
     * @throws DAOException if any error occurs while performing this operation.
     */
    public List < Project > getProjectsForCompany(Company company) throws EntityNotFoundException,
        DAOException {
        Helper.checkNull(company, "company");
        EntityManager entityManager = Helper.checkEntityManager(getEntityManager());
