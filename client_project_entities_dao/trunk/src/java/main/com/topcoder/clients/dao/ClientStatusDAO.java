 ...
 * </p>
 * <p>
 * This interface defines the specific methods available for the ClientStatusDAO business interface:
 * get the clients with the corresponding status.
 * </p>
 * <p>
...
public interface ClientStatusDAO extends GenericDAO < ClientStatus, Long > {
    /**
     * <p>
     * This static final String field represents the 'BEAN_NAME' property of the ClientStatusDAO
     * business interface. Represents the EJB session bean name.
     * </p>
     * <p>
     * It is initialized to a default value: "ClientStatusDAOBean" String during runtime.
     * </p>
     */
