 ...
 * </p>
 * <p>
 * <strong>THREAD SAFETY:</strong> This class does not contain any changeable fields, so is thread
 * safe.
 * </p>
...
final class Helper {
     ...
     * @param entityManager the entityManager used to operate entity
     * @return entityManager given
     * @throws DAOConfigurationException if entityManager is null.
     */
    static EntityManager checkEntityManager(EntityManager entityManager) {
        if (entityManager == null) {
            throw new DAOConfigurationException("The configured entityManager is invalid(null).");
        }
    ...
    static void checkNull(Object param, String paramName) {
        ExceptionUtils.checkNull(param, null, null, paramName + " should not be null.");
    }
     ...
     * @param message the message for DAOException wrapper
     * @return DAOException wrapper
     */
    public static DAOException wrapWithDAOException(Exception e, String message) {
