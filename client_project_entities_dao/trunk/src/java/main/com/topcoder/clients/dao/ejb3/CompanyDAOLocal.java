...
public interface CompanyDAOLocal extends CompanyDAO {
    /**
     * <p>
     * This static final String field represents the 'JNDI_NAME' identifier of the CompanyDAOLocal
     * interface. Represents the JNDI name of this local interface.
     * </p>
     * <p>
     * It is initialized to a default value: CompanyDAO.BEAN_NAME + "/local" String during runtime.
     * </p>
     */
