 ...
 * </p>
 * <p>
 * This interface defines the specific methods available for the ProjectDAO business interface:
...
public interface ProjectDAO extends GenericDAO < Project, Long > {
    /**
     * <p>
     * This static final String field represents the 'BEAN_NAME' property of the ProjectDAO business
     * interface. Represents the EJB session bean name.
     * </p>
     * <p>
     * It is initialized to a default value: "ProjectDAOBean" String during runtime.
     * </p>
     */
    ...
    /**
     * <p>
     * Defines the operation that performs the retrieval of a project using the given id from the
     * persistence. If include children is true return the Project.childProjects list too; otherwise
     * the list should not be returned.
     * </p>
     ...
     */
    public Project retrieveById(Long id, boolean includeChildren) throws EntityNotFoundException,
        DAOException;

    /**
     * <p>
     * Defines the operation that performs the retrieval of all projects from the persistence. If
     * include children is true return the Project.childProjects list too; otherwise the list should
     * not be returned. If nothing is found, return an empty list.
     * </p>
     * @param includeChildren the flag that mention if the Project.childrenProjects list should be
     *        returned or not.
     ...
     * @param projectId the project id
     * @throws IllegalArgumentException if the contestFees is null or the associated project id is
     ...
     *         null, or any project ID in addUserToBillingProjects array is &lt;= 0.
     * @throws DAOException if any error occurs while performing this operation.
     * @since 1.1
     */
