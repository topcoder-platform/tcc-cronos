 ...
 */
@Local
public interface ClientStatusDAOLocal extends ClientStatusDAO {
    /**
     * <p>
     * This static final String field represents the 'JNDI_NAME' identifier of the
     * ClientStatusDAOLocal interface. Represents the JNDI name of this local interface.
     * </p>
     * <p>
     * It is initialized to a default value: ClientStatusDAO.BEAN_NAME + "/local" String during
     * runtime.
     * </p>
     */
    public static final String JNDI_NAME = ClientStatusDAO.BEAN_NAME + "/local";
}
