...
public interface ProjectStatusDAOLocal extends ProjectStatusDAO {
     ...
     * ProjectStatusDAOLocal interface. Represents the JNDI name of this local interface.
     * </p>
     * <p>
     * It is initialized to a default value: ProjectStatusDAO.BEAN_NAME + "/local" String during
     * runtime.
     * </p>
     */
    public static final String JNDI_NAME = ProjectStatusDAO.BEAN_NAME + "/local";
}
