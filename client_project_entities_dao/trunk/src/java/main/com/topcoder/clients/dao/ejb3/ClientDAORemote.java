 ...
 */
@Remote
public interface ClientDAORemote extends ClientDAO {
    /**
     * <p>
     * This static final String field represents the 'JNDI_NAME' identifier of the ClientDAORemote
     * interface. Represents the JNDI name of this remote interface.
     * </p>
     * <p>
     * It is initialized to a default value: ClientDAO.BEAN_NAME + "/remote" String during runtime.
     * </p>
     */
    public static final String JNDI_NAME = ClientDAO.BEAN_NAME + "/remote";
}
