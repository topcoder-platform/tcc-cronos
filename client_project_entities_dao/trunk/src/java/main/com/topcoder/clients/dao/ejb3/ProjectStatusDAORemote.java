...
public interface ProjectStatusDAORemote extends ProjectStatusDAO {
     ...
     * ProjectStatusDAORemote interface. Represents the JNDI name of this remote interface.
     * </p>
     * <p>
     * It is initialized to a default value: ProjectStatusDAO.BEAN_NAME + "/remote" String during
     * runtime.
     * </p>
     */
    public static final String JNDI_NAME = ProjectStatusDAO.BEAN_NAME + "/remote";
}
