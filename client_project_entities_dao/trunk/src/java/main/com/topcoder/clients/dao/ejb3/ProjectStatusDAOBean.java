 ...
 * </p>
 * <p>
 * This class implements the method available for the ProjectStatusDAO business interface: get the
 * projects with the corresponding status.
 * </p>
 * <p>
...
public class ProjectStatusDAOBean extends GenericEJB3DAO < ProjectStatus, Long > implements
    ProjectStatusDAO, ProjectStatusDAOLocal, ProjectStatusDAORemote {
    /**
    ...
    /**
     * Default no-arg constructor. Constructs a new 'ProjectStatusDAOBean' instance.
     */
    public ProjectStatusDAOBean() {
    }

    /**
     * Performs the retrieval of the list with projects with the given status from the persistence.
