...
/**
 * <p>
 * This exception is the base exception for all exceptions raised from operations performed on
 * entities (in this design, entities inherited from AuditableEntity) from this design (excerpt
 * loading of the configurations).
 * </p>
 * <p>
 * This exception wraps exceptions raised from persistence, from usage of the J2EE utilities or used
 * TopCoder components.
 * </p>
 * <p>
...
public class DAOException extends BaseCriticalException {
    ...
    /**
     * Constructs a new 'DAOException' exception with the given message and cause.
     * @param message the exception message
    ...
    /**
     * Constructs a new 'DAOException' exception with the given message and data.
     * @param message the exception message
    ...
    /**
     * Constructs a new 'DAOException' exception with the given message, cause, and data.
     * @param message the exception message
     * @param cause the exception cause
     * @param data the additional exception data
     */
