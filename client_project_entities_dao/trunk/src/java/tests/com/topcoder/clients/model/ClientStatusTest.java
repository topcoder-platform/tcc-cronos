...
public class ClientStatusTest extends TestCase {
    ...
    public void testInheritance() {
        assertTrue("ClientStatus does not subclasses AuditableEntity.",
            target instanceof AuditableEntity);
    }

    /**
     * <p>
     * Tests the <code>com.topcoder.clients.model.ClientStatus()</code> for proper behavior.
     * Verifies that instance should be created.
     * </p>
     * @throws Exception to JUnit
     */
