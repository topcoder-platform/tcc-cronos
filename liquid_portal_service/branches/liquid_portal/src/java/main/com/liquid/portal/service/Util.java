...
*/
    ...
    public static String getProperty(String property)
        ...
        try {
            ...
            throw new LiquidPortalServiceException("" + e);
        }
    }
    ...
    private static Key loadKey(String alias)
            throws ConfigManagerException, LiquidPortalServiceException {
        ...
        try {
            ...
            e.printStackTrace();
            throw new LiquidPortalServiceException("Password encryption error in com.topcoder.security.Util.loadKey: " + e.getMessage());
        }
    }
    ...
    private static Key storeKeyStore(KeyStore ks, String alias)
        ...
        try {
            ...
            e.printStackTrace();
            throw new LiquidPortalServiceException("Password encryption error in com.topcoder.security.Util.storeKeyStore: " + e.getMessage());
        }
    }
    ...
    private static byte[] encdec(byte[] passwd, String alias, int cipherMode)
        ...
        try {
            ...
            e.printStackTrace();
            throw new LiquidPortalServiceException("Password encrption error in com.topcoder.security.Util.encdec: " + e.getMessage());
        }
    }
