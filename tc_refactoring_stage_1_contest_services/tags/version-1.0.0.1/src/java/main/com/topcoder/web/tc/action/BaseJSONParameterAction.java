 ...
 * @version 1.0
 */
public abstract class BaseJSONParameterAction extends ActionSupport implements ServletRequestAware {
    /**
     * <p>
     * Represent the class name.
     * </p>
     */
    private static final String CLASS_NAME = BaseJSONParameterAction.class.getName();
     ...
     * Logger.getLogger(BaseJSONParameterAction.class). It is used throughout the class wherever logging is
     * needed.
     * </p>
     */
    private static final Logger LOGGER = Logger.getLogger(BaseJSONParameterAction.class);

    /**
     * <p>
     * The name of the http parameter that is a JSON string as the input to this action. It is set through
     ...
     * restriction before the IoC initialization) It can be changed after it is initialized as part of
     * variable declaration to: "parameter". It is used in getParameterAsJSONObject(), setParameterKey().
     * </p>
     */
    ...
    /**
     * <p>
     * The date format string used to parse dates in the JSON string. It has both getter and setter. It cannot
     * be null or empty. (Note that the above statement applies only after the setter has been called as part
     * of the IoC initialization. This field's value has no restriction before the IoC initialization) It can
     * be changed after it is initialized as part of variable declaration to: "yyyy/MM/dd". It is used in
    ...
    /**
     * <p>
     * The http servlet request. This is injected by Struts. It is set through setter and doesn't have a
     * getter. It cannot be null. It does not need to be initialized when the instance is created. It is used
     * in setServletRequest(), getParameterAsJSONObject().
     * </p>
     */
     ...
     *             if any error occurs
     */
    protected JSONObject getParameterAsJSONObject() throws ContestServicesActionException {
        // Log the entry
        ...
        try {
            JSONObject result = (JSONObject) decoder.decode(servletRequest.getParameter(parameterKey));
            ...
            throw Helper.logException(LOGGER, new ContestServicesActionException(
                "ClassCastException occurs while decoding", e), signature);
        } catch (JSONDecodingException e) {
            throw Helper.logException(LOGGER, new ContestServicesActionException(
                "JSONDecodingException occurs while decoding", e), signature);
        }
    }

    /**
     * <p>
     * Setter method for the parameterKey, simply set the value to the namesake field.
     * </p>
     *
     * @param parameterKey
     *            The name of the http parameter that is a JSON string as the input to this action
     */
    ...
    /**
     * <p>
     * Getter method for dateFormatString, simply return the value of the namesake field.
     * </p>
     *
    ...
    /**
     * <p>
     * Setter method for the dateFormatString, simply set the value to the namesake field.
     * </p>
     *
    ...
    public void checkConfiguration() {
        ...
        checkStringNotNullAndEmptyForConfiguration("dateFormatString", dateFormatString);
    }

    /**
     * <p>
     * Throw ContestServicesConfigurationException if the parameter is null or empty.
     * </p>
     *
     * @param param
     ...
     */
    private static void checkStringNotNullAndEmptyForConfiguration(String name, String param) {
        if (param == null || param.trim().length() == 0) {
            throw new ContestServicesConfigurationException("The argument " + name
