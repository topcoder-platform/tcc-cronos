...
public class ContestStatusManagerAction extends BaseJSONParameterAction {
     ...
     * </p>
     */
    private static final String CLASS_NAME = ContestStatusManagerAction.class.getName();
     ...
     * Logger.getLogger(ContestStatusManagerAction.class). It is used throughout the class wherever logging is
     * needed.
     * </p>
     */
    private static final Logger LOGGER = Logger.getLogger(ContestStatusManagerAction.class);

    /**
     * <p>
     * The ContestStatusManager for getting contest statuses. It is set through setter and doesn't have a
     ...
     * setContestStatusManager(). Its value legality is checked in checkConfiguration() method.
     * </p>
     */
    ...
    /**
     * <p>
     * The retrieved contest statuses. It is accessed through getter and doesn't have a setter. It cannot be
     * null but can be empty. The contained values can't be null. It does not need to be initialized when the
     * instance is created. It is used in getContestStatuses(), execute().
     * </p>
     */
    ...
    public String execute() throws ContestServicesActionException {
        ...
        try {
            ...
            contestStatuses = contestStatusManager.retrieveContestStatuses((String) mapParam
                            .get("columnName"), (SortingOrder) mapParam.get("sortingOrder"),
            ...
            throw Helper.logException(LOGGER, new ContestServicesActionException(
                "ContestStatusManagerException occurs while retrieving contestStatuses", e), signature);
        }
    }

    /**
     * <p>
     * Getter method for contestStatuses, simply return the value of the namesake field.
     * </p>
     *
    ...
    /**
     * <p>
     * Setter method for the contestStatusManager, simply set the value to the namesake field.
     * </p>
     *
     * @param contestStatusManager
     *            The ContestStatusManager for getting contest statuses to set
     */
    public void setContestStatusManager(ContestStatusManager contestStatusManager) {
    ...
    public void checkConfiguration() {
        ...
        Helper.checkNotNullForConfiguration("contestStatusManager", contestStatusManager);
    }
}
