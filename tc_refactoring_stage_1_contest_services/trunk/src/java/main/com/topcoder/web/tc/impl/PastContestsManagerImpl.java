...
/**
 * <p>
 * This is the default implementation of PastContestsManager. It extends HibernateDaoSupport to execute HQL
 ...
 * @version 1.0
 */
public class PastContestsManagerImpl extends HibernateDaoSupport implements PastContestsManager {
    /**
     * <p>
     * Represent the class name.
     * </p>
     */
    private static final String CLASS_NAME = PastContestsManagerImpl.class.getName();
     ...
     * </p>
     */
    private static final String SQL_QUERY = "SELECT DISTINCT new map(projectGroupCategory.name as type,"
     ...
     * Logger.getLogger(PastContestsManagerImpl.class). It is used throughout the class wherever logging is
     * needed.
     * </p>
     */
    private static final Logger LOGGER = Logger.getLogger(PastContestsManagerImpl.class);
     ...
     * setProjectNameInfoId(), retrievePastContests(). Its value legality is checked in checkConfiguration()
     * method.
     * </p>
     */
    ...
    /**
     * <p>
     * The id of the phase_status_lu row that has name 'Completed'. It is set through setter and doesn't have
     ...
     * retrievePastContests(), setCompletedStatusId(). Its value legality is checked in checkConfiguration()
     * method.
     * </p>
     */
    ...
    /**
     * <p>
     * The id of the phase_type_lu row that has name 'Approval'. It is set through setter and doesn't have a
     ...
     * initialization) It does not need to be initialized when the instance is created. It is used in
     * setApprovalPhaseTypeId(), retrievePastContests(). Its value legality is checked in checkConfiguration()
     * method.
     * </p>
     */
    ...
    /**
     * <p>
     * The id of the project_info_type_lu row that has name 'Winner External Reference ID'. It is set through
     * setter and doesn't have a getter. It must be non-negative. (Note that the above statement applies only
     ...
     * created. It is used in retrievePastContests(), setWinnerIdInfoId(). Its value legality is checked in
    ...
    /**
     * <p>
     * The id of the resource_info_type_lu row that has name 'External Reference ID'. It is set through setter
     ...
     * used in setExternalReferenceIdInfoId(), retrievePastContests(). Its value legality is checked in
     * checkConfiguration() method.
     * </p>
     */
    ...
    /**
     * <p>
     * The id of the resource_info_type_lu row that has name 'Handle'. It is set through setter and doesn't
     ...
     * initialization) It does not need to be initialized when the instance is created. It is used in
     * setHandleInfoId(), retrievePastContests(). Its value legality is checked in checkConfiguration()
     * method.
     * </p>
     */
     ...
     * been called as part of the IoC initialization. This field's value has no restriction before the IoC
     * initialization) It does not need to be initialized when the instance is created. It is used in
     * setSubmitterRoleId(), retrievePastContests(). Its value legality is checked in checkConfiguration()
     * method.
     * </p>
     */
     ...
     * setter has been called as part of the IoC initialization. This field's value has no restriction before
     * the IoC initialization) It does not need to be initialized when the instance is created. It is used in
     * setContestSubmissionTypeId(), retrievePastContests(). Its value legality is checked in
     * checkConfiguration() method.
     * </p>
     */
     ...
     * has been called as part of the IoC initialization. This field's value has no restriction before the IoC
     * initialization) It does not need to be initialized when the instance is created. It is used in
     * setActiveSubmissionStatusId(), retrievePastContests(). Its value legality is checked in
     * checkConfiguration() method.
     * </p>
     */
     ...
     * setter has been called as part of the IoC initialization. This field's value has no restriction before
     * the IoC initialization) It does not need to be initialized when the instance is created. It is used in
     * setFailedScreeningSubmissionStatusId(), retrievePastContests(). Its value legality is checked in
     * checkConfiguration() method.
     * </p>
     */
     ...
     * setter has been called as part of the IoC initialization. This field's value has no restriction before
     * the IoC initialization) It does not need to be initialized when the instance is created. It is used in
     * setFailedReviewSubmissionStatusId(), retrievePastContests(). Its value legality is checked in
     * checkConfiguration() method.
     * </p>
     */
     ...
     * the setter has been called as part of the IoC initialization. This field's value has no restriction
     * before the IoC initialization) It does not need to be initialized when the instance is created. It is
     * used in retrievePastContests(), setCompletedWithoutWinSubmissionStatusId(). Its value legality is
    ...
    /**
     * <p>
     * The winner profile link template. This is a URL that points to the profile page of the winner, which
     * must have a variable "%id%". This variable will be replaced with the actual winner id. It is set
     * through setter and doesn't have a getter. It cannot be null or empty. (Note that the above statement
     * applies only after the setter has been called as part of the IoC initialization. This field's value has
     * no restriction before the IoC initialization) It does not need to be initialized when the instance is
     * created. It is used in setWinnerProfileLinkTemplate(), retrievePastContests(). Its value legality is
     * checked in checkConfiguration() method.
     * </p>
     */
    private String winnerProfileLinkTemplate;

    /**
     * <p>
     * The minimal screening score that passes screening. It is set through setter and doesn't have a getter.
     * It must be non-negative. (Note that the above statement applies only after the setter has been called
     * as part of the IoC initialization. This field's value has no restriction before the IoC initialization)
     * It does not need to be initialized when the instance is created. It is used in
     * setPassingScreeningScore(), retrievePastContests(). Its value legality is checked in
     * checkConfiguration() method.
     * </p>
     */
    ...
    public List<PastContestDTO> retrievePastContests(final String columnName,
                    ...
                    final PastContestFilter filter) throws PastContestsManagerException {
        // Log the entry
        ...
        // ActiveContestsManagerImpl.retrieveActiveContests(). The difference is that a different HQL should
        // be used, and the populated DTO class is PastContestDTO. The HQL to use is given in CS 1.3.3.
        // Special care should be taken for PastContestDTO.winnerProfileLink. The "%id%" in
        // this.winnerProfileLinkTemplate should be replaced with the value of winnerExternalReferenceId of
        // the HQL to form the real link and set to PastContestDTO.winnerProfileLink.
        try {
            // check parameter
            ...
            this.getHibernateTemplate().execute(new HibernateCallback<Object>() {
                ...
                public Object doInHibernate(Session session) throws HibernateException {
                    // Create the sql
                    String sql = SQL_QUERY + Helper.addFilterForSQL(filter, "PastContest");
                    // Add filter to winner handle
                    if (Helper.checkStringNotNullAndNotEmptyOfBoolean(filter.getWinnerHandle())) {
                        sql += " and externalReferenceIdInfo.resourceInfoTypeId=:externalReferenceIdInfoId"
                            + " and externalReferenceIdInfo.value=winnerIdInfo.value"
                            + " and handleInfo.resourceInfoTypeId=:handleInfoId"
                            + " and handleInfo.value LIKE '%" + filter.getWinnerHandle() + "%'";
                    }
                    ...
                    // set the parameters of the HQL according to CS 1.3.3
            ...
            throw Helper.logException(LOGGER, new PastContestsManagerException(
    ...
    private void setQueryParameters(Query query, PastContestFilter filter) {
        ...
        if (Helper.checkStringNotNullAndNotEmptyOfBoolean(filter.getWinnerHandle())) {
            query.setParameter("externalReferenceIdInfoId", externalReferenceIdInfoId);
    ...
    private PastContestDTO transferMapToDTO(Map<String, Object> map) {
        ...
        dto.setCompletionDate((Date) map.get("completionDate"));
        dto.setPassedScreeningCount(((Long) map.get("passedScreeningCount")).intValue());
        String winnerExternalReferenceId = (String) map.get("winnerExternalReferenceId");
        if (winnerExternalReferenceId != null) {
            dto.setWinnerProfileLink(winnerProfileLinkTemplate.replaceAll("%id%", winnerExternalReferenceId));
        }
    ...
    public List<PastContestDTO> retrievePastContests(PastContestFilter filter)
        throws PastContestsManagerException {
        final String signature = CLASS_NAME + ".retrievePastContests(PastContestFilter)";
        Helper.logEntrance(LOGGER, signature, new String[] {"filter"}, new Object[] {filter});
        final long startTime = System.currentTimeMillis();

        List<PastContestDTO> result = retrievePastContests(null, null, -1, -1, filter);
    ...
    /**
     * <p>
     * Setter method for the completedStatusId, simply set the value to the namesake field.
     * </p>
     *
    ...
    /**
     * <p>
     * Setter method for the approvalPhaseTypeId, simply set the value to the namesake field.
     * </p>
     *
    ...
    /**
     * <p>
     * Setter method for the winnerIdInfoId, simply set the value to the namesake field.
     * </p>
     *
     * @param winnerIdInfoId
     *            The id of the project_info_type_lu row that has name 'Winner External Reference ID'
     */
    ...
    /**
     * <p>
     * Setter method for the externalReferenceIdInfoId, simply set the value to the namesake field.
     * </p>
     *
     * @param externalReferenceIdInfoId
     *            The id of the resource_info_type_lu row that has name 'External Reference ID'
     */
    ...
    /**
     * <p>
     * Setter method for the handleInfoId, simply set the value to the namesake field.
     * </p>
     *
     * @param handleInfoId
    ...
    /**
     * <p>
     * Setter method for the winnerProfileLinkTemplate, simply set the value to the namesake field.
     * </p>
     *
     * @param winnerProfileLinkTemplate
     *            The winner profile link template. This is a URL that points to the profile page of the
     *            winner, which must have a variable "%id%". This variable will be replaced with the actual
     *            winner id
     */
    public void setWinnerProfileLinkTemplate(String winnerProfileLinkTemplate) {
        this.winnerProfileLinkTemplate = winnerProfileLinkTemplate;
    }

    /**
     * <p>
     * Setter method for the passingScreeningScore, simply set the value to the namesake field.
     * </p>
     *
    ...
    public void checkConfiguration() {
        ...
        Helper.checkNotNegativeForConfiguration("externalReferenceIdInfoId", externalReferenceIdInfoId);
        Helper.checkNotNegativeForConfiguration("failedReviewSubmissionStatusId",
            failedReviewSubmissionStatusId);
        Helper.checkNotNegativeForConfiguration("completedStatusId", completedStatusId);
        Helper.checkNotNegativeForConfiguration("activeSubmissionStatusId", activeSubmissionStatusId);
        Helper.checkNotNegativeForConfiguration("winnerIdInfoId", winnerIdInfoId);
        Helper.checkNotNegativeForConfiguration("failedScreeningSubmissionStatusId",
            failedScreeningSubmissionStatusId);
        Helper.checkNotNegativeForConfiguration("approvalPhaseTypeId", approvalPhaseTypeId);
        ...
        if (winnerProfileLinkTemplate == null || winnerProfileLinkTemplate.trim().length() == 0) {
            throw new ContestServicesConfigurationException(
                "The argument winnerProfileLinkTemplate can not be null or empty.");
        }
        if (winnerProfileLinkTemplate.indexOf("%id%") == -1) {
            throw new ContestServicesConfigurationException(
                "The argument winnerProfileLinkTemplate must contain a variable '%id%'.");
        }
    }
}
