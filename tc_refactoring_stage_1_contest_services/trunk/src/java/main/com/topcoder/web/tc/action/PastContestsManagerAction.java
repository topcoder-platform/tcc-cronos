...
public class PastContestsManagerAction extends BaseJSONParameterAction {
     ...
     * </p>
     */
    private static final String CLASS_NAME = PastContestsManagerAction.class.getName();
    /**
     * <p>
     ...
     * Logger.getLogger(PastContestsManagerAction.class). It is used throughout the class wherever logging is
     * needed.
     * </p>
     */
    private static final Logger LOGGER = Logger.getLogger(PastContestsManagerAction.class);

    /**
     * <p>
     * The PastContestsManager for getting past contests. It is set through setter and doesn't have a getter.
     * It cannot be null. (Note that the above statement applies only after the setter has been called as part
     * of the IoC initialization. This field's value has no restriction before the IoC initialization) It does
     * not need to be initialized when the instance is created. It is used in execute(),
     * setPastContestsManager(). Its value legality is checked in checkConfiguration() method.
     * </p>
     */
    ...
    /**
     * <p>
     * The retrieved past contests. It is accessed through getter and doesn't have a setter. It cannot be null
     * but can be empty. The contained values can't be null. It does not need to be initialized when the
     * instance is created. It is used in getPastContests(), execute().
     * </p>
     */
    ...
    public String execute() throws ContestServicesActionException {
        ...
        try {
            ...
            pastContests = pastContestsManager.retrievePastContests((String) mapParam.get("columnName"),
                (SortingOrder) mapParam.get("sortingOrder"), (Integer) mapParam.get("pageNumber"),
            ...
            throw Helper.logException(LOGGER, new ContestServicesActionException(
                "PastContestsManagerException occurs while retrieving pastContests", e), signature);
        }
    }

    /**
     * <p>
     * Getter method for pastContests, simply return the value of the namesake field.
     * </p>
     *
    ...
    /**
     * <p>
     * Setter method for the pastContestsManager, simply set the value to the namesake field.
     * </p>
     *
    ...
    public void checkConfiguration() {
        ...
        Helper.checkNotNullForConfiguration("pastContestsManager", pastContestsManager);
    }
}
