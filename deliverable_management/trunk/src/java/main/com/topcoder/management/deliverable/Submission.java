...
/**
 * <p>
 * The Submission class is the one of the main modeling classes of this component. It represents a
 * submission, which consists of an upload and a status. The Submission class is simply a container
 * for a few basic data fields. All data fields in this class are mutable and have get and set
 * methods.
 * </p>
 * <p>
...
public class Submission extends AuditedDeliverableStructure {
    ...
    /**
     * The upload that is associated with the submission. This field can be null or non-null and is
     * mutable. The default value is null, which indicates that this field has not been set. This
     * field can be set through the setUpload method and retrieved through the getUpload method.
     */
    private Upload upload = null;

    /**
     * The status of the submission. This field can be null or non-null and is mutable. The default
     * value is null, which indicates that this field has not been set.
     */
    ...
    public boolean isValidToPersist() {
        ...
        // not null, submissionStatus is not null, super.isValidTopPersist is true.
        return ((super.getId() != UNSET_ID)
                    && (upload != null)
                    && (upload.isValidToPersist())
                    && (submissionStatus != null)
                    && (submissionStatus.isValidToPersist())
