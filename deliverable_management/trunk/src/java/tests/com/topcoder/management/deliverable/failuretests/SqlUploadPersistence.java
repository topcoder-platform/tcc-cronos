...
/**
 * <p>The SqlUploadPersistence class implements the UploadPersistence interface,
 * in order to persist to the database structure given in the
 ...
 * PreparedStatements in order to accomplish their tasks.</p>
 *
...
public class SqlUploadPersistence implements UploadPersistence {
    ...
    /**
     * <p>addUploadType: Adds the given uploadType to the persistence. The id of
     ...
     * be wrapped in a UploadPersistenceException.</p>
     *
     ...
     * @throws  UploadPersistenceException  If there is an error making the
    ...
    /**
     * <p>removeUploadType: Removes the given upload type (by id) from the
    ...
    /**
     * <p>updateUploadType: Updates the given upload type in the persistence.
     * The id of the uploadType can not be UNSET_ID, and all other fields needed
     * for persistence must also be assigned.</p>
     *
     * <p>Exception Handling: Any SqlException or DBConnectionException should
     * be wrapped in a UploadPersistenceException.</p>
     *
    ...
    /**
     * <p>loadUploadType: Loads the UploadType with the given id from
     * persistence. Returns null if there is no UploadType with the given
     * id.</p>
     *
     * <p>Exception Handling: Any SqlException or DBConnectionException should
     * be wrapped in a UploadPersistenceException.</p>
     ...
     * @throws  UploadPersistenceException  if there is an error reading the
     *                                      persistence data
     */
    ...
    /**
     * <p>getAllUploadTypeIds: Gets the ids of all upload types in the
     * persistence. The individual upload types can then be loaded with the
    ...
    /**
     * <p>addUploadStatus: Adds the given uploadStatus to the persistence. The
     * id of the upload status must already be assigned, as must all the other
    ...
    /**
     * <p>removeUploadStatus: Removes the given upload status (by id) from the
    ...
    /**
     * <p>updateUploadStatus: Updates the given upload status in the
     * persistence. The id of the uploadStatus can not be UNSET_ID, and all
    ...
    /**
     * <p>loadUploadStatus: Loads the UploadStatus with the given id from
     * persistence. Returns null if there is no UploadStatus with the given
     * id.</p>
     *
     * <p>Exception Handling: Any SqlException or DBConnectionException should
     * be wrapped in a UploadPersistenceException.</p>
    ...
    /**
     * <p>getAllUploadStatusIds: Gets the ids of all upload statuses in the
     * persistence. The individual upload statuses can then be loaded with the
     * loadUploadStatus method.</p>
     *
     * <p>Exception Handling: Any SqlException or DBConnectionException should
     * be wrapped in a UploadPersistenceException.</p>
     *
    ...
    /**
     * <p>addSubmissionStatus: Adds the given submission status to the
     * persistence. The id of the submission status must already be assigned, as
    ...
    /**
     * <p>removeSubmissionStatus: Removes the given submission status (by id)
     * from the persistence. The id of the submission status can not be
    ...
    /**
     * <p>updateSubmissionStatus: Updates the given submission status in the
    ...
    /**
     * <p>loadSubmissionStatus: Loads the SubmissionStatus with the given id
     * from persistence. Returns null if there is no SubmissionStatus with the
     * given id.</p>
     *
     * <p>Exception Handling: Any SqlException or DBConnectionException should
     * be wrapped in a UploadPersistenceException.</p>
    ...
    /**
     * <p>getAllSubmissionStatusIds: Gets the ids of all submission statuses in
     * the persistence. The individual submission statuses can then be loaded
     * with the loadSubmissionStatus method.</p>
     *
     * <p>Exception Handling: Any SqlException or DBConnectionException should
     * be wrapped in a UploadPersistenceException.</p>
     *
    ...
    /**
     * <p>addUpload: Adds the given upload to the persistence. The id of the
     * upload must already be assigned, as must all the other fields needed for
     * persistence.</p>
     *
     * <p>Exception Handling: Any SqlException or DBConnectionException should
     * be wrapped in a UploadPersistenceException.</p>
    ...
    /**
     * <p>removeUpload: Removes the given upload (by id) from the persistence.
    ...
    /**
     * <p>updateUpload: Updates the given upload in the persistence. The id of
     * the upload can not be UNSET_ID, and all other fields needed for
    ...
    /**
     * <p>loadUpload: Loads the Upload with the given id from persistence.
     * Returns null if there is no Upload with the given id.</p>
     *
     * <p>Exception Handling: Any SqlException or DBConnectionException should
     * be wrapped in a UploadPersistenceException.</p>
     *
    ...
    /**
     * <p>addSubmission: Adds the given submission to the persistence. The id of
    ...
    /**
     * <p>removeSubmission: Removes the given submission (by id) from the
    ...
    /**
     * <p>updateSubmission: Updates the given submission in the persistence. The
     * id of the submission can not be UNSET_ID, and all other fields needed for
     * persistence must also be assigned.</p>
     *
     * <p>Exception Handling: Any SqlException or DBConnectionException should
     * be wrapped in a UploadPersistenceException.</p>
    ...
    /**
     * <p>loadSubmission: Loads the Submission with the given id from
     * persistence. Returns null if there is no Submission with the given
     * id.</p>
     *
     * <p>Exception Handling: Any SqlException or DBConnectionException should
     * be wrapped in a UploadPersistenceException.</p>
    ...
    /**
     * <p>loadSubmissions: Loads all Submissions with the given ids from
     ...
     *                                      persistence data
     */
    public com.topcoder.management.deliverable.Submission[] loadSubmissions(
        long[] submissionIds) {
    ...
    /**
     * <p>loadUploads: Loads all Uploads with the given ids from persistence.
     ...
     *                                      persistence data
     */
    public com.topcoder.management.deliverable.Upload[] loadUploads(
        long[] uploadIds) {
    ...
    /**
     * <p>loadUploadTypes: Loads all UploadTypes with the given ids from
     * persistence. May return a 0-length array.</p>
     *
     * <p>Exception Handling: Any SqlException or DBConnectionException should
     * be wrapped in a UploadPersistenceException.</p>
     ...
     *                                      persistence data
     */
    public com.topcoder.management.deliverable.UploadType[] loadUploadTypes(
        long[] uploadTypeIds) {
    ...
    /**
     * <p>loadUploadStatuses: Loads all UploadStatuses with the given ids from
     * persistence. May return a 0-length array.</p>
     *
     * <p>Exception Handling: Any SqlException or DBConnectionException should
     * be wrapped in a UploadPersistenceException.</p>
     ...
     *                                      persistence data
     */
    public com.topcoder.management.deliverable.UploadStatus[] loadUploadStatuses(
        long[] uploadStatusIds) {

        return null;
    }

    /**
     * <p>loadSubmissionStatuses: Loads all SubmissionStatuses with the given
     * ids from persistence. May return a 0-length array.</p>
     *
     * <p>Exception Handling: Any SqlException or DBConnectionException should
     * be wrapped in a UploadPersistenceException.</p>
     *
     ...
     *                                      persistence data
     */
    public SubmissionStatus[] loadSubmissionStatuses(
        long[] submissionStatusIds) {
