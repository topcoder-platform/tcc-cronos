...
public class PersistenceUploadManagerAccuracyTests extends AccuracyTestsHelper {
     ...
     * @throws Exception pass to JUnit.
     */
    public void testConstructorWithSearchBundlesAndIdGenerators()
        throws Exception {
        SearchBundle uploadSearchBundle = searchBundleManager.getSearchBundle(PersistenceUploadManager.UPLOAD_SEARCH_BUNDLE_NAME);
        SearchBundle submissionSearchBundle = searchBundleManager.getSearchBundle(PersistenceUploadManager.SUBMISSION_SEARCH_BUNDLE_NAME);
        IDGenerator uploadIdGenerator = IDGeneratorFactory.getIDGenerator(PersistenceUploadManager.UPLOAD_ID_GENERATOR_NAME);
        IDGenerator uploadTypeIdGenerator = IDGeneratorFactory.getIDGenerator(PersistenceUploadManager.UPLOAD_TYPE_ID_GENERATOR_NAME);
        IDGenerator uploadStatusIdGenerator = IDGeneratorFactory.getIDGenerator(PersistenceUploadManager.UPLOAD_STATUS_ID_GENERATOR_NAME);
        IDGenerator submissionIdGenerator = IDGeneratorFactory.getIDGenerator(PersistenceUploadManager.SUBMISSION_ID_GENERATOR_NAME);
        IDGenerator submissionStatusIdGenerator = IDGeneratorFactory.getIDGenerator(PersistenceUploadManager.SUBMISSION_STATUS_ID_GENERATOR_NAME);
     ...
     * @throws Exception pass to JUnit.
     */
    public void testConstructorWithSearchBundleManagerAndIdGeneratorFactory()
        throws Exception {
        manager = new PersistenceUploadManager(new MockUploadPersistence(), searchBundleManager);
        assertNotNull("Unable to instantiate PersistenceUploadManager", manager);
    }
    ...
    public void testGetAllUploadTypes() throws Exception {
        ...
        assertTrue("Persistence implementation not used correctly",
            MockUploadPersistence.getLastCalled().startsWith("loadUploadTypes"));
    }
    ...
    public void testGetAllUploadStatuses() throws Exception {
        ...
        assertTrue("Persistence implementation not used correctly",
            MockUploadPersistence.getLastCalled().startsWith("loadUploadStatuses"));
    }
    ...
    public void testGetAllSubmissionStatuses() throws Exception {
        ...
        assertTrue("Persistence implementation not used correctly",
            MockUploadPersistence.getLastCalled().startsWith("loadSubmissionStatuses"));
    }
    ...
    public void testCreateUpload() throws Exception {
        ...
        assertEquals("Persistence implementation not used correctly", "addUpload" + upload,
            MockUploadPersistence.getLastCalled());
    }
    ...
    public void testUpdateUpload() throws Exception {
        ...
        assertTrue("Invalid UploadType persisted", upload.isValidToPersist());
        assertEquals("Persistence implementation not used correctly", "updateUpload" + upload,
            MockUploadPersistence.getLastCalled());
    }
    ...
    public void testRemoveUpload() throws Exception {
        ...
        assertTrue("ModificationTimestamp not updated", upload.getModificationTimestamp() != timestamp);
        assertTrue("Invalid UploadType persisted", upload.isValidToPersist());
        assertEquals("Persistence implementation not used correctly", "removeUpload" + upload,
            MockUploadPersistence.getLastCalled());
    }
    ...
    public void testGetUpload() throws Exception {
        ...
        assertEquals("Persistence implementation not used correctly", "loadUpload" + id,
            MockUploadPersistence.getLastCalled());
    }
    ...
    public void testGetSubmission() throws Exception {
        ...
        assertEquals("Persistence implementation not used correctly", "loadSubmission" + id,
            MockUploadPersistence.getLastCalled());
    }
    ...
    public void testSearchUploadsByUploadId() throws Exception {
        try {
            ...
            assertTrue("Persistence method not called correctly",
                MockUploadPersistence.getLastCalled().startsWith("loadUploads"));
        } finally {
            executeBatch(CLEAR_DB_SQL);
        }
    }
    ...
    public void testSearchSubmissionsBySubmissionId() throws Exception {
        try {
            ...
            for (int i = 1; i <= 5; ++i) {
                Submission[] submissions = manager.searchSubmissions(SubmissionFilterBuilder.createSubmissionIdFilter(i));
            ...
            assertTrue("Persistence method not called correctly",
                MockUploadPersistence.getLastCalled().startsWith("loadSubmissions"));
        } finally {
            executeBatch(CLEAR_DB_SQL);
        }
    }
     ...
     * @throws Exception pass to JUnit.
     */
    public void testSearchSubmissionsBySubmissionStatusId()
        throws Exception {
        try {
            executeBatch(CLEAR_DB_SQL);
            executeBatch(INIT_DB_SQL);

            Submission[] submissions = manager.searchSubmissions(SubmissionFilterBuilder.createSubmissionStatusIdFilter(
                        4));
     ...
     * @param project the project of the upload.
     * @param parameter the parameter of the upload.
     *
     * @return the upload created.
     *
     * @throws Exception pass to JUnit.
     */
    private Upload createUpload(int owner, int project, String parameter)
        throws Exception {
        UploadType uploadType = new UploadType();
