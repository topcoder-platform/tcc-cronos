...
public interface DeliverablePersistence {
    /**
     * Loads the deliverables associated with the given deliverable id. There may be more than one
     * deliverable returned if the deliverable is a "per submission" deliverable. Hence the need for
     * an array return type. If there is no matching deliverable in the persistence, an empty array
     * should be returned.
     *
     ...
     * submission" deliverable and the given submission must be "Active". If this is not the case,
     * null is returned.
     *
     ...
     */
    public Deliverable loadDeliverable(long deliverableId, long submissionId) throws DeliverablePersistenceException;
    ...
    /**
     * Loads per-submission deliverables that have the given deliverable id and submission id. The
