...
public class SubmissionAccuracyTests extends TestCase {
     ...
     * <code>UploadStatus</code>, <code>SubmissionStatus</code> and <code>Submission</code> are created. Fields are
     * set to valid values.
     */
    ...
    public void testSetAndGetUploadStatus() {
        ...
        assertEquals("SetSubmissionStatus or getSubmissionStatus not functions correctly", submissionStatus,
            submission.getSubmissionStatus());
        submission.setSubmissionStatus(null);
        assertEquals("SetSubmissionStatus or getSubmissionStatus not functions correctly", null,
            submission.getSubmissionStatus());
    }
