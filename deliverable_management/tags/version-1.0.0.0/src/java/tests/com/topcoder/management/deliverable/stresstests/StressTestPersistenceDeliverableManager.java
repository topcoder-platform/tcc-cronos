...
public class StressTestPersistenceDeliverableManager extends TestCase {
    ...
    public void setUp() throws Exception {
        ...
        SearchBundle deliverableWithSubmissionsSearchBundle = sm.getSearchBundle("Deliverable With Submission Search Bundle");
    ...
    public void testSearchDeliverablesWithSubmissions() throws Exception {
        ...
        for (int i = 0; i < 20; i++) {
            ...
            assertEquals("Equal is expected.", 1, ds.length);
        }
