...
public class PersistenceUploadManagerTests extends TestCase {
    ...
    /**
     * Set the behaviour of createUpload. Set the 1th paramter to null. IllegalArgumentException
     * should be thrown.
     */
    ...
    /**
     * Set the behaviour of createUpload. Set the 2th paramter to null. IllegalArgumentException
     * should be thrown.
     */
    ...
    /**
     * Set the behaviour of createUpload. Set the upload's id to 10. Since upload's id should be
    ...
    /**
     * Set the behaviour of createUpload. Give some valid parameters. See if the method can
     * successfully add the Upload object to persistence No exception should be thrown.
     */
    public void testCreateUpload_Accuracy1() {
        try {
            // Get a Upload.
            Upload upload = DeliverableTestHelper.getValidToPersitUpload();
    ...
    /**
     * Set the behaviour of updateUpload. Set the 1th paramter to null. IllegalArgumentException
     * should be thrown.
     */
    ...
    /**
     * Set the behaviour of updateUpload. Set the 2th paramter to null. IllegalArgumentException
     * should be thrown.
     */
    ...
    /**
     * Set the behaviour of updateUpload. Set the upload's id to UNSET_ID. Since upload's id should
    ...
    /**
     * Set the behaviour of updateUpload. Give some valid parameters. See if the method can
     * successfully add the Upload object to persistence No exception should be thrown.
     */
    ...
    /**
     * Set the behaviour of removeUpload. Set the 1th paramter to null. IllegalArgumentException
     * should be thrown.
     */
    ...
    /**
     * Set the behaviour of removeUpload. Set the 2th paramter to null. IllegalArgumentException
     * should be thrown.
     */
    ...
    /**
     * Set the behaviour of removeUpload. Set the upload's id to UNSET_ID. Since upload's id should
     * not be UNSET_ID, IllegalArgumentException should be thrown.
     */
    ...
    /**
     * Set the behaviour of removeUpload. Give some valid parameters. See if the method can
     * successfully add the Upload object to persistence No exception should be thrown.
     */
    ...
    /**
     * Set the behaviour of getUpload. Set the paramter = 0. IllegalArgumentException should be
     * thrown.
     */
    ...
    /**
     * Set the behaviour of getUpload. Set the paramter = 111, then the id field of return Upload
     * will be 111 too.
     */
    ...
    /**
     * Set the behaviour of searchUpload. Set the paramter = null. IllegalArgumentException should
     * be thrown.
     */
    ...
    /**
     * Set the behaviour of createUploadType. Set the 1th paramter to null. IllegalArgumentException
     * should be thrown.
     */
    ...
    /**
     * Set the behaviour of createUploadType. Set the 2th paramter to null. IllegalArgumentException
     * should be thrown.
     */
    ...
    /**
     * Set the behaviour of createUploadType. Set the uploadType's id to 10. Since uploadType's id
    ...
    /**
     * Set the behaviour of createUploadType. Give some valid parameters. See if the method can
    ...
    public void testCreateUploadType_Accuracy1() {
        try {
            // Get a UploadType.
            UploadType uploadType = DeliverableTestHelper.getValidToPersitUploadType();
    ...
    /**
     * Set the behaviour of updateUploadType. Set the 1th paramter to null. IllegalArgumentException
     * should be thrown.
     */
    ...
    /**
     * Set the behaviour of updateUploadType. Set the 2th paramter to null. IllegalArgumentException
     * should be thrown.
     */
    ...
    /**
     * Set the behaviour of updateUploadType. Set the uploadType's id to UNSET_ID. Since
    ...
    /**
     * Set the behaviour of updateUploadType. Give some valid parameters. See if the method can
     * successfully add the UploadType object to persistence No exception should be thrown.
     */
    ...
    /**
     * Set the behaviour of removeUploadType. Set the 1th paramter to null. IllegalArgumentException
     * should be thrown.
     */
    ...
    /**
     * Set the behaviour of removeUploadType. Set the 2th paramter to null. IllegalArgumentException
     * should be thrown.
     */
    ...
    /**
     * Set the behaviour of removeUploadType. Set the uploadType's id to UNSET_ID. Since
     * uploadType's id should not be UNSET_ID, IllegalArgumentException should be thrown.
     */
    ...
    /**
     * Set the behaviour of removeUploadType. Give some valid parameters. See if the method can
     * successfully add the UploadType object to persistence No exception should be thrown.
     */
    ...
    /**
     * Sicne the getAllUploadTypes totally invoke method in persistence, We just use MOCK
    ...
    /**
     * Set the behaviour of createUploadStatus. Set the 1th paramter to null.
    ...
    /**
     * Set the behaviour of createUploadStatus. Set the 2th paramter to null.
     * IllegalArgumentException should be thrown.
     */
    ...
    /**
     * Set the behaviour of createUploadStatus. Set the uploadStatus's id to 10. Since
    ...
    /**
     * Set the behaviour of createUploadStatus. Give some valid parameters. See if the method can
    ...
    public void testCreateUploadStatus_Accuracy1() {
        try {
            // Get a UploadStatus.
            UploadStatus uploadStatus = DeliverableTestHelper.getValidToPersitUploadStatus();
    ...
    /**
     * Set the behaviour of updateUploadStatus. Set the 1th paramter to null.
     * IllegalArgumentException should be thrown.
     */
    ...
    /**
     * Set the behaviour of updateUploadStatus. Set the 2th paramter to null.
     * IllegalArgumentException should be thrown.
     */
    ...
    /**
     * Set the behaviour of updateUploadStatus. Set the uploadStatus's id to UNSET_ID. Since
    ...
    /**
     * Set the behaviour of updateUploadStatus. Give some valid parameters. See if the method can
     * successfully add the UploadStatus object to persistence No exception should be thrown.
     */
    ...
    /**
     * Set the behaviour of removeUploadStatus. Set the 1th paramter to null.
     * IllegalArgumentException should be thrown.
     */
    ...
    /**
     * Set the behaviour of removeUploadStatus. Set the 2th paramter to null.
     * IllegalArgumentException should be thrown.
     */
    ...
    /**
     * Set the behaviour of removeUploadStatus. Set the uploadStatus's id to UNSET_ID. Since
     * uploadStatus's id should not be UNSET_ID, IllegalArgumentException should be thrown.
     */
    ...
    /**
     * Set the behaviour of removeUploadStatus. Give some valid parameters. See if the method can
     * successfully add the UploadStatus object to persistence No exception should be thrown.
     */
    ...
    /**
     * Sicne the getAllUploadStatuses totally invoke method in persistence, We just use MOCK
     * persistence class to prove it is invoked properly.
     */
    ...
    /**
     * Set the behaviour of createSubmission. Set the 1th paramter to null. IllegalArgumentException
     * should be thrown.
     */
    ...
    /**
     * Set the behaviour of createSubmission. Set the 2th paramter to null. IllegalArgumentException
     * should be thrown.
     */
    ...
    /**
     * Set the behaviour of createSubmission. Set the submission's id to 10. Since submission's id
     * should be UNSET_ID, IllegalArgumentException should be thrown.
     */
    ...
    /**
     * Set the behaviour of createSubmission. Give some valid parameters. See if the method can
    ...
    public void testCreateSubmission_Accuracy1() {
        try {
            // Get a Submission.
            Submission submission = DeliverableTestHelper.getValidToPersitSubmission();
    ...
    /**
     * Set the behaviour of updateSubmission. Set the 1th paramter to null. IllegalArgumentException
     * should be thrown.
     */
    ...
    /**
     * Set the behaviour of updateSubmission. Set the 2th paramter to null. IllegalArgumentException
     * should be thrown.
     */
    ...
    /**
     * Set the behaviour of updateSubmission. Set the submission's id to UNSET_ID. Since
    ...
    /**
     * Set the behaviour of updateSubmission. Give some valid parameters. See if the method can
     * successfully add the Submission object to persistence No exception should be thrown.
     */
    ...
    /**
     * Set the behaviour of removeSubmission. Set the 1th paramter to null. IllegalArgumentException
     * should be thrown.
     */
    ...
    /**
     * Set the behaviour of removeSubmission. Set the 2th paramter to null. IllegalArgumentException
     * should be thrown.
     */
    ...
    /**
     * Set the behaviour of removeSubmission. Set the submission's id to UNSET_ID. Since
     * submission's id should not be UNSET_ID, IllegalArgumentException should be thrown.
     */
    ...
    /**
     * Set the behaviour of removeSubmission. Give some valid parameters. See if the method can
     * successfully add the Submission object to persistence No exception should be thrown.
     */
    ...
    /**
     * Set the behaviour of getSubmission. Set the paramter = 0. IllegalArgumentException should be
     * thrown.
     */
    ...
    /**
     * Set the behaviour of getSubmission. Set the paramter = 111, then the id field of return
    ...
    /**
     * Set the behaviour of searchSubmission. Set the paramter = null. IllegalArgumentException
     * should be thrown.
     */
    ...
    /**
     * Set the behaviour of createSubmissionStatus. Set the 1th paramter to null.
     * IllegalArgumentException should be thrown.
     */
    ...
    /**
     * Set the behaviour of createSubmissionStatus. Set the 2th paramter to null.
     * IllegalArgumentException should be thrown.
     */
    ...
    /**
     * Set the behaviour of createSubmissionStatus. Set the submissionStatus's id to 10. Since
    ...
    /**
     * Set the behaviour of createSubmissionStatus. Give some valid parameters. See if the method
    ...
    public void testCreateSubmissionStatus_Accuracy1() {
        try {
            ...
            SubmissionStatus submissionStatus = DeliverableTestHelper.getValidToPersitSubmissionStatus();
    ...
    /**
     * Set the behaviour of updateSubmissionStatus. Set the 1th paramter to null.
     * IllegalArgumentException should be thrown.
     */
    ...
    /**
     * Set the behaviour of updateSubmissionStatus. Set the 2th paramter to null.
     * IllegalArgumentException should be thrown.
     */
    ...
    /**
     * Set the behaviour of updateSubmissionStatus. Set the submissionStatus's id to UNSET_ID. Since
    ...
    /**
     * Set the behaviour of updateSubmissionStatus. Give some valid parameters. See if the method
     * can successfully add the SubmissionStatus object to persistence No exception should be
     * thrown.
     */
    ...
    /**
     * Set the behaviour of removeSubmissionStatus. Set the 1th paramter to null.
     * IllegalArgumentException should be thrown.
     */
    ...
    /**
     * Set the behaviour of removeSubmissionStatus. Set the 2th paramter to null.
     * IllegalArgumentException should be thrown.
     */
    ...
    /**
     * Set the behaviour of removeSubmissionStatus. Set the submissionStatus's id to UNSET_ID. Since
     * submissionStatus's id should not be UNSET_ID, IllegalArgumentException should be thrown.
     */
    ...
    /**
     * Set the behaviour of removeSubmissionStatus. Give some valid parameters. See if the method
     * can successfully add the SubmissionStatus object to persistence No exception should be
     * thrown.
     */
    ...
    /**
     * Sicne the getAllSubmissionStatuses totally invoke method in persistence, We just use MOCK
     * persistence class to prove it is invoked properly.
     */
