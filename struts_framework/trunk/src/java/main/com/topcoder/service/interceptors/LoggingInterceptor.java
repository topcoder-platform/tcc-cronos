...
/**
 * <p>
 * This interceptor will simply log exceptions. Basically, when the action is done it will intercept the
 * result and check if there is an AggregateDataModel instance on the value stack. If an
 * AggregateDataModel instance is found, there will be a result in it with key of <code>result</code>.
 * If the result is a java.lang.Throwable instance, then the interceptor will log its error message
 * and stack trace using the Logging Wrapper.
 * </p>
 *
 * <p>
...
public class LoggingInterceptor extends AbstractInterceptor {
     ...
     *
     * <p>
     * It's set and accessed in the set/get methods.
     * It should be non-null after being set. The default value is null.
     * </p>
     */
    private Log logger;
    ...
    /**
     * Constructor which takes the logger name as an argument. It initializes the logger
     ...
     * <code>result</code>. If the result is a java.lang.Throwable instance, then the interceptor will log its
     * error message and stack trace using the Logging Wrapper.
     * </p>
     *
